...
data class AnnualStockResponse (
    ...
    @SerializedName("referenceCycleCountNo") var referenceCycleCountNo: String? = null,
    @SerializedName("periodicLine"      ) var periodicLine      : ArrayList<PeriodicLine> = arrayListOf()
