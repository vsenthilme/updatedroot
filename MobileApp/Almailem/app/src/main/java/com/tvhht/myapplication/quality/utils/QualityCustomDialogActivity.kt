    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        qty_two!!.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(editable: Editable) {
                ...
                try {
                    if ((editable.toString().toInt() > qualityInfo.pickConfirmQty!!) || (editable.toString().toInt() < qualityInfo.pickConfirmQty!!)) {
                        ToastUtils.showToast(
                            applicationContext,
                            "Inspected Quantity cannot be greater than or less than Picked Quantity")
                        qty_two!!.setText(qualityInfo.pickConfirmQty.toString())
                    }
