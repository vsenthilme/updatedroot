...
public class ReversalAddBinCustomDialog extends AppCompatActivity implements
        View.OnClickListener {

    public Activity c;
    public String title = "Please Scan Bin Number";
    public String value = "";
    public Dialog d;
    ...
    private void displayScanResult(Intent initiatingIntent, String howDataReceived) {
        ...
        if (!TextUtils.isEmpty(decodedData)) {
            ...
            textValue.setText(value);
            textMessage.setText("Bin Number Scanned");
        ...
        switch (v.getId()) {
            case R.id.buttonYes: {
                if (!TextUtils.isEmpty(value)) {
                    ...
                    BinQuantityConfirm qtyInfo1 = new BinQuantityConfirm(qtyInfo.getPutawayConfirmedQty(), qtyInfo.getPutawayTotalQty(), value, false,"");
                    ...
                    Intent myIntent = new Intent(getApplicationContext(), ReversalQuantityCustomDialogActivity.class);
                    startActivity(myIntent);
                } else {

                    ToastUtils.Companion.showToast(getApplicationContext(), "Please scan the Bin");
                }
