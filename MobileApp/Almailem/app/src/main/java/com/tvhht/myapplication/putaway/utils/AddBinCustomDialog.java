...
public class AddBinCustomDialog extends AppCompatActivity implements
        ...
        switch (v.getId()) {
            case R.id.buttonYes: {
                if (!TextUtils.isEmpty(value)) {
                    ...
                    Intent myIntent = new Intent(getApplicationContext(), QuantityCustomDialogActivity.class);
