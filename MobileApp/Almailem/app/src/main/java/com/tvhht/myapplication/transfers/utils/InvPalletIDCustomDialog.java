...
public class InvPalletIDCustomDialog extends Dialog implements
    ...
    public InvPalletIDCustomDialog(Activity a, String title, String value) {
        super(a);
        this.c = a;
        this.title = title;
        this.value = value;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.buttonYes: {
                ...
                Intent myIntent = new Intent(c, InvQuantityCustomDialogActivity.class);
