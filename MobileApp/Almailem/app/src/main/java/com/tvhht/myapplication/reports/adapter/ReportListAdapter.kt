...
import kotlinx.android.synthetic.main.list_report_pallet_id_cell.view.*


class ReportListAdapter(val ctx: Context, val data: List<ReportResponse>) :
    ...
    override fun onCreateViewHolder(
        ...
        val v =
            LayoutInflater.from(parent.context)
                .inflate(R.layout.list_report_pallet_id_cell, parent, false)
        return ViewHolder(v)
    }
