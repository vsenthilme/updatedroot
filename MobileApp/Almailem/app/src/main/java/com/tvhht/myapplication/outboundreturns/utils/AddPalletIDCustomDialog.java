...
public class AddPalletIDCustomDialog extends AppCompatActivity implements
        View.OnClickListener {

    public Activity c;
    public String title = "Verify Barcode";
    public String value = "";
    public Dialog d;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        value=getIntent().getStringExtra("PALLET_ID_NN");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.buttonYes: {
                finish();
                ReturnPickingBinDetailsActivity.Companion.getInstance().verifyItemCode(value);
