...
import kotlinx.android.synthetic.main.activity_putaway_details.header_tt
...
class InboundReversalListActivity : AppCompatActivity() {
    ...
    fun loadPutAwayList() {
        ...
        model.getPutAwayList().observe(this) { vDataList ->
            ...
            filter_list =
                duplicate_dataList.filter { (it.inboundOrderTypeId == 2) }
            ...
            Recycler_view.adapter = ReversalAdapter(this, sortedList)
    ...
    private fun filterByDate() {
       ...
       /* val toIndexValue = spinner_order_no.selectedItem;
        ...
        if (sortedList.isNotEmpty()) {
            ...
            putaway_txt_count_val.text = sizeList
            Recycler_view.adapter = ReversalAdapter(this, selectedFilterList)
        } else {
            for (cases in filter_list) {
                str_list.add(cases.barcodeId.toString())
            }
