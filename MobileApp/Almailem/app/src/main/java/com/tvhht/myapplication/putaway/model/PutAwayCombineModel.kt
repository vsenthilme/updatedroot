...
data class PutAwayCombineModel(
    ...
    @SerializedName("orderQty") val orderQty: Double?=null,
    ...
    @SerializedName("confirmedStorageBin") val confirmedStorageBin: String? = null,
    @SerializedName("putawayConfirmedQty") val putAwayConfirmedQty: Int? = null,
    @SerializedName("companyCode") val companyCode: String?=null,
    @SerializedName("container") val container: String?=null,
    @SerializedName("cbmUnit") val cbmUnit: String?=null,
    @SerializedName("cbm") val cbm: Double?=null,
    ...
    @SerializedName("rejectType") val rejectType: String?=null,
    @SerializedName("rejectReason") val rejectReason: String?=null,
    @SerializedName("cbmQuantity") val cbmQuantity: Double?=null,
    @SerializedName("companyDescription") val companyDescription: String?=null,
    @SerializedName("plantDescription") val plantDescription: String?=null,
    @SerializedName("warehouseDescription") val warehouseDescription: String?=null,
    @SerializedName("statusDescription") val statusDescription: String?=null,
    @SerializedName("interimStorageBin") val interimStorageBin: String?=null,
    @SerializedName("middlewareId") val middlewareId: String?=null,
    @SerializedName("middlewareTable") val middlewareTable: String?=null,
    @SerializedName("manufactureFullName") val manufactureFullName: String?=null,
    @SerializedName("middlewareHeaderId") val middlewareHeaderId: String?=null,
    @SerializedName("purchaseOrderNumber") val purchaseOrderNumber: String?=null,
