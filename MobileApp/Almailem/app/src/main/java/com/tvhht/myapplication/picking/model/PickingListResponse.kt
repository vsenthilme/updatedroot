...
data class PickingListResponse(
    ...
    @SerializedName("referenceDocumentType") val referenceDocumentType: String? = null,
    @SerializedName("assignedPickerId") val assignedPickerId: String? = null,
    @SerializedName("salesOrderNumber") val salesOrderNumber: String? = null,
    ...
    companion object CREATOR : Parcelable.Creator<PickingListResponse> {
        override fun createFromParcel(parcel: Parcel): PickingListResponse {
            return PickingListResponse(parcel)
        }

        override fun newArray(size: Int): Array<PickingListResponse?> {
