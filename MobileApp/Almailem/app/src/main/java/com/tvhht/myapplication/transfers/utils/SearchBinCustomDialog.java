...
public class SearchBinCustomDialog extends AppCompatActivity implements
        View.OnClickListener {

    public Activity c;
    public String title = "Please Scan the Source Bin";
    public String value = "";
    public Dialog d;
    ...
    private void displayScanResult(Intent initiatingIntent, String howDataReceived) {
        ...
        if (!TextUtils.isEmpty(decodedData)) {
            ...
            textValue.setText(value);
            textMessage.setText("Source Bin Number Scanned");
            ...
            case R.id.buttonYes: {
                if (!TextUtils.isEmpty(value)) {
                    ...
                    WMSSharedPref.getAppPrefs(WMSApplication.getInstance().getContext())
                            .clearSharedPrefs("SCANNED_BIN_INFO");

                    WMSSharedPref.getAppPrefs(WMSApplication.getInstance().getContext()).saveStringValue("SCANNED_BIN_INFO",value);

                    Intent myIntent = new Intent(getApplicationContext(), InventoryListActivity.class);
                    startActivity(myIntent);
                } else {
                    ToastUtils.Companion.showToast(getApplicationContext(), "Please Scan the Source Bin");
                }
            }
            break;
            case R.id.buttonNo:
