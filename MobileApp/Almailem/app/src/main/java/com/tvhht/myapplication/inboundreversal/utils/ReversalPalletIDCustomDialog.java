...
public class ReversalPalletIDCustomDialog extends Dialog implements
    ...
    public ReversalPalletIDCustomDialog(Activity a, String title, String value) {
        super(a);
        this.c = a;
        this.title = title;
        this.value = value;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.buttonYes: {
                dismiss();
                Intent myIntent = new Intent(c, InboundReversalDetailsActivity.class);
