...
public class PalletIDCustomDialog extends Dialog implements
    ...
    public Context c;
    public String title = "";
    public QualityDetailsModel value;
    public Dialog d;
    public Button yes, no;
    public TextView textMessage, textValue;

    public PalletIDCustomDialog(Context a, String title, QualityDetailsModel value) {
        super(a);
        this.c = a;
        this.title = title;
        this.value = value;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textValue.setText(value.getPickedPackCode());
