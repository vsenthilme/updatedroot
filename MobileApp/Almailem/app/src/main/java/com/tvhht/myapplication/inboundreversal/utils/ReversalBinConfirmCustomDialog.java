...
public class ReversalBinConfirmCustomDialog extends Dialog implements
    ...
    public ReversalBinConfirmCustomDialog(Context a, String newBin, String oldBin) {
        super(a);
        this.c = a;
        this.newBin = newBin;
        this.oldBin = oldBin;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.buttonYes: {
                ...
                Intent myIntent = new Intent(c, ReversalQuantityCustomDialogActivity.class);
