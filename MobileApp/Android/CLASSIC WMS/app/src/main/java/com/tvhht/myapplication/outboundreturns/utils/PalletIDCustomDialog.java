...
public class PalletIDCustomDialog extends AppCompatActivity implements
        View.OnClickListener {

    public Activity c;
    public String title = "Verify Pallet ID";
    public String value = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        value= getIntent().getStringExtra("EXTRA_PALLET_CODE");
        value2=value;
    ...
    private void displayScanResult(Intent initiatingIntent, String howDataReceived)
    {
        ...
        if (decodedData.toString().length() > ApiConstant.INSTANCE.getCode_length_three()) {
            ...
            {
                textMessage.setText("Invalid Pallet ID");
                imageIcon.setBackgroundResource(R.drawable.icon_alert_failure);
            }
        }
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.buttonYes: {
                ...
                if (value.equalsIgnoreCase(value2)) {
                    finish();
                    ReturnPickingDetailsActivity.Companion.getInstance().verifyItemCode();
                } else {
                    ToastUtils.Companion.showToast(getApplicationContext(),"Invalid Pallet ID");
                }
