...
public class HECustomDialog extends AppCompatActivity implements
    ...
    public String qualityInspectionNo = "";
    public Dialog d;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        value = getIntent().getStringExtra("EXTRA_CODE_1");
        valueCode = getIntent().getStringExtra("EXTRA_CODE_2");
        qualityInspectionNo = getIntent().getStringExtra("EXTRA_CODE_3");
        title = getIntent().getStringExtra("EXTRA_CODE_4");
    ...
    private void displayScanResult(Intent initiatingIntent, String howDataReceived) {
        ...
        if (decodedData.toString().length() > ApiConstant.INSTANCE.getCode_length_one()) {
            ...
            textValue.setText(value);
            textMessage.setText("HE Number Scanned");
        ...
        switch (v.getId()) {
            case R.id.buttonYes: {
                ...
                if (value.length() > 0) {
                    ...
                    ToastUtils.Companion.showToast(getApplicationContext(), "Please Scan HE Number");
                }
