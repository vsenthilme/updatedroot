...
import com.tvhht.myapplication.picking.PickingBinDetailsActivity.Companion.getInstance
...
class AddPickingQuantityActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val stringValue1 =
            WMSSharedPref.getAppPrefs(applicationContext).getStringValue("ALLOC_QTY");
