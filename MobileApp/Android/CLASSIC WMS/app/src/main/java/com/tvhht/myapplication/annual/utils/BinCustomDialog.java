...
public class BinCustomDialog extends Dialog implements
    ...
    public BinCustomDialog(Activity a, String title, String value) {
        super(a);
        this.c = a;
        this.title = title;
        this.value = value;
        ...
        switch (v.getId()) {
            case R.id.buttonYes: {
                ...
                WMSSharedPref.getAppPrefs(
                        WMSApplication.getInstance().getContext()).clearSharedPrefs("STOCKS_QUALITY_INFO_LIST_PER2");
                Intent myIntent = new Intent(c, AnnualConfirmActivity.class);
