...
public class ScanPalletCustomDialog extends AppCompatActivity implements
    ...
    public Activity c;
    public String title = "Please Scan Pallet ID";
    public String value = "";
    public Dialog d;
    ...
    private void displayScanResult(Intent initiatingIntent, String howDataReceived)
    {
        ...
        if (decodedData.toString().length() > ApiConstant.INSTANCE.getCode_length_three()) {
            ...
            textValue.setText(value);
            textMessage.setText("Pallet ID is Scanned");
            ...
            case R.id.buttonYes: {
                ...
                if (value.length() > 0) {
                   finish();
                    ...
                    ToastUtils.Companion.showToast(getApplicationContext(), "Please scan the Pallet ID");
                }
