...
public class HeNoCustomDialog extends AppCompatActivity implements
        View.OnClickListener {

    public Activity c;
    public String title = "Scan HE Number";
    public String value = "";
    public Dialog d;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.buttonYes: {
                ...
                if (value.length() > 0) {
                    ReturnPickingDetailsActivity.Companion.getInstance().checkHandlingEquipmentID(value);
                } else {
