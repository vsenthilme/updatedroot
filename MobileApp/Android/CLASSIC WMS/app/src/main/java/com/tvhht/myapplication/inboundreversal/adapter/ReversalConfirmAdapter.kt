...
class ReversalConfirmAdapter(val ctx: Context, val data: List<BinQuantityConfirm>) :
    RecyclerView.Adapter<ReversalConfirmAdapter.ViewHolder>() {


    //this method is returning the view for each item in the list
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ReversalConfirmAdapter.ViewHolder {
        val v =
    ...
    override fun onBindViewHolder(holder: ReversalConfirmAdapter.ViewHolder, position: Int) {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(model: BinQuantityConfirm) {
            ...
            putaway_qty.text = model.putawayConfirmedQty.toString()
