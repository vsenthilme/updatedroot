...
class AnnualListActivity : AppCompatActivity() {
    ...
    private fun getStockList() {
        ...
        val linestatusID: MutableList<Int> = ArrayList()

        assUser.add(loginID)
        wareID.add(wareId)
        headerstatusID.add(70)
        headerstatusID.add(73)
        linestatusID.add(72)

        val requestData = AnnualHeader(wareId, assUser, headerstatusID,linestatusID)
        ...
        model.getAnnualList(requestData).observe(this) { vDataList ->
            ...
            Recycler_view.adapter = AnnualListAdapter(this, stockData)
