...
public class ConfirmWarningDialog extends Dialog implements
    ...
    public ConfirmWarningDialog(Activity a) {
        super(a);
        this.c = a;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.buttonYes:
                dismiss();
                PutAwayDetailsActivity.Companion.getInstance().loadAddBinData();
            case R.id.buttonNo:
