...
class PickingConfirmAdapter(val ctx: Context, val data: List<PickingQuantityConfirm>) :
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): PickingConfirmAdapter.ViewHolder {
        val v =
    ...
    override fun onBindViewHolder(holder: PickingConfirmAdapter.ViewHolder, position: Int) {
