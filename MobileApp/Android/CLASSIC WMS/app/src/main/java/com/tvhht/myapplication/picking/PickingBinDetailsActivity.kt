...
import com.tvhht.myapplication.picking.utils.AddBinCustomDialog
import com.tvhht.myapplication.picking.utils.AddItemCodeCustomDialog
...
class PickingBinDetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toolbar.sign_out.setOnClickListener {
            val cdd = LogoutCustomDialog(
                this@PickingBinDetailsActivity
            )
            if (cdd.isShowing) {
                cdd.dismiss()
            }
    ...
    private fun loadData() {
        ...
        pd = ProgressDialog(this@PickingBinDetailsActivity)
    ...
    companion object {
        private var instances2: PickingBinDetailsActivity? = null
        fun getInstance(): PickingBinDetailsActivity? {
            return instances2
        }
    }
    ...
    fun loadPalletID(string: String) {
        ...
        val myIntent =
            Intent(this@PickingBinDetailsActivity, AddPalletIDCustomDialog::class.java)
