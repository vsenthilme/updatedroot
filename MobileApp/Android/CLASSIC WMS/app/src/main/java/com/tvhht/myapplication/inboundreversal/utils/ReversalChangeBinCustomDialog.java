...
public class ReversalChangeBinCustomDialog extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_view_one_cc_activity);
        yes = (Button) findViewById(R.id.buttonYes);
        textMessage = (TextView) findViewById(R.id.textMessage);
        textValue = (TextView) findViewById(R.id.textTitle);
        imageIcon = (ImageView) findViewById(R.id.imageIcon);
        barcode_value = (EditText) findViewById(R.id.barcode_value1);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.buttonYes: {
                ...
                if (value.length() > 0) {
                    finish();
                    ReversalBinConfirmCustomDialog cdd = new ReversalBinConfirmCustomDialog(
                            c, value, "");
