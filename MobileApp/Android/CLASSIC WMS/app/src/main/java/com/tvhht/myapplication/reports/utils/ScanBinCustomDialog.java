...
public class ScanBinCustomDialog extends AppCompatActivity implements
        View.OnClickListener {

    public Activity c;
    public String title = "Please Scan Bin No";
    public String value = "";
    public Dialog d;
        ...
        switch (v.getId()) {
            case R.id.buttonYes: {
                ...
                if (value.length() > 0) {
                    ...
                    ReportListFromBinNoActivity.Companion.getInstance().verifyToken();
