...
@NoArgsConstructor
/*
 * `REQUEST_ID`,`COUNTRY_ID`, `LANG_ID`
 */
@Table(
        name = "tblownershiprequest",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "unique_key_ownershiprequest",
                        columnNames = {"LANG_ID", "C_ID", "REQUEST_ID"})
        }
)
@IdClass(OwnerShipRequestCompositeKey.class)
public class OwnerShipRequest {
    ...
    @Column(name = "STORE_ID", columnDefinition = "nvarchar(5)")
