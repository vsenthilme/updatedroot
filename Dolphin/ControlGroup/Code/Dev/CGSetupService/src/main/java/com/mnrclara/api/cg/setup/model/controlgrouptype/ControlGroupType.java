...
@NoArgsConstructor
/*
 * `COUNTRY_ID`,`LANG_ID`,'LANG_ID',VERSION_NO'
 */
@Table(
        name = "tblcontrolgrouptype",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "unique_key_controlgrouptype",
                        columnNames = {"GRP_TYP_ID","C_ID","LANG_ID","VERSION_NO"})
        }
)
@IdClass(ControlGroupTypeCompositeKey.class)
