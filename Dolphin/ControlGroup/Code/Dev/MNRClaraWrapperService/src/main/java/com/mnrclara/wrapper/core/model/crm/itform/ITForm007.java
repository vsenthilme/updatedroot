...
@Data
public class ITForm007 extends BaseMatterITForm {
	...
	@Data
	class DiovercedOrWidowerMaritalStatus {
	...
	@Data
	static class AmericanResidenceOrAmericanCitizenship {
	...
	@Data
	static class ArrivalAndDeparture {
