...
@Component({
  selector: 'app-proformainvoiceline-new',
  templateUrl: './proformainvoiceline-new.component.html',
  styleUrls: ['./proformainvoiceline-new.component.scss']
})
export class ProformainvoicelineNewComponent implements OnInit {
