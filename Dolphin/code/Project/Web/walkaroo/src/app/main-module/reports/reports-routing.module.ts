...
const routes: Routes = [
  ...
  { path: 'mlProjection', component: MlProjectionComponent , },
  { path: 'storagebin', component: StoragebinreportComponent , },
  { path: 'binproductivity', component: BinningproductivityreportComponent , },
  { path : 'productionOrder', component: ProductionOrderComponent},
  { path : 'operationConsumption', component: OperationConsumptionComponent},
  { path : 'processOperation', component: ProcessOperationComponent},
];
