...
export class ReportsService {
  ...
  getBatchgenerate(companyCodeId:any,plantId:any,warehouseId:any,languageId:any,storageMethod:any) {
    return this.apiService.get('/wms-transaction-service/grline/batchSerialNumber/v2'+'?companyCodeId='+companyCodeId+'&plantId='+plantId+'&warehouseId='+warehouseId+'&languageId='+languageId+'&storageMethod='+storageMethod);
  }
...
findInventoryspark(obj:any){
  return this.http.post<any>('/wms-spark-service/inventory/v2', obj);
}
  GetInventory() {
  ...
  getAllStockReportStoreProcedure(obj: any){
    return this.http.post<any>('/wms-transaction-service/reports/v2/stockReportSP', obj);
  }
  ...
  getInventoryMovementV2(obj: any) {
    return this.http.post<any>('/wms-spark-service/inventorymovement', obj);
  }
  ...
  getBinnerReportspark(obj: any) {
    return this.http.post<any>('/wms-spark-service/putawayline/v2', obj);
  } 
  getBinnerReportsparknormal(obj: any) {
    return this.http.post<any>('/wms-spark-service/putawayline/new', obj);
  } 
  ...
  getperodiclineSpark(obj: any) {
    return this.http.post<any>('/wms-spark-service/periodicline', obj);
  }
  getperpertuallineSpark(obj: any) {
    return this.http.post<any>('/wms-spark-service/perpetualline', obj);
  }
  ...
  searchstream(obj: any) {
    return this.http.post<any>('/wms-transaction-service/inboundheader/findInboundHeader/v2/stream', obj);
  }
  getstatus(obj: any) {
  ...
  getoutboundlinestream(obj: any) {
    return this.http.post<any>('/wms-transaction-service/outboundline/v2/findOutboundLine/stream', obj);
  }
  ...
  getgrlinev2(obj: any) {
    return this.http.post<any>('/wms-transaction-service/grline/findGrLineNew/v2', obj);
  }
  getgrlinev2spark(obj: any) {
  ...
  binningProductivity(obj: any) {
    return this.http.post<any>('/wms-transaction-service/reports/productivity/binning', obj);
  }
  ...
  searchstorage(obj: any) {
    return this.http.post<any>('/wms-spark-service/storageBin', obj);
  }

  search(obj: any) {
    return this.http.post<any>('/wms-mfg-service/operationLineV2Report/', obj);
  }
  
  productionOrderReport(obj: any) {
    return this.http.post<any>('/wms-mfg-service/operationLineReport/', obj);
  }
  productionOrderReportv2(obj: any) {
    return this.http.post<any>('/wms-mfg-service/operationLineV2Report/', obj);
  }
  operationConsumption(obj: any) {
    return this.http.post<any>('/wms-mfg-service/operationConsumption/findOperationConsumption', obj);
  }
  processReport(obj: any) {
    return this.http.post<any>('/wms-mfg-service/findOperationLineProcessReport', obj);
  }


  biningProductivity(obj: any) {
    return this.http.post<any>('/wms-transaction-service/reports/productivity/binning', obj);
  }


  pickingProducitivy(obj: any) {
    return this.http.post<any>('/wms-transaction-service/reports/productivity/picking', obj);
  }


  binningReportDashboard(obj: any) {
    return this.http.post<any>('/wms-transaction-service/reports/putaway/v2', obj);
  }


  pickingReportDashboard(obj: any) {
    return this.http.post<any>('/wms-transaction-service/reports/picking/v2', obj);
  }
}
