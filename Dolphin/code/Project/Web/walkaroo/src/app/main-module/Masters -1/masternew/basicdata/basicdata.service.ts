...
export class BasicdataService {
  ...
  searchDecription(obj: any) {
    return this.http.post<any>( '/wms-masters-service/imbasicdata1/imf/findImBasicData1', obj);
  }
  search1(obj: any) {
    return this.http.post<any>(this.apiName + 'imbasicdata1/findImBasicData1New', obj);
  }
  searchSpark(obj: any) {
    return this.http.post<any>('/wms-spark-service/imbasicdata1/test/v2', obj);
  }

  imfBasicData(obj:any){
    return this.http.post<any>('/wms-masters-service/imbasicdata1/imf/findImBasicData1', obj);
