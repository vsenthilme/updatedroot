...
export class PrepetualCountService {
  ...
  constructor(private apiService: ApiService, private configService: ConfigService, private auth: AuthService,private http: HttpClient) { }
  ...
  getPerpetualCountListSpark(obj: any ) {
    return this.apiService.post('/wms-spark-service/perpetualheader', obj);
  }
  Save(data: any) {
  ...
  createPerpetualorderCreateV2(obj: any) {
    return this.http.post<any>('/wms-transaction-service/v2/perpetualheader', obj);
  }
  createPeriodicorderCreateV2(obj: any) {
    return this.http.post<any>('/wms-transaction-service/v2/periodicheader', obj);
  }
  createstockadjustmentV2(obj: any) {
    return this.http.patch<any>('/wms-transaction-service/stockAdjustment/create', obj);
  }
  ...
  findPerpetualSpark(data: any) {
    return this.apiService.post('/wms-spark-service/perpetualline', data);
  }
