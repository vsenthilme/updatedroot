...
@Component({
  selector: 'app-b2borderlines',
  templateUrl: './b2borderlines.component.html',
  styleUrls: ['./b2borderlines.component.scss']
})
export class B2borderlinesComponent implements OnInit {

  constructor(private fb: FormBuilder,
    private auth: AuthService,
    public dialogRef: MatDialogRef<B2borderlinesComponent>,
...
submit(){
  ...
  this.form.controls.supplierCode.patchValue(this.form.controls.storeID.value)
  this.form.controls.supplierPartNumber.patchValue(this.form.controls.storeID.value)
  this.form.controls.packQty.patchValue(this.form.controls.expectedQty.value)
