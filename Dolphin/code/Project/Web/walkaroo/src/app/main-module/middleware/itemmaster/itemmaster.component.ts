...
export class ItemmasterComponent implements OnInit {
  ...
  reload() {
    ...
    this.sub.add(this.service.ItemMaster({ companyCode:[this.auth.companyId],branchCode:[this.auth.plantId], }).subscribe(res => {
      ...
      this.multisalesOrderNo = this.cs.removeDuplicatesFromArrayNewstatus(this.multisalesOrderNo);
      this.multistatus = this.cs.removeDuplicatesFromArrayNewstatus(this.multistatus);
    }))
  }
