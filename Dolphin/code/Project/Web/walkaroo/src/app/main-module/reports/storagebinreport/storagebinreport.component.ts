...
@Component({
  selector: 'app-storagebinreport',
  templateUrl: './storagebinreport.component.html',
  styleUrls: ['./storagebinreport.component.scss']
})
export class StoragebinreportComponent implements OnInit {
  screenid=3225;
  ...
  if(this.searhform.controls.storageBinFE.value!=null){
    ...
    this.searhform.controls.storageBin.patchValue(null);
  }
   ...
   ;
    ...
    this.sub.add(this.reportService.searchstorage(this.searhform.getRawValue()).subscribe(res => {
