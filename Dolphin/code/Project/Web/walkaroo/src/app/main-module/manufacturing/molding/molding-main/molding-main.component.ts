...
const ELEMENT_DATA1:  variant1[] = [
  {orderDetails:  'TF-2907',itemCode:  'EG60363-200',description:  'PULLEY TAHOE/YUKON 00-13',inputQty: '1',confirmedQty: '',confirmedBy: '',
  confirmedOn: new Date(),actions: new Date(), status:'Open'}
];
...
if(result){
  this.OrderDetails = [];
  const ELEMENT_DATA1 =[
    {orderDetails:  'TF-2907',itemCode:  'EG60363-200',description:  'PULLEY TAHOE/YUKON 00-13',inputQty: '1',confirmedQty: '1',confirmedBy: this.auth.userID,
