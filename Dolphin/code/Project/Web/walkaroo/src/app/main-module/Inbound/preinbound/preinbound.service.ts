...
export class PreinboundService {
  ...
  public inboundUpload(file: File, apiName:any) {
    ...
    return this.http.post(`/wms-transaction-service/warehouse/inbound/${apiName}/upload/v3` +'?languageId='+this.auth.languageId+'&companyCodeId='+this.auth.companyId+'&plantId='+this.auth.plantId+'&warehouseId='+this.auth.warehouseId+'&loginUserID='+this.auth.userID , formParams)
  }
