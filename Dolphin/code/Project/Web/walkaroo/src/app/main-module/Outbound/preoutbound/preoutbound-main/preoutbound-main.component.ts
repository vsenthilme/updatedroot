...
export class PreoutboundMainComponent implements OnInit {
  ...
  callIndusTable() {
    this.cols = [];
    this.cols = [
      { field: 'plantDescription', header: 'Plant', format: 'value' },
      ...
      { field: 'customerId', header: 'Customer Code', format: 'value' },
      { field: 'customerName', header: 'Customer Name', format: 'value' },
  ...
  location:any;
    ...
    if((element == 'salesOrder')) {
      this.fileName='Outbound_upload_template.xlsx'
      this.location='/outbound/salesOrder'
    }
