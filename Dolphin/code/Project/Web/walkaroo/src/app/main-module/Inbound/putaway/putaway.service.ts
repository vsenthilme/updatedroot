...
export class PutawayService {
  ...
  searchSpark(obj: any) {
    return this.http.post<any>( '/wms-spark-service/putAwayHeader', obj); ///v2
  }
  ...
  findStorageBinV2(obj: any) {
    return this.http.post<any>('/wms-masters-service/storagebin/v2/findStorageBinByLikeNew', obj);
  }
  ...
  searchLinev2spark(obj: any) {
    return this.http.post<any>( '/wms-spark-service/putawayline/v2', obj); // + '/v2'
  }
