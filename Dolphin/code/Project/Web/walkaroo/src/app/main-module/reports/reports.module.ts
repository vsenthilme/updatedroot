...
import { MlProjectionComponent } from './ml-projection/ml-projection.component';
import { StoragebinreportComponent } from './storagebinreport/storagebinreport.component';
import { BinningproductivityreportComponent } from './binningproductivityreport/binningproductivityreport.component';
import { ProductionOrderComponent } from './production-order/production-order.component';
import { LinesComponent } from './production-order/lines/lines.component';
import { PreparationDetailsComponent } from './production-order/preparation-details/preparation-details.component';
import { ProcessOperationComponent } from './Indus/process-operation/process-operation.component';
import { OperationConsumptionComponent } from './Indus/operation-consumption/operation-consumption.component';
...
@NgModule({
  declarations: [
    ...
    InventoryPutwayComponent,
    MlProjectionComponent,
    StoragebinreportComponent,
    BinningproductivityreportComponent,
    ProductionOrderComponent,
    LinesComponent,
    PreparationDetailsComponent,
    ProcessOperationComponent,
    OperationConsumptionComponent,
  ],
  imports: [
    CommonModule,
