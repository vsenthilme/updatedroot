...
const ELEMENT_DATA1:  variant1[] = [
  {orderDetails:  'TF-2907',itemCode:  'EG60363',description:  'PULLEY TAHOE/YUKON 00-13',inputQty: '1',confirmedQty: '',confirmedBy: '',
    confirmedOn: null,actions: '15-04-2023', status:'Open'}
];
...
if(result){
  this.OrderDetails = [];
  const ELEMENT_DATA1 =[
    {orderDetails:  'TF-2907',itemCode:  'EG60363',description:  'PULLEY TAHOE/YUKON 00-13',inputQty: '1',confirmedQty: '1',confirmedBy: this.auth.userID,
