...
export class StocksampleService {
  ...
  searchNew(obj: any) {
    return this.http.post<any>(this.url + '/findInventory/v2', obj);
  }
  searchNewSparkforcore(obj: any) {
    return this.http.post<any>( '/wms-spark-service/inventory/core/v2/new', obj);
  }
  searchSpark(obj: any) {
