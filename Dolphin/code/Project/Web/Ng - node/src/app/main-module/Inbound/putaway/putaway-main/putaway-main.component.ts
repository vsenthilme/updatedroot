...
export class PutawayMainComponent implements OnInit {
  ...
  @ViewChild('putawayTag') putawayTag: Table | undefined;
  ...
  callTableHeader() {
    this.cols = [
      ...
      { field: 'referenceField5', header: 'Product No' },
      { field: 'refDocNumber', header: 'Order No', format:'extra' },
      { field: 'putAwayNumber', header: 'Putaway No' },
      { field: 'packBarcodes', header: 'Pallet ID' },
      { field: 'proposedStorageBin', header: 'Storage Bin' },
      { field: 'proposedHandlingEquipment', header: 'HE No' },
      { field: 'putAwayQuantity', header: 'TO Qty' },
