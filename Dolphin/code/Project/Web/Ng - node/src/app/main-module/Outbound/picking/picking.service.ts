...
export class PickingService {
  ...
  deletePickupLine(obj: any) {
    return this.http.delete<any>('/wms-transaction-service/pickupline/'  + obj.actualHeNo + '?itemCode=' + obj.itemCode + '&lineNumber=' + obj.lineNumber + '&partnerCode=' + obj.partnerCode + '&preOutboundNo=' + obj.preOutboundNo + '&pickedPackCode=' + obj.pickedPackCode + '&pickedStorageBin=' + obj.pickedStorageBin + '&pickupNumber=' + obj.pickupNumber  + '&refDocNumber=' + obj.refDocNumber + '&warehouseId=' + obj.warehouseId);
  }
