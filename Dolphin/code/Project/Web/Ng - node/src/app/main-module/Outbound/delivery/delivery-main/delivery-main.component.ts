...
export class DeliveryMainComponent implements OnInit {
  @ViewChild('deliveryTag') deliveryTag: Table | undefined;
  ...
  ngOnInit(): void {
    ...
    this.searhform.controls.startDeliveryConfirmedOnFE.patchValue(this.oneMonthDate);
    this.searhform.controls.endDeliveryConfirmedOnFE.patchValue(this.currentDate);
  ...
  callTableHeader() {
    this.cols = [
      ...
      { field: 'referenceField8', header: 'Delivered Lines' },
      { field: 'deliveryQty', header: 'Delivered Qty', format: 'extra' },
  ...
  displayedColumns: string[] = ['select', 'statusId', 'refDocNumber', 'doc', 'referenceField1', 'outboundOrderTypeId', 'partnerCode', 'referenceField10', 'referenceField9', 'referenceField8', 'deliveryQty', 'requiredDeliveryDate', 'refDocDate', 'deliveryConfirmedOn',];
  ...
  downloadexcel() {
    ...
    this.cs.exportAsExcel(exportData, 'Delivery');
  }
