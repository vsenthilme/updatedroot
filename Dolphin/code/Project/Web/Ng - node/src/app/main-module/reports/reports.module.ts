...
import { PreoutboundLinesComponent } from './preoutbound/preoutbound-lines/preoutbound-lines.component';
import { TransactionHistoryComponent } from './transaction-history/transaction-history.component';
import { UpdateInventorymovementComponent } from './inventorymovement/update-inventorymovement/update-inventorymovement.component';
import { InventorylinesComponent } from './inventory-report/inventorylines/inventorylines.component';
import { InventoryputwayComponent } from './inventory-report/inventoryputway/inventoryputway.component';
import { TransactionHistorylinesComponent } from './transaction-history/transaction-historylines/transaction-historylines.component';
...
@NgModule({
  declarations: [
    ...
    PreinboundComponent,
    PreoutboundLinesComponent,
    TransactionHistoryComponent,
    UpdateInventorymovementComponent,
    InventorylinesComponent,
    InventoryputwayComponent,
    TransactionHistorylinesComponent,
