...
this.spin.show();
     ...
     obj.endDeliveryConfirmedOn = this.cs.dateNewFormat1(this.endDeliveryConfirmedOn);
     obj.startDeliveryConfirmedOn = this.cs.dateNewFormat1(this.startDeliveryConfirmedOn);

     obj.endOrderDate = this.cs.dateNewFormat1(this.endOrderDate);
     obj.startOrderDate = this.cs.dateNewFormat1(this.startOrderDate);
     
     obj.endRequiredDeliveryDate = this.cs.dateNewFormat1(this.endRequiredDeliveryDate);
     obj.startRequiredDeliveryDate = this.cs.dateNewFormat1(this.startRequiredDeliveryDate);
