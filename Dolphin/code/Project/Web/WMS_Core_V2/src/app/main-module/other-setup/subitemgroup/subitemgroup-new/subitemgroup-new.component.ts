...
@Component({
  selector: 'app-subitemgroup-new',
  templateUrl: './subitemgroup-new.component.html',
  styleUrls: ['./subitemgroup-new.component.scss']
})
export class SubitemgroupNewComponent implements OnInit {
  ...
  form = this.fb.group({
    ...
    itemTypeIdAndDescription:[],
    itemGroupIdAndDescription:[],
  });
  ...
  // this.itemtypeList=this.cas.foreachlist2(results[4], this.cas.dropdownlist.setup.itemtypeid.key);
  // this.itemgroupList=this.cas.foreachlist2(results[5], this.cas.dropdownlist.setup.itemgroupid.key);
...
this.masterService.searchitemtype({companyCodeId: this.data.companyCodeId, plantId: this.data.plantId, warehouseId: this.data.warehouseId, languageId: [this.data.languageId]}).subscribe(res => {
 this.itemtypeList = [];
 res.forEach(element => {
  this.itemtypeList.push({value: element.itemTypeId, label: element.itemTypeId + '-' + element.itemType});
 })
 });
 this.masterService.searchitemgroup({companyCodeId: this.data.companyCodeId, plantId: this.data.plantId, warehouseId: this.data.warehouseId, languageId: [this.data.languageId],itemTypeId:[this.data.itemTypeId]}).subscribe(res => {
  this.itemgroupList = [];
   res.forEach(element => {
  ...
  dropdownlist(){
   ...
   this.plantidList = this.cas.forLanguageFilter(results[3], this.cas.dropdownlist.setup.plantid.key);
   this.itemtypeList=this.cas.forLanguageFilter(results[4], this.cas.dropdownlist.setup.itemtypeid.key);
   this.itemgroupList=this.cas.forLanguageFilter(results[5], this.cas.dropdownlist.setup.itemgroupid.key);
  ...
  this.masterService.searchitemgroup({companyCodeId: this.auth.companyId, plantId: this.auth.plantId, warehouseId: this.auth.warehouseId, languageId: [this.auth.languageId]}).subscribe(res => {
    this.itemgroupList = [];
    res.forEach(element => {
      this.itemgroupList.push({value: element.itemGroupId, label: element.itemGroupId + '-' + element.itemGroup});
    })
  ...
  onLanguageChange(value){
    ...
    this.masterService.searchitemgroup({companyCodeId: this.form.controls.companyCodeId.value, plantId: this.form.controls.plantId.value,warehouseId:this.form.controls.warehouseId.value,itemTypeId:[this.form.controls.itemTypeId.value], languageId: [value.value]}).subscribe(res => {
      this.itemgroupList = [];
      res.forEach(element => {
        this.itemgroupList.push({value: element.itemGroupId, label: element.itemGroupId + '-' + element.itemGroup});
      })
  ...
  onCompanyChange(value){
    ...
    this.masterService.searchitemgroup({companyCodeId: value.value, plantId: this.form.controls.plantId.value,warehouseId:this.form.controls.warehouseId.value,itemTypeId:[this.form.controls.itemTypeId.value], languageId: [this.form.controls.languageId.value]}).subscribe(res => {
      this.itemgroupList = [];
      res.forEach(element => {
        this.itemgroupList.push({value: element.itemGroupId, label: element.itemGroupId + '-' + element.itemGroup});
      })
  ...
  onPlantChange(value){
    ...
    this.masterService.searchitemgroup({companyCodeId: this.form.controls.companyCodeId.value, plantId:value.value,warehouseId:this.form.controls.warehouseId.value,itemTypeId:[this.form.controls.itemTypeId.value], languageId: [this.form.controls.languageId.value]}).subscribe(res => {
      this.itemgroupList = [];
      res.forEach(element => {
        this.itemgroupList.push({value: element.itemGroupId, label: element.itemGroupId + '-' + element.itemGroup});
      })
  ...
  onWarehouseChange(value){
    ...
    this.masterService.searchitemgroup({companyCodeId: this.form.controls.companyCodeId.value, plantId: this.form.controls.plantId.value,warehouseId:value.value,itemTypeId:[this.form.controls.itemTypeId.value], languageId: [this.form.controls.languageId.value]}).subscribe(res => {
      this.itemgroupList = [];
      res.forEach(element => {
        this.itemgroupList.push({value: element.itemGroupId, label: element.itemGroupId + '-' + element.itemGroup});
      })
 ...
 onItemTypeChange(value){
  this.masterService.searchitemgroup({companyCodeId: this.form.controls.companyCodeId.value, plantId: this.form.controls.plantId.value,warehouseId:this.form.controls.warehouseId.value,itemTypeId:[value.value], languageId: [this.form.controls.languageId.value]}).subscribe(res => {
    this.itemgroupList = [];
    res.forEach(element => {
      this.itemgroupList.push({value: element.itemGroupId, label: element.itemGroupId + '-' + element.itemGroup});
    })
  ...
  fill() {
    this.spin.show();
    this.sub.add(this.service.Get(this.data.code,this.data.warehouseId,this.data.languageId,this.data.companyCodeId,this.data.plantId,this.data.itemGroupId,this.data.itemTypeId).subscribe(res => {
  ...
  if (this.data.code) {
    this.sub.add(this.service.Update(this.form.getRawValue(), this.data.code,this.data.warehouseId,this.data.languageId,this.data.companyCodeId,this.data.plantId,this.data.itemGroupId,this.data.itemTypeId).subscribe(res => {
    ...
    this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
      this.toastr.success(res.subItemGroupId + " Saved Successfully!","Notification",{
        timeOut: 2000,
        progressBar: false,
      });
      this.spin.hide();
