      ...
      forkJoin({
        ...
        .subscribe(({ itemList }) => {
          if (itemList != null && itemList.length > 0) {
            ...
            this.itemCodeList.forEach(x => this.multiselectItemCodeList.push({value: x.itemCode, label: x.itemCode + ' - ' + x.manufacturerName + ' - ' + x.description, manufacturingName: x.manufacturerName , description: x.description}))
          }
        });
   }
 }
     ...
     forkJoin({
       ...
       .subscribe(({ itemList }) => {
         if (itemList != null && itemList.length > 0) {
           ...
           this.itemCodeList1.forEach(x => this.multiselectItemCodeList1.push({value: x.itemCode, label: x.itemCode + ' - ' + x.description, manufacturingName: x.manufacturerName, description: x.description }))
         }
       });
  }
}
