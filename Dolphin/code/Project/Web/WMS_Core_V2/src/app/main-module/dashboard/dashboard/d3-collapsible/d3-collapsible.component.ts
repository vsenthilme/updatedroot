...
process:any;
  ...
  height: number;
  width: number;
  margin: any = { top: 275, bottom: 90, left: 130, right: 90 };
  duration: number = 750;
  nodeWidth: number = 5;
  nodeHeight: number = 1;
  nodeRadius: number = 5;
  ...
  toList: any[] = [];
  ProcessList:any[]=[];
  constructor(private data: DataService, private spin: NgxSpinnerService,  private router: Router,
  ...
  this.itemCode = [
    {value: '9028618', label: '9028618'},
    {value: '9028619', label: '9028619'},
    {value: '9028620', label: '9028620'},
    {value: '9028621', label: '9028621'},
];
...
if (this.process == 'Inbound')
   ...
   // this.root.children.forEach(collapse);
    ...
    // Assigns parent, children, height, depth
    this.root = d3.hierarchy(this.data.data2, (d) => { return d.children; });
    this.root.x0 = this.height / 4;
    this.root.y0 = 10;
    //this.renderTreeChart();
