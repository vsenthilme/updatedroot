...
@Component({
  selector: 'app-completed-line',
  templateUrl: './completed-line.component.html',
  styleUrls: ['./completed-line.component.scss']
})
export class CompletedLineComponent implements OnInit {
