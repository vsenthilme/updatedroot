...
@Component({
  selector: 'app-paymentmode-new',
  templateUrl: './paymentmode-new.component.html',
  styleUrls: ['./paymentmode-new.component.scss']
})
export class PaymentmodeNewComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.data.pageflow != 'New') {
      this.form.controls.paymentModeId.disable();
  ...
  onwarehouseChange(value){
    this.masterService.searchpaymentmode({companyCodeId: this.form.controls.companyCodeId.value, plantId:this.form.controls.plantId.value, warehouseId:this.form.controls.warehouseId.value, languageId: [this.form.controls.languageId.value]}).subscribe(res => {
      console.log(res.length);
      if(res.length >0){
      this.payementmode=res.length +1;
      this.form.controls.paymentModeId.patchValue(this.payementmode);
      }else{
        this.payementmode=1;
        this.form.controls.paymentModeId.patchValue(this.payementmode);
      }
