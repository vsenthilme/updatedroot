...
@Component({
  selector: 'app-proformainvoiceheader-new',
  templateUrl: './proformainvoiceheader-new.component.html',
  styleUrls: ['./proformainvoiceheader-new.component.scss']
})
export class ProformainvoiceheaderNewComponent implements OnInit {
