...
{path: 'productionOrderSfg', component: ProductionOrderComponent},
{path: 'productionOrderFg', component: ProductionOrderComponent},
{path: 'productionOrder-New/:code', component: ProductionOrderNewComponent},
{path: 'productionOrder-confirm/:code', component: ProductionOrderConfirmComponent},
// {
