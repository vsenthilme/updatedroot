...
@Component({
  selector: 'app-soorderlines',
  templateUrl: './soorderlines.component.html',
  styleUrls: ['./soorderlines.component.scss']
})
export class SoorderlinesComponent implements OnInit {

  constructor(private fb: FormBuilder,
    private auth: AuthService,
    public dialogRef: MatDialogRef<SoorderlinesComponent>,
    ...
    itemCodeChanged(e) {
      ...
      this.form.controls.uom.patchValue(e.uomId)
      let obj: any = {};
  ...
  ngOnInit(): void {
    if(this.data ==  1){
    this.form.controls.lineReference.patchValue(1);
    this.dropdownList();
    }
