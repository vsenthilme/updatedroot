...
@Component({
  selector: 'app-fabrication-new',
  templateUrl: './fabrication-new.component.html',
  styleUrls: ['./fabrication-new.component.scss']
})
export class FabricationNewComponent implements OnInit {
