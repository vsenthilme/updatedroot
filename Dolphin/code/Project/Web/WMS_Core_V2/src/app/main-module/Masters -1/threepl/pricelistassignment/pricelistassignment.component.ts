...
import { PricelistassigementlistComponent } from './pricelistassigementlist/pricelistassigementlist.component';
...
if(res){
  ...
  downloadexcel() {
    ...
    this.pricelistassignemnt.forEach(x => {
      ...
      "Language":x.languageId,
        ...
        "Price List":x.priceListIdAndDescription,
        "Partner":x.partnerCodeAndDescription,
    ...
    this.cs.exportAsExcel(res, "Price List Assignement");
  }
  onChange() {
  ...
  openprice(data): void {
    console.log(data);
    const dialogRef = this.dialog.open(PricelistassigementlistComponent, {
      disableClose: true,
      width: '80%',
      maxWidth: '90%',
      height:'50%',
