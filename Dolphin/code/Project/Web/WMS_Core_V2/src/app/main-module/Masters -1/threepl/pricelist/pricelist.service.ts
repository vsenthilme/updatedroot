...
export class PricelistService {
  ...
  CreateList(obj: any) {
    return this.http.post<any>(this.apiName + `pricelist/create/list`, obj);
  }
  ...
  UpdateList(obj: any) {
    return this.http.patch<any>(this.apiName + `pricelist/update/list` , obj);
  }
  ...
  DeleteList(obj:any) {
    return this.http.post<any>(this.apiName + `pricelist/delete/list` ,obj);
  }
  search(obj: any) {
