...
export class ShipmentorderComponent implements OnInit {
  ...
  search(ispageload = false) {
    this.spin.show();
    this.form.controls.fromOrderProcessedOn.patchValue(this.cs.dateNewFormat1(this.form.controls.fromOrderProcessedOnFE.value));
    this.form.controls.toOrderProcessedOn.patchValue(this.cs.dateNewFormat1(this.form.controls.toOrderProcessedOnFE.value));
  ...
  downloadexcel() {
    ...
    this.cs.exportAsExcel(res, 'Outbound NONWMS to WMS');
  }
