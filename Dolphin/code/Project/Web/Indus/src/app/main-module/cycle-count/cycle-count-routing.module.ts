...
import { AnnualCreateComponent } from './physical-inventory/physical-main/annual-create/annual-create.component';
...
const routes: Routes = [
  ...
  {
    path: 'stockAdjustmentEdit/:data',
    component: StockAdjustmentEditComponent
  },
  {
    path: 'cycleCountCreate',
    component: CreatePopupComponent
  },
  {
    path: 'annualcreate',
    component: AnnualCreateComponent
  },
  {
    path: 'stockAdjust',
