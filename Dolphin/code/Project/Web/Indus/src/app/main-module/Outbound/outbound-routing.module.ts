...
import { PreoutboundNewComponent } from './preoutbound/preoutbound-new/preoutbound-new.component';
import { FailedoutboundordersComponent } from './failedoutboundorders/failedoutboundorders.component';
import { InterwarehousecreateComponent } from './preoutbound/interwarehousecreate/interwarehousecreate.component';
import { SalesinvoiceComponent } from './preoutbound/salesinvoice/salesinvoice.component';
import { CancellationComponent } from './picking/cancellation/cancellation.component';
import { CancellationLinesComponent } from './picking/cancellation/cancellation-lines/cancellation-lines.component';
import { PurchasereturnComponent } from './preoutbound/purchasereturn/purchasereturn.component';
...
const routes: Routes = [
  ...
  {
    path: 'failedorder',
    component: FailedoutboundordersComponent
  },
  {
    path: 'quality-main',
  ...
  {
    path: 'preboutboundUpload',
    component: PreoutboundNewComponent
  },
    {
    path: 'purchasereturn',
  ...
  {
    path: 'interwarehouse',
    component: InterwarehousecreateComponent
  },
  {
    path: 'salesinvoice',
  ...
  },
  {
    ...
    component: CancellationLinesComponent
  },
  {
    path: '',
