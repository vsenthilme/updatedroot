...
@Component({
  selector: 'app-popupgrconfirm',
  templateUrl: './popupgrconfirm.component.html',
  styleUrls: ['./popupgrconfirm.component.scss']
})
export class PopupgrconfirmComponent implements OnInit {
  ...
  fill() {
    ...
    this.sub.add(this.service.Get(this.data.code.warehouseId,this.data.code.preInboundNo,this.data.code.refDocNumber,this.auth.companyId,this.data.code.languageId,this.data.code.plantId).subscribe(res => {
  ...
  if (this.data) {
    this.sub.add(this.service.updateinboundHeaderV2(this.form.getRawValue(),this.form.controls.refDocNumber.value,this.form.controls.warehouseId.value,this.auth.companyId,this.form.controls.plantId.value,this.form.controls.languageId.value,this.form.controls.preInboundNo.value).subscribe(res => {
