...
import { B2borderComponent } from './b2border/b2border.component';
import { B2borderlinesComponent } from './b2border/b2borderlines/b2borderlines.component';
import { InterwarehousetransferComponent } from './interwarehousetransfer/interwarehousetransfer.component';
import { InterwarehousetransferaddlinesComponent } from './interwarehousetransfer/interwarehousetransferaddlines/interwarehousetransferaddlines.component';
import { SoorderComponent } from './soorder/soorder.component';
import { SoorderlinesComponent } from './soorder/soorderlines/soorderlines.component';
import { StockreceiptComponent } from './stockreceipt/stockreceipt.component';
import { StockreceiptLineComponent } from './stockreceipt/stockreceipt-line/stockreceipt-line.component';
import { PreinboundprodComponent } from './preinboundprod/preinboundprod.component';
import { PreinboundprodNewComponent } from './preinboundprod/preinboundprod-new/preinboundprod-new.component';
...
@NgModule({
  declarations: [
    ...
    B2borderComponent,
    B2borderlinesComponent,
    InterwarehousetransferComponent,
    InterwarehousetransferaddlinesComponent,
    SoorderComponent,
    SoorderlinesComponent,
    StockreceiptComponent,
    StockreceiptLineComponent,
    PreinboundprodComponent,
    PreinboundprodNewComponent,
