...
export class OthermasterTabComponent implements OnInit {
  ...
  link = [
    ...
    { url: "/main/other-masters/receipe", title: "Process BOM", screenid: 3227, class: "mx-1 d-flex justify-content-center align-items-center" },
    { url: "/main/other-masters/masteroperation", title: "Master Operation", screenid: 3227, class: "mx-1 d-flex justify-content-center align-items-center" },
    { url: "/main/other-masters/masterReceipe", title: "Master Recipe", screenid: 3227, class: "mx-1 d-flex justify-content-center align-items-center" },
 ];
