...
@Component({
  selector: 'app-approvalid-new',
  templateUrl: './approvalid-new.component.html',
  styleUrls: ['./approvalid-new.component.scss']
})
export class ApprovalidNewComponent implements OnInit {
  ...
  form = this.fb.group({
    companyCodeId: [,Validators.required],
        ...
        approvalId: [,Validators.required],
        approvalLevel: [,Validators.required],
        approverCode: [],
        languageId: [,Validators.required],
        approvalProcessId: [,Validators.required],
  ...
  constructor(
    ...
    private service: ApprovalidService,
  ...
  ngOnInit(): void {
    ...
    if (this.data.pageflow != 'New') {
      this.form.controls.approvalId.disable();
      this.form.controls.approvalLevel.disable();
      this.form.controls.approvalProcessId.disable();
      this.form.controls.warehouseId.disable();
      this.form.controls.languageId.disable();
      this.form.controls.plantId.disable();
      this.form.controls.companyCodeId.disable();
    this.form.controls.approvalProcessId.patchValue(this.form.controls.approvalProcessId.value);
  ...
  dropdownlist(){
    ...
    this.cas.getalldropdownlist([
      ...
      this.cas.dropdownlist.setup.approvalprocessid.url,
    ]).subscribe((results) => {
   ...
   this.plantidList = this.cas.forLanguageFilter(results[3], this.cas.dropdownlist.setup.plantid.key);
    ...
    this.masterService.searchapprovalprocess({companyCodeId: this.auth.companyId, plantId: this.auth.plantId, warehouseId: this.auth.warehouseId, languageId: [this.auth.languageId]}).subscribe(res => {
      this.approvalList = [];
      res.forEach(element => {
        this.approvalList.push({value: element.approvalProcessId, label: element.approvalProcessId + '-' + element.approvalProcess});
      })
    });
  ...
  //  this.approvalList=this.cas.foreachlist2(results[6],this.cas.dropdownlist.setup.approvalprocessid.key);
 ...
 this.masterService.searchWarehouse({languageId: [this.data.languageId],companyCodeId:this.data.companyCodeId,plantId:this.data.plantId}).subscribe(res => {
  ...
  this.warehouseidList.push({value: element.warehouseId, label: element.warehouseId + '-' + element.warehouseDesc});
   ...
   this.masterService.searchapprovalprocess({languageId: [this.data.languageId],companyCodeId:this.data.companyCodeId,plantId:this.data.plantId,warehouseId:this.data.warehouseId}).subscribe(res => {
    this.approvalList = [];
    res.forEach(element => {
       this.approvalList.push({value: element.approvalProcessId, label: element.approvalProcessId + '-' + element.approvalProcess});
    })
  ...
  onLanguageChange(value){
    ...
    this.masterService.searchapprovalprocess({companyCodeId: this.form.controls.companyCodeId.value, plantId: this.form.controls.plantId.value, warehouseId: this.form.controls.warehouseId.value, languageId: [value.value]}).subscribe(res => {
      this.approvalList = [];
      res.forEach(element => {
        this.approvalList.push({value: element.approvalProcessId, label: element.approvalProcessId + '-' + element.approvalProcess});
      });
  ...
  onCompanyChange(value){
    ...
    this.masterService.searchapprovalprocess({companyCodeId: value.value, plantId: this.form.controls.plantId.value, warehouseId: this.form.controls.warehouseId.value, languageId: [this.form.controls.languageId.value]}).subscribe(res => {
      this.approvalList = [];
      res.forEach(element => {
        this.approvalList.push({value: element.approvalProcessId, label: element.approvalProcessId + '-' + element.approvalProcess});
      });
  ...
  onPlantChange(value){
      ...
      this.masterService.searchapprovalprocess({companyCodeId: this.form.controls.companyCodeId.value, plantId: value.value, warehouseId: this.form.controls.warehouseId.value, languageId: [this.form.controls.languageId.value]}).subscribe(res => {
        this.approvalList = [];
        res.forEach(element => {
          this.approvalList.push({value: element.approvalProcessId, label: element.approvalProcessId + '-' + element.approvalProcess});
        });
  ...
  onWarehouseChange(value){
    this.masterService.searchapprovalprocess({companyCodeId: this.form.controls.companyCodeId.value, plantId:this.form.controls.plantId.value, warehouseId: value.value, languageId: [this.form.controls.languageId.value]}).subscribe(res => {
      this.approvalList = [];
      res.forEach(element => {
        this.approvalList.push({value: element.approvalProcessId, label: element.approvalProcessId + '-' + element.approvalProcess});
      });
  ...
  fill() {
    this.spin.show();
    this.sub.add(this.service.Get(this.data.code,this.data.warehouseId,this.data.languageId,this.data.plantId,this.data.companyCodeId,this.data.approvalLevel,this.data.approvalProcessId).subscribe(res => {
  ...
  if (this.data.code) {
    this.sub.add(this.service.Update(this.form.getRawValue(), this.data.code,this.data.warehouseId,this.data.languageId,this.data.plantId,this.data.companyCodeId,this.data.approvalLevel,this.data.approvalProcessId).subscribe(res => {
    ...
    this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
      this.toastr.success(res.approvalId + " Saved Successfully!","Notification",{
        timeOut: 2000,
        progressBar: false,
      });
      this.spin.hide();
