...
export class CommonApiService {
  ...
  dropdownlist: any = {
    setup: {
      ...
      uomid: { url: this.setup + 'uomid', key: { key: 'uomId' , value: 'uomId',languageId: 'languageId'  } },
    ...
    master: {
      ...
      driver:{url: this.masters + 'driver', key: { key: 'driverId' , value: 'driverId',languageId: 'languageId'}},
