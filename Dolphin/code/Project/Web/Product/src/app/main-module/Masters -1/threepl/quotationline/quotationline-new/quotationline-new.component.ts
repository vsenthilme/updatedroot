...
@Component({
  selector: 'app-quotationline-new',
  templateUrl: './quotationline-new.component.html',
  styleUrls: ['./quotationline-new.component.scss']
})
export class QuotationlineNewComponent implements OnInit {
 ...
 // dialogRef: any;
  ...
  constructor(
    ...
    private service: QuotationlineService
  ) { }
  ngOnInit(): void {
