...
@Component({
  selector: 'app-handlingunit-new',
  templateUrl: './handlingunit-new.component.html',
  styleUrls: ['./handlingunit-new.component.scss']
})
export class HandlingunitNewComponent implements OnInit {
 ...
 // dialogRef: any;
  ...
  form = this.fb.group({
    companyCodeId: [],
        ...
        createdOnFE: [],
        deletionIndicator: [],
        handlingUnitDescription: [,Validators.required],
        handlingUnitId: [,Validators.required],
        handlingUnitNumber: [,Validators.required],
        languageId: [],
        plantId: [],
        referenceField1: [],
        referenceField10: [],
  ...
  ngOnInit(): void {
    ...
    if (this.data.pageflow != 'New') {
      this.form.controls.handlingUnitId.disable();
      this.form.controls.handlingUnitNumber.disable();
      this.form.controls.warehouseId.disable();
      this.form.controls.languageId.disable();
      this.form.controls.plantId.disable();
      this.form.controls.companyCodeId.disable();
  ...
  fill() {
    this.spin.show();
    this.sub.add(this.service.Get(this.data.code,this.data.warehouseId,this.data.languageId,this.data.companyCodeId,this.data.plantId,this.data.handlingUnitNumber).subscribe(res => {
  ...
  if (this.data.code) {
    this.sub.add(this.service.Update(this.form.getRawValue(),this.data.code,this.data.warehouseId,this.data.languageId,this.data.companyCodeId,this.data.plantId,this.data.handlingUnitNumber).subscribe(res => {
    ...
    this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
      this.toastr.success(res.handlingUnitId + " Saved Successfully!","Notification",{
        timeOut: 2000,
        progressBar: false,
      });
      this.spin.hide();
