...
export class BatchserialComponent implements OnInit {
  ...
  openDialog(data: any = 'New'): void {
    ...
    let paramdata = "";
    paramdata = this.cs.encrypt({ pageflow: data, code: data != 'New' ? this.selectedbatch[0].storageMethod : null,languageId: data != 'New' ? this.selectedbatch[0].languageId : null,plantId: data != 'New' ? this.selectedbatch[0].plantId : null,warehouseId: data != 'New' ? this.selectedbatch[0].warehouseId : null,companyId: data != 'New' ? this.selectedbatch[0].companyId : null ,levelId: data != 'New' ? this.selectedbatch[0].levelId : null});
  ...
  deleteDialog() {
    ...
    const dialogRef = this.dialog.open(DeleteComponent, {
      ...
      maxWidth: '80%',
      position: { top: '9%', },
      data: this.selectedbatch[0].code,
    });
  
    dialogRef.afterClosed().subscribe(result => {
  
      if (result) {
        this.deleterecord(this.selectedbatch[0].storageMethod);
