...
import { ItemCreateNewComponent } from './Item receipt/item-create-new/item-create-new.component';
import { InboundConfirmModule } from './inbound-confirmation/inbound-confirm.module';
...
@NgModule({
  declarations: [
    ...
    CasenoPopupComponent, ContainerreceiptCreateComponent, ItemCreateNewComponent,
