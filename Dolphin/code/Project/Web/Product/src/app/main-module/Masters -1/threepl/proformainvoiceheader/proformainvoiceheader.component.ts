...
import { ProformainvoiceheaderNewComponent } from './proformainvoiceheader-new/proformainvoiceheader-new.component';
import { ProformainvoiceheaderService } from './proformainvoiceheader.service';

@Component({
  selector: 'app-proformainvoiceheader',
  templateUrl: './proformainvoiceheader.component.html',
  styleUrls: ['./proformainvoiceheader.component.scss']
})
export class ProformainvoiceheaderComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog,
   ...
   // private excel: ExcelService,
    ...
    private service: ProformainvoiceheaderService) { }
  ngOnInit(): void {
  ...
  console.log(this.selectedproforma)
    ...
    const dialogRef = this.dialog.open(ProformainvoiceheaderNewComponent, {
      disableClose: true,
      width: '85%',
      maxWidth: '65%',
      data: { pageflow: data, code: data != 'New' ? this.selectedproforma[0].code : null,}
    });
