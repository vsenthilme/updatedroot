...
paginator!: MatPaginator; // Pagination
 ...
 reload(){
  ...
  displayedColumns: string[] = ['select','actions', 'statusId', 'refDocNumber','partnerCode',  'outboundOrderTypeId',   'lineNumber', 'itemCode','orderQty', 'inventoryQty', 'allocatedQty', 'requiredDeliveryDate','preOutboundNo', 'description', ];
