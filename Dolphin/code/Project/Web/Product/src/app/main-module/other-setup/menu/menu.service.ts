...
export class MenuService {
  ...
  Update(obj: any, code: any,warehouseId:any,authorizationObjectId:any,companyCodeId:any,languageId:any,plantId:any,subMenuId:any) {
    return this.http.patch<any>('/wms-idmaster-service/menuid/' + code +'?warehouseId='+warehouseId+'&authorizationObjectId='+authorizationObjectId+'&companyCodeId='+companyCodeId+'&languageId='+languageId+'&plantId='+plantId+'&subMenuId='+subMenuId, obj);
  }
