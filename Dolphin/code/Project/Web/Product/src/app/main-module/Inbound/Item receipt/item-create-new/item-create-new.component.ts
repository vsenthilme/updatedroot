...
import { AssignHEComponent } from "../item-create/assign-he/assign-he.component";
import { PackDetailsComponent } from "../item-create/pack-details/pack-details.component";
import { Packdetails1Component } from "../item-create/packdetails1/packdetails1.component";
import { ItemReceiptService } from "../item-receipt.service";
import { Location } from "@angular/common";

@Component({
  selector: 'app-item-create-new',
  templateUrl: './item-create-new.component.html',
  styleUrls: ['./item-create-new.component.scss']
})
export class ItemCreateNewComponent implements OnInit {
