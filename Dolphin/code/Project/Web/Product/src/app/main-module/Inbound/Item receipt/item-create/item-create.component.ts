...
export class ItemCreateComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select',  'itemCode', 'manufacturerPartNo', 'lineNo','itemDescription', 'orderQty', 'acceptedQty', 'damageQty', 'varianceQty', 'cases', 'batchSerialNumber','expiryDate','manufacturerDate', 'status',];
