...
export class HhtuserComponent implements OnInit {
  ...
  openDialog(data: any = 'New'): void {
    ...
    const dialogRef = this.dialog.open(HhtuserNewComponent, {
      ...
      width: '55%',
      maxWidth: '80%',
      data: { pageflow: data, code: data != 'New' ? this.selectedaisle[0].userId : null, warehouseId: data != 'New' ? this.selectedaisle[0].warehouseId : null,plantId: data != 'New' ? this.selectedaisle[0].plantId : null,companyCodeId: data != 'New' ? this.selectedaisle[0].companyCodeId : null,languageId: data != 'New' ? this.selectedaisle[0].languageId : null, othermaster: this.js.tabSelected == 'otherMaster' ? 'otherMaster' : ''}
    });
...
if(res){
  ...
  deleteDialog() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        this.deleterecord(this.selectedaisle[0].userId,this.selectedaisle[0].warehouseId,this.selectedaisle[0].plantId,this.selectedaisle[0].companyCodeId,this.selectedaisle[0].languageId);
  ...
  deleterecord(id: any,warehouseId:any,plantId:any,companyCodeId:any,languageId:any) {
    this.spin.show();
    this.sub.add(this.service.Delete(id,warehouseId,plantId,companyCodeId,languageId).subscribe((res) => {
