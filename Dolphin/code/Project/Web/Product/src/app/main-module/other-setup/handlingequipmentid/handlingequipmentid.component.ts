...
superAdmin(){
  ...
  deleteDialog() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        this.deleterecord(this.selectedhandling[0].handlingEquipmentId,this.selectedhandling[0].warehouseId,this.selectedhandling[0].languageId,this.selectedhandling[0].companyCodeId,this.selectedhandling[0].plantId,this.selectedhandling[0].handlingEquipmentNumber);
