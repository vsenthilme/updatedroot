...
export class DeliveryMainComponent implements OnInit {
  ...
  search(ispageload = false) {
    ...
    this.searhform.controls.statusId.patchValue([59]);
  ...
  displayedColumns: string[] = [ 'select', 'actions', 'refDocNumber', 'doc', 'referenceField1', 'outboundOrderTypeId', 'partnerCode', 'referenceField10', 'referenceField9', 'referenceField8', 'deliveryQty', 'requiredDeliveryDate', 'refDocDate', 'deliveryConfirmedOn',];
