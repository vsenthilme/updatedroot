...
export class PartnerNewComponent implements OnInit {
  ...
  warehouseIdList: any[] = [];
    ...
    dropdownlist(){
      ...
      this.masterService.searchpartner({ warehouseId:[this.auth.warehouseId] ,languageId:[this.auth.languageId],companyCodeId:[this.auth.companyId],plantId:[this.auth.plantId]}).subscribe(res => {
