...
import { InquiryService } from '../../threepl/inquiry/inquiry.service';
...
export class AltpartComponent implements OnInit {
   ...
   downloadexcel() {
    ...
    this.invoices.forEach(x => {
       ...
       "Company":x.companyCodeId,
        ...
        "Alt Product Code":x.altItemCode,
  ...
  deleteDialog() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        this.deleterecord(this.selectedinvoice[0].altItemCode,this.selectedinvoice[0].warehouseId,this.selectedinvoice[0].languageId,this.selectedinvoice[0].plantId,this.selectedinvoice[0].companyCodeId,this.selectedinvoice[0].itemCode);
