...
import { InvoiceheaderNewComponent } from './invoiceheader-new/invoiceheader-new.component';
import { InvoiceheaderService } from './invoiceheader.service';

@Component({
  selector: 'app-invoiceheader',
  templateUrl: './invoiceheader.component.html',
  styleUrls: ['./invoiceheader.component.scss']
})
export class InvoiceheaderComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog,
   ...
   // private excel: ExcelService,
    ...
    private service: InvoiceheaderService) { }
  ngOnInit(): void {
  ...
  console.log(this.selectedinvoice)
    ...
    const dialogRef = this.dialog.open(InvoiceheaderNewComponent, {
      disableClose: true,
      width: '85%',
      maxWidth: '65%',
      data: { pageflow: data, code: data != 'New' ? this.selectedinvoice[0].code : null,}
    });
