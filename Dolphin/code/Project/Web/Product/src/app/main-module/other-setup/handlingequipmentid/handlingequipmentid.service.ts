...
export class HandlingequipmentidService {
  ...
  Delete(handlingEquipmentId: any, warehouseId: string,languageId:any,companyCodeId:any,plantId:any,handlingEquipmentNumber:any) {
    return this.http.delete<any>('/wms-idmaster-service/handlingequipmentid/' + handlingEquipmentId+'?warehouseId='+warehouseId+'&languageId='+languageId+'&companyCodeId='+companyCodeId+'&plantId='+plantId+'&handlingEquipmentNumber='+handlingEquipmentNumber);
}
search(obj: any) {
