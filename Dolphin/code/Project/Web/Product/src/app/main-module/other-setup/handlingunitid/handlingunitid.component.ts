...
superAdmin(){
  ...
  deleteDialog() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        this.deleterecord(this.selectedhandlingunit[0].handlingUnitId,this.selectedhandlingunit[0].warehouseId,this.selectedhandlingunit[0].languageId,this.selectedhandlingunit[0].companyCodeId,this.selectedhandlingunit[0].plantId,this.selectedhandlingunit[0].handlingUnitNumber);
