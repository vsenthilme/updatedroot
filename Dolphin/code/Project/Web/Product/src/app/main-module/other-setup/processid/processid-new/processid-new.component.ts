...
@Component({
  selector: 'app-processid-new',
  templateUrl: './processid-new.component.html',
  styleUrls: ['./processid-new.component.scss']
})
export class ProcessidNewComponent implements OnInit {
 ...
 // dialogRef: any;
  ...
  form = this.fb.group({
    ...
    processText: [,Validators.required],
    referenceField1: [],
    referenceField10: [],
    referenceField2: [],
    referenceField3: [],
  ...
  if (this.data.code) {
    ...
    this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
      this.toastr.success(res.processId + " Saved Successfully!","Notification",{
        timeOut: 2000,
        progressBar: false,
      });
      this.spin.hide();
