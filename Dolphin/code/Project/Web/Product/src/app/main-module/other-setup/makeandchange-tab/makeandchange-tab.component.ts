...
export class MakeandchangeTabComponent implements OnInit {
  ...
  link = [
    { url: "/main/otherSetup/cyclecounttypeid", title: "Cycle Count Type ", screenid: 3124, class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
    { url: "/main/otherSetup/approvalprocessid", title: "Approval Process ", screenid: 3103, class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
    { url: "/main/otherSetup/approvalid", title: "Approval ",screenid: 3132,  class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
    { url: "/main/otherSetup/movementtypeid", title: "Movement Type ",screenid: 3115,  class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
    { url: "/main/otherSetup/submovementtypeid", title: "Sub Movement Type ",screenid: 3116,  class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
    { url: "/main/otherSetup/transfertypeid", title: "Transfer Type ",screenid: 3117,  class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
