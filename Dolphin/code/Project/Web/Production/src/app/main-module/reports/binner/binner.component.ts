...
export class BinnerComponent implements OnInit {
  ...
  //wms demo
  displayedColumns: string[] = ['select', 'statusId', 'itemCode', 'proposedStorageBin', 'confirmedStorageBin', 'packBarcodes', 'putAwayQuantity', 'putawayConfirmedQty', 'confirmedBy', 'createdOn',];
  ...
  downloadexcel() {
    ...
    this.dataSource.data.forEach(x => {
      res.push({
        ...
        "Confirmed On": this.cs.dateExcel(x.createdOn),
