...
export class DeliveryMainComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // this.searhform.controls.startDeliveryConfirmedOn.patchValue(this.oneMonthDate);
    // this.searhform.controls.endDeliveryConfirmedOn.patchValue(this.currentDate);
