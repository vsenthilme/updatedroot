...
import { InventorylinesComponent } from "./inventorylines/inventorylines.component";
import { InventoryputwayComponent } from "./inventoryputway/inventoryputway.component";
...
export class InventoryReportComponent implements OnInit {
  ...
  showFiller = false;
  displayedColumns: string[] = ['itemCode', 'referenceField8', 'referenceField9', 'storageBin', 'referenceField10', 'packBarcodes', 'inventoryQuantity', 'allocatedQuantity', 'total', 'stockTypeId'];
