...
export class TransactionHistoryComponent implements OnInit {
  ...
  displayedColumns: string[] = ['warehouseId', 'itemCode','itemDescription',  'openingStock', 'inboundQty', 'outboundQty','stockAdjustmentQty','closingStock','systemInventory','variance'];
