...
export class OrderStatusComponent implements OnInit {
  ...
  getOrderStatusData() {
    ...
    this.reportService.getOrderStatusDetails(this.sendingCustomerCodeList, this.sendingFromCreatedOn, this.sendingOrderTypeList, this.sendingStatusIdList, this.sendingToCreatedOn, this.selectedWarehouse).subscribe(
      result => {
        console.log(result);
