...
export class HandlingUnitService {
  ...
  Get(code: string) {
    return this.http.get<any>(this.apiName + `handlingunit/` + code);
  }
  Create(obj: HandlingUnitElement) {
    return this.http.post<any>(this.apiName + `handlingunit`, obj);
  }
  Update(obj: HandlingUnitElement, code: any) {
    return this.http.patch<any>(this.apiName + `handlingunit/` + code, obj);
  }
  Delete(handlingUnit: any) {
    return this.http.delete<any>(this.apiName + `handlingunit/` + '?handlingUnit=' + handlingUnit  );
  }
  search(obj: any) {
