...
@Component({
  selector: 'app-receiptconfirmation-list',
  templateUrl: './receiptconfirmation-list.component.html',
  styleUrls: ['./receiptconfirmation-list.component.scss']
})
export class ReceiptconfirmationListComponent implements OnInit {
  constructor() { }
