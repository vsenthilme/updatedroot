...
export class VarianteditAnnualComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.data.type == "Edit" && this.data.periodicHeaderData.periodicLine) {
    ...
    console.log(this.data.periodicHeaderData.periodicLine)
    if (this.data.type =='Display' && this.data.periodicHeaderData.periodicLine) {
      console.log(this.data.periodicHeaderData.periodicLine)
      this.data.periodicHeaderData.periodicLine.forEach(element => {
        if((element.countedQty - element.inventoryQuantity) != 0  && element.varianceQty != null ){
          this.filteredVariance.push(element);
