...
export class EquipmentNewComponent implements OnInit {
  ...
  onWarehouseChange(value){
    this.form.controls.companyCodeId.patchValue(this.auth.warehouseId);
    this.form.controls.languageId.patchValue(this.auth.languageId);
    this.form.controls.plantId.patchValue(this.auth.plantId);
  ...
  if (this.js.code) {
    this.sub.add(this.service.Update(this.form.getRawValue(),this.js.handlingEquipmentId,this.js.companyCodeId,this.js.languageId,this.js.plantId,this.js.warehouseId).subscribe(res => {
