...
export class TransactionHistoryComponent implements OnInit {
  ...
  displayedColumns: string[] = ['warehouseId', 'itemCode',  'openingStock', 'inboundQty', 'outboundQty','stockAdjustmentQty','closingStock'];
  ...
  onItemType(searchKey) {
    ...
    if (searchVal !== '' && searchVal !== null) {
      forkJoin({
        itemList: this.service.getItemCodeDropDown(searchVal.trim()).pipe(catchError(err => of(err))),
      })
        .subscribe(({ itemList }) => {
