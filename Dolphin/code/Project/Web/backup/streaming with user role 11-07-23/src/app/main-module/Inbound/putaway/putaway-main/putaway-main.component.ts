...
export class PutawayMainComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'referenceField10','itemCode', 'refDocNumber', 'putAwayNumber', 'packBarcodes', 'proposedStorageBin', 'proposedHandlingEquipment', 'putAwayQuantity', 'createdBy', 'createdOn',];
