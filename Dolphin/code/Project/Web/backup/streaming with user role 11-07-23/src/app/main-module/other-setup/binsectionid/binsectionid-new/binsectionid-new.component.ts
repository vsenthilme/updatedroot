...
@Component({
  selector: 'app-binsectionid-new',
  templateUrl: './binsectionid-new.component.html',
  styleUrls: ['./binsectionid-new.component.scss']
})
export class BinsectionidNewComponent implements OnInit {
  ...
  form = this.fb.group({
    binSection: [,Validators.required],
    binSectionId: [,Validators.required],
  ...
  ngOnInit(): void {
    ...
    if (this.data.pageflow != 'New') {
      this.form.controls.binSectionId.disable();
      this.form.controls.plantId.disable();
    this.form.controls.warehouseId.disable();
      this.form.controls.languageId.disable();
      this.form.controls.companyCodeId.disable();
  ...
  if (this.data.code) {
    ...
    this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
      this.toastr.success(res.binSectionId + " Saved Successfully!","Notification",{
        timeOut: 2000,
        progressBar: false,
      });
      this.spin.hide();
