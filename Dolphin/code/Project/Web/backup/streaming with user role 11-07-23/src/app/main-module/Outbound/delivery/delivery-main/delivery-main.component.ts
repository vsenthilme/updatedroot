...
export class DeliveryMainComponent implements OnInit {
  ...
  displayedColumns: string[] = [ 'select', 'statusDescription', 'refDocNumber', 'doc', 'referenceField1', 'outboundOrderTypeId', 'partnerCode', 'referenceField10', 'referenceField9', 'referenceField8', 'deliveryQty', 'requiredDeliveryDate', 'refDocDate', 'deliveryConfirmedOn',];
