...
@Component({
  selector: 'app-outboundordertypeid-new',
  templateUrl: './outboundordertypeid-new.component.html',
  styleUrls: ['./outboundordertypeid-new.component.scss']
})
export class OutboundordertypeidNewComponent implements OnInit {
  ...
  form = this.fb.group({
    ...
    deletionIndicator: [],
    languageId: [],
    outboundOrderTypeId: [,Validators.required],
    outboundOrderTypeText: [,Validators.required],
    plantId: [],
    referenceField1: [],
    referenceField10: [],
    referenceField2: [],
  ...
  ngOnInit(): void {
    ...
    if (this.data.pageflow != 'New') {
      this.form.controls.outboundOrderTypeId.disable();
  ...
  if (this.data.code) {
    ...
    this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
      this.toastr.success(res.outboundOrderTypeId + " Saved Successfully!","Notification",{
        timeOut: 2000,
        progressBar: false,
      });
      this.spin.hide();
