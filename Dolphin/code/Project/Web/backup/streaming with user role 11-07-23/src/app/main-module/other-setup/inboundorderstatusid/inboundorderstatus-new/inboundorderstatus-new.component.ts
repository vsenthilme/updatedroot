...
@Component({
  selector: 'app-inboundorderstatus-new',
  templateUrl: './inboundorderstatus-new.component.html',
  styleUrls: ['./inboundorderstatus-new.component.scss']
})
export class InboundorderstatusNewComponent implements OnInit {
  ...
  form = this.fb.group({
    ...
    createdOnFE: [],
    deletionIndicator: [],
    inboundOrderStatus: [,Validators.required],
    inboundOrderStatusId: [,Validators.required],
    languageId: [],
    plantId: [],
    referenceField1: [],
    referenceField10: [],
  ...
  ngOnInit(): void {
    ...
    if (this.data.pageflow != 'New') {
      this.form.controls.inboundOrderStatusId.disable();
  ...
  if (this.data.code) {
    ...
    this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
      this.toastr.success(res.inboundOrderStatusId + " Saved Successfully!","Notification",{
        timeOut: 2000,
        progressBar: false,
      });
      this.spin.hide();
