...
export class PackingNewComponent implements OnInit {
  ...
  dropdownlist() {
    ...
    this.cas.getalldropdownlist([
      ...
      this.businessList=this.cas.foreachlist2(results[2],this.cas.dropdownlist.master.businesspartner.key);
  ...
  superadmindropdownlist(){
    ...
    this.uomList = this.cas.foreachlist2(results[1], this.cas.dropdownlist.setup.uomid.key);
    this.businessList=this.cas.foreachlist2(results[2],this.cas.dropdownlist.master.businesspartner.key);
