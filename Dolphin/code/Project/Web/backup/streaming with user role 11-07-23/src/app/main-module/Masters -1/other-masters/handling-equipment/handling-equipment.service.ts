...
export class HandlingEquipmentService {
  ...
  Update(obj: HandlingquipmentElement, handlingEquipmentId:any,companyCodeId:any,languageId:any,plantId:any,warehouseId:any) {
    return this.http.patch<any>(this.apiName + `handlingequipment/` + '?handlingEquipmentId='+handlingEquipmentId+'&companyCodeId='+companyCodeId+'&languageId='+languageId+'&plantId='+plantId+'&warehouseId='+warehouseId, obj);
  }
