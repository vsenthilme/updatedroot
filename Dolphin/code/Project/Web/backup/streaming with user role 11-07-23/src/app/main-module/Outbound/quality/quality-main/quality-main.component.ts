...
export class QualityMainComponent implements OnInit {
  ...
  displayedColumns: string[] = [ 'select', 'actions1', 'referenceField10', 'actualHeNo','referenceField4','referenceField1', 'pickedPackCode','refDocNumber', 'partnerCode','qualityQty', 'rejectQty','qualityInspectionNo', 'manufacturerPartNo', 'qualityCreatedBy', 'qualityCreatedOn'];
