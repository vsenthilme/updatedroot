     ...
     // Pagination
      ...
      openDialog(data: any = 'New'): void {
        ...
        const dialogRef = this.dialog.open(VerticalNewComponent, {
          ...
          width: '55%',
          maxWidth: '80%',
          data: { pageflow: data, code: data != 'New' ? this.selection.selected[0].verticalId : null}
        });
      ...
      deleteDialog() {
        ...
        const dialogRef = this.dialog.open(DeleteComponent, {
          ...
          maxWidth: '80%',
          position: { top: '9%', },
          data: this.selection.selected[0].verticalId,
        });
    
        dialogRef.afterClosed().subscribe(result => {
    
          if (result) {
            this.deleterecord(this.selection.selected[0].verticalId);
