...
export class PutawayService {
  ...
  deletePutawayLine(obj: any) {
    return this.http.delete<any>('/wms-transaction-service/putawayline/'  + obj.confirmedStorageBin + '?companyCodeId=' + obj.companyCode + '&goodsReceiptNo=' + obj.goodsReceiptNo + '&itemCode=' + obj.itemCode + '&languageId=' + obj.languageId + '&lineNo=' + obj.lineNo + '&plantId=' + obj.plantId + '&preInboundNo=' + obj.preInboundNo + '&proposedStorageBin=' + obj.proposedStorageBin + '&putAwayNumber=' + obj.putAwayNumber + '&refDocNumber=' + obj.refDocNumber + '&warehouseId=' + obj.warehouseId);
  }
}
