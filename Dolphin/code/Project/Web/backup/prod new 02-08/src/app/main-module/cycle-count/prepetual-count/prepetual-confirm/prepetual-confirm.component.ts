  ...
  ngOnInit(): void {
    ...
    if (js.pageflow == 'New') {
      ...
      this.prepetualCountService.get(this.code).subscribe(result=>{
        ...
        this.displayedColumns = ['select', 'no', 'itemCode', 'itemDesc', 'manufacturerPartNo', 'storageSectionId', 'storageBin', 'packBarcodes', 'stockTypeId', 'inventoryQuantity', 'countedQty', 'varianceQty','cycleCounterId', 'statusId'];
        }
       if(js.pageflow == "Edit"){
        console.log("Edit")
      ...
      if(js.pageflow == "Display"){
        this.dataSource = new MatTableDataSource(this.code.perpetualLine);
        this.pageTitle = this.pageflow;
        this.displayedColumns = ['no', 'itemCode', 'itemDesc', 'manufacturerPartNo', 'storageSectionId', 'storageBin', 'packBarcodes', 'stockTypeId', 'inventoryQuantity', 'countedQty', 'varianceQty','cycleCounterId','statusId','countedOn'];
      }
        this.dataSource.paginator = this.paginator;
        this.dataSource.sort = this.sort;
      });
