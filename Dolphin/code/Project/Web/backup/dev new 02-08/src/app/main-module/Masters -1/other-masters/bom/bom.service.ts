...
export class BOMService {
  ...
  GetitemcodeNew(obj: any = { warehouseId: [this.auth.warehouseId] }) {
    return this.http.post<any>('/wms-masters-service/imbasicdata1/findImBasicData1New', obj);
  }
  ...
  DeleteLine(bomNumber: any,childItemCode: any,companyCode: any,languageId: any,plantId: any,warehouseId: any) {
    return this.http.delete<any>(this.apiName + `bomline/` + bomNumber + '?childItemCode=' + childItemCode + '&companyCode=' + companyCode + '&languageId=' + languageId + '&plantId=' + plantId + '&warehouseId=' + warehouseId);
  }
}
