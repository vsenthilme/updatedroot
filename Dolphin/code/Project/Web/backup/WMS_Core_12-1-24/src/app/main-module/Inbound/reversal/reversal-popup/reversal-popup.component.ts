...
screenid=3056;
  ...
  reverse() {
    ...
    this.spin.show();
    this.sub.add(this.service.reverse(this.refDocNumber, this.packBarcodes,this.auth.companyId,this.auth.plantId,this.auth.warehouseId,this.auth.languageId).subscribe(res => {
      this.spin.hide();
