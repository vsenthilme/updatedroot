...
import { InhouseTransferService } from "../../make&change/inhouse-transfer/inhouse-transfer.service";
  ...
  export class TransferReportComponent implements OnInit {
    ...
    @ViewChild('transferTag') transferTag: Table | any;
     ...
     selectedwarehouse:any[]=[];
      ...
      filtersearch(){
        if(this.searhform.controls.endConfirmedOn.value == null || this.searhform.controls.endConfirmedOn.value == undefined || !this.searhform.controls.endConfirmedOn.value){
  ...
  obj.stockTypeId=this.targetStockTypeId;
        ...
        this.sub.add(this.transferService.searchTransferLine(this.searhform.getRawValue()).subscribe(res => {
