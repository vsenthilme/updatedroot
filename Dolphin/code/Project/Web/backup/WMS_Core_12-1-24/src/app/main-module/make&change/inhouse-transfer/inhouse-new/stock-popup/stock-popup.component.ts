...
export class StockPopupComponent implements OnInit {
  ...
  load(sourceItemCode: any) {
    ...
    obj.itemCode = [this.sourceItemCode];
    obj.stockTypeId = [this.sourceStockTypeId];
  ...
  save() {
    ...
    obj.warehouseId = this.auth.warehouseId;
    obj.languageId = this.auth.languageId;
    obj.sourceItemCode= this.sourceItemCode;
    obj.targetItemCode= this.targetItemCode; 
    obj.targetStockTypeId= this.targetStockTypeId; 
    obj.sourceStockTypeId= this.sourceStockTypeId ;

    this.data.inhouseTransferLine.push(obj);
