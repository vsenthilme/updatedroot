...
export class InhouseLinesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    obj.transferNumber = [this.data],

    this.transferService.searchTransferLine(obj).subscribe(res => {
  ...
  constructor(public dialogRef: MatDialogRef<any>, 
    ...
    private service: ReportsService, private transferService: InhouseTransferService) { }
