...
export class OrderStatusComponent implements OnInit {
  ...
  @ViewChild('inboundTag') inboundTag: Table | any;
    ...
    filtersearch() {
      this.selectedItems=this.auth.warehouseId;
      ...
      if ((this.selectedItems != null && this.selectedItems != undefined && this.selectedItems.length > 0) &&
        ...
        this.toastr.error("Please fill the required fields. Required fields Delivered Date To Continue", "", {
          timeOut: 2000,
          progressBar: false,
        });
      }
    ...
    dropdownfill() {
      ...
      forkJoin({
        ...
        .subscribe(({ warehouse }) => {
          ...
          this.multiStatusList.push({ item_id: 'Delivered', item_text: 'DELIVERED' }, { item_id: 'Partial', item_text: 'IN PROGRESS' }, { item_id: 'Unfulfilled', item_text: 'NOT FULFILLED' });
