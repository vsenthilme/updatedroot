...
export class PhysicalAssignComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'no','warehouseId', 'itemCode', 'referenceField8', 'referenceField9', 'referenceField10', 'storageBin', 'packBarcodes', 'stock', 'inventoryQuantity', 'countedQty', 'varianceQty', 'countedBy', 'cycleCounterId', 'countedOn', 'statusId',];
  ...
  ngOnInit(): void {
    ...
    if(this.data.type == 'Display'){
      this.displayedColumns = [ 'no','warehouseId', 'itemCode', 'referenceField8', 'referenceField9', 'referenceField10', 'storageBin', 'packBarcodes', 'stock',  'inventoryQuantity', 'countedQty', 'countedBy', 'cycleCounterId', 'countedOn', 'statusId'];
    ...
    if(this.data.type == "Assign"){
      ...
      this.displayedColumns = ['select', 'no','warehouseId', 'itemCode', 'referenceField8', 'referenceField9', 'referenceField10', 'storageBin', 'packBarcodes', 'stock', 'cycleCounterId','statusId'];
    }
    ...
    this.displayedColumns = ['select', 'no','warehouseId', 'itemCode', 'referenceField8', 'referenceField9', 'referenceField10', 'storageBin', 'packBarcodes', 'stock', 'inventoryQuantity', 'countedQty','countedBy',  'varianceQty','cycleCounterId', 'statusId'];
    }
...
confirmValidate(){
  ...
  confirmNew(){
    this.selectedCountedQty.filter(x => x.companyCodeId = x.companyCode);
    // if (this.selectedCountedQty.length == 0) {
    //   this.toastr.error(
    //     "Please select a line to confirm",
    //     "Notification"
