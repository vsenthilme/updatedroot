...
export class PerpetualTabComponent implements OnInit {
  ...
  link = [
    { url: "/main/cycle-count/Prepetual-main/count", title: "Perpetual Creation",screenid:3071,  class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
    { url: "/main/cycle-count/varianceConfirm", title: "Variance Analysis", screenid:3074,class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
 ];
