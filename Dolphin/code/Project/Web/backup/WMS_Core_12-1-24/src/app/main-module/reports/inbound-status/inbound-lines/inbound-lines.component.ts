...
export class InboundLinesComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.spin.show();
    this.sub.add(this.service.Get(this.data.warehouseId, this.data.preInboundNo, this.data.refDocNumber, this.auth.companyId ,this.auth.languageId, this.auth.plantId).subscribe(res => {
