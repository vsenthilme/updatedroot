...
export class PickingService {
  ...
  searchSpark(obj: any) {
    return this.http.post<any>( '/wms-spark-service/pickupHeader', obj);
  }
  ...
  getadditionalBins(itemCode: any, obOrdertypeId: any, warehouseId: any, proposedPackBarCode: any, proposedStorageBin: any) {
    return this.http.get<any>(this.apiName + 'pickupline/additionalBins?itemCode=' + itemCode + '&obOrdertypeId=' + obOrdertypeId + '&proposedStorageBin=' + proposedStorageBin + '&proposedPackBarCode=' + proposedPackBarCode + '&warehouseId=' + this.auth.warehouseId + '&companyCode='+ this.auth.companyId +'&plantId='+ this.auth.plantId +'&languageId='+ this.auth.languageId);
  }
  confirm(obj: any) {
