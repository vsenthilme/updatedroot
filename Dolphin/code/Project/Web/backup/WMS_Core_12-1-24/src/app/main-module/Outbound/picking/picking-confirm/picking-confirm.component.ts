  ...
  fill(data: any) {
    ...
    if (data.pageflow != 'New') {
      ...
      if (data.pageflow == 'Display') {
        ...
        obj.pickupNumber = [this.code.pickupNumber];
        this.sub.add(this.service.getpickingline(obj).subscribe(res => {
...
//end
        ...
        obj.plantId = [this.auth.plantId];
        obj.warehouseId = [this.auth.warehouseId];
        obj.warehouseId = [this.code.warehouseId], 
        obj.itemCode = [this.code?.itemCode],
        obj.stockTypeId = [this.code?.stockTypeId],
        obj.storageBin = [this.code?.proposedStorageBin],
        obj.packBarcodes = [this.code?.proposedPackBarCode],
        
        this.sub.add(this.service.GetInventory(obj).subscribe(res => {
          this.spin.hide();
