...
export class ConfirmEditComponent implements OnInit {
 ...
 this.form.controls.description.disable();
  ...
  if (this.data) {
    this.sub.add(this.service.updateinboundline(this.form.getRawValue(),this.form.controls.refDocNumber.value,this.form.controls.warehouseId.value,this.auth.companyId,this.form.controls.plantId.value,this.form.controls.languageId.value,this.form.controls.preInboundNo.value,this.form.controls.lineNo.value,this.form.controls.itemCode.value).subscribe(res => {
