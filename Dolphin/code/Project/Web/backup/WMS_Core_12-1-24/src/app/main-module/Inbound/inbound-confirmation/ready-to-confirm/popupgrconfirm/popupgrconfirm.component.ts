...
export class PopupgrconfirmComponent implements OnInit {
  ...
  if (this.data) {
    this.sub.add(this.service.updateinboundHeader(this.form.getRawValue(),this.form.controls.refDocNumber.value,this.form.controls.warehouseId.value,this.auth.companyId,this.form.controls.plantId.value,this.form.controls.languageId.value,this.form.controls.preInboundNo.value).subscribe(res => {
