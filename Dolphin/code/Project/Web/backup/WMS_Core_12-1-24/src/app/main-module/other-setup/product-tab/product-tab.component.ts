...
export class ProductTabComponent implements OnInit {
  ...
  link = [
    { url: "/main/otherSetup/itemtype", title: "Item Type", screenid: 3137, class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
    { url: "/main/otherSetup/itemgroup", title: "Item Group",screenid: 3138,  class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
    { url: "/main/otherSetup/subitemgroup", title: "Sub Item Group",screenid: 3139,  class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
    { url: "/main/otherSetup/variantid", title: "Variant",screenid: 3136,  class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
    { url: "/main/otherSetup/uom", title: "UOM",screenid: 3098,  class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
