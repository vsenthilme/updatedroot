...
export class HhtuserService {
  ...
  Get(code: string,warehouseId:any,plantId:any,companyCodeId:any,languageId:any,levelId:any) {
    return this.http.get<any>('/wms-idmaster-service/hhtuser/'+ code+'?warehouseId='+warehouseId+'&plantId='+plantId+'&companyCodeId='+companyCodeId+'&languageId='+languageId +'&levelId='+levelId);
  }
  Create(obj: any) {
