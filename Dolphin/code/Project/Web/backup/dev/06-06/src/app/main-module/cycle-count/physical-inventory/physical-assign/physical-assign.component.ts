...
export class PhysicalAssignComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'no', 'itemCode', 'referenceField8', 'referenceField9', 'referenceField10', 'storageBin', 'packBarcodes', 'stock', 'inventoryQuantity', 'countedQty', 'variance', 'countedBy', 'cycleCounterId', 'countedOn', 'statusId',];
  ...
  ngOnInit(): void {
    ...
    if(this.data.type == 'edit'){
      this.displayedColumns = ['select', 'no', 'itemCode', 'referenceField8', 'referenceField9', 'referenceField10', 'storageBin', 'packBarcodes', 'stock', 'countedBy', 'cycleCounterId', 'countedOn', 'statusId'];
    }
    if(this.data.type == "Assign"){
      ...
      this.displayedColumns = ['select', 'no', 'itemCode', 'referenceField8', 'referenceField9', 'referenceField10', 'storageBin', 'packBarcodes', 'stock', 'countedBy', 'cycleCounterId','statusId'];
    }
    if(this.data.type == "count"){
      ...
      this.data.periodicHeaderData.periodicLine.forEach(element => {
        if(element.cycleCounterId && element.statusId == 72){
          ...
          console.log(this.filterCountLines);
        }
      });
    this.dataSource = new MatTableDataSource(this.filterCountLines);
    this.displayedColumns = ['select', 'no', 'itemCode', 'referenceField8', 'referenceField9', 'referenceField10', 'storageBin', 'packBarcodes', 'stock', 'inventoryQuantity', 'countedQty', 'variance','cycleCounterId', 'statusId'];
    }
