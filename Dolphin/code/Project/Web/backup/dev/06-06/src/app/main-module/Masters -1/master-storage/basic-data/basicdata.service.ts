...
export class BasicdataService {
  ...
  Get1(code: string, warehouseId:any) {
    return this.http.get<any>(this.apiName + `storagebin/` + code + `/warehouseId?` + 'warehouseId=' + warehouseId);
  }
  ...
  Delete(code: any) {
    return this.http.delete<any>(this.apiName + `storagebin/` + code);
  }
  GetWh() {
