...
export class PackingMaterialService {
  ...
  Get(code: string) {
    return this.http.get<any>(this.apiName + `packingmaterial/` + code);
  }
  Create(obj: PackingmaterialElement) {
    return this.http.post<any>(this.apiName + `packingmaterial`, obj);
  }
  Update(obj: PackingmaterialElement, code: any) {
    return this.http.patch<any>(this.apiName + `packingmaterial/` + code, obj);
  }
  Delete(packingMaterialNo: any) {
    return this.http.delete<any>(this.apiName + `packingmaterial/` + '?packingMaterialNo=' + packingMaterialNo  );
  }
