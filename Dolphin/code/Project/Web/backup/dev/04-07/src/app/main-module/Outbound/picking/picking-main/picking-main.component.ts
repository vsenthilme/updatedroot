...
export class PickingMainComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'actions1', 'referenceField7', 'refDocNumber', 'outboundOrderTypeId','referenceField1', 'lineNumber', 'itemCode', 'proposedPackBarCode', 'proposedStorageBin','assignedPickerId','partnerCode', 'pickToQty', 'pickupCreatedOn',];
