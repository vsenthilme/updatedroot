...
import  { stockElement, StocksampleService }  from "../stocksamplereport/stocksample.service";
  ...
  export class ContainerReportComponent implements OnInit {
    ...
    displayedColumns: string[] = ['select', 'warehouseId', 'referenceField7',  'containerNo', 'containerReceiptNo', 'refDocNumber','containerType','origin','partnerCode', 'createdBy', 'referenceField2','referenceField5'];
