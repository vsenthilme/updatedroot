...
export class ReportsService {
  ...
  searchSpark(obj: any) {
    return this.http.post<any>('/mnr-spark-service/inventorymovement/findInventoryMovement', obj);
  }
  ...
  getInventoryMovementSpark(obj: any) {
    return this.http.post<any>('/mnr-spark-service/inventorymovement/findInventoryMovement', obj);
  }
  ...
  getInventoryMovement1(obj: any,) {
    return this.http.get<any>('/wms-transaction-service/inventorymovement/' + obj.movementType +'?batchSerialNumber=' + 1 +  '&itemCode=' + obj.itemCode + '&movementDocumentNo=' + obj.movementDocumentNo + '&packBarcodes=' + obj.packBarcodes +  '&submovementType=' + obj.submovementType + '&warehouseId=' + obj.warehouseId);
  }
