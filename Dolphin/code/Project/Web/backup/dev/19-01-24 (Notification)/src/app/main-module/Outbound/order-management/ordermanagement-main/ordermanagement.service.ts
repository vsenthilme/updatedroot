...
export class OrdermanagementService {
  ...
  searchLineNew(obj: any) {
    return this.http.post<any>(this.url + '/findOrderManagementLineNew', obj);
  }
  searchLineSpark(obj: any) {
    return this.http.post<any>('/mnr-spark-service/ordermanagementline/findOrderManagementLineNew', obj);
  }
  ...
  allocateBatch(obj: any) {
    return this.http.patch<any>('/wms-transaction-service/ordermanagementline/allocate/patch', obj);
  }
  unallocateBatch(obj: any) {
    return this.http.patch<any>('/wms-transaction-service/ordermanagementline/unallocate/patch', obj);
  }
}
