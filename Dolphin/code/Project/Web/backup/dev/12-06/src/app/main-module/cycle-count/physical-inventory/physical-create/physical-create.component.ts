...
export class PhysicalCreateComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'no', 'product', 'referenceField8', 'referenceField9', 'referenceField10', 'bin', 'pallet', 'stock', 'inventory', 'uom', 'cycleCountTypeId',];
  ...
  ngOnInit(): void {
    ...
    if(this.data.pageflow == 'New'){
      this.displayedColumns = ['no', 'product', 'referenceField8', 'referenceField9', 'referenceField10', 'bin', 'pallet', 'stock', 'inventory', 'uom', 'cycleCountTypeId',];
    }
      ...
      result => {
        ...
        result.forEach(element => {
          ...
          if(element.inventoryQuantity > 0){
            console.log(element.inventoryQuantity)
