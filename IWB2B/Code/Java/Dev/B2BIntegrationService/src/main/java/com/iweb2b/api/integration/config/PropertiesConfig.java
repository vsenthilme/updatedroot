...
public class PropertiesConfig {
	...
	/*
	 * shopify.auth.access.token=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
	 * shopify.api.orders.get-all=https://turevaluekw.myshopify.com/admin/api/2024-01/orders.json
	 */
	@Value("${shopify.auth.access.token}")
	private String shopifyAuthAccessToken;
	
	@Value("${shopify.api.orders.get-all}")
	private String shopifyApiOrdersGetAll;
	...
	//-------------------FLOW-APIs---------------------------------------------------------------
	/*
	 * flow.shipsy.api.server=https://flowexpressdemo.customerportalnew.shipsy.io
