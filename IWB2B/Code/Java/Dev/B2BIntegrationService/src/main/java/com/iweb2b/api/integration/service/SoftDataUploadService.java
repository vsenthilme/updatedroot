...
public class SoftDataUploadService {
    ...
    public ConsignmentResponse createConsignmentNew(Consignment newConsignment, String loginUserId) throws Exception {
        try {
            ...
            //Ali Al Ghanim & Sons
            if (newConsignment.getCustomer_code() != null && newConsignment.getCustomer_code().equalsIgnoreCase(GNM_CUST_CODE)) {
                if (newConsignment.getDestination_details() != null) {
                    newConsignment.getDestination_details().setCompany_name(newConsignment.getDestination_details().getDelivery());
                }
            }
            ...
            if (response != null) {
                ...
                if (createdConsignmentEntity.getCustomer_code() != null &&
                        (createdConsignmentEntity.getCustomer_code().equalsIgnoreCase(FLOW_LOG_CUST_CODE) ||
                                createdConsignmentEntity.getCustomer_code().equalsIgnoreCase(FLOW_LOG_CUST_CODE_TO))) {
    ...
    public void processShopifyOrders() {
        ...
        consignments.stream().forEach(o -> {
            ...
            if (referenceNumber == null) {
                ...
                ConsignmentEntity createdConsignmentEntity = createConsignmentInLocalNew(o, null, "From Shopify");
    ...
    public List<Consignment> prepareShopifyOrders() {
        ...
        if (orders != null) {
            for (Order o : orders) {
                ...
                newConsignment.setWeight(Double.valueOf(o.getTotal_weight()));
