...
import com.iweb2b.api.portal.model.auth.AuthToken;
import com.iweb2b.api.portal.model.auth.AuthTokenRequest;
import com.iweb2b.api.portal.model.auth.CustomerAccessToken;
import com.iweb2b.api.portal.repository.CustomerAccessTokenRepository;
...
public class CommonService {
	...
	@Autowired
	CustomerAccessTokenRepository customerAccessTokenRepository;
...
//		String accessTokenUrl = apiUrl;
	 ...
	 * @return
	 */
	public CustomerAccessToken generateToken (String customerName) {
		String encodedToken = PasswordEncoder.generateToken(customerName);
		CustomerAccessToken customerAccessToken = new CustomerAccessToken();
		customerAccessToken.setCustomerName(customerName);
		customerAccessToken.setToken(encodedToken);
		customerAccessToken = customerAccessTokenRepository.save(customerAccessToken);
	 ...
	 * @return
	 */
	public CustomerAccessToken getCustomerToken (String token) {
		CustomerAccessToken customerAccessToken = customerAccessTokenRepository.findByToken(token);
		return customerAccessToken;
	}
