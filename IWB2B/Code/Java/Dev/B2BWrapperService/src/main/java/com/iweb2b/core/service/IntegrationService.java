...
public class IntegrationService {
	...
	// GET
	public ConsignmentTracking getFlowConsignmentTrackingByRefNumber(String referenceNumber) {
		try {
			AuthToken integAuthToken = authTokenService.getIntegrationServiceAuthToken();
			String authToken = integAuthToken.getAccess_token();
			...
			headers.add("Authorization", "Bearer " + authToken);
			UriComponentsBuilder builder =
					UriComponentsBuilder.fromHttpUrl(getB2bintegrationServiceUrl() + "consignment/" + referenceNumber + "/flow/shipment");
			HttpEntity<?> entity = new HttpEntity<>(headers);
			ResponseEntity<ConsignmentTracking> result =
					getRestTemplate().exchange(builder.toUriString(), HttpMethod.GET, entity, ConsignmentTracking.class);
			return result.getBody();
	...
	// POST
	public JNTResponse postConsignmentWebhookPayloadForFlowLog(ConsignmentWebhook consignmentWebhook) {
		AuthToken integAuthToken = authTokenService.getIntegrationServiceAuthToken();
		String authToken = integAuthToken.getAccess_token();
		...
		headers.add("User-Agent", "RestTemplate");
		headers.add("Authorization", "Bearer " + authToken);
		UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getB2bintegrationServiceUrl() + "consignment/flow/webhook");
	...
	// POST
	public JNTResponse postEPConsignmentWebhookPayload(ConsignmentWebhook consignmentWebhook) {
		AuthToken integAuthToken = authTokenService.getIntegrationServiceAuthToken();
		String authToken = integAuthToken.getAccess_token();
		...
		headers.add("User-Agent", "RestTemplate");
		headers.add("Authorization", "Bearer " + authToken);
		UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getB2bintegrationServiceUrl() + "consignment/ep/webhook");
	 ...
	 * @return
	 */
	public byte[] getFlowShippingLabel(String referenceNumber) {
		try {
			AuthToken integAuthToken = authTokenService.getIntegrationServiceAuthToken();
			String authToken = integAuthToken.getAccess_token();
			...
			headers.add("Authorization", "Bearer " + authToken);
			UriComponentsBuilder builder =
					UriComponentsBuilder.fromHttpUrl(getB2bintegrationServiceUrl() + "consignment/" + referenceNumber + "/flow/shippingLabel");
			HttpEntity<?> entity = new HttpEntity<>(headers);
			ResponseEntity<byte[]> result =
					getRestTemplate().exchange(builder.toUriString(), HttpMethod.GET, entity, byte[].class);
			return result.getBody();
	...
	public CancelResponse cancelShipment (CancelShipmentRequest cancelShipmentRequest) {
		...
		ResponseEntity<CancelResponse> result =
				getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, CancelResponse.class);
		return result.getBody();
	}
	
	// POST
	public CancelResponse flowCancelShipment (CancelShipmentRequest cancelShipmentRequest) {
		AuthToken integAuthToken = authTokenService.getIntegrationServiceAuthToken();
		String authToken = integAuthToken.getAccess_token();
		...
		headers.add("User-Agent", "RestTemplate");
		headers.add("Authorization", "Bearer " + authToken);
		UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getB2bintegrationServiceUrl() + "consignment/flow/cancel");
	...
	public ConsignmentResponse createConsignmentNonBOQ (Consignment newConsignment, String loginUserID) {
		...
		headers.add("User-Agent", "RestTemplate");
		headers.add("Authorization", "Bearer " + authToken);
		UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getB2bintegrationServiceUrl() + "softDataUpload/order/non-boq")
	...
	// GET
	public CustomerAccessToken generateToken(String customerName, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "RestTemplate");
			headers.add("Authorization", "Bearer " + authToken);
			UriComponentsBuilder builder =
					UriComponentsBuilder.fromHttpUrl(getB2bintegrationServiceUrl() + "softDataUpload/generate-token")
							.queryParam("customerName", customerName);
			HttpEntity<?> entity = new HttpEntity<>(headers);
			ResponseEntity<CustomerAccessToken> result =
					getRestTemplate().exchange(builder.toUriString(), HttpMethod.GET, entity, CustomerAccessToken.class);
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
			throw e;
	...
	// GET
	public CustomerAccessToken getCustomerToken(String token, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "RestTemplate");
			headers.add("Authorization", "Bearer " + authToken);
			UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getB2bintegrationServiceUrl() + "softDataUpload/token")
...
//	}
	...
	// POST - RescheduledDatesResponse
	public RescheduledDatesResponse getRescheduledDates(RescheduledDatesRequest rescheduledDatesRequest) {
		AuthToken integAuthToken = authTokenService.getIntegrationServiceAuthToken();
		String authToken = integAuthToken.getAccess_token();
		...
		headers.add("Authorization", "Bearer " + authToken);
		UriComponentsBuilder builder = 
				UriComponentsBuilder.fromHttpUrl(getB2bintegrationServiceUrl() + "consignment/rescheduled-dates");
		HttpEntity<?> entity = new HttpEntity<>(rescheduledDatesRequest, headers);
		ResponseEntity<RescheduledDatesResponse> result =
				getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, RescheduledDatesResponse.class);
		return result.getBody();
	}

	// PATCH - AddressUpdateResponse
	public AddressUpdateResponse addressUpdate(AddressUpdateRequest addressUpdateRequest) throws Exception {
		try {
			AuthToken integAuthToken = authTokenService.getIntegrationServiceAuthToken();
			String authToken = integAuthToken.getAccess_token();
			...
			headers.add("Authorization", "Bearer " + authToken);
			UriComponentsBuilder builder = 
					UriComponentsBuilder.fromHttpUrl(getB2bintegrationServiceUrl() + "consignment/address");
			HttpEntity<?> entity = new HttpEntity<>(addressUpdateRequest, headers);
			ResponseEntity<AddressUpdateResponse> result =
					getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, AddressUpdateResponse.class);
			return result.getBody();
	...
	public WillingnessResponse willingnessUpdate(Willingness willingness) {
		...
		headers.add("Authorization", "Bearer " + authToken);
		UriComponentsBuilder builder = 
				UriComponentsBuilder.fromHttpUrl(getB2bintegrationServiceUrl() + "consignment/willingness");
		HttpEntity<?> entity = new HttpEntity<>(willingness, headers);
		ResponseEntity<WillingnessResponse> result =
				getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, WillingnessResponse.class);
		return result.getBody();
	}
}