...
import com.iweb2b.api.portal.repository.*;
...
import com.iweb2b.api.portal.config.PropertiesConfig;
...
import com.iweb2b.api.portal.model.consignment.dto.ConsignmentResponse;
import com.iweb2b.api.portal.model.consignment.dto.ConsignmentWebhook;
...
import com.iweb2b.api.portal.model.consignment.dto.Items;
import com.iweb2b.api.portal.model.consignment.dto.JNTResponse;
import com.iweb2b.api.portal.model.consignment.dto.OrderStatusUpdate;
import com.iweb2b.api.portal.model.consignment.dto.OrderStatusUpdateResponse;
import com.iweb2b.api.portal.model.consignment.dto.Pieces_Details;
import com.iweb2b.api.portal.model.consignment.dto.Receiver;
import com.iweb2b.api.portal.model.consignment.dto.Sender;
import com.iweb2b.api.portal.model.consignment.dto.jnt.Details;
import com.iweb2b.api.portal.model.consignment.dto.jnt.JNTOrderCreate;
import com.iweb2b.api.portal.model.consignment.dto.jnt.JNTOrderCreateRequest;
import com.iweb2b.api.portal.model.consignment.dto.jnt.JNTPrintLabelBzContent;
...
import com.iweb2b.api.portal.model.consignment.dto.qp.QPOrder;
import com.iweb2b.api.portal.model.consignment.dto.qp.QPOrderCreateResponse;
import com.iweb2b.api.portal.model.consignment.dto.qp.QPToken;
import com.iweb2b.api.portal.model.consignment.dto.qp.QPTokenResponse;
import com.iweb2b.api.portal.model.consignment.dto.qp.QPTrackingRequest;
import com.iweb2b.api.portal.model.consignment.dto.qp.QPTrackingResponse;
...
import com.iweb2b.api.portal.model.tracking.ConsignmentTracking;
import com.iweb2b.api.portal.repository.ConsignmentRepository;
import com.iweb2b.api.portal.repository.ConsignmentWebhookRepository;
import com.iweb2b.api.portal.repository.JNTFailureResponseRepository;
import com.iweb2b.api.portal.repository.JNTWebhookRepository;
import com.iweb2b.api.portal.repository.PocImageListRepository;
import com.iweb2b.api.portal.repository.QualityCheckImageListRepository;
import com.iweb2b.api.portal.repository.Specification.ConsignmentSpecification;
import com.iweb2b.api.portal.util.CommonUtils;
import com.iweb2b.api.portal.util.DateUtils;
import com.iweb2b.api.portal.util.JsonConvertor;
import com.iweb2b.api.portal.util.MD5Utils;
...
//    }
    ...
    public List<ConsignmentImpl> findConsignment(FindConsignment findConsignment) throws Exception {
        ...
        if (findConsignment.getFromDate() != null && findConsignment.getToDate() != null) {
            Date[] dates = DateUtils.addTimeToDatesForSearch(findConsignment.getFromDate(), findConsignment.getToDate());
...
//                    log.info("scan type: " + findConsignment.getScanType());
//                }
//            }
//        }
        ...
        List<ConsignmentImpl> results = null;

        if(findConsignment.getScanType() != null) {
            results = consignmentRepository.findConsignment(findConsignment.getAwb_3rd_Party(),
        ...
        if(findConsignment.getScanType() == null) {
            results = consignmentRepository.findConsignmentWithScanTypeNull(findConsignment.getAwb_3rd_Party(),
                    findConsignment.getBoutiqaatPushStatus(),
                    findConsignment.getConsignmentId(),
                    findConsignment.getConsignment_type(),
                    findConsignment.getCustomer_civil_id(),
