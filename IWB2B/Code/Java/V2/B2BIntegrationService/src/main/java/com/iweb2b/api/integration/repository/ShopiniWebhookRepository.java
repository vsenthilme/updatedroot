...
public interface ShopiniWebhookRepository extends JpaRepository<ShopiniWebhook, Long>, StreamableJpaSpecificationRepository<ShopiniWebhook> {
	...
	public List<ShopiniWebhook> findByTrackingNoAndItemActionNameInAndLmdStatusOrderByActionDate(String trackingNo, List<String> itemActionName, Long lmdStatus);
