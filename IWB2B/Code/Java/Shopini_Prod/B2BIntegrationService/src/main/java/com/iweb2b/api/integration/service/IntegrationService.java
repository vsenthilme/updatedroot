...
import com.iweb2b.api.integration.model.consignment.dto.jnt.*;
import com.iweb2b.api.integration.model.consignment.dto.qp.*;
import com.iweb2b.api.integration.model.consignment.dto.shopini.CancelResponse;
import com.iweb2b.api.integration.model.consignment.dto.shopini.*;
...
//			                        ConsignmentEntity createdConsignmentEntity = softDataUploadService.createConsignmentInLocal(consignment, "From Shipsy");
			                        ...
			                        ConsignmentEntity newlyCreatedConsignmentEntity =
			                                softDataUploadService.updateQPConsignment(newConsignmentWebhook.getReference_number(),
			                                		newConsignmentWebhook.getReference_number(), QAP_HUBCODE);
...
//        List<ParcelBox> parcel_box_list = new ArrayList<>(); 
        for (Pieces_Details pieces_detail : dbConsignment.getPieces_detail()) {
            ...
            if (pieces_detail.getDeclared_value() != null) {
                ...
                parcel_box.setValue_of_goods(Double.valueOf(dbConsignment.getDeclared_value()));
            }
