...
export class JntTabComponent implements OnInit {
  ...
  link = [
    { url: "/main/jntOrders/qatarPost", title: "Qatar Post", screenid: 3082, icon: "fas fa-truck font_1-5 me-2", class: "mx-1 hovertab  d-flex justify-content-center align-items-center" },
    ...
    { url: "/main/jntOrders/shopini", title: "Shopini", screenid: 3082, icon: "fas fa-truck font_1-5 me-2", class: "mx-1 hovertab  d-flex justify-content-center align-items-center" },
 ];
