...
export class JntOrdersService {
  ...
  getAll(){
    ...
    getAllOrder(orderType){
    return this.http.get<any>('/iwe-user-service/softdata/' + orderType + '/orders'); // + '?referenceNumber=' + referenceNumber
  }
  getAll1(){
  ...
  findConsignmentSpark(obj: any) {
    return this.http.post<any>('/b2b-spark-service/jntHubCode', obj);
  }

  findQatarPost(obj :any){
    return this.http.post<any>('/b2b-spark-service/qpwebhook', obj)
  }
  findShopiniWebhook(obj :any){
    return this.http.post<any>('/iwe-user-service/softdata/findShopiniWebhook', obj)
  }
}
