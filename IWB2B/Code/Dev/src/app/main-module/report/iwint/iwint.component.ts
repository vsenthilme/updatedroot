...
@Component({
  selector: 'app-iwint',
  templateUrl: './iwint.component.html',
  styleUrls: ['./iwint.component.scss']
})
export class IwintComponent implements OnInit {
...
filterValue: any[] = [];
  getAll(){
    ...
    this.sub.add(this.service.getAll().subscribe((res: any[]) => {
      ...
      res.forEach(x => {
        if(x.customer_code == "IWINTL" && x.orderType == "1"){
...
this.cs.commonerror(err);
  ...
  downloadExcel() {
    ...
    this.cs.exportAsExcel(res, "IWINTL Orders");
  }
