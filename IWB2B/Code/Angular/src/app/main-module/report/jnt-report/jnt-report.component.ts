...
@Component({
  selector: 'app-jnt-report',
  templateUrl: './jnt-report.component.html',
  styleUrls: ['./jnt-report.component.scss']
})
export class JntReportComponent implements OnInit {
...
filterValue: any[] = [];
  getAll(){
    ...
    this.sub.add(this.service.getAll().subscribe((res: any[]) => {
      ...
      res.forEach(x => {
        if(x.awb_3rd_Party != null && x.orderType == "1"){
