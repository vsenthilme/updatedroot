...
import { ConsignmentNewService } from '../consignment-new/consignment-new.service';
...
export class ConsignmentHistoryComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog,    private router: Router, public spinner: NgxSpinnerService,public customerService: ConsignmentHistoryService,public cs: CommonService, private messageService: MessageService) { 
