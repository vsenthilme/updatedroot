...
public class AuthTokenService {
	...
	private AuthToken generateOAuthToken(String apiUrl, String clientId, String clientSecretKey, String grantType,
		...
		if (apiUrl.equalsIgnoreCase("mv-master-service")) {
			accessTokenUrl = propertiesConfig.getMasterAccessTokenUrl();
		} else {
			throw new BadRequestException("The give URL is not available. Quiting");
		}
