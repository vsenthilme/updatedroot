...
@Table(
		...
		uniqueConstraints = { 
				@UniqueConstraint (
						name = "unique_key_levelid", 
						columnNames = {"C_ID", "PLANT_ID", "WH_ID", "LEVEL_ID", "LANG_ID"})
				}
		)
@IdClass(LevelIdCompositeKey.class)
public class LevelId { 
	...
	@Column(name = "LEVEL_REF",columnDefinition = "nvarchar(50)")
