...
@Table(
		...
		uniqueConstraints = { 
				@UniqueConstraint (
						...
						columnNames = {"C_ID", "PLANT_ID", "WH_ID", "STR_TYP_ID", "ST_NO", "LANG_ID"})
				}
		)
@IdClass(StrategyIdCompositeKey.class)
public class StrategyId { 
	...
	@Id
	@Column(name = "ST_NO",columnDefinition = "nvarchar(50)")
	...
	@Column(name = "STR_TYP_TEXT",columnDefinition = "nvarchar(50)")
	private String strategyTypeText;
	
	@Column(name = "ST_NO_TEXT",columnDefinition = "nvarchar(50)")
