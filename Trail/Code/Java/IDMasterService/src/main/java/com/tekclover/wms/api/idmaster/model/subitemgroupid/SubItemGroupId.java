...
@NoArgsConstructor
/*
 * `C_ID`, `PLANT_ID`, `WH_ID`, `ITM_TYP_ID`, `ITM_GRP_ID`, `SUB_ITM_GRP_ID`,  `LANG_ID`
 */
@Table(
		...
		uniqueConstraints = { 
				@UniqueConstraint (
						...
						columnNames = {"C_ID", "PLANT_ID", "WH_ID", "ITM_TYP_ID", "ITM_GRP_ID", "SUB_ITM_GRP_ID", "LANG_ID"})
				}
		)
...
public class SubItemGroupId { 
	...
	@Column(name = "SUB_ITM_GRP",columnDefinition = "nvarchar(200)")
	private String subItemGroup;

	@Column(name = "SUB_ITM_GRP_TEXT",columnDefinition = "nvarchar(500)")
	...
	@Column(name="ITEM_GROUP_ID_DESC",columnDefinition = "nvarchar(500)")
