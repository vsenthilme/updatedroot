 ...
 */
@Table(
		name = "tblstorageclassid", 
		uniqueConstraints = { 
				@UniqueConstraint (
						name = "unique_key_storageclassid", 
						columnNames = {"C_ID", "PLANT_ID", "WH_ID", "ST_CL_ID", "LANG_ID"})
				}
		)
@IdClass(StorageClassIdCompositeKey.class)
public class StorageClassId { 
	...
	@Column(name = "ST_CL_TEXT",columnDefinition = "nvarchar(500)")
