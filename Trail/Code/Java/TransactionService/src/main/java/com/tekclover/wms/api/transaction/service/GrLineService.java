    ...
    public void assignBinner (String companyCode, String plantId, String languageId, String warehouseId, String parentProductionOrderNo) throws Exception {
        try {
            ...
            Warehouse entWarehouse =
                    enterpriseSetupService.getWarehouse(warehouseId, companyCode,
                            plantId, languageId, authTokenForEnterpriseSetupService.getAccess_token());
...
//            inventory.setPackBarcodes(createdGRLine.getPackBarcodes());
     ...
     * @throws Exception
     */
    public void createPutAwayHeaderFromInboundQualityLine(FetchImpl fetch) throws Exception {
        try {
            ...
            if (grLines != null && !grLines.isEmpty()) {
                for(GrLineV2 grLine : grLines) {
                    ...
                    createPutAwayHeaderNonCBMV2(grLine, fetch.getLoginUserID());
                }
            }
        } catch (Exception e) {
            log.error("Exception while PutAwayHeader Create : " + e.toString());
    ...
    private void createInboundQualityHeader(GrLineV2 createdGRLine, String loginUserID) {
        com.tekclover.wms.api.transaction.model.inbound.inboundquality.InboundQualityHeader inboundQualityHeader = new InboundQualityHeader();
        ...
        inboundQualityHeaderService.createInboundQualityHeader(inboundQualityHeader, loginUserID);
    }
}