	...
	public List<StagingLineEntityV2> caseConfirmationV3(List<CaseConfirmation> caseConfirmations, String caseCode,
		...
		try {
			...
			if (updatedStagingLineEntityList != null && !updatedStagingLineEntityList.isEmpty()) {
                ...
                Long orderCount = grHeaderV2Repository.getObOrderHeaderCountV3(createdGrHeader.getCompanyCode(), createdGrHeader.getPlantId(), createdGrHeader.getParentProductionOrderNo());
...
//	        Double cbmPerQty = 0D;
	        ...
	        for (StagingLineEntityV2 dbStagingLine : stagingLineEntityList) {
                ...
                com.tekclover.wms.api.transaction.model.enterprise.Warehouse updateCounterValue = new com.tekclover.wms.api.transaction.model.enterprise.Warehouse();
                updateCounterValue.setNoAisles(counter);
                com.tekclover.wms.api.transaction.model.enterprise.Warehouse updatedWarehouse =
