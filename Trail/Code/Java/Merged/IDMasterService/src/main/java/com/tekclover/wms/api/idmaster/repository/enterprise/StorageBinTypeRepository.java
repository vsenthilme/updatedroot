...
public interface StorageBinTypeRepository extends JpaRepository<StorageBinType, Long>, JpaSpecificationExecutor<StorageBinType> {
    ...
    public Optional<StorageBinType> findByLanguageIdAndCompanyIdAndPlantIdAndWarehouseIdAndStorageTypeIdAndStorageClassIdAndStorageBinTypeIdAndDeletionIndicator(
