 ...
 */
@Table(
		name = "tblapprovalprocessid",
		uniqueConstraints = { 
				@UniqueConstraint (
						name = "unique_key_approvalprocessid",
						columnNames = {"C_ID", "PLANT_ID", "WH_ID", "APP_PROCESS_ID", "LANG_ID"})
				}
		)
@IdClass(ApprovalProcessIdCompositeKey.class)
