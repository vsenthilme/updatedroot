 ...
 */
@Table(
		name = "tblcontrolprocessid",
		uniqueConstraints = { 
				@UniqueConstraint (
						name = "unique_key_controlprocessid",
						columnNames = {"C_ID", "PLANT_ID", "WH_ID", "CTRL_PROCESS_ID", "LANG_ID"})
				}
		)
@IdClass(ControlProcessIdCompositeKey.class)
public class ControlProcessId {
	...
	@Id
	@Column(name = "CTRL_PROCESS_ID", columnDefinition = "nvarchar(50)")
	...
	@Column(name = "CTRL_PROCESS", columnDefinition = "nvarchar(500)")
