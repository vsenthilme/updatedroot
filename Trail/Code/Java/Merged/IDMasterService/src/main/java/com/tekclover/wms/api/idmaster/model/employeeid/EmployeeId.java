...
@Table(
		...
		uniqueConstraints = { 
				@UniqueConstraint (
						name = "unique_key_employeeid",
						columnNames = {"C_ID", "PLANT_ID", "WH_ID", "EMP_ID", "LANG_ID"})
				}
		)
...
public class EmployeeId {
	...
	@Id
	@Column(name = "EMP_ID", columnDefinition = "nvarchar(50)")
	...
	@Column(name = "EMP_NM", columnDefinition = "nvarchar(500)")
