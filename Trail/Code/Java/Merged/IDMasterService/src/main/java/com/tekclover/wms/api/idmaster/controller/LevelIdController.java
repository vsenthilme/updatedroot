...
//	}
	...
	public ResponseEntity<?> postLevelId(@Valid @RequestBody AddLevelId newLevelId, 
		...
		notificationInput.setUserId(Arrays.asList(createdLevelId.getCreatedBy()));
		notificationInput.setUserType(null);
		notificationInput.setMessage("A new Level- " + createdLevelId.getLevel() + " has been created on ");
		notificationInput.setTopic("LevelId Create");
		notificationInput.setCreatedOn(createdLevelId.getCreatedOn());
		notificationInput.setCreatedBy(createdLevelId.getCreatedBy());
		notificationInput.setReferenceNumber(String.valueOf(createdLevelId.getLevelId()));
		notificationInput.setDocumentNumber(createdLevelId.getLevel());
