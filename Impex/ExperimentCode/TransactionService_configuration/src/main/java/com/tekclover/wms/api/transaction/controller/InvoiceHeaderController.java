...
public class InvoiceHeaderController {
    ...
    public ResponseEntity<?> patchInvoiceHeader(@PathVariable Long invoiceNumber, @RequestParam String languageId, @RequestParam String companyCodeId,
    ...
    public ResponseEntity<?> deleteInvoiceHeader(@PathVariable Long invoiceNumber, @RequestParam String languageId, @RequestParam String companyCodeId,
    ...
    @PostMapping("/find")
    public ResponseEntity<?> findInvoiceHeader(@RequestBody FindInvoiceHeader findInvoiceHeader) throws Exception {
        List<InvoiceHeader> createdInvoiceHeader = invoiceHeaderService.findInvoiceHeader(findInvoiceHeader);
        return new ResponseEntity<>(createdInvoiceHeader, HttpStatus.OK);
    }
}