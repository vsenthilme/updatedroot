...
public class ProformaInvoiceHeaderController {
    ...
    public ResponseEntity<?> getAll() {
        List<ProformaInvoiceHeader> ProformaInvoiceHeaderList =
                proformaInvoiceHeaderService.getProformaInvoiceHeaders();
    ...
    public ResponseEntity<?> patchProformaInvoiceHeader(@RequestParam String companyCodeId, @RequestParam String plantId, @RequestParam String languageId,
                                                        @RequestParam String warehouseId, @PathVariable Long proformaBillNo, @RequestParam String partnerCode,
    ...
    public ResponseEntity<?> deleteProformaInvoiceHeader(@PathVariable Long proformaBillNo, @RequestParam String companyCodeId, @RequestParam String plantId,
                                                         @RequestParam String languageId, @RequestParam String warehouseId, @RequestParam String partnerCode,
    ...
    @PostMapping("/find")
    public ResponseEntity<?> findProformaInvoiceHeader(@Valid @RequestBody FindProformaInvoiceHeader findProformaInvoiceHeader) throws Exception {
        List<ProformaInvoiceHeader> proformaInvoiceHeaderList = proformaInvoiceHeaderService.findProformaInvoiceHeader(findProformaInvoiceHeader);
        return new ResponseEntity<>(proformaInvoiceHeaderList, HttpStatus.OK);
    }
}