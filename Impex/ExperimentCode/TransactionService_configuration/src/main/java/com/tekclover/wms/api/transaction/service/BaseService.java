...
//            referenceDocumentType = "STOCKRECEIPTHEADER";
     ...
     * @return
     */
    public String getProfile(String companyCodeId, String plantId, String languageId, String warehouseId) {
        return stagingLineV2Repository.getProfile(companyCodeId, plantId, languageId, warehouseId);
    }
}