...
public class InboundOrderProcessingService extends BaseService {
     ...
     * @throws Exception
     */
    public InboundHeaderV2 processInboundReceivedV4(String refDocNumber, InboundIntegrationHeader inboundIntegrationHeader) throws Exception {
        ...
        try {
            ...
            Optional<PreInboundHeaderEntityV2> orderProcessedStatus = preInboundHeaderV2Repository.
                    findByRefDocNumberAndInboundOrderTypeIdAndDeletionIndicator(refDocNumber, inboundOrderTypeId, 0L);
        ...
        try {
            ...
            for (InboundIntegrationLine inboundIntegrationLine : inboundIntegrationHeader.getInboundIntegrationLine()) {
                ...
                if (bomHeader != null) {
                    ...
                    for (BomLine dbBomLine : bomLine) {
                        PreInboundLineEntityV2 preInboundLineEntity = createPreInboundLineBOMBasedV3(companyCodeId, plantId, languageId, warehouseId,
     ...
     * @throws Exception
     */
    private PreInboundLineEntityV2 createPreInboundLineBOMBasedV3(String companyCodeId, String plantId, String languageId, String warehouseId,
                                                                  String preInboundNo, InboundIntegrationHeader inboundIntegrationHeader,
                                                                  InboundIntegrationLine inboundIntegrationLine, BomLine bomLine, String MW_AMS,
     ...
     * @throws Exception
     */
    private PreInboundLineEntityV2 createPreInboundLineV3(String companyCodeId, String plantId, String languageId, String warehouseId,
                                                          String preInboundNo, InboundIntegrationHeader inboundIntegrationHeader,
                                                          InboundIntegrationLine inboundIntegrationLine, String MW_AMS,
                                                          IKeyValuePair description, Long statusId, String statusDesc, String masterAuthToken) throws Exception {
        try {
...
//                    newGrLine.setPackBarcode(newPackBarcode);
            ...
            putAwayHeaderV2Repository.saveAll(putAwayHeaderListWithBinner);
