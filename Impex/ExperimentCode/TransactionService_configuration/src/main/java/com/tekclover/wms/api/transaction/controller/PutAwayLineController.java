...
public class PutAwayLineController {
    ...
    public List<PutAwayLine> findPutAwayLine(@RequestBody SearchPutAwayLine searchPutAwayLine) throws Exception {
    ...
    public ResponseEntity<?> deletePutAwayLine(@PathVariable String confirmedStorageBin, @RequestParam String languageId, @RequestParam String companyCodeId,
                                               @RequestParam String plantId, @RequestParam String warehouseId, @RequestParam String goodsReceiptNo,
                                               @RequestParam String preInboundNo, @RequestParam String refDocNumber, @RequestParam String putAwayNumber,
                                               @RequestParam Long lineNo, @RequestParam String itemCode, @RequestParam String proposedStorageBin,
...
//        List<PutAwayLineV2> createdPutAwayLine = putawaylineService.putAwayLineConfirmV2(newPutAwayLine, loginUserID);
    ...
    @ApiOperation(response = PutAwayLineV2.class, value = "Create PutAwayLine V2") // label for swagger
    @PostMapping("/confirm/v3")
    public ResponseEntity<?> postPutAwayLineConfirmV3(@Valid @RequestBody List<PutAwayLineV2> newPutAwayLine,
                                                      @RequestParam String loginUserID) throws Exception {
        log.info("Request for putAwayLines to confirm : " + newPutAwayLine);
        List<PutAwayLineV2> createdPutAwayLine = putawaylineService.putAwayLineConfirmV3(newPutAwayLine, loginUserID);
        return new ResponseEntity<>(createdPutAwayLine, HttpStatus.OK);
    }

    @ApiOperation(response = PutAwayLineV2.class, value = "Search PutAwayLine V2") // label for swagger
    @PostMapping("/findPutAwayLine/v2")
    public List<PutAwayLineV2> findPutAwayLineV2(@RequestBody SearchPutAwayLineV2 searchPutAwayLine) throws Exception {
        return putawaylineService.findPutAwayLineV2(searchPutAwayLine);
    }

    @ApiOperation(response = PutAwayLineV2.class, value = "Create PutAwayLine V2") // label for swagger
    @PostMapping("/v2")
    public ResponseEntity<?> postPutAwayLineV2(@Valid @RequestBody PutAwayLineV2 newPutAwayLine,
                                               @RequestParam String loginUserID) throws Exception {
