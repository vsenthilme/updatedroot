...
//                                       String preInboundNo, String refDocNumber, String manufacturerCode);
    ...
    //get Profile
    @Query(value = "select top 1 profile from tblconfiguration \n" +
            "WHERE \n" +
            ...
            "is_deleted = 0 order by ctd_on desc", nativeQuery = true)
    public String getProfile(@Param("companyCodeId") String companyCodeId,
                             @Param("plantId") String plantId,
                             @Param("languageId") String languageId,
                             @Param("warehouseId") String warehouseId);
}