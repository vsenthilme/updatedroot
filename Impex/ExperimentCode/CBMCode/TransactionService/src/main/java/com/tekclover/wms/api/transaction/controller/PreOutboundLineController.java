...
public class PreOutboundLineController {
    ...
    @PostMapping("")
    public ResponseEntity<?> postPreOutboundLine(@Valid @RequestBody AddPreOutboundLine newPreOutboundLine,
...
//	}
    ...
    public Stream<PreOutboundLineV2> findPreOutboundLineV2(@RequestBody SearchPreOutboundLineV2 searchPreOutboundLine) throws Exception {
    ...
    @PostMapping("/v2")
    public ResponseEntity<?> postPreOutboundLineV2(@Valid @RequestBody PreOutboundLineV2 newPreOutboundLine,
                                                   @RequestParam String loginUserID) throws Exception {
