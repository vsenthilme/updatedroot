...
public class QualityHeaderController {
    ...
    public List<QualityHeader> findQualityHeader(@RequestBody SearchQualityHeader searchQualityHeader) throws Exception {
    ...
    public Stream<QualityHeader> findQualityHeaderNew(@RequestBody SearchQualityHeader searchQualityHeader) throws Exception {
    ...
    @PostMapping("")
    public ResponseEntity<?> postQualityHeader(@Valid @RequestBody AddQualityHeader newQualityHeader,
    ...
    public List<QualityHeaderV2> findQualityHeaderV2(@RequestBody SearchQualityHeaderV2 searchQualityHeader) throws Exception {
    ...
    public Stream<QualityHeaderV2> findQualityHeaderNewV2(@RequestBody SearchQualityHeaderV2 searchQualityHeader) throws Exception {
