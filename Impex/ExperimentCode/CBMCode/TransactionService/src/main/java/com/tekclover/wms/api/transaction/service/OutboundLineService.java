...
//                            Double INV_QTY = inventory.getInventoryQuantity() + pickupLine.getPickConfirmQty();
                            ...
                            //===============================CBM=================================================
                            Double[] cbm = cbmService.storageBinCapacityReduction(companyCodeId, plantId, languageId, warehouseId, itemCode, manufacturerName,
                                                                                  pickupLine.getPickedStorageBin(), pickupLine.getPickConfirmQty(), loginUserID);
...
//                            Double INV_QTY = inventory.getInventoryQuantity() + pickupLine.getPickConfirmQty();
                            ...
                            //===============================CBM=================================================
                            Double[] cbm = cbmService.storageBinCapacityReduction(pickupLine.getCompanyCodeId(), pickupLine.getPlantId(), pickupLine.getLanguageId(),
                                                                                  pickupLine.getWarehouseId(), itemCode, manufacturerName,
                                                                                  pickupLine.getPickedStorageBin(), pickupLine.getPickConfirmQty(), loginUserID);
                            if(cbm != null && cbm.length > 1) {
                                inventory.setCbmPerQuantity(String.valueOf(cbm[0]));
                                inventory.setCbm(String.valueOf(cbm[1]));
