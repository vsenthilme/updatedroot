...
//            referenceDocumentType = "STOCKRECEIPTHEADER";
     ...
     * @return
     */
    public double getCBMImBasicData1(String companyCode, String plantId, String languageId,
                                     String warehouseId, String itemCode, String manufacturerName) {
        return cbmService.getImBasicData1CBM(companyCode, plantId, languageId, warehouseId, itemCode, manufacturerName);
    }
}