...
public class PutAwayHeaderService extends BaseService {
    ...
    public PutAwayHeaderV2 createPutAwayHeaderV2(PutAwayHeaderV2 newPutAwayHeader, String loginUserID)
        ...
        dbPutAwayHeader.setCreatedOn(new Date());
        dbPutAwayHeader.setUpdatedOn(new Date());
        PutAwayHeaderV2 savePutAwayHeader = putAwayHeaderV2Repository.save(dbPutAwayHeader);

        if (savePutAwayHeader != null) {
            sendNotification();                 // Send Notification
        }
        return savePutAwayHeader;
    }
    ...
    public void sendNotification() throws FirebaseMessagingException {
        ...
        List<IKeyValuePair> notification =
                putAwayHeaderV2Repository.findByStatusIdAndNotificationStatusAndDeletionIndicatorDistinctRefDocNo();

        if (notification != null) {
            for (IKeyValuePair qualityHeader : notification) {

                List<String> deviceToken = pickupHeaderV2Repository.getDeviceToken(
                        qualityHeader.getAssignPicker(), qualityHeader.getWarehouseId());

                if (deviceToken != null && !deviceToken.isEmpty()) {
                    String title = "PUTAWAY";
                    String message = qualityHeader.getRefDocType() + " ORDER - " + qualityHeader.getRefDocNumber() + " - IS RECEIVED ";
                    String response = pushNotificationService.sendPushNotification(deviceToken, title, message);
                    if (response.equals("OK")) {
                        putAwayHeaderV2Repository.updateNotificationStatus(
                                qualityHeader.getAssignPicker(), qualityHeader.getRefDocNumber(), qualityHeader.getWarehouseId());
     ...
     */
    @Transactional
    public List<PutAwayHeaderV2> batchPutAwayReversal(List<InboundReversalInput> inboundReversalInputList, String loginUserID) throws Exception {
...
//                updatePutAwayHeaderReversalBatch(inboundReversalInput.getCompanyCodeId(), inboundReversalInput.getPlantId(),
//                        inboundReversalInput.getLanguageId(), inboundReversalInput.getWarehouseId(),
//                        inboundReversalInput.getRefDocNumber(), inboundReversalInput.getPackBarcodes(),
//                        inboundReversalInput.getPutAwayNumber(), loginUserID);

                inboundReversalNonCBMV4(inboundReversalInput.getCompanyCodeId(), inboundReversalInput.getPlantId(),
                        inboundReversalInput.getLanguageId(), inboundReversalInput.getWarehouseId(),
                        inboundReversalInput.getRefDocNumber(), inboundReversalInput.getPackBarcodes(),
                        inboundReversalInput.getPutAwayNumber(), loginUserID);
            }
...
//                            deleteInventory.setInventoryId(System.currentTimeMillis());
                            ...
                            deleteInventory.setReferenceField4(round(deleteInventory.getInventoryQuantity()));         //Allocated Qty is always 0 for BinClassId 3
                        ...
                        if (isDeleted) {
                            StorageBinV2 dbstorageBin = storageBinService.getStorageBinByBinClassIdV2(companyCode, plantId, languageId, warehouseId, 3L, updateStorageBin.getStorageBin());
                            ...
                            if (dbstorageBin != null) {
                                ...
                                if (capacityCheck && storageBinCapacityCheck) {
                                    ...
                                    StorageBinV2 updateStorageBinV2 = storageBinService.updateStorageBinV2(dbstorageBin.getStorageBin(),
                                                                                                           dbstorageBin,
                                                                                                           companyCode,
                                                                                                           plantId,
                                                                                                           languageId,
...
//                createInventoryMovement = inventoryService.getInventoryForInvMmt(companyCode, plantId, languageId, warehouseId, itemCode, manufactureName, 1L);
                ...
                if (updateStorageBin != null) {
                    ...
                    BeanUtils.copyProperties(updateStorageBin, deleteInventory, CommonUtils.getNullPropertyNames(updateStorageBin));
//                    deleteInventory.setInventoryId(System.currentTimeMillis());
                    deleteInventory.setInventoryQuantity(round(updateStorageBin.getInventoryQuantity() - dbPutAwayHeader.getPutAwayQuantity()));
                    deleteInventory.setReferenceField4(round(deleteInventory.getInventoryQuantity()));         //Allocated Qty is always 0 for BinClassId 3
                    InventoryV2 createInventory = inventoryV2Repository.save(deleteInventory);
                    log.info("Delete Inventory Inserted: " + createInventory);
                    isDeleted = true;
                ...
                if (isDeleted) {
                    StorageBinV2 dbstorageBin = storageBinService.getStorageBinByBinClassIdV2(companyCode, plantId, languageId, warehouseId, 1L, updateStorageBin.getStorageBin());
                    log.info("dbStorageBin: " + dbstorageBin);

                    if (dbstorageBin == null) {
                        dbstorageBin = storageBinService.getStorageBinByBinClassIdV2(companyCode, plantId, languageId, warehouseId, 1L, storageBin);
                    }
...
//        PutAwayHeaderV2 dbPutAwayHeader = putAwayHeaderV2Repository.findTopByCompanyCodeIdAndPlantIdAndWarehouseIdAndLanguageIdAndReferenceField5AndManufacturerNameAndStatusIdAndAlternateUomAndBagSizeAndDeletionIndicatorOrderByCreatedOn(companyCodeId, plantId, warehouseId, languageId, itemCode, manufacturerName, 19L, alternateUom, bagSize, 0L);
    ...
    @Transactional
    public List<PutAwayHeaderV2> updatePutAwayHeaderV4(String companyCode, String plantId, String languageId, String warehouseId,
                                                       String refDocNumber, String packBarcodes, String loginUserID) throws Exception {
        /*
         * Pass WH_ID/REF_DOC_NO/PACK_BARCODE values in PUTAWAYHEADER table and fetch STATUS_ID value and PA_NO
         * 1. If STATUS_ID=20, then
         */
        ...
        for (PutAwayHeaderV2 dbPutAwayHeader : putAwayHeaderList) {
                ...
                if (putAwayLineList != null && !putAwayLineList.isEmpty()) {
                    for (PutAwayLineV2 dbPutAwayLine : putAwayLineList) {
                        ...
                        if (updateStorageBin != null) {
                            InventoryV2 deleteInventory = new InventoryV2();
                            BeanUtils.copyProperties(updateStorageBin, deleteInventory, CommonUtils.getNullPropertyNames(updateStorageBin));
                            double INV_QTY = updateStorageBin.getInventoryQuantity() != null ? updateStorageBin.getInventoryQuantity() : 0;
                            double TOT_QTY = INV_QTY - dbPutAwayHeader.getPutAwayQuantity();
                            TOT_QTY = round(TOT_QTY);
                            if (TOT_QTY < 0) {
                                TOT_QTY = 0;
                            }
                            deleteInventory.setInventoryQuantity(TOT_QTY);
                            deleteInventory.setReferenceField4(TOT_QTY);         //Allocated Qty is always 0 for BinClassId 3
                            InventoryV2 createInventory = inventoryV2Repository.save(deleteInventory);
                            log.info("Delete Inventory Inserted: " + createInventory);
                            isDeleted = true;
                        }
                        ...
                        StagingLineEntityV2 dbStagingLineEntity = stagingLineService.getStagingLineForReversalV2(companyCode, plantId, languageId, warehouseId, refDocNumber,
                                                                                                                 preInboundNo, itemCode, manufactureName, lineNumber);
                        if (dbStagingLineEntity != null) {
                         ...
                         */
                        InboundLineV2 inboundLine = inboundLineService.getInboundLineV2(
                                companyCode, plantId, languageId, warehouseId, refDocNumber, preInboundNo, lineNumber, itemCode);
                        if (dbPutAwayLine.getQuantityType().equalsIgnoreCase("A")) {
                            Double acceptedQty = inboundLine.getAcceptedQty() - dbPutAwayLine.getPutawayConfirmedQty();
                            log.info("Accepted Qty: " + acceptedQty);
                            inboundLine.setAcceptedQty(acceptedQty);
            ...
            if (dbPutAwayHeader.getStatusId() == 19L) {
                ...
                StagingLineEntityV2 dbStagingLineEntity = stagingLineService.getStagingLineForReversalV2(companyCode, plantId, languageId, warehouseId, refDocNumber,
                                                                                                         dbPutAwayHeader.getPreInboundNo(), dbPutAwayHeader.getReferenceField5(),
                                                                                                         dbPutAwayHeader.getManufacturerName(), lineNumber);
                if (dbStagingLineEntity != null) {
                    Double rec_accept_qty = 0D;
                    Double rec_damage_qty = 0D;
                    if (dbPutAwayHeader.getQuantityType().equalsIgnoreCase("A")) {
            ...
            //update the statusId to complete reversal process
            inboundReversalLineStatusUpdateV4(companyCode, plantId, languageId, warehouseId, dbPutAwayHeader.getReferenceField5(),
                                              dbPutAwayHeader.getManufacturerName(), lineNumber, refDocNumber, preInboundNo, loginUserID);
        }

        inboundReversalHeaderStatusUpdateV4(preInboundNo, companyCode, plantId, languageId, warehouseId, refDocNumber, loginUserID);
     ...
     * @throws Exception
     */
    public List<PutAwayHeaderV2> inboundReversalNonCBMV4(String companyCode, String plantId, String languageId, String warehouseId,
     ...
     * @throws Exception
     */
    public void inboundReversalHeaderStatusUpdateV4(String preInboundNo, String companyCode, String plantId, String languageId,
     ...
     * @throws Exception
     */
    public void inboundReversalLineStatusUpdateV4(String companyCode, String plantId, String languageId, String warehouseId,
        ...
        try {
            ...
            boolean partialPutAwayExists = putAwayLineService.getPutAwayLineForReversalV4(
     ...
     * @return
     */
    public List<String> getPutawayHeaderExistingBinCheckV4(String companyCodeId, String plantId, String languageId, String warehouseId) {
        return putAwayHeaderV2Repository.getPutAwayHeaderProposedBins (companyCodeId, plantId, languageId, warehouseId, 19L);
    }
     ...
     * @throws Exception
     */
    public List<PutAwayHeaderV2> inboundReversalCBMV4(String companyCode, String plantId, String languageId, String warehouseId,
                                                      String refDocNumber, String packBarcodes, String putAwayNumber, String loginUserID) throws Exception {
        ...
        for (PutAwayHeaderV2 dbPutAwayHeader : putAwayHeaderList) {
                ...
                if (putAwayLineList != null && !putAwayLineList.isEmpty()) {
                    for (PutAwayLineV2 dbPutAwayLine : putAwayLineList) {
                        ...
                        if (isDeleted) {
                            ...
                            cbmService.storageBinCapacityExpansion(companyCode, plantId, languageId, warehouseId, itemCode, manufactureName,
                                                                   dbPutAwayLine.getConfirmedStorageBin(), dbPutAwayLine.getPutawayConfirmedQty(), loginUserID);
            ...
            //CBM Code
            cbmService.storageBinCapacityExpansion(companyCode, plantId, languageId, warehouseId, itemCode, manufactureName,
                                                   dbPutAwayHeader.getProposedStorageBin(), dbPutAwayHeader.getPutAwayQuantity(), loginUserID);
