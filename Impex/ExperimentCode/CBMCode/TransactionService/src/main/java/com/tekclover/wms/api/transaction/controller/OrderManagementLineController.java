...
//=======================================================V2============================================================================================
    ...
    @ApiOperation(response = OrderManagementLineV2.class, value = "Get all OrderManagementLine details") // label for swagger
    @GetMapping("/v2")
...
//        List<OrderManagementLineV2> updatedOrderManagementLine = ordermangementlineService.doUnAllocationV2(orderManagementLineV2, loginUserID);
        List<OrderManagementLineV2> updatedOrderManagementLine = ordermangementlineService.doUnAllocationV4(orderManagementLineV2, loginUserID);
        return new ResponseEntity<>(updatedOrderManagementLine, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> unallocateOrderManagementLineV2(@RequestParam String warehouseId, @RequestParam String companyCodeId, @RequestParam String plantId,
        ...
        OrderManagementLineV2 updatedOrderManagementLine =
                ordermangementlineService.doUnAllocationV4(companyCodeId, plantId, languageId, warehouseId, preOutboundNo, refDocNumber, partnerCode, lineNumber,
                                                           itemCode, proposedStorageBin, proposedPackBarCode, loginUserID);
        return new ResponseEntity<>(updatedOrderManagementLine, HttpStatus.OK);
    }
