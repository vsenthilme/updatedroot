...
//			}
    ...
    public PerpetualHeaderEntityV2 processStockCountReceived(CycleCountHeader cycleCountHeader) {
        ...
        if (cycleCountHeader.getWarehouseId() != null) {
            newPerpetualHeader.setWarehouseId(cycleCountHeader.getWarehouseId());
        } else {
            // Get Warehouse
        ...
        newPerpetualHeader.setLanguageId(cycleCountHeader.getLanguageId() != null ? cycleCountHeader.getLanguageId() : LANG_ID);
