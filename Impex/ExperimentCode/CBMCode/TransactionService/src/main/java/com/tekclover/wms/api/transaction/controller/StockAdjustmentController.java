...
public class StockAdjustmentController {
    ...
    public Stream<StockAdjustment> findStockAdjustment(@RequestBody SearchStockAdjustment searchInventory) throws Exception {
    ...
    public ResponseEntity<?> patchStockAdjustment(@PathVariable Long stockAdjustmentKey, @RequestParam String languageId, @RequestParam String companyCode,
                                                  ...
                                                  @RequestBody List<StockAdjustment> updateStockAdjustment) throws Exception {
