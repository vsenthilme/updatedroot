...
public class StorageBinService extends BaseService {
    ...
    public StorageBinV2 getaStorageBinV2(StorageBinPutAway storageBinPutAway) {
        ...
        if (storageBinPutAway.getBinClassId() != null && storageBinPutAway.getStorageSectionIds() != null) {
            return storageBinV2Repository.findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndStorageBinAndBinClassIdAndStorageSectionIdNotInAndDeletionIndicator(
                    storageBinPutAway.getCompanyCodeId(), storageBinPutAway.getPlantId(), storageBinPutAway.getLanguageId(),
                    storageBinPutAway.getWarehouseId(), storageBinPutAway.getBin(), storageBinPutAway.getBinClassId(),
                    storageBinPutAway.getStorageSectionIds(), 0L);
        }
        if (storageBinPutAway.getBinClassId() != null) {
            return storageBinV2Repository.findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndStorageBinAndBinClassIdAndDeletionIndicator(
                    ...
                    storageBinPutAway.getBin(), storageBinPutAway.getBinClassId(), 0L);
        }
        if (storageBinPutAway.getBinClassId() == null && storageBinPutAway.getStorageSectionIds() != null) {
            return storageBinV2Repository.findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndStorageBinAndStorageSectionIdNotInAndDeletionIndicator(
                    storageBinPutAway.getCompanyCodeId(), storageBinPutAway.getPlantId(), storageBinPutAway.getLanguageId(),
                    storageBinPutAway.getWarehouseId(), storageBinPutAway.getBin(), storageBinPutAway.getStorageSectionIds(), 0L);
        }
        if (storageBinPutAway.getBinClassId() == null) {
            return storageBinV2Repository.findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndStorageBinAndDeletionIndicator(
                    storageBinPutAway.getCompanyCodeId(), storageBinPutAway.getPlantId(), storageBinPutAway.getLanguageId(),
                    storageBinPutAway.getWarehouseId(), storageBinPutAway.getBin(), 0L);
        }
        return storagebin;
    }
    ...
    public StorageBinV2 getProposedStorageBinNonCBM(StorageBinPutAway storageBinPutAway) {
        ...
        try {
            ...
            if (storageBinPutAway.getBinClassId() != 7 && (storageBinPutAway.getStorageBin() != null && !storageBinPutAway.getStorageBin().isEmpty()) && storageBinPutAway.getStorageSectionIds() != null) {
                return storageBinV2Repository.getStorageBinNonCBM(
                        storageBinPutAway.getBinClassId(), storageBinPutAway.getStorageSectionIds(), storageBinPutAway.getCompanyCodeId(),
                        storageBinPutAway.getPlantId(), storageBinPutAway.getLanguageId(), storageBinPutAway.getStatusId(),
                        storageBinPutAway.getStorageBin(), storageBinPutAway.getWarehouseId());
            }
            if (storageBinPutAway.getBinClassId() != 7 && storageBinPutAway.getStorageSectionIds() != null &&
                ...
                return storageBinV2Repository.getStorageBinNonCBM(
                        storageBinPutAway.getBinClassId(), storageBinPutAway.getStorageSectionIds(), storageBinPutAway.getCompanyCodeId(),
                        storageBinPutAway.getPlantId(), storageBinPutAway.getLanguageId(),
            ...
            if (storageBinPutAway.getBinClassId() != 7 && storageBinPutAway.getStorageBin() != null && !storageBinPutAway.getStorageBin().isEmpty()) {
                return storageBinV2Repository.getStorageBinNonCBM(
                        storageBinPutAway.getBinClassId(), storageBinPutAway.getCompanyCodeId(), storageBinPutAway.getPlantId(),
                        storageBinPutAway.getLanguageId(), storageBinPutAway.getStatusId(), storageBinPutAway.getStorageBin(), storageBinPutAway.getWarehouseId());
            }
            if (storageBinPutAway.getBinClassId() != 7 &&
                    (storageBinPutAway.getStorageBin() == null || (storageBinPutAway.getStorageBin() != null && storageBinPutAway.getStorageBin().isEmpty()))) {
                return storageBinV2Repository.getStorageBinNonCBM(
                        storageBinPutAway.getBinClassId(), storageBinPutAway.getCompanyCodeId(), storageBinPutAway.getPlantId(),
                        storageBinPutAway.getLanguageId(), storageBinPutAway.getStatusId(), storageBinPutAway.getWarehouseId());
            }
            if (storageBinPutAway.getBinClassId() == 7) {
                return storageBinV2Repository.getStorageBinNonCBMBinClassId(
                        storageBinPutAway.getBinClassId(), storageBinPutAway.getCompanyCodeId(),
                        storageBinPutAway.getPlantId(), storageBinPutAway.getLanguageId(), storageBinPutAway.getWarehouseId());
            }
            return storagebin;
        } catch (Exception e) {
            e.printStackTrace();
     ...
     * @param loginUserId
     */
    public void updateStorageBinV2(String companyCodeId, String plantId, String languageId, String warehouseId,
                                   String storageBin, String remainingVolume, String occupiedVolume, Double allocatedVolume,
                                   Long statusId, boolean capacityCheck, String loginUserId) {
        storageBinV2Repository.updateStorageBin(companyCodeId, plantId, languageId, warehouseId,
                                                storageBin, remainingVolume, occupiedVolume, allocatedVolume,
                                                statusId, capacityCheck, loginUserId, new Date());
     ...
     * @param loginUserId
     */
    public void updateStorageBinStatusV2(String companyCodeId, String plantId, String languageId, String warehouseId,
                                         String storageBin, Long statusId, boolean capacityCheck, String loginUserId) {
        storageBinV2Repository.updateStorageBinStatus(companyCodeId, plantId, languageId, warehouseId,
                                                      storageBin, statusId, capacityCheck, loginUserId, new Date());
        log.info("Storage Bin Status Updated successfully ");
    }
     ...
     * @return
     */
    public StorageBinV2 getInventoryBinOrderByRemainingVolume(String companyCodeId, String plantId, String languageId, String warehouseId,
                                                              String itemCode, String manufacturerName, Long binClassId, Double cbmPerQty) {
        return storageBinV2Repository.getInventoryBinOrderByRemainingVolume(companyCodeId, plantId, languageId, warehouseId,
                                                                            itemCode, manufacturerName, binClassId, cbmPerQty);
    }
     ...
     * @return
     */
    public StorageBinV2 getLastPickedBin(String companyCodeId, String plantId, String languageId,
                                         String warehouseId, String itemCode, String manufacturerName,
                                         Long binClassId, Long statusId, Double cbm) {
        return storageBinV2Repository.getLastPickedBin(companyCodeId, plantId, languageId, warehouseId,
                                                       itemCode, manufacturerName, binClassId, statusId, cbm);
    }
     ...
     * @return
     */
    public StorageBinV2 getConfirmedPutAwayLineBin(String companyCodeId, String plantId, String languageId,
                                                   String warehouseId, String itemCode, String manufacturerName,
                                                   Long binClassId, Long statusId, Double cbm) {
        return storageBinV2Repository.getConfirmedPutAwayLineBin(companyCodeId, plantId, languageId, warehouseId,
                                                                 itemCode, manufacturerName, binClassId, statusId, cbm);
    }
     ...
     * @return
     */
    public StorageBinV2 getProposedPutAwayHeaderBin(String companyCodeId, String plantId, String languageId,
                                                    String warehouseId, String itemCode, String manufacturerName,
                                                    Long binClassId, Long statusId, Double cbm) {
        return storageBinV2Repository.getProposedPutAwayHeaderBin(companyCodeId, plantId, languageId, warehouseId,
                                                                  itemCode, manufacturerName, binClassId, statusId, cbm);
    }
     ...
     * @return
     */
    public StorageBinV2 getProposedEmptyBin(String companyCodeId, String plantId, String languageId,
                                            String warehouseId, Long binClassId, Long statusId, Double cbm) {
        return storageBinV2Repository.getProposedEmptyBin(companyCodeId, plantId, languageId,
                                                          warehouseId, binClassId, statusId, cbm);
    }
}