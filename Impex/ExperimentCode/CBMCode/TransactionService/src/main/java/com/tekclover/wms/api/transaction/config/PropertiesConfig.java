...
//	private String axapiServiceSalesOrderUrl;
	...
	@Value("${pickupline.bin.allocation.strategy}")
	private String pickupLineBinAllocationStrategy;

	@Value("${pickupline.bin.partial.allocation.strategy}")
	private String pickupLineBinPartialAllocationStrategy;

	@Value("${putaway.bin.partial.allocation.strategy}")
	private String putAwayBinPartialAllocationStrategy;
}