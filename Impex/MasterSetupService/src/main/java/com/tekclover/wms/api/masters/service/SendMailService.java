...
public class SendMailService {
     ...
     */
    public void sendMail(OrderCancelInput orderCancelInput) {
        //Send Email
...
//        }
            ...
            if (orderCancelInput.getReferenceField1().equalsIgnoreCase("STOCKADJUSTMENT") ||
                ...
                emailSubject = "Impex-Classic WMS/AMS Integration - Sync failure Notification - Item Code: " + ref_doc_no + ", " + orderCancelInput.getReferenceField2() + ", " + localDate;

                emailBodyText = "Dear IMPEX Operations/IT team,<br><br>" + "Please find below the failed order sync details <br><br> " +
                ...
                emailSubject = "Impex-Classic WMS/AMS Integration - Sync failure Notification - Order No: " + ref_doc_no + ", " + localDate;
                emailBodyText = "Dear IMPEX Operations/IT team,<br><br>" + "Please find below the failed order sync details" +
                        "<table>" +
                        "<tr>" +
                        "<td>Order No </td>" +
                        "<td>: " + ref_doc_no + "</td>" +
            ...
            email.setSenderName("Impex-Support");
    ...
    public void sendaMail(EMailDetails email) throws MessagingException, IOException {
        ...
        try {
            ...
            log.info("Impex-Failed Order Detail Mail sent successful");
        } catch (Exception e) {
            e.printStackTrace();
            helper.setFrom(propertiesConfig.getEmailFromAddress());
            helper.setTo("raj@tekclover.com");
            helper.setCc("senthil.v@tekclover.com");
            helper.setSubject("Impex-Failed Order Details sending through eMail Failed");
            helper.setText("IMPEX-Failed Order Details sending through eMail Failed", true);
            javaMailSender.send(msg);
            log.info("Impex-Failed Order Detail Mail sent Unsuccessful");
