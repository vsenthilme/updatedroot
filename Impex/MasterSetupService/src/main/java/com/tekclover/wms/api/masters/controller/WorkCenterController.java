...
public class WorkCenterController {
    ...
    public ResponseEntity<?> getWorkCenter(@PathVariable Long workCenterId, @RequestParam String companyCodeId, @RequestParam String plantId,
                                           @RequestParam String warehouseId, @RequestParam String languageId, @RequestParam String workCenterType) {
    ...
    public ResponseEntity<?> patchWorkCenter(@PathVariable Long workCenterId, @RequestParam String companyCodeId, @RequestParam String plantId,
                                             @RequestParam String warehouseId, @RequestParam String languageId, @RequestParam String workCenterType,
                                             @Valid @RequestBody UpdateWorkCenter updateWorkCenter, @RequestParam String loginUserID) {
        WorkCenter createdWorkCenter = workCenterService.updateWorkCenter(workCenterId, companyCodeId, plantId, warehouseId,
                workCenterType, languageId, updateWorkCenter, loginUserID);
        return new ResponseEntity<>(createdWorkCenter, HttpStatus.OK);
    }

    @ApiOperation(response = WorkCenter.class, value = "Delete WorkCenter") // label for swagger
    @DeleteMapping("/{workCenterId}")
    public ResponseEntity<?> deleteWorkCenter(@PathVariable Long workCenterId, @RequestParam String loginUserID, @RequestParam String warehouseId,
                                              @RequestParam String companyCodeId, @RequestParam String plantId,
                                              @RequestParam String workCenterType, @RequestParam String languageId) {
