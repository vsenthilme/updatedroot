...
import com.tekclover.wms.api.masters.model.threepl.pricelistassignment.AddPriceListAssignment;
...
import com.tekclover.wms.api.masters.model.threepl.pricelistassignment.UpdatePriceListAssignment;
...
@Slf4j
@Validated
@Api(tags = {"PriceListAssignment"}, value = "PriceListAssignment  Operations related to PriceListAssignmentController")
// label for swagger
...
public class PriceListAssignmentController {
    ...
    @ApiOperation(response = PriceListAssignment.class, value = "Get all PriceListAssignment details")
    // label for swagger
    @GetMapping("")
    ...
    @PostMapping("")
    public ResponseEntity<?> postPriceListAssignment(@Valid @RequestBody AddPriceListAssignment newPriceListAssignment, @RequestParam String loginUserID) {
    ...
    @PostMapping("/find")
    public ResponseEntity<?> findPriceListAssignment(@Valid @RequestBody FindPriceListAssignment findPriceListAssignment) {
