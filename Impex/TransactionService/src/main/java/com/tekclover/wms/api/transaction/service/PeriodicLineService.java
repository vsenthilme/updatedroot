        ...
        try {
            for (PeriodicLineV2 updatePeriodicLine : periodicLineV2s) {
                ...
                if (dbPeriodicLine.getStatusId() == 47L) {
                    ...
                    updatePeriodicLine.setPackBarcodes("99999");       //HardCode
...
//                                dbPeriodicLine.getManufacturerName());
     ...
     * @return
     */
    public PeriodicLineV2 getPeriodicLineV4(String companyCode, String plantId, String languageId, String warehouseId,
