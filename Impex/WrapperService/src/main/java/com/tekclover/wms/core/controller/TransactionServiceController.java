...
//    }
    ...
    // File Upload - Orders - V3 - Walkaroo
    @ApiOperation(response = ASNV2.class, value = "ASN V3 - Walkaroo") // label for swagger
    @PostMapping("/warehouse/inbound/asn/upload/v3")
    public ResponseEntity<?> postWarehouseInboundAsnUploadV3(@RequestParam(required = false) String companyCodeId, @RequestParam(required = false) String plantId,
                                                             @RequestParam(required = false) String languageId, @RequestParam(required = false) String warehouseId,
                                                             @RequestParam(required = false) String loginUserID, @RequestParam("file") MultipartFile file) throws Exception {
        Map<String, String> response = fileStorageService.processAsnOrdersV3(companyCodeId, plantId, languageId, warehouseId, loginUserID, file);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    // File Upload - Sales Orders - V3 - Walkaroo
    @ApiOperation(response = SalesOrderV2.class, value = "Create Sales Order V3 Walkaroo") // label for swagger
    @PostMapping("/warehouse/outbound/salesOrder/upload/v3")
    public ResponseEntity<?> postSalesOrderUploadV3(@RequestParam(required = false) String companyCodeId, @RequestParam(required = false) String plantId,
                                                    @RequestParam(required = false) String languageId, @RequestParam(required = false) String warehouseId,
                                                    @RequestParam(required = false) String loginUserID, @RequestParam("file") MultipartFile file) throws Exception {
        Map<String, String> response = fileStorageService.processSalesOrdersV3(companyCodeId, plantId, languageId, warehouseId, loginUserID, file);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }

    // File Upload - Sales Orders - V3 - Walkaroo
    @ApiOperation(response = SalesOrderV2.class, value = "DeliveryConfirmation V3 Walkaroo") // label for swagger
    @PostMapping("/warehouse/outbound/deliveryConfirmation/upload/v3")
    public ResponseEntity<?> postDeliveryConfirmationUploadV3(@RequestParam("file") MultipartFile file) throws Exception {
        Map<String, String> response = fileStorageService.processDeliveryConfirmationV3(file);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
...
// -------------------------------------StagingHeader-V2--------------------------------------------------------------------------------------------
    ...
    //Create
    @ApiOperation(response = PutAwayLineV2.class, value = "Create PutAwayLine V2") // label for swagger
    @PostMapping("/putawayline/v3")
    public ResponseEntity<?> postPutAwayLineV3(@Valid @RequestBody List<PutAwayLineV2> newPutAwayLine, @RequestParam String loginUserID,
                                               @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
        PutAwayLineV2[] createdPutAwayLine = transactionService.createPutAwayLineV3(newPutAwayLine, loginUserID, authToken);
        return new ResponseEntity<>(createdPutAwayLine, HttpStatus.OK);
    }
...
//    }
    ...
    //Impex
    @ApiOperation(response = PeriodicHeaderEntityV2.class, value = "Impex Post PeriodicHeader and Line V2") // label for swagger
    ...
    public ResponseEntity<?> postPickupNumber(@PathVariable String pickupNumber, @RequestParam String languageId, @RequestParam String companyCode,
                                              @RequestParam String plantId, @RequestParam String warehouseId,
                                              @RequestParam String loginUserID, @RequestParam String authToken) {
        transactionService.processPickup(companyCode, plantId, languageId, warehouseId, pickupNumber, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
