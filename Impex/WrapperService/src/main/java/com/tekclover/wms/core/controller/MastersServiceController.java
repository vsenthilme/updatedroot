...
*/
    ...
    //IMF
    @ApiOperation(response = ImBasicData1V2.class, value = "Search ImBasicData1 IMF") // label for swagger
    @PostMapping("/imbasicdata1/imf/findImBasicData1")
    public ImBasicData1V2[] findImfImBasicData1New(@RequestBody SearchImBasicData1 searchImBasicData1,
                                                   @RequestParam String authToken) throws Exception {
        return mastersService.findImfImBasicData1(searchImBasicData1, authToken);
    }
    ...
    public ResponseEntity<?> getImBasicData1LikeSearchNew(@RequestParam String likeSearchByItemCodeNDesc, @RequestParam String companyCodeId,
                                                          @RequestParam String plantId, @RequestParam String languageId,
                                                          @RequestParam String warehouseId, @RequestParam String authToken) throws Exception {
        ItemCodeDesc[] itemCodes = mastersService.findImBasicData1LikeSearchNew(likeSearchByItemCodeNDesc, companyCodeId, plantId,
                languageId, warehouseId, authToken);
        return new ResponseEntity<>(itemCodes, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> getImBasicData1LikeSearchNew(@Valid @RequestBody LikeSearchInput likeSearchInput,
                                                          @RequestParam String authToken) throws Exception {

        ItemCodeDesc[] itemCodes = mastersService.findImBasicData1LikeSearchNewV2(likeSearchInput, authToken);
        return new ResponseEntity<>(itemCodes, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> findImBasicData1V3(@RequestBody SearchImBasicData1 searchImBasicData1,
                                                @RequestParam String authToken) throws Exception {
        ImBasicData1[] imBasicDatas = mastersService.findImBasicData1V3(searchImBasicData1, authToken);
        return new ResponseEntity<>(imBasicDatas, HttpStatus.OK);
    }
...
//DELETE
    ...
    @PostMapping("/pricelist/get/list")
    public ResponseEntity<?> getPriceListBulk(@RequestBody PriceListInput priceListInput, @RequestParam String authToken) {
        PriceList[] priceLists = mastersService.getPriceListBulk(priceListInput, authToken);
    ...
    @PostMapping("/pricelist/create/list")
    public ResponseEntity<?> createPriceListBulk(@RequestBody List<PriceList> priceLists, @RequestParam String loginUserID,
                                                 @RequestParam String authToken) {
        PriceList[] priceListBulk = mastersService.createPriceListBulk(priceLists, loginUserID, authToken);
        return new ResponseEntity<>(priceListBulk, HttpStatus.OK);
    }

    // Update Multiple PriceLists
    @ApiOperation(response = PriceList.class, value = "Update Multiple PriceLists") // label for swagger
    @PatchMapping("/pricelist/update/list")
    public ResponseEntity<?> patchPriceListBulk(@RequestBody List<PriceList> updatePriceLists, @RequestParam String loginUserID, @RequestParam String authToken) {
        PriceList[] priceLists = mastersService.updatePriceListBulk(updatePriceLists, loginUserID, authToken);
        return new ResponseEntity<>(priceLists, HttpStatus.OK);
    }

    // Delete Multiple PriceLists
    @ApiOperation(response = PriceList.class, value = "Delete Multiple PriceLists") // label for swagger
    @PostMapping("/pricelist/delete/list")
    public ResponseEntity<?> deletePriceListBulk(@RequestParam String authToken, @RequestBody List<PriceListInput> priceListInputs,
                                                 @RequestParam String loginUserID) {
        mastersService.deletePriceListBulk(priceListInputs, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
