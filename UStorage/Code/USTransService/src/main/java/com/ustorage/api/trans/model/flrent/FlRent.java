...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tblflrent")
public class FlRent {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_fl_rent")
	@GenericGenerator(name = "seq_fl_rent", strategy = "com.ustorage.api.trans.sequence.DefaultSequence", parameters = {
			@org.hibernate.annotations.Parameter(name = BaseSequence.INCREMENT_PARAM, value = "1"),
			@org.hibernate.annotations.Parameter(name = BaseSequence.VALUE_PREFIX_PARAMETER, value = "FL"),
