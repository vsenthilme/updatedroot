...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tblotherservices")
public class OtherServices {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_other_services")
	@GenericGenerator(name = "seq_other_services", strategy = "com.ustorage.api.trans.sequence.DefaultSequence", parameters = {
			@org.hibernate.annotations.Parameter(name = BaseSequence.INCREMENT_PARAM, value = "1"),
			@org.hibernate.annotations.Parameter(name = BaseSequence.VALUE_PREFIX_PARAMETER, value = "OS"),
