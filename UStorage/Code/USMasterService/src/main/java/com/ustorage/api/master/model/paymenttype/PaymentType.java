package com.ustorage.api.master.model.paymenttype;
...
public class PaymentType {
	...
	@GenericGenerator(name = "seq_payment_type", strategy = "com.ustorage.api.master.sequence.DefaultSequence", parameters = {
			@org.hibernate.annotations.Parameter(name = BaseSequence.INCREMENT_PARAM, value = "1"),
			@org.hibernate.annotations.Parameter(name = BaseSequence.VALUE_PREFIX_PARAMETER, value = "PTC"),
