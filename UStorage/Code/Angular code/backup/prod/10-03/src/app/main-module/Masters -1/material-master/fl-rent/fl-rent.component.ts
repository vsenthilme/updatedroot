...
import { FlRentService } from './fl-rent.service';
  ...
  @Component({
    selector: 'app-fl-rent',
    templateUrl: './fl-rent.component.html',
    styleUrls: ['./fl-rent.component.scss']
  })
  export class FlRentComponent implements OnInit {
    ...
    flRent(data: any = 'new'): void {
      ...
      this.router.navigate(['/main/materialmasters/flrent-new/' + paramdata]);
    }
  ...
  downloadexcel() {
    ...
    this.cs.exportAsExcel(res, "Fl-rent");
  }
  search(){
