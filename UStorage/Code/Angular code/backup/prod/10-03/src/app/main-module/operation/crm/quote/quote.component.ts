...
import { CommonApiService } from 'src/app/common-service/common-api.service';
 ...
 pdfMake.fonts = fonts;
  ...
  export class QuoteComponent implements OnInit {
    ...
    displayedColumns: string[] = ['select', 'quoteId', 'Doc','enquiryReferenceNumber', 'customerName', 'mobileNumber', 'requirement', 'email', 'customerGroup', 'storeSize', 'rent','status', 'notes'];
