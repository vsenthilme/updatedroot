...
@Component({
  selector: 'app-handlingcharges',
  templateUrl: './handlingcharges.component.html',
  styleUrls: ['./handlingcharges.component.scss']
})
export class HandlingchargesComponent implements OnInit {
    ...
    constructor(private router: Router,
      ...
      private service: HandlingChargesService,
    ...
    handlingCharges(data: any = 'new'): void {
      if (data != 'New')
      ...
      this.router.navigate(['/main/materialmasters/handling-charges-new/' + paramdata]);
    }
  ...
  downloadexcel() {
    ...
    this.cs.exportAsExcel(res, "Handling-charges");
  }
  search(){
    this.service.search(this.searhform.value).subscribe(res => {
      ...
      res.forEach((x) => this.multiselectdescriptionList.push({value: x.description, label: x.description}));
      this.multiselectdescriptionList = this.cs.removeDuplicatesFromArrayNew(this.multiselectdescriptionList);
      ...
      res.forEach((x) => this.multiselectunitPriceList.push({value: x.unitPrice, label: x.unitPrice}));
      this.multiselectunitPriceList = this.cs.removeDuplicatesFromArrayNew(this.multiselectunitPriceList);
