  ...
  dataList: any[] = [];
    ...
    getData(){
      this.sub.add(this.service.getpaymentdue({}).subscribe(res => {
          ...
          // console.log(this.lessThanSeven)
          // console.log(this.lessThanFourteen)
          // console.log(this.lessThanTweentyOne)
          // console.log(this.lessThanTweentyEight)
          // console.log(this.greaterThanTweentyEight)
          this.dataList.push(
              {
                  name: "0 < 7",
