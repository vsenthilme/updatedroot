...
import { DoortypeComponent } from './doortype/doortype.component';
...
const ELEMENT_DATA: PeriodicElement[] = [
  {usercode: '001', name: 'Double Door', admin: 'EN'},
];
...
export class DoorTypeComponent implements OnInit {
  ...
  constructor(private router: Router,
    ...
    private service: DoortypeService
  ) { }
  ...
  openDialog(data: any = 'New'): void {
    ...
    const dialogRef = this.dialog.open(DoortypeComponent, {
      disableClose: true,
      width: '55%',
      maxWidth: '80%',
      position: { top: '9%', },
...
getAll() {
  ...
  downloadexcel() {
      ...
      this.cs.exportAsExcel(res, "DoorType");
    }
}
