...
// };
  ...
  export class PaymentComponent implements OnInit {
    ...
    displayedColumns: string[] = ['select', 'voucherId', 'Doc', 'customerFullName','voucherDate','contractNumber', 'voucherAmount', 'phase','storeName' , 'modeOfPayment', 'voucherStatus','createdBy','createdOn'];
...
if(res.period == "YEARLY"){
  ...
  this.periodDate = moment(new Date(this.oneDateBefore._d)).subtract(1,'d');
        ...
        body2Array.push([
          ...
          { text: (res.storeName != null ? res.storeName : '') + (res.startDate != null ?  ' (' + (this.datePipe.transform(res.startDate, 'd MMM, y','GMT') + ' To ' + this.datePipe.transform(res.endDate, 'd MMM, y','GMT') + ')') : 'No-Data'), bold: false, alignment:'left', fontSize: 14, border: [false, false, false, true],borderColor: ['', '', '', '#808080'] },
