...
@Component({
  selector: 'app-paymentterm-new',
  templateUrl: './paymentterm-new.component.html',
  styleUrls: ['./paymentterm-new.component.scss']
})
export class PaymenttermNewComponent implements OnInit {
