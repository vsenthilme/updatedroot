...
@Component({
  selector: 'app-lead-conversion1',
  templateUrl: './lead-conversion1.component.html',
  styleUrls: ['./lead-conversion1.component.scss']
})
export class LeadConversion1Component implements OnInit {
