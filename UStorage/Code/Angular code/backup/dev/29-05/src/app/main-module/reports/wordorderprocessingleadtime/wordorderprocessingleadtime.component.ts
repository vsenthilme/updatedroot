...
@Component({
  selector: 'app-wordorderprocessingleadtime',
  templateUrl: './wordorderprocessingleadtime.component.html',
  styleUrls: ['./wordorderprocessingleadtime.component.scss']
})
export class WordorderprocessingleadtimeComponent implements OnInit {
  ...
  displayedColumns: string[] = ['workOrderDate','workOrderId','customerId','customerName','status','startDate','endDate','created', 'processedTime', 'processedBy','leadTime'];
  ...
  downloadexcel() {
    ...
    this.cs.exportAsExcel(res,"WorkOrder-Processingleadtime");
  }
}
