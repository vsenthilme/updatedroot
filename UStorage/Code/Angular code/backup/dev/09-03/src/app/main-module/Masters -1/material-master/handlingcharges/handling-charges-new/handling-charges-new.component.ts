...
import { CommonApiService } from "src/app/common-service/common-api.service";
  ...
  @Component({
    selector: 'app-handling-charges-new',
    templateUrl: './handling-charges-new.component.html',
    styleUrls: ['./handling-charges-new.component.scss']
  })
  export class HandlingChargesNewComponent implements OnInit {
    ...
    if (this.js.code) {
      this.sub.add(this.service.Update(this.form.getRawValue(), this.js.code).subscribe(res => {
        ...
        this.router.navigate(['/main/materialmasters/handling-charges']);
