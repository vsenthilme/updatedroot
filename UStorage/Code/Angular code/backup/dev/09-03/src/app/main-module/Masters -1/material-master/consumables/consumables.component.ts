...
export class ConsumablesComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'itemCode', 'description', 'itemGroup', 'saleUnitOfMeasure', 'unitPrice', 'inStock', 'openWo', 'lastReceipt','createdBy','createdOn'];
  ...
  materialMaster(data: any = 'new'): void {
    ...
    this.router.navigate(['/main/materialmasters/consumables-new/' + paramdata]);
  }
  ...
  downloadexcel() {
    ...
    this.dataSource.data.forEach(x => {
      res.push({
        ...
        "Instock": x.inStock,
        "Open WO": x.openWo,
        "Last Receipt": this.cs.dateapiutc0(x.unitPrice),
    ...
    this.cs.exportAsExcel(res, "Consumable");
  }
