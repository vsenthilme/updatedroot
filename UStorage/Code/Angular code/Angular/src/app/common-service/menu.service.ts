...
export class MenuService {
      ...
      children: [
        {
          ...
          id: 2101,
          url: '/main/setup/User-management',
          // icon: "fas fa-warehouse  fa-2x me-2",
        },
        {
          title: 'Currency',
          id: 2102,
          url: '/main/setup/currency',
        }
        ,
        {
          title: 'Countries',
          id: 2103,
          url: '/main/setup/countries',
        },
        // {
        //   title: 'Numbering Series',
        //   id: 2104,
        //   url: '/main/setup/numbering-series',
        // } 
      ...
      children: [
        {
          title: 'Business Unit',
          id: 2903,
          url: '/main/setup/storage-unit',
        },
        {
          title: 'Employee',
          id: 2904,
          url: '/main/setup/exployee',
        },
        {
          title: 'Item Group',
          id: 2902,
          url: '/main/setup/uitemgroup',
        },
      ...
      children: [
        {
          title: 'Storage Type',
          id: 3002,
          url: '/main/setup/storagetype',
        },
        {
          title: 'Door Type',
          id: 3001,
          url: '/main/setup/doortype',
        }
      ]
    },
    {
      ...
      children: [
        {
          title: 'Nationality',
          id: 1201,
          url: '/main/setup/nationality',
        },
        {
          title: 'Payment Mode',
          id: 1202,
          url: '/main/setup/payment-mode',
        }
        ,
        {
          title: 'Payment Term',
          id: 1203,
          url: '/main/setup/payment-term',
        }
      ...
      children: [
        {
          title: 'Payment Mode',
          id: 2801,
          url: '/main/setup/payment',
        },
        {
          title: 'Payment Term',
          id: 2803,
          url: '/main/setup/paymentterm',
        },
      ...
      children: [
        {
          title: 'enquiry',
          id: 1101,
          url: '/main/crm/enquiry',
        },
        {
          title: 'quote',
          id: 1102,
          url: '/main/crm/quote-unit',
        },
        // {
        //   title: 'BOM',
        //   id: 1103,
      ...
      children: [
        {
          ...
          id: 2301,
          url: '/main/operation/agreement',
        },
        {
          title: 'Invoice',
          id: 2302,
          url: '/main/operation/invoice',
        },
        {
            title: 'Pament',
            id: 1103,
            url: '/main/operation/payment',
          },
          {
            title: 'Work Order',
            id: 1104,
            url: '/main/operation/workorder',
          },
            {
          title: 'Agreement',
          id: 1105,
  ...
  menuForEdit: imenulist[] = [
    ...
    },
    {
      title: 'selection',
      id: 2210,
      url: '/main/materialmasters/storageunit',
    },
    ...
    },
    {
      title: 'Selection',
      id: 2805,
      url: '/main/customermasters/customerlist',
    },
    //other master
    {
      title: 'Other Masters',
