...
const ELEMENT_DATA: PeriodicElement[] = [
  {usercode: '001', name: 'Phase I', admin: 'EN'},
];



@Component({
  selector: 'app-warehousematerial',
  templateUrl: './warehousematerial.component.html',
  styleUrls: ['./warehousematerial.component.scss']
})
export class WarehousematerialComponent implements OnInit {
  ...
  constructor(private router: Router,
    ...
    private service: WarehousematerialService
  ) { }
  ngOnInit() {
    this.getAll();
  }
  ...
  downloadexcel() {
    ...
    this.cs.exportAsExcel(res, "Storage Location");
  }
}
