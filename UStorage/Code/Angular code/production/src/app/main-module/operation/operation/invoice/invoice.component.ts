...
import { AgreementService } from '../agreement/agreement.service';
  ...
  export class InvoiceComponent implements OnInit {
    ...
    displayedColumns: string[] = ['select', 'invoiceNumber','customerFullName', 'Doc',  'invoiceCurrency', 'invoiceAmount', 'invoiceDiscount', 'totalAfterDiscount','createdBy','createdOn'];
