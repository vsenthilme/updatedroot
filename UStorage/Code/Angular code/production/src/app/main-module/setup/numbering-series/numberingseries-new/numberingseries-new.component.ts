...
@Component({
  selector: 'app-numberingseries-new',
  templateUrl: './numberingseries-new.component.html',
  styleUrls: ['./numberingseries-new.component.scss']
})
export class NumberingseriesNewComponent implements OnInit {
