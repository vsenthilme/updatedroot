...
import { NationalityNewComponent } from './nationality-new/nationality-new.component';
...
const ELEMENT_DATA: PeriodicElement[] = [
  {usercode: 'KW', name: 'Kuwaiti', admin: 'EN'},
];
...
export class NationalityComponent implements OnInit {
  ...
  openDialog(data: any = 'New'): void {
    ...
    const dialogRef = this.dialog.open(NationalityNewComponent, {
      disableClose: true,
      width: '55%',
      maxWidth: '80%',
      position: { top: '9%', },
...
downloadexcel() {
  ...
  this.cs.exportAsExcel(res, "Nationality");
}
}
