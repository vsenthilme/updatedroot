...
@Component({
  selector: 'app-agreement-renew',
  templateUrl: './agreement-renew.component.html',
  styleUrls: ['./agreement-renew.component.scss']
})
export class AgreementRenewComponent implements OnInit {
  ...
  isShowDiv = false;
    ...
    showFiller = false;
    displayedColumns: string[] = ['agreementRenewalDate', 'agreementNumber', 'customerName', 'phoneNumber', 'secondaryNumber', 'storeNumber', 'size', 'storageType','phase','totalRent','fillrateStatus'];
  ...
  dropdownlist() {
    ...
    this.cas.getalldropdownlist([
      ...
      this.phaseList = this.cas.foreachlist(results[0], this.cas.dropdownlist.setup.phase.key);
    ...
    filtersearch() {
      ...
      this.spin.show();
      this.sub.add(this.service.getAgreementrenewTime(this.form.getRawValue()).subscribe(res => {
    ...
    downloadexcel() {
      ...
      this.dataSource.data.forEach(x => {
        res.push({
          "Agreement Renewal Date": this.cs.dateapiutc0(x.agreementRenewalDate),
          "Agreement No.": x.agreementNumber,
          "Customer Name": x.customerName,
          'Phone No': x.phoneNumber,
          'Secondary No':x.secondaryNumber ,
          'Store No':x.storeNumber,
          "Size": x.size,
          "Storage Type": x.storageType,
          "Phase":x.phase,
          "Total Rent":x.totalRent,
          "Fillrate Status":x.fillrateStatus,
        });
  
      })
      this.cs.exportAsExcel(res,"Agreement-Renewal");
    }
