...
@Slf4j
@Service
public class SparkInventoryServiceV2 {

    Properties connProp = new Properties();
    SparkSession sparkSession = null;

    public SparkInventoryServiceV2() {
        ...
        val df2 = sparkSession.read()
                ...
                .repartition(16);
        df2.createOrReplaceTempView("tblinventoryv5core");
    }
...
//                + "REF_FIELD_4 as referenceField4, "
                ...
                + "FROM tblinventoryv5core WHERE IS_DELETED = 0 "
