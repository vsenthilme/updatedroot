...
@Service
@Slf4j
public class OutboundJainCordService {
    ...
    public OutboundJainCordService() throws ParseException {
    ...
    private Dataset<Row> readJdbcTable(String tableName) {
        return sparkSession.read().option("fetchSize", "10000").jdbc("jdbc:sqlserver://35.154.84.178;databaseName=WMS_CORE", tableName, connProp).repartition(16);
    }
