...
//@Service
//@Slf4j
//public class SparkQualityLineIndusServiceV2 {
//
//    Properties connProp = new Properties();
//    SparkSession sparkSession = null;
//    private static final SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HHmmss");
//
//    public SparkQualityLineIndusServiceV2() throws ParseException {
...
//
//        //Read from Sql Table
//        val df2 = sparkSession.read().jdbc("jdbc:sqlserver://3.111.134.239;databaseName=WMS_IMF", "tblqualityline", connProp)
//                .repartition(16);
//        df2.createOrReplaceTempView("tblqualitylinev5");
//
//
//    }
//
...
//                "FROM tblqualitylinev5 WHERE IS_DELETED = 0 ");
//
