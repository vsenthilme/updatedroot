...
//@Service
//@Slf4j
//public class SparkStagingLineV2IndusServiceV2 {
//
//
...
//
//    public SparkStagingLineV2IndusServiceV2() throws ParseException {
...
//
//        //Read from Sql Table
//        val df2 = sparkSession.read().option("fetchSize", "10000").jdbc("jdbc:sqlserver://3.111.134.239;databaseName=WMS_IMF", "tblstagingline", connProp)
//                .repartition(16);
