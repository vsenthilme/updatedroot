...
@Service
@Slf4j
public class SparkPickupHeaderServiceV2 {

    Properties connProp = new Properties();
    SparkSession sparkSession = null;

    public SparkPickupHeaderServiceV2() throws ParseException {
        ...
        val df2 = sparkSession.read()
                .option("fetchSize", "10000").jdbc("jdbc:sqlserver://35.154.84.178;databaseName=WMS_CORE", "tblpickupheader", connProp)
                .repartition(16);
        df2.createOrReplaceTempView("tblpickupheaderv5core");
    }
    ...
    public List<PickupHeaderV2> findPickupHeaderV2(FindPickupHeaderV2 findPickupHeaderV2) throws ParseException {
        ...
        Dataset<Row> imPickupHeaderQuery = sparkSession.sql("SELECT "
                ...
                + "FROM tblpickupheaderv5core WHERE IS_DELETED = 0 ");
