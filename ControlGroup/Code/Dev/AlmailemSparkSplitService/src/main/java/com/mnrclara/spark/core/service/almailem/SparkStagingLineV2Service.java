...
import com.mnrclara.spark.core.model.Almailem.FindStagingLineV2;
import com.mnrclara.spark.core.model.Almailem.StagingLineV2;
...
@Service
@Slf4j
public class SparkStagingLineV2Service {
    ...
    public SparkStagingLineV2Service() throws ParseException {
        ...
        //Read from Sql Table
        val df2 = sparkSession.read().option("fetchSize", "10000").jdbc("jdbc:sqlserver://3.109.20.248;databaseName=WMS_ALMDEV_SPLIT", "tblstagingline", connProp)
                .repartition(16);
        df2.createOrReplaceTempView("tblstaginglineV2");
    }
