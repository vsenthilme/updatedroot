...
//		String storeId = s.substring(s.indexOf("CG")+3, s.lastIndexOf("/"));
//		log.info(storeId);
//		
//		String requestId = s.substring(s.lastIndexOf("/")+1);
//		log.info(requestId);
		
		String file = "Alia_Properties,_LLC_-_Company_Agreement_(10.21.2019).pdf";
