...
public class SparkQualityLineServiceV2 {
    ...
    public SparkQualityLineServiceV2() throws ParseException {
        ...
        //Read from Sql Table
        val df2 = sparkSession.read().jdbc("jdbc:sqlserver://35.154.84.178;databaseName=WMS_CORE", "tblqualityline", connProp)
                .repartition(16);
        df2.createOrReplaceTempView("tblqualitylinev5core");
    ...
    public List<QualityLineV2> findQualityLineV2(FindQualityLineV2 findQualityLineV2) throws ParseException {
        Dataset<Row>
                ...
                "FROM tblqualitylinev5core WHERE IS_DELETED = 0 ");
