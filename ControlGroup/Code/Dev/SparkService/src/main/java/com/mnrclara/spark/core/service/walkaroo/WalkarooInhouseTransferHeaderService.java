package com.mnrclara.spark.core.service.walkaroo;
...
@Slf4j
@Service
public class WalkarooInhouseTransferHeaderService {

    Properties connProp = new Properties();
    SparkSession sparkSession = null;

    public WalkarooInhouseTransferHeaderService() throws ParseException {
        ...
        val df2 = sparkSession.read()
                ...
                .jdbc("jdbc:sqlserver://3.111.134.239;databaseName=WMS_IMF", "tblinhousetransferheader", connProp)
                .repartition(16);
        df2.createOrReplaceTempView("tblinhousetransferheaderv5");
    }
    ...
    public List<InhouseTransferHeader> getAllInhouseTransferHeader() throws ParseException {
        ...
        Dataset<Row> inhouseTransferHeaderQuery = sparkSession.sql("SELECT "
                ...
                + "From tblinhousetransferheaderv5 where IS_DELETED = 0 "
        );
