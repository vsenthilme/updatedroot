...
@Slf4j
@Service
public class SparkStockReportServiceV2 {

    Properties connProp = new Properties();
    SparkSession sparkSession = null;

    public SparkStockReportServiceV2() throws ParseException {
        ...
        val df2 = sparkSession.read()
                ...
                .jdbc("jdbc:sqlserver://35.154.84.178;databaseName=WMS_CORE", "tblinventory", connProp)
                .repartition(16);
        df2.createOrReplaceTempView("tblinventoryv2core");
    }
...
//                + " as availableQty, "
                        ...
                        + "FROM tblinventoryv2core WHERE IS_DELETED = 0 "
        );
