...
<<<<<<< HEAD
    ...
    public static String getWalkarooCoreJdbcUrl() {
        return "jdbc:sqlserver://13.203.34.203;databaseName=WMS_WK";
=======
    //============================================ WMS Walkaroo V3================================
    public static String getWalkarooCoreJdbcUrl() {
...
<<<<<<< HEAD
    ...
    //============================================ WMS Walkaroo Dev V3================================
    public static String getWalkarooDevJdbcUrl() {
        return "jdbc:sqlserver://3.111.134.239;databaseName=WMS_WK";
    }

    public static Properties getWalkarooDevDatabaseConnectionProperties() {
        Properties connProp = new Properties();
        connProp.put("user", "sa");
=======
>>>>>>> 81dc64bb940937a238631ec1ef8d3af347b8ec9e
...
<<<<<<< HEAD
    ...
    public static String getJainCordJdbcUrl() {
        return "jdbc:sqlserver://43.230.156.163;databaseName=JAIN_CORD";
    }
