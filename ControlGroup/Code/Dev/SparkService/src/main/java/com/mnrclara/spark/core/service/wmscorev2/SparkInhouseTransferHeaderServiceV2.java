...
@Slf4j
@Service
public class SparkInhouseTransferHeaderServiceV2 {

    Properties connProp = new Properties();
    SparkSession sparkSession = null;

    public SparkInhouseTransferHeaderServiceV2() throws ParseException {
        ...
        val df2 = sparkSession.read()
                ...
                .jdbc("jdbc:sqlserver://35.154.84.178;databaseName=WMS_CORE", "tblinhousetransferheader", connProp)
                .repartition(16);
        df2.createOrReplaceTempView("tblinhousetransferheaderv5core");
    }
    ...
    public List<InhouseTransferHeader> getAllInhouseTransferHeader() throws ParseException {
        ...
        Dataset<Row> inhouseTransferHeaderQuery = sparkSession.sql("SELECT "
                ...
                + "From tblinhousetransferheaderv5core where IS_DELETED = 0 "
        );
