...
@Service
@Slf4j
public class WalkarooDevService {

    // SparkSession
    SparkSession spark = SparkSessionUtil.createSparkSession();

    Properties connProp = DatabaseConnectionUtil.getWalkarooDevDatabaseConnectionProperties();
    String jdbcUrl = DatabaseConnectionUtil.getWalkarooDevJdbcUrl();
