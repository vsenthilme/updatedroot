...
import com.mnrclara.spark.core.service.WalkarooDevService;
...
@RequestMapping("/walkaroo/dev")
public class WalkarooDevController {

    @Autowired
    WalkarooDevService walkarooService;
    ...
    public ResponseEntity<?> getOutboundLine(@RequestBody FindOutboundLineV2 findOutBoundHeader) {
        List<OutboundLineV2> outboundLineV2s = walkarooService.getOutBoundLineV3(findOutBoundHeader);
