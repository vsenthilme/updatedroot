...
import com.mnrclara.spark.core.model.wmscorev2.*;
import com.mnrclara.spark.core.service.WalkarooService;
import com.mnrclara.spark.core.service.walkaroo.*;
...
=======
    @Autowired
    WalkarooPeriodicHeaderService sparkPeriodicHeaderService;

    @Autowired
    WalkarooPerpetualHeaderService sparkPerpetualHeaderService;

    @Autowired
    WalkarooStockReportService sparkStockReportService;

    @Autowired
    WalkarooInhouseTransferHeaderService sparkInhouseTransferHeaderService;

    @Autowired
    WalkarooOrderStatusReportService sparkOrderStatusReportService;

    @Autowired
    WalkarooPerpetualLineService sparkPerpetualLineService;

    @Autowired
    WalkarooPeriodicLineService sparkPeriodicLineService;
