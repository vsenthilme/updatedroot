...
@Slf4j
@Service
public class SparkInventoryServiceJainCordV2 {

    Properties connProp = new Properties();
    SparkSession sparkSession = null;

    public SparkInventoryServiceJainCordV2() {
        ...
        val df2 = sparkSession.read()
                ...
                .jdbc("jdbc:sqlserver://43.230.156.163;databaseName=JAIN_CORD", "tblinventory", connProp)
                .repartition(16);
        df2.createOrReplaceTempView("tblinventoryv5jain");
    }
...
//                + "REF_FIELD_4 as referenceField4, "
                ...
                + "FROM tblinventoryv5jain WHERE IS_DELETED = 0 "
