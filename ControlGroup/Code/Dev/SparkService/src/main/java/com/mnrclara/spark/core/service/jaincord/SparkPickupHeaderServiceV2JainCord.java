...
import com.mnrclara.spark.core.model.jaincord.PickupHeaderJainCord;
...
public class SparkPickupHeaderServiceV2JainCord {
    ...
    public SparkPickupHeaderServiceV2JainCord() throws ParseException {
        ...
        val df2 = sparkSession.read()
                .option("fetchSize", "10000").jdbc("jdbc:sqlserver://43.230.156.163;databaseName=JAIN_CORD", "tblpickupheader", connProp)
                .repartition(16);
     ...
     */
    public List<PickupHeaderJainCord> findPickupHeaderV2(FindPickupHeaderV2 findPickupHeaderV2) throws ParseException {
...
//        imPickupHeaderQuery.cache();
        ...
        Encoder<PickupHeaderJainCord> pickupHeaderEncoder = Encoders.bean(PickupHeaderJainCord.class);
        Dataset<PickupHeaderJainCord> dataSetControlGroup = imPickupHeaderQuery.as(pickupHeaderEncoder);
        List<PickupHeaderJainCord> result = dataSetControlGroup.collectAsList();
        return result;
    }
}