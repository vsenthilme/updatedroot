...
import com.mnrclara.spark.core.model.jaincord.PutAwayLineJainCordNew;
...
@Service
@Slf4j
public class SparkJainCordPutAwayLineNewService {
     ...
     * @return
     */
    public List<PutAwayLineJainCordNew> getPutAwayLine(FindPutAwayLineV2 findPutAwayLineV2) {
        ...
        Properties connProp = DatabaseConnectionUtil.getJainCordDatabaseConnectionProperties();
        String jdbcUrl = DatabaseConnectionUtil.getJainCordJdbcUrl();
        ...
        data.show();
        Encoder<PutAwayLineJainCordNew> putAwayLineEncoder = Encoders.bean(PutAwayLineJainCordNew.class);
        Dataset<PutAwayLineJainCordNew> dataset = data.as(putAwayLineEncoder);
