package com.tekclover.core.controller.user;
...
import com.tekclover.core.config.PropertiesConfig;
import com.tekclover.core.model.user.AddUser;
import com.tekclover.core.model.user.ModifyUser;
import com.tekclover.core.model.user.User;
import com.tekclover.core.service.user.UserService;
...
public class UserController {
	...
	public ResponseEntity<?> getAll() {
    	...
    	log.info("User properties: " + prop.getUserId() + " : " + prop.getChangePwdSucessMsg());
