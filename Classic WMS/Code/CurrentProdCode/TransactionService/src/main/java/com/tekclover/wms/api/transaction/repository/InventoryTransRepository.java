...
public interface InventoryTransRepository extends PagingAndSortingRepository<InventoryTrans,Long>, JpaSpecificationExecutor<InventoryTrans> {
	 ...
	 * @return
	 */
	public Optional<InventoryTrans> 
	 ...
	 */
	public List<InventoryTrans> findByWarehouseIdAndItemCodeAndBinClassIdAndDeletionIndicator(String warehouseId, 
			String itemCode, Long binClassId, Long deletionIndicator);
	
	// referenceField10
	public List<InventoryTrans> findByWarehouseIdAndItemCodeAndBinClassIdAndReferenceField10InAndDeletionIndicator(String warehouseId, 
	 ...
	 * @return
	 */
	public List<InventoryTrans> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndPalletCodeAndCaseCodeAndPackBarcodesAndItemCodeAndDeletionIndicator(
	...
	// SQL Query for getting InventoryTrans
	...
	public Optional<InventoryTrans> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndPackBarcodesAndItemCodeAndStorageBinAndDeletionIndicator(
	...
	public List<InventoryTrans> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndDeletionIndicator(
			String languageId, String companyCode, String plantId, String warehouseId, String itemCode, Long deletionIndicator);

	public List<InventoryTrans> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndPalletCodeAndPackBarcodesAndStorageBinAndDeletionIndicator(
	...
	public List<InventoryTrans> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndPalletCodeAndPackBarcodesAndDeletionIndicator(
			String languageId, String companyCode, String plantId, String warehouseId, String itemCode,
			String palletCode, String packBarcodes, Long deletionIndicator);

	public List<InventoryTrans> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndPalletCodeAndDeletionIndicator(
			String languageId, String companyCode, String plantId, String warehouseId, String itemCode,
			String palletCode, Long deletionIndicator);

	public List<InventoryTrans> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndBinClassIdAndStorageBinAndStockTypeIdAndDeletionIndicator(
	...
	public List<InventoryTrans> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndStorageBinAndAllocatedQuantityAndDeletionIndicator(
	...
	public List<InventoryTrans> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndBinClassIdAndDeletionIndicator(
			String languageId, String companyCodeId, String plantId, String warehouseId, String itemCode,
	...
	public List<InventoryTrans> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndPackBarcodesAndItemCodeAndDeletionIndicator(
			String languageId, String companyCode, String plantId, String warehouseId, 
			String packBarcodes, String itemCode, Long deletionIndicator);

	public List<InventoryTrans> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndBinClassIdAndStorageBinAndStockTypeIdAndDeletionIndicatorAndInventoryQuantityGreaterThan(
			String languageId, String companyCode, String plantId, String warehouseId, String itemCode, Long binClassId,
			String storageBin, Long stockTypeId, Long l, Double d);

	public List<InventoryTrans> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndStorageBinAndStockTypeIdAndBinClassIdAndDeletionIndicator(
			String languageId, String companyCode, String plantId, String warehouseId, String itemCode,
			String storageBin, Long stockTypeId, Long binClassId, Long deletionIndicator);

	public Optional<InventoryTrans> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndPackBarcodesAndItemCodeAndBinClassIdNotAndDeletionIndicator(
			String languageId, String companyCode, String plantId, String warehouseId, String packBarcodes,
			String itemCode, Long binClassId, Long deletionIndicator);

	public List<InventoryTrans> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndAndStockTypeIdAndDeletionIndicator(
			String languageId, String companyCode, String plantId, String warehouseId, String itemCode,
			Long stockTypeId, Long l);
	
	public List<InventoryTrans> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndBinClassIdAndStorageBinAndStockTypeIdAndCreatedOnAndDeletionIndicatorAndInventoryQuantityGreaterThan(
			String languageId, String companyCode, String plantId, String warehouseId, String itemCode, Long binClassId,
	...
	public List<InventoryTrans> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndPackBarcodesAndBinClassIdAndDeletionIndicator(
			String languageId, String companyCode, String plantId, String warehouseId, String itemCode,
			String packBarcodes, Long binClassId, long l);

	public List<InventoryTrans> findByWarehouseIdAndStorageBinIn(String warehouseId, List<String> storageBin); 
	public List<InventoryTrans> findByWarehouseId(String warehouseId);
	public Page<InventoryTrans> findByWarehouseIdAndDeletionIndicator(String warehouseId, Long delFlag, Pageable pageable);

	@QueryHints(@javax.persistence.QueryHint(name="org.hibernate.fetchSize", value="100"))
	public Page<InventoryTrans> findByWarehouseIdInAndDeletionIndicator(List<String> warehouseId, Long delFlag, Pageable pageable);
	
	public Page<InventoryTrans> findByWarehouseIdInAndDeletionIndicatorAndItemCode(List<String> warehouseId, Long delFlag, String itemCode, Pageable pageable);
	
	@QueryHints(@javax.persistence.QueryHint(name="org.hibernate.fetchSize", value="1000"))
	public List<InventoryTrans> findByWarehouseIdInAndDeletionIndicator(List<String> warehouseId, Long delFlag);
	...
	public List<InventoryTrans> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndReferenceField10InAndBinClassIdAndInventoryQuantityGreaterThan(
			String languageId, String companyCode, String plantId, String warehouseId, String itemCode,
			List<String> storageSectionIds, long l, Double m);

	public List<InventoryTrans> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndReferenceField10InAndStockTypeIdAndBinClassIdAndInventoryQuantityGreaterThan(
			String languageId, String companyCode, String plantId, String warehouseId, String itemCode,
			List<String> storageSectionIds, Long stockTypeId, long l, Double m);

	public List<InventoryTrans> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndBinClassIdAndStorageBinAndStockTypeIdAndDeletionIndicatorAndInventoryQuantityGreaterThanOrderByInventoryQuantity(
			String languageId, String companyCode, String plantId, String warehouseId, String itemCode, Long binClassId,
			String storageBin, Long stockTypeId, long l, double d);
	...
	public Optional<InventoryTrans> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndStorageBinAndDeletionIndicator(
	...
	public List<InventoryTrans> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndAndStockTypeIdAndBinClassIdAndInventoryQuantityGreaterThanAndDeletionIndicator(
			String languageId, String companyCode, String plantId, String warehouseId, String itemCode,
...
//	Stream<InventoryImpl> findInventory (
	...
	//----------------------------STORED-PROCEDURE----------------------------------------------------------
	/*
	 * Calling this Stored Proc during Create orderManagementLine - update InventoryTrans
	 */
	@Transactional
	...
	@Query(" UPDATE InventoryTrans inv \r\n"
