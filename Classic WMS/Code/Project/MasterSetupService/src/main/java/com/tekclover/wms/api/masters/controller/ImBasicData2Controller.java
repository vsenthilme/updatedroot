...
public class ImBasicData2Controller {
	...
	@GetMapping("/{itemCode}")
	public ResponseEntity<?> getImBasicData2(@PathVariable String itemCode) {
    	ImBasicData2 imbasicdata2 = imbasicdata2Service.getImBasicData2(itemCode);
...
//	}
	...
	public ResponseEntity<?> patchImBasicData2(@PathVariable String itemCode, 
			@Valid @RequestBody UpdateImBasicData2 updateImBasicData2, @RequestParam String loginUserID) 
			throws IllegalAccessException, InvocationTargetException {
		ImBasicData2 createdImBasicData2 = imbasicdata2Service.updateImBasicData2(itemCode, updateImBasicData2, loginUserID);
		return new ResponseEntity<>(createdImBasicData2 , HttpStatus.OK);
	}
    
    @ApiOperation(response = ImBasicData2.class, value = "Delete ImBasicData2") // label for swagger
	@DeleteMapping("/{itemCode}")
	public ResponseEntity<?> deleteImBasicData2(@PathVariable String itemCode, @RequestParam String loginUserID) {
    	imbasicdata2Service.deleteImBasicData2(itemCode, loginUserID);
