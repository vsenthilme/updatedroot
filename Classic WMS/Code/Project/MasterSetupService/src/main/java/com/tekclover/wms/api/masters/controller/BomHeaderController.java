...
public class BomHeaderController {
	...
	public ResponseEntity<?> getBomHeader(@PathVariable String parentItemCode, @RequestParam String warehouseId) {
    	AddBomHeader bomheader = bomheaderService.getBomHeader(warehouseId, parentItemCode);
	...
	public ResponseEntity<?> patchBomHeader(@PathVariable String parentItemCode, @RequestParam String warehouseId,
			@Valid @RequestBody UpdateBomHeader updateBomHeader, @RequestParam String loginUserID) 
			throws IllegalAccessException, InvocationTargetException {
		UpdateBomHeader createdBomHeader = 
				bomheaderService.updateBomHeader(warehouseId, parentItemCode, loginUserID, updateBomHeader);
		return new ResponseEntity<>(createdBomHeader , HttpStatus.OK);
	}
	...
	public ResponseEntity<?> deleteBomHeader(@PathVariable String parentItemCode, @RequestParam String warehouseId, 
    	...
    	bomheaderService.deleteBomHeader(warehouseId, parentItemCode, loginUserID);
