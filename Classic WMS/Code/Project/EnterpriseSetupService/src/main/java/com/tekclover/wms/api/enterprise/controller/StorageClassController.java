...
public class StorageClassController {
	...
	public ResponseEntity<?> getStorageClass(@PathVariable Long storageClassId, @RequestParam String warehouseId) {
	   	StorageClass storageclass = storageclassService.getStorageClass(warehouseId, storageClassId);
	...
	public ResponseEntity<?> patchStorageClass(@PathVariable Long storageClassId, @RequestParam String warehouseId, 
			@Valid @RequestBody UpdateStorageClass updateStorageClass, @RequestParam String loginUserID) 
			throws IllegalAccessException, InvocationTargetException {
		StorageClass createdStorageClass = storageclassService.updateStorageClass(warehouseId, storageClassId, updateStorageClass, loginUserID);
		return new ResponseEntity<>(createdStorageClass , HttpStatus.OK);
	}
	...
	public ResponseEntity<?> deleteStorageClass(@PathVariable Long storageClassId, @RequestParam String warehouseId, 
    	...
    	storageclassService.deleteStorageClass(warehouseId, storageClassId, loginUserID);
