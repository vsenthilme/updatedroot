...
<<<<<<< HEAD
	...
	private void updateExistingInventory (PutAwayLine createdPutAwayLine) {
		...
		try {
			...
			newInventoryTrans.setWarehouseId(createdPutAwayLine.getWarehouseId());	
			newInventoryTrans.setPackBarcodes(createdPutAwayLine.getPackBarcodes());
			newInventoryTrans.setItemCode(createdPutAwayLine.getItemCode());	
			newInventoryTrans.setStorageBin(createdPutAwayLine.getConfirmedStorageBin());			
