...
//			log.info("result : " + result);
    ...
    // GET
    public NumberRange getNumberRange(Long numberRangeCode, Long fiscalYear, String warehouseId, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
...
//			log.info("result : " + result.getStatusCode());
    ...
    // GET
    public String getNextNumberRange(Long numberRangeCode, Long fiscalYear, String warehouseId, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
            ...
            HttpEntity<?> entity = new HttpEntity<>(headers);
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getIDMasterServiceApiUrl() + "numberRange/nextNumberRange/" + numberRangeCode)
                    .queryParam("fiscalYear", fiscalYear)
                    .queryParam("warehouseId", warehouseId);
...
//			log.info("result : " + result.getStatusCode());
    ...
    // CREATE
    public NumberRange createNumberRange(NumberRange newNumberRange, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
...
//			log.info("result : " + result.getStatusCode());
    ...
    // UPDATE
    public NumberRange updateNumberRange(String warehouseId, Long numberRangeCode, Long fiscalYear,
                                         String loginUserID, UpdateNumberRange updateNumberRange, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
...
//			log.info("result : " + result.getStatusCode());
    ...
    // DELETE
    public boolean deleteNumberRange(String warehouseId, Long numberRangeCode, Long fiscalYear,
...
//			log.info("result : " + result);
    ...
    public NumberRange[] findNumberRange(FindNumberRange findNumberRange, String authToken) {
        try {
            ...
            headers.add("User-Agent", "RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getIDMasterServiceApiUrl() + "numberRange/findNumberRange");
