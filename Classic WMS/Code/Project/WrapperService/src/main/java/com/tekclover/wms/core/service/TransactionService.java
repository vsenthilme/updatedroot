...
=======
	public InventoryStock[] getInventoryStockReport(String warehouseId, String itemCode, String fromCreatedOn, String toCreatedOn, String authToken) {
>>>>>>> 81dc64bb940937a238631ec1ef8d3af347b8ec9e
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
...
=======
			...
			HttpEntity<?> entity = new HttpEntity<>(headers);
			ResponseEntity<InventoryStock[]> result = getRestTemplate().exchange(builder.toUriString(),
					HttpMethod.GET, entity, InventoryStock[].class);
			log.info("result : " + result.getStatusCode());
>>>>>>> 81dc64bb940937a238631ec1ef8d3af347b8ec9e
			return result.getBody();
		} catch (Exception e) {
...
<<<<<<< HEAD
	...
	public void batchQualityReversalV2(List<ReversalInput> qualityReversalInputList, String loginUserID, String authToken) throws Exception {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "ClassicWMS RestTemplate");
