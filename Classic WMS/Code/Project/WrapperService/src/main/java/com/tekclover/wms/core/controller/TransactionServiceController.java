...
=======
   	@GetMapping("/reports/openingStockReport")
   	public ResponseEntity<?> getInventoryStockReport(
   			@RequestParam String warehouseId, 
   			@RequestParam (required=false) String itemCode, 
   			@RequestParam String fromCreatedOn, 
   			@RequestParam String toCreatedOn,
   			@RequestParam String authToken) throws java.text.ParseException {
       	InventoryStock[] inventoryReportList = transactionService.getInventoryStockReport(warehouseId, itemCode, 
       			fromCreatedOn, toCreatedOn, authToken);
>>>>>>> 81dc64bb940937a238631ec1ef8d3af347b8ec9e
   		return new ResponseEntity<>(inventoryReportList, HttpStatus.OK);
   	}
...
<<<<<<< HEAD
	...
	public ResponseEntity<?> cancelQualityLine(@Valid @RequestBody List<ReversalInput> reversalInputList, @RequestParam String loginUserID, @RequestParam String authToken) throws Exception {
		transactionService.batchQualityReversalV2(reversalInputList, loginUserID, authToken);
		return new ResponseEntity<>(HttpStatus.OK);
	}
