...
@Component({
  selector: 'app-prepetual-assign',
  templateUrl: './prepetual-assign.component.html',
  styleUrls: ['./prepetual-assign.component.scss']
})
export class PrepetualAssignComponent implements OnInit {
  title1 = "cycle Count";
  title2 = "Assign User";
