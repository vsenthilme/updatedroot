...
import { SelectionPopupComponent } from "../../Masters -1/masters/selection/selection-popup/selection-popup.component";
import { SetupPopupComponent } from "./setup-popup/setup-popup.component";
...
export interface selection {
  ...
  { no: "1", lineno: 'readonly', partner: 'readonly', product: 'readonly',description: 'readonly',refdocno: 'readonly', },
  { no: "1", lineno: 'readonly', partner: 'readonly', product: 'readonly',description: 'readonly',refdocno: 'readonly', },
  { no: "1", lineno: 'readonly', partner: 'readonly', product: 'readonly',description: 'readonly',refdocno: 'readonly', },
  { no: "1", lineno: 'readonly', partner: 'readonly', product: 'readonly',description: 'readonly',refdocno: 'readonly', },
  { no: "1", lineno: 'readonly', partner: 'readonly', product: 'readonly',description: 'readonly',refdocno: 'readonly', },
...
export class SetupSelectionComponent implements OnInit {
  ...
  selectionpara(): void {
    ...
    const dialogRef = this.dialog.open(SetupPopupComponent, {
      disableClose: true,
      width: '55%',
      maxWidth: '80%',
      position: { top: '9%', },
