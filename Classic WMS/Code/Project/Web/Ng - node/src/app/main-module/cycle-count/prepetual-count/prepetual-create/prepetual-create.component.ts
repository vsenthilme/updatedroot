...
@Component({
  selector: 'app-prepetual-create',
  templateUrl: './prepetual-create.component.html',
  styleUrls: ['./prepetual-create.component.scss']
})
export class PrepetualCreateComponent implements OnInit {
