...
@Component({
  selector: 'app-prepetual-couting',
  templateUrl: './prepetual-couting.component.html',
  styleUrls: ['./prepetual-couting.component.scss']
})
export class PrepetualCoutingComponent implements OnInit {
  title1 = "Cycle count";
  title2 = "Perpetual Count - Counting";
