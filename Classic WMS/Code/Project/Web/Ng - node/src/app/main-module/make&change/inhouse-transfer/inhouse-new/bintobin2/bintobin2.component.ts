...
@Component({
  selector: 'app-bintobin2',
  templateUrl: './bintobin2.component.html',
  styleUrls: ['./bintobin2.component.scss']
})
export class Bintobin2Component implements OnInit {
  
  ngOnInit(): void {
  }

  displayedColumns: string[] = ['select', 'no', 'dimensions', 'length','uom','pack','available','transfer',];
