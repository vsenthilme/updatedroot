...
@Table(
		...
		uniqueConstraints = { 
				@UniqueConstraint (
						name = "unique_key_spanid",
						columnNames = {"C_ID", "PLANT_ID", "WH_ID", "FL_ID","ST_SEC_ID","AISLE_ID","ROW_ID","SPAN_ID","LANG_ID"})
				}
		)
@IdClass(SpanIdCompositeKey.class)
public class SpanId {
	...
	@Id
	@Column(name = "FL_ID", columnDefinition = "nvarchar(10)")
	private String floorId;

	@Id
	@Column(name = "ST_SEC_ID", columnDefinition = "nvarchar(10)")
	...
	@Column(name = "SPAN_TEXT", columnDefinition = "nvarchar(500)")
