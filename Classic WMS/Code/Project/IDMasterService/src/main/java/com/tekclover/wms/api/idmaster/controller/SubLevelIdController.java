...
public class SubLevelIdController {
	...
	public ResponseEntity<?> getSubLevelId(@PathVariable String subLevelId,
    	...
    	SubLevelId sublevelid = 
    			sublevelidService.getSubLevelId(warehouseId, subLevelId, levelId);
	...
	public ResponseEntity<?> patchSubLevelId(@PathVariable String subLevelId,
		...
		SubLevelId createdSubLevelId = 
				sublevelidService.updateSubLevelId(warehouseId, subLevelId,levelId, loginUserID, updateSubLevelId);
		return new ResponseEntity<>(createdSubLevelId , HttpStatus.OK);
	}
	...
	public ResponseEntity<?> deleteSubLevelId(@PathVariable String subLevelId,
			@RequestParam String warehouseId,@RequestParam String levelId, @RequestParam String loginUserID) {
    	sublevelidService.deleteSubLevelId(warehouseId, subLevelId, levelId, loginUserID);
