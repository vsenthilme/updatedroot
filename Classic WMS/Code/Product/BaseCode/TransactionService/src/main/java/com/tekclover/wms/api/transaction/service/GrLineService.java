...
public class GrLineService extends BaseService {
     ...
     * @return
     */
    public List<GrLine> getGrLine(String refDocNumber,String companyCode, String plantId, String languageId, String packBarcodes) {
        List<GrLine> grLine =
     ...
     * @return
     */
    public List<PackBarcode> generatePackBarcode(Long acceptQty, Long damageQty, String warehouseId, String companyCode,
    ...
    public List<GrLine> createGrLine(@Valid List<AddGrLine> newGrLines, String loginUserID)
        ...
        try {
            ...
            for (GrLine grLine : createdGRLines) {
                 ...
                 */
                List<GrHeader> grHeaders = grHeaderService.getGrHeader(grLine.getWarehouseId(),grLine.getCompanyCode(),grLine.getPlantId(),
                        grLine.getLanguageId(), grLine.getGoodsReceiptNo(),
                 ...
                 */
                InboundLine inboundLine = inboundLineService.getInboundLine(grLine.getWarehouseId(),grLine.getCompanyCode(),grLine.getPlantId(),grLine.getLanguageId(),
    ...
    private void createPutAwayHeader(GrLine createdGRLine, String loginUserID) {
        ...
        if (createdGRLine != null && createdGRLine.getAssignedUserId() != null) {
            ...
            AuthToken authTokenForIDMasterService = authTokenService.getIDMasterServiceAuthToken();
            long NUM_RAN_CODE = 7;
            String nextPANumber = getNextRangeNumber(NUM_RAN_CODE, createdGRLine.getWarehouseId(), createdGRLine.getCompanyCode(),
                    createdGRLine.getPlantId(),createdGRLine.getLanguageId(), authTokenForIDMasterService.getAccess_token());
...
//							createdGRLine.getItemCode(), 1L, 0L);
    ...
    public void deleteGrLine(String warehouseId, String preInboundNo, String refDocNumber, String goodsReceiptNo,
                             String palletCode, String caseCode,String companyCode, String plantId, String languageId, String packBarcodes, Long lineNo, String itemCode, String loginUserID)
            throws IllegalAccessException, InvocationTargetException {
        GrLine grLine = getGrLine(warehouseId,companyCode,plantId,languageId, preInboundNo, refDocNumber, goodsReceiptNo, palletCode, caseCode,
                packBarcodes, lineNo, itemCode);
        if (grLine != null) {
