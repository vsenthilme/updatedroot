...
public class PickupHeaderService {
	 ...
	 * @return
	 */
	public long getPickupHeaderCountForDeliveryConfirmation (String warehouseId,String companyCodeId,String plantId,String languageId, String refDocNumber, String preOutboundNo, Long statusId) {
