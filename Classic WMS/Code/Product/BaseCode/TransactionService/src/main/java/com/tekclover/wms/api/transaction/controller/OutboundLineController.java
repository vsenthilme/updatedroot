...
public class OutboundLineController {
    ...
    public ResponseEntity<?> deliveryConfirmation(@RequestParam String warehouseId, @RequestParam String companyCodeId,
        ...
        List<OutboundLine> createdOutboundLine =
                outboundlineService.deliveryConfirmation(warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, partnerCode, loginUserID);
        return new ResponseEntity<>(createdOutboundLine, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> patchOutboundLine(@PathVariable Long lineNumber, @RequestParam String companyCodeId,
        ...
        OutboundLine updatedOutboundLine =
                outboundlineService.updateOutboundLine(warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, partnerCode,
