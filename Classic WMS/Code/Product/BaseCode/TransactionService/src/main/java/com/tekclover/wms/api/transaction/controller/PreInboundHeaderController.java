...
@Slf4j
@Validated
@Api(tags = {"PreInboundHeader"}, value = "PreInboundHeader  Operations related to PreInboundHeaderController")
// label for swagger
...
public class PreInboundHeaderController {
    ...
    public ResponseEntity<?> getPreInboundHeader(@PathVariable String preInboundNo, @RequestParam String companyCode,
                                                 @RequestParam String languageId, @RequestParam String plantId, @RequestParam String warehouseId) {
        PreInboundHeader preinboundheader = preinboundheaderService.getPreInboundHeader(preInboundNo, warehouseId, companyCode, plantId, languageId);
...
//       	log.info("PreInboundHeader : " + preinboundheader);
    ...
    public ResponseEntity<?> patchPreInboundHeader(@PathVariable String preInboundNo, @RequestParam String warehouseId,
        ...
        PreInboundHeader createdPreInboundHeader =
                preinboundheaderService.updatePreInboundHeader(preInboundNo, warehouseId, companyCode, plantId, languageId, updatePreInboundHeader, loginUserID);
        return new ResponseEntity<>(createdPreInboundHeader, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> deletePreInboundHeader(@PathVariable String preInboundNo, @RequestParam String warehouseId,
        ...
        preinboundheaderService.deletePreInboundHeader(preInboundNo, companyCode, plantId, languageId, warehouseId, loginUserID);
