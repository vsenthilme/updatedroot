...
public class InventoryController {
    ...
    public ResponseEntity<?> getInventory(@PathVariable Long stockTypeId, @RequestParam String warehouseId,
        ...
        Inventory inventory =
                inventoryService.getInventory(warehouseId,companyCode,plantId,languageId,
    ...
    public ResponseEntity<?> patchInventory(@PathVariable Long stockTypeId, @RequestParam String warehouseId,
        ...
        Inventory createdInventory =
                inventoryService.updateInventory(warehouseId,companyCodeId,plantId,languageId, packBarcodes, itemCode, storageBin, stockTypeId,
