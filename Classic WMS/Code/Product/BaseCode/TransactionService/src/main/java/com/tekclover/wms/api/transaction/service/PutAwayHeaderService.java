...
public class PutAwayHeaderService {
     ...
     * @return
     */
    public List<PutAwayHeader> getPutAwayHeader(String warehouseId, String companyCode, String plantId,
                                                String languageId, String preInboundNo, String refDocNumber, String putAwayNumber) {
     ...
     * @return
     */
    public long getPutawayHeaderByStatusId(String warehouseId, String companyCode, String plantId, String preInboundNo, String refDocNumber) {
        long putAwayHeaderStatusIdCount = putAwayHeaderRepository.getPutawayHeaderCountByStatusId(
                companyCode, plantId, warehouseId, preInboundNo, refDocNumber);
    ...
    public PutAwayHeader updatePutAwayHeader(String warehouseId, String preInboundNo, String refDocNumber, String companyCodeId,
            ...
            throws IllegalAccessException, InvocationTargetException {
        PutAwayHeader dbPutAwayHeader = getPutAwayHeader(warehouseId, companyCodeId, plantId, languageId, preInboundNo, refDocNumber, goodsReceiptNo,
     ...
     * @throws IllegalAccessException
     */
    public List<PutAwayHeader> updatePutAwayHeader(String refDocNumber, String companyCodeId, String plantId, String languageId, String packBarcodes, String loginUserID)
            throws IllegalAccessException, InvocationTargetException {
         ...
         */
        List<PutAwayHeader> putAwayHeaderList = getPutAwayHeader(refDocNumber, companyCodeId, plantId, languageId, packBarcodes);
        List<GrLine> grLineList = grLineService.getGrLine(refDocNumber, companyCodeId, plantId, languageId, packBarcodes);
        ...
        for (PutAwayHeader dbPutAwayHeader : putAwayHeaderList) {
            ...
            if (dbPutAwayHeader.getStatusId() == 20L) {
                ...
                for (PutAwayLine dbPutAwayLine : putAwayLineList) {
                     ...
                     */
                    InboundLine inboundLine = inboundLineService.getInboundLine(dbPutAwayHeader.getWarehouseId(),
                            dbPutAwayHeader.getCompanyCodeId(), dbPutAwayHeader.getPlantId(), dbPutAwayHeader.getLanguageId(), refDocNumber, dbPutAwayHeader.getPreInboundNo(),
