...
public class OutboundLineService extends BaseService {
     ...
     * @return
     */
    public OutboundLine getOutboundLine(String warehouseId, String companyCodeId, String plantId, String languageId, String preOutboundNo, String refDocNumber, String partnerCode,
        ...
        OutboundLine outboundLine = outboundLineRepository.findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndPreOutboundNoAndRefDocNumberAndPartnerCodeAndLineNumberAndItemCodeAndDeletionIndicator(
                warehouseId, companyCodeId, plantId, warehouseId, preOutboundNo, refDocNumber, partnerCode, lineNumber, itemCode, 0L);
        if (outboundLine != null) {
            return outboundLine;
        }
        throw new BadRequestException("The given OutboundLine ID : " +
...
//		}
    ...
    public List<OutboundLine> deliveryConfirmation(String warehouseId, String companyCodeId, String plantId, String languageId, String preOutboundNo, String refDocNumber,
        ...
        long orderManagementLineCount = orderManagementLineService.getOrderManagementLine(warehouseId, companyCodeId, plantId, languageId, refDocNumber, preOutboundNo, Arrays.asList(42L, 43L));
        ...
        long pickupHeaderCount = pickupHeaderService.getPickupHeaderCountForDeliveryConfirmation(warehouseId, companyCodeId, plantId, languageId, refDocNumber, preOutboundNo, 48L);
        ...
        long qualityHeaderCount = qualityHeaderService.getQualityHeaderCountForDeliveryConfirmation(warehouseId, companyCodeId, plantId, languageId, refDocNumber, preOutboundNo, 54L);
        ...
        long outboundLineListCount = getOutboundLine(warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, partnerCode, statusIdsToBeChecked);
        ...
        if (!isConditionMet) {
             ...
             */
            OutboundHeader confirmedOutboundHeader = outboundHeaderService.getOutboundHeader(warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber);
            List<OutboundLine> confirmedOutboundLines = getOutboundLine(warehouseId,companyCodeId,plantId,languageId, preOutboundNo, refDocNumber);
        ...
        if (axapiResponse.getStatusCode() != null && axapiResponse.getStatusCode().equalsIgnoreCase("200")) {
            try {
                ...
                List<OutboundLine> outboundLineByStatus57List = findOutboundLineByStatus(warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, partnerCode, statusId57);
                ...
                OutboundHeader isOrderConfirmedOutboundHeader = outboundHeaderService.getOutboundHeader(warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber);
...
//	}
    ...
    private OutboundReversal createOutboundReversal(Warehouse warehouse, String reversalType, String refDocNumber,
        ...
        String OB_REVERSAL_NO = getNextRangeNumber(NUM_RAN_CODE, warehouse.getWarehouseId(), warehouse.getCompanyCode(), warehouse.getPlantId(), warehouse.getLanguageId());
