...
public class ContainerReceiptController {
	...
	public ResponseEntity<?> patchContainerReceipt(@PathVariable String containerReceiptNo, @RequestParam String companyCode, @RequestParam String plantId,
		...
		ContainerReceipt createdContainerReceipt =
				containerreceiptService.updateContainerReceipt(preInboundNo, containerReceiptNo, companyCode, languageId,
