	...
	public List<QualityLine> createQualityLine(List<AddQualityLine> newQualityLines, String loginUserID)
		...
		try {
			...
			for (QualityLine dbQualityLine : createdQualityLineList) {
				...
				String DLV_ORD_NO = getNextRangeNumber(NUM_RAN_CODE, dbQualityLine.getWarehouseId(),dbQualityLine.getCompanyCodeId(),dbQualityLine.getPlantId(),dbQualityLine.getLanguageId());
