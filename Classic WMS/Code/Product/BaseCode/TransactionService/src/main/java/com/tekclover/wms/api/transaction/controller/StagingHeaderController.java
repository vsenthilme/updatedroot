...
public class StagingHeaderController {
    ...
    public ResponseEntity<?> getStagingHeader(@PathVariable String stagingNo, @RequestParam String languageId,
        ...
        StagingHeader stagingheader = stagingheaderService.getStagingHeader(warehouseId, preInboundNo,companyCode,plantId,languageId, refDocNumber, stagingNo);
    ...
    public ResponseEntity<?> getStagingHeader(@PathVariable Long numberOfCases, @RequestParam String warehouseId,
        ...
        List<String> stagingheader = stagingheaderService.generateNumberRanges(numberOfCases, warehouseId,companyCode,languageId,plantId);
        log.info("StagingHeader : " + stagingheader);
        return new ResponseEntity<>(stagingheader, HttpStatus.OK);
    }
}