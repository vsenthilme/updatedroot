...
public class StagingLineController {
    ...
    public ResponseEntity<?> getStagingLine(@PathVariable Long lineNo, @RequestParam String companyCode,
        ...
        StagingLineEntity stagingline =
                staginglineService.getStagingLine(warehouseId, companyCode, plantId, languageId, preInboundNo, refDocNumber,
                        stagingNo, palletCode, caseCode, lineNo, itemCode);
    ...
    public ResponseEntity<?> getStagingLineForInboundLine(@PathVariable Long lineNo, @RequestParam String warehouseId,
                                                          ...
                                                          @RequestParam String plantId, @RequestParam String refDocNumber,
                                                          @RequestParam String preInboundNo, @RequestParam String itemCode) {
        List<StagingLineEntity> stagingline = staginglineService.getStagingLine(warehouseId,
                companyCode, plantId, languageId, refDocNumber, preInboundNo, lineNo, itemCode);
        log.info("StagingLine : " + stagingline);
        return new ResponseEntity<>(stagingline, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> patchStagingLine(@PathVariable Long lineNo, @RequestParam String warehouseId, @RequestParam String companyCode,
        ...
        StagingLineEntity createdStagingLine =
                staginglineService.updateStagingLine(warehouseId, companyCode, plantId, languageId, preInboundNo,
                        refDocNumber, stagingNo, palletCode, caseCode, lineNo, itemCode, loginUserID, updateStagingLine);
        return new ResponseEntity<>(createdStagingLine, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> patchStagingLineForCaseConfirmation(@RequestBody List<CaseConfirmation> caseConfirmations, @RequestParam String companyCode,
                                                                 @RequestParam String plantId, @RequestParam String languageId,
                                                                 @RequestParam String caseCode, @RequestParam String loginUserID)
            throws IllegalAccessException, InvocationTargetException {
        List<StagingLineEntity> createdStagingLine =
                staginglineService.caseConfirmation(caseConfirmations, caseCode, companyCode, plantId, languageId, loginUserID);
        return new ResponseEntity<>(createdStagingLine, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> deleteStagingLine(@PathVariable Long lineNo, @RequestParam String warehouseId,
        ...
        staginglineService.deleteStagingLine(companyCode, plantId, languageId, warehouseId,
    ...
    public ResponseEntity<?> deleteCases(@PathVariable Long lineNo, @RequestParam String preInboundNo,
                                         ...
                                         @RequestParam String plantId, @RequestParam String languageId,
                                         @RequestParam String itemCode, @RequestParam String loginUserID) {
        staginglineService.deleteCases(companyCode, plantId, languageId, preInboundNo, lineNo, itemCode, caseCode, loginUserID);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
}