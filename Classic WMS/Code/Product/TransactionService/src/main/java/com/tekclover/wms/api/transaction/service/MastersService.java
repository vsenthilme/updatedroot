...
//     GET ImBasicData1
    ...
    public ImBasicData1 getImBasicData1ByItemCode(String companyCodeId, String plantId, String languageId,
                                                  String warehouseId, String itemCode, String uomId, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
            ...
            HttpEntity<?> entity = new HttpEntity<>(headers);
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getMastersServiceApiUrl() + "imbasicdata1/imbasicdata1/" + itemCode)
...
//    }
    ...
    public BomHeader getBomHeader(String companyCode, String plantId, String languageId,
                                  String warehouseId, String parentItemCode, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
    ...
    public BomLine[] getBomLine(String companyCode, String plantId, String languageId,
                                Long bomNumber, String warehouseId, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
...
//			throw e;
    ...
    public StorageBin getStorageBin(String storageBin, String warehouseId,
    ...
    // GET StorageBin - /{warehouseId}/bins/{binClassId}
    public StorageBin getStorageBin(String companyCode, String plantId,
    ...
    // PATCH
    public StorageBin updateStorageBin(String storageBin, StorageBin modifiedStorageBin,
