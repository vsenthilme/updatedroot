...
public class PerpetualHeaderController {
    ...
    public ResponseEntity<?> getPerpetualHeader(@PathVariable String cycleCountNo, @RequestParam String companyCodeId,
        ...
        PerpetualHeader perpetualheader =
                perpetualheaderService.getPerpetualHeaderWithLine(warehouseId, companyCodeId, plantId, languageId, cycleCountTypeId, cycleCountNo,
    ...
    public ResponseEntity<?> patchPerpetualHeader(@PathVariable String cycleCountNo, @RequestParam String warehouseId,
        ...
        PerpetualHeader createdPerpetualHeader =
                perpetualheaderService.updatePerpetualHeader(warehouseId, companyCodeId, plantId, languageId, cycleCountTypeId, cycleCountNo, movementTypeId,
    ...
    public ResponseEntity<?> deletePerpetualHeader(@PathVariable String cycleCountNo, @RequestParam String warehouseId, @RequestParam String companyCodeId,
        ...
        perpetualheaderService.deletePerpetualHeader(warehouseId,companyCodeId,plantId,languageId, cycleCountTypeId, cycleCountNo, movementTypeId,
