...
public class PutAwayHeaderService {
     ...
     * @return
     */
    public PutAwayHeader getPutAwayHeader(String warehouseId, String companyCode, String plantId, String languageId, String preInboundNo, String refDocNumber, String goodsReceiptNo,
     ...
     * @return
     */
    public List<PutAwayHeader> getPutAwayHeader(String warehouseId, String companyCode, String plantId, String languageId, String preInboundNo, String refDocNumber) {
        List<PutAwayHeader> putAwayHeader =
    ...
    public List<PutAwayHeader> getPutAwayHeaderV2(String companyCode, String plantId, String languageId,
                                                 String warehouseId, String refDocNumber, String packBarcodes) {
        List<PutAwayHeader> putAwayHeader =
                putAwayHeaderRepository.findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndRefDocNumberAndPackBarcodesAndDeletionIndicator(
                        languageId,
                        companyCode,
                        plantId,
                        warehouseId,
     ...
     * @return
     */
    public long getPutawayHeaderByStatusId(String companyId, String plantId, String warehouseId,
                                           String preInboundNo, String refDocNumber) {
        long putAwayHeaderStatusIdCount = putAwayHeaderRepository.getPutawayHeaderCountByStatusId(
                companyId, plantId, warehouseId, preInboundNo, refDocNumber);
     ...
     * @return
     */
    public List<PutAwayHeader> getPutAwayHeader(String refDocNumber, String companyCodeId, String languageId, String plantId, String packBarcodes) {
        List<PutAwayHeader> putAwayHeader =
     ...
     * @return
     */
    public List<PutAwayHeader> getPutAwayHeader(String refDocNumber, String languageId, String companyCode, String plantId) {
     ...
     * @throws InvocationTargetException
     */
    public PutAwayHeader updatePutAwayHeader(String warehouseId, String preInboundNo, String refDocNumber, String companyCodeId,
                                             String plantId, String languageId, String goodsReceiptNo,
                                             String palletCode, String caseCode, String packBarcodes,
                                             String putAwayNumber, String proposedStorageBin,
                                             String loginUserID, UpdatePutAwayHeader updatePutAwayHeader)
            throws IllegalAccessException, InvocationTargetException {

        PutAwayHeader dbPutAwayHeader = getPutAwayHeader(warehouseId, companyCodeId, plantId,
                languageId, preInboundNo, refDocNumber, goodsReceiptNo,
     ...
     * @throws InvocationTargetException
     */
    public List<PutAwayHeader> updatePutAwayHeader(String warehouseId, String companyCodeId, String plantId, String languageId,
                                                   String preInboundNo, String refDocNumber, Long statusId, String loginUserID)
            throws IllegalAccessException, InvocationTargetException {
        List<PutAwayHeader> dbPutAwayHeaderList = getPutAwayHeader(warehouseId, companyCodeId, plantId, languageId, preInboundNo, refDocNumber);
     ...
     * @throws IllegalAccessException
     */
    public List<PutAwayHeader> updatePutAwayHeader(String refDocNumber, String companyCodeId,String warehouseId,
                                                   String plantId, String languageId, String packBarcodes, String loginUserID)
            throws IllegalAccessException, InvocationTargetException {
         ...
         */
        List<PutAwayHeader> putAwayHeaderList = getPutAwayHeaderV2(companyCodeId, plantId, languageId, warehouseId, refDocNumber, packBarcodes);
        List<GrLine> grLineList = grLineService.getGrLine(companyCodeId, languageId, plantId, warehouseId, refDocNumber, packBarcodes);
        ...
        for (PutAwayHeader dbPutAwayHeader : putAwayHeaderList) {
            ...
            if (dbPutAwayHeader.getStatusId() == 20L) {
                 ...
                 */
                long STATUS_ID_22_COUNT = putAwayLineService.getPutAwayLineByStatusId(companyCodeId, plantId, languageId, warehouseId,
                ...
                List<PutAwayLine> putAwayLineList =
                        putAwayLineService.getPutAwayLine(dbPutAwayHeader.getCompanyCodeId(),
                ...
                for (PutAwayLine dbPutAwayLine : putAwayLineList) {
                     ...
                     */
                    boolean isDeleted = inventoryService.deleteInventory(companyCodeId, plantId, languageId, warehouseId, packBarcodes, itemCode);
                    ...
                    InboundLine inboundLine = inboundLineService.getInboundLine(
                            dbPutAwayHeader.getWarehouseId(), dbPutAwayHeader.getCompanyCodeId(),
                            dbPutAwayHeader.getPlantId(), dbPutAwayHeader.getLanguageId(),
    ...
    private void createInventoryMovement(GrLine grLine, String caseCode, String palletCode, String storageBin) {
        ...
        List<Inventory> inventoryList = inventoryService.getInventory(grLine.getWarehouseId(), grLine.getItemCode(), 1L,
                grLine.getCompanyCode(), grLine.getPlantId(), grLine.getLanguageId());
    ...
    public void updatePutAwayHeader(String warehouseId, String preInboundNo, String refDocNumber, Long lineNo,
                                    String itemCode, String companyCode, String plantId, String languageId, Long statusId, String loginUserID) {
        List<PutAwayHeader> putAwayHeaderList = getPutAwayHeader(warehouseId, companyCode, plantId, languageId, preInboundNo, refDocNumber);
        for (PutAwayHeader dbPutAwayHeader : putAwayHeaderList) {
            dbPutAwayHeader.setStatusId(statusId);
            dbPutAwayHeader.setUpdatedBy(loginUserID);
            dbPutAwayHeader.setUpdatedOn(new Date());
     ...
     * @param loginUserID
     */
    public void deletePutAwayHeader(String warehouseId, String companyCode, String plantId, String languageId, String preInboundNo, String refDocNumber, String goodsReceiptNo,
                                    String palletCode, String caseCode, String packBarcodes, String putAwayNumber,
                                    String proposedStorageBin, String loginUserID) {
        PutAwayHeader putAwayHeader = getPutAwayHeader(warehouseId, companyCode, plantId, languageId, preInboundNo, refDocNumber, goodsReceiptNo,
                palletCode, caseCode, packBarcodes, putAwayNumber, proposedStorageBin);
