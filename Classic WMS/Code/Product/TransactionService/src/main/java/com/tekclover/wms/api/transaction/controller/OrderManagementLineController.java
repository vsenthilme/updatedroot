...
public class OrderManagementLineController {
    ...
    public ResponseEntity<?> getOrderManagementLine(@PathVariable String refDocNumber, @RequestParam String companyCodeId, @RequestParam String plantId,
        ...
        OrderManagementLine ordermangementline =
                ordermangementlineService.getOrderManagementLine(companyCodeId, plantId, languageId, warehouseId, preOutboundNo, refDocNumber, partnerCode,
    ...
    public ResponseEntity<?> unallocateOrderManagementLine(@RequestParam String warehouseId, @RequestParam String companyCodeId,
                                                           @RequestParam String plantId, @RequestParam String languageId, @RequestParam String preOutboundNo,
        ...
        OrderManagementLine updatedOrderManagementLine =
                ordermangementlineService.doUnAllocation(warehouseId, companyCodeId, languageId, plantId, preOutboundNo, refDocNumber, partnerCode, lineNumber,
    ...
    public ResponseEntity<?> allocateOrderManagementLine(@RequestParam String warehouseId, @RequestParam String companyCodeId,
            ...
            throws IllegalAccessException, InvocationTargetException {
        OrderManagementLine updatedOrderManagementLine =
                ordermangementlineService.doAllocation(companyCodeId, plantId, languageId, warehouseId, preOutboundNo, refDocNumber,
                        partnerCode, lineNumber, itemCode, loginUserID);
        return new ResponseEntity<>(updatedOrderManagementLine, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> patchOrderMangementLine(@PathVariable String refDocNumber, @RequestParam String companyCodeId,
                                                     @RequestParam String plantId, @RequestParam String languageId,
                                                     ...
                                                     @Valid @RequestBody OrderManagementLine updateOrderManagementLine)
            throws IllegalAccessException, InvocationTargetException {

        OrderManagementLine createdOrderMangementLine =
                ordermangementlineService.updateOrderManagementLine(companyCodeId, plantId, languageId, warehouseId, preOutboundNo, refDocNumber,
                        partnerCode, lineNumber, itemCode, proposedStorageBin, proposedPackCode, loginUserID, updateOrderManagementLine);
    ...
    public ResponseEntity<?> deleteOrderManagementLine(@PathVariable String refDocNumber, @RequestParam String companyCodeId,
                                                       @RequestParam String plantId, @RequestParam String languageId,
                                                       @RequestParam String warehouseId, @RequestParam String preOutboundNo,
                                                       @RequestParam String partnerCode, @RequestParam Long lineNumber,
                                                       @RequestParam String itemCode, @RequestParam String proposedStorageBin,
                                                       @RequestParam String proposedPackCode, @RequestParam String loginUserID) {
        ordermangementlineService.deleteOrderManagementLine(companyCodeId, plantId, languageId, warehouseId, preOutboundNo, refDocNumber, partnerCode,
