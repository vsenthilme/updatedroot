...
public class OutboundLineService extends BaseService {
     ...
     * @return
     */
    public long getOutboundLine(String warehouseId, String companyCodeId, String plantId, String languageId, String preOutboundNo,
                                String refDocNumber, String partnerCode, List<Long> statusIds) {
        long outboundLineCount =
                outboundLineRepository.getOutboudLineByWarehouseIdAndCompanyCodeIdAndPlantIdAndLanguageIdAndPreOutboundNoAndRefDocNumberAndPartnerCodeAndStatusIdInAndDeletionIndicator(
                        warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, partnerCode, statusIds, 0);
     ...
     * @return
     */
    public List<OutboundLine> findOutboundLineByStatus(String warehouseId, String companyCodeId, String plantId, String languageId, String preOutboundNo,
                                                       String refDocNumber, String partnerCode, List<Long> statusIds) {
        List<OutboundLine> outboundLine;
        try {
            outboundLine = outboundLineRepository.findByWarehouseIdAndCompanyCodeIdAndPlantIdAndLanguageIdAndPreOutboundNoAndRefDocNumberAndPartnerCodeAndStatusIdInAndDeletionIndicator(
                    warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, partnerCode, statusIds, 0L);
            if (outboundLine == null) {
                throw new BadRequestException("The given OutboundLine ID : "
     ...
     * @return
     */
    public List<OutboundLine> getOutboundLine(String warehouseId, String companyCodeId, String languageId, String plantId, String preOutboundNo,
                                              String refDocNumber) {
        List<OutboundLine> outboundLine =
                outboundLineRepository.findByWarehouseIdAndCompanyCodeIdAndPlantIdAndLanguageIdAndPreOutboundNoAndRefDocNumberAndReferenceField2AndDeletionIndicator(
                        warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, null, 0L);
     ...
     * @return
     */
    public List<OutboundLine> getOutboundLineForReports(String warehouseId, String companyCodeId, String plantId, String languageId, String preOutboundNo,
                                                        String refDocNumber) {
        List<OutboundLine> outboundLine =
                outboundLineRepository.findByWarehouseIdAndCompanyCodeIdAndPlantIdAndLanguageIdAndPreOutboundNoAndRefDocNumberAndReferenceField2AndDeletionIndicator(
                        warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, null, 0L);
     ...
     * @return
     */
    public OutboundLine getOutboundLine(String warehouseId, String companyCodeId, String plantId, String languageId,
                                        String preOutboundNo, String refDocNumber, String partnerCode,
                                        Long lineNumber, String itemCode) {
        OutboundLine outboundLine = outboundLineRepository.findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndPreOutboundNoAndRefDocNumberAndPartnerCodeAndLineNumberAndItemCodeAndDeletionIndicator(
                languageId, companyCodeId, plantId, warehouseId, preOutboundNo, refDocNumber, partnerCode, lineNumber, itemCode, 0L);
        if (outboundLine != null) {
            return outboundLine;
        }
        throw new BadRequestException("The given OutboundLine ID : " +
...
//		}
     ...
     * @throws InvocationTargetException
     */
    public List<OutboundLine> deliveryConfirmation(String warehouseId, String companyCodeId, String plantId, String languageId, String preOutboundNo, String refDocNumber,
        ...
        long outboundLineProcessedCount = getOutboundLine(warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, partnerCode, statusIds);
        ...
        long orderManagementLineCount = orderManagementLineService.getOrderManagementLine(
                warehouseId, companyCodeId, plantId, languageId, refDocNumber, preOutboundNo, Arrays.asList(42L, 43L));
        ...
        long pickupHeaderCount = pickupHeaderService.getPickupHeaderCountForDeliveryConfirmation(
                warehouseId, companyCodeId, plantId, languageId, refDocNumber, preOutboundNo, 48L);
        ...
        long qualityHeaderCount = qualityHeaderService.getQualityHeaderCountForDeliveryConfirmation(
                warehouseId, companyCodeId, plantId, languageId, refDocNumber, preOutboundNo, 54L);
        ...
        long outboundLineListCount = getOutboundLine(warehouseId, companyCodeId, plantId,
                languageId, preOutboundNo, refDocNumber, partnerCode, statusIdsToBeChecked);
        ...
        if (!isConditionMet) {
             ...
             */
            OutboundHeader confirmedOutboundHeader = outboundHeaderService.getOutboundHeader(
                    warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber);
            List<OutboundLine> confirmedOutboundLines = getOutboundLine(
                    warehouseId, companyCodeId, languageId, plantId, preOutboundNo, refDocNumber);
...
//            }
        ...
        if (axapiResponse.getStatusCode() != null && axapiResponse.getStatusCode().equalsIgnoreCase("200")) {
            try {
                ...
                List<OutboundLine> outboundLineByStatus57List = findOutboundLineByStatus(
                        warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, partnerCode, statusId57);
                ...
                outboundLineRepository.updateOutboundLineStatus(warehouseId, companyCodeId, plantId, languageId, refDocNumber, STATUS_ID_59, lineNumbers, new Date());
                log.info("OutboundLine updated ");

                //----------------Outbound Header update----------------------------------------------------------------------------------------
                outboundHeaderRepository.updateOutboundHeaderStatus(warehouseId, companyCodeId, plantId, languageId, refDocNumber, STATUS_ID_59, new Date());
                OutboundHeader isOrderConfirmedOutboundHeader = outboundHeaderService.getOutboundHeader(
                        warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber);
                ...
                //----------------Preoutbound Line----------------------------------------------------------------------------------------------
                preOutboundLineRepository.updatePreOutboundLineStatus(warehouseId, companyCodeId, plantId, languageId, refDocNumber, STATUS_ID_59);
                log.info("PreOutbound Line updated");

                //----------------Preoutbound Header--------------------------------------------------------------------------------------------
                StatusId idStatus = idmasterService.getStatus(STATUS_ID_59, languageId, authTokenForIDService.getAccess_token());
                preOutboundHeaderRepository.updatePreOutboundHeaderStatus(warehouseId, companyCodeId, plantId, languageId, refDocNumber, STATUS_ID_59, idStatus.getStatus());
                log.info("PreOutbound Header updated");

                /*-----------------Inventory Updates---------------------------*/
                List<QualityLine> dbQualityLine = qualityLineService.getQualityLine(
                        warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, partnerCode, lineNumbers, itemCodes);
                Long BIN_CL_ID = 5L;
                for (QualityLine qualityLine : dbQualityLine) {
                    //------------Update Lock applied---------------------------------------------------------------------------------
                    List<Inventory> inventoryList = inventoryService.getInventoryForDeliveryConfirmtion(
                            qualityLine.getWarehouseId(), qualityLine.getCompanyCodeId(), qualityLine.getPlantId(), qualityLine.getLanguageId(),
                ...
                StorageBin storageBin = mastersService.getStorageBin(companyCodeId, plantId, languageId, warehouseId, BIN_CLASS_ID, authTokenForMastersService.getAccess_token());
                String movementDocumentNo = refDocNumber;
                String stBin = storageBin.getStorageBin();
                String movementQtyValue = "N";

                List<PickupLine> dbPickupLine = pickupLineService.getPickupLine(warehouseId,
                        companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, partnerCode, lineNumbers, itemCodes);
...
//		}
     ...
     * @throws InvocationTargetException
     */
    public OutboundLine updateOutboundLine(String warehouseId, String companyCodeId, String plantId, String languageId, String preOutboundNo, String refDocNumber,
                                           String partnerCode, Long lineNumber, String itemCode, String loginUserID, UpdateOutboundLine updateOutboundLine)
            throws IllegalAccessException, InvocationTargetException {
        OutboundLine outboundLine = getOutboundLine(warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, partnerCode, lineNumber, itemCode);
    ...
    public List<OutboundLine> updateOutboundLines(String loginUserID, List<UpdateOutboundLine> updateOutboundLines)
        ...
        for (UpdateOutboundLine updateOutboundLine : updateOutboundLines) {
            OutboundLine outboundLine = getOutboundLine(updateOutboundLine.getWarehouseId(), updateOutboundLine.getCompanyCodeId(),
                    updateOutboundLine.getPlantId(), updateOutboundLine.getLanguageId(), updateOutboundLine.getPreOutboundNo(),
     ...
     * @param lineNumber
     */
    public void deleteOutboundLine(String warehouseId, String companyCodeId, String plantId, String languageId,
                                   String preOutboundNo, String refDocNumber, String partnerCode, Long lineNumber,
                                   String itemCode, String loginUserID) {

        OutboundLine outboundLine = getOutboundLine(warehouseId, companyCodeId, plantId, languageId, preOutboundNo,
    ...
    public List<OutboundReversal> doReversal(String refDocNumber, String companyCodeId, String plantId, String languageId, String itemCode, String loginUserID)
            throws IllegalAccessException, InvocationTargetException {
        List<OutboundLine> outboundLineList =
                outboundLineRepository.findByRefDocNumberAndCompanyCodeIdAndPlantIdAndLanguageIdAndItemCodeAndDeletionIndicator(refDocNumber, companyCodeId, plantId, languageId, itemCode, 0L);
        ...
        for (OutboundLine outboundLine : outboundLineList) {
            ...
            if (outboundLine.getStatusId() == 57L) {
                 ...
                 */
                List<QualityLine> qualityLine = qualityLineService.deleteQualityLineForReversal(outboundLine.getWarehouseId(),
                        outboundLine.getCompanyCodeId(), outboundLine.getPlantId(), outboundLine.getLanguageId(), outboundLine.getPreOutboundNo(),
                ...
                List<OutboundLineInterim> outboundLineInterim = qualityLineService.deleteOutboundLineInterimForReversal(
                        outboundLine.getWarehouseId(), outboundLine.getCompanyCodeId(), outboundLine.getPlantId(), outboundLine.getLanguageId(), outboundLine.getPreOutboundNo(),
                        outboundLine.getRefDocNumber(), outboundLine.getPartnerCode(), outboundLine.getLineNumber(),
                        outboundLine.getItemCode(), loginUserID);
                ...
                if (qualityLine != null && qualityLine.size() > 0) {
                    for (QualityLine qualityLineData : qualityLine) {
                        List<QualityHeader> qualityHeader = qualityHeaderService.deleteQualityHeaderForReversal(
                                outboundLine.getWarehouseId(), outboundLine.getCompanyCodeId(), outboundLine.getPlantId(),
                                outboundLine.getLanguageId(), outboundLine.getPreOutboundNo(), refDocNumber,
                ...
                List<PickupLine> pickupLineList = pickupLineService.deletePickupLineForReversal(
                        outboundLine.getWarehouseId(), outboundLine.getCompanyCodeId(), outboundLine.getPlantId(),
                        outboundLine.getLanguageId(), outboundLine.getPreOutboundNo(),
                        outboundLine.getRefDocNumber(), outboundLine.getPartnerCode(), outboundLine.getLineNumber(),
                        outboundLine.getItemCode(), loginUserID);
                ...
                if (pickupLineList != null && !pickupLineList.isEmpty()) {
                    for (PickupLine pickupLine : pickupLineList) {
                        ...
                        List<PickupHeader> pickupHeader = pickupHeaderService.getPickupHeaderForReversal(outboundLine.getWarehouseId(),
                                outboundLine.getCompanyCodeId(), outboundLine.getPlantId(), outboundLine.getLanguageId(), outboundLine.getPreOutboundNo(),
                         ...
                         */
                        if (inventory != null) {
                            inventory = inventoryService.getInventory(pickupLine.getWarehouseId(), pickupLine.getCompanyCodeId(), pickupLine.getPlantId(), pickupLine.getLanguageId(), pickupLine.getPickedPackCode(),
...
//								}
                    ...
                    for (PickupLine pickupLine : pickupLineList) {
                         ...
                         */
                        List<PickupHeader> pickupHeader = pickupHeaderService.deletePickupHeaderForReversal(
                                outboundLine.getWarehouseId(), outboundLine.getCompanyCodeId(), outboundLine.getPlantId(),
                                outboundLine.getLanguageId(), outboundLine.getPreOutboundNo(),
                                outboundLine.getRefDocNumber(), outboundLine.getPartnerCode(),
            ...
            if (outboundLine.getStatusId() == 50L || outboundLine.getStatusId() == 51L) {
                ...
                List<PickupLine> pickupLineList = pickupLineService.deletePickupLineForReversal(outboundLine.getWarehouseId(),
                        outboundLine.getCompanyCodeId(), outboundLine.getPlantId(), outboundLine.getLanguageId(), outboundLine.getPreOutboundNo(),
                        outboundLine.getRefDocNumber(), outboundLine.getPartnerCode(), outboundLine.getLineNumber(),
                        outboundLine.getItemCode(), loginUserID);
                if (pickupLineList != null && !pickupLineList.isEmpty()) {
                    for (PickupLine pickupLine : pickupLineList) {
                        ...
                        //get pickup header
                        List<PickupHeader> pickupHeader = pickupHeaderService.getPickupHeaderForReversal(outboundLine.getWarehouseId(), outboundLine.getCompanyCodeId(),
                                outboundLine.getPlantId(), outboundLine.getLanguageId(), outboundLine.getPreOutboundNo(),
                                outboundLine.getRefDocNumber(), outboundLine.getPartnerCode(),
                                pickupLine.getPickupNumber(), outboundLine.getLineNumber(), outboundLine.getItemCode());
                        log.info("get pickupHeader : " + pickupHeader);

                        List<QualityLine> qualityLine = qualityLineService.deleteQualityLineForReversal(outboundLine.getWarehouseId(), outboundLine.getCompanyCodeId(),
                                outboundLine.getPlantId(), outboundLine.getLanguageId(), outboundLine.getPreOutboundNo(),
                                outboundLine.getRefDocNumber(), outboundLine.getPartnerCode(), outboundLine.getLineNumber(),
                                outboundLine.getItemCode(), loginUserID);
                        log.info("QualityLine----------Deleted-------> : " + qualityLine);
                        ...
                        List<QualityHeader> dbQualityHeader = qualityHeaderService.getInitialQualityHeaderForReversal(outboundLine.getWarehouseId(), outboundLine.getCompanyCodeId(), outboundLine.getPlantId(), outboundLine.getLanguageId(),
                         ...
                         */
                        Inventory inventory = inventoryService.getInventory(pickupLine.getWarehouseId(), pickupLine.getCompanyCodeId(), pickupLine.getPlantId(), pickupLine.getLanguageId(), pickupLine.getPickedPackCode(),
                                pickupLine.getItemCode(), pickupLine.getPickedStorageBin());
                    ...
                    //Delete pickupheader after inventory update
                    for (PickupLine pickupLine : pickupLineList) {
                        List<PickupHeader> pickupHeader = pickupHeaderService.deletePickupHeaderForReversal(outboundLine.getWarehouseId(),
                                outboundLine.getCompanyCodeId(), outboundLine.getPlantId(), outboundLine.getLanguageId(), outboundLine.getPreOutboundNo(),
                                outboundLine.getRefDocNumber(), outboundLine.getPartnerCode(),
                                pickupLine.getPickupNumber(), outboundLine.getLineNumber(), outboundLine.getItemCode(), loginUserID);
                        log.info("pickupHeader deleted : " + pickupHeader);
...
//	}
    ...
    private OutboundReversal createOutboundReversal(Warehouse warehouse, String reversalType, String refDocNumber,
        ...
        StatusId idStatus = idmasterService.getStatus(47L, warehouse.getLanguageId(), idmasterAuthToken.getAccess_token());
        ...
        String OB_REVERSAL_NO = getNextRangeNumber(NUM_RAN_CODE, warehouse.getWarehouseId(), warehouse.getCompanyCodeId(), warehouse.getPlantId(), warehouse.getLanguageId());
...
//				pickupHeader.getItemCode(), loginUserID, updateOrderManagementLine);
        ...
        List<OrderManagementLine> dbOrderManagementLines = orderManagementLineService.getOrderManagementLine(pickupHeader.getCompanyCodeId(),
                pickupHeader.getPlantId(), pickupHeader.getLanguageId(), pickupHeader.getWarehouseId(), pickupHeader.getPreOutboundNo(),
    ...
    private List<OrderManagementLine> updateOrderManagementLineForReversal(PickupHeader pickupHeader, String loginUserID) throws IllegalAccessException, InvocationTargetException {
        ...
        List<OrderManagementLine> dbOrderManagementLine = orderManagementLineService.getListOrderManagementLine(pickupHeader.getCompanyCodeId(),
                pickupHeader.getPlantId(), pickupHeader.getLanguageId(), pickupHeader.getWarehouseId(), pickupHeader.getPreOutboundNo(),
                pickupHeader.getRefDocNumber(), pickupHeader.getPartnerCode(), pickupHeader.getLineNumber(),
                pickupHeader.getItemCode());
        AuthToken idmasterAuthToken = authTokenService.getIDMasterServiceAuthToken();
        StatusId idStatus = idmasterService.getStatus(47L, pickupHeader.getLanguageId(), idmasterAuthToken.getAccess_token());
