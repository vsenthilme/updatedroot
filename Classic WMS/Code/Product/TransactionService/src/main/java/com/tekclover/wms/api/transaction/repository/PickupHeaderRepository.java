...
public interface PickupHeaderRepository
    ...
    public List<PickupHeader> findAllByWarehouseIdAndPreOutboundNoAndCompanyCodeIdAndPlantIdAndLanguageIdAndRefDocNumberAndPartnerCodeAndPickupNumberAndLineNumberAndItemCodeAndDeletionIndicator(
            String warehouseId, String preOutboundNo,String companyCodeId,String plantId,String languageId, String refDocNumber, String partnerCode, String pickupNumber,
            Long lineNumber, String itemCode, Long deletionIndicator);
    ...
    PickupHeader findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndPreOutboundNoAndRefDocNumberAndPartnerCodeAndLineNumberAndItemCodeAndProposedStorageBinAndProposedPackBarCodeAndDeletionIndicator(
