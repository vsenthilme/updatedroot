...
public class QualityLineService extends BaseService {
     ...
     * @return
     */
    public List<QualityLine> getQualityLineForReversal(String warehouseId, String companyCodeId, String plantId, String languageId, String preOutboundNo, String refDocNumber,
                                                       String partnerCode, Long lineNumber, String itemCode) {
     ...
     * @return
     */
    public List<QualityLine> getQualityLineForUpdateForDeliverConformation(String warehouseId, String companyCodeId, String plantId, String languageId, String preOutboundNo,
        ...
        log.info("The given QualityLine ID : " + "warehouseId:" + warehouseId + ",preOutboundNo:" + preOutboundNo
                + ",companyCodeId: " + companyCodeId + ", plantId: " + plantId + ", languageId: " + languageId
                + ",refDocNumber:" + refDocNumber + ",partnerCode:" + partnerCode + ",lineNumber:" + lineNumber
                + ",itemCode:" + itemCode + " doesn't exist.");
        return null;
    }
     ...
     * @return
     */
    public List<QualityLine> getQualityLine(String warehouseId, String companyCodeId, String plantId, String languageId,
     ...
     * @return
     */
    private QualityLine findDuplicateRecord(String companyCodeId, String plantId, String languageId, String warehouseId,
    ...
    public List<QualityLine> createQualityLine(List<AddQualityLine> newQualityLines, String loginUserID)
        ...
        try {
            ...
            for (AddQualityLine newQualityLine : newQualityLines) {
                ...
                IkeyValuePair ikeyValuePair = containerReceiptRepository.getDescription(newQualityLine.getLanguageId(),
                        newQualityLine.getCompanyCodeId(), newQualityLine.getPlantId(), newQualityLine.getWarehouseId());

                if(ikeyValuePair != null){
                    dbQualityLine.setCompanyDescription(ikeyValuePair.getCompanyDesc());
                    dbQualityLine.setPlantDescription(ikeyValuePair.getPlantDesc());
                    dbQualityLine.setWarehouseDescription(ikeyValuePair.getWarehouseDesc());
                }
                ...
                String statusDescription = containerReceiptRepository.getStatusDescription(55L, newQualityLine.getLanguageId());
                 ...
                 */
                QualityLine existingQualityLine = findDuplicateRecord(newQualityLine.getCompanyCodeId(),
            ...
            for (QualityLine dbQualityLine : createdQualityLineList) {
                ...
                try {
                    ...
                    StatusId idStatus = idmasterService.getStatus(55L, dbQualityLine.getLanguageId(), authTokenForIDService.getAccess_token());
                    ...
                    QualityHeader qualityHeader = qualityHeaderService.updateQualityHeader(
                            ...
                            dbQualityLine.getQualityInspectionNo(),
...
//					updateOutboundLine (dbQualityLine, DLV_ORD_NO);
                    ...
                    OutboundHeader updateOutboundHeader = new OutboundHeader();
                    updateOutboundHeader.setStatusId(57L);
                    String statusDescription = containerReceiptRepository.getStatusDescription(57L, dbQualityLine.getLanguageId());
                    if(statusDescription != null){
...
//					log.info("outboundHeader updated : " + outboundHeader);
                ...
                StorageBin storageBin = mastersService.getStorageBin(dbQualityLine.getCompanyCodeId(), dbQualityLine.getPlantId(),
                ...
                try {
                    inventory = inventoryService.getInventory(dbQualityLine.getWarehouseId(), dbQualityLine.getCompanyCodeId(), dbQualityLine.getPlantId(), dbQualityLine.getLanguageId(),
                ...
                if (existingInventory != null) {
                    ...
                    newInventory.setCompanyCodeId(warehouse.getCompanyCodeId());
...
//			log.info("createdOutboundLineNewly created ----------->: " + createdOutboundLineNewly);
     ...
     * @throws InvocationTargetException
     */
    public List<QualityLine> updateQualityLine(String warehouseId, String companyCodeId, String plantId, String languageId, String preOutboundNo, String refDocNumber,
        ...
        List<QualityLine> dbQualityLine = getQualityLineForUpdateForDeliverConformation(warehouseId, companyCodeId, plantId, languageId, preOutboundNo,
     ...
     * @throws InvocationTargetException
     */
    public List<QualityLine> deleteQualityLineForReversal(String warehouseId, String companyCodeId, String plantId, String languageId, String preOutboundNo, String refDocNumber,
                                                          String partnerCode, Long lineNumber, String itemCode, String loginUserID)
            throws IllegalAccessException, InvocationTargetException {
        List<QualityLine> dbQualityLine = getQualityLineForReversal(warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, partnerCode, lineNumber, itemCode);
     ...
     * @throws InvocationTargetException
     */
    public List<OutboundLineInterim> deleteOutboundLineInterimForReversal(String warehouseId, String companyCodeId, String plantId, String languageId, String preOutboundNo, String refDocNumber,
                                                                          String partnerCode, Long lineNumber, String itemCode, String loginUserID)
            throws IllegalAccessException, InvocationTargetException {
        List<OutboundLineInterim> listOutboundLineInterim = outboundLineInterimRepository.
                findByWarehouseIdAndCompanyCodeIdAndLanguageIdAndPlantIdAndPreOutboundNoAndRefDocNumberAndPartnerCodeAndLineNumberAndItemCodeAndDeletionIndicator(warehouseId,
                        companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, partnerCode, lineNumber, itemCode, 0L);
