...
public interface PreInboundHeaderRepository extends JpaRepository<PreInboundHeaderEntity,Long>, 
	...
	public Optional<PreInboundHeaderEntity>
	findByLanguageIdAndCompanyCodeAndPlantIdAndWarehouseIdAndPreInboundNoAndDeletionIndicator(
			String languageId, String companyCode, String plantId, String warehouseId, String preInboundNo, Long deletionIndicator);
	...
	@Query("UPDATE PreInboundHeaderEntity ib SET ib.statusId = :statusId " +
