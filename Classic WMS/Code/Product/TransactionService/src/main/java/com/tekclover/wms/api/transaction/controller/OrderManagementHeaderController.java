...
public class OrderManagementHeaderController {
    ...
    @ApiOperation(response = OrderManagementHeader.class, value = "Get all OrderManagementHeader details")
    // label for swagger
    @GetMapping("")
    ...
    public ResponseEntity<?> getOrderManagementHeader(@PathVariable String refDocNumber, @RequestParam String companyCodeId, @RequestParam String plantId,
        ...
        OrderManagementHeader ordermangementheader =
                ordermangementheaderService.getOrderManagementHeader(companyCodeId, plantId, languageId, warehouseId,
...
//	}
    ...
    public ResponseEntity<?> patchOrderManagementHeader(@PathVariable String refDocNumber, @RequestParam String companyCodeId, @RequestParam String plantId,
                                                        @RequestParam String languageId, @RequestParam String warehouseId, @RequestParam String preOutboundNo,
                                                        @RequestParam String partnerCode, @RequestParam String loginUserID,
                                                        @Valid @RequestBody OrderManagementHeader updateOrderManagementHeader)
            throws IllegalAccessException, InvocationTargetException {
        OrderManagementHeader createdOrderManagementHeader =
                ordermangementheaderService.updateOrderManagementHeader(companyCodeId, plantId, languageId, warehouseId,
    ...
    public ResponseEntity<?> deleteOrderManagementHeader(@PathVariable String refDocNumber, @RequestParam String companyCodeId,
                                                         @RequestParam String plantId, @RequestParam String languageId,
                                                         @RequestParam String warehouseId, @RequestParam String preOutboundNo,
                                                         @RequestParam String partnerCode, @RequestParam String loginUserID) {
        ordermangementheaderService.deleteOrderManagementHeader(companyCodeId, plantId, languageId, warehouseId,
