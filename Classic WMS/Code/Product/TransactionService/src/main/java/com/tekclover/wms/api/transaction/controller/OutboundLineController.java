...
public class OutboundLineController {
    ...
    public ResponseEntity<?> deliveryConfirmation(@RequestParam String warehouseId, @RequestParam String companyCodeId,
                                                  @RequestParam String languageId, @RequestParam String plantId, @RequestParam String preOutboundNo,
        ...
        List<OutboundLine> createdOutboundLine =
                outboundlineService.deliveryConfirmation(warehouseId, companyCodeId, plantId, languageId,
    ...
    public ResponseEntity<?> patchOutboundLine(@PathVariable Long lineNumber, @RequestParam String companyCodeId,
                                               ...
                                               @RequestParam String itemCode, @Valid @RequestBody UpdateOutboundLine updateOutboundLine,
                                               @RequestParam String loginUserID)
            throws IllegalAccessException, InvocationTargetException {
        OutboundLine updatedOutboundLine =
                outboundlineService.updateOutboundLine(warehouseId, companyCodeId, plantId, languageId,
                        preOutboundNo, refDocNumber, partnerCode, lineNumber, itemCode, loginUserID, updateOutboundLine);
    ...
    public ResponseEntity<?> deleteOutboundLine(@PathVariable Long lineNumber, @RequestParam String companyCodeId, @RequestParam String plantId, @RequestParam String languageId,
        ...
        outboundlineService.deleteOutboundLine(warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, partnerCode, lineNumber,
    ...
    public ResponseEntity<?> doReversal(@RequestParam String refDocNumber,@RequestParam String companyCodeId,
        ...
        List<OutboundReversal> deliveryLines = outboundlineService.doReversal(
                refDocNumber,companyCodeId,plantId,languageId, itemCode, loginUserID);
