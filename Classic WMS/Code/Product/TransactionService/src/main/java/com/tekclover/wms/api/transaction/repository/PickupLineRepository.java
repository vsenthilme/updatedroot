...
public interface PickupLineRepository extends JpaRepository<PickupLine, Long>, JpaSpecificationExecutor<PickupLine> {
    ...
    public List<PickupLine> findAllByWarehouseIdAndCompanyCodeIdAndPlantIdAndLanguageIdAndPreOutboundNoAndRefDocNumberAndPartnerCodeAndLineNumberAndItemCodeAndDeletionIndicator(
    ...
    public List<PickupLine> findAllByWarehouseIdAndCompanyCodeIdAndPlantIdAndLanguageIdAndPreOutboundNoAndRefDocNumberAndPartnerCodeAndLineNumberInAndItemCodeInAndDeletionIndicator(
