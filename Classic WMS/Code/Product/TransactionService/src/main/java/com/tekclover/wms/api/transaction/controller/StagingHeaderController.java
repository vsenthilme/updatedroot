...
public class StagingHeaderController {
    ...
    public ResponseEntity<?> getStagingHeader(@PathVariable String stagingNo, @RequestParam String languageId, @RequestParam String companyCode,
        ...
        StagingHeader stagingheader = stagingheaderService.getStagingHeader(
                warehouseId, preInboundNo, companyCode, plantId, languageId, refDocNumber, stagingNo);
    ...
    public ResponseEntity<?> patchStagingHeader(@PathVariable String stagingNo, @RequestParam String warehouseId,
        ...
        StagingHeader createdStagingHeader =
                stagingheaderService.updateStagingHeader(warehouseId, companyCode, plantId, languageId,
    ...
    public ResponseEntity<?> deleteStagingHeader(@PathVariable String stagingNo, @RequestParam String warehouseId,
        ...
        stagingheaderService.deleteStagingHeader(warehouseId, companyCode, plantId, languageId, preInboundNo, refDocNumber, stagingNo, loginUserID);
    ...
    public ResponseEntity<?> getStagingHeader(@PathVariable Long numberOfCases, @RequestParam String warehouseId,
                                              @RequestParam String companyCode, @RequestParam String plantId, String languageId) {
        List<String> stagingheader =
                stagingheaderService.generateNumberRanges(numberOfCases, warehouseId, companyCode, languageId, plantId);
        log.info("StagingHeader : " + stagingheader);
        return new ResponseEntity<>(stagingheader, HttpStatus.OK);
    }
}