...
public class BaseService {
     ...
     * @return
     */
    protected String getNextRangeNumber(long NUM_RAN_CODE, String warehouseId, String companyCode,
                                        String plantId, String languageId, String accessToken) {
        int FISCALYEAR = Year.now().getValue();
        String nextNumberRange = idmasterService.getNextNumberRange(NUM_RAN_CODE, FISCALYEAR, warehouseId, companyCode, plantId, languageId, accessToken);
     ...
     * @return
     */
    protected String getNextRangeNumber(long NUM_RAN_CODE, String warehouseId, String companyCodeId, String plantId, String languageId) {
...
//    }
     ...
     * @return
     */
    protected UserManagement getUserManagement(String companyCode, String plantId,
                                               String languageId, String warehouseId, String loginUserID) {
        AuthToken authTokenForIDMasterService = authTokenService.getIDMasterServiceAuthToken();
        UserManagement userManagement = idmasterService.getUserManagement(
                companyCode, plantId, languageId, warehouseId, loginUserID, authTokenForIDMasterService.getAccess_token());
        return userManagement;
    }
