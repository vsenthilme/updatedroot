...
public class GrHeaderController {
    ...
    public ResponseEntity<?> getGrHeader(@PathVariable String goodsReceiptNo, @RequestParam String warehouseId,
        ...
        GrHeader grheader = grheaderService.getGrHeader(warehouseId, companyCode, plantId, languageId, preInboundNo, refDocNumber, stagingNo, goodsReceiptNo,
                palletCode, caseCode);
    ...
    public ResponseEntity<?> patchGrHeader(@PathVariable String goodsReceiptNo, @RequestParam String companyCode,
                                           ...
                                           @RequestParam String preInboundNo, @RequestParam String refDocNumber, @RequestParam String stagingNo,
                                           @RequestParam String palletCode, @RequestParam String caseCode,
                                           @Valid @RequestBody GrHeader updateGrHeader, @RequestParam String loginUserID)
            throws IllegalAccessException, InvocationTargetException {

        GrHeader createdGrHeader =
                grheaderService.updateGrHeader(companyCode, languageId, plantId, warehouseId,
...
//	}
    ...
    public ResponseEntity<?> deleteGrHeader(@PathVariable String goodsReceiptNo, @RequestParam String warehouseId,
        ...
        grheaderService.deleteGrHeader(warehouseId, companyCode, plantId, languageId, preInboundNo,
                refDocNumber, stagingNo, goodsReceiptNo, palletCode, caseCode, loginUserID);
