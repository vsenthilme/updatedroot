...
public interface OutboundLineRepository extends JpaRepository<OutboundLine, Long>, JpaSpecificationExecutor<OutboundLine> {
    ...
    OutboundLine findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndPreOutboundNoAndRefDocNumberAndPartnerCodeAndLineNumberAndItemCodeAndDeletionIndicator(
            String languageId, String companyCodeId, String plantId, String warehouseId, String preOutboundNo, String refDocNumber, String partnerCode,
    ...
    public List<OutboundLine> findByRefDocNumberAndCompanyCodeIdAndPlantIdAndLanguageIdAndItemCodeAndDeletionIndicator(String refDocNumber, String companyCodeId, String plantId, String languageId, String itemCode,
    ...
    public List<OutboundLine> findByWarehouseIdAndCompanyCodeIdAndPlantIdAndLanguageIdAndPreOutboundNoAndRefDocNumberAndReferenceField2AndDeletionIndicator(
            String warehouseId, String companyCodeId, String plantId, String languageId, String preOutboundNo, String refDocNumber, String referenceField2, Long deletionIndicator);
    ...
    @Query("Select count(ob) from OutboundLine ob where ob.warehouseId=:warehouseId and ob.companyCodeId=:companyCodeId and ob.plantId=:plantId and ob.languageId=:languageId and ob.preOutboundNo=:preOutboundNo and \r\n"
    ...
    public long getOutboudLineByWarehouseIdAndCompanyCodeIdAndPlantIdAndLanguageIdAndPreOutboundNoAndRefDocNumberAndPartnerCodeAndStatusIdInAndDeletionIndicator(
            ...
            @Param("preOutboundNo") String preOutboundNo, @Param("refDocNumber") String refDocNumber, @Param("partnerCode") String partnerCode, @Param("statusId") List<Long> statusId,
            @Param("deletionIndicator") long deletionIndicator);

    public List<OutboundLine> findByWarehouseIdAndCompanyCodeIdAndPlantIdAndLanguageIdAndPreOutboundNoAndRefDocNumberAndPartnerCodeAndStatusIdInAndDeletionIndicator(
            String warehouseId, String companyCodeId, String plantId, String languageId, String preOutboundNo, String refDocNumber, String partnerCode, List<Long> statusId,
            long i);
    ...
    @Query("UPDATE OutboundLine ob SET ob.statusId = :statusId, ob.deliveryConfirmedOn = :deliveryConfirmedOn \r\n"
            + " WHERE ob.warehouseId = :warehouseId AND ob.companyCodeId = :companyCodeId AND ob.plantId = :plantId AND ob.languageId = :languageId AND \r\n "
