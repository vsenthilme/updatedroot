...
public class PerpetualHeaderService extends BaseService {
     ...
     * @return
     */
    public List<PerpetualHeaderEntity> getPerpetualHeader(String warehouseId,String companyCoeId,String plantId,String languageId, Long cycleCountTypeId, String cycleCountNo,
                                                          Long movementTypeId, Long subMovementTypeId) {
        Optional<PerpetualHeader> optPerpetualHeader =
                perpetualHeaderRepository.findByCompanyCodeIdAndPlantIdAndWarehouseIdAndLanguageIdAndCycleCountTypeIdAndCycleCountNoAndMovementTypeIdAndSubMovementTypeIdAndDeletionIndicator(
                        companyCoeId,plantId, warehouseId,languageId, cycleCountTypeId, cycleCountNo, movementTypeId, subMovementTypeId, 0L);

        if (optPerpetualHeader.isEmpty()) {
            throw new BadRequestException("The given PerpetualHeader ID : " + cycleCountNo
                    + "companyCodeId: " + companyCoeId + ","
                    + "plantId: " + plantId + ","
     ...
     * @return
     */
    public PerpetualHeader getPerpetualHeaderRecord(String warehouseId, String companyCodeId, String plantId, String languageId, Long cycleCountTypeId, String cycleCountNo,
                                                    Long movementTypeId, Long subMovementTypeId) {
        Optional<PerpetualHeader> optPerpetualHeader =
                perpetualHeaderRepository.findByCompanyCodeIdAndPlantIdAndWarehouseIdAndLanguageIdAndCycleCountTypeIdAndCycleCountNoAndMovementTypeIdAndSubMovementTypeIdAndDeletionIndicator(
                        companyCodeId, plantId, warehouseId, languageId, cycleCountTypeId, cycleCountNo, movementTypeId, subMovementTypeId, 0L);
     ...
     * @return
     */
    public PerpetualHeader getPerpetualHeaderWithLine(String warehouseId, String companyCodeId, String plantId, String languageId, Long cycleCountTypeId, String cycleCountNo,
                                                      Long movementTypeId, Long subMovementTypeId) {
        Optional<PerpetualHeader> optPerpetualHeader =
                perpetualHeaderRepository.findByCompanyCodeIdAndPlantIdAndWarehouseIdAndLanguageIdAndCycleCountTypeIdAndCycleCountNoAndMovementTypeIdAndSubMovementTypeIdAndDeletionIndicator(
                        companyCodeId, plantId, warehouseId, languageId, cycleCountTypeId, cycleCountNo, movementTypeId, subMovementTypeId, 0L);
...
//			StorageBin storageBin = mastersService.getStorageBin(inventoryMovement.getStorageBin(), authTokenForMastersService.getAccess_token());
            ...
            Inventory inventory = inventoryService.getInventory(inventoryMovement.getWarehouseId(),
                    inventoryMovement.getCompanyCodeId(), inventoryMovement.getPlantId(), inventoryMovement.getLanguageId(),
    ...
    public Set<PerpetualLineEntityImpl> runPerpetualHeaderNew(@Valid RunPerpetualHeader runPerpetualHeader) throws java.text.ParseException {
        ...
        for (PerpetualLineEntityImpl line : runResponseList) {
            List<PerpetualLine> dbPerpetualLines = perpetualLineRepository.findByWarehouseIdAndCompanyCodeIdAndPlantIdAndLanguageIdAndStorageBinAndItemCodeAndPackBarcodesAndDeletionIndicator(
                    line.getWarehouseId(), line.getCompanyCodeId(), line.getPlantId(), line.getLanguageId(), line.getStorageBin(), line.getItemCode(), line.getPackBarcodes(), 0L);
    ...
    public Set<PerpetualLineEntityImpl> runPerpetualHeaderStream(@Valid RunPerpetualHeader runPerpetualHeader) throws java.text.ParseException {
        ...
        runResponseList.forEach(n -> {
                    ...
                    List<PerpetualLine> dbPerpetualLines = perpetualLineRepository
                            .findByWarehouseIdAndCompanyCodeIdAndPlantIdAndLanguageIdAndStorageBinAndItemCodeAndPackBarcodesAndDeletionIndicator(
                                    n.getWarehouseId(),
                                    n.getCompanyCodeId(),
                                    n.getPlantId(),
                                    n.getLanguageId(),
...
//		dbPerpetualHeader.setPlantId(getPlantId());
        ...
        String nextRangeNumber = getNextRangeNumber(NUM_RAN_ID, newPerpetualHeader.getWarehouseId(),
                newPerpetualHeader.getCompanyCodeId(), newPerpetualHeader.getPlantId(), newPerpetualHeader.getLanguageId(),
        ...
        for (AddPerpetualLine newPerpetualLine : newPerpetualHeader.getAddPerpetualLine()) {
            ...
            dbPerpetualLine.setLanguageId(createdPerpetualHeader.getLanguageId());
            dbPerpetualLine.setCompanyCodeId(createdPerpetualHeader.getCompanyCodeId());
            dbPerpetualLine.setPlantId(createdPerpetualHeader.getPlantId());
...
//		perpetualHeaderEntity.setPerpetualLine(listPerpetualLineEntity);
    ...
    public PerpetualHeader updatePerpetualHeader(String warehouseId, String companyCodeId, String plantId, String languageId, Long cycleCountTypeId, String cycleCountNo,
        ...
        try {
            ...
            PerpetualHeader dbPerpetualHeader = getPerpetualHeaderRecord(warehouseId, companyCodeId, plantId, languageId, cycleCountTypeId, cycleCountNo, movementTypeId,
                    subMovementTypeId);
     ...
     * @throws InvocationTargetException
     */
    public PerpetualHeader updatePerpetualHeader(String warehouseId, String companyCodeId, String plantId, String languageId, Long cycleCountTypeId, String cycleCountNo, Long movementTypeId,
                                                 Long subMovementTypeId, String loginUserID) throws IllegalAccessException, InvocationTargetException {
        PerpetualHeader dbPerpetualHeader = getPerpetualHeaderRecord(warehouseId, companyCodeId, plantId, languageId, cycleCountTypeId, cycleCountNo, movementTypeId, subMovementTypeId);
     ...
     * @param cycleCountNo
     */
    public void deletePerpetualHeader(String warehouseId, String companyCodeId, String plantId, String languageId, Long cycleCountTypeId, String cycleCountNo, Long movementTypeId,
