...
;
	 ...
	 * @return
	 */
	public UserManagement getUserManagement (String companyCode,String plantId, String languageId, String warehouseId, String userId) {
		UserManagement userManagement =
				userManagementRepository.findByLanguageIdAndCompanyCodeAndPlantIdAndWarehouseIdAndUserIdAndDeletionIndicator(
				languageId,companyCode,plantId,warehouseId, userId, 0L);
		if (userManagement == null) {
			throw new BadRequestException("Invalid Username : " + userId);
		}
		return userManagement;
