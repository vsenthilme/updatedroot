 ...
 */
@Table(
		name = "tbloutboundorderstatusid",
		uniqueConstraints = { 
				@UniqueConstraint (
						name = "unique_key_outboundorderstatusid",
						columnNames = {"C_ID", "PLANT_ID", "WH_ID", "OB_ORD_STATUS_ID", "LANG_ID"})
				}
		)
@IdClass(OutboundOrderStatusIdCompositeKey.class)
public class OutboundOrderStatusId {
	...
	@Id
	@Column(name = "OB_ORD_STATUS_ID", columnDefinition = "nvarchar(10)")
	...
	@Column(name = "OB_ORD_STATUS", columnDefinition = "nvarchar(50)")
