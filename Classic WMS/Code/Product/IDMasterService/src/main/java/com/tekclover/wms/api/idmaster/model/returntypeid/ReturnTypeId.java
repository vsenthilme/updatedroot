 ...
 */
@Table(
		name = "tblreturntypeid",
		uniqueConstraints = { 
				@UniqueConstraint (
						name = "unique_key_returntypeid",
						columnNames = {"C_ID", "PLANT_ID", "WH_ID", "RETURN_TYP_ID", "LANG_ID"})
				}
		)
@IdClass(ReturnTypeIdCompositeKey.class)
public class ReturnTypeId {
	...
	@Id
	@Column(name = "RETURN_TYP_ID", columnDefinition = "nvarchar(10)")
	...
	@Column(name = "RETURN_TYP_TEXT", columnDefinition = "nvarchar(50)")
