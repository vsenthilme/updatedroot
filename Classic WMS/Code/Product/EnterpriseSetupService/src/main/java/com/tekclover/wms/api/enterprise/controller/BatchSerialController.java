...
public class BatchSerialController {
	...
	public ResponseEntity<?> getBatchSerial(@PathVariable String storageMethod,@RequestParam String plantId,@RequestParam String companyId,@RequestParam String languageId,@RequestParam String warehouseId,@RequestParam Long levelId) {
    	BatchSerial batchserial = batchserialService.getBatchSerial(storageMethod,plantId,companyId,languageId,warehouseId,levelId);
	...
	public ResponseEntity<?> patchBatchSerial(@PathVariable String storageMethod,@RequestParam String companyId,@RequestParam String plantId,@RequestParam String languageId,@RequestParam String warehouseId,@RequestParam Long levelId,
			@Valid @RequestBody UpdateBatchSerial updateBatchSerial, @RequestParam String loginUserID) 
			throws IllegalAccessException, InvocationTargetException {
		BatchSerial createdBatchSerial = batchserialService.updateBatchSerial(storageMethod,companyId,plantId,languageId,warehouseId,levelId,updateBatchSerial, loginUserID);
		return new ResponseEntity<>(createdBatchSerial, HttpStatus.OK);
	}
    
    @ApiOperation(response = BatchSerial.class, value = "Delete BatchSerial") // label for swagger
	@DeleteMapping("/{storageMethod}")
	public ResponseEntity<?> deleteBatchSerial(@PathVariable String storageMethod,@RequestParam String companyId,@RequestParam String languageId,@RequestParam String plantId,@RequestParam Long levelId,@RequestParam String warehouseId,@RequestParam String loginUserID)  {
    	batchserialService.deleteBatchSerial(storageMethod,companyId,languageId,plantId,warehouseId,levelId, loginUserID);
