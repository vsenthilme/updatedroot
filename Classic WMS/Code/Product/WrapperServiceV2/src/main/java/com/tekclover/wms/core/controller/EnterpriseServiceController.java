...
public class EnterpriseServiceController {
	...
	public ResponseEntity<?> getBarcode(@PathVariable Long barcodeTypeId, @RequestParam String warehouseId, 
			...
			@RequestParam String levelReference, @RequestParam Long processId,@RequestParam String companyId,@RequestParam String languageId,@RequestParam String plantId,@RequestParam String authToken) {
	...
	public ResponseEntity<?> updateBarcode(@PathVariable Long barcodeTypeId, @RequestParam String warehouseId, 
			@RequestParam String method, @RequestParam Long barcodeSubTypeId, @RequestParam Long levelId, @RequestParam String companyId,@RequestParam String languageId,@RequestParam String plantId,
	...
	public ResponseEntity<?> deleteBarcode(@PathVariable Long barcodeTypeId, @RequestParam String warehouseId, 
			@RequestParam String method, @RequestParam Long barcodeSubTypeId, @RequestParam Long levelId, 
			@RequestParam String levelReference, @RequestParam Long processId,@RequestParam String companyId,@RequestParam String plantId,@RequestParam String languageId, @RequestParam String loginUserID,
			@RequestParam String authToken) {
	...
	public ResponseEntity<?> getBatchSerial(@PathVariable String storageMethod,@RequestParam String companyId,@RequestParam String languageId,@RequestParam String plantId,@RequestParam String warehouseId,@RequestParam Long levelId, @RequestParam String authToken) {
    	BatchSerial batchserial = enterpriseSetupService.getBatchSerial(storageMethod,companyId,languageId,plantId,warehouseId,levelId,authToken);
    	log.info("BatchSerial : " + batchserial);
		return new ResponseEntity<>(batchserial, HttpStatus.OK);
	}
	...
	public ResponseEntity<?> createBatchSerial(@RequestBody AddBatchSerial newBatchSerial, @RequestParam String loginUserID,
											   @RequestParam String authToken) {
...
//	}
	...
	public ResponseEntity<?> updateBatchSerial(@PathVariable String storageMethod,@RequestParam String companyId,@RequestParam String plantId,@RequestParam String warehouseId,@RequestParam String languageId,@RequestParam Long levelId,
			@Valid @RequestBody UpdateBatchSerial updatedBatchSerial, @RequestParam String loginUserID, @RequestParam String authToken) {
		BatchSerial modifiedBatchSerial = enterpriseSetupService.updateBatchSerial(storageMethod,companyId,languageId,plantId,warehouseId,levelId, updatedBatchSerial, loginUserID, authToken);
...
//	}
	...
	public ResponseEntity<?> deleteBatchSerial(@RequestParam String storageMethod,@RequestParam String companyId,@RequestParam String plantId,@RequestParam String languageId,@RequestParam String warehouseId,@RequestParam Long levelId,@RequestParam String loginUserID,
			@RequestParam String authToken) {
		enterpriseSetupService.deleteBatchSerial(storageMethod,companyId,plantId,warehouseId,levelId,languageId,loginUserID, authToken);
		return new ResponseEntity<>(HttpStatus.NO_CONTENT);
	}
...
//	}
	...
	public ResponseEntity<?> updateEmployee(@PathVariable String employee,@Valid @RequestBody Employee updateEmployee, @RequestParam String loginUserID, @RequestParam String authToken) {
	...
	public ResponseEntity<?> getItemGroup(@PathVariable Long itemGroupId, @RequestParam String warehouseId, 
		@RequestParam Long itemTypeId, @RequestParam Long subItemGroupId,@RequestParam String companyId,@RequestParam String languageId,@RequestParam String plantId, @RequestParam String authToken) {
	   	ItemGroup itemgroup = enterpriseSetupService.getItemGroup(companyId,languageId,plantId,warehouseId, itemTypeId, itemGroupId,
	   			subItemGroupId, authToken);
	   	log.info("ItemGroup : " + itemgroup);
		return new ResponseEntity<>(itemgroup, HttpStatus.OK);
	}
	...
	public ResponseEntity<?> updateItemGroup(@PathVariable Long itemGroupId, @RequestParam String warehouseId, 
			@RequestParam Long itemTypeId, @RequestParam Long subItemGroupId,@RequestParam String companyId,@RequestParam String languageId,@RequestParam String plantId,
		...
		ItemGroup modifiedItemGroup = 
				enterpriseSetupService.updateItemGroup(itemGroupId, warehouseId, itemTypeId, subItemGroupId,
						updateItemGroup,companyId,languageId,plantId, loginUserID, authToken);
	...
	public ResponseEntity<?> deleteItemGroup(@PathVariable Long itemGroupId, @RequestParam String warehouseId, @RequestParam String companyId,@RequestParam String languageId,@RequestParam String plantId,
			@RequestParam Long itemTypeId, @RequestParam Long subItemGroupId, @RequestParam String loginUserID,
			@RequestParam String authToken) {
		enterpriseSetupService.deleteItemGroup(warehouseId, itemTypeId,companyId,languageId,plantId, itemGroupId, subItemGroupId, loginUserID, authToken);
		return new ResponseEntity<>(HttpStatus.NO_CONTENT);
	}
	...
	public ResponseEntity<?> updateItemType(@PathVariable Long itemTypeId, @RequestParam String warehouseId, @RequestParam String companyId,@RequestParam String plantId,@RequestParam String languageId,
	...
	public ResponseEntity<?> deleteItemType(@PathVariable Long itemTypeId,@RequestParam String companyId,@RequestParam String plantId,@RequestParam String languageId,@RequestParam String warehouseId,
			 @RequestParam String loginUserID,
			@RequestParam String authToken) {
	...
	public ResponseEntity<?> getPlant(@PathVariable String plantId,@RequestParam String companyId,@RequestParam String languageId,@RequestParam String authToken) {
   ...
   @RequestMapping(value = "/plant/{plantId}", method = RequestMethod.PATCH)
	...
	public ResponseEntity<?> deletePlant(@PathVariable String plantId,@RequestParam String companyId,@RequestParam String languageId,@RequestParam String loginUserID, @RequestParam String authToken ) {
	...
	public ResponseEntity<?> getStorageBinType(@PathVariable Long storageBinTypeId, @RequestParam String warehouseId,@RequestParam Long storageClassId,
		@RequestParam Long storageTypeId,@RequestParam String companyId,@RequestParam String languageId,@RequestParam String plantId, @RequestParam String authToken) {
	...
	public ResponseEntity<?> getStorageClass(@PathVariable Long storageClassId, @RequestParam String warehouseId, @RequestParam String companyId,@RequestParam String languageId,@RequestParam String plantId,
			 @RequestParam String authToken) {
	...
	public ResponseEntity<?> updateStorageClass(@PathVariable Long storageClassId, @RequestParam String warehouseId,@RequestParam String companyId,@RequestParam String plantId,@RequestParam String languageId,
	...
	public ResponseEntity<?> getStorageSection(@PathVariable String storageSectionId,@RequestParam String companyId,@RequestParam String plantId,@RequestParam String languageId, @RequestParam String warehouseId,
	...
	public ResponseEntity<?> updateStorageSection(@PathVariable String storageSectionId, @RequestParam String warehouseId,
			...
			@RequestBody StorageSection updatedStorageSection, @RequestParam String loginUserID,@RequestParam String companyId,@RequestParam String languageId,@RequestParam String plantId,@RequestParam String authToken) {
		StorageSection modifiedStorageSection = 
				enterpriseSetupService.updateStorageSection(warehouseId, floorId, storageSectionId,companyId,languageId,plantId,updatedStorageSection, loginUserID, authToken);
	...
	public ResponseEntity<?> deleteStorageSection(@PathVariable String storageSectionId, @RequestParam String warehouseId, @RequestParam Long floorId,@RequestParam String companyId,@RequestParam String languageId,@RequestParam String plantId,@RequestParam String loginUserID,
			@RequestParam String authToken) {
	...
	public ResponseEntity<?> getStorageType(@PathVariable Long storageTypeId, @RequestParam String warehouseId, @RequestParam String companyId,@RequestParam String languageId,@RequestParam String plantId,
	...
	public ResponseEntity<?> updateStorageType(@PathVariable Long storageTypeId, @RequestParam String warehouseId, 
			@RequestParam Long storageClassId, @RequestParam String companyId,@RequestParam String plantId,@RequestParam String languageId,
	...
	public ResponseEntity<?> deleteStorageType(@PathVariable Long storageTypeId, @RequestParam String warehouseId, @RequestParam String companyId,@RequestParam String plantId,@RequestParam String languageId,
	...
	public ResponseEntity<?> getStrategies(@PathVariable Long strategyTypeId, @RequestParam String warehouseId, 
			@RequestParam Long sequenceIndicator, @RequestParam String strategyNo,@RequestParam String companyId,@RequestParam String languageId,@RequestParam String plantId,
										   @RequestParam Long priority, @RequestParam String authToken) {
	   	Strategies strategies = enterpriseSetupService.getStrategies(companyId,languageId,plantId,warehouseId, strategyTypeId, sequenceIndicator, strategyNo, priority, authToken);
	   	log.info("Strategies : " + strategies);
		return new ResponseEntity<>(strategies, HttpStatus.OK);
	}
	...
	public ResponseEntity<?> updateStrategies(@PathVariable Long strategyTypeId, @RequestParam String warehouseId, 
			@RequestParam Long sequenceIndicator, @RequestParam String strategyNo, @RequestParam Long priority,@RequestParam String companyId,@RequestParam String languageId,@RequestParam String plantId,
		...
		Strategies modifiedStrategies = 
				enterpriseSetupService.updateStrategies(companyId,languageId,plantId,warehouseId, strategyTypeId, sequenceIndicator, strategyNo, priority, updatedStrategies, loginUserID, authToken);
	...
	public ResponseEntity<?> deleteStrategies(@PathVariable Long strategyTypeId, @RequestParam String warehouseId,
			@RequestParam Long sequenceIndicator, @RequestParam String strategyNo, @RequestParam Long priority,@RequestParam String companyId,@RequestParam String languageId,@RequestParam String plantId,
			@RequestParam String loginUserID, @RequestParam String authToken) {
		enterpriseSetupService.deleteStrategies(companyId,languageId,plantId,warehouseId, strategyTypeId, sequenceIndicator, strategyNo, priority, loginUserID, authToken);
		return new ResponseEntity<>(HttpStatus.NO_CONTENT);
	}
	...
	public ResponseEntity<?> getVariant(@PathVariable String variantId,@RequestParam String companyId,@RequestParam String plantId,@RequestParam String languageId,@RequestParam Long levelId,@RequestParam String warehouseId,@RequestParam String authToken) {
		Variant variant = enterpriseSetupService.getVariant(variantId,companyId,languageId,plantId,levelId,warehouseId,authToken);
		log.info("Variant : " + variant);
		return new ResponseEntity<>(variant, HttpStatus.OK);
	}
	...
	public ResponseEntity<?> createVariant(@RequestBody AddVariant newVariant, @RequestParam String loginUserID,
			@RequestParam String authToken) {
	...
	public ResponseEntity<?> updateVariant(@PathVariable String variantId,@RequestParam String companyId,@RequestParam String plantId,@RequestParam String languageId,@RequestParam String warehouseId,@RequestParam Long levelId,
			@RequestBody UpdateVariant updatedVariant, @RequestParam String loginUserID, @RequestParam String authToken) {
		Variant modifiedVariant =  enterpriseSetupService.updateVariant(variantId, updatedVariant,companyId,plantId,warehouseId,languageId,levelId,loginUserID, authToken);
	...
	public ResponseEntity<?> deleteVariant(@RequestParam String authToken,@RequestParam String companyId,@RequestParam String languageId,@RequestParam String plantId,@RequestParam String warehouseId,@RequestParam Long levelId,@RequestParam String variantId,
			@RequestParam String loginUserID) {
		enterpriseSetupService.deleteVariant(variantId,companyId,plantId,warehouseId,languageId,levelId,loginUserID,authToken);
		return new ResponseEntity<>(HttpStatus.NO_CONTENT);
	}
	...
	public ResponseEntity<?> getWarehouse(@PathVariable String warehouseId, @RequestParam String modeOfImplementation,@RequestParam String companyId,@RequestParam String plantId,@RequestParam String languageId,
	...
	public ResponseEntity<?> updateWarehouse(@PathVariable String warehouseId,@RequestParam String modeOfImplementation,@RequestParam Long warehouseTypeId,@RequestParam String companyId,@RequestParam String plantId,@RequestParam String languageId,
	...
	public ResponseEntity<?> deleteWarehouse(@PathVariable String warehouseId,@RequestParam String modeOfImplementation,@RequestParam Long warehouseTypeId,@RequestParam String companyId,@RequestParam String plantId,@RequestParam String languageId,@RequestParam String loginUserID,
			@RequestParam String authToken) {
