...
public class IDMasterServiceController {
	...
	public ResponseEntity<?> getCity(@PathVariable String cityId,@RequestParam String stateId,@RequestParam String countryId,@RequestParam Long zipCode,
									 @RequestParam String languageId,@RequestParam String authToken) {
		City city = idmasterService.getCity(cityId,stateId,countryId,zipCode,languageId,authToken);
	...
	public ResponseEntity<?> updateCity(@PathVariable String cityId,@RequestParam String stateId,@RequestParam String countryId,@RequestParam Long zipCode,@RequestParam String languageId,
										@RequestParam String loginUserID,@RequestBody UpdateCity updatedCity,@RequestParam String authToken) {
		City city = idmasterService.updateCity(cityId,stateId,countryId,zipCode,languageId,loginUserID,updatedCity,authToken);
	...
	public ResponseEntity<?> deleteCity(@PathVariable String cityId,@RequestParam String stateId,@RequestParam String countryId,@RequestParam Long zipCode,@RequestParam String languageId,@RequestParam String authToken) {
		boolean isCityDeleted = idmasterService.deleteCity(cityId,stateId,countryId,zipCode,languageId,authToken);
	...
	public ResponseEntity<?> getSubItemGroupId(@RequestParam String warehouseId,@RequestParam Long itemTypeId,@RequestParam Long itemGroupId,@PathVariable Long subItemGroupId, @RequestParam String subItemGroup,
											   @RequestParam String companyCodeId,@RequestParam String languageId,@RequestParam String plantId,@RequestParam String authToken) {
		SubItemGroupId dbSubItemGroupId =
				idmasterService.getSubItemGroupId(warehouseId, itemTypeId, itemGroupId, subItemGroupId, subItemGroup,companyCodeId,languageId,plantId,authToken);
	...
	public ResponseEntity<?> patchSubItemGroupId( @RequestParam String warehouseId,
												  @RequestParam Long itemTypeId, @RequestParam Long itemGroupId,@PathVariable Long subItemGroupId, @RequestParam String subItemGroup,@RequestParam String companyCodeId,@RequestParam String languageId,@RequestParam String plantId,
												  @RequestParam String loginUserID, @Valid @RequestBody UpdateSubItemGroupId updateSubItemGroupId, @RequestParam String authToken)
			throws IllegalAccessException, InvocationTargetException {
		SubItemGroupId updatedSubItemGroupId =
				idmasterService.updateSubItemGroupId(warehouseId, itemTypeId, itemGroupId, subItemGroupId, subItemGroup,companyCodeId,languageId,plantId,loginUserID,
	...
	public ResponseEntity<?> deleteSubItemGroupId(@RequestParam String warehouseId,@RequestParam Long itemTypeId,
												  @RequestParam Long itemGroupId,@PathVariable Long subItemGroupId,@RequestParam String subItemGroup,@RequestParam String companyCodeId,@RequestParam String languageId,@RequestParam String plantId,
												  @RequestParam String loginUserID, @RequestParam String authToken) {
		idmasterService.deleteSubItemGroupId(warehouseId, itemTypeId, itemGroupId, subItemGroupId, subItemGroup,companyCodeId,languageId,plantId,loginUserID, authToken);
		return new ResponseEntity<>(HttpStatus.NO_CONTENT);
	}
	...
	//FIND HhtUser
	@ApiOperation(response = HhtUser[].class, value = "Find HhtUser")//label for swagger
	@PostMapping("/hhtuser/findHhtUser")
	public HhtUser[] findHhtUser(@RequestBody FindHhtUser findHhtUser,
								 @RequestParam String authToken)throws Exception{
	...
	public ResponseEntity<?>  getHandlingEquipmentId( @RequestParam String warehouseId,@PathVariable String handlingEquipmentId,
													  @RequestParam String handlingEquipmentNumber,@RequestParam String companyCodeId,@RequestParam String languageId,@RequestParam String plantId,
													  @RequestParam String authToken) {
		HandlingEquipmentId dbHandlingEquipmentId= idmasterService.getHandlingEquipmentId(warehouseId,handlingEquipmentId,handlingEquipmentNumber,companyCodeId,languageId,plantId,authToken);
	...
	public ResponseEntity<?>updateHandlingEquipmentId(@RequestParam String warehouseId,@PathVariable String handlingEquipmentId,
													  @RequestParam String handlingEquipmentNumber,@RequestParam String companyCodeId,@RequestParam String languageId,@RequestParam String plantId,@RequestParam String loginUserID,
													  @Valid @RequestBody UpdateHandlingEquipmentId updateHandlingEquipmentId,@RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
		HandlingEquipmentId UpdateHandlingEquipmentId =
				idmasterService.updateHandlingEquipmentId(warehouseId,handlingEquipmentId,handlingEquipmentNumber,companyCodeId,languageId,plantId,loginUserID,updateHandlingEquipmentId,authToken);
	...
	public ResponseEntity<?> deleteHandlingEquipmentId(@RequestParam String warehouseId,@PathVariable String handlingEquipmentId,@RequestParam String handlingEquipmentNumber,
													   @RequestParam String companyCodeId,@RequestParam String languageId,@RequestParam String plantId,
													   @RequestParam String loginUserID,@RequestParam String authToken) {
		idmasterService.deleteHandlingEquipmentId(warehouseId,handlingEquipmentId,handlingEquipmentNumber,companyCodeId,languageId,plantId,loginUserID,authToken);
		return new ResponseEntity<>(HttpStatus.NO_CONTENT);
	}
	...
	public ResponseEntity<?>  getHandlingUnitId(@RequestParam String warehouseId,@PathVariable String handlingUnitId,
												@RequestParam String handlingUnitNumber,@RequestParam String companyCodeId,@RequestParam String languageId,@RequestParam String plantId,
												@RequestParam String authToken) {
		HandlingUnitId dbHandlingUnitId= idmasterService.getHandlingUnitId(warehouseId,handlingUnitId,handlingUnitNumber,companyCodeId,languageId,plantId,authToken);
	...
	public ResponseEntity<?>updateHandlingUnitId(@RequestParam String warehouseId,@PathVariable String handlingUnitId,
												 @RequestParam String handlingUnitNumber,@RequestParam String companyCodeId,@RequestParam String languageId,@RequestParam String plantId,@RequestParam String loginUserID,
		...
		HandlingUnitId UpdateHandlingUnitId =
				idmasterService.updateHandlingUnitId(warehouseId,handlingUnitId,handlingUnitNumber,companyCodeId,languageId,plantId,loginUserID,updateHandlingUnitId,authToken);
	...
	public ResponseEntity<?> deleteHandlingUnitId(@RequestParam String warehouseId,@PathVariable String handlingUnitId,
												  @RequestParam String handlingUnitNumber,@RequestParam String companyCodeId,@RequestParam String languageId,@RequestParam String plantId,
												  @RequestParam String loginUserID,@RequestParam String authToken) {
		idmasterService.deleteHandlingUnitId(warehouseId,handlingUnitId,handlingUnitNumber,companyCodeId,languageId,plantId,loginUserID,authToken);
		return new ResponseEntity<>(HttpStatus.NO_CONTENT);
	}
	...
	@GetMapping("")
	public ResponseEntity<?> getInterimBarcodes(@RequestParam String authToken) {
		InterimBarcode[] interimBarcodeList = idmasterService.getInterimBarcodes (authToken);
	...
	public ResponseEntity<?> addInterimBarcode(@Valid @RequestBody AddInterimBarcode newInterimBarcode, @RequestParam String loginUserID,
											   @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
		InterimBarcode createdInterimBarcode = idmasterService.addInterimBarcode (newInterimBarcode,loginUserID, authToken);
