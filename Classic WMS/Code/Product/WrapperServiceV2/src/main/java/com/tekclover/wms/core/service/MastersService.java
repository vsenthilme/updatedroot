...
public class MastersService {
	...
	// GET
	public BomHeader getBomHeader (String warehouseId, String parentItemCode,String languageId,String companyCode,String plantId,String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "MNRClara RestTemplate");
	...
	// PATCH
	public BomHeader updateBomHeader (String warehouseId, String parentItemCode,String languageId,String companyCode,String plantId,String loginUserID,
	...
	// DELETE
	public boolean deleteBomHeader (String warehouseId, String parentItemCode,String languageId,String companyCode,String plantId,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "MNRClara's RestTemplate");
	...
	// PATCH
	public BomLine updateBomLine (String warehouseId,String companyCode,String languageId,String plantId, Long bomNumber, String childItemCode,
	...
	// GET BusinessPartner
	public BusinessPartner getBusinessPartner(String partnerCode,String companyCodeId,String plantId,String warehouseId,String languageId,Long businessPartnerType, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public BusinessPartner updateBusinessPartner (String partnerCode,String companyCodeId,String plantId,String warehouseId,String languageId,Long businessPartnerType, BusinessPartner modifiedBusinessPartner,
	...
	public boolean deleteBusinessPartner (String partnerCode,String companyCodeId,String plantId,String warehouseId,String languageId,Long businessPartnerType, String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public HandlingEquipment getHandlingEquipment(String warehouseId, String handlingEquipmentId, String companyCodeId, String languageId, String plantId, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public HandlingEquipment updateHandlingEquipment (String warehouseId, String handlingEquipmentId, String companyCodeId, String languageId, String plantId,
	...
	public boolean deleteHandlingEquipment (String warehouseId, String handlingEquipmentId, String companyCodeId, String languageId, String plantId, String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// GET HandlingUnit
	public HandlingUnit getHandlingUnit(String handlingUnit,String companyCodeId,String plantId,String warehouseId,String languageId,String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// Patch HandlingUnit
	public HandlingUnit updateHandlingUnit (String handlingUnit,String warehouseId,String companyCodeId, String languageId, String plantId, HandlingUnit modifiedHandlingUnit,
											String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	// Delete HandlingUnit
	public boolean deleteHandlingUnit (String handlingUnit,String warehouseId,String companyCodeId, String languageId, String plantId,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public ImAlternateUom[] getImAlternateUom(String alternateUom,String companyCodeId,String plantId,
											  String warehouseId,String itemCode,String uomId,String languageId, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public boolean deleteImAlternateUom (String alternateUom,String companyCodeId,String plantId,String warehouseId,String itemCode,String uomId,String languageId, String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// GET ImBasicData1
	public ImBasicData1 getImBasicData1(String itemCode, String warehouseId,String companyCodeId,String plantId,String uomId,String languageId, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
...
//			return obList.toArray(new ImBasicData1[obList.size()]);
	...
	// Patch ImBasicData1
	public ImBasicData1 updateImBasicData1 (String itemCode, String warehouseId,String companyCodeId,String plantId,String uomId,String languageId, ImBasicData1 modifiedImBasicData1,
											String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	// Delete ImBasicData1
	public boolean deleteImBasicData1 (String itemCode, String warehouseId,String companyCodeId,String plantId,String uomId,String languageId,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// GET ImBasicData2
	public ImBasicData2 getImBasicData2(String itemCode,String companyCodeId,String plantId,String warehouseId,String languageId,String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// Patch ImBasicData2
	public ImBasicData2 updateImBasicData2 (String itemCode,String companyCodeId,String plantId,String warehouseId,String languageId,ImBasicData2 modifiedImBasicData2,
											String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	// Delete ImBasicData2
	public boolean deleteImBasicData2 (String itemCode,String companyCodeId,String plantId,String warehouseId,String languageId,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// GET ImPacking
	public ImPacking getImPacking(String packingMaterialNo,String companyCodeId,String plantId,String languageId,String warehouseId,String itemCode, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// Patch ImPacking
	public ImPacking updateImPacking (String packingMaterialNo,String companyCodeId,String plantId,String languageId,String warehouseId,String itemCode,ImPacking modifiedImPacking,
									  String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	// Delete ImPacking
	public boolean deleteImPacking (String packingMaterialNo,String companyCodeId,String plantId,String languageId,String warehouseId,String itemCode,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// GET ImPartner
	public ImPartner getImPartner(String businessPartnerCode,String companyCodeId,String plantId,String languageId,String warehouseId,String itemCode,String businessPartnerType,String partnerItemBarcode, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// Patch ImPartner
	public ImPartner updateImPartner (String businessPartnerCode,String companyCodeId,String plantId,String languageId,String warehouseId,String itemCode,String businessPartnerType,String partnerItemBarcode, ImPartner modifiedImPartner, String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// Delete ImPartner
	public boolean deleteImPartner (String businessPartnerCode,String companyCodeId,String plantId,String languageId,String warehouseId,String itemCode,String businessPartnerType,String partnerItemBarcode, String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// GET ImStrategies
	public ImStrategies getImStrategies(String strategeyTypeId,String companyCodeId,String plantId,String warehouseId,String itemCode,Long sequenceIndicator,String languageId,String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// Patch ImStrategies
	public ImStrategies updateImStrategies (String strategeyTypeId,String companyCodeId,String plantId,String warehouseId,String itemCode,Long sequenceIndicator,String languageId, ImStrategies modifiedImStrategies,
											String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	// Delete ImStrategies
	public boolean deleteImStrategies (String strategeyTypeId,String companyCodeId,String plantId,String warehouseId,String itemCode,Long sequenceIndicator,String languageId,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// GET PackingMaterial
	public PackingMaterial getPackingMaterial(String packingMaterialNo,String companyCodeId,String plantId,String languageId,String warehouseId, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public PackingMaterial updatePackingMaterial (String packingMaterialNo,String companyCodeId,String languageId,String plantId,String warehouseId, PackingMaterial modifiedPackingMaterial,
												  String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	public boolean deletePackingMaterial (String packingMaterialNo,String companyCodeId,String plantId,String languageId,String warehouseId, String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// GET ImAlternatePart
	public ImAlternatePart getImAlternatePart(String companyCodeId,String languageId,String warehouseId,String plantId,String itemCode,String altItemCode, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
			...
			HttpEntity<?> entity = new HttpEntity<>(headers);
			UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getMastersServiceUrl() + "imalternatepart/" + altItemCode)
					.queryParam("companyCodeId",companyCodeId)
					.queryParam("plantId",plantId)
					.queryParam("itemCode",itemCode)
					.queryParam("languageId",languageId)
	...
	public ImAlternatePart addImalternatePart (AddImAlternatePart addImAlternatePart, String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public ImAlternatePart updateImAlternatePart (String companyCodeId,String languageId,String warehouseId,String plantId,String itemCode,String altItemCode, UpdateImAlternatePart updateImAlternatePart,
												  String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			...
			restTemplate.setRequestFactory(new HttpComponentsClientHttpRequestFactory(client));
			UriComponentsBuilder builder =
					UriComponentsBuilder.fromHttpUrl(getMastersServiceUrl() + "imalternatepart/" + altItemCode)
							.queryParam("companyCodeId",companyCodeId)
							.queryParam("languageId",languageId)
							.queryParam("plantId",plantId)
							.queryParam("itemCode",itemCode)
	...
	// Delete PackingMaterial
	public boolean deleteImAlternateCode (String companyCodeId,String languageId,String warehouseId,String plantId,String itemCode,String altItemCode, String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// GET StorageBin
	public StorageBin getStorageBin(String storageBin,String companyCodeId,String plantId,String warehouseId,String languageId, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
...
//			return obList.toArray(new StorageBin[obList.size()]);
	...
	// Patch StorageBin
	public StorageBin updateStorageBin (String storageBin, String companyCodeId, String plantId, String languageId,String warehouseId, StorageBin modifiedStorageBin, String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// Delete StorageBin
	public boolean deleteStorageBin (String storageBin,String warehouseId, String companyCodeId,String languageId,String plantId,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// GET ImBatchSerial
	public ImBatchSerial getImBatchSerial(String storageMethod,String companyCodeId,String plantId,String languageId,String warehouseId,String itemCode, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// Patch ImPacking
	public ImBatchSerial updateImBatchSerial (String storageMethod,String companyCodeId,String plantId,String languageId,String warehouseId,String itemCode,UpdateImBatchSerial updateImBatchSerial,
											  String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	// Delete ImPacking
	public boolean deleteImBatchSerial (String storageMethod,String companyCodeId,String plantId,String languageId,String warehouseId,String itemCode,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// GET ImCapacity
	public ImCapacity getImCapacity(String companyCodeId,String plantId,String languageId,String warehouseId,String itemCode, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// Patch ImCapacity
	public ImCapacity updateImCapacity (String companyCodeId,String plantId,String languageId,String warehouseId,String itemCode,UpdateImCapacity updateImCapacity,
										String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	// Delete ImCapacity
	public boolean deleteImCapacity (String companyCodeId,String plantId,String languageId,String warehouseId,String itemCode,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// GET ImCapacity
	public ImVariant getImVariant(String companyCodeId,String plantId,String languageId,String warehouseId,String itemCode,Long variantCode,String variantType, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
			...
			HttpEntity<?> entity = new HttpEntity<>(headers);
			UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getMastersServiceUrl() + "imvariant/" + variantCode)
					.queryParam("companyCodeId",companyCodeId)
					.queryParam("languageId",languageId)
	...
	// POST ImVariant
	public ImVariant addImVariant (AddImVariant addImVariant, String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// Patch ImVariant
	public ImVariant updateImVariant (String companyCodeId,String plantId,String languageId,String warehouseId,String itemCode,Long variantCode,String variantType,UpdateImVariant updateImVariant,
									  String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			...
			UriComponentsBuilder builder =
					UriComponentsBuilder.fromHttpUrl(getMastersServiceUrl() + "imvariant/" + variantCode)
							.queryParam("companyCodeId",companyCodeId)
							.queryParam("languageId",languageId)
							.queryParam("warehouseId",warehouseId)
							.queryParam("plantId",plantId)
	...
	// Delete ImVariant
	public boolean deleteImVariant (String companyCodeId,String plantId,String languageId,String warehouseId,String itemCode,Long variantCode,String variantType, String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// GET ImPalletization
	public ImPalletization getImPalletization(String companyCodeId,String plantId,String languageId,String warehouseId,String itemCode,String palletizationLevel, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
			...
			HttpEntity<?> entity = new HttpEntity<>(headers);
			UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getMastersServiceUrl() + "impalletization/" + palletizationLevel)
					.queryParam("companyCodeId",companyCodeId)
					.queryParam("languageId",languageId)
					.queryParam("itemCode",itemCode)
					.queryParam("plantId",plantId)
	...
	public ImPalletization addImPalletization (AddImPalletization addImPalletization, String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public ImPalletization updatePalletization (String companyCodeId,String plantId,String languageId,String warehouseId,String itemCode,String palletizationLevel,UpdateImPalletization updateImPalletization,
												String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			...
			UriComponentsBuilder builder =
					UriComponentsBuilder.fromHttpUrl(getMastersServiceUrl() + "impalletization/" + palletizationLevel)
							.queryParam("companyCodeId",companyCodeId)
							.queryParam("languageId",languageId)
							.queryParam("warehouseId",warehouseId)
							.queryParam("plantId",plantId)
	...
	public boolean deleteImPalletization (String companyCodeId,String plantId,String languageId,String warehouseId,String itemCode,String palletizationLevel, String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// GET Dock
	public Dock getDock(String companyCodeId,String plantId,String languageId,String warehouseId,String dockId,String dockType, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// Patch Dock
	public Dock updateDock (String companyCodeId,String plantId,String languageId,String warehouseId,String dockId,String dockType,UpdateDock updateDock,
							String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	// Delete Dock
	public boolean deleteDock (String companyCodeId,String plantId,String languageId,String warehouseId,String dockId,String dockType, String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public CycleCountScheduler getCycleCountScheduler(String companyCodeId,String plantId,String languageId,String warehouseId,Long cycleCountTypeId,Long levelId,String schedulerNumber, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public CycleCountScheduler updateCycleCountScheduler (String companyCodeId,String plantId,String languageId,String warehouseId,Long cycleCountTypeId,Long levelId,String schedulerNumber,UpdateCycleCountScheduler updateCycleCountScheduler,
														  String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	public boolean deleteCycleCountScheduler (String companyCodeId,String plantId,String languageId,String warehouseId,Long levelId,String schedulerNumber,Long cycleCountTypeId,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// GET NumberRangeItem
	public NumberRangeItem getNumberRange(String companyCodeId,String plantId,String languageId,String warehouseId,Long itemTypeId,Long sequenceNo, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public NumberRangeItem updateNumberRangeItem (String companyCodeId,String plantId,String languageId,String warehouseId,Long itemTypeId,Long sequenceNo,UpdateNumberRangeItem updateNumberRangeItem,
												  String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	public boolean deleteNumberRangeItem (String companyCodeId,String plantId,String languageId,String warehouseId,Long itemTypeId,Long sequenceNo,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public NumberRangeStorageBin getNumberRangeStorageBin(String companyCodeId,String plantId,String languageId,String warehouseId,Long floorId,Long storageSectionId,String rowId,String aisleNumber,String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public NumberRangeStorageBin addNumberRangeStorageBin (AddNumberRangeStorageBin addNumberRangeStorageBin, String loginUserID, String authToken) {
		try {
			...
			ResponseEntity<NumberRangeStorageBin> result = getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, NumberRangeStorageBin.class);
			log.info("result : " + result.getStatusCode());
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public NumberRangeStorageBin updateNumberRangeStorageBin (String companyCodeId,String plantId,String languageId,String warehouseId,Long storageSectionId,Long floorId,String rowId,String aisleNumber,UpdateNumberRangeStorageBin updateNumberRangeStorageBin,
															  String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	public boolean deleteNumberRangeStorageBin (String companyCodeId,String plantId,String languageId,String warehouseId,Long floorId,Long storageSectionId,String rowId,String aisleNumber,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
...
//	}
	...
	// Patch WOrkCenterId
	public WorkCenter updateWorkCenter (String companyCodeId,String plantId,String languageId,String warehouseId,Long workCenterId,UpdateWorkCenter updateWorkCenter,
	...
	// Delete WorkCenter
	public boolean deleteWorkCenter (String companyCodeId,String plantId,String languageId,String warehouseId,Long workCenterId,String workCenterType,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
...
//THREEPL
	...
	// GET
	public Billing getBilling(String warehouseId, String moduleId, String partnerCode,String companyCodeId,String languageId,String plantId,String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Threepl RestTemplate");
	...
	// DELETE
	public boolean deleteBilling(String warehouseId,String moduleId,String partnerCode,String companyCodeId,String languageId,String plantId,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Threepl RestTemplate");
	...
	// GET
	public PriceList getPriceList(String warehouseId, String moduleId, Long priceListId, Long serviceTypeId,Long chargeRangeId,String companyCodeId,String languageId,String plantId,String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Threepl RestTemplate");
	...
	// DELETE
	public boolean deletePriceList(String warehouseId,String moduleId, Long priceListId,Long serviceTypeId,Long chargeRangeId,String companyCodeId,String languageId,String plantId,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Threepl RestTemplate");
	...
	// GET Driver
	public Driver getDriver(String companyCodeId,String plantId,String languageId,String warehouseId,String driverId, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public Driver updateDriver (String companyCodeId,String plantId,String languageId,String warehouseId,String driverId,UpdateDriver updateDriver,
								String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	public boolean deleteDriver (String companyCodeId,String plantId,String languageId,String warehouseId,String driverId,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// GET Vehicle
	public Vehicle getVehicle(String companyCodeId,String plantId,String languageId,String warehouseId,String vehicleNumber, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public Vehicle updateVehicle (String companyCodeId,String plantId,String languageId,String warehouseId,String vehicleNumber,UpdateVehicle updateVehicle,
								  String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	public boolean deleteVehicle (String companyCodeId,String plantId,String languageId,String warehouseId,String vehicleNumber,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// GET Route
	public Route getRoute(String companyCodeId,String plantId,String languageId,String warehouseId,String routeId, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public Route updateRoute (String companyCodeId,String plantId,String languageId,String warehouseId,String routeId,UpdateRoute updateRoute,
							  String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	public boolean deleteRoute (String companyCodeId,String plantId,String languageId,String warehouseId,String routeId,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public DriverVehicleAssignment getDriverVehicleAssignment(String companyCodeId,String plantId,String languageId,String warehouseId,String routeId,String driverId,String vehicleNumber, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public DriverVehicleAssignment addDriverVehicleAssignment (AddDriverVehicleAssignment addDriverVehicleAssignment, String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
			...
			ResponseEntity<DriverVehicleAssignment> result = getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, DriverVehicleAssignment.class);
			log.info("result : " + result.getStatusCode());
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public DriverVehicleAssignment updateDriverVehicleAssignment (String companyCodeId,String plantId,String languageId,String warehouseId,String routeId,String driverId,
		...
		try {
			...
			ResponseEntity<DriverVehicleAssignment> result = restTemplate.exchange(builder.toUriString(), HttpMethod.PATCH, entity, DriverVehicleAssignment.class);
			log.info("result : " + result.getStatusCode());
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public boolean deleteDriverVehicleAssignment (String companyCodeId,String plantId,String languageId,String warehouseId,
												  String routeId,String vehicleNumber,String driverId,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public DriverVehicleAssignment[] findDriverVehicleAssignment(SearchDriverVehicleAssignment searchDriverVehicleAssignment, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "MNRClara RestTemplate");
