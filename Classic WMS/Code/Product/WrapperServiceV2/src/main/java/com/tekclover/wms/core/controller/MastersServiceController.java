...
public class MastersServiceController {
	...
	public ResponseEntity<?> getBomHeader(@PathVariable String parentItemCode,@RequestParam String languageId,
										  @RequestParam String companyCode,@RequestParam String plantId, @RequestParam String warehouseId, @RequestParam String authToken) {
...
*/
	...
	public ResponseEntity<?> getBusinessPartner(@PathVariable String partnerCode,@RequestParam String companyCodeId,@RequestParam String plantId,
												@RequestParam String warehouseId,@RequestParam String languageId,@RequestParam Long businessPartnerType, @RequestParam String authToken) {
	...
	public ResponseEntity<?> updateHandlingEquipment(@PathVariable String handlingEquipmentId,@RequestParam String warehouseId,
													 ...
													 @RequestBody HandlingEquipment updatedHandlingEquipment, @RequestParam String loginUserID, @RequestParam String authToken) {
	...
	public ResponseEntity<?> getImBasicData1(@PathVariable String itemCode,@RequestParam String companyCodeId,@RequestParam String plantId,
											 @RequestParam String uomId,@RequestParam String languageId, @RequestParam String warehouseId, @RequestParam String authToken) {

		ImBasicData1 imbasicdata1 = mastersService.getImBasicData1(itemCode, warehouseId,companyCodeId,plantId,uomId,languageId,authToken);
		log.info("ImBasicData1 : " + imbasicdata1);
		return new ResponseEntity<>(imbasicdata1, HttpStatus.OK);
	}
	...
	public ResponseEntity<?> updateImBasicData1(@PathVariable String itemCode,@RequestParam String warehouseId,@RequestParam String companyCodeId,
												@RequestParam String plantId,@RequestParam String languageId, @RequestParam String uomId, @RequestBody ImBasicData1 updatedImBasicData1,
												@RequestParam String loginUserID, @RequestParam String authToken) {

		ImBasicData1 modifiedImBasicData1 = mastersService.updateImBasicData1(itemCode,warehouseId,companyCodeId,plantId,
	...
	public ResponseEntity<?> deleteImBasicData1(@RequestParam String authToken,@RequestParam String itemCode,@RequestParam String warehouseId,
												@RequestParam String companyCodeId,@RequestParam String plantId,@RequestParam String languageId, @RequestParam String loginUserID,
												@RequestParam String uomId) {

		mastersService.deleteImBasicData1(itemCode,warehouseId,companyCodeId,plantId,uomId,languageId,loginUserID, authToken);
		return new ResponseEntity<>(HttpStatus.NO_CONTENT);
	}
	...
	public ResponseEntity<?> getImPartner(@PathVariable String businessPartnerCode,@RequestParam String companyCodeId,
										  @RequestParam String plantId,@RequestParam String languageId,@RequestParam String partnerItemBarcode,@RequestParam String warehouseId,
										  @RequestParam String itemCode,@RequestParam String businessPartnerType, @RequestParam String authToken) {

		ImPartner impartner = mastersService.getImPartner(businessPartnerCode,companyCodeId,plantId,languageId,
				warehouseId,itemCode,businessPartnerType,partnerItemBarcode,authToken);
	...
	public ResponseEntity<?> updateImPartner(@PathVariable String businessPartnerCode,@RequestParam String companyCodeId,
											 @RequestParam String plantId,@RequestParam String languageId,@RequestParam String partnerItemBarcode,
											 @RequestParam String warehouseId,@RequestParam String itemCode,@RequestParam String businessPartnerType,
											 @RequestBody ImPartner updatedImPartner, @RequestParam String loginUserID, @RequestParam String authToken) {

		ImPartner modifiedImPartner = mastersService.updateImPartner(businessPartnerCode,companyCodeId,plantId,languageId,
				warehouseId,itemCode,businessPartnerType,partnerItemBarcode,updatedImPartner,loginUserID, authToken);
	...
	public ResponseEntity<?> deleteImPartner(@RequestParam String authToken,@RequestParam String companyCodeId,
											 @RequestParam String plantId,@RequestParam String languageId,@RequestParam String warehouseId,
											 @RequestParam String itemCode,@RequestParam String businessPartnerType,@RequestParam String partnerItemBarcode,
											 @RequestParam String loginUserID, @RequestParam String businessPartnerCode) {
		mastersService.deleteImPartner(businessPartnerCode,companyCodeId,plantId,languageId,warehouseId, itemCode,businessPartnerType,
				partnerItemBarcode,loginUserID, authToken);
	...
	public ResponseEntity<?> getImStrategies(@PathVariable String strategeyTypeId,@RequestParam String companyCodeId,
											 @RequestParam String plantId,@RequestParam String warehouseId,@RequestParam String itemCode,@RequestParam Long sequenceIndicator,
											 @RequestParam String languageId, @RequestParam String authToken) {

		ImStrategies imstrategies = mastersService.getImStrategies(strategeyTypeId,companyCodeId,plantId,warehouseId,
	...
	public ResponseEntity<?> updateImStrategies(@PathVariable String strategeyTypeId,
												@RequestBody ImStrategies updatedImStrategies, @RequestParam String loginUserID,@RequestParam String companyCodeId,
		...
		ImStrategies modifiedImStrategies =
				mastersService.updateImStrategies(strategeyTypeId,companyCodeId,plantId,warehouseId,itemCode,sequenceIndicator,
	...
	public ResponseEntity<?> deleteImStrategies(@RequestParam String authToken,@RequestParam String companyCodeId,
												@RequestParam String plantId,@RequestParam String languageId,@RequestParam String warehouseId,@RequestParam String itemCode,@RequestParam Long sequenceIndicator, @RequestParam String loginUserID,
												@RequestParam String strategeyTypeId) {
		mastersService.deleteImStrategies(strategeyTypeId,companyCodeId,plantId,warehouseId,itemCode,sequenceIndicator,
	...
	public ResponseEntity<?> getPackingMaterial(@PathVariable String packingMaterialNo,@RequestParam String companyCodeId,@RequestParam String languageId,@RequestParam String plantId,@RequestParam String warehouseId, @RequestParam String authToken) {
	...
	public ResponseEntity<?> deletePackingMaterial(@RequestParam String authToken,@RequestParam String companyCodeId,
												   @RequestParam String languageId,@RequestParam String plantId,@RequestParam String warehouseId,@RequestParam String loginUserID,
	...
	@RequestMapping(value = "/imalternatepart/{altItemCode}", method = RequestMethod.GET)
	public ResponseEntity<?> getImAlternatePart(@PathVariable String altItemCode, @RequestParam String companyCodeId,
												@RequestParam String languageId, @RequestParam String plantId,@RequestParam String itemCode,
												@RequestParam String warehouseId, @RequestParam String authToken) {
		ImAlternatePart imAlternatePart =
				mastersService.getImAlternatePart(companyCodeId,languageId,warehouseId,plantId,itemCode,altItemCode,authToken);
	...
	public ResponseEntity<?> createImAlternatePart(@RequestBody AddImAlternatePart newImPartner, @RequestParam String loginUserID,
												   @RequestParam String authToken) {
	...
	@RequestMapping(value = "/imalternatepart/{altItemCode}", method = RequestMethod.PATCH)
	public ResponseEntity<?> updateImAlternatePart(@PathVariable String altItemCode, @RequestParam String companyCodeId, @RequestParam String languageId, @RequestParam String plantId,
												   @RequestParam String itemCode, @RequestParam String warehouseId, @Valid @RequestBody UpdateImAlternatePart updateImAlternatePart,
												   @RequestParam String loginUserID, @RequestParam String authToken) {
		ImAlternatePart modifiedImAlternatePart =
				mastersService.updateImAlternatePart(companyCodeId,languageId,warehouseId,plantId,itemCode,altItemCode,
	...
	@RequestMapping(value = "/imalternatepart/{altItemCode}", method = RequestMethod.DELETE)
	public ResponseEntity<?> deleteImAlternatePart(@RequestParam String authToken,@PathVariable String altItemCode,
												   @RequestParam String companyCodeId, @RequestParam String languageId, @RequestParam String plantId,@RequestParam String itemCode, @RequestParam String warehouseId,@RequestParam String loginUserID) {

		mastersService.deleteImAlternateCode(companyCodeId,languageId,warehouseId,plantId,itemCode,altItemCode,loginUserID, authToken);
		return new ResponseEntity<>(HttpStatus.NO_CONTENT);
	}
	...
	public ResponseEntity<?> getStorageBin(@PathVariable String storageBin,@RequestParam String companyCodeId,
										   @RequestParam String plantId,@RequestParam String warehouseId,@RequestParam String languageId,@RequestParam String authToken) {
	...
	public ResponseEntity<?> deleteStorageBin(@PathVariable String storageBin,@RequestParam String warehouseId,@RequestParam String companyCodeId,@RequestParam String plantId,@RequestParam String languageId,
											  @RequestParam String loginUserID,@RequestParam String authToken) {
	...
	public ResponseEntity<?> getImBatchSerial(@RequestParam String warehouseId,@PathVariable String storageMethod,@RequestParam String itemCode,@RequestParam String companyCodeId,
											  @RequestParam String languageId,@RequestParam String plantId,@RequestParam String authToken) {
	...
	public ResponseEntity<?> updateBatchSerial(@RequestParam String authToken,@PathVariable String storageMethod,@RequestParam String companyCodeId,@RequestParam String itemCode,
											   @RequestParam String languageId,@RequestParam String plantId,@RequestParam String loginUserID,
	...
	@RequestMapping(value = "/imvariant/{variantCode}", method = RequestMethod.GET)
	public ResponseEntity<?> getImVariant(@RequestParam String warehouseId,@PathVariable Long variantCode,@RequestParam String itemCode,
										  @RequestParam String variantType, @RequestParam String companyCodeId, @RequestParam String languageId,
		...
		ImVariant imVariant = mastersService.getImVariant(companyCodeId,plantId,languageId,warehouseId,
				itemCode,variantCode,variantType,authToken);
	...
	public ResponseEntity<?> createImVariant(@RequestParam String authToken,@RequestParam String loginUserID,
											 @RequestBody AddImVariant addImVariant) {
	...
	@RequestMapping(value = "/imvariant/{variantCode}", method = RequestMethod.PATCH)
	public ResponseEntity<?> updateVariant(@RequestParam String authToken,@PathVariable Long variantCode,@RequestParam String companyCodeId,
										   @RequestParam String itemCode,@RequestParam String variantType,
										   @RequestParam String languageId,@RequestParam String plantId,@RequestParam String loginUserID,
										   @RequestParam String warehouseId,@RequestBody UpdateImVariant updateImVariant) {

		ImVariant imVariant = mastersService.updateImVariant(companyCodeId,plantId,languageId,warehouseId,itemCode,
				variantCode,variantType,updateImVariant,loginUserID,authToken);
		return new ResponseEntity<>(imVariant,HttpStatus.OK);
	}

	@ApiOperation(response = ImVariant.class, value = "Delete ImVariant") // label for swagger
	@RequestMapping(value = "/imvariant/{variantCode}", method = RequestMethod.DELETE)
	public ResponseEntity<?> deleteImVariant(@PathVariable Long variantCode,@RequestParam String companyCodeId,@RequestParam String itemCode,
											 @RequestParam String variantType, @RequestParam String languageId,@RequestParam String plantId,
											 @RequestParam String loginUserID,@RequestParam String warehouseId, @RequestParam String authToken) {

		mastersService.deleteImVariant(companyCodeId,plantId,languageId,warehouseId,itemCode,variantCode,
				variantType,loginUserID,authToken);
		return new ResponseEntity<>(HttpStatus.NO_CONTENT);
	}
	...
	@RequestMapping(value = "/impalletization/{palletizationLevel}", method = RequestMethod.GET)
	public ResponseEntity<?> getImPalletization(@RequestParam String warehouseId,@PathVariable String palletizationLevel,
												@RequestParam String itemCode, @RequestParam String companyCodeId,@RequestParam String languageId,
												@RequestParam String plantId,@RequestParam String authToken) {
		ImPalletization imPalletization = mastersService.getImPalletization(companyCodeId,plantId,languageId,warehouseId,
				itemCode,palletizationLevel,authToken);
	...
	public ResponseEntity<?> createImPalletization(@RequestParam String authToken,@RequestParam String loginUserID,
												   @RequestBody AddImPalletization addImPalletization) {
	...
	@RequestMapping(value = "/impalletization/{palletizationLevel}", method = RequestMethod.PATCH)
	public ResponseEntity<?> updateVariant(@RequestParam String authToken,@PathVariable String palletizationLevel,@RequestParam String companyCodeId,
										   @RequestParam String itemCode, @RequestParam String languageId,@RequestParam String plantId,
										   @RequestParam String loginUserID, @RequestParam String warehouseId,@RequestBody UpdateImPalletization updateImPalletization) {

		ImPalletization imPalletization = mastersService.updatePalletization(companyCodeId,plantId,languageId,warehouseId,
				itemCode,palletizationLevel,updateImPalletization,loginUserID,authToken);
		return new ResponseEntity<>(imPalletization,HttpStatus.OK);
	}
	@ApiOperation(response = ImPalletization.class, value = "Delete ImPalletization") // label for swagger
	@RequestMapping(value = "/impalletization/{palletizationLevel}", method = RequestMethod.DELETE)
	public ResponseEntity<?> deleteImVariant(@PathVariable String palletizationLevel,@RequestParam String companyCodeId,@RequestParam String itemCode,
											 @RequestParam String languageId,@RequestParam String plantId,@RequestParam String loginUserID,
											 @RequestParam String warehouseId, @RequestParam String authToken) {

		mastersService.deleteImPalletization(companyCodeId,plantId,languageId,warehouseId,itemCode,
				palletizationLevel,loginUserID,authToken);
		return new ResponseEntity<>(HttpStatus.NO_CONTENT);
	}
...
//GET
	...
	public ResponseEntity<?> getNumberRangeStorageBin(@RequestParam String warehouseId,@PathVariable Long storageSectionId,@RequestParam Long floorId,
													  @RequestParam String aisleNumber,@RequestParam String rowId, @RequestParam String companyCodeId,
													  @RequestParam String languageId,@RequestParam String plantId, @RequestParam String authToken) {
...
//CREATE
	...
	@ApiOperation(response = NumberRangeStorageBin.class, value = "Create new NumberRangeStorageBin") // label for swagger
...
//UPDATE
	...
	public ResponseEntity<?> updateNumberRangeStorageBin(@RequestParam String authToken,@PathVariable Long storageSectionId,@RequestParam String companyCodeId,
														 @RequestParam Long floorId,@RequestParam String rowId,@RequestParam String aisleNumber, @RequestParam String languageId,@RequestParam String plantId,
														 @RequestParam String loginUserID, @RequestParam String warehouseId,@RequestBody UpdateNumberRangeStorageBin updateNumberRangeStorageBin) {
...
//DELETE
	...
	public ResponseEntity<?> deleteNUmberRangeItem(@PathVariable Long storageSectionId,@RequestParam String companyCodeId,@RequestParam Long floorId,
...
//GET
	...
	public ResponseEntity<?> getWorkCenter(@RequestParam String warehouseId,@PathVariable Long workCenterId,@RequestParam String workCenterType, @RequestParam String companyCodeId,
										   @RequestParam String languageId,@RequestParam String plantId, @RequestParam String authToken) {
...
//GET
	...
	public ResponseEntity<?> getbilling(@RequestParam String warehouseId,@RequestParam  String moduleId,@PathVariable String partnerCode,@RequestParam String companyCodeId,
										@RequestParam String languageId,@RequestParam String plantId,@RequestParam String authToken) {
...
//GET
	...
	public ResponseEntity<?> getPriceList(@RequestParam String warehouseId,@RequestParam String moduleId,@RequestParam String companyCodeId,
										  @RequestParam String languageId,@RequestParam String plantId,
										  @PathVariable Long priceListId,@RequestParam Long serviceTypeId,@RequestParam Long chargeRangeId,@RequestParam String authToken) {
...
//UPDATE
	...
	public ResponseEntity<?> updatePriceList(@RequestParam String authToken,@PathVariable Long priceListId,@RequestParam String companyCodeId,
											 @RequestParam String languageId,@RequestParam String plantId,
											 @RequestParam Long serviceTypeId, @RequestParam String moduleId,@RequestParam Long chargeRangeId,@RequestParam  String loginUserID,
...
//DELETE
	...
	public ResponseEntity<?> getDriver(@RequestParam String warehouseId,@PathVariable String driverId, @RequestParam String companyCodeId,
									   @RequestParam String languageId,@RequestParam String plantId, @RequestParam String authToken) {
	...
	public ResponseEntity<?> updateDriver(@RequestParam String authToken,@PathVariable String driverId,@RequestParam String companyCodeId,
										  @RequestParam String languageId,@RequestParam String plantId,
										  @RequestParam String loginUserID, @RequestParam String warehouseId,@RequestBody UpdateDriver updateDriver) {
	...
	public ResponseEntity<?> deleteDriver(@PathVariable String driverId,@RequestParam String companyCodeId, @RequestParam String languageId,
										  @RequestParam String plantId,@RequestParam String loginUserID,
										  @RequestParam String warehouseId, @RequestParam String authToken) {
	...
	public ResponseEntity<?> getRoute(@RequestParam String warehouseId,@PathVariable String routeId, @RequestParam String companyCodeId,
									  @RequestParam String languageId,@RequestParam String plantId, @RequestParam String authToken) {
	...
	public ResponseEntity<?> updateRoute(@RequestParam String authToken,@PathVariable String routeId,@RequestParam String companyCodeId,
										 @RequestParam String languageId,@RequestParam String plantId,
										 @RequestParam String loginUserID, @RequestParam String warehouseId,@RequestBody UpdateRoute updateRoute) {
	...
	public ResponseEntity<?> deleteRoute(@PathVariable String routeId,@RequestParam String companyCodeId, @RequestParam String languageId,
										 @RequestParam String plantId,@RequestParam String loginUserID,
										 @RequestParam String warehouseId, @RequestParam String authToken) {
	...
	//GET ALL
	@ApiOperation(response = DriverVehicleAssignment.class, value = "Get All DriverVehicleAssignment") // label for swagger
	...
	public ResponseEntity<?> getDriverVehicleAssignment(@RequestParam String warehouseId,@PathVariable String driverId,@RequestParam String vehicleNumber,
														@RequestParam String routeId,@RequestParam String companyCodeId,
														@RequestParam String languageId,@RequestParam String plantId, @RequestParam String authToken) {
	...
	//CREATE
	@ApiOperation(response = DriverVehicleAssignment.class, value = "Create new DriverVehicleAssignment") // label for swagger
	...
	public ResponseEntity<?> createDriverVehicleAssignment(@RequestParam String authToken,@RequestParam String loginUserID,
		...
		DriverVehicleAssignment dbDriverVehicleAssignment = mastersService.addDriverVehicleAssignment(addDriverVehicleAssignment,loginUserID, authToken);
		return new ResponseEntity<>(dbDriverVehicleAssignment, HttpStatus.OK);
	}
	...
	public ResponseEntity<?> updateDriverVehicleAssignment(@RequestParam String authToken,@PathVariable String driverId,@RequestParam String vehicleNumber,
														   @RequestParam String routeId,@RequestParam String companyCodeId, @RequestParam String languageId,@RequestParam String plantId,
														   @RequestParam String loginUserID, @RequestParam String warehouseId,@RequestBody UpdateDriverVehicleAssignment updateDriverVehicleAssignment) {

		DriverVehicleAssignment dbDriverVehicleAssignment = mastersService.updateDriverVehicleAssignment(companyCodeId,plantId,
				languageId,warehouseId,routeId,driverId,vehicleNumber,updateDriverVehicleAssignment,loginUserID,authToken);
	...
	public ResponseEntity<?> deleteDriverVehicleAssignment(@PathVariable String driverId,@RequestParam String vehicleNumber,@RequestParam String routeId,@RequestParam String companyCodeId,
														   @RequestParam String languageId, @RequestParam String plantId,@RequestParam String loginUserID,
														   @RequestParam String warehouseId, @RequestParam String authToken) {
