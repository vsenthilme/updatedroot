...
//			log.info("result : " + result);
	...
	// GET
	public City getCity(String cityId,String stateId,String countryId,Long zipCode,String languageId,String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
...
//			log.info("result : " + result.getStatusCode());
	...
	// UPDATE
	public City updateCity (String cityId,String stateId,String countryId,Long zipCode,String languageId,String loginUserID,UpdateCity modifiedCity, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
...
//			log.info("result : " + result.getStatusCode());
	...
	// DELETE
	public boolean deleteCity (String cityId,String stateId,String countryId,Long zipCode,String languageId,String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
...
//			log.info("result : " + result.getStatusCode());
	...
	public SubItemGroupId getSubItemGroupId (String warehouseId, Long itemTypeId, Long itemGroupId,
											 Long subItemGroupId, String subItemGroup,String companyCodeId,String languageId,String plantId,String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "RestTemplate");
	...
	public SubItemGroupId updateSubItemGroupId (String warehouseId, Long itemTypeId, Long itemGroupId,
												Long subItemGroupId, String subItemGroup,String companyCodeId,String languageId,String plantId,String loginUserID, UpdateSubItemGroupId modifiedSubItemGroupId,
												String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	public boolean deleteSubItemGroupId (String warehouseId, Long itemTypeId, Long itemGroupId, Long subItemGroupId,
										 String subItemGroup,String companyCodeId,String languageId,String plantId,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "MNRClara's RestTemplate");
	...
	//SEARCH HhtUser
	public HhtUser[] findHhtUser(FindHhtUser findHhtUser,String authToken){
		try{
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "RestTemplate");
			...
			ResponseEntity<HhtUser[]> result =
					getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, HhtUser[].class);
			log.info("result : " + result.getStatusCode());
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
	...
	//PATCH
	public HandlingEquipmentId updateHandlingEquipmentId(String warehouseId, String handlingEquipmentId,String handlingEquipmentNumber,String companyCodeId,String languageId,String plantId,String loginUserID,
	...
	//DELETE
	public boolean deleteHandlingEquipmentId(String warehouseId, String handlingEquipmentId,String handlingEquipmentNumber,String companyCodeId,String languageId,String plantId,String loginUserID,String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "RestTemplate");
	...
	// GET
	public HandlingUnitId getHandlingUnitId(String warehouseId,String handlingUnitId, String handlingUnitNumber,String companyCodeId,String languageId,String plantId,String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "RestTemplate");
	...
	//PATCH
	public HandlingUnitId updateHandlingUnitId(String warehouseId, String handlingUnitId,String handlingUnitNumber,String companyCodeId,String languageId,String plantId, String loginUserID,
	...
	//DELETE
	public boolean deleteHandlingUnitId(String warehouseId,String handlingUnitId,String handlingUnitNumber,String companyCodeId,String languageId,String plantId,String loginUserID,String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "RestTemplate");
	...
	//------------------------------INTERIM-BARCODE---------------------------------------------------------
	// GET ALL
	public InterimBarcode[] getInterimBarcodes (String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "IdMaster RestTemplate");
			...
			ResponseEntity<InterimBarcode[]> result =
					getRestTemplate().exchange(builder.toUriString(), HttpMethod.GET, entity, InterimBarcode[].class);
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
			throw e;
	...
	// GET
	public InterimBarcode getInterimBarcode(String storageBin, String itemCode, String barcode, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "IdMaster RestTemplate");
			headers.add("Authorization", "Bearer " + authToken);
			HttpEntity<?> entity = new HttpEntity<>(headers);
			UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getIDMasterServiceApiUrl() + "interimbarcode/" + storageBin)
	...
	// CREATE
	public InterimBarcode addInterimBarcode(AddInterimBarcode newInterimBarcode, String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "IdMaster RestTemplate");
