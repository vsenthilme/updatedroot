...
public class InvoiceHeaderController {
    ...
    public ResponseEntity<?> getInvoiceHeader(@PathVariable String invoiceNumber, @RequestParam String partnerCode,
        ...
        InvoiceHeader InvoiceHeader =
                invoiceHeaderService.getInvoiceHeader(warehouseId, invoiceNumber, partnerCode);
    ...
    public ResponseEntity<?> patchInvoiceHeader(@RequestParam String warehouseId, @PathVariable String invoiceNumber, @RequestParam String partnerCode,
        ...
        InvoiceHeader createdInvoiceHeader =
                invoiceHeaderService.updateInvoiceHeader(warehouseId, invoiceNumber,partnerCode,loginUserID, updateInvoiceHeader);
        return new ResponseEntity<>(createdInvoiceHeader, HttpStatus.OK);
    }

    @ApiOperation(response = InvoiceHeader.class, value = "Delete InvoiceHeader") // label for swagger
    @DeleteMapping("/{invoiceNumber}")
    public ResponseEntity<?> deleteInvoiceHeader(@PathVariable String invoiceNumber,
                                               @RequestParam String warehouseId, @RequestParam String partnerCode, @RequestParam String loginUserID) {
        invoiceHeaderService.deleteInvoiceHeader(warehouseId,invoiceNumber,partnerCode, loginUserID);
