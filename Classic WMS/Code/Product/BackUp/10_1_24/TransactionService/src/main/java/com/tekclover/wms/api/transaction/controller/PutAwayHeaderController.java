...
//    	log.info("PutAwayHeader : " + putawayheader);
    ...
    @PostMapping("")
    public ResponseEntity<?> postPutAwayHeader(@Valid @RequestBody AddPutAwayHeader newPutAwayHeader,
                                               @RequestParam String loginUserID)
            throws IllegalAccessException, InvocationTargetException {
        PutAwayHeader createdPutAwayHeader =
                putawayheaderService.createPutAwayHeader(newPutAwayHeader, loginUserID);
    ...
    public ResponseEntity<?> patchPutAwayHeader(@PathVariable String putAwayNumber, @RequestParam String companyCodeId,
                                                ...
                                                @Valid @RequestBody UpdatePutAwayHeader updatePutAwayHeader,
                                                @RequestParam String loginUserID)
            throws IllegalAccessException, InvocationTargetException {

        PutAwayHeader createdPutAwayHeader =
                putawayheaderService.updatePutAwayHeader(warehouseId, companyCodeId, plantId,
                        languageId, preInboundNo, refDocNumber, goodsReceiptNo, palletCode,
    ...
    public ResponseEntity<?> patchPutAwayHeader(@PathVariable String refDocNumber, @RequestParam String packBarcodes,
        ...
        putawayheaderService.updatePutAwayHeader(refDocNumber, companyCodeId, warehouseId, plantId, languageId,
                packBarcodes, loginUserID);
    ...
    public ResponseEntity<?> deletePutAwayHeader(@PathVariable String putAwayNumber, @RequestParam String companyCodeId,
        ...
        putawayheaderService.deletePutAwayHeader(warehouseId, companyCodeId, plantId, languageId,
