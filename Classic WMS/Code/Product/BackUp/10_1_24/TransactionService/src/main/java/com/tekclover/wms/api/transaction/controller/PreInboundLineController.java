...
//    	log.info("PreInboundLine : " + preinboundline);
    ...
    public ResponseEntity<?> postPreInboundLineBOM(@RequestParam String preInboundNo, @RequestParam String warehouseId,
        ...
        List<PreInboundLineEntity> createdPreInboundLine = preinboundlineService.createPreInboundLine(
                preInboundNo, warehouseId, companyCode, plantId, languageId, refDocNumber, itemCode, lineNo, loginUserID);
        return new ResponseEntity<>(createdPreInboundLine, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> patchPreInboundLine(@PathVariable String preInboundNo, @RequestParam String warehouseId,
        ...
        PreInboundLineEntity createdPreInboundLine = preinboundlineService.updatePreInboundLine(preInboundNo, warehouseId, companyCode,
                plantId, languageId, refDocNumber, lineNo, itemCode, updatePreInboundLine, loginUserID);
        return new ResponseEntity<>(createdPreInboundLine, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> deletePreInboundLine(@PathVariable String preInboundNo, @RequestParam String warehouseId,
                                                  @RequestParam String companyCode, @RequestParam String plantId, @RequestParam String languageId,
                                                  @RequestParam String refDocNumber, @RequestParam Long lineNo,
                                                  @RequestParam String itemCode, @RequestParam String loginUserID) {

        preinboundlineService.deletePreInboundLine(preInboundNo, warehouseId, companyCode, plantId,
                languageId, refDocNumber, lineNo, itemCode, loginUserID);
