	...
	public void processInboundOrder() throws IllegalAccessException, InvocationTargetException {
		if (inboundList == null || inboundList.isEmpty()) {
			...
			for (InboundOrder dbOBOrder : sqlInboundList) {
				...
				inboundIntegrationHeader.setCompanyCode(dbOBOrder.getCompanyCode());
				inboundIntegrationHeader.setPlantId(dbOBOrder.getBranchCode());
				inboundIntegrationHeader.setLanguageId(dbOBOrder.getLanguageId());
				inboundIntegrationHeader.setWarehouseID(dbOBOrder.getWarehouseID());
	...
	public void processOutboundOrder() throws IllegalAccessException, InvocationTargetException, ParseException {
		if (outboundList == null || outboundList.isEmpty()) {
			...
			for (OutboundOrder dbOBOrder : sqlOutboundList) {
				...
				outboundIntegrationHeader.setCompanyCodeId(dbOBOrder.getCompanyCode());
				outboundIntegrationHeader.setPlantId(dbOBOrder.getBranchCode());
