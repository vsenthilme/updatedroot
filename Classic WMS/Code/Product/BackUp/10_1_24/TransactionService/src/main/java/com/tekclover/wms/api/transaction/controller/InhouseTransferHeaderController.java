...
public class InhouseTransferHeaderController {
    ...
    public ResponseEntity<?> getInHouseTransferHeader(@PathVariable String transferNumber, @RequestParam String warehouseId, @RequestParam String companyCode,
                                                      @RequestParam String plantId, @RequestParam String languageId, @RequestParam Long transferTypeId) {
        InhouseTransferHeader inhousetransferheader =
                inHouseTransferHeaderService.getInHouseTransferHeader(warehouseId, companyCode, plantId,
                languageId, transferNumber, transferTypeId);
