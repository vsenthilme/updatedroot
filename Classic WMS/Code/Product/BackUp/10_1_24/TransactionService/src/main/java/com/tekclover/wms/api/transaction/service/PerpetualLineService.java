...
public class PerpetualLineService extends BaseService {
     ...
     * @return
     */
    public PerpetualLine getPerpetualLine(String warehouseId, String companyCodeId, String plantId, String languageId, String cycleCountNo,
                                          String storageBin, String itemCode, String packBarcodes) {
        PerpetualLine perpetualLine =
                perpetualLineRepository.findByCompanyCodeIdAndPlantIdAndWarehouseIdAndLanguageIdAndCycleCountNoAndStorageBinAndItemCodeAndPackBarcodesAndDeletionIndicator(
                        companyCodeId, plantId, warehouseId, languageId, cycleCountNo, storageBin, itemCode,
                        packBarcodes, 0L);
    ...
    public List<PerpetualLine> updateAssingHHTUser(List<AssignHHTUserCC> assignHHTUsers, String loginUserID) {
        ...
        for (AssignHHTUserCC assignHHTUser : assignHHTUsers) {
            perpetualLineRepository.updateHHTUser(assignHHTUser.getCompanyCode(), assignHHTUser.getPlantId(), assignHHTUser.getLanguageId(),  assignHHTUser.getCycleCounterId(),
    ...
    public List<PerpetualLine> updatePerpetualLineForMobileCount(List<UpdatePerpetualLine> updatePerpetualLines,
        ...
        for (UpdatePerpetualLine updatePerpetualLine : updatePerpetualLines) {
            PerpetualLine dbPerpetualLine = getPerpetualLine(updatePerpetualLine.getWarehouseId(), updatePerpetualLine.getCompanyCodeId(),
                    updatePerpetualLine.getPlantId(), updatePerpetualLine.getLanguageId(), updatePerpetualLine.getCycleCountNo(),
...
//					createInventoryMovement (updatedPerpetualLine);
            ...
            PerpetualHeader updatedPerpetualHeader = perpetualHeaderService.updatePerpetualHeader(dbPerpetualHeader.getWarehouseId(), dbPerpetualHeader.getCompanyCodeId(), dbPerpetualHeader.getPlantId(), dbPerpetualHeader.getLanguageId(), dbPerpetualHeader.getCycleCountTypeId(),
