...
public class QualityHeaderService {
     ...
     * @return
     */
    public QualityHeader getQualityHeader(String warehouseId, String companyCodeId, String plantId, String languageId, String preOutboundNo, String refDocNumber,
                                          String qualityInspectionNo, String actualHeNo) {
        QualityHeader qualityHeader =
                qualityHeaderRepository.findByWarehouseIdAndCompanyCodeIdAndPlantIdAndLanguageIdAndPreOutboundNoAndRefDocNumberAndQualityInspectionNoAndActualHeNoAndDeletionIndicator(
                        warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, qualityInspectionNo, actualHeNo, 0L);
     ...
     * @return
     */
    public long getQualityHeaderCountForDeliveryConfirmation(String warehouseId, String companyCodeId, String plantId, String languageId, String refDocNumber, String preOutboundNo, Long statusId) {
        long qualityHeaderCount = qualityHeaderRepository.getQualityHeaderByWarehouseIdAndCompanyCodeIdAndPlantIdAndLanguageIdAndRefDocNumberAndPreOutboundNoAndStatusIdInAndDeletionIndicator(
     ...
     * @return
     */
    public QualityHeader getQualityHeaderForUpdate(String companyCodeId, String plantId, String languageId,
                                                   String warehouseId, String preOutboundNo, String refDocNumber,
                                                   String qualityInspectionNo, String actualHeNo) {
        QualityHeader qualityHeader =
                qualityHeaderRepository.findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndPreOutboundNoAndRefDocNumberAndQualityInspectionNoAndActualHeNoAndDeletionIndicator(
     ...
     * @return
     */
    private QualityHeader getQualityHeaderForUpdate(String warehouseId, String companyCodeId, String plantId, String languageId, String preOutboundNo, String refDocNumber,
                                                    String partnerCode, String pickupNumber, String qualityInspectionNo, String actualHeNo) {
        QualityHeader qualityHeader =
                qualityHeaderRepository.findByWarehouseIdAndCompanyCodeIdAndPlantIdAndLanguageIdAndPreOutboundNoAndRefDocNumberAndPartnerCodeAndPickupNumberAndQualityInspectionNoAndActualHeNoAndDeletionIndicator(
                        warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, partnerCode, pickupNumber, qualityInspectionNo, actualHeNo, 0L);
        if (qualityHeader != null) {
            return qualityHeader;
        }
     ...
     * @return
     */
    public List<QualityHeader> getQualityHeaderForReversal(String warehouseId, String companyCodeId, String plantId, String languageId, String preOutboundNo, String refDocNumber,
                                                           String qualityInspectionNo, String actualHeNo) {
        List<QualityHeader> qualityHeader =
                qualityHeaderRepository.findAllByWarehouseIdAndCompanyCodeIdAndPlantIdAndLanguageIdAndPreOutboundNoAndRefDocNumberAndQualityInspectionNoAndActualHeNoAndDeletionIndicator(
                        warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, qualityInspectionNo, actualHeNo, 0L);
    ...
    public List<QualityHeader> getInitialQualityHeaderForReversal(String warehouseId, String companyCodeId, String plantId, String languageId, String preOutboundNo, String refDocNumber,
                                                                  String pickupNumber, String partnerCode) {
        List<QualityHeader> qualityHeader =
                qualityHeaderRepository.findByWarehouseIdAndCompanyCodeIdAndPlantIdAndLanguageIdAndPreOutboundNoAndRefDocNumberAndPickupNumberAndPartnerCodeAndDeletionIndicator(
                        warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, pickupNumber, partnerCode, 0L);
        if (qualityHeader != null && qualityHeader.size() != 0) {
            return qualityHeader;
        }
        log.info("Given values for QualityHeader : " + warehouseId + ":" + companyCodeId + ":" + plantId + ":" + languageId + ":" + preOutboundNo + ":" + refDocNumber + ":" + pickupNumber
     ...
     */
    public QualityHeader updateQualityHeader(String companyCodeId, String plantId, String languageId, String warehouseId,
                                             String preOutboundNo, String refDocNumber, String qualityInspectionNo, String actualHeNo,
                                             String loginUserID, QualityHeader updateQualityHeader)
            throws IllegalAccessException, InvocationTargetException {
        QualityHeader dbQualityHeader = getQualityHeaderForUpdate(companyCodeId, plantId, languageId, warehouseId, preOutboundNo,
    ...
    public QualityHeader updateQualityHeader(String warehouseId, String companyCodeId, String plantId, String languageId, String preOutboundNo, String refDocNumber,
        ...
        QualityHeader dbQualityHeader = getQualityHeaderForUpdate(warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, partnerCode,
     ...
     * @return
     */
    public QualityHeader deleteQualityHeader(String warehouseId, String companyCodeId, String plantId, String languageId,
                                             String preOutboundNo, String refDocNumber, String qualityInspectionNo, String actualHeNo, String loginUserID) {
        QualityHeader qualityHeader = getQualityHeader(warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, qualityInspectionNo, actualHeNo);
        if (qualityHeader != null) {
    ...
    public List<QualityHeader> deleteQualityHeaderForReversal(String warehouseId, String companyCodeId, String plantId, String languageId, String preOutboundNo, String refDocNumber, String qualityInspectionNo, String actualHeNo, String loginUserID) {
        List<QualityHeader> qualityHeader = getQualityHeaderForReversal(warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, qualityInspectionNo, actualHeNo);
        if (qualityHeader != null && qualityHeader.size() != 0) {
     ...
     * @return
     */
    public QualityHeader deleteQualityHeader(String warehouseId, String companyCodeId, String languageId, String plantId,
        ...
        QualityHeader qualityHeader = getQualityHeaderForUpdate(warehouseId, companyCodeId, plantId,
                languageId, preOutboundNo, refDocNumber, partnerCode, pickupNumber, qualityInspectionNo, actualHeNo);
        if (qualityHeader != null) {
            qualityHeader.setDeletionIndicator(1L);
            qualityHeader.setQualityUpdatedBy(loginUserID);
            qualityHeader.setQualityUpdatedOn(new Date());
