...
//		log.info("results: " + results);
     ...
     * @throws InvocationTargetException
     */
    public GrHeader updateGrHeader(String companyCode, String languageId, String plantId,
                                   String warehouseId, String preInboundNo, String refDocNumber,
                                   String stagingNo, String goodsReceiptNo, String palletCode, String caseCode,
                                   String loginUserID, GrHeader updateGrHeader)
            throws IllegalAccessException, InvocationTargetException {
    ...
    public void updateGrHeader(String refDocNumber, String companyCode, String plantId,
        ...
        List<GrLine> grLineList = grLineService.getGrLine(refDocNumber,companyCode, packBarcodes, warehouseId, preInboundNo, caseCode);
    ...
    public void deleteGrHeader(String warehouseId, String companyCode, String plantId,
        ...
        GrHeader grHeader = getGrHeader(warehouseId, companyCode, plantId, languageId,
                preInboundNo, refDocNumber, stagingNo, goodsReceiptNo, palletCode, caseCode);
        if (grHeader != null) {
