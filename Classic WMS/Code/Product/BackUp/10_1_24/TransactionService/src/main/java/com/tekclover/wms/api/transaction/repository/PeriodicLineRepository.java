...
public interface PeriodicLineRepository extends JpaRepository<PeriodicLine,Long>,
	...
	public PeriodicLine findByWarehouseIdAndCompanyCodeAndPlantIdAndLanguageIdAndCycleCountNoAndStorageBinAndItemCodeAndPackBarcodesAndDeletionIndicator(
			String warehouseId,String companyCode,String plantId,String languageId, String cycleCountNo, String storageBin, String itemCode, String packBarcodes, long l);
