...
public interface InventoryRepository extends PagingAndSortingRepository<Inventory, Long>, JpaSpecificationExecutor<Inventory> {
	 ...
	 */
	List<Inventory> findByWarehouseIdAndItemCodeAndBinClassIdAndDeletionIndicator(String warehouseId, String itemCode,
																				  Long binClassId, Long deletionIndicator);

	// referenceField10
	List<Inventory> findByWarehouseIdAndCompanyCodeIdAndPlantIdAndLanguageIdAndItemCodeAndBinClassIdAndReferenceField10InAndDeletionIndicator(
			String warehouseId, String companyCodeId, String plantId, String languageId,
	...
	List<Inventory> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndBinClassIdAndStorageBinAndStockTypeIdAndCreatedOnAndDeletionIndicatorAndInventoryQuantityGreaterThan(
			String languageId, String companyCode, String plantId, String warehouseId, String itemCode, Long binClassId,
	...
	List<IInventory> findInventoryGroupByCreatedOn(
			@Param(value = "warehouseId") String warehouseId,
			@Param(value = "itemCode") String itemCode,
			@Param(value = "storageSecIds") List<String> storageSecIds);
