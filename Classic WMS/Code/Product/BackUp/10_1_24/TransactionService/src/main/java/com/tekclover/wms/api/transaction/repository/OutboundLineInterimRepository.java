...
public interface OutboundLineInterimRepository extends JpaRepository<OutboundLineInterim,Long>, JpaSpecificationExecutor<OutboundLineInterim> {
	...
	public List<OutboundLineInterim> findByWarehouseIdAndCompanyCodeIdAndLanguageIdAndPlantIdAndPreOutboundNoAndRefDocNumberAndPartnerCodeAndLineNumberAndItemCodeAndDeletionIndicator(
