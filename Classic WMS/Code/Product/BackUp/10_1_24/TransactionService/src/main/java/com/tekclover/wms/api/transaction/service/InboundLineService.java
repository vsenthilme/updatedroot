...
public class InboundLineService extends BaseService {
    ...
    public InboundLine getInboundLine(String warehouseId, String companyCode, String plantId, String languageId,
                                      String refDocNumber, String preInboundNo, Long lineNo, String itemCode) {
     ...
     * @return
     */
    public List<InboundLine> getInboundLine(String companyCode, String plantId, String languageId,
     ...
     * @return
     */
    public List<InboundLine> getInboundLinebyRefDocNoISNULL(String languageId, String companyCode, String plantId, String warehouseId, String refDocNumber, String preInboundNo) {
        List<InboundLine> inboundLine =
    ...
    public InboundLine confirmInboundLine(List<AddInboundLine> newInboundLines, String loginUserID) throws IllegalAccessException, InvocationTargetException {
        for (AddInboundLine addInboundLine : newInboundLines) {
            ...
            InboundLine inboundLine =
                    getInboundLine(addInboundLine.getWarehouseId(), addInboundLine.getCompanyCodeId(),
                            addInboundLine.getPlantId(), addInboundLine.getLanguageId(), addInboundLine.getRefDocNumber(),
            ...
            if (inboundLine.getStatusId() == 20L) {
                ...
                putAwayHeaderService.updatePutAwayHeader(inboundLine.getWarehouseId(), inboundLine.getCompanyCode(),
                        inboundLine.getPlantId(), inboundLine.getLanguageId(), inboundLine.getPreInboundNo(),
     ...
     * @throws InvocationTargetException
     */
    public InboundLine updateInboundLine(String warehouseId, String companyCode, String plantId, String languageId,
                                         String refDocNumber, String preInboundNo, Long lineNo, String itemCode,
                                         String loginUserID, InboundLine updateInboundLine)
            throws IllegalAccessException, InvocationTargetException {
        InboundLine dbInboundLine = getInboundLine(warehouseId, companyCode, plantId, languageId, refDocNumber, preInboundNo, lineNo, itemCode);
     ...
     * @param loginUserID
     */
    public void deleteInboundLine(String warehouseId, String companyCode, String plantId, String languageId,
                                  String refDocNumber, String preInboundNo, Long lineNo, String itemCode, String loginUserID) {
        InboundLine inboundLine = getInboundLine(warehouseId, companyCode, plantId,
                languageId, refDocNumber, preInboundNo, lineNo, itemCode);
        if (inboundLine != null) {
