...
public class InventoryController {
    ...
    public ResponseEntity<?> getInventory(@RequestParam String warehouseId, @RequestParam String packBarcodes,
        ...
        Inventory inventory =
                inventoryService.getInventory(warehouseId,companyCodeId,plantId,languageId, packBarcodes, itemCode, storageBin);
    ...
    public ResponseEntity<?> patchInventory(@PathVariable Long stockTypeId, @RequestParam String warehouseId,
                                            ...
                                            @RequestParam String storageBin, @RequestParam String companyCodeId,
                                            @RequestParam String plantId, @RequestParam String languageId,
                                            @RequestParam Long specialStockIndicatorId, @Valid @RequestBody Inventory updateInventory,
                                            @RequestParam String loginUserID) throws IllegalAccessException, InvocationTargetException {
        Inventory createdInventory =
                inventoryService.updateInventory(warehouseId,companyCodeId,plantId,languageId, packBarcodes,
                        itemCode, storageBin, stockTypeId, specialStockIndicatorId, updateInventory, loginUserID);
        return new ResponseEntity<>(createdInventory, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> deleteInventory(@PathVariable Long stockTypeId, @RequestParam String warehouseId,
        ...
        inventoryService.deleteInventory(warehouseId, companyCode, plantId, languageId, packBarcodes, itemCode, storageBin, stockTypeId, specialStockIndicatorId);
