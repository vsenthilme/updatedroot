...
public interface PreOutboundHeaderRepository extends JpaRepository<PreOutboundHeader, Long>, JpaSpecificationExecutor<PreOutboundHeader>,
    ...
    @Query("UPDATE PreOutboundHeader ib SET ib.statusId = :statusId, REF_FIELD_10 = :refField10 WHERE ib.warehouseId = :warehouseId \r\n" +
            "AND ib.companyCodeId =:companyCodeId AND ib.plantId =:plantId AND ib.languageId =:languageId AND ib.refDocNumber = :refDocNumber")
    void updatePreOutboundHeaderStatus(@Param("warehouseId") String warehouseId,
                                       ...
                                       @Param("refField10") String refField10);
