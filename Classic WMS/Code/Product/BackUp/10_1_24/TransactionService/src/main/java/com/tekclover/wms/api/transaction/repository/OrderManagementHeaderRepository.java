...
public interface OrderManagementHeaderRepository extends JpaRepository<OrderManagementHeader,Long>, JpaSpecificationExecutor<OrderManagementHeader> {
    ...
    OrderManagementHeader findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndPreOutboundNoAndRefDocNumberAndPartnerCodeAndDeletionIndicator(
			String companyCodeId, String plantId, String languageId, String warehouseId, String preOutboundNo, String refDocNumber, String partnerCode, Long deletionIndicator);
}