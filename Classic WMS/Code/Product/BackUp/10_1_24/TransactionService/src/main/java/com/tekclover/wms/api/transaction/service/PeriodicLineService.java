...
public class PeriodicLineService extends BaseService {
     ...
     * @return
     */
    public PeriodicLine getPeriodicLine(String warehouseId, String companyCodeId, String plantId, String languageId, String cycleCountNo, String storageBin, String itemCode,
                                        String packBarcodes) {
        PeriodicLine periodicLine =
                periodicLineRepository.findByWarehouseIdAndCompanyCodeAndPlantIdAndLanguageIdAndCycleCountNoAndStorageBinAndItemCodeAndPackBarcodesAndDeletionIndicator(
                        warehouseId, companyCodeId, plantId, languageId, cycleCountNo, storageBin, itemCode, packBarcodes, 0L);
    ...
    public List<PeriodicLine> updateAssingHHTUser(List<AssignHHTUserCC> assignHHTUsers, String loginUserID) {
        try {
            ...
            for (AssignHHTUserCC assignHHTUser : assignHHTUsers) {
                PeriodicLine periodicLine = getPeriodicLine(assignHHTUser.getWarehouseId(),
                        assignHHTUser.getCompanyCode(), assignHHTUser.getPlantId(), assignHHTUser.getLanguageId(), assignHHTUser.getCycleCountNo(),
    ...
    public List<PeriodicLine> updatePeriodicLineForMobileCount(List<UpdatePeriodicLine> updatePeriodicLines,
        ...
        for (UpdatePeriodicLine updatePeriodicLine : updatePeriodicLines) {
            PeriodicLine dbPeriodicLine = getPeriodicLine(updatePeriodicLine.getWarehouseId(), updatePeriodicLine.getCompanyCodeId(),
                    updatePeriodicLine.getPlantId(), updatePeriodicLine.getLanguageId(), updatePeriodicLine.getCycleCountNo(),
        ...
        try {
            ...
            for (UpdatePeriodicLine updatePeriodicLine : updatePeriodicLines) {
                PeriodicLine dbPeriodicLine = getPeriodicLine(updatePeriodicLine.getWarehouseId(),
                        updatePeriodicLine.getCompanyCodeId(),
...
//					createInventoryMovement (updatedPeriodicLine) ;
            ...
            PeriodicHeader updatedPeriodicHeader = periodicHeaderService.updatePeriodicHeaderFromPeriodicLine(dbPeriodicHeader.getWarehouseId(), dbPeriodicHeader.getCompanyCode(),
                    dbPeriodicHeader.getPlantId(), dbPeriodicHeader.getLanguageId(),
    ...
    private Inventory updateInventory(PeriodicLine updatePeriodicLine) {
        Inventory inventory = inventoryService.getInventory(updatePeriodicLine.getWarehouseId(),
                updatePeriodicLine.getCompanyCode(), updatePeriodicLine.getPlantId(), updatePeriodicLine.getLanguageId(),
    ...
    private InventoryMovement createInventoryMovement(PeriodicLine updatedPeriodicLine) {
        ...
        AuthToken authTokenForMastersService = authTokenService.getMastersServiceAuthToken();
        ImBasicData1 imBasicData1 = mastersService.getImBasicData1ByItemCode(inventoryMovement.getCompanyCodeId(),
                inventoryMovement.getPlantId(), inventoryMovement.getLanguageId(), inventoryMovement.getWarehouseId(),
                inventoryMovement.getItemCode(), inventoryMovement.getInventoryUom(),
     ...
     * @param storageBin
     */
    public void deletePeriodicLine(String warehouseId, String companyCodeId, String plantId, String languageId,
                                   String cycleCountNo, String storageBin, String itemCode, String packBarcodes, String loginUserID) {
        PeriodicLine periodicLine = getPeriodicLine(warehouseId, companyCodeId, plantId, languageId, cycleCountNo,
