    ...
    public Warehouse getWarehouse(String warehouseId, String authToken) {
        try {
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getIDMasterServiceApiUrl() + "warehouseid/warehouse/" + warehouseId);
...
//			e.printStackTrace();
    ...
    //-------------------------------------------------------------------------------------------------------------------
    // GET - /usermanagement/?
    public UserManagement getUserManagement(String companyCode, String plantId, String languageId,
                                            String warehouseId, String userId, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            ...
            headers.add("Authorization", "Bearer " + authToken);
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getIDMasterServiceApiUrl() + "usermanagement/user/" + userId)
    ...
    public String getNextNumberRange(Long numberRangeCode, int fiscalYear, String warehouseId, String companyCodeId,
    ...
    public void createAuditLogRecord(String warehouseId, String tableName, Integer screenNo, Integer subScreenNo,
        ...
        // C_ID
        auditLog.setCompanyCode(warehouse.getCompanyCodeId());
        ...
        String newAuditLogNumber = getNextNumberRange(NUM_RAN_CODE, fiscalYear, warehouseId, auditLog.getCompanyCode(), auditLog.getPlantID(), warehouse.getLanguageId(), authTokenForIdmasterService.getAccess_token());
     ...
     * @param access_token
     */
    public StatusId getStatus(Long statusId, String languageId, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
