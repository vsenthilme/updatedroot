...
//	}
     ...
     * @return
     */
    public List<StockReport> getAllStockReport(List<String> languageId, List<String> companyCodeId, List<String> plantId, List<String> warehouseId,
                                               List<String> itemCode, String itemText, String stockTypeText) {
        if (languageId == null) {
            throw new BadRequestException("LanguageId can't be blank");
        }

        if (companyCodeId == null) {
            throw new BadRequestException("CompanyCodeId can't be null");
        }

        if (plantId == null) {
            throw new BadRequestException("PlantId can't be null");
        }
        ...
        List<StockReport> stockReportList = new ArrayList<>();
        List<StockReportImpl> reportList = inventoryRepository.getAllStockReport(languageId, companyCodeId, plantId, warehouseId, itemCode, itemText, stockTypeText);
    ...
    public Page<InventoryReport> getInventoryReport(List<String> warehouseId, List<String> itemCode, String storageBin,
        ...
        try {
            ...
            for (Inventory dbInventory : inventoryList) {
                 ...
                 * values
                 */
                ImBasicData1 imBasicData1 = mastersService.getImBasicData1ByItemCode(dbInventory.getCompanyCodeId(), dbInventory.getPlantId(),
                        dbInventory.getLanguageId(), dbInventory.getWarehouseId(), dbInventory.getItemCode(), dbInventory.getInventoryUom(), authTokenForMastersService.getAccess_token());
                 ...
                 * ST_SEC_ID values
                 */
                StorageBin stBin = mastersService.getStorageBin(dbInventory.getStorageBin(), warehouseId.get(0), dbInventory.getCompanyCodeId(),
                        dbInventory.getPlantId(), dbInventory.getLanguageId(),
                        authTokenForMastersService.getAccess_token());
