...
//			return obList.toArray(new ImBasicData1[obList.size()]);
	...
	// Delete ImBasicData1
	public boolean deleteImBasicData1 (String itemCode, String warehouseId,String companyCodeId,String plantId,String uomId,String languageId,
 ...
 // Get ALL
	...
	// Delete ImStrategies
	public boolean deleteImStrategies (Long strategyTypeId,String companyCodeId,String plantId,String warehouseId,String itemCode,Long sequenceIndicator,String languageId,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
...
//			return obList.toArray(new StorageBin[obList.size()]);
	...
	// Delete ImVariant
	public boolean deleteImVariant (String companyCodeId,String plantId,String languageId,String warehouseId,String itemCode,
									String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	// GET ImPalletization
	public ImPalletization[] getImPalletization(String companyCodeId,String plantId,String languageId,String warehouseId,String itemCode, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public NumberRangeStorageBin updateNumberRangeStorageBin (String companyCodeId,String plantId,String languageId,
															  ...
															  String aisleNumber,UpdateNumberRangeStorageBin updateNumberRangeStorageBin, String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public boolean deleteNumberRangeStorageBin (String companyCodeId,String plantId,String languageId,String warehouseId,
												Long floorId,String storageSectionId,String rowId,String aisleNumber,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
...
//THREEPL
	...
	// GET Driver
	public Driver getDriver(String companyCodeId,String plantId,String languageId,String warehouseId,Long driverId, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// GET Route
	public Route getRoute(String companyCodeId,String plantId,String languageId,String warehouseId,
						  Long routeId, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
