...
public class EnterpriseServiceController {
	...
	public ResponseEntity<?> updateBarcode(@PathVariable Long barcodeTypeId, @RequestParam String warehouseId,
		...
		Barcode modifiedBarcode = enterpriseSetupService.updateBarcode(warehouseId, method, barcodeTypeId,
				barcodeSubTypeId,companyId,plantId,languageId,levelId, levelReference, processId,
				updatedBarcode, loginUserID, authToken);
	...
	public ResponseEntity<?> deleteBarcode(@PathVariable Long barcodeTypeId, @RequestParam String warehouseId,
										   @RequestParam String method, @RequestParam Long barcodeSubTypeId,
										   @RequestParam Long levelId, @RequestParam String levelReference,
										   @RequestParam Long processId,@RequestParam String companyId,@RequestParam String plantId,
										   @RequestParam String languageId, @RequestParam String loginUserID,
										   @RequestParam String authToken) {

		enterpriseSetupService.deleteBarcode(warehouseId, method, barcodeTypeId, barcodeSubTypeId,companyId,languageId,
				plantId,levelId, levelReference, processId, loginUserID, authToken);
	...
	public ResponseEntity<?> updateCompany(@PathVariable String companyId, @RequestParam String languageId,
										   @RequestParam String loginUserID, @RequestBody Company updatedCompany,
										   @RequestParam String authToken) {
	...
	public ResponseEntity<?> deleteCompany(@RequestParam String authToken,@RequestParam String languageId,
	...
	public ResponseEntity<?> getBatchSerial(@PathVariable String storageMethod,@RequestParam String companyId,
		...
		BatchSerial batchserial =
				enterpriseSetupService.getBatchSerial(storageMethod,companyId,languageId,
				plantId,warehouseId,levelId,authToken);
		log.info("BatchSerial : " + batchserial);
		return new ResponseEntity<>(batchserial, HttpStatus.OK);
	}
...
//	}
	...
	public ResponseEntity<?> updateBatchSerial(@PathVariable String storageMethod,@RequestParam String companyId,
											   ...
											   @Valid @RequestBody UpdateBatchSerial updatedBatchSerial,
											   @RequestParam String loginUserID, @RequestParam String authToken) {

		BatchSerial modifiedBatchSerial =
						enterpriseSetupService.updateBatchSerial(storageMethod,companyId,languageId,plantId,
						warehouseId,levelId, updatedBatchSerial, loginUserID, authToken);
...
//	}
	...
	public ResponseEntity<?> deleteBatchSerial(@RequestParam String storageMethod,@RequestParam String companyId,
	...
	public ResponseEntity<?> getFloor(@PathVariable Long floorId,@RequestParam String companyId,
									  @RequestParam String plantId,@RequestParam String languageId,
	...
	public ResponseEntity<?> updateFloor(@PathVariable Long floorId, @RequestParam String companyId,
										 @RequestParam String plantId,@RequestParam String languageId,
										 @RequestBody Floor updatedFloor, @RequestParam String loginUserID,
										 @RequestParam String warehouseId, @RequestParam String authToken) {

		Floor modifiedFloor =
				enterpriseSetupService.updateFloor(floorId, warehouseId,companyId,plantId,
				languageId,updatedFloor, loginUserID, authToken);
	...
	public ResponseEntity<?> deleteFloor(@PathVariable Long floorId,@RequestParam String companyId,
										 @RequestParam String plantId,@RequestParam String languageId,
...
//	}
	...
	public ResponseEntity<?> getItemGroup(@PathVariable Long itemGroupId, @RequestParam String warehouseId,
	   	...
	   	ItemGroup itemgroup =
				enterpriseSetupService.getItemGroup(companyId,languageId,plantId,warehouseId,
				itemTypeId, itemGroupId, subItemGroupId, authToken);
	   	log.info("ItemGroup : " + itemgroup);
		return new ResponseEntity<>(itemgroup, HttpStatus.OK);
	}
	...
	public ResponseEntity<?> updateItemGroup(@PathVariable Long itemGroupId, @RequestParam String warehouseId,
											 @RequestParam Long itemTypeId, @RequestParam Long subItemGroupId,
											 @RequestParam String companyId,@RequestParam String languageId,@RequestParam String plantId,
											 @Valid @RequestBody ItemGroup updateItemGroup, @RequestParam String loginUserID,
											 @RequestParam String authToken) {
	...
	public ResponseEntity<?> deleteItemGroup(@PathVariable Long itemGroupId, @RequestParam String warehouseId,
											 ...
											 @RequestParam String plantId, @RequestParam Long itemTypeId,
											 @RequestParam Long subItemGroupId, @RequestParam String loginUserID,
											 @RequestParam String authToken) {

		enterpriseSetupService.deleteItemGroup(warehouseId, itemTypeId,companyId,
				languageId,plantId, itemGroupId, subItemGroupId, loginUserID, authToken);
		return new ResponseEntity<>(HttpStatus.NO_CONTENT);
	}
	...
	public ResponseEntity<?> getItemType(@PathVariable Long itemTypeId, @RequestParam String warehouseId,
										 @RequestParam String companyId,@RequestParam String plantId,
										 @RequestParam String languageId,@RequestParam String authToken) {

	   	ItemType itemtype =
						enterpriseSetupService.getItemType(warehouseId, itemTypeId,companyId,
						plantId,languageId, authToken);
	   	log.info("ItemType : " + itemtype);
		return new ResponseEntity<>(itemtype, HttpStatus.OK);
	}
	...
	public ResponseEntity<?> createItemType(@RequestBody ItemType newItemType, @RequestParam String loginUserID,
		...
		ItemType createdItemType
				= enterpriseSetupService.addItemType(newItemType, loginUserID, authToken);
	...
	public ResponseEntity<?> updateItemType(@PathVariable Long itemTypeId, @RequestParam String warehouseId,
											@RequestParam String companyId,@RequestParam String plantId,
											@RequestParam String languageId, @RequestBody ItemType updatedItemType,
											@RequestParam String loginUserID, @RequestParam String authToken) {
		ItemType modifiedItemType = 
						enterpriseSetupService.updateItemType( warehouseId, itemTypeId,companyId,plantId,
						languageId,updatedItemType, loginUserID, authToken);
	...
	public ResponseEntity<?> deleteItemType(@PathVariable Long itemTypeId,@RequestParam String companyId,
											@RequestParam String plantId,@RequestParam String languageId,
											@RequestParam String warehouseId, @RequestParam String loginUserID,
											@RequestParam String authToken) {
   ...
   @RequestMapping(value = "/plant/{plantId}", method = RequestMethod.PATCH)
	public ResponseEntity<?> updatePlant(@PathVariable String plantId, @RequestParam String companyId,
										 @RequestParam String languageId, @RequestBody Plant updatedPlant,
										 @RequestParam String loginUserID, @RequestParam String authToken) {

		Plant modifiedPlant = enterpriseSetupService.updatePlant(plantId, updatedPlant,
				companyId,languageId,loginUserID, authToken);
	...
	public ResponseEntity<?> getStorageBinType(@PathVariable Long storageBinTypeId, @RequestParam String warehouseId,
											   @RequestParam Long storageClassId, @RequestParam Long storageTypeId,
											   @RequestParam String companyId,@RequestParam String languageId,
											   @RequestParam String plantId, @RequestParam String authToken) {
	   	StorageBinType storagebintype = 
	   			enterpriseSetupService.getStorageBinType(warehouseId, storageTypeId,storageClassId,
						storageBinTypeId,companyId,languageId,plantId,authToken);
	   	log.info("StorageBinType : " + storagebintype);
		return new ResponseEntity<>(storagebintype, HttpStatus.OK);
	}
	...
	public ResponseEntity<?> createStorageBinType(@RequestBody StorageBinType newStorageBinType,
		...
		StorageBinType createdStorageBinType =
				enterpriseSetupService.addStorageBinType(newStorageBinType, loginUserID, authToken);
	...
	public ResponseEntity<?> updateStorageBinType(@PathVariable Long storageBinTypeId,@RequestParam String companyId,
												  @RequestParam Long storageClassId,@RequestParam String languageId,
												  @RequestParam String plantId, @RequestParam String warehouseId,
												  @RequestParam Long storageTypeId, @RequestBody StorageBinType updatedStorageBinType,
												  @RequestParam String loginUserID, @RequestParam String authToken) {
		StorageBinType modifiedStorageBinType = 
				enterpriseSetupService.updateStorageBinType(warehouseId, storageTypeId,storageClassId,
						storageBinTypeId,companyId,languageId,plantId, updatedStorageBinType, loginUserID, authToken);
	...
	public ResponseEntity<?> deleteStorageBinType(@PathVariable Long storageBinTypeId, @RequestParam String warehouseId,
												  ...
												  @RequestParam String companyId,@RequestParam Long storageClassId,
												  @RequestParam String languageId,@RequestParam String plantId, @RequestParam String authToken) {

		enterpriseSetupService.deleteStorageBinType(warehouseId, storageTypeId,storageClassId,
				storageBinTypeId,companyId,languageId,plantId,loginUserID, authToken);
		return new ResponseEntity<>(HttpStatus.NO_CONTENT);
	}
	...
	public ResponseEntity<?> getStorageClass(@PathVariable Long storageClassId, @RequestParam String warehouseId,
	   	...
	   	StorageClass storageclass =
				enterpriseSetupService.getStorageClass(warehouseId, storageClassId,companyId,plantId,languageId, authToken);
	   	log.info("StorageClass : " + storageclass);
		return new ResponseEntity<>(storageclass, HttpStatus.OK);
	}
	...
	public ResponseEntity<?> updateStorageClass(@PathVariable Long storageClassId, @RequestParam String warehouseId,
		...
		StorageClass modifiedStorageClass = 
				enterpriseSetupService.updateStorageClass(warehouseId, storageClassId,companyId,
						languageId,plantId, updatedStorageClass, loginUserID, authToken);
	...
	public ResponseEntity<?> getStorageSection(@PathVariable String storageSectionId,@RequestParam String companyId,
											   @RequestParam String plantId,@RequestParam String languageId,
											   @RequestParam String warehouseId, @RequestParam Long floorId,
											   @RequestParam String authToken) {

		StorageSection storagesection =
						enterpriseSetupService.getStorageSection(warehouseId, floorId,storageSectionId,
						companyId,languageId,plantId,authToken);
	   	log.info("StorageSection : " + storagesection);
		return new ResponseEntity<>(storagesection, HttpStatus.OK);
	}
	...
	public ResponseEntity<?> updateStorageSection(@PathVariable String storageSectionId, @RequestParam String warehouseId,
												  @RequestParam Long floorId, @RequestBody StorageSection updatedStorageSection,
												  @RequestParam String loginUserID,@RequestParam String companyId,
												  @RequestParam String languageId,@RequestParam String plantId,@RequestParam String authToken) {
		StorageSection modifiedStorageSection = 
				enterpriseSetupService.updateStorageSection(warehouseId, floorId, storageSectionId,
						companyId,languageId,plantId,updatedStorageSection, loginUserID, authToken);
	...
	public ResponseEntity<?> deleteStorageSection(@PathVariable String storageSectionId, @RequestParam String warehouseId,
												  @RequestParam Long floorId,@RequestParam String companyId,
												  @RequestParam String languageId,@RequestParam String plantId,
												  @RequestParam String loginUserID, @RequestParam String authToken) {

		enterpriseSetupService.deleteStorageSection(warehouseId, floorId, storageSectionId,
				companyId,plantId,languageId,loginUserID, authToken);
		return new ResponseEntity<>(HttpStatus.NO_CONTENT);
	}
	...
	public ResponseEntity<?> getStorageType(@PathVariable Long storageTypeId, @RequestParam String warehouseId,
											@RequestParam String companyId,@RequestParam String languageId,
											@RequestParam String plantId, @RequestParam Long storageClassId,
											@RequestParam String authToken) {

	   	StorageType storagetype =
				enterpriseSetupService.getStorageType(warehouseId, storageClassId, storageTypeId,
				companyId,languageId,plantId,authToken);
	   	log.info("StorageType : " + storagetype);
		return new ResponseEntity<>(storagetype, HttpStatus.OK);
	}
	...
	public StorageType[] findStorageType(@RequestBody SearchStorageType searchStorageType,
										 @RequestParam String authToken)
			throws Exception {
	...
	public ResponseEntity<?> createStorageType(@RequestBody StorageType newStorageType, @RequestParam String loginUserID,
											   @RequestParam String authToken) {
		StorageType createdStorageType =
				enterpriseSetupService.addStorageType(newStorageType, loginUserID, authToken);
	...
	public ResponseEntity<?> updateStorageType(@PathVariable Long storageTypeId, @RequestParam String warehouseId,
											   @RequestParam Long storageClassId, @RequestParam String companyId,
											   @RequestParam String plantId,@RequestParam String languageId,
		...
		StorageType modifiedStorageType = 
						enterpriseSetupService.updateStorageType(warehouseId, storageClassId, storageTypeId,
						updatedStorageType,companyId,languageId,plantId,loginUserID, authToken);
	...
	public ResponseEntity<?> deleteStorageType(@PathVariable Long storageTypeId, @RequestParam String warehouseId,
											   @RequestParam String companyId,@RequestParam String plantId,
											   @RequestParam String languageId, @RequestParam Long storageClassId,
											   @RequestParam String loginUserID, @RequestParam String authToken) {

		enterpriseSetupService.deleteStorageType(warehouseId, storageClassId, storageTypeId,
				companyId,languageId,plantId,loginUserID, authToken);
		return new ResponseEntity<>(HttpStatus.NO_CONTENT);
	}
	...
	public ResponseEntity<?> getStrategies(@PathVariable Long strategyTypeId, @RequestParam String warehouseId,
										   ...
										   @RequestParam String companyId,@RequestParam String languageId,
										   @RequestParam String plantId, @RequestParam Long priority,
										   @RequestParam String authToken) {

	   	Strategies[] strategies = enterpriseSetupService.getStrategies(companyId,languageId,plantId,
				warehouseId, strategyTypeId, sequenceIndicator, strategyNo, priority, authToken);
	   	log.info("Strategies : " + strategies);
		return new ResponseEntity<>(strategies, HttpStatus.OK);
	}
	...
	public Strategies[] findStrategies(@RequestBody SearchStrategies searchStrategies,
									   @RequestParam String authToken)
			throws Exception {
	...
	public ResponseEntity<?> createStrategies(@RequestBody Strategies[] newStrategies,
											  @RequestParam String loginUserID, @RequestParam String authToken) {

		Strategies[] createdStrategies =
				enterpriseSetupService.addStrategies(newStrategies, loginUserID, authToken);
	...
	public ResponseEntity<?> updateStrategies(@PathVariable Long strategyTypeId, @RequestParam String warehouseId,
											  @RequestParam Long sequenceIndicator, @RequestParam String strategyNo,
											  @RequestParam Long priority,@RequestParam String companyId,
											  @RequestParam String languageId,@RequestParam String plantId,
											  @RequestBody Strategies[] updatedStrategies, @RequestParam String loginUserID,
											  @RequestParam String authToken) {
		Strategies[] modifiedStrategies =
				enterpriseSetupService.updateStrategies(companyId,languageId,plantId,warehouseId, strategyTypeId,
						sequenceIndicator, strategyNo, priority, updatedStrategies, loginUserID, authToken);
	...
	public ResponseEntity<?> deleteStrategies(@PathVariable Long strategyTypeId, @RequestParam String warehouseId,
		...
		enterpriseSetupService.deleteStrategies(companyId,languageId,plantId,warehouseId,
				strategyTypeId, sequenceIndicator, strategyNo, priority, loginUserID, authToken);
		return new ResponseEntity<>(HttpStatus.NO_CONTENT);
	}
	...
	public ResponseEntity<?> updateVariant(@PathVariable String variantId,@RequestParam String companyId,
										   ...
										   @RequestParam Long levelId, @RequestBody UpdateVariant updatedVariant,
										   @RequestParam String loginUserID, @RequestParam String authToken) {

		Variant modifiedVariant =
				enterpriseSetupService.updateVariant(variantId, updatedVariant,companyId,plantId,
				warehouseId,languageId,levelId,loginUserID, authToken);
	...
	public ResponseEntity<?> deleteVariant(@RequestParam String authToken,@RequestParam String companyId,
										   ...
										   @RequestParam Long levelId,@RequestParam String variantId, @RequestParam String loginUserID) {

		enterpriseSetupService.deleteVariant(variantId,companyId,plantId,warehouseId,
				languageId,levelId,loginUserID,authToken);
		return new ResponseEntity<>(HttpStatus.NO_CONTENT);
	}
	...
	public ResponseEntity<?> getWarehouse(@PathVariable String warehouseId, @RequestParam String modeOfImplementation,
										  @RequestParam String companyId,@RequestParam String plantId,
										  @RequestParam String languageId, @RequestParam Long warehouseTypeId, @RequestParam String authToken) {

		Warehouse warehouse =
				enterpriseSetupService.getWarehouse(warehouseId, modeOfImplementation,
				warehouseTypeId,companyId,plantId,languageId,authToken);
		log.info("Warehouse : " + warehouse);
		return new ResponseEntity<>(warehouse, HttpStatus.OK);
	}
	...
	public ResponseEntity<?> updateWarehouse(@PathVariable String warehouseId,@RequestParam String modeOfImplementation,
		...
		Warehouse modifiedWarehouse =
				enterpriseSetupService.updateWarehouse(warehouseId,modeOfImplementation,warehouseTypeId,
						companyId,plantId,languageId, updatedWarehouse, loginUserID, authToken);
	...
	public ResponseEntity<?> deleteWarehouse(@PathVariable String warehouseId,@RequestParam String modeOfImplementation,
		...
		enterpriseSetupService.deleteWarehouse(warehouseId,modeOfImplementation,warehouseTypeId,companyId,
				plantId,languageId,loginUserID,authToken);
		return new ResponseEntity<>(HttpStatus.NO_CONTENT);
	}
}