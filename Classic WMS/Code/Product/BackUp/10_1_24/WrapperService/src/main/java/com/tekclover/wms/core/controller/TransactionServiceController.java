...
public class TransactionServiceController {
    ...
    public ResponseEntity<?> getContainerReceipt(@PathVariable String containerReceiptNo, @RequestParam String preInboundNo,
                                                 ...
                                                 @RequestParam String warehouseId, @RequestParam String authToken) throws Exception {
        ContainerReceipt containerreceipt =
                transactionService.getContainerReceipt(preInboundNo, languageId, companyCodeId, plantId,
                        refDocNumber, containerReceiptNo, warehouseId, authToken);
    ...
    public ResponseEntity<?> patchContainerReceipt(@PathVariable String containerReceiptNo, @RequestParam String preInboundNo,
                                                   @RequestParam String languageId, @RequestParam String refDocNumber, @RequestParam String companyCodeId,
        ...
        ContainerReceipt updatedContainerReceipt =
                transactionService.updateContainerReceipt(preInboundNo, containerReceiptNo, companyCodeId, languageId,
                        plantId, warehouseId, refDocNumber, loginUserID, updateContainerReceipt, authToken);
    ...
    public ResponseEntity<?> deleteContainerReceipt(@PathVariable String containerReceiptNo, @RequestParam String companyCodeId, @RequestParam String languageId,
                                                    @RequestParam String warehouseId, @RequestParam String preInboundNo, @RequestParam String refDocNumber,
                                                    @RequestParam String loginUserID, @RequestParam String plantId, @RequestParam String authToken) {
        transactionService.deleteContainerReceipt(preInboundNo, refDocNumber, containerReceiptNo, companyCodeId, languageId,
                plantId, warehouseId, loginUserID, authToken);
    ...
    public ResponseEntity<?> getPreInboundHeader(@PathVariable String preInboundNo, @RequestParam String warehouseId,
                                                 ...
                                                 @RequestParam String authToken) throws Exception {
        PreInboundHeader preinboundheader = transactionService.getPreInboundHeader(preInboundNo, warehouseId, companyCode, plantId, languageId, authToken);
    ...
    public ResponseEntity<?> patchPreInboundHeader(@PathVariable String preInboundNo, @RequestParam String warehouseId, @RequestParam String companyCode,
        ...
        PreInboundHeader createdPreInboundHeader =
                transactionService.updatePreInboundHeader(preInboundNo, companyCode, plantId, languageId,
                        warehouseId, loginUserID, updatePreInboundHeader, authToken);
        return new ResponseEntity<>(createdPreInboundHeader, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> deletePreInboundHeader(@PathVariable String preInboundNo, @RequestParam String warehouseId,
        ...
        transactionService.deletePreInboundHeader(preInboundNo, warehouseId, companyCode, plantId, languageId, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
    ...
    public ResponseEntity<?> postPreInboundLineBOM(@RequestParam String preInboundNo, @RequestParam String companyCode,
                                                   @RequestParam String plantId, @RequestParam String languageId,
        ...
        PreInboundLine[] createdPreInboundLine =
                transactionService.createPreInboundLineBOM(preInboundNo, warehouseId, companyCode, plantId, languageId, refDocNumber, itemCode,
    ...
    @ApiOperation(response = PreInboundLine.class, value = "Patch PreInboundLine ") // label for swagger
    ...
    public ResponseEntity<?> patchPreInboundLineV2(@PathVariable String preInboundNo, @RequestParam String warehouseId, @RequestParam String companyCode,
                                                   ...
                                                   @Valid @RequestBody PreInboundLine updatePreInboundLine, @RequestParam String loginUserID,
                                                   @RequestParam String authToken) throws java.text.ParseException {
        PreInboundLine preinboundline = transactionService.updatePreInboundLine(
    ...
    public ResponseEntity<?> getInboundHeader(@PathVariable String refDocNumber, @RequestParam String companyCode,
                                              @RequestParam String plantId, @RequestParam String languageId,
                                              @RequestParam String warehouseId, @RequestParam String preInboundNo,
                                              @RequestParam String authToken) throws Exception {
        InboundHeader dbInboundHeader =
                transactionService.getInboundHeader(warehouseId, companyCode, plantId, languageId, refDocNumber, preInboundNo, authToken);
    ...
    public ResponseEntity<?> patchInboundHeader(@PathVariable String refDocNumber, @RequestParam String warehouseId,
                                                ...
                                                @RequestParam String languageId, @RequestParam String preInboundNo,
                                                @RequestParam String loginUserID, @RequestParam String authToken,
                                                @Valid @RequestBody InboundHeader updateInboundHeader)
            throws IllegalAccessException, InvocationTargetException {

        InboundHeader updatedInboundHeader =
                transactionService.updateInboundHeader(warehouseId, companyCode, plantId, languageId,
                        refDocNumber, preInboundNo, loginUserID, updateInboundHeader, authToken);
    ...
    public ResponseEntity<?> patchInboundHeaderConfirm(@RequestParam String warehouseId, @RequestParam String companyCode,
                                                       @RequestParam String plantId, @RequestParam String languageId,
                                                       @RequestParam String preInboundNo, @RequestParam String refDocNumber,
                                                       @RequestParam String loginUserID, @RequestParam String authToken)
            throws IllegalAccessException, InvocationTargetException {
        AXApiResponse createdInboundHeaderResponse =
                transactionService.updateInboundHeaderConfirm(warehouseId, companyCode, plantId, languageId,
                        preInboundNo, refDocNumber, loginUserID, authToken);
    ...
    public ResponseEntity<?> getInboundLine(@PathVariable Long lineNo, @RequestParam String languageId,
                                            @RequestParam String companyCode, @RequestParam String plantId,
        ...
        InboundLine dbInboundLine =
                transactionService.getInboundLine(warehouseId, companyCode, plantId,
                        languageId, refDocNumber, preInboundNo, lineNo, itemCode, authToken);
    ...
    public ResponseEntity<?> patchInboundLine(@RequestParam Long lineNo, @RequestParam String warehouseId,
                                              @RequestParam String refDocNumber, @RequestParam String companyCode,
                                              @RequestParam String plantId, @RequestParam String languageId,
                                              @RequestParam String preInboundNo, @RequestParam String itemCode,
                                              @RequestParam String loginUserID, @RequestParam String authToken,
                                              @Valid @RequestBody InboundLine updateInboundLine)
            throws IllegalAccessException, InvocationTargetException {
        InboundLine updatedInboundLine =
                transactionService.updateInboundLine(warehouseId, companyCode, plantId, languageId,
                        refDocNumber, preInboundNo, lineNo, itemCode, loginUserID, updateInboundLine, authToken);
    ...
    public ResponseEntity<?> deleteInboundLine(@PathVariable Long lineNo, @RequestParam String warehouseId,
        ...
        transactionService.deleteInboundLine(warehouseId, companyCode, plantId, languageId,
                refDocNumber, preInboundNo, lineNo, itemCode, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
    ...
    public ResponseEntity<?> getStagingHeader(@PathVariable String stagingNo, @RequestParam String languageId,
        ...
        StagingHeader stagingheader = transactionService.getStagingHeader(warehouseId, preInboundNo, refDocNumber,
                companyCode, plantId, languageId, stagingNo, authToken);
    ...
    public ResponseEntity<?> getStagingHeader(@PathVariable Long numberOfCases, @RequestParam String warehouseId,
                                              @RequestParam String companyCode, @RequestParam String plantId, @RequestParam String languageId,
                                              @RequestParam String authToken) {
        String[] stagingheader = transactionService.generateNumberRanges(numberOfCases, warehouseId, companyCode, plantId, languageId, authToken);
        log.info("StagingHeader : " + stagingheader);
        return new ResponseEntity<>(stagingheader, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> getStagingLine(@PathVariable Long lineNo, @RequestParam String companyCode,
        ...
        StagingLineEntity dbStagingLine =
                transactionService.getStagingLine(companyCode, plantId, languageId, warehouseId,
    ...
    public ResponseEntity<?> patchStagingLine(@PathVariable Long lineNo, @RequestParam String warehouseId, @RequestParam String companyCode,
                                              ...
                                              @RequestParam String preInboundNo, @RequestParam String itemCode,
                                              @Valid @RequestBody StagingLineEntity updateStagingLine, @RequestParam String loginUserID,
                                              @RequestParam String authToken)
            throws IllegalAccessException, InvocationTargetException {

        StagingLineEntity updatedStagingLine = transactionService.updateStagingLine(companyCode, plantId,
                languageId, warehouseId, preInboundNo, refDocNumber, stagingNo, palletCode, caseCode,
    ...
    public ResponseEntity<?> patchStagingLineForCaseConfirmation(@RequestBody List<CaseConfirmation> caseConfirmations,
                                                                 @RequestParam String companyCode, @RequestParam String plantId,
                                                                 @RequestParam String languageId, @RequestParam String caseCode,
                                                                 @RequestParam String loginUserID, @RequestParam String authToken)
            throws IllegalAccessException, InvocationTargetException {
        StagingLineEntity[] createdStagingLine =
                transactionService.caseConfirmation(companyCode, plantId, languageId, caseConfirmations, caseCode, loginUserID, authToken);
        return new ResponseEntity<>(createdStagingLine, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> deleteStagingLine(@PathVariable Long lineNo, @RequestParam String companyCode,
                                               ...
                                               @RequestParam String authToken) {
        transactionService.deleteStagingLine(companyCode, plantId, languageId, warehouseId,
    ...
    public ResponseEntity<?> deleteCases(@PathVariable Long lineNo, @RequestParam String preInboundNo,
                                         ...
                                         @RequestParam String authToken) {
        transactionService.deleteCases(preInboundNo, lineNo, itemCode, companyCode, plantId, languageId, caseCode, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
    ...
    public ResponseEntity<?> patchGrHeader(@PathVariable String goodsReceiptNo, @RequestParam String companyCode,
                                           @RequestParam String plantId, @RequestParam String languageId,
                                           @RequestParam String warehouseId, @RequestParam String preInboundNo,
        ...
        GrHeader updatedGrHeader =
                transactionService.updateGrHeader(warehouseId, preInboundNo, refDocNumber, stagingNo,
                        companyCode, plantId, languageId, goodsReceiptNo, palletCode, caseCode, loginUserID, updateGrHeader, authToken);
    ...
    public ResponseEntity<?> deleteGrHeader(@PathVariable String goodsReceiptNo, @RequestParam String warehouseId,
        ...
        transactionService.deleteGrHeader(warehouseId, companyCode, plantId, languageId,
                preInboundNo, refDocNumber, stagingNo, goodsReceiptNo, palletCode, caseCode, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
    ...
    public ResponseEntity<?> getGrLine(@PathVariable Long lineNo, @RequestParam String warehouseId,@RequestParam String companyCode,
                                       ...
                                       @RequestParam String itemCode, @RequestParam String authToken) throws Exception {
        GrLine dbGrLine =
                transactionService.getGrLine(warehouseId, preInboundNo, refDocNumber, goodsReceiptNo,companyCode, palletCode, caseCode,
    ...
    public ResponseEntity<?> patchGrLine(@RequestParam Long lineNo, @RequestParam String warehouseId,
                                         @RequestParam String preInboundNo, @RequestParam String refDocNumber,
                                         @RequestParam String goodsReceiptNo, @RequestParam String palletCode,
                                         @RequestParam String caseCode, @RequestParam String packBarcodes,
                                         @RequestParam String itemCode, @RequestParam String loginUserID,
                                         @RequestParam String authToken, @Valid @RequestBody GrLine updateGrLine)
            throws IllegalAccessException, InvocationTargetException {
    ...
    public ResponseEntity<?> deleteGrLine(@PathVariable Long lineNo, @RequestParam String warehouseId,
        ...
        transactionService.deleteGrLine(warehouseId, preInboundNo, refDocNumber, goodsReceiptNo, companyCode,
                plantId, languageId, palletCode, caseCode, packBarcodes, lineNo, itemCode, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
    ...
    public ResponseEntity<?> getPackBarcode(@RequestParam Long acceptQty, @RequestParam Long damageQty,
        ...
        PackBarcode[] packBarcodes =
                transactionService.generatePackBarcode(companyCodeId, plantId, languageId, acceptQty,
    ...
    public ResponseEntity<?> patchPutAwayHeader(@PathVariable String putAwayNumber, @RequestParam String warehouseId,
                                                @RequestParam String preInboundNo, @RequestParam String refDocNumber,
                                                @RequestParam String companyCodeId, @RequestParam String plantId,
                                                @RequestParam String languageId, @RequestParam String goodsReceiptNo,
                                                @RequestParam String palletCode, @RequestParam String caseCode,
                                                @RequestParam String packBarcodes, @RequestParam String proposedStorageBin,
                                                @Valid @RequestBody PutAwayHeader updatePutAwayHeader,
                                                @RequestParam String loginUserID, @RequestParam String authToken)
            throws IllegalAccessException, InvocationTargetException {

        PutAwayHeader updatedPutAwayHeader = transactionService.updatePutAwayHeader(warehouseId, companyCodeId, plantId,
                languageId, preInboundNo, refDocNumber, goodsReceiptNo, palletCode, caseCode, packBarcodes,
    ...
    public ResponseEntity<?> patchPutAwayHeader(@PathVariable String refDocNumber, @RequestParam String packBarcodes,
        ...
        transactionService.updatePutAwayHeader(companyCodeId, plantId, languageId, warehouseId,
                refDocNumber, packBarcodes, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> deletePutAwayHeader(@PathVariable String putAwayNumber, @RequestParam String companyCodeId,
                                                 @RequestParam String plantId, @RequestParam String languageId,
                                                 @RequestParam String warehouseId, @RequestParam String preInboundNo,
                                                 @RequestParam String refDocNumber, @RequestParam String goodsReceiptNo,
                                                 @RequestParam String palletCode, @RequestParam String caseCode,
        ...
        transactionService.deletePutAwayHeader(warehouseId, preInboundNo, refDocNumber, companyCodeId, languageId,
                plantId, goodsReceiptNo, palletCode, caseCode, packBarcodes, putAwayNumber,
    ...
    public ResponseEntity<?> postPutAwayLine(@Valid @RequestBody List<AddPutAwayLine> newPutAwayLine, @RequestParam String loginUserID,
        ...
        PutAwayLine[] createdPutAwayLine =
                transactionService.createPutAwayLine(newPutAwayLine, loginUserID, authToken);
    ...
    public ResponseEntity<?> getInventory(@RequestParam String warehouseId, @RequestParam String companyCodeId,
                                          @RequestParam String plantId, @RequestParam String languageId, @RequestParam String packBarcodes,
                                          @RequestParam String itemCode, @RequestParam String storageBin, @RequestParam String authToken) throws Exception {
        Inventory inventory =
                transactionService.getInventory(warehouseId, companyCodeId, plantId, languageId,
                        packBarcodes, itemCode, storageBin, authToken);
    ...
    public ResponseEntity<?> patchInventory(@PathVariable Long stockTypeId, @RequestParam String companyCodeId,
                                            @RequestParam String plantId, @RequestParam String languageId,
                                            @RequestParam String warehouseId, @RequestParam String packBarcodes,
                                            ...
                                            @RequestParam String authToken, @Valid @RequestBody Inventory updateInventory)
            throws IllegalAccessException, InvocationTargetException {
        Inventory updatedInventory =
                transactionService.updateInventory(warehouseId, companyCodeId, plantId, languageId, packBarcodes,
                        itemCode, storageBin, stockTypeId, specialStockIndicatorId, updateInventory,
                        loginUserID, authToken);
    ...
    public ResponseEntity<?> postInHouseTransferHeader(@Valid @RequestBody InhouseTransferHeader newInHouseTransferHeader,
                                                       @RequestParam String loginUserID, @RequestParam String authToken)
            throws IllegalAccessException, InvocationTargetException {
        InhouseTransferHeader createdInHouseTransferHeader =
                transactionService.createInhouseTransferHeader(newInHouseTransferHeader, loginUserID, authToken);
    ...
    public ResponseEntity<?> patchUnallocate(@RequestParam String warehouseId, @RequestParam String companyCodeId, @RequestParam String plantId,
        ...
        OrderManagementLine updatedOrderManagementLine =
                transactionService.doUnAllocation(warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, partnerCode, lineNumber,
    ...
    public ResponseEntity<?> patchAllocate(@RequestParam String companyCodeId, @RequestParam String plantId, @RequestParam String languageId,
            ...
            throws IllegalAccessException, InvocationTargetException {
        OrderManagementLine updatedOrderManagementLine =
                transactionService.doAllocation(companyCodeId, plantId, languageId, warehouseId, preOutboundNo, refDocNumber,
                        partnerCode, lineNumber, itemCode, loginUserID, authToken);
        return new ResponseEntity<>(updatedOrderManagementLine, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> getAdditionalBins(@RequestParam String companyCodeId, @RequestParam String plantId,
                                               @RequestParam String languageId, @RequestParam String warehouseId,
                                               @RequestParam String itemCode, @RequestParam Long obOrdertypeId,
                                               @RequestParam String proposedPackBarCode, @RequestParam String proposedStorageBin,
                                               @RequestParam String authToken) {
        Inventory[] additionalBins =
                transactionService.getAdditionalBins(companyCodeId, plantId, languageId, warehouseId,
                        itemCode, obOrdertypeId, proposedPackBarCode, proposedStorageBin, authToken);
    ...
    public ResponseEntity<?> patchQualityHeader(@PathVariable String qualityInspectionNo, @RequestParam String companyCodeId,
                                                @RequestParam String plantId, @RequestParam String languageId,
                                                @RequestParam String warehouseId, @RequestParam String preOutboundNo,
                                                @RequestParam String refDocNumber, @RequestParam String partnerCode,
        ...
        QualityHeader updatedQualityHeader =
                transactionService.updateQualityHeader(warehouseId, companyCodeId,
                        plantId, languageId, preOutboundNo, refDocNumber,
    ...
    public ResponseEntity<?> deleteQualityHeader(@PathVariable String qualityInspectionNo, @RequestParam String companyCodeId,
                                                 @RequestParam String plantId, @RequestParam String languageId,
                                                 @RequestParam String warehouseId, @RequestParam String preOutboundNo,
                                                 @RequestParam String refDocNumber, @RequestParam String partnerCode,
                                                 @RequestParam String pickupNumber, @RequestParam String actualHeNo,
                                                 @RequestParam String loginUserID, @RequestParam String authToken)
            throws IllegalAccessException, InvocationTargetException {
        transactionService.deleteQualityHeader(warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber,
    ...
    public ResponseEntity<?> deliveryConfirmation(@RequestParam String warehouseId, @RequestParam String companyCodeId,
                                                  @RequestParam String plantId, @RequestParam String languageId,
        ...
        OutboundLine[] createdOutboundLine =
                transactionService.deliveryConfirmation(warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber,
    ...
    public ResponseEntity<?> patchOutboundLine(@PathVariable Long lineNumber, @RequestParam String companyCodeId, @RequestParam String plantId, @RequestParam String languageId,
                                               @RequestParam String warehouseId, @RequestParam String preOutboundNo,
        ...
        OutboundLine updatedOutboundLine =
                transactionService.updateOutboundLine(warehouseId, preOutboundNo, refDocNumber, companyCodeId, plantId, languageId, partnerCode,
    ...
    public ResponseEntity<?> deleteOutboundLine(@PathVariable Long lineNumber, @RequestParam String companyCodeId, @RequestParam String plantId, @RequestParam String languageId,
                                                ...
                                                @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
        transactionService.deleteOutboundLine(warehouseId, companyCodeId, plantId, languageId, preOutboundNo, refDocNumber, partnerCode, lineNumber,
                itemCode, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
    ...
    public ResponseEntity<?> doReversal(@RequestParam String refDocNumber, @RequestParam String companyCodeId,
                                        @RequestParam String plantId, @RequestParam String languageId,
                                        @RequestParam String itemCode, @RequestParam String loginUserID,
                                        @RequestParam String authToken)
            throws IllegalAccessException, InvocationTargetException {

        OutboundReversal[] deliveryLines = transactionService.doReversal(refDocNumber, companyCodeId,
                plantId, languageId, itemCode, loginUserID, authToken);
    ...
    public ResponseEntity<?> getAllStockReport(@RequestParam List<String> languageId,
        ...
        StockReport[] stockReportList = transactionService.getAllStockReports(languageId, companyCodeId, plantId, warehouseId, itemCode, itemText, stockTypeText, authToken);
    ...
    public ResponseEntity<?> getPerpetualHeader(@PathVariable String cycleCountNo, @RequestParam String companyCodeId,
                                                @RequestParam String plantId, @RequestParam String languageId, @RequestParam String warehouseId,
        ...
        PerpetualHeader perpetualheader =
                transactionService.getPerpetualHeader(warehouseId, companyCodeId, plantId, languageId, cycleCountTypeId, cycleCountNo,
    ...
    public ResponseEntity<?> patchPerpetualHeader(@PathVariable String cycleCountNo, @RequestParam String warehouseId, @RequestParam String companyCodeId,
                                                  @RequestParam String languageId, @RequestParam String plantId,
                                                  @RequestParam Long cycleCountTypeId, @RequestParam Long movementTypeId, @RequestParam Long subMovementTypeId,
                                                  @Valid @RequestBody UpdatePerpetualHeader updatePerpetualHeader, @RequestParam String loginUserID,
                                                  @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
        PerpetualHeader createdPerpetualHeader =
                transactionService.updatePerpetualHeader(warehouseId, companyCodeId, plantId, languageId, cycleCountTypeId, cycleCountNo, movementTypeId,
    ...
    public ResponseEntity<?> deletePerpetualHeader(@PathVariable String cycleCountNo, @RequestParam String warehouseId, @RequestParam String companyCodeId,
                                                   @RequestParam String plantId, @RequestParam String languageId,
                                                   @RequestParam Long cycleCountTypeId, @RequestParam Long movementTypeId, @RequestParam Long subMovementTypeId,
                                                   @RequestParam String loginUserID, @RequestParam String authToken) {
        transactionService.deletePerpetualHeader(warehouseId, companyCodeId, plantId, languageId, cycleCountTypeId, cycleCountNo, movementTypeId,
...
//		batchJobScheduler.runJobPeriodic();
    ...
    public ResponseEntity<?> patchPeriodicHeader(@PathVariable String cycleCountNo, @RequestParam String warehouseId, @RequestParam String companyCodeId,
                                                 @RequestParam String plantId, @RequestParam String languageId,
        ...
        PeriodicHeader createdPeriodicHeader =
                transactionService.updatePeriodicHeader(warehouseId, companyCodeId, plantId, languageId, cycleCountTypeId, cycleCountNo,
    ...
    public ResponseEntity<?> deletePeriodicHeader(@PathVariable String cycleCountNo, @RequestParam String companyCodeId,
        ...
        transactionService.deletePeriodicHeader(warehouseId, companyCodeId, plantId, languageId, cycleCountTypeId, cycleCountNo, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
  ...
  //--------------------------------Inbound ---------------------------------------------------------------
    ...
    @ApiOperation(response = SaleOrderReturn.class, value = "Sales Order Return ") // label for swagger
    @PostMapping("/warehouse/inbound/soReturn")
    public ResponseEntity<?> postSoReturnV2(@Valid @RequestBody SaleOrderReturn saleOrderReturn, @RequestParam String authToken)
            throws IllegalAccessException, InvocationTargetException {
        WarehouseApiResponse createdSO = transactionService.postSOReturn(saleOrderReturn, authToken);
        return new ResponseEntity<>(createdSO, HttpStatus.OK);
    }
    ...
    // B2b Transfer IN
    @ApiOperation(response = InterWarehouseTransferIn.class, value = "InterWarehouse TransferIn") // label for swagger
    @PostMapping("/warehouse/inbound/interWarehouseTransferIn")
    public ResponseEntity<?> postInterWarehouseTransferInV2(@Valid @RequestBody InterWarehouseTransferIn interWarehouseTransferIn, @RequestParam String authToken)
            throws IllegalAccessException, InvocationTargetException {
        WarehouseApiResponse createdSO = transactionService.postInterWarehouseTransferIn(interWarehouseTransferIn, authToken);
        return new ResponseEntity<>(createdSO, HttpStatus.OK);
    }
