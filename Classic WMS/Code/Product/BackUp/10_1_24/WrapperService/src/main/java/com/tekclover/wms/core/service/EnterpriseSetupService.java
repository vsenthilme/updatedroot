...
public class EnterpriseSetupService {
	...
	// GET Barcode
	public Barcode getBarcode(String warehouseId, String method, Long barcodeTypeId,
							  Long barcodeSubTypeId, Long levelId, String levelReference,
							  Long processId,String companyId,String plantId,String languageId,String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// Patch Barcode
	public Barcode updateBarcode (String warehouseId, String method, Long barcodeTypeId,
								  Long barcodeSubTypeId,String companyId,String plantId,
								  String languageId, Long levelId, String levelReference,
								  Long processId, Barcode modifiedBarcode, String loginUserID,
								  String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	public boolean deleteBarcode (String warehouseId, String method, Long barcodeTypeId,
								  Long barcodeSubTypeId, String companyId,String languageId,
								  String plantId, Long levelId, String levelReference, Long processId,
	...
	public BatchSerial getBatchSerial(String storageMethod,String companyId,String languageId,
									  String plantId,String warehouseId,Long levelId,String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
...
//	}
	...
	// Patch BatchSerial
	public BatchSerial updateBatchSerial (String storageMethod,String companyId,String languageId,
										  String plantId,String warehouseId,Long levelId,UpdateBatchSerial modifiedBatchSerial,
										  String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
...
//	}
// Delete BatchSerial
public boolean deleteBatchSerial (String storageMethod,String companyId,
...
// Get ALL
	public ItemGroup[] getItemGroups (String authToken) {
		try {
			...
			UriComponentsBuilder builder = UriComponentsBuilder.
					fromHttpUrl(getEnterpriseSetupServiceApiUrl() + "itemgroup");
	...
	public ItemGroup getItemGroup(String companyId,String languageId,String plantId,
								  String warehouseId, Long itemTypeId, Long itemGroupId,
								  Long subItemGroupId, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
			...
			ResponseEntity<ItemGroup> result = getRestTemplate().exchange(builder.toUriString(),
					HttpMethod.GET, entity, ItemGroup.class);
			log.info("result : " + result.getStatusCode());
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
	...
	// Patch ItemGroup
	public ItemGroup updateItemGroup (Long itemGroupId, String warehouseId, Long itemTypeId,
									  Long subItemGroupId, ItemGroup modifiedItemGroup,
	...
	// Delete ItemGroup
	public boolean deleteItemGroup (String warehouseId, Long itemTypeId,String companyId,
									String languageId,String plantId, Long itemGroupId,
									Long subItemGroupId, String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public Employee[] getEMployees (String authToken) {
		try {
			...
			HttpEntity<?> entity = new HttpEntity<>(headers);
			UriComponentsBuilder builder = UriComponentsBuilder.
					fromHttpUrl(getEnterpriseSetupServiceApiUrl() + "employee");

			ResponseEntity<Employee[]> result = getRestTemplate().
					exchange(builder.toUriString(), HttpMethod.GET, entity, Employee[].class);
			log.info("result : " + result.getStatusCode());
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
...
//	}
	...
	public Employee addEmployee (Employee employee, String loginUserID, String authToken) {
		try {
			...
			ResponseEntity<Employee> result = getRestTemplate().
					exchange(builder.toUriString(), HttpMethod.POST, entity, Employee.class);
			log.info("result : " + result.getStatusCode());
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
	...
	// Patch ItemGroup
	public Employee updateEmployee (String employee,Employee modifiedEmployee,
									String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			...
			ResponseEntity<Employee> result = restTemplate.exchange(builder.toUriString(),
					HttpMethod.PATCH, entity, Employee.class);
			log.info("result : " + result.getStatusCode());
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public ItemType getItemType(String warehouseId, Long itemTypeId,String companyId,
		...
		try {
			...
			ResponseEntity<ItemType> result = getRestTemplate().
					exchange(builder.toUriString(), HttpMethod.GET, entity, ItemType.class);
			log.info("result : " + result.getStatusCode());
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public ItemType updateItemType (String warehouseId, Long itemTypeId,String companyId,
		...
		try {
			...
			ResponseEntity<ItemType> result = restTemplate.
					exchange(builder.toUriString(), HttpMethod.PATCH, entity, ItemType.class);
			log.info("result : " + result.getStatusCode());
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public Plant[] getPlants (String authToken) {
		try {
			...
			HttpEntity<?> entity = new HttpEntity<>(headers);
			UriComponentsBuilder builder = UriComponentsBuilder.
					fromHttpUrl(getEnterpriseSetupServiceApiUrl() + "plant");

			ResponseEntity<Plant[]> result = getRestTemplate().
					exchange(builder.toUriString(), HttpMethod.GET, entity, Plant[].class);
			log.info("result : " + result.getStatusCode());
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public Plant addPlant (Plant plant, String loginUserID, String authToken) {
		try {
			...
			ResponseEntity<Plant> result = getRestTemplate().
					exchange(builder.toUriString(), HttpMethod.POST, entity, Plant.class);
			log.info("result : " + result.getStatusCode());
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public StorageBinType[] getStorageBinTypes (String authToken) {
		try {
			...
			ResponseEntity<StorageBinType[]> result = getRestTemplate().
					exchange(builder.toUriString(), HttpMethod.GET, entity, StorageBinType[].class);
			log.info("result : " + result.getStatusCode());
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
	...
	// GET StorageBinType
	public StorageBinType getStorageBinType(String warehouseId, Long storageTypeId,
											Long storageClassId, Long storageBinTypeId,String companyId,
	...
	public StorageBinType[] findStorageBinType(SearchStorageBinType searchStorageBinType, String authToken){
		try{
			...
			headers.add("Authorization", "Bearer " + authToken);
			UriComponentsBuilder builder=UriComponentsBuilder.
					fromHttpUrl(getEnterpriseSetupServiceApiUrl() +"storagebintype/findStorageBinType");
	...
	public StorageBinType updateStorageBinType (String warehouseId, Long storageTypeId,
												Long storageClassId, Long storageBinTypeId,
												String companyId,String languageId,String plantId,
												StorageBinType modifiedStorageBinType, String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
			...
			ResponseEntity<StorageBinType> result =
					restTemplate.exchange(builder.toUriString(), HttpMethod.PATCH, entity, StorageBinType.class);
			log.info("result : " + result.getStatusCode());
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
	...
	// Patch StorageClass
	public StorageClass updateStorageClass (String warehouseId, Long storageClassId,String companyId,
											String languageId,String plantId,StorageClass modifiedStorageClass,
											String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			...
			ResponseEntity<StorageClass> result =
					restTemplate.exchange(builder.toUriString(), HttpMethod.PATCH, entity, StorageClass.class);
			log.info("result : " + result.getStatusCode());
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public StorageSection updateStorageSection (String warehouseId, Long floorId, String storageSectionId,
		...
		try {
			...
			ResponseEntity<StorageSection> result
					= restTemplate.exchange(builder.toUriString(), HttpMethod.PATCH, entity, StorageSection.class);
			log.info("result : " + result.getStatusCode());
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public StorageType updateStorageType (String warehouseId, Long storageClassId, Long storageTypeId,
		...
		try {
			...
			ResponseEntity<StorageType> result
					= restTemplate.exchange(builder.toUriString(), HttpMethod.PATCH, entity, StorageType.class);
			log.info("result : " + result.getStatusCode());
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
	...
	// GET Strategies
	public Strategies[] getStrategies( String companyId, String languageId,String plantId,
										   String warehouseId, Long strategyTypeId, Long sequenceIndicator,
										   String strategyNo, Long priority, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// Patch Strategies
	public Strategies[] updateStrategies (String companyId, String languageId,String plantId,
										  String warehouseId, Long strategyTypeId, Long sequenceIndicator,
										  String strategyNo, Long priority, Strategies[] modifiedStrategies,
										  String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			...
			ResponseEntity<Strategies[]> result =
					restTemplate.exchange(builder.toUriString(), HttpMethod.PATCH, entity, Strategies[].class);
			log.info("result : " + result.getStatusCode());
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public boolean deleteStrategies ( String companyId, String languageId,String plantId,String warehouseId,
									  Long strategyTypeId, Long sequenceIndicator, String strategyNo, Long priority,
									  String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	// GET Variant
	public Variant getVariant(String variantId,String companyId,String languageId,
							  String plantId,Long levelId,String warehouseId,String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// Patch Variant
	public Variant updateVariant (String variantId, UpdateVariant modifiedVariant,String companyId,
		...
		try {
			...
			ResponseEntity<Variant> result =
					restTemplate.exchange(builder.toUriString(), HttpMethod.PATCH, entity, Variant.class);
			log.info("result : " + result.getStatusCode());
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
	...
	// Delete Variant
	public boolean deleteVariant (String variantId,String companyId,String plantId,
								  String warehouseId,String languageId,Long levelId,
								  String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	// GET Warehouse
	public Warehouse getWarehouse(String warehouseId, String modeOfImplementation,
								  Long warehouseTypeId,String companyId,String plantId,
	...
	// Patch Warehouse
	public Warehouse updateWarehouse (String warehouseId, String modeOfImplementation,
									  Long warehouseTypeId,String companyId,String plantId,
									  String languageId,Warehouse modifiedWarehouse,
									  String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	// Delete Warehouse
	public boolean deleteWarehouse (String warehouseId, String modeOfImplementation,
									Long warehouseTypeId,String companyId,String plantId,
									String languageId,String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
