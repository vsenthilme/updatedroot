...
public class HandlingEquipmentController {
	...
	public ResponseEntity<?> deleteHandlingEquipment(@PathVariable String handlingEquipmentId,@RequestParam String companyCodeId,@RequestParam String plantId,@RequestParam String warehouseId,@RequestParam String languageId,@RequestParam String loginUserID) {
