...
public interface ImBasicData1Repository extends PagingAndSortingRepository<ImBasicData1,Long>, 
   ...
   @Query(
    ...
    Optional<ImBasicData1> findByCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndUomIdAndLanguageIdAndDeletionIndicator(
			String companyCodeId, String plantId, String warehouseId, String itemCode, String uomId, String languageId, Long deletionIndicator);
}