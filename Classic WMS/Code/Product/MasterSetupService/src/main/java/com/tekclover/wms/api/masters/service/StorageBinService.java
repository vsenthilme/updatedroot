...
//		log.info("storagebinList : " + storagebinList);
     ...
     * @return
     */
    public StorageBin getStorageBin(String warehouseId, Long binClassId, String companyCodeId, String plantId, String languageId) {
        StorageBin storagebin =
                storagebinRepository.findByWarehouseIdAndBinClassIdAndCompanyCodeIdAndPlantIdAndLanguageIdAndDeletionIndicator(
                warehouseId, binClassId, companyCodeId, plantId, languageId, 0L);
        if (storagebin != null) {
            return storagebin;
        } else {
            throw new BadRequestException("The given values : "
