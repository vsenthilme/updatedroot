...
public class PlantIdController {
	...
	@GetMapping("/{plantId}")
	public ResponseEntity<?> getPlantId(@PathVariable String plantId) {
    	PlantId plantid = plantidService.getPlantId(plantId);
    	log.info("PlantId : " + plantid);
		return new ResponseEntity<>(plantid, HttpStatus.OK);
	}
    
//	@ApiOperation(response = PlantId.class, value = "Search PlantId") // label for swagger
//	@PostMapping("/findPlantId")
//	public List<PlantId> findPlantId(@RequestBody SearchPlantId searchPlantId)
//			throws Exception {
//		return plantidService.findPlantId(searchPlantId);
//	}
	...
	public ResponseEntity<?> patchPlantId(@PathVariable String plantId, @Valid @RequestBody UpdatePlantId updatePlantId, @RequestParam String loginUserID) 
			throws IllegalAccessException, InvocationTargetException {
		PlantId createdPlantId = plantidService.updatePlantId(plantId, loginUserID, updatePlantId);
		return new ResponseEntity<>(createdPlantId , HttpStatus.OK);
	}
    
    @ApiOperation(response = PlantId.class, value = "Delete PlantId") // label for swagger
	@DeleteMapping("/{plantId}")
	public ResponseEntity<?> deletePlantId(@PathVariable String plantId, 
			@RequestParam String loginUserID) {
    	plantidService.deletePlantId(plantId, loginUserID);
