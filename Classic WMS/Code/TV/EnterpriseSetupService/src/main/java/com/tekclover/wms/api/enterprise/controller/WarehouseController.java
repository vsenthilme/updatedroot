...
public class WarehouseController {
	...
	public ResponseEntity<?> getWarehouse(@PathVariable String warehouseId, String modeOfImplementation, Long warehouseTypeId) {
    	Warehouse warehouse = warehouseService.getWarehouse(warehouseId, modeOfImplementation, warehouseTypeId);
	...
	public ResponseEntity<?> patchWarehouse(@PathVariable String warehouseId, 
			...
			throws IllegalAccessException, InvocationTargetException {
		Warehouse updatedWarehouse = warehouseService.updateWarehouse(warehouseId, updateWarehouse, loginUserID);
