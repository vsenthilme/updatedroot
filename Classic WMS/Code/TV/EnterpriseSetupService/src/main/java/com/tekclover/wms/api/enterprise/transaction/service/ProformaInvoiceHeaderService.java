...
import com.tekclover.wms.api.enterprise.transaction.model.threepl.proformainvoiceheader.AddProformaInvoiceHeader;
import com.tekclover.wms.api.enterprise.transaction.model.threepl.proformainvoiceheader.ProformaInvoiceHeader;
import com.tekclover.wms.api.enterprise.transaction.model.threepl.proformainvoiceheader.UpdateProformaInvoiceHeader;
import com.tekclover.wms.api.enterprise.transaction.repository.ProformaInvoiceHeaderRepository;
...
public class ProformaInvoiceHeaderService extends BaseService {
     ...
     * @return
     */
    public ProformaInvoiceHeader getProformaInvoiceHeader (String warehouseId, String proformaBillNo, String partnerCode) {
     ...
     * @throws InvocationTargetException
     */
    public ProformaInvoiceHeader updateProformaInvoiceHeader(String warehouseId, String proformaBillNo,String partnerCode, String loginUserID,
                                 UpdateProformaInvoiceHeader updateProformaInvoiceHeader)
            throws IllegalAccessException, InvocationTargetException {
        ProformaInvoiceHeader dbProformaInvoiceHeader= getProformaInvoiceHeader(warehouseId, proformaBillNo, partnerCode);
     ...
     * @param proformaBillNo
     */
    public void deleteProformaInvoiceHeader(String warehouseId,String proformaBillNo,String partnerCode, String loginUserID) {
        ProformaInvoiceHeader dbProformaInvoiceHeader = getProformaInvoiceHeader(warehouseId, proformaBillNo, partnerCode);
