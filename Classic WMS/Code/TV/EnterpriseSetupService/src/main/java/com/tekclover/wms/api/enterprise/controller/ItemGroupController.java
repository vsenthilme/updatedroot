...
public class ItemGroupController {
	...
	public ResponseEntity<?> getItemGroup(@PathVariable Long itemGroupId, @RequestParam String warehouseId, @RequestParam Long itemTypeId, 
		@RequestParam Long subItemGroup) {
	   	ItemGroup itemgroup = itemgroupService.getItemGroup(warehouseId, itemTypeId, itemGroupId, subItemGroup);
	...
	public ResponseEntity<?> patchItemGroup(@PathVariable Long itemGroupId, @RequestParam String warehouseId, 
			...
			throws IllegalAccessException, InvocationTargetException {
		ItemGroup createdItemGroup = itemgroupService.updateItemGroup(warehouseId, itemTypeId, itemGroupId, subItemGroup, updateItemGroup, loginUserID);
		return new ResponseEntity<>(createdItemGroup , HttpStatus.OK);
	}
	...
	public ResponseEntity<?> deleteItemGroup(@PathVariable Long itemGroupId, @RequestParam String warehouseId, 
    	...
    	itemgroupService.deleteItemGroup(warehouseId, itemTypeId, itemGroupId, subItemGroup, loginUserID);
