...
public class BarcodeSubTypeIdController {
	...
	public ResponseEntity<?> getBarcodeSubTypeId(@PathVariable Long barcodeSubTypeId, 
			@RequestParam String warehouseId, @RequestParam Long barcodeTypeId) {
    	BarcodeSubTypeId barcodesubtypeid = 
    			barcodesubtypeidService.getBarcodeSubTypeId(warehouseId, barcodeTypeId, barcodeSubTypeId);
...
//	}
	...
	public ResponseEntity<?> patchBarcodeSubTypeId(@PathVariable Long barcodeSubTypeId, 
			@RequestParam String warehouseId, @RequestParam Long barcodeTypeId, 
		...
		BarcodeSubTypeId createdBarcodeSubTypeId = 
				barcodesubtypeidService.updateBarcodeSubTypeId(warehouseId, barcodeTypeId, barcodeSubTypeId, loginUserID, updateBarcodeSubTypeId);
		return new ResponseEntity<>(createdBarcodeSubTypeId , HttpStatus.OK);
	}
	...
	public ResponseEntity<?> deleteBarcodeSubTypeId(@PathVariable Long barcodeSubTypeId, 
			@RequestParam String warehouseId, @RequestParam Long barcodeTypeId, @RequestParam String loginUserID) {
    	barcodesubtypeidService.deleteBarcodeSubTypeId(warehouseId, barcodeTypeId, barcodeSubTypeId, loginUserID);
