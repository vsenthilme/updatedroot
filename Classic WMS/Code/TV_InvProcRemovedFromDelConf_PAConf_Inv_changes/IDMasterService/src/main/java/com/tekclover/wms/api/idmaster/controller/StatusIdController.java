...
public class StatusIdController {
	...
	public ResponseEntity<?> getStatusId(@PathVariable Long statusId, 
    	...
    	StatusId statusid = 
    			statusidService.getStatusId(warehouseId, statusId);
...
//	}
	...
	public ResponseEntity<?> patchStatusId(@PathVariable Long statusId, 
		...
		StatusId createdStatusId = 
				statusidService.updateStatusId(warehouseId, statusId, loginUserID, updateStatusId);
		return new ResponseEntity<>(createdStatusId , HttpStatus.OK);
	}
	...
	public ResponseEntity<?> deleteStatusId(@PathVariable Long statusId, 
    	...
    	statusidService.deleteStatusId(warehouseId, statusId, loginUserID);
