...
@IdClass(PowderCompositeKey.class)
public class Powder {
    ...
    @Column(name = "PHASE_DETAILS", columnDefinition = "nvarchar(100)")
    ...
    @Column(name = "RST_START_TIME")
    private Date roastingStartTime;

    @Column(name = "RST_END_TIME")
    private Date roastingEndTime;

    @Column(name = "PWR_START_TIME")
    private Date powderPreparationStartTime;

    @Column(name = "PWR_END_TIME")
    private Date powderPreparationEndTime;

    @Column(name = "RST_WGT")
    private Double postRoastingWeight;
