...
@Repository
@Transactional
public interface CookingRepository extends JpaRepository<Cooking, Long>, JpaSpecificationExecutor<Cooking>, StreamableJpaSpecificationRepository<Cooking> {

    Optional<Cooking> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndOperationNumberAndReceipeIdAndProductionOrderNoAndProductionOrderLineNoAndItemCodeAndDeletionIndicator(
    ...
    Optional<Cooking> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndOperationNumberAndReceipeIdAndProductionOrderNoAndProductionOrderLineNoAndItemCodeAndPhaseNumberAndBomItemAndBatchNumberAndDeletionIndicator(
    ...
    List<Cooking> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndProductionOrderNoAndDeletionIndicator(
            String languageId, String companyCodeId, String plantId, String warehouseId, String productionOrderNo, Long deletionIndicator);

    Cooking findTopByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndProductionOrderNoAndBatchNumberAndDeletionIndicator(
    ...
    @Query(value = "SELECT \n" +
            ...
            "FROM tblcooking tc \n" +
            "WHERE \n" +
            "(COALESCE(:itemCode, null) IS NULL OR tc.ITM_CODE IN (:itemCode)) AND \n" +
            "(COALESCE(:batchNumber, null) IS NULL OR tc.BATCH_NO IN (:batchNumber)) AND \n" +
            "(COALESCE(:productionOrderNo, null) IS NULL OR tc.PROD_ORD_NO IN (:productionOrderNo))",
            nativeQuery = true)
    List<ProcessImpl> findCooking(
            @Param("itemCode") String itemCode,
            @Param("batchNumber") String batchNumber,
            @Param("productionOrderNo") String productionOrderNo);

    List<Cooking> findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndProductionOrderNoAndBatchNumberAndDeletionIndicator(
