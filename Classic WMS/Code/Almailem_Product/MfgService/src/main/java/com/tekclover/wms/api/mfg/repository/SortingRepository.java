...
import com.tekclover.wms.api.mfg.model.prodcutionorder.SortingImpl;
...
@Repository
@Transactional
public interface SortingRepository extends JpaRepository<Sorting, Long>,
        JpaSpecificationExecutor<Sorting>, StreamableJpaSpecificationRepository<Sorting> {

    Optional<Sorting> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndProductionOrderNoAndProductionOrderLineNoAndReceipeIdAndOperationNumberAndItemCodeAndDeletionIndicator(
    ...
    Optional<Sorting> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndProductionOrderNoAndProductionOrderLineNoAndReceipeIdAndOperationNumberAndItemCodeAndPhaseNumberAndBomItemAndBatchNumberAndDeletionIndicator(
            String languageId, String companyCodeId, String plantId, String warehouseId,
            String productionOrderNo, Long productionOrderLineNo, String receipeId,
            String operationNumber, String itemCode, String phaseNumber,
            String bomItem, String batchNumber, Long deletionIndicator);

    List<Sorting> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndProductionOrderNoAndDeletionIndicator(
            String languageId, String companyCodeId, String plantId, String warehouseId, String productionOrderNo, Long deletionIndicator);

    Sorting findTopByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndProductionOrderNoAndBatchNumberAndDeletionIndicator(
    ...
    @Query(value = "SELECT \n" +
            ...
            nativeQuery = true)
    List<ProcessImpl> findSorting(
            @Param("itemCode") String itemCode,
            @Param("batchNumber") String batchNumber,
            @Param("productionOrderNo") String productionOrderNo
    );

    List<Sorting> findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndProductionOrderNoAndBatchNumberAndDeletionIndicator(
