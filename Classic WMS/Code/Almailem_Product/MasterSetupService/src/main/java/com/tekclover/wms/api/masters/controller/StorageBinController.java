...
public class StorageBinController {
    ...
    public ResponseEntity<?> getStorageBin(@PathVariable String storageBin, @RequestParam String companyCodeId, @RequestParam String plantId,
    ...
    public ResponseEntity<?> patchStorageBin(@PathVariable String storageBin, @RequestParam String companyCodeId, @RequestParam String plantId,
                                             @RequestParam String warehouseId, @RequestParam String languageId,
                                             @Valid @RequestBody UpdateStorageBin updateStorageBin, @RequestParam String loginUserID) {
        StorageBin createdStorageBin =
                storagebinService.updateStorageBin(storageBin, companyCodeId, plantId, warehouseId, languageId, updateStorageBin, loginUserID);
        return new ResponseEntity<>(createdStorageBin, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> patchStorageBinV2(@PathVariable String storageBin, @RequestParam String companyCodeId, @RequestParam String plantId,
                                               @RequestParam String warehouseId, @RequestParam String languageId,
    ...
    public ResponseEntity<?> deleteStorageBin(@PathVariable String storageBin, @RequestParam String loginUserID, @RequestParam String warehouseId,
    ...
    public ResponseEntity<?> patchStoreBin(@PathVariable String storageBin, @RequestParam String companyCodeId, @RequestParam String plantId,
                                           @RequestParam String warehouseId, @RequestParam String languageId,
                                           @Valid @RequestBody StorageBinV2 storageBinV2, @RequestParam String loginUserID) {
        StorageBinV2 createdStorageBin = storagebinService.updateStoreBinV2(storageBin, companyCodeId, plantId, warehouseId,
                languageId, storageBinV2, loginUserID);
        return new ResponseEntity<>(createdStorageBin, HttpStatus.OK);
    }
