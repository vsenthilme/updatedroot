...
public class BomHeaderController {
    ...
    public ResponseEntity<?> getBomHeader(@PathVariable String parentItemCode, @RequestParam String warehouseId, @RequestParam String companyCode,
...
//    	log.info("BomHeader : " + bomheader);
    ...
    public ResponseEntity<?> patchBomHeader(@PathVariable String parentItemCode, @RequestParam String warehouseId, @RequestParam String languageId,
                                            @RequestParam String plantId, @RequestParam String companyCode,
