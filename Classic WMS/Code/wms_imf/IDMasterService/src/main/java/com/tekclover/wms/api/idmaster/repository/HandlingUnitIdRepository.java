...
public interface HandlingUnitIdRepository extends JpaRepository<HandlingUnitId,Long>, JpaSpecificationExecutor<HandlingUnitId> {
	...
	public Optional<HandlingUnitId> 
		findByCompanyCodeIdAndPlantIdAndWarehouseIdAndHandlingUnitNumberAndLanguageIdAndDeletionIndicator(
				String companyCodeId, String plantId, String warehouseId,String handlingUnitNumber, String languageId, Long deletionIndicator);
}