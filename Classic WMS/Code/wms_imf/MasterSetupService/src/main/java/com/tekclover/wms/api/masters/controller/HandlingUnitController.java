...
public class HandlingUnitController {
    ...
    public ResponseEntity<?> getHandlingUnit(@PathVariable String handlingUnit, @RequestParam String companyCodeId, @RequestParam String languageId,
...
//    	log.info("HandlingUnit : " + dbHandlingUnit);
    ...
    public ResponseEntity<?> patchHandlingUnit(@PathVariable String handlingUnit, @RequestParam String companyCodeId, @RequestParam String languageId,
                                               @RequestParam String plantId, @RequestParam String warehouseId,
    ...
    public ResponseEntity<?> deleteHandlingUnit(@PathVariable String handlingUnit, @RequestParam String companyCodeId, @RequestParam String languageId,
