...
public class NumberRangeStorageBinController {
    ...
    @PostMapping("")
    public ResponseEntity<?> postNumberRangeStorageBin(@Valid @RequestBody AddNumberRangeStorageBin newNumberRangeStorageBin, @RequestParam String loginUserID) {
    ...
    public ResponseEntity<?> findNumberRangeStorageSection(@Valid @RequestBody SearchNumberRangeStorageBin searchNumberRangeStorageBin) {
