...
public interface QualityHeaderV2Repository extends JpaRepository<QualityHeaderV2, Long>,
    ...
    @Modifying
    @Query(value = "update tblqualityheader set noti_status = 1 where \n" +
    ...
    @Query(value = "select distinct ref_doc_no as refDocNumber, wh_id as warehouseId, \n" +
            " ref_doc_type as refDocType from tblqualityheader \n" +
            " WHERE status_id = 54 AND noti_status = 0 AND is_deleted = 0", nativeQuery = true)
