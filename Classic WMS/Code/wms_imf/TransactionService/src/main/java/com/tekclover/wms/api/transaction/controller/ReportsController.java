...
//	}
    ...
    public ResponseEntity<?> getShipmentDeliveryReportV2(@RequestParam String companyCodeId, @RequestParam String plantId,
                                                         ...
                                                         @RequestParam(required = false) String storeCode,
                                                         @RequestParam(required = false) List<String> soType,
                                                         @RequestParam String orderNumber, @RequestParam String preOutboundNo) throws Exception {
        List<ShipmentDeliveryReport> shipmentDeliveryList = reportsService.getShipmentDeliveryReportV2(companyCodeId, plantId, languageId, warehouseId,
    ...
    public ResponseEntity<?> getShipmentDispatchSummaryReport(@RequestParam String fromDeliveryDate, @RequestParam String toDeliveryDate,
                                                              @RequestParam(required = false) List<String> customerCode, @RequestParam(required = true) String warehouseId)
            throws Exception {
    ...
    public ResponseEntity<?> getTransactionHistoryReport(@RequestBody FindImBasicData1 searchImBasicData1) throws Exception {
    ...
    public ResponseEntity<?> getBillingTransactionReport(@RequestBody FindBillingTransactionReport findBillingTransactionReport) {
        Stream<BillingTransactionReport> billingTransactionReportStream = reportsService.getBillingTransactionReport(findBillingTransactionReport);
        return new ResponseEntity<>(billingTransactionReportStream, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> getPickingProductivityReport(@RequestBody SearchPickingProductivityReport searchPickingProductivityReport) throws Exception {
