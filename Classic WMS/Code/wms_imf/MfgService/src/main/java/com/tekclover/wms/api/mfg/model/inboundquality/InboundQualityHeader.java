package com.tekclover.wms.api.mfg.model.inboundquality;
 ...
 */
@Table(
        name = "tblinboundqualityheader",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "unique_key_inboundqualityheader",
                        columnNames = {"C_ID", "PLANT_ID", "LANG_ID", "WH_ID", "REF_DOC_NO", "PRE_IB_NO", "IB_QC_NO", "ITM_CODE"})
        }
)
@IdClass(InboundQualityHeaderCompositeKey.class)
