...
@Repository
@Transactional
public interface PackingQcRepository extends JpaRepository<PackingQc, Long>, JpaSpecificationExecutor<PackingQc>, StreamableJpaSpecificationRepository<PackingQc> {

    Optional<PackingQc> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndOperationNumberAndReceipeIdAndProductionOrderNoAndProductionOrderLineNoAndItemCodeAndDeletionIndicator(
