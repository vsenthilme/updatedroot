package com.tekclover.wms.api.mfg.util;
...
public class DateUtils {
	...
	public static String dateConv(String input) {
...
//		LocalDate eLocalDate =  LocalDate.ofInstant(endDate.toInstant(), ZoneId.systemDefault());
	 ...
	 * @throws ParseException
	 */
	public static Date emptyDateTime (Date startDate) throws ParseException {
		LocalDate sLocalDate =  LocalDate.ofInstant(startDate.toInstant(), ZoneId.systemDefault());
	 ...
	 * @return
	 */
	public static boolean compareLocalDates(LocalDate date1, LocalDate date2) {
        return date1.isEqual(date2);
    }
	
	public static boolean compareDates(Date dateParam1, Date dateParam2) {
...
//		log.info("convertStringToDate-------> : " + date);
	...
	public static String convertDate2StringWithTime(Date date) {
...
//		log.info("Kuwait Time: " + kwtLocalDateTime);
	...
	public static Date convertStringToDateWithT(String fromDeliveryDate) throws NumberFormatException, Exception {
		...
		return addTimeToDate (dateAlone, Integer.parseInt(time[0]), Integer.parseInt(time[1]), Integer.parseInt(time[2]));
	}
...
//			return Date.from(fromDeliveryDate_d.atStartOfDay(ZoneId.systemDefault()).toInstant());
	 ...
	 * @return
	 */
	public static Date addTimeToDate(Date inputDate, int numberOfDays) {
		try {
	 ...
	 * @return
	 */
	public static LocalDate dateConv2(String input) {
		...
		try {
			LocalDate date = LocalDate.parse(input, formatter2);
