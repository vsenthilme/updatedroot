...
import com.tekclover.wms.api.enterprise.transaction.model.auditlog.AuditLog;
import com.tekclover.wms.api.enterprise.transaction.model.auth.AuthToken;
import com.tekclover.wms.api.enterprise.transaction.model.dto.BinClassId;
...
import com.tekclover.wms.api.enterprise.transaction.model.notification.NotificationSave;
...
public class IDMasterService {
    ...
    //--------------------------------------------------------------------------------------------------------------------
    // GET
    public WarehouseId getWarehouse(String warehouseId, String authToken) {
        try {
            ...
            ResponseEntity<WarehouseId> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.GET, entity, WarehouseId.class);
...
//			e.printStackTrace();
     ...
     * @return
     */
    public WarehouseId getWarehouse(String warehouseId, String companyCodeId,
