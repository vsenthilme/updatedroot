...
//            String manufacturerName, String storageBin, Long statusId, Date stockCountDate, Date date, Long deletionIndicator);
    ...
    PutAwayLineV2 findTopByIsInventoryCreatedAndStatusIdAndDeletionIndicatorOrderByCreatedOn(Long isInventoryCreated, Long statusId, Long deletionIndicator);

    @Modifying(clearAutomatically = true, flushAutomatically = true)
    @Query("Update PutAwayLineV2 ob SET ob.isInventoryCreated = :isInventoryCreated \r\n "
            + " WHERE ob.companyCode = :companyCode AND ob.plantId = :plantId AND ob.languageId = :languageId AND ob.warehouseId = :warehouseId AND \r\n"
            + "ob.goodsReceiptNo = :goodsReceiptNo AND ob.preInboundNo = :preInboundNo AND ob.refDocNumber = :refDocNumber AND ob.lineNo = :lineNo AND \r\n"
            + "ob.itemCode = :itemCode AND ob.putAwayNumber = :putAwayNumber AND ob.proposedStorageBin = :proposedStorageBin AND ob.confirmedStorageBin = :confirmedStorageBin ")
    public void updatePutAwayLineStatusV2(@Param("companyCode") String companyCode,
                                          @Param("plantId") String plantId,
                                          @Param("languageId") String languageId,
                                          @Param("warehouseId") String warehouseId,
                                          ...
                                          @Param("confirmedStorageBin") String confirmedStorageBin,
                                          @Param("isInventoryCreated") Long isInventoryCreated);
}