...
//                }
                ...
                newPutAwayLine.setIsInventoryCreated(0l);
...
//        }
    ...
    /**
     * get putawayline for create inventory with statusId 24
     * @return
     */
    public PutAwayLineV2 getPutAwayLineV2() {
        ...
        if(putAwayLine != null) {
            putAwayLineV2Repository.updatePutAwayLineStatusV2(
                    ...
                    putAwayLine.getItemCode(), putAwayLine.getPutAwayNumber(), putAwayLine.getProposedStorageBin(), putAwayLine.getConfirmedStorageBin(), 1L);
            return putAwayLine;
        }
        return null;
    }
