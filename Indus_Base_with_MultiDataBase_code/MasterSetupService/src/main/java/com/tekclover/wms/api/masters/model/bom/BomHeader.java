...
@Table(
		...
		uniqueConstraints = { 
				@UniqueConstraint (
						name = "unique_key_bomheader", 
						columnNames = {"LANG_ID", "C_ID", "PLANT_ID", "WH_ID", "PAR_ITM_CODE"})
				}
		)
@IdClass(BomHeaderCompositeKey.class)
public class BomHeader { 
	...
	@Id
	@Column(name = "PAR_ITM_CODE")	
	private String parentItemCode;

	@Column(name = "BOM_NO") 
	private Long bomNumber;
	
	@Column(name = "PAR_ITM_QTY") 
