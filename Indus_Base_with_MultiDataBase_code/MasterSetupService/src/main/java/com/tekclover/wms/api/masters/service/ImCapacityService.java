...
public class ImCapacityService {
     ...
     * @return
     */
    public ImCapacity updateImCapacity(String companyCodeId, String plantId, String warehouseId, String languageId,
                                       String itemCode, UpdateImCapacity updateImCapacity, String loginUserID) {
        try {
     ...
     * @param itemCode
     */
    public void deleteImCapacity(String companyCodeId, String languageId, String plantId,
