...
//        log.info("dock : " + dbDock);
    ...
    @PatchMapping("/{dockId}")
    public ResponseEntity<?> patchDock(@PathVariable String dockId, @RequestParam String companyCodeId, @RequestParam String languageId,
                                       @RequestParam String plantId, @RequestParam String dockType, @RequestParam String warehouseId,
    ...
    public ResponseEntity<?> deleteDock(@PathVariable String dockId, @RequestParam String companyCodeId, @RequestParam String languageId,
                                        @RequestParam String plantId, @RequestParam String dockType, @RequestParam String warehouseId,
    ...
    public ResponseEntity<?> findDock(@Valid @RequestBody SearchDock searchDock) {
