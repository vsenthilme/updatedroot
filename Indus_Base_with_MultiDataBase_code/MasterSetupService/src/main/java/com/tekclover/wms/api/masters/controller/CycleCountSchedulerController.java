...
@Slf4j
@Validated
@Api(tags = {"CycleCountScheduler"}, value = "CycleCountScheduler  Operations related to CycleCountSchedulerController")
// label for swagger
...
public class CycleCountSchedulerController {
    ...
    @ApiOperation(response = CycleCountScheduler.class, value = "Get all CycleCountScheduler details")
    // label for swagger
    @GetMapping("")
    ...
    public ResponseEntity<?> patchCycleCountScheduler(@PathVariable Long cycleCountTypeId, @RequestParam String companyCodeId, @RequestParam String languageId,
                                                      @RequestParam String plantId, @RequestParam Long levelId, @RequestParam String warehouseId, @RequestParam String schedulerNumber,
                                                      @Valid @RequestBody UpdateCycleCountScheduler updateCycleCountScheduler, @RequestParam String loginUserID) {
        CycleCountScheduler createdCycleCountScheduler =
                cycleCountSchedulerService.updateCycleCountScheduler(companyCodeId, languageId, plantId, warehouseId, levelId, cycleCountTypeId, schedulerNumber, updateCycleCountScheduler, loginUserID);
        return new ResponseEntity<>(createdCycleCountScheduler, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> deleteCycleCountScheduler(@PathVariable Long cycleCountTypeId, @RequestParam String companyCodeId, @RequestParam String languageId,
                                                       @RequestParam String plantId, @RequestParam String schedulerNumber, @RequestParam Long levelId,
    ...
    @PostMapping("/find")
    public ResponseEntity<?> findCycleCountScheduler(@Valid @RequestBody SearchCycleCountScheduler searchCycleCountScheduler) {
