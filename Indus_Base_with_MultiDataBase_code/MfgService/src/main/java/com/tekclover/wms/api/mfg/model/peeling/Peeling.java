...
@IdClass(PeelingCompositeKey.class)
public class Peeling {
    ...
    @Column(name = "PEEL_START_TIME")
    private Date peelingStartTime;

    @Column(name = "PEEL_END_TIME")
    private Date peelingEndTime;

    @Column(name = "WSH_START_TIME")
    private Date washingStartTime;

    @Column(name = "WSH_END_TIME")
    private Date washingEndTime;
    ...
    @Column(name = "PST_BOIL_WGT", columnDefinition = "nvarchar(50)")
    private String postBoilingWeight;

    @Column(name = "BRX_BOIL_DAL", columnDefinition = "nvarchar(50)")
