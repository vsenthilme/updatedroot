...
public class FgPacking {
    ...
    @Column(name = "NO_PKT_BX", columnDefinition = "nvarchar(50)")
    private String noOfPacketsInBox;

    @Column(name = "NT_PS_THR_MTL_DTR", columnDefinition = "nvarchar(50)")
    private String notPassingThroughMetalDetector;

    @Column(name = "PKG_START_TIME")
    private Date packingStartTime;

    @Column(name = "PKG_END_TIME")
    private Date packingEndTime;

    @Column(name = "STG", columnDefinition = "nvarchar(100)")
