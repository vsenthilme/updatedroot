...
public class PackingQc {
    ...
    @Column(name = "TSS", columnDefinition = "nvarchar(50)")
    private String tss;

    @Column(name = "SUG_SRP_TSS", columnDefinition = "nvarchar(50)")
    private String sugarSyrupTss;
    ...
    @Column(name = "PH", columnDefinition = "nvarchar(50)")
    private String pH;

    @Column(name = "MOISTURE", columnDefinition = "nvarchar(50)")
    private String moisture;

    @Column(name = "OBSERVATION", columnDefinition = "nvarchar(50)")
