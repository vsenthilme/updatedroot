 ...
 */
@Table(
        name = "tblbillingmodeid",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "unique_key_billingmodeid",
                        columnNames = {"LANG_ID", "C_ID", "PLANT_ID", "WH_ID","BILL_MODE_ID"})
        }
)
@IdClass(BillingModeIdCompositeKey.class)
public class BillingModeId {
    @Id
    ...
    @Column(name="BILL_MODE_TEXT",columnDefinition = "nvarchar(200)")
