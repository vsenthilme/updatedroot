...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/imbasicdata1");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/storagebin");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/containerReceipt");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/preinboundHeader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/stagingheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/grheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/putawayheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/inboundHeader");
            HttpEntity<?> entity = new HttpEntity<>(searchInboundHeaderV2, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/preoutboundheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/ordermanagementline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/pickupheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/qualityheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/outboundheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/outboundreversal");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/pickupline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/inventorymovement");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/inventory");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/inventory/new");
            HttpEntity<?> entity = new HttpEntity<>(findInventoryV2, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/putawayline");
            HttpEntity<?> entity = new HttpEntity<>(findInventoryV2, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/putawayline/new");
            HttpEntity<?> entity = new HttpEntity<>(findInventoryV2, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/periodicheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/inhousetransferline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/perpetualheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/inboundline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/inhousetransferheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/stockreport");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/periodicline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/perpetualline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/preoutboundline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/stagingLine");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/grline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wmsIndus/spark/qualityline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/wmsIndus/spark/imbasicdata1v3");
            HttpEntity<?> entity = new HttpEntity<>(searchImBasicData1, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/wmsIndus/spark/imbasicdata1v5");
            HttpEntity<?> entity = new HttpEntity<>(searchImBasicData1, headers);
            ResponseEntity<ImBasicData1V3[]> result = getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, ImBasicData1V3[].class);
            log.info("result: " + result.getStatusCode());
            return result.getBody();
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/wmsIndus/spark/businessPartner");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/wmsIndus/spark/inboundLineV3");
            HttpEntity<?> entity = new HttpEntity<>(findInboundLineV2, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/wmsIndus/spark/outboundHeaderTest");
...
//        headers.add("Authorization", "Bearer " + authToken);
    ...
    public InboundLineV4[] findInboundLinev4(FindInboundLineV2 findInboundLineV2) {
        try {
            ...
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "almailem/spark/inboundLine/new");
            HttpEntity<?> entity = new HttpEntity<>(findInboundLineV2, headers);
