...
//    	log.info("PreInboundLine : " + preinboundline);
    ...
    @PostMapping("")
    public ResponseEntity<?> postPreInboundLine(@Valid @RequestBody AddPreInboundLine newPreInboundLine,
    ...
    public ResponseEntity<?> postPreInboundLineBOM(@RequestParam String preInboundNo, @RequestParam String warehouseId,
                                                   ...
                                                   @RequestParam Long lineNo, @RequestParam String loginUserID) throws Exception {
...
//    	log.info("PreInboundLine : " + preinboundline);
    ...
    @PostMapping("/v2")
    public ResponseEntity<?> postPreInboundLineV2(@Valid @RequestBody PreInboundLineEntityV2 newPreInboundLine,
                                                  @RequestParam String loginUserID) throws Exception {
    ...
    public ResponseEntity<?> deletePreInboundLineV2(@PathVariable String preInboundNo, @RequestParam String warehouseId, @RequestParam String companyCode,
                                                    ...
                                                    @RequestParam Long lineNo, @RequestParam String itemCode, @RequestParam String loginUserID) throws Exception {
    ...
    public List<PreInboundLineOutputV2> findPreInboundLineV2(@RequestBody SearchPreInboundLineV2 searchPreInboundLine) throws Exception {
