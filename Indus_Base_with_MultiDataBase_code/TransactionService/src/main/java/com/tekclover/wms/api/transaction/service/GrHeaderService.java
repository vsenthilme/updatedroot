...
//    }
    ...
    public void sendNotification() throws FirebaseMessagingException {
        ...
        List<IKeyValuePair> notification =
                grHeaderV2Repository.findByStatusIdAndNotificationStatusAndDeletionIndicatorDistinctRefDocNo();

        if (notification != null) {
            for (IKeyValuePair qualityHeader : notification) {

                List<String> deviceToken = grHeaderV2Repository.getDeviceToken();
                ...
                if (deviceToken != null && !deviceToken.isEmpty()) {
                    ...
                    if (response.equals("OK")) {
                        grHeaderV2Repository.updateNotificationStatus(qualityHeader.getRefDocNumber(), qualityHeader.getWarehouseId());
