...
public class OrderController {
    ...
    @ApiOperation(response = InboundOrderV2.class, value = "Find InboundOrderV2 details") // label for swagger
    ...
    @ApiOperation(response = InboundOrderLinesV2.class, value = "Find InboundOrderLinesV2 details") // label for swagger
    ...
    @ApiOperation(response = OutboundOrderV2.class, value = "Find OutboundOrderV2 details") // label for swagger
    ...
    @ApiOperation(response = OutboundOrderLineV2.class, value = "Find OutboundOrderLineV2 details") // label for swagger
