...
//==================================================Inbound V2===========================================================================
    ...
    private InboundOrderV2 saveASNV2(ASNV2 asnv2) {
        try {
            ...
            apiHeader.setLanguageId(asnV2Header.getLanguageId() != null ? asnV2Header.getLanguageId() : "EN");
            ...
            if (asnV2Header.getInboundOrderTypeId() != null) {
                if (asnV2Header.getInboundOrderTypeId().equals(IB_PO_ORD_TYP_ID)) {                //Production Order tested for a client
                    apiHeader.setInboundOrderTypeId(IB_PO_ORD_TYP_ID);
                } else if (asnV2Header.getInboundOrderTypeId().equals(IB_QH_ORD_TYP_ID)) {        //Indus
                    apiHeader.setInboundOrderTypeId(IB_QH_ORD_TYP_ID);
                } else if (asnV2Header.getInboundOrderTypeId().equals(IB_FG_ORD_TYP_ID)) {        //Indus
                    apiHeader.setInboundOrderTypeId(IB_FG_ORD_TYP_ID);
                } else if (asnV2Header.getInboundOrderTypeId().equals(IB_SFG_ORD_TYP_ID)) {        //Indus
                    apiHeader.setInboundOrderTypeId(IB_SFG_ORD_TYP_ID);
                } else {
                    apiHeader.setInboundOrderTypeId(1L);
                }
            } else {
...
//				apiLine.setInboundOrderHeaderId(apiHeader.getInboundOrderHeaderId());
                ...
                if (asnV2Header.getInboundOrderTypeId() != null) {
                    if (asnV2Header.getInboundOrderTypeId().equals(IB_PO_ORD_TYP_ID)) {                //Production Order tested for a client
                        apiLine.setInboundOrderTypeId(IB_PO_ORD_TYP_ID);
                    } else if (asnV2Header.getInboundOrderTypeId().equals(IB_QH_ORD_TYP_ID)) {        //Indus
                        apiLine.setInboundOrderTypeId(IB_QH_ORD_TYP_ID);
                    } else if (asnV2Header.getInboundOrderTypeId().equals(IB_FG_ORD_TYP_ID)) {        //Indus
                        apiLine.setInboundOrderTypeId(IB_FG_ORD_TYP_ID);
                    } else if (asnV2Header.getInboundOrderTypeId().equals(IB_SFG_ORD_TYP_ID)) {        //Indus
                        apiLine.setInboundOrderTypeId(IB_SFG_ORD_TYP_ID);
                    } else {
            ...
            setDataSourceContextHolder(apiHeader.getCompanyCode(), apiHeader.getWarehouseID());
...
//				apiLine.setManufacturerCode(soReturnLineV2.getManufacturerCode());
                if (soReturnLineV2.getManufacturerCode() != null) {
                    apiLine.setManufacturerCode(soReturnLineV2.getManufacturerCode());
                } else {
                    if (apiHeader.getCompanyCode().equalsIgnoreCase(COMPANY_CODE)) {
                        apiLine.setManufacturerCode(getMfrName(COMPANY_CODE));
                ...
                if (soReturnLineV2.getManufacturerName() != null) {
            ...
            if (salesOrderHeader.getWarehouseId() != null) {
                ...
                Optional<Warehouse> warehouse =
                        warehouseRepository.findByCompanyCodeIdAndPlantIdAndLanguageIdAndDeletionIndicator(
                                ...
                                salesOrderHeader.getLanguageId() != null ? salesOrderHeader.getLanguageId() : "EN",
                                0L);
                // Warehouse ID Validation
                validateWarehouseId(warehouse.get().getWarehouseId());
                apiHeader.setWarehouseID(warehouse.get().getWarehouseId());
...
//			}
            ...
            apiHeader.setLanguageId(salesOrderHeader.getLanguageId() != null ? salesOrderHeader.getLanguageId() : "EN");
            ...
            if (salesOrderHeader.getOrderType() != null) {
                if (salesOrderHeader.getOrderType().equalsIgnoreCase(OB_PL_ORD_TYP)) {
                    apiHeader.setOutboundOrderTypeID(OB_PL_ORD_TYP_ID);
                } else if (salesOrderHeader.getOrderType().equalsIgnoreCase(OB_IPL_ORD_TYP_SFG)) {                //Indus
                    apiHeader.setOutboundOrderTypeID(OB_IPL_ORD_TYP_ID_SFG);
                } else if (salesOrderHeader.getOrderType().equalsIgnoreCase(OB_IPL_ORD_TYP_FG)) {                //Indus
                    apiHeader.setOutboundOrderTypeID(OB_IPL_ORD_TYP_ID_FG);
                } else {
                    apiHeader.setOutboundOrderTypeID(OB_PL_ORD_TYP_ID);
                }
            } else {
...
//			apiHeader.setOutboundOrderHeaderId(System.currentTimeMillis());
            ...
            for (SalesOrderLineV2 soLine : salesOrderLines) {
                ...
                if (soLine.getOrderType() != null) {
                    if (soLine.getOrderType().equalsIgnoreCase(OB_PL_ORD_TYP)) {
                        apiLine.setOutboundOrderTypeID(OB_PL_ORD_TYP_ID);
                    } else if (soLine.getOrderType().equalsIgnoreCase(OB_IPL_ORD_TYP_SFG)) {                //Indus
                        apiLine.setOutboundOrderTypeID(OB_IPL_ORD_TYP_ID_SFG);
                    } else if (soLine.getOrderType().equalsIgnoreCase(OB_IPL_ORD_TYP_FG)) {                //Indus
                        apiLine.setOutboundOrderTypeID(OB_IPL_ORD_TYP_ID_FG);
                    } else {
                        apiLine.setOutboundOrderTypeID(OB_PL_ORD_TYP_ID);
                    }
                } else {
