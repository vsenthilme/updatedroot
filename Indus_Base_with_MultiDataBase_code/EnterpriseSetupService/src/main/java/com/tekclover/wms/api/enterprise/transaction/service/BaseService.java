...
//import com.tekclover.wms.api.enterprise.transaction.model.dto.WarehouseId;
...
public class BaseService {
     ...
     * @return
     */
    protected String getTransactionAuthToken() {
     ...
     * @return
     */
//    protected WarehouseId getWarehouse(String warehouseId, String companyCodeId, String plantId, String languageId) {
//        AuthToken authTokenForIDMasterService = authTokenService.getIDMasterServiceAuthToken();
...
//        return transactionService.getStockTypeDescription(companyCodeId, plantId, languageId, warehouseId, stockTypeId, getTransactionAuthToken());
//    }
...
//    }
     ...
     * @return
     */
    public KeyValuePair getDescription(String companyCodeId, String plantId, String languageId, String warehouseId, String authToken) {
        return transactionService.getDescription(companyCodeId, plantId, languageId, warehouseId, authToken);
    }
