...
public class MastersService {
     ...
     * @return
     */
    public ImBasicData1V2 getImBasicData1ByItemCodeV2(ImBasicData imBasicData, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "RestTemplate");
            ...
            ResponseEntity<ImBasicData1V2> result =
                    restTemplate.exchange(builder.toUriString(), HttpMethod.POST, entity, ImBasicData1V2.class);
            return result.getBody();
        } catch (Exception e) {
            return null;
        }
