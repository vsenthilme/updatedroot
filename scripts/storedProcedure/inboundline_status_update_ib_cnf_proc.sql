...
CREATE OR ALTER PROCEDURE inboundline_status_update_ib_cnf_proc 
...
BEGIN
	...
	IBL.UTD_BY = @updatedBy, IBL.UTD_ON = @updatedOn, IBL.IB_CNF_ON = @updatedOn 
	...
	IBL.MFR_NAME = X.MFR_NAME AND IBL.IB_LINE_NO = X.IB_LINE_NO AND IBL.IS_DELETED = 0 AND IBL.REF_FIELD_2 = 'TRUE'
