...
CREATE OR ALTER PROCEDURE paheader_status_update_ib_cnf_proc  
...
BEGIN
	...
	FROM tblputawayheader IBL INNER JOIN
	...
	IBL.REF_DOC_NO = X.REF_DOC_NO AND IBL.PRE_IB_NO = X.PRE_IB_NO AND IBL.ref_field_5 = X.ITM_CODE AND 
	IBL.MFR_NAME = X.MFR_NAME AND IBL.REF_FIELD_9 = X.IB_LINE_NO AND IBL.IS_DELETED = 0
