package com.tekclover.wms.api.mfg.model.gingerpaste;
...
public class GingerPaste {
    ...
    @Column(name = "PREP_START_TIME")
    private Date pastePreparationStart;

    @Column(name = "PREP_END_TIME")
