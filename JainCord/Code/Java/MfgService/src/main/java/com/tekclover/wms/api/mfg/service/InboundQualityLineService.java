...
import com.tekclover.wms.api.mfg.repository.InboundQualityLineRepository;
import com.tekclover.wms.api.mfg.repository.specification.InboundQualityLineSpecification;
...
//                    }
                    ...
                    if (dbInboundQualityLine.getCompanyCodeId() != null && dbInboundQualityLine.getPlantId() != null &&
                        ...
                        if (description != null) {
                            dbInboundQualityLine.setCompanyDescription(description.getCompanyDescription());
                            dbInboundQualityLine.setPlantDescription(description.getPlantDescription());
                            dbInboundQualityLine.setWarehouseDescription(description.getWarehouseDescription());
                        }
                    }
    ...
    public void createPutAwayHeader(InboundQualityLine inboundQualityLine, String loginUserID) {
        try {
            ...
            transactionService.createPutAwayHeader(dbFetchImpl);
        } catch (Exception e) {
            e.printStackTrace();
            throw new BadRequestException("Exception : " + e);
        }
