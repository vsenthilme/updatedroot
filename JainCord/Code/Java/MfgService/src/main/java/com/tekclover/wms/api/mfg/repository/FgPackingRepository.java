...
@Repository
@Transactional
public interface FgPackingRepository extends JpaRepository<FgPacking, Long>,
        JpaSpecificationExecutor<FgPacking>, StreamableJpaSpecificationRepository<FgPacking>{

    Optional<FgPacking> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndProductionOrderNoAndProductionOrderLineNoAndReceipeIdAndOperationNumberAndItemCodeAndDeletionIndicator(
    ...
    List<FgPacking> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndProductionOrderNoAndDeletionIndicator(
