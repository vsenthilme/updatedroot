...
//				log.info("Result containerReceipt---getContainerReceivedDate() :" + containerReceipt.getContainerReceivedDate());
    ...
    // PATCH
    public GrLineV2[] updateStagingLineForMobileApp(List<StagingLineEntityV2> modifiedStagingLine, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "ClassicWMS-Almailem RestTemplate");
            ...
            UriComponentsBuilder builder = UriComponentsBuilder
                    .fromHttpUrl(getTransactionServiceApiUrl() + "grline/updateStagingLine/MobileApp")
                    .queryParam("loginUserID", loginUserID);

            ResponseEntity<GrLineV2[]> result = restTemplate.exchange(builder.toUriString(), HttpMethod.PATCH,
                    entity, GrLineV2[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    // PATCH
    public StagingLineEntityV2[] updateStagingLine(StagingLineEntityV2[] stagingLineEntityV2s,
                                                   String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            ...
            RestTemplate restTemplate = getRestTemplate();
            restTemplate.setRequestFactory(new HttpComponentsClientHttpRequestFactory(client));
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "stagingline/update/v2")
                    .queryParam("loginUserID", loginUserID);
    ...
    // PATCH
    public GrLineV2 updateGrLine(String companyCode, String plantId, String languageId,
                                 String warehouseId, String refDocNumber,
                                 String palletId, GrLineV2 updateGrLine, String loginUserID,
                                 String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "JainCard RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);

            HttpEntity<?> entity = new HttpEntity<>(updateGrLine, headers);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder
                    .fromHttpUrl(getTransactionServiceApiUrl() + "grline/update")
                    .queryParam("companyCode", companyCode)
                    .queryParam("plantId", plantId)
                    .queryParam("languageId", languageId)
                    .queryParam("warehouseId", warehouseId)
                    .queryParam("palletId", palletId)
                    .queryParam("refDocNumber", refDocNumber)
                    .queryParam("loginUserID", loginUserID);
            ResponseEntity<GrLineV2> result = restTemplate.exchange(builder.toUriString(), HttpMethod.PATCH, entity,
                    GrLineV2.class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
...
//            return putAwayLineList.toArray(new PutAwayLineV2[putAwayLineList.size()]);
    ...
    // POST - Purchase Order upload
//    public WarehouseApiResponse[] postPurchaseOrder(List<PurchaseOrder> purchaseOrders, String authToken) {
//        HttpHeaders headers = new HttpHeaders();
//        headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
//        headers.add("User-Agent", "RestTemplate");
//        headers.add("Authorization", "Bearer " + authToken);
//        UriComponentsBuilder builder =
//                UriComponentsBuilder.fromHttpUrl(getTransactionServiceApiUrl() + "warehouse/inbound/purchase/upload");
//        HttpEntity<?> entity = new HttpEntity<>(purchaseOrders, headers);
//        ResponseEntity<WarehouseApiResponse[]> result =
//                getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, WarehouseApiResponse[].class);
//        return result.getBody();
//    }
...
//            return obList.toArray(new OrderManagementLineV2[obList.size()]);
    ...
    //PatchOrderManagementLine
    public void udpateOrderManagementLineV5(List<OrderManagementLineV2> orderManagementLineV2, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "ClassicWMS-Almailem RestTemplate");
            ...
            UriComponentsBuilder builder = UriComponentsBuilder
                    .fromHttpUrl(getTransactionServiceApiUrl() + "ordermanagementline/v5/patch")
                    .queryParam("loginUserID", loginUserID);
