...
//			return obList.toArray(new ImBasicData1[obList.size()]);
    ...
    // POST - findImBasicData1 - IMF
    public ImBasicData1V2[] findImfImBasicData1(SearchImBasicData1 searchImBasicData1, String authToken) throws ParseException {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getMastersServiceUrl() + "imbasicdata1/imf/findImBasicData1");
            HttpEntity<?> entity = new HttpEntity<>(searchImBasicData1, headers);
            ResponseEntity<ImBasicData1V2[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, ImBasicData1V2[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
...
//			return obList.toArray(new StorageBin[obList.size()]);
    ...
    //-----------------------------------Notify------------------------------------------------
    public Notify[] getAllNotifications(String userId, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            ...
            HttpEntity<?> entity = new HttpEntity<>(headers);
            ResponseEntity<Notify[]> result = getRestTemplate().exchange(builder.toUriString(), HttpMethod.GET, entity, Notify[].class);
...
//THREEPL
    ...
    public PriceList[] getPriceListBulk(PriceListInput priceListInput, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
            ...
            HttpEntity<?> entity = new HttpEntity<>(priceListInput, headers);
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getMastersServiceUrl() + "pricelist/get/list");
            ResponseEntity<PriceList[]> result = getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, PriceList[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
    ...
    // POST Multiple PriceLists
    public PriceList[] createPriceListBulk(List<PriceList> priceLists, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getMastersServiceUrl() + "pricelist/create/list")
                    .queryParam("loginUserID", loginUserID);
            HttpEntity<?> entity = new HttpEntity<>(priceLists, headers);
            ResponseEntity<PriceList[]> result = getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, PriceList[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
    ...
    public PriceList[] updatePriceListBulk(List<PriceList> priceLists, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getMastersServiceUrl() + "pricelist/update/list")
                    .queryParam("loginUserID", loginUserID);
            ResponseEntity<PriceList[]> result = restTemplate.exchange(builder.toUriString(), HttpMethod.PATCH, entity, PriceList[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
    ...
    public boolean deletePriceListBulk(List<PriceListInput> priceListInputs, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);
            HttpEntity<?> entity = new HttpEntity<>(priceListInputs, headers);
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getMastersServiceUrl() + "pricelist/delete/list")
                    .queryParam("loginUserID", loginUserID);
            ResponseEntity<String> result = getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, String.class);
            log.info("result : " + result);
            return true;
