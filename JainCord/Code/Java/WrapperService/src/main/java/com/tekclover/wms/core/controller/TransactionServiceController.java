...
//    }
    ...
    @PatchMapping("/stagingLine/v2")
    public ResponseEntity<?> stagingLine(@Valid @RequestBody StagingLineEntityV2[] stagingLine, @RequestParam String loginUserID, @RequestParam String authToken) {
        StagingLineEntityV2[] createdStagingLine =
                transactionService.updateStagingLine(stagingLine, loginUserID, authToken);
        return new ResponseEntity<>(createdStagingLine, HttpStatus.OK);
    }
    ...
    @ApiOperation(response = GrLineV2.class, value = "Update PalletId in GrLine ") // label for swagger
    @PatchMapping("/update/grline")
    public ResponseEntity<?> patchGrLineV2(@RequestParam String companyCode, @RequestParam String plantId, @RequestParam String languageId,
                                            @RequestParam String warehouseId, @RequestParam String refDocNumber,
                                            @RequestParam String palletId, @Valid @RequestBody GrLineV2 updateGrLine,
        ...
        GrLineV2 createdGrLine =
                transactionService.updateGrLine(companyCode, plantId, languageId, warehouseId, refDocNumber, palletId, updateGrLine, loginUserID, authToken);
        return new ResponseEntity<>(createdGrLine, HttpStatus.OK);
    }
    ...
    @ApiOperation(response = BillingTransactionReport.class, value = "Get Billing Transaction Report")
    @PostMapping("/reports/billingTransactionReport")
    public ResponseEntity<?> getBillingTransactionReport(@RequestBody FindBillingTransactionReport findBillingTransactionReport,
                                                         @RequestParam String authToken) throws java.text.ParseException {
        BillingTransactionReport[] billingTransactionReports = transactionService.getBillingTransactionReport(findBillingTransactionReport, authToken);
        return new ResponseEntity<>(billingTransactionReports, HttpStatus.OK);
    }
...
//    public ResponseEntity<?> postSalesOrderUpload(@RequestParam("file") MultipartFile file) throws Exception {
//        Map<String, String> response = fileStorageService.processSalesOrders(file);
//        return new ResponseEntity<>(response, HttpStatus.OK);
//    }
    ...
    public ResponseEntity<?> postWarehouseInboundAsnUploadV2(@RequestParam(required = false) String companyCodeId, @RequestParam(required = false) String plantId,
                                                             ...
                                                             @RequestParam(required = false) String loginUserID, @RequestParam("file") MultipartFile file) throws Exception {
        Map<String, String> response = fileStorageService.processAsnOrders(companyCodeId, plantId, languageId, warehouseId, loginUserID, file);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> postSalesOrderUpload(@RequestParam(required = false) String companyCodeId, @RequestParam(required = false) String plantId,
                                                  @RequestParam(required = false) String languageId, @RequestParam(required = false) String warehouseId,
                                                  @RequestParam(required = false) String loginUserID, @RequestParam("file") MultipartFile file) throws Exception {
        Map<String, String> response = fileStorageService.processSalesOrders(companyCodeId, plantId, languageId, warehouseId, loginUserID, file);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
...
// -------------------------------------StagingHeader-V2--------------------------------------------------------------------------------------------
    ...
    //-----------------BATCH-SERIAL-GENERATION-V2--------------------------------------------------------------------------
    @ApiOperation(response = Optional.class, value = "Generate Batch Serial Number V2") // label for swagger
    @GetMapping("/grline/batchSerialNumber/v2")
    public ResponseEntity<?> getBatchSerialNumberV2(@RequestParam String warehouseId, @RequestParam String companyCodeId, @RequestParam String plantId,
                                                    @RequestParam String languageId, @RequestParam String storageMethod, @RequestParam String authToken) {
        String batchSerialNo =
                transactionService.generateBatchSerialNumber(companyCodeId, plantId, languageId, warehouseId, storageMethod, authToken);
        log.info("batchSerialNo : " + batchSerialNo);
        return new ResponseEntity<>(batchSerialNo, HttpStatus.OK);
    }
...
//    }
    ...
    // B2b Transfer IN
    @ApiOperation(response = InterWarehouseTransferInV2.class, value = "InterWarehouse TransferIn V2")    // label for swagger
    ...
    //====================================================InhouseTransferHeader============================================
    @ApiOperation(response = InhouseTransferHeader.class, value = "Create InHouseTransferHeader V2")    // label for swagger
    ...
    @ApiOperation(response = OrderManagementLineV2.class, value = "Update OrderManagementLine") // label for swagger
    @PatchMapping("/ordermanagementline/v5/patch")
    public ResponseEntity<?> patchOrderManagementLineV5(@Valid @RequestBody List<OrderManagementLineV2> orderManagementLineV2,
                                                        @RequestParam String loginUserID, @RequestParam String authToken) throws Exception {
        transactionService.udpateOrderManagementLineV5(orderManagementLineV2, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.OK);
    }
...
//    }
    ...
    @ApiOperation(response = WarehouseApiResponse.class, value = "Create PerpetualHeader and Line V2") // label for swagger
    @PostMapping("/v2/perpetualheader")
    public ResponseEntity<?> postPerpetualHeaderV2(@Valid @RequestBody Perpetual newPerpetualHeader, @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
        WarehouseApiResponse createdPerpetualHeader = transactionService.postPerpetualHeaderV2(newPerpetualHeader, authToken);
        return new ResponseEntity<>(createdPerpetualHeader, HttpStatus.OK);
    }
...
//    }
    ...
    public ResponseEntity<?> createPeriodicHeaderV2(@Valid @RequestBody Periodic newPeriodicHeader, @RequestParam String authToken) throws Exception {
        WarehouseApiResponse createdPeriodicHeader = transactionService.postPeriodicHeaderV2(newPeriodicHeader, authToken);
        log.info("createdPeriodicHeader:" + createdPeriodicHeader);
        return new ResponseEntity<>(createdPeriodicHeader, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> postStockAdjustment(@RequestBody StockAdjustment newStockAdjustment, @RequestParam String authToken) {
        WarehouseApiResponse createdStockAdjustment = transactionService.createStockAdjustmentV2(newStockAdjustment, authToken);
    ...
    public PickingProductivityReport[] pickingProductivityReport(@RequestBody SearchPickingProductivityReport searchPickingProductivityReport,
                                                                 @RequestParam String authToken) throws Exception {
        return transactionService.pickingProductivityReport(searchPickingProductivityReport, authToken);
    }
    ...
    public BinningProductivityReport[] binningProductivityReport(@RequestBody SearchBinningProductivityReport searchBinningProductivityReport,
                                                                 @RequestParam String authToken) throws Exception {
        return transactionService.binningProductivityReport(searchBinningProductivityReport, authToken);
    }
    /*
     * --------------------------------InvoiceHeader---------------------------------
     */
    ...
    public ResponseEntity<?> getAllInvoiceHeader(@RequestParam String authToken) {
        InvoiceHeader[] invoiceHeaders = transactionService.getAllInvoiceHeader(authToken);
    ...
    public ResponseEntity<?> getInvoiceHeader(@PathVariable Long invoiceNumber, @RequestParam String partnerCode,
                                              @RequestParam String languageId, @RequestParam String companyCodeId,
                                              @RequestParam String plantId, @RequestParam String warehouseId, @RequestParam String authToken) {
        InvoiceHeader dbInvoiceHeader
                = transactionService.getInvoiceHeader(companyCodeId, plantId, languageId, warehouseId, invoiceNumber, partnerCode, authToken);

        log.info("InvoiceHeader : " + dbInvoiceHeader);
    ...
    public ResponseEntity<?> postInvoiceHeader(@Valid @RequestBody AddInvoiceHeader addInvoiceHeader,
                                               @RequestParam String loginUserID, @RequestParam String authToken)
            throws IllegalAccessException, InvocationTargetException {

        InvoiceHeader createdInvoiceHeader
                = transactionService.createInvoiceHeader(addInvoiceHeader, loginUserID, authToken);
    ...
    @RequestMapping(value = "/invoiceHeader/{invoiceNumber}", method = RequestMethod.PATCH)
    public ResponseEntity<?> patchInvoiceLine(@PathVariable String invoiceNumber, @RequestParam String languageId, @RequestParam String companyCodeId,
                                              @RequestParam String plantId, @RequestParam UpdateInvoiceHeader updateInvoiceHeader,
                                              @RequestParam String warehouseId, @RequestParam String partnerCode, @RequestParam String loginUserID, @RequestParam String authToken)
            throws IllegalAccessException, InvocationTargetException {

        InvoiceHeader dbInvoiceHeader = transactionService.updateInvoiceHeader(companyCodeId, plantId, languageId, warehouseId, invoiceNumber,
                partnerCode, loginUserID, updateInvoiceHeader, authToken);
        return new ResponseEntity<>(dbInvoiceHeader, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> deleteInvoiceLine(@PathVariable String invoiceNumber, @RequestParam String languageId, @RequestParam String companyCodeId,
                                               @RequestParam String plantId,
                                               @RequestParam String warehouseId, @RequestParam String partnerCode, @RequestParam String loginUserID,
                                               @RequestParam String authToken) {

        transactionService.deleteInvoiceHeader(companyCodeId, plantId, languageId, warehouseId, invoiceNumber, partnerCode, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
    ...
    public InvoiceHeader[] findInvoiceHeader(@RequestBody FindInvoiceHeader findInvoiceHeader,
                                             @RequestParam String authToken) throws Exception {
        return transactionService.findInvoiceHeader(findInvoiceHeader, authToken);
    }
    ...
    public ResponseEntity<?> getAllInvoiceLine(@RequestParam String authToken) {
        InvoiceLine[] invoiceLines = transactionService.getAllInvoiceLine(authToken);
        return new ResponseEntity<>(invoiceLines, HttpStatus.OK);
    }

    // GET
    @ApiOperation(response = InvoiceLine.class, value = "Get a InvoiceLine") // label for swagger
    @GetMapping("/invoiceLine/{invoiceNumber}")
    public ResponseEntity<?> getInvoiceLine(@PathVariable Long invoiceNumber, @RequestParam String companyCodeId,
                                            @RequestParam String languageId, @RequestParam String plantId, @RequestParam String partnerCode,
                                            @RequestParam String warehouseId, @RequestParam String authToken) {
        InvoiceLine[] dbInvoiceLine =
                transactionService.getInvoiceLine(companyCodeId, plantId, languageId, warehouseId, invoiceNumber, partnerCode, authToken);

        log.info("InvoiceLine : " + dbInvoiceLine);
        return new ResponseEntity<>(dbInvoiceLine, HttpStatus.OK);
    }

    // CREATE
    @ApiOperation(response = InvoiceLine.class, value = "Create InvoiceLine") // label for swagger
    @PostMapping("/invoiceLine")
    public ResponseEntity<?> postInvoiceLine(@Valid @RequestBody List<AddInvoiceLine> addInvoiceLine,
                                             @RequestParam String loginUserID, @RequestParam String authToken)
            throws IllegalAccessException, InvocationTargetException {

        InvoiceLine[] createdInvoiceLine
                = transactionService.createInvoiceLine(addInvoiceLine, loginUserID, authToken);
    ...
    @RequestMapping(value = "/invoiceLine/{invoiceNumber}", method = RequestMethod.PATCH)
    public ResponseEntity<?> patchInvoiceLine(@PathVariable Long lineNumber, @RequestParam String companyCodeId,
                                              @RequestParam String languageId, @RequestParam String plantId, @RequestParam String partnerCode,
                                              @RequestParam Long invoiceNumber, @RequestParam String warehouseId,
                                              @Valid @RequestBody UpdateInvoiceLine updateInvoiceLine, @RequestParam String loginUserID,
                                              @RequestParam String authToken)
            throws IllegalAccessException, InvocationTargetException {

        InvoiceLine dbInvoiceLine = transactionService.updateInvoiceLine(companyCodeId, plantId, languageId,
                warehouseId, invoiceNumber, partnerCode, lineNumber, loginUserID, updateInvoiceLine, authToken);
        return new ResponseEntity<>(dbInvoiceLine, HttpStatus.OK);
    }

    // DELETE
    @ApiOperation(response = InvoiceLine.class, value = "Delete InvoiceLine") // label for swagger
    @DeleteMapping("/invoiceLine/{invoiceNumber}")
    public ResponseEntity<?> deleteInvoiceLine(@PathVariable Long lineNumber, @RequestParam String companyCodeId,
                                               @RequestParam String languageId, @RequestParam String plantId, @RequestParam String partner,
                                               @RequestParam Long invoiceNumber, @RequestParam String warehouseId, @RequestParam String loginUserID,
                                               @RequestParam String authToken) {

        transactionService.deleteInvoiceLine(companyCodeId, plantId, languageId, warehouseId, invoiceNumber, partner,
                lineNumber, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }

    //FIND
    @ApiOperation(response = InvoiceLine[].class, value = "Find InvoiceLine")//label for swagger
    @PostMapping("/invoiceLine/findInvoiceLine")
    public InvoiceLine[] findInvoiceLine(@RequestBody FindInvoiceLine findInvoiceLine,
                                         @RequestParam String authToken) throws Exception {
        return transactionService.findInvoiceLine(findInvoiceLine, authToken);
    }
    ...
    @GetMapping("/proformainvoiceheader")
    public ResponseEntity<?> getAllProformaInvoiceHeader(@RequestParam String authToken) {
        ProformaInvoiceHeader[] proformaInvoiceHeaders = transactionService.getProformaInvoiceHeader(authToken);
        return new ResponseEntity<>(proformaInvoiceHeaders, HttpStatus.OK);
    }

    // Get
    @ApiOperation(response = ProformaInvoiceHeader.class, value = "Get a ProformaInvoiceHeader") // label for swagger
    @GetMapping("/proformainvoiceheader/{proformaBillNo}")
    public ResponseEntity<?> getProformaInvoiceHeader(@PathVariable Long proformaBillNo, @RequestParam String partnerCode,
                                                      @RequestParam String companyCodeId, @RequestParam String plantId,
                                                      @RequestParam String languageId, @RequestParam String warehouseId, @RequestParam String authToken) throws Exception {
        ProformaInvoiceHeader proformaInvoiceHeaders =
                transactionService.getProformaInvoiceHeader(companyCodeId, plantId, languageId, warehouseId, proformaBillNo, partnerCode, authToken);
        log.info("ProformaInvoiceHeader : " + proformaInvoiceHeaders);
        return new ResponseEntity<>(proformaInvoiceHeaders, HttpStatus.OK);
    }

    //Create
    @ApiOperation(response = ProformaInvoiceHeader.class, value = "Create ProformaInvoiceHeader ") // label for swagger
    @PostMapping("/proformainvoiceheader")
    public ResponseEntity<?> postProformaInvoiceHeader(@Valid @RequestBody AddProformaInvoiceHeader addProformaInvoiceHeader,
                                                       @RequestParam String loginUserID, @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
        ProformaInvoiceHeader createdProformaInvoiceHeader = transactionService.createProformainvoiceheader(addProformaInvoiceHeader, loginUserID, authToken);
        log.info("createdProformaInvoiceHeader:" + createdProformaInvoiceHeader);
    ...
    @PatchMapping("/proformainvoiceheader/{proformaBillNo}")
    public ResponseEntity<?> patchProformaInvoiceHeader(@PathVariable Long proformaBillNo, @RequestParam String partnerCode,
                                                        @RequestParam String companyCodeId, @RequestParam String plantId,
                                                        @RequestParam String languageId, @RequestParam String warehouseId,
        ...
        ProformaInvoiceHeader createdProformaInvoiceHeader =
                transactionService.updateProformaInvoiceHeader(companyCodeId, plantId, languageId, warehouseId, proformaBillNo, partnerCode,
                        loginUserID, updateProformaInvoiceHeader, authToken);
        return new ResponseEntity<>(createdProformaInvoiceHeader, HttpStatus.OK);
    }

    //Delete
    @ApiOperation(response = ProformaInvoiceHeader.class, value = "Delete ProformaInvoiceHeader ") // label for swagger
    @DeleteMapping("/proformainvoiceheader/{proformaBillNo}")
    public ResponseEntity<?> deleteProformaInvoiceHeader(@PathVariable Long proformaBillNo, @RequestParam String partnerCode,
                                                         @RequestParam String companyCodeId, @RequestParam String plantId,
                                                         @RequestParam String languageId, @RequestParam String warehouseId, @RequestParam String loginUserID,
                                                         @RequestParam String authToken) {
        transactionService.deleteProformaInvoiceHeader(companyCodeId, plantId, languageId, warehouseId, proformaBillNo, partnerCode,
                loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }

    //Find
    @ApiOperation(response = ProformaInvoiceHeader[].class, value = "Find ProformaInvoiceHeader") // label for swagger
    @PostMapping("/proformainvoiceheader/find")
    public ResponseEntity<?> findProformaInvoiceHeader(@RequestBody FindProformaInvoiceHeader findProformaInvoiceHeader, @RequestParam String authToken) throws Exception {
        ProformaInvoiceHeader[] proformaInvoiceHeaders = transactionService.findProformaInvoiceHeader(findProformaInvoiceHeader, authToken);
        return new ResponseEntity<>(proformaInvoiceHeaders, HttpStatus.OK);
    }
    ...
    @GetMapping("/proformainvoiceline")
    public ResponseEntity<?> getAllProformaInvoiceLine(@RequestParam String authToken) {
        ProformaInvoiceLine[] proformaInvoiceLines = transactionService.getProformaInvoiceLine(authToken);
        return new ResponseEntity<>(proformaInvoiceLines, HttpStatus.OK);
    }

    // Get
    @ApiOperation(response = ProformaInvoiceLine.class, value = "Get a ProformaInvoiceLine") // label for swagger
    @GetMapping("/proformainvoiceline/{proformaBillNo}")
    public ResponseEntity<?> getProformaInvoiceLine(@PathVariable Long proformaBillNo, @RequestParam String partnerCode,
        ...
        ProformaInvoiceLine[] proformaInvoiceLine =
                transactionService.getProformaInvoiceLine(companyCodeId, plantId, languageId, warehouseId, proformaBillNo, partnerCode, authToken);
    ...
    @PostMapping("/proformainvoiceline")
    public ResponseEntity<?> postProformaInvoiceLine(@Valid @RequestBody List<AddProformaInvoiceLine> addProformaInvoiceLine,
                                                     @RequestParam String loginUserID, @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException {
        ProformaInvoiceLine[] createdProformaInvoiceLine = transactionService.createProformaInvoiceLine(addProformaInvoiceLine, loginUserID, authToken);
    ...
    @PatchMapping("/proformainvoiceline/{proformaBillNo}")
    public ResponseEntity<?> patchProformaInvoiceLine(@PathVariable Long proformaBillNo, @RequestParam String partnerCode,
                                                      @RequestParam String companyCodeId, @RequestParam String plantId,
                                                      @RequestParam String languageId, @RequestParam String warehouseId, @RequestParam Long lineNumber,
        ...
        ProformaInvoiceLine createdProformaInvoiceLine =
                transactionService.updateProformaInvoiceLine(companyCodeId, plantId, languageId, warehouseId, proformaBillNo, partnerCode, lineNumber,
                        loginUserID, updateProformaInvoiceLine, authToken);
        return new ResponseEntity<>(createdProformaInvoiceLine, HttpStatus.OK);
    }

    //Delete
    @ApiOperation(response = ProformaInvoiceLine.class, value = "Delete ProformaInvoiceLine ") // label for swagger
    @DeleteMapping("/proformainvoiceline/{proformaBillNo}")
    public ResponseEntity<?> deleteProformaInvoiceLine(@PathVariable Long proformaBillNo, @RequestParam String partnerCode,
                                                       @RequestParam String companyCodeId, @RequestParam String plantId,
                                                       @RequestParam String languageId, @RequestParam String warehouseId,
                                                       @RequestParam Long lineNumber, @RequestParam String loginUserID,
                                                       @RequestParam String authToken) {
        transactionService.deleteProformaInvoiceLine(companyCodeId, plantId, languageId, warehouseId, proformaBillNo, partnerCode,
                lineNumber, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
    ...
    @PostMapping("/proformainvoiceline/find")
    public ResponseEntity<?> findProformaInvoiceLine(@RequestBody FindProformaInvoiceLine findProformaInvoiceLine, @RequestParam String authToken) throws Exception {
        ProformaInvoiceLine[] proformaInvoiceLine = transactionService.findProformaInvoiceLine(findProformaInvoiceLine, authToken);
        return new ResponseEntity<>(proformaInvoiceLine, HttpStatus.OK);
    }
    //============================================================================================================================
    //Find
    ...
    public CharData[] pickingReportV2(@RequestBody FindReport findReport, @RequestParam String authToken) throws Exception {
        return transactionService.pickingReport(findReport, authToken);
    }

    //PutAway - Report
    @ApiOperation(response = CharData.class, value = "PutAway Report") // label for swagger
    @PostMapping("/reports/putaway/v2")
    public CharData[] putAwayReportV2(@RequestBody FindReport findReport, @RequestParam String authToken) throws Exception {
        return transactionService.putAwayReport(findReport, authToken);
    }

    // File Upload - Inbound Orders - V4 - Dynamic
    @ApiOperation(response = ASNV2.class, value = "Inbound Upload") // label for swagger
    @PostMapping("/warehouse/inbound/upload/v4")
    public ResponseEntity<?> postWarehouseInboundUploadV4(@RequestParam String companyCodeId, @RequestParam String plantId,
                                                          @RequestParam String languageId, @RequestParam String warehouseId,
                                                          @RequestParam String loginUserID, @RequestParam Long inboundOrderTypeId,
                                                          @RequestParam("file") MultipartFile file) throws Exception {
        Map<String, String> response = fileStorageService.processInboundOrdersV4(companyCodeId, plantId, languageId, warehouseId, inboundOrderTypeId, loginUserID, file);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }


    // Inbound_order_upload
    // File Upload - Orders
//    @ApiOperation(response = PurchaseOrder.class, value = "PurchaseOrder_Upload ") // label for swagger
//    @PostMapping("/warehouse/inbound/purchase/upload")
//    public ResponseEntity<?> postPurchaseOrder(@RequestParam(required = false) String companyCodeId, @RequestParam(required = false) String plantId,
//                                                             @RequestParam(required = false) String languageId, @RequestParam(required = false) String warehouseId,
//                                                             @RequestParam(required = false) String loginUserID, @RequestParam("file") MultipartFile file) throws Exception {
//        Map<String, String> response = fileStorageService.processPurchaseOrder(companyCodeId, plantId, languageId, warehouseId, loginUserID, file);
//        return new ResponseEntity<>(response, HttpStatus.OK);
//    }
    ...
    public ResponseEntity<?> postWarehouseOutboundUploadV4(@RequestParam String companyCodeId, @RequestParam String plantId,
                                                           ...
                                                           @RequestParam("file") MultipartFile file) throws Exception {
        Map<String, String> response = fileStorageService.processOutboundOrdersV4(companyCodeId, plantId, languageId, warehouseId, outboundOrderTypeId, loginUserID, file);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }

    @ApiOperation(response = StagingLineEntityV2.class, value = "Update StagingLine for MobileApp")
    @PatchMapping("updateStagingLine/mobileApp")
    public ResponseEntity<?> updateStagingLine(@Valid @RequestBody List<StagingLineEntityV2> stagingLineEntityV2List,
                                               @RequestParam String loginUserID, @RequestParam String authToken) {
        GrLineV2[] grLineV2List = transactionService.updateStagingLineForMobileApp(stagingLineEntityV2List, loginUserID, authToken);
        return new ResponseEntity<>(grLineV2List, HttpStatus.OK);
    }

    //Jain_Cord
    @ApiOperation(response = PeriodicLineV2.class, value = "ExecuteStockCount") // label for swagger
    @PostMapping("/periodicline/v4/executeStockCount")
    public ResponseEntity<?> executeStockCount(@RequestParam String companyCodeId, @RequestParam String plantId,
                                               ...
                                               @RequestParam String authToken) throws Exception {
        PeriodicLineV2[] stockCountLines = transactionService.executeStockCount(companyCodeId, plantId, languageId, warehouseId, executeStockCountInput, authToken);
        return new ResponseEntity<>(stockCountLines, HttpStatus.OK);
    }

    //Jain_Cord
    @ApiOperation(response = PeriodicHeaderEntityV2.class, value = "JainCord Post PeriodicHeader and Line V2") // label for swagger
    @PostMapping("/periodicheader/v4/create")
    public ResponseEntity<?> createPeriodicHeaderV4(@RequestParam String companyCodeId, @RequestParam String plantId,
                                                    ...
                                                    @RequestParam String loginUserID, @RequestParam String authToken) throws Exception {
        PeriodicHeaderEntityV2 createdPeriodicHeader = transactionService.postPeriodicHeaderV4(
