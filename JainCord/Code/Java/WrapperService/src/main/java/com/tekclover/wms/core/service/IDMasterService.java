...
public class IDMasterService {
    ...
    // GET - /login/validate/v2 - return with role access and moduleId
    public Login validateUserId(UserLoginInput userLoginInput, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "Classic WMS's RestTemplate");
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getIDMasterServiceApiUrl() + "login/v2");

            HttpEntity<?> entity = new HttpEntity<>(userLoginInput, headers);
            ResponseEntity<Login> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, Login.class);
            return result.getBody();
        } catch (Exception e) {
            throw new BadRequestException(e.getLocalizedMessage());
        }
...
//			log.info("result : " + result.getStatusCode());
    ...
    public NotificationMessage[] getAllNotificationMessages(String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("ClientGeneral-Agent", "MNRClara RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getIDMasterServiceApiUrl() + "notificationMessage");
            HttpEntity<?> entity = new HttpEntity<>(headers);
            ResponseEntity<NotificationMessage[]> result = getRestTemplate().exchange(builder.toUriString(), HttpMethod.GET, entity, NotificationMessage[].class);
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
            throw e;
    ...
    public NotificationMessage[] findNotificationMessage(FindNotificationMessage findNotificationMessage, String authToken) {
        try {
            ...
            UriComponentsBuilder builder = UriComponentsBuilder
                    .fromHttpUrl(getIDMasterServiceApiUrl() + "notificationMessage/find");
    ...
    public NotificationMessage[] updateNotificationMessage(List<NotificationMessage> updateNotifications, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            ...
            RestTemplate restTemplate = getRestTemplate();
            restTemplate.setRequestFactory(new HttpComponentsClientHttpRequestFactory(client));
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getIDMasterServiceApiUrl() + "notificationMessage/update")
                    .queryParam("loginUserID", loginUserID);
    ...
    public NotificationMessage[] deleteNotificationMessage(NotificationMsgDeleteInput deleteInput, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("ClientNote-Agent", "MNRClara RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getIDMasterServiceApiUrl() + "notificationMessage/delete")
                    .queryParam("loginUserID", loginUserID);
            HttpEntity<?> entity = new HttpEntity<>(deleteInput, headers);
            ResponseEntity<NotificationMessage[]> result = getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST,
                    entity, NotificationMessage[].class);
            log.info("result : {}", result.getBody());
            return result.getBody();
    ...
    public NotificationMessage[] deleteNotificationMessageList(List<NotificationMsgDeleteInput> deleteInputList, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("ClientNote-Agent", "MNRClara RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getIDMasterServiceApiUrl() + "notificationMessage/delete/list")
                    .queryParam("loginUserID", loginUserID);
    ...
    // UPDATE
    public Boolean updateFirebaseNotificationMessage(String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "MNRClara's RestTemplate");
    ...
    // UPDATE
    public Boolean updateFirebaseNotificationAsReadAll (String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "MNRClara's RestTemplate");
            ...
            restTemplate.setRequestFactory(new HttpComponentsClientHttpRequestFactory(client));
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getIDMasterServiceApiUrl() + "/notificationMessage/mark-read-all")
                    .queryParam("loginUserID", loginUserID);
            ResponseEntity<Boolean> result = restTemplate.exchange(builder.toUriString(), HttpMethod.GET, entity, Boolean.class);
            log.info("result : " + result.getBody());
            return result.getBody();
    ...
    public Notification[] getAllNotification(String authToken) {
        try {
            ...
            headers.add("Authorization", "Bearer " + authToken);
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getIDMasterServiceApiUrl() + "firebase/notification");
            HttpEntity<?> entity = new HttpEntity<>(headers);
    ...
    public Notification getNotification(String languageId, String companyId, String notificationId, String authToken) {
        try {
            ...
            headers.add("User-Agent", "RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getIDMasterServiceApiUrl() + "firebase/notification/" + notificationId)
    ...
    // Create Notification
    public Notification createNotification(Notification addNotification, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "RestTemplate");
    ...
    // Update Notification
    public Notification updateNotification(Notification updateNotification, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "MNRClara's RestTemplate");
            ...
            RestTemplate restTemplate = getRestTemplate();
            restTemplate.setRequestFactory(new HttpComponentsClientHttpRequestFactory(client));
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getIDMasterServiceApiUrl() + "firebase/notification/update")
                    .queryParam("loginUserID", loginUserID);
    ...
    public Notification[] findNotification(FindNotification findNotification, String authToken) {
        try {
            ...
            headers.add("User-Agent", "RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getIDMasterServiceApiUrl() + "firebase/notification/find");
    ...
    public WebSocketNotification[] getAllWebSocketNotifications (String userId, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("Inquiry-Agent", "MNRClara RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getIDMasterServiceApiUrl() + "/notification-message")
                    .queryParam("userId", userId);
            HttpEntity<?> entity = new HttpEntity<>(headers);
            ResponseEntity<WebSocketNotification[]> result = getRestTemplate().exchange(builder.toUriString(), HttpMethod.GET, entity, WebSocketNotification[].class);
            log.info("result : " + result.getBody());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    // UPDATE
    public Boolean updateWebSocketNotificationAsRead (String loginUserID,Long id, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "MNRClara's RestTemplate");
            ...
            restTemplate.setRequestFactory(new HttpComponentsClientHttpRequestFactory(client));
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getIDMasterServiceApiUrl() + "/notification-message/mark-read/"+id)
                    .queryParam("loginUserID", loginUserID);
            ResponseEntity<Boolean> result = restTemplate.exchange(builder.toUriString(), HttpMethod.GET, entity, Boolean.class);
            log.info("result : " + result.getBody());
            return result.getBody();
    ...
    // UPDATE
    public Boolean updateWebSocketNotificationAsReadAll (String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "MNRClara's RestTemplate");
            ...
            restTemplate.setRequestFactory(new HttpComponentsClientHttpRequestFactory(client));
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getIDMasterServiceApiUrl() + "/notification-message/mark-read-all")
                    .queryParam("loginUserID", loginUserID);
            ResponseEntity<Boolean> result = restTemplate.exchange(builder.toUriString(), HttpMethod.GET, entity, Boolean.class);
            log.info("result : " + result.getBody());
            return result.getBody();
    ...
    // UPDATE
    public Boolean updateWebSocketNotificationMessage(List<WebSocketNotification> notification, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "MNRClara's RestTemplate");
            ...
            restTemplate.setRequestFactory(new HttpComponentsClientHttpRequestFactory(client));
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getIDMasterServiceApiUrl() + "/notification-message/update/message");

            ResponseEntity<Boolean> result = restTemplate.exchange(builder.toUriString(), HttpMethod.PATCH, entity, Boolean.class);
            log.info("result : " + result.getBody());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    // UPDATE
    public Boolean updateWebSocketNotificationMessage(String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "MNRClara's RestTemplate");
            ...
            restTemplate.setRequestFactory(new HttpComponentsClientHttpRequestFactory(client));
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getIDMasterServiceApiUrl() + "/notification-message/update");
    ...
    public WebSocketNotification[] findWebSocketNotification(SearchNotification searchNotification, String authToken){
        try{
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "RestTemplate");
            headers.add("Authorization", "Bearer " + authToken);
            UriComponentsBuilder builder=UriComponentsBuilder.fromHttpUrl(getIDMasterServiceApiUrl() +"notification-message/find");
            HttpEntity<?>entity = new HttpEntity<>(searchNotification,headers);
            ResponseEntity<WebSocketNotification[]> result =
                    getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, WebSocketNotification[].class);
            log.info("result : " + result.getStatusCode());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
