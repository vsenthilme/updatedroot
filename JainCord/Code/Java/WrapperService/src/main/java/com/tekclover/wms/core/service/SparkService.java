...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/imbasicdata1");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/storagebin");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/containerReceipt");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/preinboundHeader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/stagingheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/grheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/putawayheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/inboundHeader");
            HttpEntity<?> entity = new HttpEntity<>(searchInboundHeaderV2, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/preoutboundheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/ordermanagementline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/pickupheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/qualityheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/outboundheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/outboundreversal");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/pickupline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/inventorymovement");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/jain/cord/inventory");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/inventory/new");
            HttpEntity<?> entity = new HttpEntity<>(findInventoryV2, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/putawayline");
            HttpEntity<?> entity = new HttpEntity<>(findInventoryV2, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/putawayline/new");
            HttpEntity<?> entity = new HttpEntity<>(findInventoryV2, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/periodicheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/inhousetransferline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/perpetualheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/inboundline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/inhousetransferheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/stockreport");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/periodicline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/perpetualline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/preoutboundline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/stagingLine");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/grline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/qualityline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/imbasicdata1v3");
            HttpEntity<?> entity = new HttpEntity<>(searchImBasicData1, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/imbasicdata1v5");
            HttpEntity<?> entity = new HttpEntity<>(searchImBasicData1, headers);
            ResponseEntity<ImBasicData1V3[]> result = getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, ImBasicData1V3[].class);
            log.info("result: " + result.getStatusCode());
            return result.getBody();
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/businessPartner");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/inboundLineV3");
            HttpEntity<?> entity = new HttpEntity<>(findInboundLineV2, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/outboundHeaderTest");
...
//        headers.add("Authorization", "Bearer " + authToken);
    ...
    public InboundLineV4[] findInboundLinev4(FindInboundLineV2 findInboundLineV2) {
        try {
            ...
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/jain/cord/inboundLine/new");
            HttpEntity<?> entity = new HttpEntity<>(findInboundLineV2, headers);
    ...
    public PickUpLineV3[] findPickUpLineV3(SearchPickupLineV3 searchPickupLineV3) {
        try {
            ...
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "almailem/spark/pickuplinev3/new");
    ...
    public OutboundLineV3[] findOutboundLineV3(FindOutboundLineV2 findOutboundLineV2) {
        try {
            ...
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "almailem/spark/outboundv3/new");
    ...
    public GrLineV3[] findGrLineV3(FindGrLineV2 findGrLineV2) {
        try {
            ...
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "almailem/spark/grline/v3");
            HttpEntity<?> entity = new HttpEntity<>(findGrLineV2, headers);
    ...
    public OutboundHeaderV3[] findOutboundOrderSummaryReport(FindOutBoundHeaderV2 findOutBoundHeaderV2) {
        try {
            ...
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", " RestTemplate");
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "almailem/spark/obHeader/obOrderSummaryReport");
            HttpEntity<?> entity = new HttpEntity<>(findOutBoundHeaderV2, headers);
