...
//        }
            ...
            if (orderCancelInput.getReferenceField1().equalsIgnoreCase("STOCKADJUSTMENT") ||
                ...
                emailSubject = "JC Classic WMS/AMS Integration - Sync failure Notification - Item Code: " + ref_doc_no + ", " + orderCancelInput.getReferenceField2() + ", " + localDate;

                emailBodyText = "Dear JainCord Operations/IT team,<br><br>" + "Please find below the failed order sync details <br><br> " +
                ...
                emailSubject = "JC Classic WMS/AMS Integration - Sync failure Notification - Order No: " + ref_doc_no + ", " + localDate;
                emailBodyText = "Dear Jain Cord Operations/IT team,<br><br>" + "Please find below the failed order sync details" +
                        "<table>" +
                        "<tr>" +
                        "<td>Order No </td>" +
                        "<td>: " + ref_doc_no + "</td>" +
            ...
            email.setSenderName("JainCord-Support");
    ...
    public void sendaMail(EMailDetails email) throws MessagingException, IOException {
        ...
        try {
            ...
            log.info("JC-Failed Order Detail Mail sent successful");
        } catch (Exception e) {
            e.printStackTrace();
            helper.setFrom(propertiesConfig.getEmailFromAddress());
            helper.setTo("raj@tekclover.com");
            helper.setCc("senthil.v@tekclover.com");
            helper.setSubject("JC-Failed Order Details sending through eMail Failed");
            helper.setText("JC-Failed Order Details sending through eMail Failed", true);
            javaMailSender.send(msg);
            log.info("JC-Failed Order Detail Mail sent Unsuccessful");
