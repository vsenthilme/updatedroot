...
public class PutAwayHeaderService extends BaseService {
    ...
    public PutAwayHeaderV2 createPutAwayHeaderV2(PutAwayHeaderV2 newPutAwayHeader, String loginUserID)
        ...
        if (savePutAwayHeader != null) {
            sendNotification(savePutAwayHeader.getLanguageId(), savePutAwayHeader.getCompanyCodeId(), savePutAwayHeader.getPlantId(),
                    savePutAwayHeader.getWarehouseId(), savePutAwayHeader.getRefDocNumber());
        }
        return savePutAwayHeader;
    }

    // SendNotification
    public void sendNotification(String languageId, String companyId, String plantId, String warehouseId, String processId) throws FirebaseMessagingException {
        // send Notification
            ...
            for (IKeyValuePair qualityHeader : notification) {
                ...
                if (deviceToken != null && !deviceToken.isEmpty()) {
                    ...
                    String response = pushNotificationService.sendPushNotificationWithUserId(deviceToken, title, message,
                            languageId, companyId, plantId, warehouseId, processId, qualityHeader.getAssignPicker());
