...
//                }
     ...
     * @throws Exception
     */
    public void deliveryConfirmationV5(String companyCodeId, String plantId, String languageId, String warehouseId,
                                       String preOutboundNo, String refDocNumber, String loginUserID) throws Exception {
        try {
            /*--------------------OrderManagementLine-Check---------------------------------------------------------------------*/
            // OrderManagementLine checking for STATUS_ID - 42L, 43L
            boolean orderManagementLineCount = orderManagementLineService.getOrderManagementLineV5(companyCodeId, plantId, languageId, warehouseId, refDocNumber, preOutboundNo, Arrays.asList(42L, 43L));
            ...
            /*--------------------PickupHeader-Check---------------------------------------------------------------------*/
            // PickupHeader checking for STATUS_ID - 48
            boolean pickupHeaderCount = pickupHeaderService.getPickupHeaderCountForDeliveryConfirmationV5(companyCodeId, plantId, languageId, warehouseId, refDocNumber, preOutboundNo, 48L);
