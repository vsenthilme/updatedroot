...
//    }
    public StorageBinV2 getStorageBinV2(String companyCodeId, String plantId, String languageId, String warehouseId, String storageBin) {
        Optional<StorageBinV2> storagebin;
        try {
            storagebin = storageBinV2Repository.findByStorageBinAndCompanyCodeIdAndPlantIdAndWarehouseIdAndLanguageIdAndDeletionIndicator(
<<<<<<< HEAD
                    storageBin,
                    companyCodeId,
                    plantId,
...
>>>>>>> 81dc64bb940937a238631ec1ef8d3af347b8ec9e
            ...
            throw new RuntimeException("Error querying database: " + e.getMessage(), e);
        }
