...
//	Stream<InventoryImpl> findInventory (
    ...
    List<Inventory> findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndPackBarcodesAndReferenceOrderNoAndDeletionIndicator(
            String companyCodeId, String languageId, String plantId, String warehouseId, String itemCode, String packBackParCode, String refDocNumber, Long deletionIndicator);

    @Modifying
    @Query(value = "update tblinventory set inv_qty = 0 " +
            "where c_id = :companyId and lang_id = :languageId and " +
            "plant_id = :plantId and wh_id = :warehouseId and " +
            "itm_code = :itemCode and BIN_CL_ID = '3' and is_Deleted = 0", nativeQuery = true)
    void updateInventory(@Param("companyId") String companyId,
