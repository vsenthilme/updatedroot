...
<<<<<<< HEAD
            "group by itm_code,piece_id,mfr_name,pack_barcode,st_bin,plant_id,wh_id,c_id,lang_id \n"
=======
...
//            @Param(value = "binClassId") Long binClassId,
    ...
    @Query(value = "select max(inv_id) inventoryId into #inv from tblinventory \n"
<<<<<<< HEAD
            + "WHERE is_deleted = 0 group by itm_code,piece_id,mfr_name,pack_barcode,st_bin,plant_id,wh_id,c_id,lang_id \n" +
=======
            + "WHERE is_deleted = 0 group by itm_code,mfr_name,pack_barcode,st_bin,plant_id,wh_id,c_id,lang_id \n" +
>>>>>>> 81dc64bb940937a238631ec1ef8d3af347b8ec9e
...
<<<<<<< HEAD
    @Query (value = "SELECT max(INV_ID) inventoryId into #inv FROM TBLINVENTORY WHERE is_deleted = 0 GROUP BY ITM_CODE,PIECE_ID,MFR_NAME,PACK_BARCODE,ST_BIN,PLANT_ID,WH_ID,C_ID,LANG_ID \r\n"
=======
    @Query (value = "SELECT max(INV_ID) inventoryId into #inv FROM TBLINVENTORY WHERE is_deleted = 0 GROUP BY ITM_CODE,MFR_NAME,PACK_BARCODE,ST_BIN,PLANT_ID,WH_ID,C_ID,LANG_ID \r\n"
>>>>>>> 81dc64bb940937a238631ec1ef8d3af347b8ec9e
...
//            "iv.NO_PAIRS noPairs, \n" +
            ...
            "(COALESCE(:binClassId, null) IS NULL OR (iv.BIN_CL_ID IN (:binClassId))) and\n" +
            "(COALESCE(:stockTypeId, null) IS NULL OR (iv.STCK_TYP_ID IN (:stockTypeId))) and \n" +
            "iv.is_deleted = 0 and (iv.INV_QTY > 0) order by iv.LEVEL_ID, iv.ST_SEC_ID, iv.REF_FIELD_10, iv.BARCODE_ID, iv.INV_QTY \n", nativeQuery = true)
...
//            "iv.NO_PAIRS noPairs, \n" +
            ...
            "(COALESCE(:binClassId, null) IS NULL OR (iv.BIN_CL_ID IN (:binClassId))) and\n" +
            "(COALESCE(:stockTypeId, null) IS NULL OR (iv.STCK_TYP_ID IN (:stockTypeId))) and \n" +
            "iv.is_deleted = 0 and (iv.INV_QTY > 0) order by iv.STR_NO, iv.ST_SEC_ID, iv.REF_FIELD_10, iv.BARCODE_ID, iv.INV_QTY \n", nativeQuery = true)
...
//            "iv.NO_PAIRS noPairs, \n" +
            ...
            "(COALESCE(:storageBin, null) IS NULL OR (iv.ST_BIN IN (:storageBin))) and\n" +
            "iv.is_deleted = 0  and iv.stck_typ_id = 1 and (iv.INV_QTY > 0) order by iv.BARCODE_ID,iv.ST_SEC_ID,iv.REF_FIELD_10 \n", nativeQuery = true)
    public List<IInventoryImpl> getInventoryV4(@Param("companyCodeId") String companyCodeId,
                                               @Param("plantId") String plantId,
                                               @Param("languageId") String languageId,
                                               @Param("warehouseId") String warehouseId,
                                               @Param("itemCode") String itemCode,
    ...
    @Query(value = "select max(inv_id) inventoryId into #inv from tblinventory \n"
            ...
            "BIN_CL_ID, TEXT, INV_UOM, C_TEXT, PLANT_TEXT, WH_TEXT ", nativeQuery = true)
    public List<IInventoryImpl> findStockCountInventory(@Param("companyCodeId") String companyCodeId,
                                                        @Param("plantId") String plantId,
                                                        @Param("languageId") String languageId,
                                                        @Param("warehouseId") String warehouseId,
                                                        @Param("itemCode") List<String> itemCode,
...
//            "iv.NO_PAIRS noPairs, \n" +
            ...
            "(COALESCE(:itemCode, null) IS NULL OR (iv.ITM_CODE IN (:itemCode))) and \n" +
            "(COALESCE(:storageBin, null) IS NULL OR (iv.ST_BIN IN (:storageBin))) and\n" +
            "iv.is_deleted = 0  and iv.stck_typ_id = :stockTypeId and iv.bin_cl_id = :binClassId order by iv.BARCODE_ID,iv.ST_SEC_ID,iv.REF_FIELD_10 \n", nativeQuery = true)
    public IInventoryImpl getInventoryV4(@Param("companyCodeId") String companyCodeId,
                                         @Param("plantId") String plantId,
                                         @Param("languageId") String languageId,
                                         @Param("warehouseId") String warehouseId,
...
//            "iv.NO_PAIRS noPairs, \n" +
            ...
            "(COALESCE(:itemCode, null) IS NULL OR (iv.ITM_CODE IN (:itemCode))) and \n" +
            "(COALESCE(:storageBin, null) IS NULL OR (iv.ST_BIN IN (:storageBin))) and\n" +
            "iv.is_deleted = 0  and iv.stck_typ_id = :stockTypeId order by iv.BARCODE_ID,iv.ST_SEC_ID,iv.REF_FIELD_10 \n", nativeQuery = true)
    public IInventoryImpl getInventoryV4(@Param("companyCodeId") String companyCodeId,
                                         @Param("plantId") String plantId,
                                         @Param("languageId") String languageId,
                                         @Param("warehouseId") String warehouseId,
    ...
    @Query(value = "select max(inv_id) inventoryId into #inv from tblinventory \n" +
            ...
            "(COALESCE(:warehouseId, null) IS NULL OR (iv.wh_id IN (:warehouseId))) and \n" +
            "(COALESCE(:packBarcodes, null) IS NULL OR (iv.PACK_BARCODE IN (:packBarcodes))) and \n" +
            "(COALESCE(:palletId, null) IS NULL OR (iv.PALLET_ID IN (:palletId))) and\n" +
            "iv.is_deleted = 0  and iv.stck_typ_id = 1 and iv.bin_cl_id = 1 and (iv.REF_FIELD_4 > 0) order by iv.BARCODE_ID \n", nativeQuery = true)
    public List<IInventoryImpl> getOutboundInventoryV4(@Param("companyCodeId") String companyCodeId,
                                                       @Param("plantId") String plantId,
                                                       @Param("languageId") String languageId,
                                                       @Param("warehouseId") String warehouseId,
                                                       @Param("packBarcodes") String packBarcodes,
