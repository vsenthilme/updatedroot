...
//                                       String preInboundNo, String refDocNumber, String manufacturerCode);
    ...
    @Query("UPDATE StagingLineEntityV2 ib SET ib.statusId = :statusId, ib.statusDescription = :statusDescription, ib.updatedBy = :updatedBy, ib.updatedOn = :updatedOn \n" +
            "WHERE ib.warehouseId = :warehouseId and ib.companyCode = :companyCode and ib.plantId = :plantId and ib.languageId = :languageId \n" +
            "AND ib.refDocNumber = :refDocNumber AND ib.preInboundNo = :preInboundNo")
    void updateStagingLineStatus(@Param("companyCode") String companyCode,
                                 @Param("plantId") String plantId,
                                 @Param("languageId") String languageId,
                                 @Param("warehouseId") String warehouseId,
                                 @Param("refDocNumber") String refDocNumber,
