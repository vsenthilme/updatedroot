...
public interface GrLineV2Repository extends JpaRepository<GrLineV2, Long>, JpaSpecificationExecutor<GrLineV2>,
    ...
    GrLineV2 findByLanguageIdAndCompanyCodeAndPlantIdAndWarehouseIdAndRefDocNumberAndPalletIdAndDeletionIndicator(
            String languageId, String companyId, String plantId, String warehouseId, String refDocNumber, String palletId, Long deletionIndicator);

    @Modifying(clearAutomatically = true, flushAutomatically = true)
    @Query("Update GrLineV2 ob SET ob.statusId = :statusId, ob.statusDescription = :statusDescription \r\n "
            + " WHERE ob.companyCode = :companyCode AND ob.plantId = :plantId AND ob.languageId = :languageId AND ob.warehouseId = :warehouseId \n"
            + " AND ob.refDocNumber = :refDocNumber AND ob.preInboundNo = :preInboundNo AND ob.lineNo = :lineNo AND ob.itemCode = :itemCode")
    public void updateGrLineStatusV5(@Param("companyCode") String companyCode,
                                     @Param("plantId") String plantId,
                                     @Param("languageId") String languageId,
                                     @Param("warehouseId") String warehouseId,
                                     @Param("refDocNumber") String refDocNumber,
