                ...
                for (PeriodicLineV2 periodicLine : periodicLines) {
                    if (periodicLine.getVarianceQty() != 0) {
                        InventoryV2 dbInventory = inventoryService.getOutboundInventoryV4(
                                ...
                                periodicLine.getBarcodeId(), periodicLine.getStorageBin());
                        ...
                        if (dbInventory != null) {
                            ...
                            double[] inventoryQty = calculateStockAdjustmentInventory(periodicLine.getVarianceQty(),
                            ...
                            dbStockAdjustment.setAfterAdjustment(newInventory.getReferenceField4());
<<<<<<< HEAD
                            dbStockAdjustment.setCompanyCode(newInventory.getCompanyCodeId());
=======
>>>>>>> 81dc64bb940937a238631ec1ef8d3af347b8ec9e
     ...
     * @return
     */
    public double[] calculateStockAdjustmentInventory (Double varianceQty, Double inventoryQty, Double invAllocatedQty) {
        log.info("INV_QTY, ALLOC_QTY, TFR_QTY : " + inventoryQty + ", " + invAllocatedQty + ", " + varianceQty);

        double INV_QTY = (inventoryQty != null ? inventoryQty : 0) + varianceQty;
        ...
        log.info("Tfr INV_QTY, ALLOC_QTY, TOT_QTY : " + INV_QTY + "|" + ALLOC_QTY + "|" + TOT_QTY );
