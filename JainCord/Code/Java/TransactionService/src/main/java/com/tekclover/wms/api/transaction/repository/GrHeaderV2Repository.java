...
public interface GrHeaderV2Repository extends JpaRepository<GrHeaderV2, Long>, JpaSpecificationExecutor<GrHeaderV2>,
    ...
    @Query(value = "select distinct ref_doc_no as refDocNumber, wh_id as warehouseId, \n" +
            ...
            " WHERE status_id = 16 AND noti_status = 0 AND is_deleted = 0", nativeQuery = true)
    ...
    public List<String> getDeviceToken(@Param("languageId") String languageId,
    ...
    @Query(value = "select usr_id userId from tblusermanagement where usr_role_id = :roleId\n" +
...
<<<<<<< HEAD
    GrHeader findByRefDocNumberAndPreInboundNoAndDeletionIndicator(String refDocNumber, String preInboundNo, Long deletionIndicator);
=======
    GrHeader findByRefDocNumberAndDeletionIndicator(String refDocNumber, Long deletionIndicator);
