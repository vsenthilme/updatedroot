...
public class QualityHeaderService extends BaseService {
    ...
    public QualityHeaderV2 createQualityHeaderV2(QualityHeaderV2 newQualityHeader, String loginUserID)
        ...
        dbQualityHeader.setQualityCreatedOn(new Date());
        dbQualityHeader.setQualityUpdatedOn(new Date());
        QualityHeaderV2 saveQualityHeader = qualityHeaderV2Repository.save(dbQualityHeader);

        // send Notification
//        if (saveQualityHeader != null) {
//            List<IKeyValuePair> notification =
//                    qualityHeaderV2Repository.findByStatusIdAndNotificationStatusAndDeletionIndicatorDistinctRefDocNo();
//
//            if (notification != null) {
//                for (IKeyValuePair qualityHeader : notification) {
//                    // Get NotificationId
//                    IKeyValuePair notifyId = qualityHeaderV2Repository.getNotificationId(saveQualityHeader.getCompanyCodeId(),
//                            saveQualityHeader.getLanguageId(), "4");
//
//                    if (notifyId == null || notifyId.getUserRole() == null) {
//                        log.warn("Notification ID or User Role not found for companyId: {}, languageId: {}", saveQualityHeader.getCompanyCodeId(), saveQualityHeader.getLanguageId());
////                        return;
//                    }
//
//                    List<String> userIds = null;
//                    if (notifyId != null) {
//                        userIds = qualityHeaderV2Repository.getUserId(saveQualityHeader.getCompanyCodeId(),
//                                saveQualityHeader.getLanguageId(), notifyId.getUserRole());
//                        if (userIds.isEmpty()) {
//                            log.warn("No Users found for the specified role: {}, companyId: {}", notifyId.getUserRole(), saveQualityHeader.getCompanyCodeId());
////                        return;
//                        }
//                    }
//
//                    List<String> deviceToken = qualityHeaderV2Repository.getDeviceToken(saveQualityHeader.getLanguageId(),
//                            saveQualityHeader.getCompanyCodeId(), saveQualityHeader.getPlantId(), saveQualityHeader.getWarehouseId(), userIds);
//
//                    if (deviceToken != null && !deviceToken.isEmpty()) {
//                        String title = "QUALITY";
//                        String message = qualityHeader.getRefDocType() + " ORDER - " + qualityHeader.getRefDocNumber() + " - IS RECEIVED";
//                        String response = pushNotificationService.sendPushNotificationWithUserIdList(deviceToken, title, message,
//                                saveQualityHeader.getLanguageId(), saveQualityHeader.getCompanyCodeId(), saveQualityHeader.getPlantId(),
//                                saveQualityHeader.getWarehouseId(), saveQualityHeader.getRefDocNumber(), userIds);
//                        if (response.equals("OK")) {
//                            qualityHeaderV2Repository.updateNotificationStatus(qualityHeader.getRefDocNumber(), qualityHeader.getWarehouseId());
...
//        }
     ...
     * @param loginUserID
     */
    public void createQualityHeaderV4 (String companyCodeId, String plantId, String languageId,
                                       String warehouseId, PickupLineV2 dbPickupLine,
                                       PickupHeaderV2 pickupHeader, String loginUserID) throws Exception {
        try {
...
<<<<<<< HEAD
            newQualityHeader.setReferenceField10(dbPickupLine.getReferenceField10());
=======
...
<<<<<<< HEAD
//            qualityLineService.createQualityLineV4(companyCodeId, plantId, languageId, warehouseId, dbPickupLine, createdQualityHeader, idMasterAuthToken, loginUserID);
=======
            qualityLineService.createQualityLineV4(companyCodeId, plantId, languageId, warehouseId, dbPickupLine, createdQualityHeader, idMasterAuthToken, loginUserID);
>>>>>>> 81dc64bb940937a238631ec1ef8d3af347b8ec9e
        } catch (Exception e) {
