...
//=======================================================V2============================================================================================
    ...
    public ResponseEntity<?> unallocateOrderManagementLineV2(@Valid @RequestBody List<OrderManagementLineV2> orderManagementLineV2, @RequestParam String loginUserID) throws Exception {
//        List<OrderManagementLineV2> updatedOrderManagementLine = ordermangementlineService.doUnAllocationV2(orderManagementLineV2, loginUserID);
        List<OrderManagementLineV2> updatedOrderManagementLine = ordermangementlineService.doUnAllocationV5(orderManagementLineV2, loginUserID);
        return new ResponseEntity<>(updatedOrderManagementLine, HttpStatus.OK);
    }
...
//        OrderManagementLineV2 updatedOrderManagementLine = ordermangementlineService.doUnAllocationV2(companyCodeId, plantId, languageId, warehouseId, preOutboundNo, refDocNumber, partnerCode, lineNumber,
        OrderManagementLineV2 updatedOrderManagementLine = ordermangementlineService.doUnAllocationV5(companyCodeId, plantId, languageId, warehouseId, preOutboundNo, refDocNumber, partnerCode, lineNumber,
                        itemCode, proposedStorageBin, proposedPackBarCode, loginUserID);
        return new ResponseEntity<>(updatedOrderManagementLine, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> allocateOrderManagementLineV2(@Valid @RequestBody List<OrderManagementLineV2> orderManagementLineV2,
                                                           @RequestParam String loginUserID) throws Exception {
//        List<OrderManagementLineV2> updatedOrderManagementLine = ordermangementlineService.doAllocationV2(orderManagementLineV2, loginUserID);
        List<OrderManagementLineV2> updatedOrderManagementLine = ordermangementlineService.doAllocationV5(orderManagementLineV2, loginUserID);
        return new ResponseEntity<>(updatedOrderManagementLine, HttpStatus.OK);
    }
...
//        ordermangementlineService.rollback(companyCodeId, plantId, languageId, warehouseId, refDocNumber, outboundOrderTypeId);
    ...
    @PatchMapping("/v5/patch")
    public ResponseEntity<?> updateOrderManagementLineV2(@Valid @RequestBody List<OrderManagementLineV2> orderManagementLineV2, @RequestParam String loginUserID) throws Exception {
        ordermangementlineService.updateOrderManagementLineV5(orderManagementLineV2, loginUserID);
        return new ResponseEntity<>(HttpStatus.OK);
    }
}