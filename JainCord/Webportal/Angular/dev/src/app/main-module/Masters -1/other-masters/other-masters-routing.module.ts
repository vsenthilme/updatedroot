...
const routes: Routes = [
  ...
  },
  {
    ...
    component:MasteroperationsComponent
  },
  {
    path: 'masteroperationnew/:code',
    component:MasteroperationNewComponent
  },
  {
    path: 'receipe',
    component:MasterrecipeComponent
  },
  {
    path: 'masterReceipe',
  ...
  {
    path: 'masterReceipeNew/:code',
    component:RecipeNewComponent
  },
  {
    path: 'receipeNew/:code',
    component:MasterrecipeNewComponent
  },
  {
    path: 'dockNew/:code',
