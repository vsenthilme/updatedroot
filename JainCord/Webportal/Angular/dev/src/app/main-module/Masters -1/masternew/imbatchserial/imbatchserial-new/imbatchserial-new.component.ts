    ...
    if (this.js.pageflow == "Edit") {
      ...
      if (this.js.pageflow != 'basicDataNew' && this.js.pageflow != 'New') {
        ...
        if (this.js.pageflow == 'Display')
         ...
         if(this.js.pageflow == 'basicDataEdit'|| this.js.pageflow == 'basicDataEdit3' || this.js.pageflow =='basicDataEdit2'){
...
//     onmaninateneceChange(event:any){
//       console.log(event)
//       if(event.value  == 'Internal'){
//       this.form.controls.maintenance.patchValue(event.value);
//       this.sub.add(this.reportservice.getBatchgenerate(this.auth.companyId,this.auth.plantId,this.auth.warehouseId,this.auth.languageId,this.form.controls.storageMethod.value).subscribe(res => {
//         this.form.controls.currentNo.patchValue(res);
...
//     
//     if (result != null) {
//     this.form.controls.currentNo.patchValue(result.remarks)
//     }
//   });
// }
...
//   }
  ...
  if (this.js.pageflow == 'Edit') {
   ;
    if ((this.js.code) && (this.js.pageflow == 'Edit') && (this.js.pageflow != "New")) {
      this.sub.add(this.service.Update(this.form.getRawValue(),this.form.controls.storageMethod.value,this.js.warehouseId,this.js.languageId,this.js.plantId,this.js.companyCodeId,this.js.itemCode).subscribe(res => {
  ...
  if(this.js.pageflow=="basicDataEdit"){
    ...
    this.sub.add(this.service.Update(this.form.getRawValue(),this.form.controls.storageMethod.value,this.js.basicdataresult.warehouseId,this.js.basicdataresult.languageId,this.js.basicdataresult.plantId,this.js.basicdataresult.companyCodeId,this.js.basicdataresult.itemCode).subscribe(res => {
      this.toastr.success(res.storageMethod + " updated successfully!","Notification",{
        timeOut: 2000,
        progressBar: false,
      });
