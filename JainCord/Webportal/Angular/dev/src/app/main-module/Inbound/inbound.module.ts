...
@NgModule({
  declarations: [
    ...
    SuppliercancellationComponent, SuppliercancellinesComponent, PutawayProposedComponent, PutawayRejectedComponent, QualityHeaderComponent, QualityLineComponent, QualityPopupComponent, PalletizationCreateComponent
  ],
