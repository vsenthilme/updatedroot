...
export class PutawaycreationCreateComponent implements OnInit {
  ...
  { header: 'Mfr Name', field: 'manufacturerPartNo', format: 'normal'},
  ...
  { header: 'Confirmed Bin Location', field: 'confirmedStorageBin', format: 'normal' },
  { header: 'Order Qty', field: 'orderQty', format: 'normal' },
  { header: 'Putaway Qty', field: 'putawayConfirmedQty', format: 'normal' },
  { header: 'Delete', field: 'delete', format: 'delete' },
  { header: 'Edit', field: 'edit', format: 'edit' }
];
