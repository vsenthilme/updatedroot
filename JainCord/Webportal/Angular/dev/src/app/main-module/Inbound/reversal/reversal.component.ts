...
export class ReversalComponent implements OnInit {
  ...
  cols: any[] = [
    ...
    { header: 'Putaway No', field: 'putAwayNumber', format: 'normal' },
    { header: 'Barcode Id', field: 'barcodeId', format: 'normal' },
    { header: 'Part No', field: 'referenceField7', format: 'normal' },
    { header: 'Order No', field: 'refDocNumber', format: 'normal' },
    { header: 'Bin Location', field: 'proposedStorageBin', format: 'normal' },
    { header: 'Reversed By', field: 'updatedBy', format: 'normal' },
    { header: 'Reversed On', field: 'updatedOn', format: 'date' }
  ];
