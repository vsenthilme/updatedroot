...
export class PreinboundNewComponent implements OnInit {
  ...
  cols: any[] = [
    ...
    { header: 'Reference Doc Number', field: 'refDocNumber',format: 'normal' },
    ...
    { header: 'Supplier Name', field: 'supplierName',format: 'normal' },
    { header: 'Order Qty', field: 'orderQty',format: 'normal' },
    { header: 'UOM', field: 'orderUom',format: 'normal' },
    { header: 'Stock Type', field: 'stockTypeId',format: 'normal' },
    { header: 'Inventory Details', field: 'details',format: 'details' },
