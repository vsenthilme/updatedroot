...
export class InboundTabbarComponent implements OnInit {
  ...
  link = [
    ...
    { url: "/main/inbound/palletization-main", title: "Palletization", screenid: 3049, class: "mx-1 d-flex justify-content-center align-items-center" },
    { url: "/main/inbound/item-main", title: "GR Release", screenid: 3049, class: "mx-1 d-flex justify-content-center align-items-center" },
    { url: "/main/inbound/qualityHeader", title: "Quality", screenid: 3228, class: "mx-1 d-flex justify-content-center align-items-center" },
