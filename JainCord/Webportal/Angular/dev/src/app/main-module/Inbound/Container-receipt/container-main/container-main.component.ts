...
screenid=3042;
  ...
  cols: any[]= [
    ...
    { header: 'Supplier Name', field: 'partnerCode', format: 'normal' },
    { header: 'Created By', field: 'createdBy', format: 'normal' },
    { header: 'Container Uploaded On', field: 'referenceField2', format: 'date' },
  ...
  downloadexcel() {
    const exportData = this.containerReceipt.map(item => {
