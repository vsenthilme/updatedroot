...
export class TransactionHistoryComponent implements OnInit {
  ...
  cols: any[] = [
    ...
    { header: 'Description', field: 'itemDescription' , format: 'normal', showFooter: false },
    { header: 'Opening Stock', field: 'openingStock' , format: 'normal', showFooter: true },
    { header: 'Inbound Qty', field: 'inboundQty' , format: 'normal', showFooter: true },
    { header: 'Outbound Qty', field: 'outboundQty' , format: 'normal', showFooter: true },
    { header: 'Stock Adjustment Qty', field: 'stockAdjustmentQty' , format: 'normal', showFooter: true },
    { header: 'Closing Stock', field: 'closingStock' , format: 'normal', showFooter: true },
    { header: 'System Stock', field: 'systemInventory' , format: 'normal', showFooter: true },
    { header: 'Variance', field: 'variance' , format: 'normal', showFooter: true },
    { header: 'Details', field: 'details' , format: 'lines', showFooter: false }
  ];
...
this.spin.show();
  ...
  downloadexcel() {
    ...
    this.cs.exportAsExcel(exportData, 'Transaction History Report');
  }
