...
import { PathLocationStrategy } from "@angular/common";
  ...
  cols: any[] = [
    ...
    { header: 'Status', field: 'statusId', format: 'status' },
    { header: 'Container No', field: 'containerNo', format: 'normal' },
    { header: 'Receipt No', field: 'containerReceiptNo', format: 'normal' },
    { header: 'Size', field: 'containerType', format: 'normal' },
    { header: 'Origin', field: 'origin', format: 'normal' },
    { header: 'Supplier', field: 'partnerCode', format: 'normal' },
    { header: 'Created By', field: 'createdBy', format: 'normal' },
    { header: 'Container Unloaded On', field: 'referenceField2', format: 'date' },
    { header: 'Actual Receipt Date', field: 'referenceField5', format: 'date' }
  ];
  ngOnInit(): void {
  ...
  downloadexcel() {
    const exportData = this.container.map(item => {
    ...
    this.cs.exportAsExcel(exportData, 'Container Status Report');
  }
