...
export class PeriodicreportComponent implements OnInit {
  ...
  cols: any[] = [
    ...
    { header: 'Cycle Count No', field: 'cycleCountNo', format: 'normal' },
    { header: 'Reference No', field: 'referenceNo', format: 'normal' },
  ...
  downloadexcel() {
    ...
    this.cs.exportAsExcel(exportData, 'Periodic Report');
  }
