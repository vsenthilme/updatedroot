...
export class HhtPickingReportComponent implements OnInit {
  ...
  cols: any[] =[
    ...
    { header: 'No Of Orders', field: 'pickUpHeaderCount', format: 'normal' },
    { header: 'Order Details', field: 'lines', format: 'lines' }
  ];
  ...
  downloadexcel() {
    const exportData = this.hhtPicker.map(item => {
    ...
    this.cs.exportAsExcel(exportData, 'HHT Order Status');
  }
