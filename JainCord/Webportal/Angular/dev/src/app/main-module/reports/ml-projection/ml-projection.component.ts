...
export class MlProjectionComponent implements OnInit {
  ...
  cols: any[] = [
    ...
    { header: 'Description', field: 'referenceField8', format: 'normal', showFooter: false },
    { header: 'Level Id', field: 'levelId', format: 'normal', showFooter: false },
    { header: 'Storage Bin', field: 'storageBin', format: 'bin', showFooter: false },
    { header: 'Barcode', field: 'barcodeId', format: 'normal', showFooter: false },
    { header: 'Projected Qty', field: 'projectedQty', format: 'normal', showFooter: true },
    { header: 'Alloc Qty', field: 'allocatedQuantity', format: 'alloc', showFooter: true },
    { header: 'Inventory Qty', field: 'inventoryQuantity', format: 'normal', showFooter: true },
    { header: 'Stock Type', field: 'stockTypeDescription', format: 'normal', showFooter: false },
    { header: 'Storage Section', field: 'referenceField10', format: 'normal', showFooter: false },
