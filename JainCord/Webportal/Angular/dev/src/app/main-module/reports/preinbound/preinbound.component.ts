...
cols: any[] = [
  ...
  { header: 'Source Branch', field: 'sourceBranchCode' , format: 'normal', showFooter: false },
  { header: 'Order No', field: 'refDocNumber' , format: 'normal', showFooter: false },
  { header: 'Line No', field: 'lineNo' , format: 'normal', showFooter: false },
  ...
  { header: 'Acc Qty', field: 'acceptedQty' , format: 'normal', showFooter: true },
  { header: 'Dam Qty', field: 'damageQty' , format: 'normal', showFooter: true },
  { header: 'Variance Qty', field: 'varianceQty' , format: 'normal', showFooter: true },
  { header: 'Quality', field: 'quality' , format: 'qty', showFooter: false },
  { header: 'Created Date', field: 'createdOn' , format: 'date', showFooter: false },
  { header: 'Confirmed Date', field: 'confirmedOn' , format: 'date', showFooter: false },
  ...
  statusDropdown: any[] = [];
    ...
    openPrice(data: any): void {
      const dialogRef = this.dialog.open(Customdialog2Component, {
        ...
        data: { title: "Quality Details", data: data },
      });
...
obj.endConfirmedOn=this.form.controls.endConfirmedOn.value;
  ...
  downloadexcel() {
    ...
    this.cs.exportAsExcel(exportData, 'Inbound Order Details Report');
  }
