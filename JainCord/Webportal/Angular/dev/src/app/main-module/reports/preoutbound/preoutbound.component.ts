...
cols: any[] =[
  ...
  { header: 'Pre-Outbound No', field: 'preOutboundNo', format: 'normal' },
  { header: 'Order No', field: 'refDocNumber', format: 'normal' },
  { header: 'Ordered Date', field: 'refDocDate', format: 'date' },
...
obj.statusId=this.form.controls.statusId.value;
  ...
  downloadexcel() {
    ...
    this.cs.exportAsExcel(exportData, 'Outbound Order Summary Report');
  }
