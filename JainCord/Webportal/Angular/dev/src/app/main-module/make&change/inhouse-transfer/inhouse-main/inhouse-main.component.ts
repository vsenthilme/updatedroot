...
export class InhouseMainComponent implements OnInit {
  ...
  cols: any[] = [
    { field: 'statusId', header: 'Status', format: 'normal' },
    { field: 'transferNumber', header: 'Transfer No', format: 'normal' },
    { field: 'lines', header: 'Lines', format: 'lines' },
    { field: 'createdOn', header: 'Transfer Date', format: 'date' },
    { field: 'transferTypeId', header: 'Transfer Type', format: 'type' },
    { field: 'createdBy', header: 'Transferred By', format: 'normal' },
  ];
  ...
  downloadexcel() {
    const exportData = this.inhouse.map(item => {
    ...
    this.cs.exportAsExcel(exportData, 'Inhouse Transfer');
  }
