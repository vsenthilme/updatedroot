...
export class PalletiztionLevelIdService {
  ...
  Delete(palletizationLevelId: any,warehouseId: string,languageId:any,companyCodeId:any,plantId:any,palletizationLevel:any) {
    return this.http.delete<any>('/wms-idmaster-service/palletizationlevelid/' + palletizationLevelId+'?warehouseId=' + warehouseId+'&languageId='+languageId+'&companyCodeId='+companyCodeId+'&plantId='+plantId+'&palletizationLevel='+palletizationLevel);
}
search(obj: any) {
