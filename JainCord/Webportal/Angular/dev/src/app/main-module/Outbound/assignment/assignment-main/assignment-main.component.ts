...
cols: any[] = [
  ...
  { header: 'Order Quantity', field: 'orderQty', format: 'normal' },
  { header: 'Allocated Quantity', field: 'allocatedQty', format: 'normal' },
  { header: 'Bin Location', field: 'proposedStorageBin', format: 'normal' },
  { header: 'Description', field: 'description', format: 'normal' },
  { header: 'Order Category', field: 'referenceField1', format: 'normal' },
  { header: 'Barcode Id', field: 'partnerItemBarcode', format: 'normal' },
  { header: 'Storage Section', field: 'referenceField9', format: 'normal' },
