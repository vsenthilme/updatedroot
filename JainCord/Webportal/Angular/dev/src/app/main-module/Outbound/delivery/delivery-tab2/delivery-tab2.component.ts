...
export class DeliveryTab2Component implements OnInit {
  ...
  cols: any[] = [
    ...
    { header: 'Sales Order No', field: 'salesOrderNumber', format: 'link' },
    { header: "Status", field: "statusDescription", format: 'status' },
    ...
    { header: "Picked Lines", field: "countOfPickedLine", format: 'normal' },
    { header: "Order Qty", field: "referenceField9", format: 'normal' },
    { header: "Picked Qty", field: "sumOfPickedQty", format: 'normal' }
  ];
  ...
  ngOnInit(): void {
    ...
    if (this.activeUrl1[3] == 'readyForDelivery') {
      this.searhform.controls.outboundOrderTypeId.patchValue([3]);
      this.searhform.controls.companyCodeId.patchValue([]);
      this.searhform.controls.plantId.patchValue([]);
      this.searhform.controls.languageId.patchValue([]);
