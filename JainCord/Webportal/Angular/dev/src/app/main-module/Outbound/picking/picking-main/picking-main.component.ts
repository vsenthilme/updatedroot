...
export class PickingMainComponent implements OnInit {
  ...
  cols: any[] = [
    ...
    { header: 'Line No', field: 'lineNumber', format: 'normal' },
    { header: 'Mfr Name', field: 'manufacturerName', format: 'normal' },
    { header: 'Part No', field: 'itemCode', format: 'normal' },
    { header: 'Description', field: 'referenceField5', format: 'normal' },
    { header: 'Barcode Id', field: 'partnerItemBarcode', format: 'normal' },
    { header: 'Bin Location', field: 'proposedStorageBin', format: 'normal' },
    { header: 'Picker', field: 'assignedPickerId', format: 'normal' },
    { header: 'Order Qty', field: 'pickToQty', format: 'normal' },
    { header: 'Created Date', field: 'pickupCreatedOn', format: 'date' },
    { header: 'Level', field: 'levelId', format: 'normal' },
  ...
  downloadexcel() {
    const exportData = this.picking.map(item => {
    ...
    this.cs.exportAsExcel(exportData, 'Picking');
  }
