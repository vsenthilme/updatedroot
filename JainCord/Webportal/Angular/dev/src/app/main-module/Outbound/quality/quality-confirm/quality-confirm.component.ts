...
export class QualityConfirmComponent implements OnInit {
  ...
  cols :any[] = [
    ...
    { header: 'Description', field: 'itemDescription', format: 'normal' },
    { header: 'Picked Storage Bin', field: 'referenceField1', format: 'normal' },
    { header: 'Barcode Id', field: 'partnerItemBarcode', format: 'normal' },
    { header: 'Batch Serial Number', field: 'batchSerialNumber', format: 'normal' },
    { header: 'Accepted Qty', field: 'qualityQty', format: 'normal' },
    { header: 'Rejected Qty', field: 'rejectQty', format: 'normal' },
    { header: 'Qc No', field: 'qualityInspectionNo', format: 'normal' },
    { header: 'HE No', field: 'actualHeNo', format: 'normal' },
    { header: 'Quality By', field: 'qualityCreatedBy', format: 'normal' },
    { header: 'Quality Date', field: 'qualityCreatedOn', format: '  ' },
...
// start of  CWMS/IW/2022/018 mugilan 02-10-2022
        ...
        this.spin.show();
        this.sub.add(this.service.searchSpark({ warehouseId:[this.auth.warehouseId],companyCodeId:[this.auth.companyId],languageId:[this.auth.languageId],plantId:[this.auth.plantId], refDocNumber: [data.code.refDocNumber] , statusId: [54],preOutboundNo:[data.code.preOutboundNo]}).subscribe(res => {

          this.sub.add(this.service.getpickinglineSpark({ pickupNumber: [res[0].pickupNumber], warehouseId: [this.auth.warehouseId],companyCodeId:[this.auth.companyId],languageId:[this.auth.languageId],plantId:[this.auth.plantId],preOutboundNo:[res[0].preOutboundNo]}).subscribe(result => {
