...
import com.tekclover.wms.core.model.middleware.SupplierInvoiceHeader;
...
public class TransactionService {
     ...
     * @return
     */
    private String getConnectorServiceServiceUrl() {
...
//                    flag = 1;
            ...
            UriComponentsBuilder builder = UriComponentsBuilder
                    .fromHttpUrl(getTransactionServiceApiUrl() + "outboundheader/v2/findOutboundHeader");
//                    .queryParam("flag", flag);
            HttpEntity<?> entity = new HttpEntity<>(requestDataForService, headers);
...
//			log.info("result : " + result.getBody());
    ...
    // GET
    public OutboundReversalV2[] doReversalV2(String refDocNumber, String itemCode, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "ClassicWMS RestTemplate");
