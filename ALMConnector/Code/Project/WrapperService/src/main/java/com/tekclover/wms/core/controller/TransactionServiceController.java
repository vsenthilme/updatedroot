...
import com.tekclover.wms.core.model.warehouse.inbound.almailem.B2bTransferIn;
import com.tekclover.wms.core.model.warehouse.inbound.almailem.SaleOrderReturnV2;
import com.tekclover.wms.core.model.warehouse.outbound.almailem.ShipmentOrderV2;
...
// -------------------------------------StagingHeader-V2--------------------------------------------------------------------------------------------
    ...
    @ApiOperation(response = OrderManagementLineV2.class, value = "Update Reference Field OrderManagementLine V2") // label for swagger
    ...
    public ResponseEntity<?> getAdditionalBinsV2(@RequestParam String companyCodeId, @RequestParam String plantId, @RequestParam String languageId,
                                                 @RequestParam String warehouseId, @RequestParam String itemCode, @RequestParam Long obOrdertypeId,
    ...
    public ResponseEntity<?> doReversalV2(@RequestParam String refDocNumber, @RequestParam String itemCode,
                                        @RequestParam String loginUserID, @RequestParam String authToken)
            throws IllegalAccessException, InvocationTargetException {
        OutboundReversalV2[] deliveryLines = transactionService.doReversalV2(refDocNumber, itemCode, loginUserID, authToken);
        log.info("deliveryLines : " + deliveryLines);
        return new ResponseEntity<>(deliveryLines, HttpStatus.OK);
    }
