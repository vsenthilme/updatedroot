...
//                createdInquiry.getCreatedOn(), createdInquiry.getCreatedBy());
        ...
        notificationInput.setUserId(Arrays.asList("MEA","RM","MW"));
        notificationInput.setUserType(null);
        notificationInput.setMessage("A new inquiry " + createdInquiry.getInquiryNumber() + " has been received on ");
        notificationInput.setTopic("Inquiry");
        notificationInput.setCreatedOn(createdInquiry.getCreatedOn());
        notificationInput.setCreatedBy(createdInquiry.getCreatedBy());
        notificationInput.setInquiryNo(createdInquiry.getInquiryNumber());
        notificationInput.setDocumentNumber(createdInquiry.getInquiryNumber());
        this.notificationService.saveNotifications(notificationInput);
...
//                createdInquiry.getUpdatedOn(), createdInquiry.getUpdatedBy());
        NotificationSave notificationInput = new NotificationSave();
        notificationInput.setUserId(createdInquiry.getAssignedUserId() != null ? Arrays.asList(createdInquiry.getAssignedUserId()) : new ArrayList<>());
        notificationInput.setUserType(null);
        notificationInput.setMessage("Inquiry " + createdInquiry.getInquiryNumber() + " was assigned to you on ");
        notificationInput.setTopic("Inquiry Assign");
        notificationInput.setCreatedOn(createdInquiry.getCreatedOn());
        notificationInput.setCreatedBy(createdInquiry.getCreatedBy());
        notificationInput.setInquiryNo(createdInquiry.getInquiryNumber());
        notificationInput.setDocumentNumber(createdInquiry.getInquiryNumber());
