...
public class PotentialClientController {
    ...
    //------------------------------------Reports------------------------------------------------------------------
    @ApiOperation(response = PotentialClientReport[].class, value = "PotentialClient Report") // label for swagger
    @PostMapping("/report")
    public List<PotentialClientReport> getPotentialClientReport(@RequestBody SearchPotentialClientReport searchPotentialClientReport)
