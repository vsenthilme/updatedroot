...
//                    updatedPCIntakeForm.getUpdatedOn(), updatedPCIntakeForm.getUpdatedBy());
			...
			notificationInput.setUserId(assignedUserId != null ? Arrays.asList(assignedUserId) : new ArrayList<>());
			notificationInput.setUserType(null);
			notificationInput.setMessage("Intake " + updatedPCIntakeForm.getIntakeFormNumber() + " has been received on ");
			notificationInput.setTopic("Intake");
			notificationInput.setCreatedOn(updatedPCIntakeForm.getUpdatedOn());
			notificationInput.setCreatedBy(updatedPCIntakeForm.getUpdatedBy());
			notificationInput.setInquiryNo(updatedPCIntakeForm.getInquiryNumber());
			notificationInput.setDocumentNumber(updatedPCIntakeForm.getIntakeFormNumber());
			notificationInput.setClassID(updatedPCIntakeForm.getClassId());
			notificationInput.setLanguage(updatedPCIntakeForm.getLanguageId());
			notificationInput.setItFormID(updatedPCIntakeForm.getIntakeFormId());
