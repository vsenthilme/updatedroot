...
//					new Date(), "");
			...
			notificationInput.setUserId(userId);
			notificationInput.setUserType(null);
			notificationInput.setMessage("Agreement Sign has been done on ");
			notificationInput.setTopic("Agreement Sign");
			notificationInput.setCreatedOn(new Date());
			notificationInput.setCreatedBy("");
			notificationInput.setInquiryNo(potentialClient.getInquiryNumber());
			notificationInput.setDocumentNumber(potentialClient.getIntakeFormNumber());
			notificationInput.setClassID(potentialClient.getClassId());
			notificationInput.setLanguage(potentialClient.getLanguageId());
			notificationInput.setItFormID(potentialClient.getIntakeFormId());
