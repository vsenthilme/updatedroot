...
public class NotificationService {
    ...
    public Notification createNotificationModel(String userId, NotificationSave notificationInput) {
        ...
        notification.setInquiryNo(notificationInput.getInquiryNo());
        notification.setClassID(notificationInput.getClassID());
        notification.setLanguage(notificationInput.getLanguage());
        notification.setItFormID(notificationInput.getItFormID());
        notification.setMatterNo(notificationInput.getMatterNo());
        notification.setMatterDesc(notificationInput.getMatterDesc());
        return notification;
    }
}
