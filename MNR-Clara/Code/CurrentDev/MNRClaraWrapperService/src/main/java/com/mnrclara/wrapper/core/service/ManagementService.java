...
//	}
	...
	public MatterTask[] getMatterTasks(String authToken) {
		try {
			...
			headers.add("Authorization", "Bearer " + authToken);
			UriComponentsBuilder builder = UriComponentsBuilder
					.fromHttpUrl(getManagementServiceUrl() + "/mattertask/v2");
			HttpEntity<?> entity = new HttpEntity<>(headers);
	...
	public MatterTask getMatterTask(String taskNumber, String authToken) {
		try {
			...
			headers.add("Authorization", "Bearer " + authToken);
			UriComponentsBuilder builder = UriComponentsBuilder
					.fromHttpUrl(getManagementServiceUrl() + "/mattertask/v2/" + taskNumber);
			HttpEntity<?> entity = new HttpEntity<>(headers);
			ResponseEntity<MatterTask> result = getRestTemplate().exchange(builder.toUriString(), HttpMethod.GET,
					entity, MatterTask.class);
			log.info("result : " + result.getBody());
	...
	public MatterTask[] findMatterTasks (SearchMatterTask searchMatterTask, String authToken) throws ParseException {
		try {
			if(searchMatterTask.getSSCreatedOn() != null) {
				searchMatterTask.setSCreatedOn(DateUtils.convertStringToYYYYMMDD(searchMatterTask.getSSCreatedOn()));
			}
			if(searchMatterTask.getSECreatedOn() != null) {
				searchMatterTask.setECreatedOn(DateUtils.convertStringToYYYYMMDD(searchMatterTask.getSECreatedOn()));
			}
			if(searchMatterTask.getSSDeadlineDate() != null) {
				searchMatterTask.setSDeadlineDate(DateUtils.convertStringToYYYYMMDD(searchMatterTask.getSSDeadlineDate()));
			}
			if(searchMatterTask.getSEDeadlineDate() != null) {
				searchMatterTask.setEDeadlineDate(DateUtils.convertStringToYYYYMMDD(searchMatterTask.getSEDeadlineDate()));
			}
			if(searchMatterTask.getSSReminderDate() != null) {
				searchMatterTask.setSReminderDate(DateUtils.convertStringToYYYYMMDD(searchMatterTask.getSSReminderDate()));
			}
			if(searchMatterTask.getSEReminderDate() != null) {
				searchMatterTask.setEReminderDate(DateUtils.convertStringToYYYYMMDD(searchMatterTask.getSSCreatedOn()));
			}
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "MNRClara RestTemplate");
			headers.add("Authorization", "Bearer " + authToken);
			UriComponentsBuilder builder = UriComponentsBuilder
					.fromHttpUrl(getManagementServiceUrl() + "/mattertask/v2/findMatterTasks");
	...
	// POST
	public MatterTask createMatterTask(MatterTask newMatterTask, String loginUserID, String authToken) throws ParseException {
		try {
			if(newMatterTask.getSTaskCompletedOn() != null) {
				newMatterTask.setTaskCompletedOn(DateUtils.convertStringToYYYYMMDD2(newMatterTask.getSTaskCompletedOn()));
			}
			if(newMatterTask.getSCourtDate() != null) {
				newMatterTask.setCourtDate(DateUtils.convertStringToYYYYMMDD2(newMatterTask.getSCourtDate()));
			}
			if(newMatterTask.getSDeadlineDate() != null) {
				newMatterTask.setDeadlineDate(DateUtils.convertStringToYYYYMMDD2(newMatterTask.getSDeadlineDate()));
			}
			if(newMatterTask.getSReminderDate() != null) {
				newMatterTask.setReminderDate(DateUtils.convertStringToYYYYMMDD2(newMatterTask.getSReminderDate()));
			}
			if(newMatterTask.getSTimeEstimate() != null) {
				newMatterTask.setTimeEstimate(DateUtils.convertStringToYYYYMMDD2(newMatterTask.getSTimeEstimate()));
			}
	...
	public MatterTask updateMatterTask(String taskNumber, MatterTask modifiedMatterTask,
		...
		try {
			if(modifiedMatterTask.getSTaskCompletedOn() != null) {
				modifiedMatterTask.setTaskCompletedOn(DateUtils.convertStringToYYYYMMDD2(modifiedMatterTask.getSTaskCompletedOn()));
			}
			if(modifiedMatterTask.getSCourtDate() != null) {
				modifiedMatterTask.setCourtDate(DateUtils.convertStringToYYYYMMDD2(modifiedMatterTask.getSCourtDate()));
			}
			if(modifiedMatterTask.getSDeadlineDate() != null) {
				modifiedMatterTask.setDeadlineDate(DateUtils.convertStringToYYYYMMDD2(modifiedMatterTask.getSDeadlineDate()));
			}
			if(modifiedMatterTask.getSReminderDate() != null) {
				modifiedMatterTask.setReminderDate(DateUtils.convertStringToYYYYMMDD2(modifiedMatterTask.getSReminderDate()));
			}
			if(modifiedMatterTask.getSTimeEstimate() != null) {
				modifiedMatterTask.setTimeEstimate(DateUtils.convertStringToYYYYMMDD2(modifiedMatterTask.getSTimeEstimate()));
			}
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
...
//	}
	...
	public MatterTimeTicket[] transferTimeTickets(MatterTimeTicketTransfer matterTimeTicketTransfer, 
		...
		try {
			...
			MatterTimeTicket[] responseMatterTimeTicket = result.getBody();
			for (MatterTimeTicket matterTimeTicket : responseMatterTimeTicket) {
				matterTimeTicket.setSTimeTicketDate(DateUtils.dateToString(matterTimeTicket.getTimeTicketDate()));
			}
			return responseMatterTimeTicket;
		} catch (Exception e) {
	...
	// UPDATE
	public void deleteTimeTickets(MatterTimeTicketDelete matterTimeTicketDelete, 
			String loginUserID, String authToken) throws Exception {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			...
			HttpEntity<?> entity = new HttpEntity<>(matterTimeTicketDelete, headers);
			HttpClient client = HttpClients.createDefault();
			RestTemplate restTemplate = getRestTemplate();
			restTemplate.setRequestFactory(new HttpComponentsClientHttpRequestFactory(client));
			UriComponentsBuilder builder = UriComponentsBuilder
					...
					.queryParam("loginUserID", loginUserID);
			ResponseEntity<String> result = restTemplate.exchange(builder.toUriString(), HttpMethod.PATCH,
					entity, String.class);
		} catch (Exception e) {
			e.printStackTrace();
			throw e;
	...
	public MatterExpense[] getMatterExpensePreBill(String preBillNo, String authToken) {
		try {
			...
			headers.add("Authorization", "Bearer " + authToken);
			UriComponentsBuilder builder = UriComponentsBuilder
					.fromHttpUrl(getManagementServiceUrl() + "/matterexpense/v2/" + preBillNo + "/preBillApprove");
			HttpEntity<?> entity = new HttpEntity<>(headers);
			ResponseEntity<MatterExpense[]> result = getRestTemplate().exchange(builder.toUriString(), HttpMethod.GET,
					entity, MatterExpense[].class);
			log.info("result : " + result.getBody());
	...
	public MatterExpense getMatterExpense (Long matterExpenseId, String authToken) {
		try {
			...
			headers.add("Authorization", "Bearer " + authToken);
			UriComponentsBuilder builder = UriComponentsBuilder
					.fromHttpUrl(getManagementServiceUrl() + "/matterexpense/v2/" + matterExpenseId);
			HttpEntity<?> entity = new HttpEntity<>(headers);
			ResponseEntity<MatterExpense> result = getRestTemplate().exchange(builder.toUriString(), HttpMethod.GET,
					entity, MatterExpense.class);
			log.info("result : " + result.getBody());
...
//            log.info("result : " + result.getBody());
	...
	public MatterExpense createMatterExpense (MatterExpense newMatterExpense, String loginUserID, String authToken) {
		try {
			if(newMatterExpense.getSReferenceField2() != null) {
				newMatterExpense.setReferenceField2(DateUtils.convertStringToDate2(newMatterExpense.getSReferenceField2()));
			}
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "MNRClara RestTemplate");
	...
	public MatterExpense updateMatterExpense (Long matterExpenseId, MatterExpense modifiedMatterExpense,
			String loginUserID, String authToken) {
		try {
			if(modifiedMatterExpense.getSReferenceField2() != null) {
				modifiedMatterExpense.setReferenceField2(DateUtils.convertStringToDate2(modifiedMatterExpense.getSReferenceField2()));
			}
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "MNRClara's RestTemplate");
