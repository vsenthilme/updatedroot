...
//	}
	...
	public PotentialClientReport[] getPotentialClientReport(SearchPotentialClientReport searchPotentialClientReport,
		...
		try {
			...
			if(searchPotentialClientReport.getSClientFromCreatedOn() != null){
				searchPotentialClientReport.setClientFromCreatedOn(DateUtils.convertStringToDate2(searchPotentialClientReport.getSClientFromCreatedOn()));
			}
			if(searchPotentialClientReport.getSClientEndCreatedOn() != null){
				searchPotentialClientReport.setClientEndCreatedOn(DateUtils.convertStringToDate2(searchPotentialClientReport.getSClientEndCreatedOn()));
			}
			if(searchPotentialClientReport.getSFromCreatedOn() != null){
				searchPotentialClientReport.setFromCreatedOn(DateUtils.convertStringToDate2(searchPotentialClientReport.getSFromCreatedOn()));
			}
			if(searchPotentialClientReport.getSToCreatedOn() != null){
				searchPotentialClientReport.setToCreatedOn(DateUtils.convertStringToDate2(searchPotentialClientReport.getSToCreatedOn()));
			}
			if(searchPotentialClientReport.getSStartProspectiveFileDate() != null){
				searchPotentialClientReport.setStartProspectiveFileDate(DateUtils.convertStringToDate2(searchPotentialClientReport.getSStartProspectiveFileDate()));
			}
			if(searchPotentialClientReport.getSEndProspectiveFileDate() != null){
				searchPotentialClientReport.setEndProspectiveFileDate(DateUtils.convertStringToDate2(searchPotentialClientReport.getSEndProspectiveFileDate()));
			}
