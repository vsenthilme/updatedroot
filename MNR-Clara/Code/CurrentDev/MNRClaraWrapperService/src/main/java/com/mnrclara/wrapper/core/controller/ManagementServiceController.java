...
public class ManagementServiceController {
    ...
    public ResponseEntity<?> postMatterTask(@Valid @RequestBody MatterTask newMatterTask,
                                            @RequestParam String loginUserID, @RequestParam String authToken) throws IllegalAccessException, InvocationTargetException, ParseException {
...
//	}
	...
	public ResponseEntity<?> patchMatterTimeTicketTransfer (@Valid @RequestBody MatterTimeTicketTransfer matterTimeTicketTransfer, 
			@RequestParam String loginUserID, @RequestParam String authToken) 
			throws Exception {
		MatterTimeTicket[] updatedMatterTimeTicket = managementService.transferTimeTickets(matterTimeTicketTransfer, loginUserID, authToken);
		return new ResponseEntity<>(updatedMatterTimeTicket , HttpStatus.OK);
	}
    
    @ApiOperation(response = MatterTimeTicket.class, value = "Delete MatterTimeTickets") // label for swagger
    @PatchMapping("/mattertimeticket/deleteTimeTicket")
	public ResponseEntity<?> deleteMatterTimeTicketTransfer (@Valid @RequestBody MatterTimeTicketDelete matterTimeTicketDelete, 
			@RequestParam String loginUserID, @RequestParam String authToken) 
			throws Exception {
    	managementService.deleteTimeTickets(matterTimeTicketDelete, loginUserID, authToken);
		return new ResponseEntity<>(HttpStatus.OK);
	}
