...
//		LocalDate eLocalDate =  LocalDate.ofInstant(endDate.toInstant(), ZoneId.systemDefault());
	 ...
	 * @throws ParseException
	 */
	public static Date convertStringToYYYYMMDD2(String strDate) throws ParseException {
		if(strDate.length() < 23) {
			throw new BadRequestException("Invalid Date Format");
		}
		String modDate = strDate.replace("T", " ");
		String modDate2 = modDate.substring(0,18);
		Date date = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(modDate2);
		return date;
	}
