...
public class SearchPotentialClientReport {
	...
	private String sFromCreatedOn;
	private String sToCreatedOn;

	private String sClientFromCreatedOn;                   // Start Client Create Date
	private String sClientEndCreatedOn;  				    // End Client Create Date

	private String sStartProspectiveFileDate;				// Start ProspectiveFileDate
	private String sEndProspectiveFileDate;				// End ProspectiveFileDate
