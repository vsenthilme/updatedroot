...
@Table(name = "tblmattertimeticketid", 
		uniqueConstraints = { 
				@UniqueConstraint (
						name = "unique_key_agreement", 
						columnNames = { "LANG_ID", "CLASS_ID", "MATTER_NO", "CLIENT_ID", "TIME_TICKET_NO", "TK_CODE"})
				}
		)
@IdClass(MatterTimeTicketCompositeKey.class)
public class MatterTimeTicket {
	...
	@Column(name = "PORTAL_CREATION", columnDefinition = "bit default '0'")
	private boolean portalCreation;
}