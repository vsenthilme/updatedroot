...
public class MatterGenAccController {
	...
	@ApiOperation(response = IMatterDropDown.class, value = "Get Matter Dropdown") // label for swagger
	@GetMapping("/dropdown/matterAlone")
	public ResponseEntity<?> getMatterAloneDropdownList() {
		List<IMatterDropDown> matterGenAcc = matterGenAccService.getMatterDropdown();
		return new ResponseEntity<>(matterGenAcc, HttpStatus.OK);
	}

	@ApiOperation(response = MatterNumberDropDown.class, value = "Get Matter Dropdown") // label for swagger
	@GetMapping("/dropdown/matter/new")
	public ResponseEntity<?> getMatterAloneDropdownListNew() {
		Stream<MatterNumberDropDown> matterGenAcc = matterGenAccService.getMatterDropdownNew();
		return new ResponseEntity<>(matterGenAcc, HttpStatus.OK);
	}
