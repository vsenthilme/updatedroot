...
//Check and Credit Request Form Fields
	...
	@Column(name = "HAS_CLIENT_PAID", columnDefinition = "nvarchar(100)")
	private String hasTheClientPaid;

	@Column(name = "IS_THIS_CORPORATE_CLIENT", columnDefinition = "nvarchar(100)")
	private String isThisCorporateClient;

	@Column(name = "CORPORATE_CLIENT", columnDefinition = "nvarchar(100)")
	private String corporateClient;

	@Column(name = "CHK_RQT_FL_NM", columnDefinition = "nvarchar(300)")
	private String checkRequestFileName;
}
