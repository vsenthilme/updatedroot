...
public class MatterAssignmentIMMSpecification implements Specification<MatterAssignment> {
	
	SearchMatterAssignmentIMMReport searchMatterAssignment;
	
	public MatterAssignmentIMMSpecification(SearchMatterAssignmentIMMReport inputSearchParams) {
