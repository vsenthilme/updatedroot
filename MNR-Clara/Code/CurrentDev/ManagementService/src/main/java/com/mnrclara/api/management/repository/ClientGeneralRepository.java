...
public interface ClientGeneralRepository extends PagingAndSortingRepository<ClientGeneral, Long>, 
	...
	@Query(value = "select *, \n"
			...
			+ "CONCAT (cg.address_line1, ' ', cg.city, ' ', cg.state, ' ', cg.zip_code) AS addressLine1, \n"
	...
	//Get Client Name
	@Query (value = "SELECT first_last_nm \r\n"
			+ "FROM tblclientgeneralid \r\n"
			+ "WHERE CLIENT_ID = :clientId and is_deleted = 0 limit 1", nativeQuery = true)
	public String getClientName (@Param(value = "clientId") String clientId);
