        ...
        try {
            ...
            if (matterTimeTicketList != null && !matterTimeTicketList.isEmpty()) {
                matterTimeTicketList.forEach(data -> {
                    if (data.getBillType().equalsIgnoreCase("billable") && (data.getStatusId().equals(33L) || 
                    		data.getStatusId().equals(34L) || data.getStatusId().equals(46L) || data.getStatusId().equals(56L))
                        ...
                        data.setDefaultRate(matterRate.getAssignedRatePerHour());
