...
public class ClientGeneralService {
	...
	public ClientGeneral createClientGeneral(AddClientGeneral newClientGeneral, String loginUserID,
		...
		//PetitionerName set code
		if(dbClientGeneral.getCorporationClientId() != null && dbClientGeneral.getClientCategoryId() != null && dbClientGeneral.getClientCategoryId().equals(3L)) {
			String clientName = clientGeneralRepository.getClientName(dbClientGeneral.getCorporationClientId());
			dbClientGeneral.setPetitionerName(clientName);
		} else {
			if(dbClientGeneral.getReferenceField2() != null && !dbClientGeneral.getReferenceField2().isBlank()) {
				String clientName = clientGeneralRepository.getClientName(dbClientGeneral.getReferenceField2());
				dbClientGeneral.setPetitionerName(clientName);
			}
		}
	...
	public ClientGeneral updateClientGeneral(String clientGeneralId, UpdateClientGeneral updateClientGeneral,
		...
		if (!loginUserID.equalsIgnoreCase("QBUpdate")) {
			...
			dbClientGeneral.setUpdatedBy(dbClientGeneral.getUpdatedBy());
		}
