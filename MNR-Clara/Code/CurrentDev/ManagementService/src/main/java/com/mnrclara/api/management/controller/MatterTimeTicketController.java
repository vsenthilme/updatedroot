...
public class MatterTimeTicketController {
    ...
    @PatchMapping("/moveTimeTicket")
	public ResponseEntity<?> patchMatterTimeTicketTransfer (@Valid @RequestBody MatterTimeTicketTransfer matterTimeTicketTransfer, 
			@RequestParam String loginUserID) 
			throws IllegalAccessException, InvocationTargetException {
		List<MatterTimeTicket> updatedMatterTimeTicket = 
				matterTimeTicketService.transferTimeTickets(matterTimeTicketTransfer, loginUserID);
		return new ResponseEntity<>(updatedMatterTimeTicket , HttpStatus.OK);
	}
	...
	public ResponseEntity<?> deleteMatterTimeTicketTransfer (@Valid @RequestBody MatterTimeTicketDelete matterTimeTicketDelete, 
		...
		matterTimeTicketService.deleteTimeTickets(matterTimeTicketDelete, loginUserID);
		return new ResponseEntity<>(HttpStatus.OK);
	}
    ...
    public ResponseEntity<?> deleteMatterTimeTicket(List<String> timeTicketNumbers, @RequestParam String loginUserID) {
        matterTimeTicketService.deleteMatterTimeTickets(timeTicketNumbers, loginUserID);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
