...
//			return nextTime.plusHours(12);
	 ...
	 * @return
	 */
	public static LocalDateTime convertDateToLocalDateTime2(Date date, String timeFlag) {
		LocalDate sLocalDate =  LocalDate.ofInstant(date.toInstant(), ZoneId.systemDefault());
		log.info("--------input Date----------> " + sLocalDate);
		if (timeFlag.equalsIgnoreCase("START")) {
			log.info("--------conv Date--1--------> " + sLocalDate.atStartOfDay());
			...
			log.info("--------conv Date--2--------> " + sLocalDate.atTime(23, 59));
			return sLocalDate.atTime(23, 59);
		}
	}
	 ...
	 * @return
	 */
	public static LocalDateTime convertDateToLocalDateTimeCustomTime(Date date, Integer hours, Integer minutes) {
		LocalDate sLocalDate =  LocalDate.ofInstant(date.toInstant(), ZoneId.systemDefault());
		log.info("--------input Date----------> " + sLocalDate);
		log.info("--------conv Date--1--------> " + sLocalDate.atStartOfDay());
		return sLocalDate.atTime(hours, minutes);
	}
	...
	public static Date[] getPreviousWeekMondayAndFriday() throws Exception {
		...
		LocalDate previousFriday = today.with(TemporalAdjusters.previous(DayOfWeek.SATURDAY)) ;
		LocalDate previousWeekMonday = previousFriday.minusDays(6);
	 ...
	 * @return
	 */
//	public static LocalDateTime convertCDT2GMT1030 (LocalDateTime inputTime) {
//		inputTime = inputTime.plusDays(1);
//		//inputTime = inputTime.minusHours(10);
//		//inputTime = inputTime.minusMinutes(30);
//		log.info("-------convertCDT2GMT1030------ > : " + inputTime);
//		return inputTime;
//	}
	...
	public static String dateToString_YYYYMMDD (Date date) {
		if (date != null) {
			...
			String dateToStr = newDate.format(formatter);
			log.info("-------dateToString_YYYYMMDD------ > : " + dateToStr);
			return dateToStr;
		}
		return null;
	}
...
//		dateToString_YYYYMMDD (new Date());
