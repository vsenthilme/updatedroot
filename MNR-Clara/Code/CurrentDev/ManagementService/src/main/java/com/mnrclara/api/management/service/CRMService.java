...
//			e.printStackTrace();
	...
	public void setNotificationMessage(String topic, String documentNumber, String matterNo,
									   String matterDescription, String message, List<String> userId,
		...
		try {
			...
			notificationSave.setDocumentNumber(documentNumber);
			notificationSave.setMatterNo(matterNo);
			notificationSave.setMatterDesc(matterDescription);
