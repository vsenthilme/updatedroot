...
public class ARAgingReportSpecification implements Specification<InvoiceHeader> {
	 ...
	 */
	public ARAgingReportSpecification(SearchInvoiceHeaderARAgingReport inputSearchParams) {
