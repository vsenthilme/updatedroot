...
public class ManagementService {
	...
	public String sendNotification(Notification notification) {
		try {
			...
			restTemplate.setRequestFactory(new HttpComponentsClientHttpRequestFactory(client));
			UriComponentsBuilder builder =
					UriComponentsBuilder.fromHttpUrl(getManagementServiceUrl() + "/pushNotification" );
	...
	// Send Notification
	public String sendNotificationForQuotation(Notification notification) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "MNRClara's RestTemplate");
			...
			restTemplate.setRequestFactory(new HttpComponentsClientHttpRequestFactory(client));
			UriComponentsBuilder builder =
					UriComponentsBuilder.fromHttpUrl(getManagementServiceUrl() + "pushNotification/sendQuotationHeaderNo" );
