...
DynamicNativeQuery {
    ...
    @Query(value = "select  \n"
            ...
            + "mg.CASE_FILED_DATE as caseFiledDate, \n"
            ...
            + "(COALESCE(:fromCaseOpenDate) IS NULL OR (mg.case_open_date BETWEEN :fromCaseOpenDate AND :toCaseOpenDate)) and \n"
            + "(COALESCE(:fromCaseFiledDate) IS NULL OR (mg.case_filed_date BETWEEN :fromCaseFiledDate AND :toCaseFiledDate)) and \n"
    ...
    public List<MatterListingReportImpl> getAllMatterListing(
            ...
            @Param(value = "fromCaseOpenDate") Date fromCaseOpenDate,
            @Param(value = "toCaseOpenDate") Date toCaseOpenDate,
            @Param(value = "fromCaseFiledDate") Date fromCaseFiledDate,
            @Param(value = "toCaseFiledDate") Date toCaseFiledDate);
...
//			@Param(value = "timeKeeperCode") List<String> timeKeeperCode);
    ...
    @Query(value = "select \n" +
            ...
            "date_format(ed.expiration_date,'%m-%d-%Y') as sExpirationDate , date_format(ed.eligibility_date,'%m-%d-%Y') as sEligibilityDate , date_format(ed.approval_date,'%m-%d-%Y') as sApprovalDate , \n" +
