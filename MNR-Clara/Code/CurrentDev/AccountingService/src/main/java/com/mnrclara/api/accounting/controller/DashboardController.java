...
public class DashboardController {
	...
	public ResponseEntity<List<ARReportImpl>> getARReport (@RequestBody SearchAR requestData)
			throws Exception {
		List<ARReportImpl> data = dashboardService.getArReport(requestData);
		return new ResponseEntity<List<ARReportImpl>>(data, HttpStatus.OK);
	}
	...
	public ResponseEntity<List<BilledPaidFeesReportImpl>> getBilledPaidFeesReport (@RequestBody BilledPaidFees requestData)
			throws Exception {
		List<BilledPaidFeesReportImpl> data = dashboardService.getBilledPaidFeesReport(requestData);
		return new ResponseEntity<List<BilledPaidFeesReportImpl>>(data, HttpStatus.OK);
	}
