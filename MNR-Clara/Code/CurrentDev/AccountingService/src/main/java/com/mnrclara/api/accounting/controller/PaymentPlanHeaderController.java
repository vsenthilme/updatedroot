...
//	}
    @ApiOperation(response = PaymentPlanHeaderImpl.class, value = "Search PaymentPlanHeader") // label for swagger
	@PostMapping("/findPaymentPlanHeader")
	public List<PaymentPlanHeaderImpl> findPaymentPlanHeader(@RequestBody SearchPaymentPlanHeader searchPaymentPlanHeader)
			throws Exception {
		return paymentPlanHeaderService.findPaymentPlanHeaderNew(searchPaymentPlanHeader);
	}
