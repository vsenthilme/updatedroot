 ...
 */
@Table(
		name = "tblquotationline", 
		uniqueConstraints = { 
				@UniqueConstraint (
						name = "unique_key_quotationline", 
						columnNames = { "QUOTE_NO" , "QUTO_REV_NO" , "SERIAL_NO"})
				}
		)
@IdClass(QuotationLineCompositeKey.class)
