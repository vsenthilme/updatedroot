 ...
 */
//@Table(
//		name = "tblagreementtemplateid", 
//		uniqueConstraints = { 
//				@UniqueConstraint (
//						name = "unique_key_agreementtemplate", 
//						columnNames = { "LANG_ID", "CLASS_ID", "CASE_CATEGORY_ID", "AGREEMENT_CODE", "AGREEMENT_URL"})
//				}
//		)
//@IdClass(AgreementTemplateCompositeKey.class)
