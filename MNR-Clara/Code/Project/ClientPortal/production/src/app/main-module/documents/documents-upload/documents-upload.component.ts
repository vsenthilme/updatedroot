...
export class DocumentsUploadComponent implements OnInit {
  ...
  displayedColumns: string[] = ['uploadDate', 'partner', 'download', 'date', 'statusId','no', 'action'];
        ...
        .subscribe(event => {
          if (event instanceof HttpResponse) {
           ...
           // element['documentUrl'] = body.file;
            ...
            element.documentUrl = body.file;
            element.statusId =  upload == "upload" ? 60 : 63;
            element.uploadDateIndicator = true;
            // matterDocLine.push({
            ...
            // });
            obj.matterDocLists = this.dataSource.data;
