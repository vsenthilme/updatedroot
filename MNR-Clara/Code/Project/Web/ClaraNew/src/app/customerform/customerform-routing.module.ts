...
import { UploadThanksComponent } from "./upload-thanks/upload-thanks.component";
...
const routes: Routes = [
  ...
  { path: 'uploadDocuments/:code', component: UploadDocumentsComponent},
  ...
  { path: 'uploadThanks', component: UploadThanksComponent },
];
