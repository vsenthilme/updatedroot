...
export class InquiresService {
  ...
  DeleteuploadInquiry(code: any, id: any) {
    return this.http.delete<any>(`/mnr-crm-service/inquiryId/` + code + `?id=` + id);
  }

  CreateuploadInquiry(obj: any) {
    return this.http.post<any>('/mnr-crm-service/inquiryId/create', obj);
  }

  GetUploadInquiry(code: string) {
    return this.http.get<any>(`/mnr-crm-service/inquiryId/` + code);
  }
