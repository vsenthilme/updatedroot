...
export class ProspectiveClientComponent implements OnInit {
  ...
  // onBoardingStatusRefField3FE: [,],
    ...
    sendProspectiveFileDate:[],
    sstartProspectiveFileDate:[],
    sclientEndCreatedOn:[],
    sclientFromCreatedOn:[],
    //potentialClientIdFE: [,],
    retainedByRefField2: [,],
    endProspectiveFileDate:[this.cs.todayapi(),],
    startProspectiveFileDate:[new Date("01/01/00 00:00:00"),],
    clientEndCreatedOn:[],
    clientFromCreatedOn:[],
    followUpBy:[],
  ...
  this.form.controls.startProspectiveFileDate.patchValue(currentMonthStartDate);
  }
  ngAfterViewInit() {
 ...
 @ViewChild(MatSort) sort: MatSort;
  ...
  //   }
    this.form.controls.sstartProspectiveFileDate.patchValue(this.cs.dateNewFormat1(this.form.controls.startProspectiveFileDate.value));
    this.form.controls.sendProspectiveFileDate.patchValue(this.cs.dateNewFormat1(this.form.controls.endProspectiveFileDate.value));
    this.form.controls.sfromCreatedOn.patchValue(this.cs.dateNewFormat1(this.form.controls.fromCreatedOn.value));
    this.form.controls.stoCreatedOn.patchValue(this.cs.dateNewFormat1(this.form.controls.toCreatedOn.value));
    this.form.controls.sclientFromCreatedOn.patchValue(this.cs.dateNewFormat1(this.form.controls.clientFromCreatedOn.value));
    this.form.controls.sclientEndCreatedOn.patchValue(this.cs.dateNewFormat1(this.form.controls.clientEndCreatedOn.value));
    this.spin.show();
