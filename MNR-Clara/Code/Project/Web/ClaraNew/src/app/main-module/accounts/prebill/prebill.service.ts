...
export class PrebillService {
  ...
  transferMatter(obj){
    return this.http.patch<any>("/mnr-management-service/mattertimeticket/move", obj);
  }

  DeleteTimeTicket(obj) {
    return this.http.patch<any>('/mnr-management-service/mattertimeticket/deleteTimeTicket', obj);
  }
  Deleteexpense(matterExpenseId: any,) {
    return this.http.delete<any>('/mnr-management-service/matterexpense/' + matterExpenseId);
}
}
