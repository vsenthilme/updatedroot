...
this.form.controls.referenceField2.patchValue("");
  ...
  fill(data: any) {
    ...
    if (data.pageflow != 'New') {
      ...
      //  this.form.controls.suiteDoorNo.patchValue(res.addressLine2);
        ...
        this.form.controls.dateOfHireFE.patchValue(this.cs.day_callapiSearch(this.form.controls.dateOfHire.value));
  ...
  submit() {
 const phone =this.form.controls.contactNumber.value;
 console.log(phone.length)
 if(phone.length !=12){
  this.toastr.error(
    "Please Ensure Length of Contact Number is 12",
    "Notification", {
      timeOut: 2000,
      progressBar: false,
    }
  ...
  return;
    ...
    // }
    this.form.controls.dateOfHire.patchValue(this.cs.dateNewFormat(this.form.controls.dateOfHireFE.value));
