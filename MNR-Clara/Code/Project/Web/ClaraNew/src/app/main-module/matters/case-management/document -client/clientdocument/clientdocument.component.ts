...
export class ClientdocumentComponent implements OnInit {
  ...
  openDialog(pageflow: any = 'new'): void {
    ...
    const dialogRef = this.dialog.open(ChecklistPopupComponent, {
      ...
      maxWidth: '80%',
      position: { top: '6.5%' },
      data: { matterNumber: this.matterNumber, matterdesc: this.matterdesc, pageflow: pageflow, data: pageflow != 'New' ? this.selection.selected[0] : null }
    });
