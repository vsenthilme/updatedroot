...
export class TimeNewComponent implements OnInit {
  ...
  onChange(ob: MatCheckboxChange) {
    ...
    this.form.controls.clientNameFE.patchValue(null)
      ...
      if (this.form.controls.allmatters.value == true) {
        ...
        this.multimatterList.forEach(matter => {
          ...
          if ((this.data.matter != null) && matter.matterNumber == this.data.matter) {
            ...
            this.form.controls.clientNameFE.patchValue(matter.clientName);
  ...
  fill() {
    this.sub.add(this.service.Get(this.data.code).subscribe(res => { 
      ...
      this.form.controls.clientName.patchValue(this.form.controls.clientNameFE.value);
  ...
  submit() {
    ...
    if (this.data.pageflow == 'Copy') {
      if (this.ttbSelected == false) {
        this.form.controls.activityCode.reset();
        this.form.controls.taskCode.reset();
        this.form.controls.portalCreation.patchValue(true);
      }
    }
    ...
    // this.form.controls.approvedBillableTimeInHours.patchValue(this.form.controls.timeTicketHours.value);
    ...
    if (this.data.code && this.data.pageflow != 'Copy') {
      ...
      this.form.controls.approvedBillableAmount.patchValue(null);
      this.form.controls.approvedBillableTimeInHours.patchValue(null)
