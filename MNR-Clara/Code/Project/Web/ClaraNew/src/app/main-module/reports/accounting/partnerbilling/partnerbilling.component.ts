...
if(this.form.controls.referredBy.value != null){
  this.form.controls.referredBy.patchValue([this.form.controls.referredBy.value]);
}
    this.spin.show();
  ...
  getAllDropDown() {
    ...
    this.cas.getalldropdownlist([
      ...
      this.userIdList.forEach(user => {
        ...
        this.multireferralList=this.cas.removeDuplicatesFromArrayNew(this.multireferralList);
      })
