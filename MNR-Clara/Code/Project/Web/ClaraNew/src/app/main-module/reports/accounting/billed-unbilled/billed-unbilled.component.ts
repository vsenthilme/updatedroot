...
import { ReportServiceService } from "../../report-service.service";
  ...
  @Component({
    ...
    styleUrls: ['./billed-unbilled.component.scss']
  })
  ...
  thisDocumentType: any[] = [];
   ...
   @ViewChild(MatSort) sort: MatSort;
    ...
    filtersearch() {
      ...
      this.spin.show();
      this.sub.add(this.service.getBilledandNonBilled(this.form.getRawValue()).subscribe(res => {
let result : any[] = [];
        res.forEach(element => {
  ...
  email = new FormControl('', [Validators.required, Validators.email]);
    ...
    downloadexcel() {
      ...
      res.push({
        ...
        'Case Sub Category': '',
        'Timekeeper ': '',
        'Billable Hours' : this.billhrs(),
        'Non Billable Hours' : this.nonbillhrs(),
        'No Charge' : this.nocharhrs(),
        'Total Hours' : this.totalhrs(),

      });
      this.excel.exportAsExcel(res, "Billed and Unbilled");
    }
    billhrs() {
      let total = 0;
