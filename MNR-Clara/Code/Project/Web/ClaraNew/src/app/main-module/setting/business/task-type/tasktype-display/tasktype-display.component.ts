...
@Component({
  selector: 'app-tasktype-display',
  templateUrl: './tasktype-display.component.html',
  styleUrls: ['./tasktype-display.component.scss']
})
export class TasktypeDisplayComponent implements OnInit {
  screenid: 1034 | undefined;
  ...
  form = this.fb.group({
    ...
    taskTypeCode: [],
    taskTypeDescription: [, [Validators.required]],
    taskTypeStatus: ['Active', [Validators.required]],
  ...
  constructor(
    public dialogRef: MatDialogRef<TasktypeDisplayComponent>,
  ...
  submit() {
    ...
    if (this.data.code) {
      ...
      this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
        this.toastr.success(res.taskTypeCode + " saved successfully!", "Notification", {
          timeOut: 2000,
          progressBar: false,
        });
        this.spin.hide();
