...
export class RateListComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'timeKeeperCode', 'name', 'defaultRatePerHour', 'assignedRatePerHour', 'createdBy', 'createdOn'];//'statusIddes', status description commented on 23/09/2024 
