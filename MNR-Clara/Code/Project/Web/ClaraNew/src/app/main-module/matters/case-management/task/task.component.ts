...
export class TaskComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'taskNumber','taskName', 'taskAssignedTo','createdBy', 'screatedOn', 'sdeadlineDate', 'sreminderDate', 'statusIddes',];
  ...
  downloadexcel() {
    ...
    this.dataSource.data.forEach(x => {
      res.push({
        ...
        'Reminder Date ': x.sreminderDate,
        'Deadline Date ': x.sdeadlineDate,
        //   'Creation Date ': this.cs.dateapi(x.createdOn),   
      });
