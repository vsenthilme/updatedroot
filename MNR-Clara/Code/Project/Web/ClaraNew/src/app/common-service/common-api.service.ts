...
export class CommonApiService {
  ...
  dropdownlist: any = {
    setup: {
      ...
      userId: { url: this.setup + 'userProfile', key: { key: 'userId', value: 'fullName' } },
      ...
      caseSubcategoryId: { url: this.setup + 'caseSubcategory', key: { key: 'caseSubcategoryId', value: 'subCategory' } },
      ...
      taskTypeCode: { url: this.setup + 'taskType', key: { key: 'taskTypeCode', value: 'taskTypeDescription' + 'referenceField1' } },
      ...
      taskbasedCode: { url: this.setup + 'taskbasedCode', key: { key: 'taskCode', value: 'taskcodeDescription' } },
      expenseCode: { url: this.setup + 'expenseCode', key: { key: 'expenseCode', value: 'expenseCodeDescription' } },
      documentcode: { url: this.setup + 'documentTemplate', key: { key: 'documentNumber', value: 'documentFileDescription' } },
      documentno: { url: this.setup + 'documentTemplate', key: { key: 'documentNumber', value: 'documentNumber' } },
      ...
      glAccount: { url: this.setup + 'glmappingmaster', key: { key: 'glAccount', value: 'glAccount' } },
      itemNumber: { url: this.setup + 'glmappingmaster', key: { key: 'itemNumber', value: 'itemDescription' } },
      coa: { url: this.setup + 'chartOfAccounts', key: { key: 'accountNumber', value: 'accountDescription' } },
     
      //written for checklist no
      checklist: { url: this.setup + 'docchecklist', key: { key: 'checkListNo', value: 'checkListNo' } },
    },
    ...
    caseinfo:{
      caseinfoId: { url: this.management + 'leCaseInfoSheet', key: { key: 'id', value: 'id' } },
      caseinfoimmId: { url: this.management + 'immCaseInfoSheet', key: { key: 'id', value: 'id' } },
  },
    client: {
    ...
    matter: {
      matterNumber: { url: this.management + 'mattergenacc', key: { key: 'matterNumber', value: 'matterDescription' } },
      ...
      matterAssignment: { url: this.management + 'matterassignment', key: { key: 'matterNumber', value: 'matterNumber' } },

      billmodematter: { url: this.management + 'mattergenacc', key: { key: 'matterNumber', value: 'billingModeId' } },
      matterNumberList: { url: this.management + 'mattergenacc/dropdown/matter',  key: { key: 'matterNumber', value: 'matterDescription' } },
      matterNumberOpenList: { url: this.management + 'dropdown/matter/open',  key: { key: 'matterNumber', value: 'matterDescription' } },
      clientList: { url: this.management + 'mattergenacc/dropdown/matter',  key: { key: 'clientId', value: 'clientName' } },
      receiptappnotice: { url: this.management + 'receiptappnotice',  key: { key: 'receiptNo', value: 'receiptNo' } },
      dropdown: { url: this.management + 'mattergenacc/dropdown' },
      dropdownNew: {url: this.management + 'mattergenacc/dropdown/matterList'}
    ...
    crm: {
      ...
      pcIntakeForm: { url: this.crm + 'pcIntakeForm', key: { key: 'intakeFormNumber', value: 'intakeFormNumber' } },
    },

    accounting: {
      quotationNo: { url: this.accounting + 'quotationheader', key: { key: 'quotationNo', value: 'quotationNo' } },
      paymentPlanNumber: { url: this.accounting + 'paymentplanheader', key: { key: 'paymentPlanNumber', value: 'paymentPlanNumber' } },
      preBillBatchNumber: { url: this.accounting + 'prebilldetails/preBillNumber', key: { key: 'preBillBatchNumber', value: 'preBillBatchNumber' } },
      partnerAssigned: { url: this.accounting + 'prebilldetails/preBillNumber', key: { key: 'partnerAssigned', value: 'partnerAssigned' } },
      preBillNumber: { url: this.accounting + 'prebilldetails/preBillNumber', key: { key: 'preBillNumber', value: 'preBillNumber' } },
      invoiceNumber: { url: this.accounting + 'invoiceheader', key: { key: 'invoiceNumber', value: 'invoiceNumber' } },
      //newly written api
    },
  //newlycontrolgroup
    cgsetup: {
      language: { url: this.cgsetup + 'languageid', key: { key: 'languageId', value: 'languageDescription' } },
      country: { url: this.cgsetup + 'country', key: { key: 'countryId', value: 'countryName' } },
      company: { url: this.cgsetup + 'companyid', key: { key: 'companyId', value: 'description' } },
      state: { url: this.cgsetup + 'state', key: { key: 'stateId', value: 'stateName' } },
      city: { url: this.cgsetup + 'city', key: { key: 'cityId', value: 'cityName' } },
      controlgrouptype: { url: this.cgsetup + 'controlgrouptype', key: { key: 'groupTypeId', value: 'groupTypeName' } },
      client: { url: this.cgsetup + 'client', key: { key: 'clientId', value: 'clientName' } },
      client1: { url: this.cgsetup + 'client', key: { key: 'clientName' ,value:'clientName'} },
      controlgroup: { url: this.cgsetup + 'controlgroup', key: { key: 'groupId', value: 'groupName' } },
      subgrouptype: { url: this.cgsetup + 'subgrouptype', key: { key: 'subGroupTypeId', value: 'subGroupTypeName' } },
      versionno:{ url: this.cgsetup + 'controlgroup', key: { key: 'versionNumber'} },
      store:{ url: this.cgsetup + 'store', key: { key: 'storeId', value: 'storeName' } },
      status:{ url: this.cgsetup + 'status', key: { key: 'statusId', value: 'status' } },
      relationshipid:{ url: this.cgsetup + 'relationshipid', key: { key: 'relationShipId', value: 'description' } },
    },
  }
