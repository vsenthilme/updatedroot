...
//mugilan added
{ path: 'documenttab', component:  ClientdocumentComponent, pathMatch: 'full', data: { title: 'Document - Client Portal', module: 'Matter' } },
{ path: 'clientdocument', component: DocumentClientportalComponent, pathMatch: 'full', data: { title: 'Document - Client Portal', module: 'Matter' } },
