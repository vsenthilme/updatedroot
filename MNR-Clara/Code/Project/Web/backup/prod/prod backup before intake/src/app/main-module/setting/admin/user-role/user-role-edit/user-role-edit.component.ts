...
//documents
...

    {
      mainMenu: "Reports", Menu: [
        ...
        { screenId: 6, subScreenId: 1165, referenceField2: 'Accouting', referenceField1: "AR Aging", createUpdate: false, delete: false, view: true, },

        { screenId: 6, subScreenId: 1166, referenceField2: 'Accouting', referenceField1: "WIP Aged Report for Prebills Validation", createUpdate: false, delete: false, view: true, },
        
        { screenId: 6, subScreenId: 1172, referenceField2: 'Accouting', referenceField1: "Expiration", createUpdate: false, delete: false, view: true, },
        
        { screenId: 6, subScreenId: 1176, referenceField2: 'Accouting', referenceField1: "AR Report", createUpdate: false, delete: false, view: true, },
        
        { screenId: 6, subScreenId: 1177, referenceField2: 'Accouting', referenceField1: "Billed Paid Fees", createUpdate: false, delete: false, view: true, },

        { screenId: 6, subScreenId: 1178, referenceField2: 'Accouting', referenceField1: "Billed Unbilled", createUpdate: false, delete: false, view: true, },
        
        { screenId: 6, subScreenId: 1179, referenceField2: 'Accouting', referenceField1: "Billed Hours Paid", createUpdate: false, delete: false, view: true, },
                
        { screenId: 6, subScreenId: 1180, referenceField2: 'Accouting', referenceField1: "Client Cash Receipt", createUpdate: false, delete: false, view: true, },
        
        { screenId: 6, subScreenId: 1181, referenceField2: 'Accouting', referenceField1: "Client Income Summary", createUpdate: false, delete: false, view: true, },
        
        { screenId: 6, subScreenId: 1182, referenceField2: 'Accouting', referenceField1: "Write Off", createUpdate: false, delete: false, view: true, },
        
        { screenId: 6, subScreenId: 1183, referenceField2: 'Accouting', referenceField1: "Client Matter", createUpdate: false, delete: false, view: true, },
        
        
        { screenId: 6, subScreenId: 1184, referenceField2: 'Accouting', referenceField1: "Matter Rates", createUpdate: false, delete: false, view: true, },
        
        { screenId: 6, subScreenId: 1185, referenceField2: 'Accouting', referenceField1: "Billing", createUpdate: false, delete: false, view: true, },
  ...
  fill(data: any) {
    ...
    if (data.pageflow != 'New') {
      ...
      this.sub.add(this.service.Get(data.code).subscribe(res => {
        ...
        this.menuList.push({
          mainMenu: "Shortcuts",
          Menu: res.filter((x: any) => x.screenId == 7)
        });
        this.menuList.push({
          mainMenu: "Home",
