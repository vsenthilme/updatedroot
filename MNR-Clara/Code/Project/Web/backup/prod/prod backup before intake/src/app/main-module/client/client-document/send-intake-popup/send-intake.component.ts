...
export class SendIntakeComponent implements OnInit, OnDestroy {
  ...
  form = this.fb.group(
    {
      bodyText: ['<p><font size="2">Dear Field_1</font></p><p><font size="2"> Please find below the credentials of M&R Client Portal.&#160;</font></p><p><font size="2">https://mrclara.com/mnrclientapp/#/</font></a><br></p><p><font size="2">Please enter you registered Mobile Number and enter the OTP(One Time Received) received in your phone to login into the Appilcation.</font></a><br></p><p><font size="2">Thanks &amp; Regards,</font></p><p><font size="2">Team M&R</font></p>',
    ],
