...
//CLARA/AMS/2022/149 mugilan 12-10-222
        ...
        let roundedAssignedRate = (Math.round(((timeKeeper.timeTicketAmount / timeKeeper.timeTicketHours) * 100) / 100))
              stackArray.push({
                text: 'Timekeeper ' + timeKeeper.timeTicketName + ' worked ' + timeTickerHours + ' hours at ' + (timeKeeper.billType == 'nocharge' ? 'No Charge' : timeKeeper.timeTicketAmount != null && timeKeeper.timeTicketHours != null ? this.decimalPipe.transform(roundedAssignedRate, "1.2-2") : '$0.00') + (timeKeeper.billType != 'nocharge' ? ' per hour, totaling '+ '$ ' + timeTicketAmount : '') ,
                alignment: 'center',
                fontSize: 10,
                lineHeight: 1.3,
              })
