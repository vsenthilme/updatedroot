...
export class PaymentPlanComponent implements OnInit {
  ...
  screenid = 1136;
  displayedColumns: string[] = ['select', 'paymentPlanNumber', 'clientId', 'matterNumber', 'quotationNo', 'paymentPlanTotalAmount', 'noOfInstallment', 'statusIddes'];
  ...
  downloadexcel() {
    ...
    this.dataSource.data.forEach(x => {
      res.push({
        ...
        'Payment Plan Amount': x.paymentPlanTotalAmount,
