...
export class ExpenseDisplayComponent implements OnInit {
  ...
  form = this.fb.group({
    ...
    expenseCodeDescription: [, [Validators.required]],
    expenseCodeStatus: ['Active', [Validators.required]],
    costPerItem: [,],
    rateUnit: [,],
  ...
  constructor(
    public dialogRef: MatDialogRef<ExpenseDisplayComponent>,
  ...
  ngOnInit(): void {
    ...
    if (this.data.pageflow != 'New') {
      if (this.data.pageflow == 'Display')
        this.form.disable();
      this.fill();
      this.form.controls.expenseCode.disable();
     // this.form.controls.costType.disable();     commented by MK 2/3/22
