...
export class CaseassignmentListComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select','classId', 'matterNumber', 'clientId', 'clientName', 'partner', 'legalAssistant', 'caseCategoryId', 'originatingTimeKeeper', 'assignedTimeKeeper', 'responsibleTimeKeeper','referenceField2', 'referenceField1', 'statusIddes',];
