...
@Component({
  selector: 'app-clientcat-edit',
  templateUrl: './clientcat-edit.component.html',
  styleUrls: ['./clientcat-edit.component.scss']
})
export class ClientcatEditComponent implements OnInit, OnDestroy {
  ...
  form = this.fb.group({
    ...
    clientCategoryId: [],
    clientCategoryDescription: [, [Validators.required]],
  ...
  constructor(
    public dialogRef: MatDialogRef<ClientcatEditComponent>,
  ...
  ngOnInit(): void {
    ...
    if (this.data.pageflow != 'New') {
      if (this.data.pageflow == 'Display')
        this.form.disable();
      this.fill();
      this.form.controls.clientCategoryId.disable();
      this.form.controls.classId.disable();
      this.form.controls.languageId.disable();
    }
  }
  ...
  submit() {
    ...
    if (this.data.code) {
      this.sub.add(this.service.Update(this.form.getRawValue(), this.data.code).subscribe(res => {
        this.toastr.success(res.clientCategoryId + " updated successfully!","Notification",{
          timeOut: 2000,
          progressBar: false,
        });
        this.spin.hide();
      ...
      this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
        this.toastr.success(res.clientCategoryId + " saved successfully!", "Notification", {
          timeOut: 2000,
          progressBar: false,
        });
        this.spin.hide();
