...
@NgModule({
  ...
  declarations: [
    DialogExampleComponent, NotesComponent, CancelComponent, DeleteComponent, ScrollButtonComponent, NgMultiselectDropdownComponent,AddStringArrayPopupComponent,ShowStringPopupComponent, TimerComponent, LogoutPopupComponent, DownloadComponent
  ],
  exports: [
