...
import { IntakeService } from '../../intake-snap-main/intake.service.js';

import { Subscription } from 'rxjs';
import { FormService } from 'src/app/customerform/form.service.js';
import { EnglishService } from 'src/app/customerform/english/english.service.js';
import { CommonService } from 'src/app/common-service/common-service.service.js';
@Component({
  selector: 'app-englishintake',
  templateUrl: './englishintake.component.html',
  styleUrls: ['./englishintake.component.scss']
})
@Injectable({
  providedIn: 'root'
})

export class EnglishintakeComponent implements OnInit {
 ...
 description:any;
  ...
  //    { text: 'Monty & Ramirez LLP \n 150 W Parker Road, 3rd Floor Houston, TX 77076',  alignment: 'center', fontSize: 12, border: [false, false, false, false] },
    ...
    headerArray899.push([
      { text: 'Other Names Used', bold: true, fontSize: 10, border: [true, true, true, true] , borderColor: ['#808080', '#808080', '#808080', '#808080'] },
    ...
    headerArray896.push([
      { text: 'Country of Citizenship:  ', bold: true, fontSize: 10, border: [true, true, true, true] , borderColor: ['#808080', '#808080', '#808080', '#808080'] },
    ...
    headerArray895.push([
      { text: 'Marital Status ', bold: true, fontSize: 10, border: [true, true, true, true],  borderColor: ['#808080', '#808080', '#808080', '#808080'] },
    ...
    headerArray894.push([
      { text: 'If married or engaged, Comple', bold: true, fontSize: 10, border: [false, true, false, false] ,margin:[0,5,0,5], color:'#267FA0' , borderColor: ['#808080', '#808080', '#808080', '#808080'] },
      { text:  'te this section.', bold: true, fontSize: 10,  border: [false, true, true, false],margin:[-13,5,0,5], color:'#267FA0',  borderColor: ['#808080', '#808080', '#808080', '#808080'] },
