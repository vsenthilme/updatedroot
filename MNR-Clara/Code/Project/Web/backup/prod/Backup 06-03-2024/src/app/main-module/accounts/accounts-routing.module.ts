...
const routes: Routes = [
 ...
 // { path: 'expensesaccounts/:code', component: MatterExpenseComponent, pathMatch: 'full', data: { title: 'Expenses', module: 'Matter' } },
  { path: 'timeticket', component: TimeticketDiaryComponent, pathMatch: 'full', data: { title: 'Timeticket', module: 'Time Ticket Summary ' } },
  { path: 'timeticket/:code', component: TimeticketDiaryComponent, pathMatch: 'full', data: { title: 'Timeticket', module: 'Matter' } },

  
  { path: 'timeticket-users', component: TimeticketSummaryUsersComponent, pathMatch: 'full', data: { title: 'Timeticket', module: 'Matter' } },
  { path: 'timeticketreport', component: TimeticketreportComponent, pathMatch: 'full', data: { title: 'Timeticket Report', module: 'Matter' } },

  { path: 'payment', component: PaymentCrudComponent, pathMatch: 'full', data: { title: 'Accounting', module: 'Payment' } },
