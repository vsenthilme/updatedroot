...
@Component({
  selector: 'app-form009-spanish',
  templateUrl: './form009-spanish.component.html',
  styleUrls: ['./form009-spanish.component.scss']
})
export class Form009SpanishComponent implements OnInit, OnDestroy {
  screenid: 1123 | undefined;
  btntext = 'Submit';
  ...
  constructor(private fb: FormBuilder, private auth: AuthService, private cs: CommonService, private route: ActivatedRoute, private location: Location,
    private service: Form009Service,
