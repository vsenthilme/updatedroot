...
export class TimeTicketNewComponent implements OnInit {
  ...
  submit() {
    ...
    if (this.data.lines != null) {
      if (this.data.lines.activityCode && this.form.controls.activityCode.value == null && !this.form.controls.activityCode.value) {
        this.toastr.error(
...
this.form.controls.timeTicketAmount.patchValue(this.form.controls.approvedBillableAmount.value);
this.form.controls.timeTicketHours.patchValue(this.form.controls.approvedBillableTimeInHours.value);
