...
export class StatusEditComponent implements OnInit, OnDestroy {
  ...
  formgr: StatusElement | undefined;
  ...
  dropdownlist() {
    ...
    this.cas.dropdownlist.setup.transactionId.url]).subscribe((results) => {
      ...
      this.transactionIdList = this.cas.foreachlist(results[2], this.cas.dropdownlist.setup.transactionId.key);
