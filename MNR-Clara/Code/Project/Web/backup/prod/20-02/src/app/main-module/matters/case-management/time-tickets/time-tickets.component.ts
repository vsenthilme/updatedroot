...
export class TimeTicketsComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'timeTicketNumber', 'timeKeeperCode', 'createdOn', 'billType', 'timeTicketHours', 'defaultRate', 'approvedBillableAmount', 'statusIddes','referenceField1'];
