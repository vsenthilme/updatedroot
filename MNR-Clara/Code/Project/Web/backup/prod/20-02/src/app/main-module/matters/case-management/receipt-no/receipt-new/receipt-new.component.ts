...
export class ReceiptNewComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.form.controls.receiptDate.patchValue(this.cs.todayCallApi());
    this.form.controls.reminderDays.valueChanges.subscribe(x => { if (x) this.calculatdate(); });



    this.form.controls.eligibiltyDate.valueChanges.subscribe(x => {
      if (x) {
        this.calculatdate();
      }
    });
  ...
  calculatdate() {
    let reminderDate: Date = new Date(this.form.controls.eligibiltyDate.value);
  ...
  fill() {
    ...
    this.sub.add(this.service.Get(this.data.code.matterNumber, this.data.code.classId, this.data.code.receiptNo, this.data.code.languageId).subscribe(res => {
      ...
      this.form.controls.receiptDate.patchValue(this.cs.day_callapiSearch(this.form.controls.receiptDate.value));
      this.form.controls.receiptNoticeDate.patchValue(this.cs.day_callapiSearch(this.form.controls.receiptNoticeDate.value));
      this.form.controls.dateGovt.patchValue(this.cs.day_callapiSearch(this.form.controls.dateGovt.value));
      this.form.controls.eligibiltyDate.patchValue(this.cs.day_callapiSearch(this.form.controls.eligibiltyDate.value));
      this.form.controls.reminderDate.patchValue(this.cs.day_callapiSearch(this.form.controls.reminderDate.value));
      this.form.controls.expirationDate.patchValue(this.cs.day_callapiSearch(this.form.controls.expirationDate.value));
      this.form.controls.approvalDate.patchValue(this.cs.day_callapiSearch(this.form.controls.approvalDate.value));
      this.form.controls.approvalReceiptDate.patchValue(this.cs.day_callapiSearch(this.form.controls.approvalReceiptDate.value));
      this.form.controls.approvedOn.patchValue(this.cs.day_callapiSearch(this.form.controls.approvedOn.value));
...
if(this.form.controls.statusId.value == 10 && !this.form.controls.eligibiltyDate.value && this.form.controls.documentType.value != "FOIAS" && this.form.controls.documentType.value != "I-140s"){
...
//this.spin.show();
    ...
    this.form.controls.receiptDate.patchValue(this.cs.dateNewFormat(this.form.controls.receiptDate.value));
    this.form.controls.receiptNoticeDate.patchValue(this.cs.dateNewFormat(this.form.controls.receiptNoticeDate.value));
    this.form.controls.dateGovt.patchValue(this.cs.dateNewFormat(this.form.controls.dateGovt.value));

    this.form.controls.eligibiltyDate.patchValue(this.cs.dateNewFormat(this.form.controls.eligibiltyDate.value));
    ...
    this.form.controls.approvalReceiptDate.patchValue(this.cs.dateNewFormat(this.form.controls.approvalReceiptDate.value));
    this.form.controls.approvedOn.patchValue(this.cs.dateNewFormat(this.form.controls.approvedOn.value));
    ...
    // let nvp =
    //   "approvalDate=" + this.form.getRawValue().approvalDate + "&" +
    //   "approvalReceiptDate=" + this.form.getRawValue().approvalReceiptDate + "&" +
    //   "approvedOn=" + this.form.getRawValue().approvedOn + "&" +
    //   "classId=" + this.form.getRawValue().classId + "&" +
    //   "clientId=" + this.form.getRawValue().clientId + "&" +
    //   "createdBy=" + this.form.getRawValue().createdBy + "&" +
    //   "deletionIndicator=" + this.form.getRawValue().deletionIndicator + "&" +
    //   "documentType=" + this.form.getRawValue().documentType + "&" +
    //   "expirationDate=" + this.form.getRawValue().expirationDate + "&" +
    //   "languageId=" + this.form.getRawValue().languageId + "&" +
    //   "matterNumber=" + this.form.getRawValue().matterNumber + "&" +
    //   "receiptDate=" + this.form.getRawValue().receiptDate + "&" +
    //   "receiptFile=" + this.form.getRawValue().receiptFile + "&" +
    //   "receiptNo=" + this.form.getRawValue().receiptNo + "&" +
    //   "receiptNote=" + this.form.getRawValue().receiptNote + "&" +
    //   "receiptNoticeDate=" + this.form.getRawValue().receiptNoticeDate + "&" +
    //   "receiptType=" + this.form.getRawValue().receiptType + "&" +
    //   "referenceField1=" + this.form.getRawValue().referenceField1 + "&" +
    //   "referenceField10=" + this.form.getRawValue().referenceField10 + "&" +
    //   "referenceField2=" + this.form.getRawValue().referenceField2 + "&" +
    //   "referenceField3=" + this.form.getRawValue().referenceField3 + "&" +
    //   "referenceField4=" + this.form.getRawValue().referenceField4 + "&" +
    //   "referenceField5=" + this.form.getRawValue().referenceField5 + "&" +
    //   "referenceField6=" + this.form.getRawValue().referenceField6 + "&" +
    //   "referenceField7=" + this.form.getRawValue().referenceField7 + "&" +
    //   "referenceField8=" + this.form.getRawValue().referenceField8 + "&" +
    //   "referenceField9=" + this.form.getRawValue().referenceField9 + "&" +
    //   "reminderDate=" + this.form.getRawValue().reminderDate + "&" +
    //   "reminderDays=" + this.form.getRawValue().reminderDays + "&" +
    //   "statusId=" + this.form.getRawValue().statusId + "&" +
    //   "updatedBy=" + this.form.getRawValue().updatedBy;
