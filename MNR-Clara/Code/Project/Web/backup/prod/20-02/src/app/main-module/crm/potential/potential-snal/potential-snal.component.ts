...
this.multiselectInquirynoList = this.cas.removeDuplicatesFromArrayNew(this.multiselectInquirynoList);
  ...
  displayedColumns: string[] = ['select', 'action', 'status', 'potentialClientId', 'inquiryNumber', 'firstNameLastName', 'emailId', 'contactNumber', 'intake', 'agreement', 'notes', 'createdBy', 'createdOn',];
  ...
  search() {
    ...
    this.searhform.controls.econsultationDate.patchValue(this.cs.day_callapiSearch(this.searhform.controls.econsultationDate.value));
    this.searhform.controls.sconsultationDate.patchValue(this.cs.day_callapiSearch(this.searhform.controls.sconsultationDate.value));
