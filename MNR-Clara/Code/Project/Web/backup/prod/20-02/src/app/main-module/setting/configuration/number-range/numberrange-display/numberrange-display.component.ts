import { MessageEditComponent } from "../../../configuration/message-id/message-edit/message-edit.component";
...
@Component({
  selector: 'app-numberrange-display',
  templateUrl: './numberrange-display.component.html',
  styleUrls: ['./numberrange-display.component.scss']
})
export class NumberrangeDisplayComponent implements OnInit {
  screenid: 1046 | undefined;
  sub = new Subscription();
  email = new FormControl('', [Validators.required, Validators.email]);
  form = this.fb.group({
    createdBy: [this.auth.userID, [Validators.required]],
    classId: [, [Validators.required]],
    numberRangeStatus: [, [Validators.required]],
  ...
  ngOnInit(): void {
    ...
    this.dropdownlist();
    this.form.controls.numberRangeStatus.patchValue("Active");
  }
