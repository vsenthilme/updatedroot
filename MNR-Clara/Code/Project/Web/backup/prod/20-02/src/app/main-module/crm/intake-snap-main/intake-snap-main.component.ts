...
export class IntakeSnapMainComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'action', 'statusId_des', 'intakeFormNumber', 'intakeFormId_des', 'inquiryNumber','name', 'createdOn', 'email', 'notes', 'sentOn', 'receivedOn', 'approvedOn',];
