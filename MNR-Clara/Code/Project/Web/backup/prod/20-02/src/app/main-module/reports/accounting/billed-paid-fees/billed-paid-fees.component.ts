  ...
  thisDocumentType: any[] = [];
    ...
    displayedColumns: string[] = [
      ...
      'billAmount',
        ...
        'paidPercent', 
        'billYearToDate', 
        'billedPercentYearToDate', 
        'paidYearToDate',
        'paidPercentYearToDate',
    ];
    ...
    downloadexcel() {
      ...
      this.dataSource.data.forEach(x => {
        res.push({
          ...
          ' Billed' : x.billAmount,
          'Billed %' : x.billedPercent,
          'Paid' : x.paidAmount,
          'Paid %' : x.paidPercent,
          "Billed Year":x.billYearToDate,
          "Billed % Year":x.billedPercentYearToDate,
          "Paid Year":x.paidYearToDate,
          "Paid % Year":x.paidPercentYearToDate,
        });
  
      })
      this.excel.exportAsExcel(res, "Billed pai fees");
    }
