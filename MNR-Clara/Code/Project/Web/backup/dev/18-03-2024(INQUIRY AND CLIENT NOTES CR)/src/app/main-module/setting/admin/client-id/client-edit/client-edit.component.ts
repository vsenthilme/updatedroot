...
export class ClientEditComponent implements OnInit, OnDestroy {
  ...
  form = this.fb.group({
    ...
    clientTypeId: [],
    clientTypeDescription: [, [Validators.required]],
  ...
  constructor(
    ...
    private service: ClientIdService,
  ...
  submit() {
    ...
    if (this.data.code) {
      this.sub.add(this.service.Update(this.form.getRawValue(), this.data.code).subscribe(res => {
        this.toastr.success(res.clientTypeId + " updated successfully!","Notification",{
          timeOut: 2000,
          progressBar: false,
        });
        this.spin.hide();
      ...
      this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
        this.toastr.success(res.clientTypeId + " saved successfully!", "Notification", {
          timeOut: 2000,
          progressBar: false,
        });
        this.spin.hide();
