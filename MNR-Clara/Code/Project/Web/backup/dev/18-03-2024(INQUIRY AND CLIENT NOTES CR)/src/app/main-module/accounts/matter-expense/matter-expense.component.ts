...
export class MatterExpenseComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'action', 'expenseCode','matterExpenseId','clientid','matterno', 'referenceField6', 'referenceField5','referenceField1',  'expenseDescription', 'expenseAmount', 'statusIddes', 'referenceField2','screatedOn', 'createdBy',];
