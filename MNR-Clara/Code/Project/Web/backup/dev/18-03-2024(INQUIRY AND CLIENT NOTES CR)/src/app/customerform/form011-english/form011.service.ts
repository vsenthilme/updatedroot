...
export class Form011Service {
  ...
  //   return this.http.get<any>(this.apiName + 'matteritform000/id?classID=' + classID + '&matterNumber=' + matterNumber + '&itFormID=' + itFormID + '&itFormNo=' + itFormNo + '&language=' + itlanguage + '&clientId=' + clientId);
  // }


  //update get api  newly added
  Get(classID: any, matterNumber: any, itFormID: any, itFormNo: any, itlanguage: any, clientId: any) {
  ...
  // Get(classID: any, matterNumber: any, itFormID: any, itFormNo: any, itlanguage: any, clientId: any) {
  //   return this.http.get<any>(this.url + '/matteritform/id?classID=' + classID + '&matterNumber=' + matterNumber + '&itFormID=' + itFormID + '&itFormNo=' + itFormNo + '&language=' + itlanguage + '&clientId=' + clientId);
  // }
  // Create(obj: any) {
