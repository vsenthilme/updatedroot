...
@Component({
  selector: 'app-matters-email',
  templateUrl: './matters-email.component.html',
  styleUrls: ['./matters-email.component.scss']
})
export class MattersEmailComponent implements OnInit {
  ...
  id: string | undefined;
  constructor(public dialog: MatDialog, private auth: AuthService, private route: ActivatedRoute, private cs: CommonService) { }
  new(): void {
