...
@Component({
  selector: 'app-spanish-feedback',
  templateUrl: './spanish-feedback.component.html',
  styleUrls: ['./spanish-feedback.component.scss']
})
export class SpanishFeedbackComponent implements OnInit {
  form = this.fb.group({
  ...
  constructor(private fb: FormBuilder, private auth: AuthService, private cs: CommonService, private route: ActivatedRoute,
    private fservice: FormService,  private serivceIntake: IntakeService,
