...
endTime: any;
  ...
  ngOnInit(): void {
    ...
    this.form.controls.supdatedOn.disable();
    //inset my MK 2/3/22
...
this.getAllMatter();
    ...
    if (this.data.pageflow != 'New') {
      if (this.data.pageflow == 'Display') {
        this.form.disable();
        if((this.form.controls.startTime.value == '00:00')&&(this.form.controls.endTime.value == '23:59')){
          this.form.controls.wholeday.patchValue(true);
        }
  ...
  //Below Code for CR Done on 14/05/2024
  Checkday(){
    console.log(this.form.controls.wholeday.value);
    if(this.form.controls.wholeday.value == true){
    this.form.controls.startTime.patchValue('00:00');
    this.form.controls.endTime.patchValue('23:59');
    console.log(this.form.controls.startTime.value);
    console.log(this.form.controls.endTime.value);
    }
    else{
      this.form.controls.startTime.patchValue(this.cs.timepipe(this.form.controls.startTimeFE.value));
      this.form.controls.endTime.patchValue(this.cs.timepipe(this.form.controls.endTimeFE.value));
      console.log(this.form.controls.startTime.value);
      console.log(this.form.controls.endTime.value);
    }
  }
  ...
  fill() {
    ...
    this.sub.add(this.service.Get(this.data.code).subscribe(res => {
      ...
      console.log(this.form.controls.sdeadlineDate.value)
      this.form.controls.deadlineDate.patchValue(this.cs.day_callapiSearch(this.form.controls.sdeadlineDate.value))
      console.log(this.form.controls.deadlineDate.value)
      if (this.form.controls.taskEmailId.value) {
        ...
        this.form.controls.startTimeFE.patchValue((this.form.controls.startTime.value));
        this.form.controls.deadlineDate.patchValue(this.cs.day_callapiSearch(this.form.controls.sdeadlineDate.value))
        console.log(this.form.controls.deadlineDate.value)
        this.form.controls.reminderDate.patchValue(this.cs.day_callapiSearch(this.form.controls.sreminderDate.value))
        this.form.controls.createdOn.patchValue(this.cs.day_callapiSearch(this.form.controls.screatedOn.value))
        this.form.controls.updatedOn.patchValue(this.cs.day_callapiSearch(this.form.controls.supdatedOn.value))
        this.form.controls.endTimeFE.patchValue((this.form.controls.endTime.value));[]
        if((this.form.controls.startTimeFE.value == "00:00")&&(this.form.controls.endTimeFE.value == "23:59")){
          console.log(2)
          this.form.controls.wholeday.patchValue(true);
        }
...
//       });
  ...
  generateTimeOptions() {
    for (let h = 0; h < 24; h++) {
      for (let m = 0; m < 60; m++) { // Increment every minute
  ...
  submit() {
    ...
    this.form.removeControl('createdOn');
      ...
      this.form.controls.deadlineDate.patchValue(this.cs.day_callapiSearch(this.form.controls.deadlineDate.value));
    this.form.controls.reminderDate.patchValue(this.cs.day_callapiSearch(this.form.controls.reminderDate.value));
    this.form.controls.sdeadlineDate.patchValue(this.cs.day_callapiSearch(this.form.controls.deadlineDate.value));
    this.form.controls.sreminderDate.patchValue(this.cs.day_callapiSearch(this.form.controls.reminderDate.value))
    ...
    if (this.data.code) {
     ...
     if(this.form.controls.wholeday.value == true){
      ...
      console.log(this.form.controls.startTimeFE.value);
      console.log(this.form.controls.endTimeFE.value);
      (this.form.controls.startTime.patchValue(this.cs.timepipe(this.form.controls.startTimeFE.value)));
console.log(this.form.controls.startTimeFE.value);
       this.form.controls.startTime.patchValue(this.cs.timepipe(this.form.controls.startTimeFE.value));
     this.form.controls.endTime.patchValue(this.cs.timepipe(this.form.controls.endTimeFE.value));
