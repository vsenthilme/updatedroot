...
const routes: Routes = [
  ...
  { path: 'general/:code', component: GeneralListComponent, pathMatch: 'full', data: { title: 'General', module: 'Matter' } },
 ...
 { path: 'document_template/:pageType/:code', component: MatterdocumentSendComponent, pathMatch: 'full', data: { title: 'Document', module: 'Matter' } },
  ...
  {path: 'expenses/chequerequest/:code', component: ExpensesChequeComponent, pathMatch: 'full', data: { title: 'Accounting', module: 'Matter' } },

  { path: 'shortcuts', component: ShortcutsComponent, pathMatch: 'full', data: { title: 'Favourites', module: 'Favourites' } },
  {
    path: '',
