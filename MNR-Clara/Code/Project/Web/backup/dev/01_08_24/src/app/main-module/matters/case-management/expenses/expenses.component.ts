...
export class ExpensesComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'action', 'expenseCode', 'download', 'referenceField5', 'expenseType', 'expenseDescription', 'expenseAmount', 'statusIddes', 'checkRequestStatus','sreferenceField2','createdOn', 'createdBy','referenceField1',];
  ...
  ngOnInit(): void {
    ...
    if(this.auth.userTypeId == 7){
      this.displayedColumns = ['select', 'action', 'expenseCode', 'download', 'referenceField5', 'expenseType', 'expenseDescription', 'expenseAmount', 'statusIddes', 'checkRequestStatus', 'sreferenceField2','createdOn', 'createdBy','referenceField1',];
    }else{
      this.displayedColumns = ['select', 'action', 'expenseCode', 'referenceField5', 'expenseType', 'expenseDescription', 'expenseAmount', 'statusIddes', 'checkRequestStatus', 'sreferenceField2','createdOn', 'createdBy','referenceField1',];
    }
