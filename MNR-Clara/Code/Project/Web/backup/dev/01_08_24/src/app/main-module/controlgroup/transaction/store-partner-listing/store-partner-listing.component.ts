...
export class StorePartnerListingComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'clientDoc','document', 'groupId', 'groupTypeId', 'storeId', 'createdBy', 'createdOn',];
  ...
  viewUpload(element): void {
    const dialogRef = this.dialog.open(UploadFilesComponent, {
      ...
      width: '60%',
      maxWidth: '80%',
      data: {line: element,code:element.requestId,storeId:element.storeId, pageflow: 'summaryView'}
    });
    dialogRef.afterClosed().subscribe(result => {
  ...
  downloadexcel() {
    ...
    this.dataSource.data.forEach(x => {
      ...
      //"Sub Group Type":x.subGroupId+'-'+x.subGroupName,
        ...
        "RelationShip1":(x.relationShipId1+'-'+x.relationShipName1) == 'null-null' ?'':(x.relationShipId1+'-'+x.relationShipName1),
        "Co-Owner Percentage 1": x.coOwnerPercentage1 == 0 ? '' : x.coOwnerPercentage1,
        
        "Co-Owner2":((x.coOwnerId2 == null ? '': x.coOwnerId2 + ' - ' )+ (x.coOwnerName2 == null ? ' ':x.coOwnerName2)) ,
        "RelationShip2":(x.relationShipId2+'-'+x.relationShipName2) == 'null-null' ?'':(x.relationShipId2+'-'+x.relationShipName2),
        "Co-Owner Percentage 2":x.coOwnerPercentage2 == 0 ? '' : x.coOwnerPercentage2,
        
        "Co-Owner3": (x.coOwnerId3 == null ? '': x.coOwnerId3 + ' - ' )+ (x.coOwnerName3 == null ? ' ':x.coOwnerName3),
        "RelationShip3":(x.relationShipId3+'-'+x.relationShipName3) == 'null-null' ?'':(x.relationShipId3+'-'+x.relationShipName3),
        "Co-Owner Percentage 3": x.coOwnerPercentage3 == 0 ? '' : x.coOwnerPercentage3,
        
        "Co-Owner4": (x.coOwnerId4 == null ? '' : x.coOwnerId4 + ' - ') + (x.coOwnerName4 == null ? '' : x.coOwnerName4),
        "RelationShip4":(x.relationShipId4+'-'+x.relationShipName4) == 'null-null' ?'':(x.relationShipId4+'-'+x.relationShipName4),
        "Co-Owner Percentage 4": x.coOwnerPercentage4 == 0 ? '' : x.coOwnerPercentage4,
        
        "Co-Owner5": (x.coOwnerId5 == null ? '': x.coOwnerId5 + ' - ') + (x.coOwnerName5 == null ? '': x.coOwnerName5),
        "RelationShip5":(x.relationShipId5+'-'+x.relationShipName5) == 'null-null' ?'':(x.relationShipId5+'-'+x.relationShipName5),
        "Co-Owner Percentage 5": x.coOwnerPercentage5 == 0 ? '' : x.coOwnerPercentage5,

        "Co-Owner6": (x.coOwnerId6== null ? ' ' : x.coOwnerId6 + ' - ') + (x.coOwnerName6 ==null ? '':x.coOwnerName6),
        "RelationShip6":(x.relationShipId6+'-'+x.relationShipName6) == 'null-null' ?'':(x.relationShipId6+'-'+x.relationShipName6),
        "Co-Owner Percentage 6": x.coOwnerPercentage6 == 0 ? '' : x.coOwnerPercentage6,

        "Co-Owner7": (x.coOwnerId7 == null ? '':x.coOwnerId7 + ' - ' )+(x.coOwnerName7 == null ? '':x.coOwnerName7),
        "RelationShip7":(x.relationShipId7+'-'+x.relationShipName7) == 'null-null' ?'':(x.relationShipId7+'-'+x.relationShipName7),
        "Co-Owner Percentage 7": x.coOwnerPercentage7 == 0 ? '' : x.coOwnerPercentage7,

        "Co-Owner8": (x.coOwnerId8 == null ? '': x.coOwnerId8 + ' - ' )+ (x.coOwnerName8 == null ? ' ':x.coOwnerName8),
        "RelationShip8":(x.relationShipId8+'-'+x.relationShipName8) == 'null-null' ?'':(x.relationShipId8+'-'+x.relationShipName8),
        "Co-Owner Percentage 8": x.coOwnerPercentage8 == 0 ? '' : x.coOwnerPercentage8,

        "Co-Owner9": (x.coOwnerId9 == null ? '': x.coOwnerId9 + ' - ' )+ (x.coOwnerName9 == null ? ' ':x.coOwnerName9),
        "RelationShip9":(x.relationShipId9+'-'+x.relationShipName9) == 'null-null' ?'':(x.relationShipId9+'-'+x.relationShipName9),
        "Co-Owner Percentage 9": x.coOwnerPercentage9 == 0 ? '' : x.coOwnerPercentage9,

        "Co-Owner10": (x.coOwnerId10 == null ? '': x.coOwnerId10 + ' - ' )+ (x.coOwnerName10 == null ? ' ':x.coOwnerName10),
        "RelationShip10":(x.relationShipId10+'-'+x.relationShipName10) == 'null-null' ?'':(x.relationShipId10+'-'+x.relationShipName10),
