...
export class ExpenseNewComponent implements OnInit {
  ...
  form = this.fb.group({
    ...
    referenceField3: [],
    sreferenceField2:[,Validators.required],
    referenceField4: [],
    referenceField5: [],
    referenceField6: [],
    referenceField7: [],
  ...
  constructor(
    public dialogRef: MatDialogRef<ExpenseNewComponent>,
  ...
  fill() {
    ...
    this.sub.add(this.service.Get(this.data.code).subscribe(res => {
      ...
      this.form.controls.createdOn.patchValue(this.cs.dateapi(this.form.controls.createdOn.value));
      this.form.controls.updatedOn.patchValue(this.cs.dateapi(this.form.controls.updatedOn.value));
      this.form.controls.referenceField2.patchValue(this.cs.day_callapiSearch(this.form.controls.sreferenceField2.value));
      console.log(this.form.controls.sreferenceField2.value)
      this.spin.hide();
    }, err => {
  ...
  getMatterDetails() {
    ...
    this.spin.show();
    if(this.data.pageflow == 'New'){
    this.sub.add(this.matterService.Get(this.data.approval.code.matterNumber).subscribe(res => {
  ...
  submit() {
    ...
    this.spin.show();
      ...
      this.form.controls.sreferenceField2.patchValue(this.cs.dateNewFormat1(this.form.controls.referenceField2.value))
...
console.log(this.form.controls.expenseAmount.value)
    ...
    if (this.data.code) {
      ...
      this.form.controls.statusId.patchValue(this.data.approval.pageflow.statusId);
      this.form.controls.referenceField1.patchValue(this.data.approval.code.preBillNumber);
