...
export class TimeticketDiaryComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'clientId', 'matterNumber', 'stimeTicketDate', 'timeTicketDescription', 'approvedBillableTimeInHours', 'approvedBillableAmount', 'timeTicketHours', 'timeTicketAmount', 'defaultRate', 'timeKeeperCode', 'taskCode', 'activityCode', 'billType', 'timeTicketNumber', 'statusIddes', 'screatedOn', 'classId',];
