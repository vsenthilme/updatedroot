...
export class CompanyNewComponent implements OnInit {
  ...
  dropdownlist() {
    ...
    this.cas.getalldropdownlist([
      ...
      console.log(this.auth.languageId);
      this.spin.hide();
    }, (err) => {
  ...
  submit() {
    ...
    if (this.data.code) {
      this.sub.add(this.service.Update(this.form.getRawValue(), this.data.code, this.data.languageId).subscribe(res => {
        this.toastr.success(res.companyId + " Company Id updated successfully!", "Notification", {
          timeOut: 2000,
          progressBar: false,
        });
        this.spin.hide();
      ...
      this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
        this.toastr.success(res.companyId + " Company Id saved successfully!", "Notification", {
          timeOut: 2000,
          progressBar: false,
        });
        this.spin.hide();
