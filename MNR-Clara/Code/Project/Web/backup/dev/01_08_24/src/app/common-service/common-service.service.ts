...
export class CommonService {
  ...
  dateapiWithTimeCS(date: any) {
    const del_date = this.datepipe.transform(date, "MM-dd-yyyy HH:mm:ss", "GMT-05:00");
    return del_date;
  }
  ...
  timeFormat(date: any) {
    const del_date = this.datepipe.transform(date, 'HH_mm a');
    return del_date;
  }
  ...
  day_callDayLight(date: any) {
    const del_date = this.datepipe.transform(date, 'yyyy-MM-ddT00:00:00.000', "UTC-05:00");
    return del_date;
  }
