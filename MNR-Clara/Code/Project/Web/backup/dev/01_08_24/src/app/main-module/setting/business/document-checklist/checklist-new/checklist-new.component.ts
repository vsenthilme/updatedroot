...
export class ChecklistNewComponent implements OnInit {
  ...
  dropdownlist() {
    ...
    this.cas.getalldropdownlist([
      ...
      if (this.data.type == 'EditfromMatter') {
        let filterObj: any = {};
        filterObj.caseCategoryId = [this.data.documentData.caseCategoryId];
        filterObj.caseSubCategoryId = [this.data.documentData.caseSubCategoryId];
        filterObj.classId = [this.data.documentData.classId];
  ...
  saveDocuments() {
    ...
    if(this.data.type == 'Edit' || this.data.type == 'EditfromMatter'){
      let documentArray: any[] = [];
      ...
      this.sub.add(this.service.updateChecklistDocument(this.data.documentData.checkListNo, documentArray).subscribe(res => {
        console.log(res)
