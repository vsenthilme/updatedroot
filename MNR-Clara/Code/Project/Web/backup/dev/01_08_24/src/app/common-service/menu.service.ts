...
export class MenuService {
  ...
  },
  {
    ...
    id: 7,
    children: [{
      displayName: 'Controlled Group Setup',
...

  {
    ...
    children: [
      ...
      {
        displayName: 'Time Entry Compliance Report',
        iconName: 'fas fa-calendar-check mx-2 mr-3 font_1-5',
        id: 1196,
        route: 'accounts/timeticketreport',
        disabled: false,
      },
...

  {
    ...
    },
    {
      ...
      {
        displayName: 'Academy Report',
        iconName: 'far fa-calendar-alt mx-2 mr-3 font_1-5',
        route: '/main/reports/academy',
        id: 1195,
        disabled: false,
      },
      ],
    },
    {
      ...
      {
        displayName: 'Partner Billing',
        iconName: 'fas fa-money-bill-alt mx-2 mr-3 font_1-5',
        route: '/main/reports/partnerbilling',
        id: 1194,
        disabled: false,
      },
      {
    ...
    },
    {
      ...
      {
        displayName: 'Attorney Productivity',
        iconName: 'fas fa-chart-line mx-2 mr-3 font_1-5',
