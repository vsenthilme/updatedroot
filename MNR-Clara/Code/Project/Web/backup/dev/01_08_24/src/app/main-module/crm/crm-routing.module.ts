...
import { UploadDocumentsComponent } from "src/app/customerform/upload-documents/upload-documents.component";
...
const crmroutes: Routes = [
  ...
  { path: 'uploadDocuments/:code', component: UploadDocumentsComponent, data: { title: 'English' } },
