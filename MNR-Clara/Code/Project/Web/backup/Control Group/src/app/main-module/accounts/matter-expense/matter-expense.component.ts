...
export class MatterExpenseComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'action', 'expenseCode','matterExpenseId','clientid','matterno', 'referenceField5','referenceField1',  'expenseDescription', 'expenseAmount', 'statusIddes', 'sreferenceField2','screatedOn', 'createdBy',];
