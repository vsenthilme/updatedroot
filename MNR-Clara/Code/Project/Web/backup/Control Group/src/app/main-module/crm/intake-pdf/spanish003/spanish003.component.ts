...
export class Spanish003Component implements OnInit {
  ...
  generatePdf(element: any, intakeRes: any) {
    var dd: any;
    let headerTable: any[] = [];
  ...
  //    { text: 'Monty & Ramirez LLP \n 150 W Parker Road, 3rd Floor Houston, TX 77076',  alignment: 'center', fontSize: 12, border: [false, false, false, false] },
       { text:   'PC - Information Sheet - '+ element.intakeFormNumber, bold: true, alignment: "right", fontSize: 13, margin:[20,0,0], border: [false, false, false, false],color:'#666362' },
     ]);
