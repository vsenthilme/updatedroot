 ...
 if(this.filteredclientId){
  ...
  dropdownlist(js?:any) {
    ...
    this.cas.getalldropdownlist([
      ...
      this.multiselectclientList = this.cas.removeDuplicatesFromArrayNew(this.multiselectclientList)
      ...
      this.multiselectcaseList = this.cas.removeDuplicatesFromArrayNew(this.multiselectcaseList)
