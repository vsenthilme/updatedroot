...
import { ConfirmComponent } from "./dialog_modules/confirm/confirm.component";
import { DeletenewComponent } from './dialog_modules/deletenew/deletenew.component';
...
@NgModule({
  ...
  declarations: [
    DialogExampleComponent, NotesComponent, CancelComponent, DeleteComponent, ScrollButtonComponent, NgMultiselectDropdownComponent,AddStringArrayPopupComponent,ShowStringPopupComponent, TimerComponent, LogoutPopupComponent, DownloadComponent, ConfirmComponent, DeletenewComponent
  ],
  exports: [
