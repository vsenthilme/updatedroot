...
export class BrotherSisterTemplateComponent implements OnInit {
  ...
  displayedColumns = ['coOwnerName', 'store1','store2', 'store3', 'store4', 'store5', 'store6', 'store7', 'Effective'];
  ...
  ngOnInit(): void {
    ...
    this.formatResult();
    this.displayedColumns = ['coOwnerName', 'store1','store2', 'store3', 'store4', 'store5','store6', 'store7',];
    ...
    if(this.js.pageflow == 'Display'){
      ...
      this.displayedColumns = ['coOwnerName', 'store1','store2', 'store3', 'store4', 'store5','store6', 'store7','Effective'];
    }
  }
  ...
  findStorePartner(){
    ...
    this.storePartner.searchStoreMatchNew(searchObj).subscribe(res => {
      //if(this.js.pageflow != 'Display'){
        let result = res.exactBrotherSisterResults.filter(x => x.storeId != this.js.code.storeId)
...
formatResult(){
  console.log('lines', this.js.code)
  let obj: any = {};

  ELEMENT_DATA.exactMatchResult.forEach((clientName, i) => {
    let result = clientName.store.filter(x => x.storeId != this.js.code.storeId);
    result.forEach((stores, j) => {
