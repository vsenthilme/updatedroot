...
export class LeadconversionComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'inquiryNumber', 'inquiyDate', 'inquiryAssignedToRefField4', 'firstNameLastName', 'contactNumber', 'email', 'modeOfInquiry', 'listOfMediumAboutFirm', 'intakeFormReceived', 'consultationDate', 'consultingAttorney', 'statusId', 'orginalInquiryObjective', 'createdOn'];
  ...
  downloadexcel() {
    ...
    this.dataSource.data.forEach(x => {
      res.push({
        ...
        'Referral': x.listOfMediumAboutFirm,
