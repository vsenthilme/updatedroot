...
export class ProspectiveClientComponent implements OnInit {
  ...
  form = this.fb.group({
    ...
    sfromCreatedOn: [new Date("01/01/00 00:00:00"), [Validators.required]],
    stoCreatedOn: [this.cs.todayapi(), [Validators.required]],
    referralId: [,],
    //referralIdFE: [,],
  ...
  // onBoardingStatusRefField3FE: [,],
    ...
    fromCreatedOn: [],
    toCreatedOn: [],
    sendProspectiveFileDate:[this.cs.todayapi(),],
    sstartProspectiveFileDate:[new Date("01/01/00 00:00:00"),],
    sclientEndCreatedOn:[],
    sclientFromCreatedOn:[],
    //potentialClientIdFE: [,],
    retainedByRefField2: [,],
    endProspectiveFileDate:[],
    startProspectiveFileDate:[],
    clientEndCreatedOn:[],
    clientFromCreatedOn:[],
    followUpBy:[],
  ...
  displayedColumns: string[] = ['select', 'classId', 'potentialClientId', 'firstNameLastName','inquiryNumber','clientCreatedDate','consulationDate','prospectiveFileDate', 'addressLine1', 'contactNumber','objectiveOfVisit',  'emailId', 'referralId', 'referenceField2',  'referenceField4', 'statusId', 'onboardingStatus','socialSecurityNo'];
  ...
  this.form.controls.sfromCreatedOn.patchValue(currentMonthStartDate);
  this.form.controls.sstartProspectiveFileDate.patchValue(currentMonthStartDate);
  }
  ngAfterViewInit() {
 ...
 @ViewChild(MatSort) sort: MatSort;
  ...
  onItemSelect(item: any, type?: any) {
    ...
    obj.statusId = [11,17,19,20];
    this.form.controls.sfromCreatedOn.patchValue(this.cs.day_callapiSearch(this.form.controls.sfromCreatedOn.value));
    this.form.controls.stoCreatedOn.patchValue(this.cs.day_callapiSearch(this.form.controls.stoCreatedOn.value));
    obj.sfromCreatedOn="2000-01-01";
    obj.stoCreatedOn=this.form.controls.stoCreatedOn.value;
      this.sub.add(this.service.getPotentialClientReport(obj).subscribe(res => {
        res.forEach((x: any) => {
          if (x.referenceField4 != null) {
            this.multifollowup.push({ value: x.referenceField4, label: x.referenceField4 });
          }
        });
        this.multifollowup = this.cs.removeDuplicateInArray(this.multifollowup);
  ...
  filtersearch() {
    ...
    // }
  //  if(this.form.controls.potentialClientId.value.length === 0){
  //   this.form.controls.potentialClientId.patchValue(null);
  //  }
  //   if(this.form.controls.referralId.value.length === 0){
  //    this.form.controls.referralId.patchValue(null);
  //   }
    this.form.controls.sstartProspectiveFileDate.patchValue(this.cs.dateNewFormat1(this.form.controls.sstartProspectiveFileDate.value));
    this.form.controls.sendProspectiveFileDate.patchValue(this.cs.dateNewFormat1(this.form.controls.sendProspectiveFileDate.value));
    this.form.controls.sfromCreatedOn.patchValue(this.cs.dateNewFormat1(this.form.controls.sfromCreatedOn.value));
    this.form.controls.stoCreatedOn.patchValue(this.cs.dateNewFormat1(this.form.controls.stoCreatedOn.value));
    this.form.controls.sclientFromCreatedOn.patchValue(this.cs.dateNewFormat1(this.form.controls.sclientFromCreatedOn.value));
    this.form.controls.sclientEndCreatedOn.patchValue(this.cs.dateNewFormat1(this.form.controls.sclientEndCreatedOn.value));
    this.spin.show();
  ...
  downloadexcel() {
    ...
    this.dataSource.data.forEach(x => {
      res.push({
        ...
        "Inquiry":x.inquiryNumber,
        "Client Created Date":(x.sclientCreatedDate),
        "Consultation Date":(x.sconsulationDate),
        "Prospective File Date":x.sprospectiveFileDate,
