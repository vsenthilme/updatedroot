...
thisDocumentType: any[] = [];
 ...
 @ViewChild(MatSort) sort: MatSort;
  ...
  filtersearch() {
    ...
    this.form.controls.stoCaseFiledDate.patchValue(this.cs.dateNewFormat1(this.form.controls.stoCaseFiledDateFE.value));
    this.form.controls.sfromCaseFiledDate.patchValue(this.cs.dateNewFormat1(this.form.controls.sfromCaseFiledDateFE.value));
    this.form.controls.stoCaseOpenDate.patchValue(this.cs.dateNewFormat1(this.form.controls.stoCaseOpenDateFE.value));
    this.form.controls.sfromCaseOpenDate.patchValue(this.cs.dateNewFormat1(this.form.controls.sfromCaseOpenDateFE.value));
    this.spin.show();
  ...
  downloadexcel() {
    ...
    this.dataSource.data.forEach(x => {
      res.push({
        ...
        'Matter Filed Date' : this.cs.dateapiutc0(x.caseFiledDate),
