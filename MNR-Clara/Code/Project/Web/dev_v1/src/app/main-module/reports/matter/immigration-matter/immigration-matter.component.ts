...
export class ImmigrationMatterComponent implements OnInit {
  ...
  form = this.fb.group({
    ...
    fromCaseOpenDateFE: [new Date("01/01/00 00:00:00"), [Validators.required]],
    toCaseOpenDateFE: [this.cs.todayapi(), [Validators.required]],
    fromCaseClosedDateFE: [,],
    toCaseClosedDateFE: [,],
    sfromCaseClosedDate: [,],
    sfromCaseOpenDate: [,],
    stoCaseClosedDate: [,],
  ...
  this.form.controls.fromCaseOpenDateFE.patchValue(currentMonthStartDate);
  }
  ...
  filtersearch() {
    ...
    obj.searchMatterIMMReport.sfromCaseOpenDate = this.cs.dateNewFormat(this.form.controls.fromCaseOpenDateFE.value);
    obj.searchMatterIMMReport.stoCaseOpenDate = this.cs.dateNewFormat(this.form.controls.toCaseOpenDateFE.value);
    obj.searchMatterIMMReport.sfromCaseClosedDate = this.cs.dateNewFormat(this.form.controls.fromCaseClosedDateFE.value);
    obj.searchMatterIMMReport.stoCaseClosedDate = this.cs.dateNewFormat(this.form.controls.toCaseClosedDateFE.value);
