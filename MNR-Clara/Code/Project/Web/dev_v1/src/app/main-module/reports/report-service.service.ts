...
export class ReportServiceService {
  ...
  getAcademyReport(obj:any){
    return this.http.post<any>('/mnr-management-service/mattergenacc/academicReport', obj);
  }
  ...
  getBillingPartnerReport(obj: any) {
    return this.http.post<any>('/mnr-accounting-service/invoiceheader/partnerBillingReport', obj);
  }
}
