...
export class MatterExpenseComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'action', 'expenseCode','matterExpenseId','clientid','matterno', 'referenceField6', 'referenceField5','referenceField1',  'expenseDescription', 'expenseAmount', 'statusIddes', 'sreferenceField2','screatedOn', 'createdBy',];
  ...
  getall(excel: boolean = false) {
    ...
    this.cas.getalldropdownlist([
     ...
     this.cas.dropdownlist.matter.dropdown.url,
      ...
      console.log(results[2].clientNameList)
  ...
  downloadexcel() {
    ...
    this.dataSource.data.forEach(x => {
      res.push({
        ...
        "Matter Description": x.referenceField6,
 ...
 //   this.searhform.controls.matterNumber.patchValue(this.matterno);
    ...
    this.searhform.controls.endCreatedOn.patchValue(this.cs.dateNewFormat1(this.searhform.controls.sEndCreatedOn.value));
    this.searhform.controls.startCreatedOn.patchValue(this.cs.dateNewFormat1(this.searhform.controls.sStartCreatedOn.value));
  ...
  post(data: any) {
    this.spin.show();
    data.statusId = 37;
    data.sreferenceField2=(this.cs.dateNewFormat1(data.referenceField2))
  ...
  openChequeRequest(element, pageflow: any) {
    let paramdata = "";
    paramdata = this.cs.encrypt({pageflow: pageflow,data: element, description: element.referenceField6})
