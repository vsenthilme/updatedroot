...
console.log(data);
    if (data.pageflow != 'New') {
      ...
      this.form.controls.invoiceDateFE.patchValue(this.cs.day_callapiSearch(this.form.controls.invoiceDate.value));
      this.form.controls.postingDateFE.patchValue(this.cs.day_callapiSearch(this.form.controls.postingDate.value));
  ...
  if((this.pageflow == 'Edit')){
    if(value.value == 51){
    this.form.controls.totalPaidAmount.patchValue(0);
    this.form.controls.remainingBalance.patchValue(this.form.controls.invoiceAmount.value);
    }
    if(value.value == 52){
      this.form.controls.totalPaidAmount.patchValue(0);
      this.form.controls.remainingBalance.patchValue(this.form.controls.invoiceAmount.value);
  ...
  submit() {
    ...
    if (this.form.controls.invoiceNumber.value) {
      this.form.controls.invoiceDate.patchValue(this.cs.dateNewFormat(this.form.controls.invoiceDateFE.value));
      this.form.controls.postingDate.patchValue(this.cs.dateNewFormat(this.form.controls.postingDateFE.value));
