...
@Component({
  selector: 'app-controlgroup-dropdown',
  templateUrl: './controlgroup-dropdown.component.html',
  styleUrls: ['./controlgroup-dropdown.component.scss']
})
export class ControlgroupDropdownComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog,
    public dialogRef1: MatDialogRef < DialogExampleComponent > ,
  ...
  submit() {
    ...
    this.dialogRef1.close(this.form.controls.groupTypeId.value);
  };
