...
export class TimeTicketsComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'timeTicketNumber', 'timeTicketDescription','timeKeeperCode', 'createdOn', 'billType',  'defaultRate1', 'defaultRate',  'timeTicketHours', 'timeTicketAmount', 'approvedBillableAmount', 'statusIddes','referenceField1'];
  ...
  downloadexcel() {
    ...
    this.dataSource.data.forEach(x => {
      res.push({
        ...
        "Assigned Rate per Hour  ": x.defaultRate,
    ...
    res.push({
      ...
      "Assigned Rate per Hour  ": '',
      'Booked Hours ': this.getTotalHours() ? this.getTotalHours() : '0',
      "Booked Amount ": '',
      "Approved Amount  ":  this.getBillableAmount() ? '$' + this.getBillableAmount() : '0',
      "Approved Hours  ": '',
      "Status  ": '',
      "Prebill No": '',
      'Creation Date ': '',
