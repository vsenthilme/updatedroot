...
import { ExpirationNewComponent } from "src/app/main-module/matters/case-management/expiration-date/expiration-new/expiration-new.component";
...
thisDocumentType: any[] = [];
  ...
  downloadexcel() {
    ...
    this.dataSource.data.forEach(x => {
      res.push({
        ...
        'Eligibility date' : this.cs.excel_date(x.eligibilityDate),
        ...
        "Mozeo SMS Notes": x.reminderDescription,
  ...
  openDialog(data: any = 'new'): void {
    ...
    const dialogRef = this.dialog.open(ExpirationNewComponent, {
      ...
      maxWidth: '80%',
      position: { top: '6.5%' },
      data: { pageflow: data, matter: this.selection.selected[0].matterNumber, matterdesc: this.selection.selected[0].matterText, code: data != 'New' ? this.selection.selected[0] : null }
    });
