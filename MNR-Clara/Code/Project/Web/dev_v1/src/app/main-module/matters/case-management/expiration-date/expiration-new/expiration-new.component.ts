...
this.form.controls.updatedBy.disable();
  ...
  getMatterDetails() {
    ...
    this.sub.add(this.matterService.Get(this.form.controls.matterNumber.value).subscribe(res => {
      ...
      if(this.form.controls.languageId.value == "EN"){
        this.form.controls.reminderDescription.patchValue("Our records indicate an upcoming expiration or eligibility on your immigration status. Please call 713-289-4546. Visit us at http://montyramirezlaw.com")
       }
       else{
        this.form.controls.reminderDescription.patchValue("Nuestros registros indican un proximo vencimiento o elegibilidad en su estatus migratorio. Llame al 713-289-4546. Visitanos en http://montyramirezlaw.com ")
       } 
      if (this.data.pageflow == 'New') {
  ...
  submit() {
    ...
    console.log(this.form.controls.reminderDescription.value);
    console.log(any);
