...
//documents
    ...
    },
    {
      mainMenu: "Billing", Menu: [
        ...
        { screenId: 5, subScreenId: 1196, referenceField1: "Time Entry Compliance Report", createUpdate: true, delete: true, view: true, },
...

    {
      mainMenu: "Reports", Menu: [
        ...
        { screenId: 6, subScreenId: 1194, referenceField2: 'Accounting', referenceField1: "Partner Billing ", createUpdate: false, delete: false, view: true, },
        { screenId: 6, subScreenId: 1195, referenceField2: 'Matter', referenceField1: "Academy", createUpdate: false, delete: false, view: true, },
...
//newly added for QB Sync
    ...
    {
      mainMenu: "Controlled Groups-Setup", Menu: [
        { screenId: 9, subScreenId: 1197, referenceField1: "Country", createUpdate: true, delete: true, view: true, },
        
        { screenId: 9, subScreenId: 1198, referenceField1: "State", createUpdate: true, delete: true, view: true, },
        { screenId: 9, subScreenId: 1199, referenceField1: "City", createUpdate: true, delete: true, view: true, },
        { screenId: 9, subScreenId: 1200, referenceField1: "Status ", createUpdate: true, delete: true, view: true, },
        { screenId: 9, subScreenId: 1201, referenceField1: "Number Range", createUpdate: true, delete: true, view: true, },
        { screenId: 9, subScreenId: 1202, referenceField1: "Store", createUpdate: true, delete: true, view: true, },
        { screenId: 9, subScreenId: 1203, referenceField1: "Co-Owner", createUpdate: true, delete: true, view: true, },

        { screenId: 9, subScreenId: 1204, referenceField1: "Relationship", createUpdate: true, delete: true, view: true, },
        { screenId: 9, subScreenId: 1212, referenceField1: "Entity", createUpdate: true, delete: true, view: true, },
        { screenId: 9, subScreenId: 1205, referenceField1: "Group Type", createUpdate: true, delete: true, view: true, },

        { screenId: 9, subScreenId: 1206, referenceField1: "Group", createUpdate: true, delete: true, view: true, },
        { screenId: 9, subScreenId: 1207, referenceField1: "Group Mapping", createUpdate: true, delete: true, view: true, },                  
      
      ]
    },
    {
      mainMenu: "Controlled Groups-Transaction", Menu: [
        { screenId: 10, subScreenId: 1208, referenceField1: "Ownership Summary", createUpdate: true, delete: true, view: true, },
        
        { screenId: 10, subScreenId: 1209, referenceField1: "Store Partner Listiing", createUpdate: true, delete: true, view: true, },
        { screenId: 10, subScreenId: 1210, referenceField1: "Approval", createUpdate: true, delete: true, view: true, },
        { screenId: 10, subScreenId: 1211, referenceField1: "Report ", createUpdate: true, delete: true, view: true, },
  ...
  fill(data: any) {
    ...
    if (data.pageflow != 'New') {
      ...
      this.sub.add(this.service.Get(data.code).subscribe(res => {
        ...
        this.menuList.push({
          mainMenu: "Controlled Groups-Setup",
          Menu: res.filter((x: any) => x.screenId == 9)
        });
        this.menuList.push({
          mainMenu: "Controlled Groups-Transaction",
          Menu: res.filter((x: any) => x.screenId == 10)
        });
        this.spin.hide();
      }, err => {
