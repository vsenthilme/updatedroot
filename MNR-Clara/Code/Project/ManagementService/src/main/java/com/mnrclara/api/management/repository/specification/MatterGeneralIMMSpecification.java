...
public class MatterGeneralIMMSpecification implements Specification<MatterGenAcc> {
	
	SearchMatterIMMReport searchMatterGeneral;
	
	public MatterGeneralIMMSpecification(SearchMatterIMMReport inputSearchParams) {
