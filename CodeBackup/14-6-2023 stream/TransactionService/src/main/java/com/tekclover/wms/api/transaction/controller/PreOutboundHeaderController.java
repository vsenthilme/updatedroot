...
public class PreOutboundHeaderController {
	...
	@PostMapping("/findPreOutboundHeaderSql")
	public List<PreOutboundHeaderStream> findPreOutboundHeaderSql(@RequestBody SearchPreOutboundHeader searchPreOutboundHeader)
			throws Exception {
		return preoutboundheaderService.findPreOutboundHeaderSql(searchPreOutboundHeader);
	}
