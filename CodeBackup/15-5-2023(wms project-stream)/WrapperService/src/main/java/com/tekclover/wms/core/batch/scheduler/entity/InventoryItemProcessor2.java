...
public class InventoryItemProcessor2 implements ItemProcessor<InventoryMovement, InventoryMovement> {
...
//    }
    ...
    @Override
    public InventoryMovement process(InventoryMovement invMovement1) throws Exception {
        return invMovement1;
    }
}