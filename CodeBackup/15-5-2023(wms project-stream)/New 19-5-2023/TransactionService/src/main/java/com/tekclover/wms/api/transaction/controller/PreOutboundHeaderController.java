...
public class PreOutboundHeaderController {
	...
	public List<PreOutboundHeaderStream> findPreOutboundHeaderNew(@RequestBody SearchPreOutboundHeader searchPreOutboundHeader)
			throws Exception {
		return preoutboundheaderService.findPreOutboundHeaderNew(searchPreOutboundHeader);
	}
	//Stream - JPA
	@ApiOperation(response = PreOutboundHeader.class, value = "Search PreOutboundHeader JPA New") // label for swagger
	@PostMapping("/findPreOutboundHeaderNewJPA")
	public Stream<PreOutboundHeader> findPreOutboundHeaderNewJPA(@RequestBody SearchPreOutboundHeader searchPreOutboundHeader)
			throws Exception {
		return preoutboundheaderService.findPreOutboundHeaderJPA(searchPreOutboundHeader);
	}
