...
//	@Transactional
	public List<PreOutboundHeaderStream> findPreOutboundHeaderNew(SearchPreOutboundHeader searchPreOutboundHeader)
			throws Exception {
...
//		PreOutboundHeaderSpecification spec = new PreOutboundHeaderSpecification(searchPreOutboundHeader);
//		Stream<PreOutboundHeaderStream> results = preOutboundHeaderRepository.findAllPreOutBoundHeaderData(
//				searchPreOutboundHeader.getWarehouseId(),
//				searchPreOutboundHeader.getPreOutboundNo(),
//				searchPreOutboundHeader.getOutboundOrderTypeId(),
//				searchPreOutboundHeader.getSoType(),
//				searchPreOutboundHeader.getSoNumber(),
//				searchPreOutboundHeader.getPartnerCode(),
//				searchPreOutboundHeader.getStatusId(),
//				searchPreOutboundHeader.getCreatedBy(),
//				searchPreOutboundHeader.getStartRequiredDeliveryDate(),
//				searchPreOutboundHeader.getEndRequiredDeliveryDate(),
//				searchPreOutboundHeader.getStartOrderDate(),
//				searchPreOutboundHeader.getEndOrderDate(),
//				searchPreOutboundHeader.getStartCreatedOn(),
//				searchPreOutboundHeader.getEndCreatedOn()
//		);
		List<PreOutboundHeaderStream> results = preOutboundHeaderRepository.findAllPreOutBoundHeaderData(
				searchPreOutboundHeader.getWarehouseId(),
				searchPreOutboundHeader.getPreOutboundNo(),
				searchPreOutboundHeader.getOutboundOrderTypeId(),
				searchPreOutboundHeader.getSoType(),
...
//		List<PreOutboundHeaderStream> preOutboundHeaderList = results.parallel().collect(Collectors.toList());
...
//	@Transactional
	public Stream<PreOutboundHeader> findPreOutboundHeaderJPA(SearchPreOutboundHeader searchPreOutboundHeader)
			throws Exception {
		...
		PreOutboundHeaderSpecification spec = new PreOutboundHeaderSpecification(searchPreOutboundHeader);
		Stream<PreOutboundHeader> results = preOutboundHeaderRepository.stream(spec, PreOutboundHeader.class);

//		List<PreOutboundHeader> preOutboundHeaderList = results.parallel().collect(Collectors.toList());

//		Stream<PreOutboundHeaderStream> result = preOutboundHeaderRepository.findStatusDescription(preOutboundHeaderList.stream().iterator().next().getStatusId());
//		Stream<String> statusDescription = preOutboundHeaderRepository.findStatusDescription(results.iterator().next().getStatusId());
//		Stream<PreOutboundHeaderStream> resultWithStatusDescription = Stream.of(statusDescription).map(results::iterator).collect(Collectors.toList());
//		Stream<PreOutboundHeaderStream> resultWithStatusDescription = ;
//		log.info("results: " + results);
//		return resultWithStatusDescription;
		return results;
	}
