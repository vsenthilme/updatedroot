...
//import com.tekclover.wms.core.repository.GrHeaderRepository;
...
//
//	@Autowired
//	GrHeaderRepository grHeaderRepository;
...
//				log.info("Result containerReceipt---getContainerReceivedDate() :" + containerReceipt.getContainerReceivedDate());
	...
	// POST - findPreOutboundHeaderJPA - Stream
	public PreOutboundHeader[] findPreOutboundHeaderJPA(SearchPreOutboundHeader searchPreOutboundHeader,
			String authToken) throws Exception {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			...
			UriComponentsBuilder builder = UriComponentsBuilder
					.fromHttpUrl(getTransactionServiceApiUrl() + "preoutboundheader/findPreOutboundHeaderNewJPA");
			HttpEntity<?> entity = new HttpEntity<>(searchPreOutboundHeader, headers);
			ResponseEntity<PreOutboundHeader[]> result = getRestTemplate().exchange(builder.toUriString(),
					HttpMethod.POST, entity, PreOutboundHeader[].class);
			log.info("result : " + result.getBody());
...
//	 * @return
//	 */
//	public StreamingResponseBody findStreamGrHeaderNew(SearchGrHeader searchGrHeader) {
//		Stream<GrHeaderStream> outboundHeaderStream = streamGrHeaderNew(searchGrHeader);
//		StreamingResponseBody responseBody = httpResponseOutputStream -> {
//			try (Writer writer = new BufferedWriter(new OutputStreamWriter(httpResponseOutputStream))) {
//				JsonGenerator jsonGenerator = new JsonFactory().createGenerator(writer);
//				jsonGenerator.writeStartArray();
...
//
////	public Stream<GrHeaderStream> streamGrHeader(SearchGrHeader searchGrHeader) {
//	public Stream<GrHeaderStream> streamGrHeaderNew(SearchGrHeader searchGrHeader) {
//		jdbcTemplate.setFetchSize(50);
//		/**
//		 * Gr Header
//		 * String languageId
