...
public class TransactionServiceController {
   ...
   @ApiOperation(response = PickupHeader.class, value = "Update PickupHeader") // label for swagger
	...
	@ApiOperation(response = OutboundHeader.class, value = "Search OutboundHeader JPA") // label for swagger
	@PostMapping("/preoutboundheader/findPreOutboundHeaderJPA")
	public PreOutboundHeader[] findOutboundHeaderJPA(@RequestBody SearchPreOutboundHeader searchOutboundHeader,
			@RequestParam String authToken) throws Exception {
		return transactionService.findPreOutboundHeaderJPA(searchOutboundHeader, authToken);
	}

//	@ApiOperation(response = OutboundHeader.class, value = "Search OutboundHeader New Trans") // label for swagger
//	@PostMapping("/grheader/findGrHeaderNew")
//	public OutboundHeader[] findOutboundHeaderNewTrans(@RequestBody SearchOutboundHeader searchOutboundHeader,
//												  @RequestParam String authToken) throws Exception {
//		return transactionService.findGrHeaderNewTrans(searchOutboundHeader, authToken);
//	}
//	@ApiOperation(response = OutboundHeader.class, value = "Search OutboundHeader New") // label for swagger
//	@PostMapping("/outboundheader/findOutboundHeaderNew")
...
//	public ResponseEntity<?> findStreamgrheader(@RequestBody SearchGrHeader searchGrHeader) throws ExecutionException, InterruptedException {
//		StreamingResponseBody responseBody = transactionService.findStreamGrHeader(searchGrHeader);
//		List<GrHeaderStream> responseBody = transactionService.streamGrHeader(searchGrHeader);
//		return ResponseEntity.status(HttpStatus.OK).contentType(MediaType.APPLICATION_JSON).body(responseBody);
//	}
