...
public class IDMasterServiceController {
    ...
    @ApiOperation(response = String.class, value = "Get all AdhocModuleId details") // label for swagger
    @GetMapping("/adhocmoduleid/v2")
    public ResponseEntity<?> getAdhocModuleIdsV2(@RequestParam String authToken) {
        String url = "http://eureka-client-idmaster/adhocmoduleid/v2";
        String adhocModuleIdList = restTemplate().getForObject(url, String.class);
        return new ResponseEntity<>(adhocModuleIdList, HttpStatus.OK);
    }
    ...
    @ApiOperation(response = InboundOrderStatusId[].class, value = "Get all InboundOrderStatusId details")
    // label for swagger
     ...
     * --------------------------------DecimalNotationId---------------------------------
     */
    @ApiOperation(response = DecimalNotationId[].class, value = "Get all DecimalNotationId details")
    // label for swagger
     ...
     * --------------------------------SubMovementTypeId---------------------------------
     */
    @ApiOperation(response = SubMovementTypeId[].class, value = "Get all SubMovementTypeId details")
    // label for swagger
     ...
     * --------------------------------InboundOrderTypeId---------------------------------
     */
    @ApiOperation(response = InboundOrderTypeId[].class, value = "Get all InboundOrderTypeId details")
    // label for swagger
     ...
     */
    @ApiOperation(response = SpecialStockIndicatorId[].class, value = "Get all SpecialStockIndicatorId details")
    // label for swagger
    ...
    @ApiOperation(response = SpecialStockIndicatorId.class, value = "Get a SpecialStockIndicatorId")
    // label for swagger
    ...
    @ApiOperation(response = SpecialStockIndicatorId.class, value = "Create a SpecialStockIndicatorId")
    // label for swagger
    ...
    @ApiOperation(response = SpecialStockIndicatorId.class, value = "Update SpecialStockIndicatorId")
    // label for swagger
    ...
    @ApiOperation(response = SpecialStockIndicatorId.class, value = "Delete SpecialStockIndicatorId")
    // label for swagger
    ...
    @ApiOperation(response = HandlingEquipmentId[].class, value = "Get all HandlingEquipmentId details")
    // label for swagger
     ...
     * --------------------------------ApprovalProcessId---------------------------------
     */
    @ApiOperation(response = ApprovalProcessId[].class, value = "Get all ApprovalProcessId details")
    // label for swagger
    ...
    @RequestMapping(value = "/servicetypeid/{serviceTypeId}", method = RequestMethod.GET)
// Long moduleId, Long serviceTypeId
