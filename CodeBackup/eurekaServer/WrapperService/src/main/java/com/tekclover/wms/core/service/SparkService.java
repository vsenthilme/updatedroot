...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/imbasicdata1");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/storagebin");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/containerReceipt");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/preinboundHeader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/stagingheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/grheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/putawayheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/inboundHeader");
            HttpEntity<?> entity = new HttpEntity<>(searchInboundHeaderV2, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/preoutboundheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/ordermanagementline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/pickupheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/qualityheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/outboundheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/outboundreversal");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/pickupline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/inventorymovement");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/inventory");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/inventory/new");
            HttpEntity<?> entity = new HttpEntity<>(findInventoryV2, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/putawayline");
            HttpEntity<?> entity = new HttpEntity<>(findInventoryV2, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/putawayline/new");
            HttpEntity<?> entity = new HttpEntity<>(findInventoryV2, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/periodicheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/inhousetransferline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/perpetualheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/inboundline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/inhousetransferheader");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/stockreport");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/periodicline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/perpetualline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/preoutboundline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/stagingLine");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder =
                    UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/grline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "wms/spark/qualityline");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/wms/spark/imbasicdata1v3");
            HttpEntity<?> entity = new HttpEntity<>(searchImBasicData1, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/wms/spark/imbasicdata1v5");
            HttpEntity<?> entity = new HttpEntity<>(searchImBasicData1, headers);
            ResponseEntity<ImBasicData1V3[]> result = getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, ImBasicData1V3[].class);
            log.info("result: " + result.getStatusCode());
            return result.getBody();
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/wms/spark/businessPartner");
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/wms/spark/inboundLineV3");
            HttpEntity<?> entity = new HttpEntity<>(findInboundLineV2, headers);
...
//        headers.add("Authorization", "Bearer " + authToken);
            ...
            UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(getSparkServiceUrl() + "/wms/spark/outboundHeaderTest");
