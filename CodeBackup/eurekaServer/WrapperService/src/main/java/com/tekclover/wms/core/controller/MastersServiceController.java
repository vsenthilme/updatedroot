...
*/
    ...
    @ApiOperation(response = HandlingEquipment.class, value = "Get HandlingEquipment by Barcode V2")
    // label for swagger
    ...
    //-------------------------Notifications-------------------------------------------------------------
    @ApiOperation(response = Notify[].class, value = "Notify List") // label for swagger
    @GetMapping("/notification-message")
    public Notify[] getAllNotifications(@RequestParam String userId, @RequestParam String authToken) throws Exception {
        return mastersService.getAllNotifications(userId, authToken);
    }

    @ApiOperation(response = Notify.class, value = "Mark Read Notify") // label for swagger
    ...
    @ApiOperation(response = Notify.class, value = "Mark Read All Notify") // label for swagger
