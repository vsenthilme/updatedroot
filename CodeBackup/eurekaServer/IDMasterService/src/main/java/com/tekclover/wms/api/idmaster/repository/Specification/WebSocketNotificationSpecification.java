...
public class WebSocketNotificationSpecification implements Specification<WSNotification> {

    SearchNotification searchNotification;

    public WebSocketNotificationSpecification(SearchNotification inputSearchParams) {
        this.searchNotification = inputSearchParams;
    }

    @Override
    public Predicate toPredicate(Root<WSNotification> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
