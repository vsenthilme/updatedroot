...
//			throw e;
	...
	// GET StorageBin - /{warehouseId}/bins/{binClassId}
	public StorageBinV2 getStorageBin (String warehouseId, Long binClassId, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	public StorageBinV2[] getStorageBinByStatusV2 ( String warehouseId, Long statusId, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// PATCH - V2
	public StorageBinV2 updateStorageBinV2 ( String storageBin, StorageBin modifiedStorageBin,
