...
@Slf4j
@Service
public class PreOutboundHeaderV2Service extends BaseService {
	 ...
	 * @return
	 */
	public List<PreOutboundHeaderV2> getPreOutboundHeaders () {
	 ...
	 * @return
	 */
	public PreOutboundHeaderV2 getPreOutboundHeader (String warehouseId, String comapnyCodeId,
													 String plantId, String languageId,
													 String refDocNumber,
													 String preOutboundNo, String partnerCode) {
		Optional<PreOutboundHeaderV2> preOutboundHeader =
				preOutboundHeaderV2Repository.findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndRefDocNumberAndPreOutboundNoAndPartnerCodeAndDeletionIndicator(
						languageId, comapnyCodeId, plantId, warehouseId, refDocNumber, preOutboundNo, partnerCode, 0L);
	 ...
	 * @return
	 */
	public PreOutboundHeaderV2 getPreOutboundHeader (String preOutboundNo) {
		PreOutboundHeaderV2 preOutboundHeader = preOutboundHeaderV2Repository.findByPreOutboundNo(preOutboundNo);
	 ...
	 */
	public PreOutboundHeaderV2 createPreOutboundHeader (PreOutboundHeaderV2 newPreOutboundHeader, String loginUserID)
			throws IllegalAccessException, InvocationTargetException {

		newPreOutboundHeader.setDeletionIndicator(0L);
		newPreOutboundHeader.setCreatedBy(loginUserID);
		newPreOutboundHeader.setUpdatedBy(loginUserID);
		newPreOutboundHeader.setCreatedOn(new Date());
		newPreOutboundHeader.setUpdatedOn(new Date());
		return preOutboundHeaderRepository.save(newPreOutboundHeader);
	}
...
//	}
	...
	public OutboundHeader processOutboundReceived (OutboundIntegrationHeader outboundIntegrationHeader) 
		...
		String preOutboundNo = getPreOutboundNo(warehouseId,
				orderProcessedStatus.get().getCompanyCodeId(),
				orderProcessedStatus.get().getPlantId(),
				orderProcessedStatus.get().getLanguageId());
		...
		PreOutboundHeader createdPreOutboundHeader = createPreOutboundHeader (warehouse.getCompanyCode(), 
				warehouse.getPlantId(), warehouse.getLanguageId(), preOutboundNo, outboundIntegrationHeader, refField1ForOrderType);
		...
		/*------------------------------------------------------------------------------------*/
		updateStatusAs47ForOBHeader(warehouseId, warehouse.getLanguageId(), preOutboundNo, outboundHeader.getRefDocNumber());
	 ...
	 * @param refDocNumber
	 */
	private void updateStatusAs47ForOBHeader(String warehouseId, String languageId, String preOutboundNo, String refDocNumber) {
		...
		if (isConditionMet) {
			...
			StatusId idStatus = idmasterService.getStatus(STATUS_ID_47, warehouseId, languageId, authTokenForIDService.getAccess_token());
	...
	private OrderManagementHeader createOrderManagementHeader(PreOutboundHeader createdPreOutboundHeader) {
		...
		AuthToken authTokenForIDService = authTokenService.getIDMasterServiceAuthToken();
		StatusId idStatus = idmasterService.getStatus(41L, createdPreOutboundHeader.getWarehouseId(),
				createdPreOutboundHeader.getLanguageId(), authTokenForIDService.getAccess_token());
	...
	private PreOutboundHeader createPreOutboundHeader(String companyCodeId, String plantId, String languageId, String preOutboundNo,
		...
		// Status Description
		StatusId idStatus = idmasterService.getStatus(39L, outboundIntegrationHeader.getWarehouseID(),
				languageId, authTokenForIDService.getAccess_token());
	 ...
	 * @return
	 */
	private String getPreOutboundNo (String warehouseId, String companyCodeId,
									 String plantId, String languageId) {
		/*
	...
	private OrderManagementLine createEMPTYOrderManagementLine(OrderManagementLine orderManagementLine) {
		...
		StatusId idStatus = idmasterService.getStatus(47L, orderManagementLine.getWarehouseId(),
																orderManagementLine.getLanguageId(), idmasterAuthToken.getAccess_token());
