...
public class IDMasterService {
	...
	// GET
	public Warehouse getWarehouse (String companyCodeId, String plantId, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "ClassicWMS RestTemplate");
...
//			e.printStackTrace();
	 ...
	 * @param loginUserID
	 */
	public void createAuditLogRecord(String warehouseId, String companyCodeId, String plantId, String languageId,
									 String tableName, Integer screenNo, Integer subScreenNo,
			String modifiedField, String oldValue, String newValue, String loginUserID) {
		AuditLog auditLog = new AuditLog();
		
		AuthToken authTokenForIdmasterService = authTokenService.getIDMasterServiceAuthToken();
		Warehouse warehouse = getWarehouse (warehouseId, companyCodeId, plantId, languageId, authTokenForIdmasterService.getAccess_token());
		...
		String newAuditLogNumber = getNextNumberRange(NUM_RAN_CODE, fiscalYear, warehouseId,
													warehouse.getCompanyCode(), warehouse.getPlantId(),
													warehouse.getLanguageId(), authTokenForIdmasterService.getAccess_token());
