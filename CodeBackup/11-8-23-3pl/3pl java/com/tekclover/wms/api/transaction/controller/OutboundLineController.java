...
public class OutboundLineController {
	...
	public ResponseEntity<?> deliveryConfirmation (@RequestParam String warehouseId, @RequestParam String preOutboundNo, 
			@RequestParam String refDocNumber, @RequestParam String partnerCode, @RequestParam String languageId, @RequestParam String loginUserID)
			throws IllegalAccessException, InvocationTargetException {
		List<OutboundLine> createdOutboundLine = 
				outboundlineService.deliveryConfirmation(warehouseId, preOutboundNo, refDocNumber, partnerCode, languageId, loginUserID);
		return new ResponseEntity<>(createdOutboundLine , HttpStatus.OK);
	}
