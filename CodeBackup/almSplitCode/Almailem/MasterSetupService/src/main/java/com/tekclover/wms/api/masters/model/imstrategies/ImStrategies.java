 ...
 */
@Table(
		name = "tblimstrategies", 
		uniqueConstraints = { 
				@UniqueConstraint (
						name = "unique_key_imstrategies", 
						columnNames = {"LANG_ID", "C_ID", "PLANT_ID", "WH_ID", "ITM_CODE", "STR_TYP_ID", "SEQ_IND"})
				}
		)
@IdClass(ImStrategiesCompositeKey.class)
