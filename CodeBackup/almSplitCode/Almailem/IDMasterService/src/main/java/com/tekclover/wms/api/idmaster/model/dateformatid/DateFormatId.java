 ...
 */
@Table(
		name = "tbldateformatid",
		uniqueConstraints = { 
				@UniqueConstraint (
						name = "unique_key_dateformatid",
						columnNames = {"C_ID", "PLANT_ID", "WH_ID", "DATE_FOR_ID", "LANG_ID"})
				}
		)
@IdClass(DateFormatIdCompositeKey.class)
public class DateFormatId {
	...
	@Id
	@Column(name = "DATE_FOR_ID", columnDefinition = "nvarchar(50)")
	...
	@Column(name = "DATE_FORMAT", columnDefinition = "nvarchar(50)")
