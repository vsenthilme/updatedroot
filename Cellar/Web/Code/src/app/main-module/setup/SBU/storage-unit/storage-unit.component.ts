...
import { ItemgroupNewComponent } from '../item-group/itemgroup-new/itemgroup-new.component';
import { SbuNewComponent } from './sbu-new/sbu-new.component';
...
const ELEMENT_DATA: PeriodicElement[] = [
  {usercode: 'Phase I', name: 'Block-1', admin: '1', userid: 'A-1', role: 'A-01-01-1A'},
];
...
export class StorageUnitComponent implements OnInit {
  ...
  openDialog(data: any = 'New'): void {
    ...
    const dialogRef = this.dialog.open(SbuNewComponent, {
      disableClose: true,
      width: '55%',
      maxWidth: '80%',
      position: { top: '9%', },
