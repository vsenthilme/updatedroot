...
@Table(
		...
		uniqueConstraints = { 
				@UniqueConstraint (
						...
						columnNames = {"C_ID", "PLANT_ID", "WH_ID", "PROCESS_ID", "PROCESS_SEQ_ID", "LANG_ID"})
				}
		)
...
public class ProcessSequenceId { 
	...
	@Column(name = "PROCESS",columnDefinition = "nvarchar(500)")
	private String processDescription;

	@Column(name = "SUBPROCESS",columnDefinition = "nvarchar(500)")
	...
	@Column(name="PROCESS_ID_DESC",columnDefinition = "nvarchar(500)")
	private String processIdAndDescription;
