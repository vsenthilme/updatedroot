...
public interface PeriodicLineTempV2Repository extends JpaRepository<PeriodicLineTempV2, Long> {
    ...
    @Query(value = "SELECT SUM(CTD_QTY) inventoryQty, itm_code itemCode, mfr_name manufacturerName, ref_no referenceCycleCountNo FROM tblperiodictempline WHERE WH_ID = :warehouseId AND CC_NO = :cycleCountNo AND\r\n"
