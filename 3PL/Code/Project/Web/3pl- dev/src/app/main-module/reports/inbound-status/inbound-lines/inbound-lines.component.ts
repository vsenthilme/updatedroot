...
export class InboundLinesComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.spin.show();
    this.sub.add(this.service.Get(this.data.warehouseId, this.data.preInboundNo, this.data.refDocNumber, this.data.code.companyCode ,this.data.code.languageId, this.data.code.plantId).subscribe(res => {
