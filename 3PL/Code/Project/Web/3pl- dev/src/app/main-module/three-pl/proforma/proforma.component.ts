...
export class ProformaComponent implements OnInit {
  ...
  click2(){
    this.toastr.success(  "Invoice Created Sucessfully! ","Notification",{
      timeOut: 2000,
      progressBar: false,
    });
  ...
  // res.totalAfterDiscount
     //Receipt List
       ...
       headerTable.push([
        ...
        { text: 'PROFORMA INVOICE', bold: true, alignment: 'left',  margin: [17, 10, 20, 0], fontSize: 25, color:'#949494', border: [false, false, false, false] },
   //     { image: workOrderLogo1.headerLogo1, fit: [180, 180], alignment: 'center',  bold: false, fontSize: 12, border: [false, false, false, false] },
      ...
      //   defaultStyle,
       ...
       headerArray.push([
         ...
         { text: 'Proforma Invoice # ', bold: true, fontSize: 10, border: [true, true, true, true] ,alignment: 'center'},
   ...
   //    pdfMake.createPdf(dd).download('Proforma Invoice');
