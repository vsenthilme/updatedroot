...
const ELEMENT_DATA1:  variant1[] = [
  {billno:'900108',proformano:  '800108',customerid:  '10001',billdate: '31-05-2023',billperiod: '01-05-2023 ',billperiodto: '31-05-2023',billamount: '$ 27,807',createdby: 'admin',
   status:'billed'},
  {billno:'900107',proformano:  '800107',customerid:  '8000515',billdate: '30-04-2023',billperiod: '01-04-2023 ',billperiodto: '30-04-2023',billamount: '$ 15200',createdby: 'admin',
   status:'billed'},{billno:'900106',proformano:  '800106',customerid:  '8000514',billdate: '30-04-2023',billperiod: '01-04-2023 ',billperiodto: '30-04-2023',billamount: '$ 6000',createdby: 'admin',
   status:'billed'},{billno:'900105',proformano:  '800105',customerid:  '8000513',billdate: '30-04-2023',billperiod: '01-04-2023 ',billperiodto: '30-04-2023',billamount: '$ 3800',createdby: 'admin',
   status:'billed'},{billno:'900104',proformano:  '800104',customerid:  '8000512',billdate: '30-04-2023',billperiod: '01-04-2023 ',billperiodto: '30-04-2023',billamount: '$ 4200',createdby: 'admin',
   status:'billed'},{billno:'900103',proformano:  '800103',customerid:  '4504513',billdate: '30-04-2023',billperiod: '01-04-2023 ',billperiodto: '30-04-2023',billamount: '$ 1900',createdby: 'admin',
   status:'billed'},{billno:'900102',proformano:  '800102',customerid:  '4504512',billdate: '30-04-2023',billperiod: '01-04-2023 ',billperiodto: '30-04-2023',billamount: '$ 2700',createdby: 'admin',
   status:'billed'},  {billno:'900101',proformano:  '800101',customerid:  '4504511',billdate: '30-04-2023',billperiod: '01-04-2023',billperiodto: '30-04-2023',billamount: '$ 3500',createdby: 'admin',
   status:'billed'},{billno:'900100',proformano:  '800100',customerid:  '4504510',billdate: '30-04-2023',billperiod: '01-04-2023 ',billperiodto: '30-04-2023',billamount: '$ 7000',createdby: 'admin',
   status:'billed'},
];
...
click(){
  this.toastr.success(  "Invoice Approved Sucessfully! ","Notification",{
    timeOut: 2000,
    progressBar: false,
  });
  ...
  //     { image: workOrderLogo1.headerLogo1, fit: [180, 180], alignment: 'center',  bold: false, fontSize: 12, border: [false, false, false, false] },
     ...
     //   defaultStyle,
      ...
      headerArray.push([
        ...
        { text: '31-5-2023', bold: false, fontSize: 10, border: [true, true, true, true],alignment: 'center' },
      ...
      headerArray.push([
        ...
        { text:   '', bold: false, fontSize: 10, border: [false, false, false, false] },
        { text: '10001', bold: false, fontSize: 10, border: [true, true, true, true], alignment: 'center' },
      ...
      headerArray4.push([
        { text: ' Fulfilment + Delivery Charges for the Month of MAY 2023'+'  '+'(Period: May 1 to May 31)', bold: false, border: [false, false, false, false], alignment: 'left', fontSize:10 },
      ...
      headerArray5.push([
        ...
        { text: 'Unit Price($)', bold: true, border: [true, true, false, true], alignment: 'center', fontSize:10 },
        { text: 'Amount($)', bold: true, border: [true, true, true, true], alignment: 'center', fontSize:10 },
      ...
      headerArray6.push([
        ...
        { text: '182.12', bold: true, border: [true, false, false, true], alignment: 'center', fontSize:10 },
        { text: '25.00', bold: true, border: [true, false, false, true], alignment: 'center', fontSize:10 },
        { text: '4553.00', bold: true, border: [true, false, true, true], alignment: 'center', fontSize:10 },
      ...
      headerArray7.push([
        ...
        { text: 'CBM', bold: true, border: [true, false, false, true], alignment: 'center', fontSize:10 },
        { text: '145.29', bold: true, border: [true, false, false, true], alignment: 'center', fontSize:10 },
        { text: '70.00', bold: true, border: [true, false, false, true], alignment: 'center', fontSize:10 },
        { text: '10,170.00', bold: true, border: [true, false, true, true], alignment: 'center', fontSize:10 },
      ...
      headerArray8.push([
        ...
        { text: '4433.00', bold: true, border: [true, false, false, true], alignment: 'center', fontSize:10 },
        { text: '2.95', bold: true, border: [true, false, false, true], alignment: 'center', fontSize:10 },
        { text: '13,084.00', bold: true, border: [true, false, true, true], alignment: 'center', fontSize:10 },
      ...
      headerArray10.push([
        ...
        { text: 'in ', bold: true, border: [false, false, false, true], alignment: 'center', fontSize:10,margin:[-35,0,0,0] },
        { text: '$ 27,807.00', bold: true, border: [false, false, true, true], alignment: 'center', fontSize:10 },
