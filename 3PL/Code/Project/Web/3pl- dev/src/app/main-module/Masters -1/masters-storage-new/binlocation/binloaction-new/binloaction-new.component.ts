...
this.masterService.searchlevel({companyCodeId: this.auth.companyId, plantId: this.auth.plantId, warehouseId: this.auth.warehouseId, languageId: [this.auth.languageId]}).subscribe(res => {
 ...
 this.masterService.searchuom({companyCodeId:this.auth.companyId ,plantId: this.auth.plantId,warehouseId:this.auth.plantId, languageId: [this.auth.languageId]}).subscribe(res => {
  this.uomList = [];
  res.forEach(element => {
