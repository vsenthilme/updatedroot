...
export class ThreeplComponent implements OnInit {
  ...
  link = [
    { url: "/main/threePLmaster/pricelist", title: "Price List",screenid:3201,  class: "mx-1 d-flex justify-content-center align-items-center" },
    { url: "/main/threePLmaster/billing", title: "Billing",screenid:3202,  class: "mx-1 d-flex justify-content-center align-items-center" },
    { url: "/main/threePLmaster/pricelistassign", title: "Price List Assignment",screenid:3203,  class: "mx-1 d-flex justify-content-center align-items-center" },
    { url: "/main/threePLmaster/cbm", title: "CBM Inbound",screenid:3204,  class: "mx-1 d-flex justify-content-center align-items-center" },
