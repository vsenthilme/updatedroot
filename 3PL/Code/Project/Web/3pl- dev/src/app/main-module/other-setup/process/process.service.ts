...
export class ProcessService {
  ...
  Delete(processSequenceId: any,warehouseId: string,languageId:any,companyCodeId:any,plantId:any,processId:any) {
    return this.http.delete<any>('/wms-idmaster-service/processsequenceid/' + processSequenceId+'?warehouseId=' + warehouseId+'&languageId='+languageId+'&companyCodeId='+companyCodeId+'&plantId='+plantId+'&processId='+processId);
}
search(obj: any) {
