...
export class PartnerComponent implements OnInit {
  ...
  deleteDialog() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        this.deleterecord(this.selecteditemtype[0].itemCode,this.selecteditemtype[0].warehouseId,this.selecteditemtype[0].plantId,this.selecteditemtype[0].languageId,this.selecteditemtype[0].companyCodeId);
  ...
  deleterecord(id: any,warehouseId:any,plantId:any,languageId:any,companyCodeId:any) {
    this.spin.show();
    this.sub.add(this.service.Delete(id,warehouseId,plantId,languageId,companyCodeId).subscribe((res) => {
  ...
  downloadexcel() {
    ...
    this.itemtype.forEach(x => {
      ...
      "Warehouse":x.warehouseId,
        ...
        "Part No":x.itemCode,
        "Business Partner Type":x.businessPartnerType,
