...
@NoArgsConstructor
/*
 * `C_ID`, `UOM_ID`, `LANG_ID`'PLANT_ID','WH_ID'
 */
@Table(
		name = "tbluomid", 
		uniqueConstraints = { 
				@UniqueConstraint (
						...
						columnNames = {"C_ID", "UOM_ID", "LANG_ID","PLANT_ID","WH_ID"})
				}
		)
...
public class UomId { 
	...
	@Column(name = "UOM_TEXT",columnDefinition = "nvarchar(500)")
	private String description;
	
	@Column(name = "UOM_TYP",columnDefinition = "nvarchar(50)")
