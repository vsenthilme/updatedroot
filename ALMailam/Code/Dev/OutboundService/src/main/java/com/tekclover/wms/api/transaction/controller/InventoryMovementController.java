...
public class InventoryMovementController {
	...
	@ApiOperation(response = InventoryMovement.class, value = "Get a InventoryMovement v2") // label for swagger
	@GetMapping("/v2/{movementType}")
	public ResponseEntity<?> getInventoryMovementV2(@PathVariable Long movementType, @RequestParam String companyCodeId, @RequestParam String plantId, @RequestParam String languageId, @RequestParam String warehouseId,
												  @RequestParam Long submovementType, @RequestParam String packBarcodes, @RequestParam String itemCode, @RequestParam String manufacturerName, @RequestParam String movementDocumentNo) {
		InventoryMovement inventorymovement =
				inventorymovementService.getInventoryMovementV2(companyCodeId, plantId, languageId, warehouseId, movementType, submovementType, packBarcodes, itemCode,
						manufacturerName, movementDocumentNo);
		return new ResponseEntity<>(inventorymovement, HttpStatus.OK);
	}

	@ApiOperation(response = InventoryMovement.class, value = "Update InventoryMovement V2") // label for swagger
	@PatchMapping("/v2/{movementType}")
	public ResponseEntity<?> patchInventoryMovementV2(@PathVariable Long movementType, @RequestParam String companyCodeId, @RequestParam String plantId, @RequestParam String languageId, @RequestParam String warehouseId,
													  @RequestParam Long submovementType, @RequestParam String packBarcodes, @RequestParam String itemCode, @RequestParam String manufacturerName, @RequestParam String movementDocumentNo,
													  @Valid @RequestBody UpdateInventoryMovement updateInventoryMovement, @RequestParam String loginUserID) {
		InventoryMovement createdInventoryMovement =
				inventorymovementService.updateInventoryMovementV2(companyCodeId, plantId, languageId, warehouseId, movementType, submovementType, packBarcodes, itemCode,
						manufacturerName, movementDocumentNo, updateInventoryMovement, loginUserID);
		return new ResponseEntity<>(createdInventoryMovement, HttpStatus.OK);
	}

	@ApiOperation(response = InventoryMovement.class, value = "Delete InventoryMovement") // label for swagger
	@DeleteMapping("/v2/{movementType}")
	public ResponseEntity<?> deleteInventoryMovementV2(@PathVariable Long movementType, @RequestParam String companyCodeId, @RequestParam String plantId, @RequestParam String languageId, @RequestParam String warehouseId,
													 @RequestParam Long submovementType, @RequestParam String packBarcodes, @RequestParam String itemCode,
													 @RequestParam String batchSerialNumber, @RequestParam String movementDocumentNo, @RequestParam String loginUserID) {
		inventorymovementService.deleteInventoryMovementV2(companyCodeId, plantId, languageId, warehouseId, movementType, submovementType, packBarcodes, itemCode,
				batchSerialNumber, movementDocumentNo, loginUserID);
		return new ResponseEntity<>(HttpStatus.NO_CONTENT);
	}
}