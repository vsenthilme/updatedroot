...
public class EMailController {
    ...
    //send Mail
    @ApiOperation(response = EMailDetails.class, value = "Send Email For Notification") // label for swagger
    @PostMapping("/sendMail/notification")
    public ResponseEntity<?> sendEmailForNotification(@Valid @RequestBody InboundOrderCancelInput inboundOrderCancelInput) throws IOException, MessagingException {
        sendMailService.sendEmail(inboundOrderCancelInput.getRemarks());
        return new ResponseEntity<>(HttpStatus.OK);
    }
}