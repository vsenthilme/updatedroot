...
export class BusinessPartnerService {
  ...
  UpdateV2(obj: BusinesspartnerElement, code: any,companyCodeId:any,languageId:any,plantId:any,warehouseId:any,businessPartnerType:any) {
    return this.http.patch<any>(this.apiName + `businesspartner/v2/` + code+'?companyCodeId='+companyCodeId+'&languageId='+languageId+'&plantId='+plantId+'&warehouseId='+warehouseId+'&businessPartnerType='+businessPartnerType, obj);
  }
  ...
  searchSpark(obj: any) {
    return this.http.post<any>('/wms-spark-service/findBusinessPartner', obj);
  }
}
