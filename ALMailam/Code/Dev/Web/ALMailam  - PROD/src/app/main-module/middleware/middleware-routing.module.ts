...
import { StockreceiptlinesComponent } from './stockreceiptheader/stockreceiptlines/stockreceiptlines.component';
...
{
  path: 'stockreceiptlines/:code',
  component: StockreceiptlinesComponent
},
