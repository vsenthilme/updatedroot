...
@NgModule({
  declarations: [
    ...
    CasenoPopupComponent, ContainerreceiptCreateComponent, InventoryDetailsComponent, ReleasedQtyComponent, CreateBarcodeComponent, LabelGenerateComponent, EditpopupComponent, ItemMainEditComponent, PutawayheaderComponent, ReversalEditComponent, SuppliercancellationComponent, SuppliercancellinesComponent
  ],
