  ...
  downloadexcel() {
    ...
    this.itemtype.forEach(x => {
      ...
      "Language ":x.languageId,
        ...
        "Part No":x.itemCode,
        "Palletization ":x.palletizationLevel,
        "Palletization Indicator":x.palletizationIndicator,
        "Pallet Height":x.palletHeight,
        "Pallet Width":x.palletWidth,
        "Pallet Length":x.palletLength,
        "Case Height":x.caseHeight,
        "Case Width":x.caseWidth,
        "Case Length":x.caseLength,
