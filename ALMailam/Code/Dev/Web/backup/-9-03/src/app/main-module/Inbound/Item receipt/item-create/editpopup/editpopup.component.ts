...
export class EditpopupComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.form.controls.rec_accept_qty.disable();
    this.form.controls.rec_damage_qty.disable();
   ...
   this.form.controls.plantId.disable();
     ...
     if(this.form.controls.partner_item_barcode == null){
      this.form.controls.partner_item_barcode =(this.form.controls.itemCode.value);
     }
     this.dropdownlist();
    // }else{
