...
import { AssemblyNewComponent } from '../assembly-new/assembly-new.component';
...
@Component({
  selector: 'app-assembly-main',
  templateUrl: './assembly-main.component.html',
  styleUrls: ['./assembly-main.component.scss']
})
export class AssemblyMainComponent implements OnInit {
...
openDialogNew(element){
  const dialogRef = this.dialog.open(AssemblyNewComponent, {
    disableClose: true,
    width: '55%',
    maxWidth: '80%',
   data: element
