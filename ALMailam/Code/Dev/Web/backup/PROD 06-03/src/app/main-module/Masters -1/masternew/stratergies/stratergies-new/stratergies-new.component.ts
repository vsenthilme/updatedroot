...
export class StratergiesNewComponent implements OnInit {
  ...
  dropdownlist() {
    ...
    this.cas.getalldropdownlist([
      ...
      this.masterService.searchstratergytype({
  ...
  Skip(){
    let paramdata = "";
    paramdata = this.cs.encrypt({pageflow: 'New', result: this.js.basicdataresult});
  ...
  submit() {
    ...
    if (this.js.pageflow == "basicDataEdit") {
      ...
      this.sub.add(this.service.Update(this.form.getRawValue(), this.form.controls.strategyTypeId.value, this.js.basicdataresult.warehouseId, this.js.basicdataresult.languageId, this.js.basicdataresult.plantId, this.js.basicdataresult.companyCodeId, this.form.controls.sequenceIndicator.value, this.js.basicdataresult.itemCode).subscribe(res => {
    ...
    if (this.js.pageflow == "Edit") {
      ...
      if (this.js.itemCode && this.js.pageflow == 'Edit' && this.js.pageflow != "New") {
        this.sub.add(this.service.Update(this.form.getRawValue(), this.form.controls.strategyTypeId.value, this.js.warehouseId, this.js.languageId, this.js.plantId, this.js.companyCodeId, this.form.controls.sequenceIndicator.value, this.js.itemCode).subscribe(res => {
          this.toastr.success(res.itemCode + " updated successfully!", "Notification", {
            timeOut: 2000,
            progressBar: false,
          });
