...
export class LevelService {
  ...
  Delete(levelId: any,warehouseId: string,languageId:any,companyCodeId:any,plantId:any,level:any) {
    return this.http.delete<any>('/wms-idmaster-service/levelid/' + levelId+'?warehouseId=' + warehouseId+'&languageId='+languageId+'&companyCodeId='+companyCodeId+'&plantId='+plantId+'&level='+level);
}
search(obj: any) {
