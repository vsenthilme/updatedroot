...
export class ThreePlComponent implements OnInit {
  ...
  link = [
    { url: "/main/otherSetup/serviceid", title: "Service ", screenid:3176, class: "mx-1 d-flex justify-content-center align-items-center" },
    { url: "/main/otherSetup/paymenttermid", title: "Payment Term",screenid:3175,  class: "mx-1 d-flex justify-content-center align-items-center" },
    { url: "/main/otherSetup/billingmodeid", title: "Billing Mode", screenid:3183, class: "mx-1 d-flex justify-content-center align-items-center" },
    { url: "/main/otherSetup/billingfrequency", title: "Billing Frequency",screenid:3182,  class: "mx-1 d-flex justify-content-center align-items-center" },
    { url: "/main/otherSetup/billingformat", title: "Billing Format",screenid:3181,  class: "mx-1 d-flex justify-content-center align-items-center" },
    { url: "/main/otherSetup/paymentmode", title: "Payment Mode", screenid:3174, class: "mx-1 d-flex justify-content-center align-items-center" },
