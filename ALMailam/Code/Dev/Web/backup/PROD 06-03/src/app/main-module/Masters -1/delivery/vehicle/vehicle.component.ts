...
export class VehicleComponent implements OnInit {
  ...
  openDialog(data: any = 'New'): void {
    ...
    let paramdata = "";
    paramdata = this.cs.encrypt({ pageflow: data, code: data != 'New' ? this.selectedstorage[0].vehicleNumber : null,warehouseId: data != 'New' ? this.selectedstorage[0].warehouseId : null,languageId: data != 'New' ? this.selectedstorage[0].languageId : null, plantId: data != 'New' ? this.selectedstorage[0].plantId : null,companyCodeId: data != 'New' ? this.selectedstorage[0].companyCodeId : null});
    this.router.navigate(['/main/delivery/vehicleNew/' + paramdata]);
  }
...
if(res){
  ...
  deleteDialog() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        this.deleterecord(this.selectedstorage[0].vehicleNumber,this.selectedstorage[0].warehouseId,this.selectedstorage[0].languageId,this.selectedstorage[0].plantId,this.selectedstorage[0].companyCodeId);
  ...
  downloadexcel() {
    ...
    this.cs.exportAsExcel(res, "Vehicle");
  }
  onChange() {
