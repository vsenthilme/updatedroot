...
plantIdAndDescription: [],
  ...
  dropdownlist(){
   ...
   this.currencyList = this.cas.forLanguageFilter(results[1], this.cas.dropdownlist.setup.currency.key);
    ...
    this.cityList = this.cas.forLanguageFilter(results[3], this.cas.dropdownlist.setup.city.key);
    this.stateList = this.cas.forLanguageFilter(results[4], this.cas.dropdownlist.setup.state.key);
    this.countryList = this.cas.forLanguageFilter(results[5], this.cas.dropdownlist.setup.country.key);
  ...
  this.spin.show();
  this.form.controls.createdOnFE.patchValue(this.cs.day_callapiSearch(this.form.controls.createdOn.value));
  this.form.controls.updatedOnFE.patchValue(this.cs.day_callapiSearch(this.form.controls.updatedOn.value));
  if (this.js.code) {
  ...
  onCountryChange(value){
    ...
    this.masterService.searchCity({countryId: value.value, stateId: this.form.controls.stateId.value, languageId: [this.form.controls.languageId.value]}).subscribe(res => {
      this.cityList = [];
      res.forEach(element => {
        this.cityList.push({value: element.cityId, label: element.cityId + '-' + element.cityName});
      });
