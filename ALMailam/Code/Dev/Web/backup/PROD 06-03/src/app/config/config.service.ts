...
export class ConfigService {
    ...
    */
    ...
    get storageBin_like_url2(): string {
        return '/wms-masters-service/storagebin/findStorageBinByLikeNew'
    }
    get itemCode_like_url2(): string {
        return '/wms-masters-service/imbasicdata1/findItemCodeByLikeNew'
    }
    get prepetualCountList_url(): string {
        return '/wms-transaction-service/perpetualheader/v2/findPerpetualHeader'
    }
    ...
    get prepetualCountSaveHHT(): string {
        return '/wms-transaction-service/perpetualline/v2/assigingHHTUser'
    }

    get prepetualLinePatch(): string {
        return '/wms-transaction-service/perpetualline'
    }
    get findPeriodicHeaderListNew(): string {
        return '/wms-transaction-service/periodicheader/findPeriodicHeaderNew'
    }
    get getStorageBinNew(): string {
        return '/wms-masters-service/storagebin/findStorageBinNew'
    }
    get prepetualRun_url_new(): string {
        return '/wms-transaction-service/perpetualheader/runNew'
    }
    ...
    get periodicCountHHTUserPatch(): string {
        return '/wms-transaction-service/periodicline/v2/assigingHHTUser'
    }
