...
@Component({
  selector: 'app-re-delivery',
  templateUrl: './re-delivery.component.html',
  styleUrls: ['./re-delivery.component.scss']
})
export class ReDeliveryComponent implements OnInit {
 ...
 //   obj.companyCodeId = [this.auth.companyId];
  ...
  confirm(linedata: any = null): void {
    ...
    this.router.navigate(['/main/delivery/redeliveryLine/' + paramdata]);
  }
