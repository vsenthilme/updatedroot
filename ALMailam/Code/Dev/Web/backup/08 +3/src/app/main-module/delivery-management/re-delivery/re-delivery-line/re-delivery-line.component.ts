...
@Component({
  selector: 'app-re-delivery-line',
  templateUrl: './re-delivery-line.component.html',
  styleUrls: ['./re-delivery-line.component.scss']
})
export class ReDeliveryLineComponent implements OnInit {
