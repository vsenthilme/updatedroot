...
@Component({
  selector: 'app-b2btransferorder-lines',
  templateUrl: './b2btransferorder-lines.component.html',
  styleUrls: ['./b2btransferorder-lines.component.scss']
})
export class B2btransferorderLinesComponent implements OnInit {
...
fill(data:any){
  ...
  this.service.b2btransferline(obj).subscribe(
    (res) => {
      this.spin.hide();
      this.picking = res;
    },
...
const fileName = `B2b Transfer_${returnOrderNo}-`;
