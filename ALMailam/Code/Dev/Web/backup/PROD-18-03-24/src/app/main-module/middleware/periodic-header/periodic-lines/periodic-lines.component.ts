...
@Component({
  selector: 'app-periodic-lines',
  templateUrl: './periodic-lines.component.html',
  styleUrls: ['./periodic-lines.component.scss']
})
export class PeriodicLinesComponent implements OnInit {
...
fill(data:any){
  ...
  this.service.periodiclines(obj).subscribe(
    (res) => {
      this.spin.hide();
      this.picking = res;
    },
...
const fileName = `Periodic Count Lines_${returnOrderNo}-`;
