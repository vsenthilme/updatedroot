...
export class MiddlewareTabComponent implements OnInit {
  ...
  link = [
    ...
    { url: "/main/middleware/stockreceiptheader", title: "Direct Receipt", screenid:3044, class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
    { url: "/main/middleware/interwarehousein", title: "Inbound WMS to WMS", screenid:3044, class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
    { url: "/main/middleware/B2BTransferOrder", title: "Inbound NONWMS TO WMS ", screenid:3044, class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
    ...
    { url: "/main/middleware/picklist", title: "Pick List ", screenid:3044, class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
    { url: "/main/middleware/interwarehouseout", title: "Outbound WMS to WMS", screenid:3044, class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
    { url: "/main/middleware/shippingorder", title: "Outbound NONWMS to WMS ", screenid:3044, class: "mx-1 d-flex justify-content-center align-items-center" },
    { url: "/main/middleware/purchasereturn", title: "Purchase Return ", screenid:3044, class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
