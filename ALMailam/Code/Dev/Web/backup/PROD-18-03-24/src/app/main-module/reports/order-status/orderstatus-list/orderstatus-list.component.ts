...
@Component({
  ...
  styleUrls: ['./orderstatus-list.component.scss']
})
export class OrderstatusListComponent implements OnInit {
  ...
  displayedColumns: string[] = [ 'warehouseno','countno','by', 'preinboundno', 'status','damage','hold','available','stype','time','balance','opening','perct','status1'];
