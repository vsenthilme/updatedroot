...
import { OrdermanagementService } from "../../Outbound/order-management/ordermanagement-main/ordermanagement.service";
...
export class InventoryReportComponent implements OnInit {
  ...
  // }
orderManagementLines: any[] = [];
  row(expand, line){
    this.orderManagementLines =[];
    let obj: any = {};
    obj.itemCode =  [line.itemCode];
    obj.manufacturerName = [line.manufacturerName];

    this.orderManagement.searchSpark(obj).subscribe(res => {
      this.orderManagementLines = res;
    })
  }
}
