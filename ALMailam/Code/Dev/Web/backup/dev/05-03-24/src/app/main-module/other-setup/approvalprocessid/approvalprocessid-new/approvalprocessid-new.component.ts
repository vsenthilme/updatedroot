...
@Component({
  selector: 'app-approvalprocessid-new',
  templateUrl: './approvalprocessid-new.component.html',
  styleUrls: ['./approvalprocessid-new.component.scss']
})
export class ApprovalprocessidNewComponent implements OnInit {
