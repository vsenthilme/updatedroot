...
@Component({
  selector: 'app-fabrication-main',
  templateUrl: './fabrication-main.component.html',
  styleUrls: ['./fabrication-main.component.scss']
})
export class FabricationMainComponent implements OnInit {
