...
export class InboundConfirmationService {
  ...
  searchstream(obj: any) {
    return this.http.post<any>(this.url + '/findInboundHeader/v2/stream', obj);
  }
  searchSpark(obj: any) {
  ...
  searchLinesparkNew(obj: any) {
    return this.http.post<any>( '/wms-spark-service/inboundline/new', obj);
  }
  searchLinesparkV1(obj: any) {
    return this.http.post<any>( '/wms-spark-service/findInboundLineReport', obj);
  }
  ...
  confirmV2(warehouseId: any, preInboundNo: any, refDocNumber: any,plantId:any,companyCode:any,languageId:any) {
    return this.http.patch<any>(this.url + '/v2/partialConfirmIndividual?preInboundNo=' + preInboundNo + '&refDocNumber=' + refDocNumber + '&warehouseId=' + warehouseId +'&plantId='+plantId+'&companyCode='+companyCode+'&languageId='+languageId, {});
  }
  ...
  getInboundFormPdfv2(asnNumber:any,companyCodeId:any,plantId:any,warehouseId:any,languageId:any,preInboundNo:any) {
    return this.http.get<any>(this.apiName + 'reports/v2/receiptConfirmation' + `?asnNumber=${asnNumber}&reportFormat='pdf'`+'&companyCodeId='+companyCodeId+'&plantId='+plantId+'&warehouseId='+warehouseId+'&languageId='+languageId+'&preInboundNo='+preInboundNo);
  }
  ...
  updateInboundLineBatch(obj){
    return this.http.patch('/wms-transaction-service/inboundline/v2/batchUpdateInboundLines', obj)
  }

  // partialConfirmationv2(obj){
  //   return this.http.patch('/wms-transaction-service/inboundheader/v2/confirmIndividual/partial', obj)
  // }
  partialConfirmationv2(line, obj) {
    return this.http.post<any>('/wms-transaction-service/inboundheader/v2/confirmIndividual/partial?preInboundNo=' + line.preInboundNo + '&refDocNumber=' + line.refDocNumber + '&warehouseId=' + line.warehouseId +'&plantId='+line.plantId+'&companyCode='+line.companyCode+'&languageId='+line.languageId, obj);
  }
}
