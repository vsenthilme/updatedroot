...
export class BasicdataNewComponent implements OnInit {
  ...
  fill() {
    ...
    if (this.js.pageflow == 'basicDataEdit' || this.js.pageflow == 'basicDataEdit2' || this.js.pageflow == 'basicDataEdit3') {
      ...
      this.sub.add(this.service.Get(this.js.code, this.auth.warehouseId, this.auth.languageId, this.auth.plantId, this.auth.companyId, this.js.uomId, this.js.itemCode, this.js.manufacturerPartNo).subscribe(res => {
  ...
  submit() {
    ...
    const myString = this.form.controls.itemCode.value;
    this.form.controls.itemCode.patchValue(myString.trim());
