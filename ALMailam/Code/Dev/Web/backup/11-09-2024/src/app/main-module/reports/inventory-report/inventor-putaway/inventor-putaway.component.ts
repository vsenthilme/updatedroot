...
@Component({
  selector: 'app-inventor-putaway',
  templateUrl: './inventor-putaway.component.html',
  styleUrls: ['./inventor-putaway.component.scss']
})
export class InventorPutawayComponent implements OnInit {
  screenid=3185;
  inbound: any[] = [];
  selectedinbound : any[] = [];
