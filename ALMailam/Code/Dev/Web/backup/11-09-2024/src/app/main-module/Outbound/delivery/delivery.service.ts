...
export class DeliveryService {
  ...
  searchsparkreport(obj: any) {
    return this.http.post<any>( '/wms-spark-service/obHeader/obOrderSummaryReport', obj);
  }
  ...
  searchspark(obj: any) {
    return this.http.post<any>('/wms-spark-service/outboundHeaderTest', obj);
  }
  ...
  getOtBoundDeliveryFormPdfv2(orderNumber:any, warehouseId:any,companyCodeId:any,plantId:any,languageId:any,preOutboundNo:any) {
    return this.http.get<any>(this.apiName + 'reports/v2/shipmentDelivery/new' + '?orderNumber='+orderNumber+'&warehouseId='+warehouseId+'&companyCodeId='+companyCodeId+'&plantId='+plantId+'&languageId='+languageId+'&preOutboundNo='+preOutboundNo);
