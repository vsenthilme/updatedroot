...
export class CommonService {
 ...
 timeFormat(date: any) {
  ...
  getDataDiff(startDate: any, endDate: any) {
    ...
    var daysInName = days == 0 ? '' : this.padWithZero(days) + 'Days: ';
    var hoursInName = hours == 0 ? '' : this.padWithZero(hours) + 'Hours: ';
    var minsInName = minutes == 0 ? '' : this.padWithZero(minutes) + 'Minutes: ';
    var secondsInName = seconds == 0 ? '' : this.padWithZero(seconds) + 'Seconds';

    return daysInName + ' ' + hoursInName + ' ' + minsInName + ' ' + secondsInName;
  };
