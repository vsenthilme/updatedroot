...
getAll() {
this.spin.show();
this.form.controls.startDeliveryConfirmedOn.patchValue(this.cs.dateNewFormat(this.form.controls.startDeliveryConfirmedOnFE.value));
this.form.controls.endDeliveryConfirmedOn.patchValue(this.cs.dateNewFormat(this.form.controls.endDeliveryConfirmedOnFE.value));
