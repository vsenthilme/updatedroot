...
export class SubitemgroupComponent implements OnInit {
  ...
  deleteDialog() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        this.deleterecord(this.selectedsubitem[0].subItemGroupId,this.selectedsubitem[0].warehouseId,this.selectedsubitem[0].languageId,this.selectedsubitem[0].companyCodeId,this.selectedsubitem[0].plantId,this.selectedsubitem[0].itemGroupId,this.selectedsubitem[0].itemTypeId,this.selectedsubitem[0].subItemGroup);
  ...
  deleterecord(id: any,warehouseId:any,languageId:any,companyCodeId:any,plantId:any,itemGroupId:any,itemTypeId:any,subItemGroup:any) {
    this.spin.show();
    this.sub.add(this.service.Delete(id,warehouseId,languageId,companyCodeId,plantId,itemGroupId,itemTypeId).subscribe((res) => {
