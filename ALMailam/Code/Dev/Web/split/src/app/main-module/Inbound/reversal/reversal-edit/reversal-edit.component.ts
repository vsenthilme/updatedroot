...
@Component({
  selector: 'app-reversal-edit',
  templateUrl: './reversal-edit.component.html',
  styleUrls: ['./reversal-edit.component.scss']
})
export class ReversalEditComponent implements OnInit {
