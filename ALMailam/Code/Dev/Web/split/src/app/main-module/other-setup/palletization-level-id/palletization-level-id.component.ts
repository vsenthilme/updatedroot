...
screenid=3102;
  ...
  constructor(public dialog: MatDialog,
   ...
   // private excel: ExcelService,
    ...
    multicountryList:any[]=[];
      ...
      res.forEach((x: { palletizationLevelId: string; palletizationLevel: string, }) => {
        this.multidateformatList.push({
          value: x.palletizationLevelId,
          label: x.palletizationLevelId + '-' + x.palletizationLevel,
        });
    });
  ...
  deleteDialog() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        this.deleterecord(this.selectedpallets[0].palletizationLevelId,this.selectedpallets[0].warehouseId,this.selectedpallets[0].languageId,this.selectedpallets[0].companyCodeId,this.selectedpallets[0].plantId,this.selectedpallets[0].palletizationLevel);
  ...
  deleterecord(id: any,warehouseId:any,languageId:any,companyCodeId:any,plantId:any,palletizationLevel:any) {
    this.spin.show();
    this.sub.add(this.service.Delete(id,warehouseId,languageId,companyCodeId,plantId,palletizationLevel).subscribe((res) => {
