...
export class PreinboundService {
  ...
  UpdateSalesInvoice(warehouseId:any,plantId:any,companyCode:any,languageId:any,oldInvoiceNumber:any,newInvoiceNumber:any,oldPreInboundNo:any,newPreInboundNo:any) {
    return this.http.get<any>('/wms-transaction-service/SalesInvoice/replace'+'?warehouseId='+warehouseId+'&plantId='+plantId +'&companyCode='+companyCode+'&languageId='+languageId+'&oldInvoiceNumber='+oldInvoiceNumber+'&newInvoiceNumber='+newInvoiceNumber+'&oldPreInboundNo='+oldPreInboundNo+'&newPreInboundNo='+newPreInboundNo,);
  }
  ...
  cancelSalesReturn(obj) {
    return this.http.post<any>('/wms-transaction-service/inboundOrder/cancellation', obj);
  }
}
