...
@Component({
  selector: 'app-shelfid-new',
  templateUrl: './shelfid-new.component.html',
  styleUrls: ['./shelfid-new.component.scss']
})
export class ShelfidNewComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.data.pageflow != 'New') {
      this.form.controls.shelfId.disable();
      this.form.controls.warehouseId.disable();
      this.form.controls.languageId.disable();
      this.form.controls.plantId.disable();
  ...
  fill() {
    this.spin.show();
    this.sub.add(this.service.Get(this.data.code,this.data.warehouseId,this.data.languageId,this.data.companyCodeId,this.data.plantId,this.data.aisleId,this.data.rowId,this.data.storageSectionId,this.data.spanId,this.data.floorId).subscribe(res => {
  ...
  dropdownlist(){
    ...
    this.flooridList = this.cas.forLanguageFilter(results[4], this.cas.dropdownlist.setup.floorid.key);
     ...
     this.spanList=this.cas.forLanguageFilter(results[8], this.cas.dropdownlist.setup.spanid.key);
    ...
    this.masterService.searchspan({companyCodeId: this.auth.companyId, plantId: this.auth.plantId, warehouseId: this.auth.warehouseId, languageId: [this.auth.languageId]}).subscribe(res => {
      this.spanList = [];
      res.forEach(element => {
  ...
  //  this.spanList=this.cas.foreachlist2(results[8], this.cas.dropdownlist.setup.spanid.key);
 ...
 this.masterService.searchPlant({companyCodeId: [this.form.controls.companyCodeId.value], languageId: [this.form.controls.languageId.value]}).subscribe(res => {
  ...
  this.masterService.searchspan({companyCodeId: this.form.controls.companyCodeId.value, plantId: this.form.controls.plantId.value, warehouseId: this.form.controls.warehouseId.value, languageId: [this.form.controls.languageId.value],aisleId:[this.form.controls.aisleId.value],rowId:[this.form.controls.rowId.value]}).subscribe(res => {
    this.spanList = [];
    res.forEach(element => {
      this.spanList.push({value: element.spanId, label: element.spanId + '-' + element.spanDescription});
    });
  ...
  onLanguageChange(value){
    ...
    this.masterService.searchspan({aiselId:[this.form.controls.aisleId.value],rowId:[this.form.controls.rowId.value],companyCodeId: this.form.controls.companyCodeId.value, plantId: this.form.controls.plantId.value, warehouseId: this.form.controls.warehouseId.value,floorId:[this.form.controls.floorId.value],storageSectionId:[this.form.controls.storageSectionId.value], languageId: [value.value]}).subscribe(res => {
      this.spanList = [];
      res.forEach(element => {
        this.spanList.push({value: element.spanId, label: element.spanId + '-' + element.spanDescription});
      });
  ...
  onCompanyChange(value){
    ...
    this.masterService.searchspan({aiselId:[this.form.controls.aisleId.value],rowId:[this.form.controls.rowId.value],companyCodeId: value.value, plantId: this.form.controls.plantId.value, warehouseId: this.form.controls.warehouseId.value,floorId:[this.form.controls.floorId.value],storageSectionId:[this.form.controls.storageSectionId.value], languageId: [this.form.controls.languageId.value]}).subscribe(res => {
      this.spanList = [];
      res.forEach(element => {
        this.spanList.push({value: element.spanId, label: element.spanId + '-' + element.spanDescription});
      });
  ...
  onPlantChange(value){
      ...
      this.masterService.searchspan({aiselId:[this.form.controls.aisleId.value],rowId:[this.form.controls.rowId.value],companyCodeId:this.form.controls.companyCodeId.value, plantId: value.value, warehouseId: this.form.controls.warehouseId.value,floorId:[this.form.controls.floorId.value],storageSectionId:[this.form.controls.storageSectionId.value], languageId: [this.form.controls.languageId.value]}).subscribe(res => {
        this.spanList = [];
        res.forEach(element => {
          this.spanList.push({value: element.spanId, label: element.spanId + '-' + element.spanDescription});
        });
  ...
  onWarehouseChange(value){
    ...
    this.masterService.searchspan({aiselId:[this.form.controls.aisleId.value],rowId:[this.form.controls.rowId.value],companyCodeId:this.form.controls.companyCodeId.value, plantId: this.form.controls.plantId.value, warehouseId: value.value,floorId:[this.form.controls.floorId.value],storageSectionId:[this.form.controls.storageSectionId.value], languageId: [this.form.controls.languageId.value]}).subscribe(res => {
      this.spanList = [];
      res.forEach(element => {
        this.spanList.push({value: element.spanId, label: element.spanId + '-' + element.spanDescription});
      });
...
onfloorChange(value){
  ...
  this.masterService.searchspan({aiselId:[this.form.controls.aisleId.value],rowId:[this.form.controls.rowId.value],companyCodeId:this.form.controls.companyCodeId.value, plantId: this.form.controls.plantId.value, warehouseId:this.form.controls.warehouseId.value,floorId:[value.value],storageSectionId:[this.form.controls.storageSectionId.value], languageId: [this.form.controls.languageId.value]}).subscribe(res => {
    this.spanList = [];
    res.forEach(element => {
      this.spanList.push({value: element.spanId, label: element.spanId + '-' + element.spanDescription});
    });
...
onstoragesectionChange(value){
  ...
  this.masterService.searchspan({aiselId:[this.form.controls.aisleId.value],rowId:[this.form.controls.rowId.value],companyCodeId:this.form.controls.companyCodeId.value, plantId: this.form.controls.plantId.value, warehouseId:this.form.controls.warehouseId.value,floorId:[this.form.controls.floorId.value],storageSectionId:[value.value], languageId: [this.form.controls.languageId.value]}).subscribe(res => {
    this.spanList = [];
    res.forEach(element => {
      this.spanList.push({value: element.spanId, label: element.spanId + '-' + element.spanDescription});
    });
...
onrowChange(value){
  ...
  this.masterService.searchspan({aiselId:[this.form.controls.aisleId.value],rowId:[value.value],companyCodeId:this.form.controls.companyCodeId.value, plantId: this.form.controls.plantId.value, warehouseId:this.form.controls.warehouseId.value,floorId:[this.form.controls.floorId.value],storageSectionId:[this.form.controls.storageSectionId.value], languageId: [this.form.controls.languageId.value]}).subscribe(res => {
    this.spanList = [];
    res.forEach(element => {
      this.spanList.push({value: element.spanId, label: element.spanId + '-' + element.spanDescription});
    });
  ...
  if (this.data.code) {
    this.sub.add(this.service.Update(this.form.getRawValue(),this.data.code,this.data.warehouseId,this.data.languageId,this.data.companyCodeId,this.data.plantId,this.data.aisleId,this.data.rowId,this.data.storageSectionId,this.data.spanId,this.data.floorId).subscribe(res => {
    ...
    this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
      this.toastr.success(res.shelfId + " Saved Successfully!","Notification",{
        timeOut: 2000,
        progressBar: false,
      });
      this.spin.hide();
