...
export class PickingReportUsersComponent implements OnInit {
 ...
 // displayedColumns: string[] = [ 'statusId', 'refDocNumber','referenceField1', 'lineNumber', 'itemCode', 'description', 'pickedPackCode', 'proposedStorageBin','pickupConfirmedBy','partnerCode', 'pickConfirmQty', 'pickupConfirmedOn', 'pickupCreatedOn', 'leadTime'];

  //wms demo
  displayedColumns: string[] = [ 'statusId', 'refDocNumber','referenceField1', 'lineNumber', 'itemCode', 'description', 'pickedPackCode', 'proposedStorageBin','pickupConfirmedBy','partnerCode', 'pickConfirmQty', 'pickupConfirmedOn'];
