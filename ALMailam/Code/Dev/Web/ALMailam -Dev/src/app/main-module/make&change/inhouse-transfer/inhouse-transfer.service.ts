...
export class InhouseTransferService {
  ...
  searchSparkheader(obj:any) {
    return this.http.post<any>('/wms-spark-service/inhousetransferheader',obj);
  }
  Create(obj: any) {
  ...
  inventoryUpdatev2(stockTypeId: any, itemCode: any, packBarcodes: any, specialStockIndicatorId: any, storageBin: any,manufacturerName:any, warehouseId: any,languageId:any,companyCodeId:any,plantId:any, obj: any) {
    return this.http.patch<any>('/wms-transaction-service/inventory/v2/' + stockTypeId + '?itemCode=' + itemCode + '&packBarcodes=' + packBarcodes + '&specialStockIndicatorId=' + specialStockIndicatorId + '&storageBin=' + storageBin+'&manufacturerName='+manufacturerName + '&warehouseId=' + warehouseId+'&languageId='+languageId+'&companyCodeId='+companyCodeId+'&plantId='+plantId, obj);
  }

  createInventoryMovement(obj: any) {
    return this.http.post<any>('/wms-transaction-service/inventorymovement', obj);
  }
  createInventoryv2(obj: any) {
    return this.http.post<any>('/wms-transaction-service/v2/inventory', obj);
  }
  ...
  searchTransferLineSpark(obj: any) {
    return this.http.post<any>('/wms-spark-service/inhousetransferline', obj);
  }
}
