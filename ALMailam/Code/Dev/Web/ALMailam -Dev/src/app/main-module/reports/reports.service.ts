...
findInventoryspark(obj:any){
  ...
  updateInventoryMovement(obj: any, object) {
    return this.http.patch<any>('/wms-transaction-service/inventorymovement/' + obj.movementType +'?batchSerialNumber=' + 1 + '&companyCodeId=' + obj.companyCodeId  + '&languageId=' + obj.languageId  +  '&plantId=' + obj.plantId + '&itemCode=' + obj.itemCode + '&movementDocumentNo=' + obj.movementDocumentNo + '&packBarcodes=' + obj.packBarcodes +  '&submovementType=' + obj.submovementType + '&warehouseId=' + obj.warehouseId, object);
  }
  updateInventoryMovementv2(obj: any, object) {
    return this.http.patch<any>('/wms-transaction-service/v2/inventorymovement/' + obj.movementType +'?batchSerialNumber=' + 1 + '&companyCodeId=' + obj.companyCodeId  + '&languageId=' + obj.languageId  +  '&plantId=' + obj.plantId + '&itemCode=' + obj.itemCode + '&movementDocumentNo=' + obj.movementDocumentNo + '&packBarcodes=' + obj.packBarcodes +  '&submovementType=' + obj.submovementType + '&warehouseId=' + obj.warehouseId+'&manufacturerName='+obj.manufacturerName , object);
  }
  ...
  getoutboundlinespark(obj: any) {
    return this.http.post<any>('/wms-spark-service/outboundlinev2/new', obj);
  }
  ...
  getgrlineSpark(obj: any) {
    return this.http.post<any>('/wms-spark-service/grline/new', obj);
  }
