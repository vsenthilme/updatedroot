...
this.searhform.controls.toPickConfirmedOnFE.patchValue(currentDate);
    this.searhform.controls.fromPickConfirmedOnFE.patchValue(currentMonthStartDate);
  }
  ...
  filtersearch(){
   ...
   if(this.searhform.controls.refDocNumber.value == null){
    this.searhform.controls.refDocNumber.patchValue(this.searhform.controls.refDocNumber.value);
    }
    else{
      this.searhform.controls.refDocNumber.patchValue([this.searhform.controls.refDocNumber.value]);
    }
...
getavgLeadTime() {
  ...
  let averageLeadTime = (total2 > 0) ? total / total2 : 0;
  ...
  downloadexcel() {
    ...
    this.hhtPicker.forEach(x => {
      res.push({
        ...
        "Level":x.levelId,
        "Storage Bin":x.pickedStorageBin,
        "Assigned On": this.cs.dateMMYY(x.pickupCreatedOn),
        "Assigned On Time":this.cs.timeFormat(x.pickupCreatedOn),
        "Picked On": this.cs.dateMMYY(x.pickupConfirmedOn),
        "Picked On Time":this.cs.timeFormat(x.pickupConfirmedOn),
