...
//				log.info("Result containerReceipt---getContainerReceivedDate() :" + containerReceipt.getContainerReceivedDate());
    ...
    public InventoryMovement getInventoryMovementV2(String companyCodeId, String plantId, String languageId, String warehouseId,
                                                    ...
                                                    String manufacturerName, String movementDocumentNo, String authToken) throws ParseException {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "ClassicWMS RestTemplate");
            ...
            UriComponentsBuilder builder = UriComponentsBuilder
                    .fromHttpUrl(getTransactionServiceApiUrl() + "inventorymovement/v2/" + movementType)
    ...
    // PATCH
    public InventoryMovement updateInventoryMovementV2(String companyCodeId, String plantId, String languageId, String warehouseId, Long movementType, Long submovementType,
                                                       String packBarcodes, String itemCode, String manufacturerName, String movementDocumentNo,
                                                       InventoryMovement modifiedInventoryMovement, String loginUserID, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
    ...
    // DELETE
    public boolean deleteInventoryMovementV2(String companyCodeId, String plantId, String languageId, String warehouseId, Long movementType, Long submovementType,
                                             String packBarcodes, String itemCode, String manufacturerName, String movementDocumentNo, String loginUserID,
                                             String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
...
//            return putAwayLineList.toArray(new PutAwayLineV2[putAwayLineList.size()]);
    ...
    public InventoryV2[] findInventoryV2(SearchInventoryV2 searchInventory, String authToken) throws ParseException {
        try {
            ...
            log.info("result : " + result.getStatusCode());
            log.info("Find Inventory result : " + new Date());
            return result.getBody();
        } catch (Exception e) {
            e.printStackTrace();
            throw e;
...
//            return obList.toArray(new OrderManagementLineV2[obList.size()]);
    ...
    public OrderManagementLineV2 doUnAllocationV2(String companyCodeId, String plantId, String languageId, String warehouseId,
                                                  ...
                                                  String loginUserID, String manufacturerName, String authToken) {
        try {
            HttpHeaders headers = new HttpHeaders();
            headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
            headers.add("User-Agent", "ClassicWMS-Almailem RestTemplate");
