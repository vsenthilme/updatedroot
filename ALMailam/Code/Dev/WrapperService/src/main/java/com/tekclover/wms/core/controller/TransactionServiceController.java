...
public class TransactionServiceController {
    ...
    @ApiOperation(response = InventoryMovement.class, value = "Get a InventoryMovement") // label for swagger
    @GetMapping("/v2/inventorymovement/{movementType}")
    public ResponseEntity<?> getInventoryMovementV2(@PathVariable Long movementType, @RequestParam String languageId, @RequestParam String companyCodeId, @RequestParam String plantId,
                                                    @RequestParam String warehouseId, @RequestParam Long submovementType, @RequestParam String packBarcodes, @RequestParam String itemCode,
                                                    @RequestParam String manufacturerName, @RequestParam String movementDocumentNo,
                                                    @RequestParam String authToken) throws Exception {
        InventoryMovement dbInventoryMovement = transactionService.getInventoryMovementV2(companyCodeId, plantId, languageId, warehouseId, movementType, submovementType,
                packBarcodes, itemCode, manufacturerName, movementDocumentNo, authToken);
        log.info("InventoryMovement : " + dbInventoryMovement);
        return new ResponseEntity<>(dbInventoryMovement, HttpStatus.OK);
    }

    @ApiOperation(response = InventoryMovement.class, value = "Update InventoryMovement") // label for swagger
    @RequestMapping(value = "/v2/inventorymovement/{movementType}", method = RequestMethod.PATCH)
    public ResponseEntity<?> patchInventoryMovementV2(@PathVariable Long movementType, @RequestParam String languageId, @RequestParam String companyCodeId, @RequestParam String plantId,
                                                      @RequestParam String warehouseId, @RequestParam Long submovementType, @RequestParam String packBarcodes, @RequestParam String itemCode,
                                                      @RequestParam String manufacturerName, @RequestParam String movementDocumentNo, @RequestParam String loginUserID,
                                                      @RequestParam String authToken, @Valid @RequestBody InventoryMovement updateInventoryMovement)
            throws IllegalAccessException, InvocationTargetException {
        InventoryMovement updatedInventoryMovement =
                transactionService.updateInventoryMovementV2(companyCodeId, plantId, languageId, warehouseId, movementType, submovementType, packBarcodes, itemCode, manufacturerName, movementDocumentNo, updateInventoryMovement,
                        loginUserID, authToken);
        return new ResponseEntity<>(updatedInventoryMovement, HttpStatus.OK);
    }

    @ApiOperation(response = InventoryMovement.class, value = "Delete InventoryMovement") // label for swagger
    @DeleteMapping("/v2/inventorymovement/{movementType}")
    public ResponseEntity<?> deleteInventoryMovementV2(@PathVariable Long movementType, @RequestParam String languageId, @RequestParam String companyCodeId, @RequestParam String plantId,
                                                       @RequestParam String warehouseId, @RequestParam Long submovementType, @RequestParam String packBarcodes, @RequestParam String itemCode,
                                                       @RequestParam String manufacturerName, @RequestParam String movementDocumentNo,
                                                     @RequestParam String loginUserID, @RequestParam String authToken) {
        transactionService.deleteInventoryMovementV2(companyCodeId, plantId, languageId, warehouseId, movementType, submovementType, packBarcodes, itemCode, manufacturerName, movementDocumentNo, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
...
// -------------------------------------StagingHeader-V2--------------------------------------------------------------------------------------------
    ...
    public ResponseEntity<?> patchUnallocateV2(@RequestParam String companyCodeId, @RequestParam String plantId, @RequestParam String languageId,
                                               ...
                                               @RequestParam String refDocNumber, @RequestParam String partnerCode, @RequestParam Long lineNumber,
                                               @RequestParam String itemCode, @RequestParam String proposedStorageBin, @RequestParam String proposedPackBarCode,
                                               @RequestParam String loginUserID, @RequestParam(required = false) String manufacturerName, @RequestParam String authToken)
            throws IllegalAccessException, InvocationTargetException {
        OrderManagementLineV2 updatedOrderManagementLine =
                transactionService.doUnAllocationV2(companyCodeId, plantId, languageId, warehouseId, preOutboundNo, refDocNumber, partnerCode, lineNumber,
                        itemCode, proposedStorageBin, proposedPackBarCode, loginUserID, manufacturerName, authToken);
        return new ResponseEntity<>(updatedOrderManagementLine, HttpStatus.OK);
    }
