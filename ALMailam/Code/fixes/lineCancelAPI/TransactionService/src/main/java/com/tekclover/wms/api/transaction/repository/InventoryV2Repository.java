...
//            @Param(value = "stockTypeText") String stockTypeText);
    ...
    public IInventoryImpl getOutboundReversalInventoryV2(@Param("companyCodeId") String companyCodeId,
                                                         @Param("plantId") String plantId,
                                                         @Param("languageId") String languageId,
                                                         @Param("warehouseId") String warehouseId,
    ...
    public String getPutAwayHeaderCreateInventoryV2(@Param("companyCodeId") String companyCodeId,
                                                    @Param("plantId") String plantId,
                                                    @Param("languageId") String languageId,
                                                    @Param("warehouseId") String warehouseId,
                                                    @Param("itemCode") String itemCode,
