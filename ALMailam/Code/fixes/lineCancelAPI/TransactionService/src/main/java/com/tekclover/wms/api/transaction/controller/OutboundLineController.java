...
import com.tekclover.wms.api.transaction.model.outbound.v2.ReversalInput;
...
//	}
	...
	@ApiOperation(response = OutboundLineV2.class, value = "Cancel Line Batch") // label for swagger
	@PostMapping("/v2/cancel/batch")
	public ResponseEntity<?> doCancelLineBatchV2(@RequestBody List<ReversalInput> outboundReversalInput,
												 @RequestParam String loginUserID) throws Exception {
		outboundlineService.batchOutboundReversalV2(outboundReversalInput, loginUserID);
