...
//            String manufacturerName, String storageBin, Long statusId, Date stockCountDate, Date date, Long deletionIndicator);
	...
	List<PickupLineV2> findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndRefDocNumberAndPreOutboundNoAndItemCodeAndManufacturerNameAndLineNumberAndOutboundOrderTypeIdAndPickConfirmQtyGreaterThanAndDeletionIndicator(
            String companyCodeId, String plantId, String languageId, String warehouseId, String refDocNumber, String preOutboundNo, String itemCode, String manufacturerName, Long lineNumber, Long orderTypeId, Double pickConfirmQty, Long deletionIndicator);
}