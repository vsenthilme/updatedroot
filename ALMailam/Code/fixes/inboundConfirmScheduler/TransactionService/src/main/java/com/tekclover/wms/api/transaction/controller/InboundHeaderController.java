...
//        AXApiResponse createdInboundHeaderResponse = inboundheaderService.updateInboundHeaderPartialConfirmNewV2(inboundLineList, companyCode, plantId, languageId, warehouseId, preInboundNo, refDocNumber, loginUserID);
        AXApiResponse createdInboundHeaderResponse = inboundheaderService.partialInboundConfirmV2(inboundLineList, companyCode, plantId, languageId, warehouseId, preInboundNo, refDocNumber, loginUserID);
        return new ResponseEntity<>(createdInboundHeaderResponse, HttpStatus.OK);
    }
