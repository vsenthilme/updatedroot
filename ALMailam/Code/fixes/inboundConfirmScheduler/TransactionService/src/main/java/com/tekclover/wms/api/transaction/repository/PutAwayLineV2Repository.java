...
PutAwayLineV2 findTopByCompanyCodeAndPlantIdAndWarehouseIdAndLanguageIdAndItemCodeAndManufacturerNameAndStatusIdAndDeletionIndicatorOrderByCreatedOn(
    ...
    @Query("Update PutAwayLineV2 ob SET ob.isInventoryCreated = :isInventoryCreated \r\n "
            + " WHERE ob.companyCode = :companyCode AND ob.plantId = :plantId AND ob.languageId = :languageId AND ob.warehouseId = :warehouseId AND ob.putAwayNumber = :putAwayNumber AND ob.preInboundNo = :preInboundNo AND ob.lineNo = :lineNo AND ob.itemCode = :itemCode")
