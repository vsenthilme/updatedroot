...
import com.tekclover.wms.api.masters.transaction.model.dto.IImbasicData1;
import com.tekclover.wms.api.masters.transaction.model.dto.StatusId;
import com.tekclover.wms.api.masters.transaction.model.dto.TStorageBin;
import com.tekclover.wms.api.masters.transaction.model.dto.Warehouse;
...
import com.tekclover.wms.api.masters.transaction.model.outbound.UpdateOutboundHeader;
import com.tekclover.wms.api.masters.transaction.model.outbound.ordermangement.v2.OrderManagementLineV2;
import com.tekclover.wms.api.masters.transaction.model.outbound.ordermangement.v2.SearchOrderManagementLineV2;
import com.tekclover.wms.api.masters.transaction.model.outbound.pickup.v2.PickupHeaderV2;
import com.tekclover.wms.api.masters.transaction.model.outbound.pickup.v2.SearchPickupHeaderV2;
import com.tekclover.wms.api.masters.transaction.model.outbound.quality.*;
import com.tekclover.wms.api.masters.transaction.model.outbound.quality.v2.*;
...
import com.tekclover.wms.api.masters.transaction.repository.specification.QualityLineSpecification;
import com.tekclover.wms.api.masters.transaction.repository.specification.QualityLineV2Specification;
...
//					log.info("outboundLine re-queried-----> : " + outboundLines);
                ...
                TStorageBin TStorageBin = mastersService.getStorageBin(dbQualityLine.getWarehouseId(), BIN_CLASS_ID,
                ...
                BIN_CLASS_ID = 5L;
                TStorageBin = mastersService.getStorageBin(dbQualityLine.getWarehouseId(), BIN_CLASS_ID,
                        authTokenForMastersService.getAccess_token());
                ...
                Inventory existingInventory = inventoryService.getInventory(dbQualityLine.getWarehouseId(),
                        dbQualityLine.getPickPackBarCode(), dbQualityLine.getItemCode(), TStorageBin.getStorageBin());
                ...
                if (existingInventory != null) {
                    ...
                    try {
                        Inventory updatedInventory = inventoryService.updateInventory(dbQualityLine.getWarehouseId(),
                                dbQualityLine.getPickPackBarCode(), dbQualityLine.getItemCode(),
                                TStorageBin.getStorageBin(), 1L, 1L, updateInventory, loginUserID);
