...
import com.tekclover.wms.api.masters.transaction.model.dto.BomHeader;
import com.tekclover.wms.api.masters.transaction.model.dto.BomLine;
...
import com.tekclover.wms.api.masters.transaction.model.inbound.preinbound.AddPreInboundLine;
import com.tekclover.wms.api.masters.transaction.model.inbound.preinbound.PreInboundLineEntity;
import com.tekclover.wms.api.masters.transaction.model.inbound.preinbound.UpdatePreInboundLine;
import com.tekclover.wms.api.masters.transaction.model.inbound.preinbound.v2.InventoryDetail;
import com.tekclover.wms.api.masters.transaction.model.inbound.preinbound.v2.PreInboundLineEntityV2;
import com.tekclover.wms.api.masters.transaction.model.inbound.preinbound.v2.PreInboundLineOutputV2;
import com.tekclover.wms.api.masters.transaction.model.inbound.preinbound.v2.SearchPreInboundLineV2;
...
import com.tekclover.wms.api.masters.transaction.repository.specification.PreInboundLineV2Specification;
...
public class PreInboundLineService extends BaseService {
    ...
    private PreInboundLineEntity createPreInboundLineBOMBased(String companyCode, String plantID, String preInboundNo, String refDocNumber,
        ...
        AuthToken authTokenForMastersService = TAuthTokenService.getMastersServiceAuthToken();
        TImBasicData1 TImBasicData1 = mastersService.getImBasicData1ByItemCode(itemCode, warehouseId, authTokenForMastersService.getAccess_token());
    ...
    private PreInboundLineEntityV2 createPreInboundLineBOMBasedV2(String companyCode, String plantId, String languageId,
        ...
        // ITEM_TEXT - Pass CHL_ITM_CODE as ITM_CODE in IMBASICDATA1 table and fetch ITEM_TEXT and insert
        AuthToken authTokenForMastersService = TAuthTokenService.getMastersServiceAuthToken();
        TImBasicData1 TImBasicData1 = mastersService.getImBasicData1ByItemCode(itemCode, languageId, companyCode, plantId, warehouseId, authTokenForMastersService.getAccess_token());
        preInboundLine.setItemDescription(TImBasicData1.getDescription());
