...
@Data
public class AuditLogSpecification implements Specification<TAuditLog> {
    ...
    @Override
    public Predicate toPredicate(Root<TAuditLog> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
