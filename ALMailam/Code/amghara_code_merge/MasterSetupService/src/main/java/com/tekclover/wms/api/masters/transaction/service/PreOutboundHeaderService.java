...
import com.tekclover.wms.api.masters.transaction.model.outbound.OutboundLineInterim;
import com.tekclover.wms.api.masters.transaction.model.outbound.ordermangement.OrderManagementHeader;
import com.tekclover.wms.api.masters.transaction.model.outbound.ordermangement.OrderManagementLine;
import com.tekclover.wms.api.masters.transaction.model.outbound.ordermangement.v2.OrderManagementHeaderV2;
import com.tekclover.wms.api.masters.transaction.model.outbound.ordermangement.v2.OrderManagementLineV2;
import com.tekclover.wms.api.masters.transaction.model.outbound.pickup.AddPickupLine;
...
import com.tekclover.wms.api.masters.transaction.model.outbound.preoutbound.*;
import com.tekclover.wms.api.masters.transaction.model.outbound.preoutbound.v2.*;
import com.tekclover.wms.api.masters.transaction.model.outbound.quality.v2.AddQualityLineV2;
...
import com.tekclover.wms.api.masters.transaction.model.outbound.v2.*;
...
import com.tekclover.wms.api.masters.transaction.repository.specification.PreOutboundHeaderSpecification;
import com.tekclover.wms.api.masters.transaction.repository.specification.PreOutboundHeaderV2Specification;
...
//        Date kwtDate = DateUtils.getCurrentKWTDateTime();
    ...
    private PreOutboundLine createPreoutboundLineBOMBased(String companyCodeId, String plantId, String preOutboundNo,
        ...
        if (TImBasicData1 != null) {
            preOutboundLine.setDescription(TImBasicData1.getDescription());
            // MFR
            preOutboundLine.setManufacturerPartNo(TImBasicData1.getManufacturerPartNo());
        }
    ...
    private PreOutboundLine createPreOutboundLine(String companyCodeId, String plantId, String preOutboundNo,
        ...
        if (TImBasicData1 != null && TImBasicData1.getDescription() != null) {
            preOutboundLine.setDescription(TImBasicData1.getDescription());
        } else {
...
//        Optional<com.tekclover.wms.api.masters.transaction.model.warehouse.Warehouse> warehouse = null;
...
//            orderService.updateProcessedOrderV2(outboundIntegrationHeader.getRefDocumentNo(), 100L);
        ...
        AuthToken authTokenForMastersService = TAuthTokenService.getMastersServiceAuthToken();
        PickListCancellation createPickListCancellation = null;
        Optional<WarehouseId> warehouse = null;
        String warehouseId = null;
        String companyCodeId = null;
        String plantId = null;
        String languageId = null;
...
//        Warehouse warehouse = getWarehouse(outboundIntegrationHeader.getWarehouseID());
        ...
        TImBasicData1 TImBasicData1 = mastersService.getImBasicData1ByItemCodeV2(imBasicData, authTokenForMastersService.getAccess_token());
