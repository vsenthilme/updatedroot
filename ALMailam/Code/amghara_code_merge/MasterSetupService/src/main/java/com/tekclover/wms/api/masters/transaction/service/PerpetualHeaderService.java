...
import com.tekclover.wms.api.masters.transaction.repository.specification.PerpetualHeaderSpecification;
import com.tekclover.wms.api.masters.transaction.repository.specification.PerpetualHeaderV2Specification;
...
//                    dbPerpetualLine.setInventoryQuantity(dbInventory.getInventoryQuantity());
            ...
            if(dbInventoryList == null){
                ...
                if(TImBasicData1 != null) {
                    dbPerpetualLine.setItemDesc(TImBasicData1.getDescription());
                }
