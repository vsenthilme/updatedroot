...
import com.tekclover.wms.api.masters.transaction.model.cyclecount.periodic.*;
import com.tekclover.wms.api.masters.transaction.model.cyclecount.periodic.v2.*;
import com.tekclover.wms.api.masters.transaction.model.cyclecount.perpetual.AssignHHTUserCC;
...
import com.tekclover.wms.api.masters.transaction.repository.specification.PeriodicLineSpecification;
import com.tekclover.wms.api.masters.transaction.repository.specification.PeriodicLineV2Specification;
import com.tekclover.wms.api.masters.transaction.repository.specification.PeriodicZeroStkLineV2Specification;
...
public class PeriodicLineService extends BaseService {
    ...
    private String getConnectorServiceApiUrl() {
        return TPropertiesConfig.getConnectorServiceUrl();
    }
...
//					createInventoryMovement (updatedPeriodicLine) ;
    ...
    private InventoryMovement createInventoryMovement(PeriodicLine updatedPeriodicLine) {
        ...
        inventoryMovement.setDescription(TImBasicData1.getDescription());

        // MFR_PART of ITM_CODE from BASICDATA1
        inventoryMovement.setManufacturerName(TImBasicData1.getManufacturerPartNo());
...
//		List<IImbasicData1> imbasicdata1 = imbasicdata1Repository.findByItemCode(inventory.getItemCode());
        ...
        if (imbasicdata1T != null) {
            inventory.setReferenceField8(imbasicdata1T.getDescription());
            inventory.setReferenceField9(imbasicdata1T.getManufacturerPartNo());
            inventory.setManufacturerCode(imbasicdata1T.getManufacturerPartNo());
            inventory.setManufacturerName(imbasicdata1T.getManufacturerPartNo());
        }
        if (storageBin != null) {
    ...
    private InventoryMovement createInventoryMovementV2(PeriodicLineV2 updatedPeriodicLine) throws ParseException {
        ...
        if (imbasicdata1T != null) {
            ...
            // MFR_PART of ITM_CODE from BASICDATA1
            inventoryMovement.setManufacturerName(imbasicdata1T.getManufacturerPartNo());
        }
    ...
    public WarehouseApiResponse updatePeriodicLineConfirmV2(String cycleCountNo, List<PeriodicLineV2> periodicLineV2s,
        ...
        try {
            ...
            AuthToken authTokenForConnectorService = TAuthTokenService.getConnectorServiceAuthToken();
