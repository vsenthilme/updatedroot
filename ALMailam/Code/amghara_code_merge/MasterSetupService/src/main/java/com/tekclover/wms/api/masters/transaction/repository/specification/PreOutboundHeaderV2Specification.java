package com.tekclover.wms.api.masters.transaction.repository.specification;

import com.tekclover.wms.api.masters.transaction.model.outbound.preoutbound.v2.PreOutboundHeaderV2;
import com.tekclover.wms.api.masters.transaction.model.outbound.preoutbound.v2.SearchPreOutboundHeaderV2;
...
public class PreOutboundHeaderV2Specification implements Specification<PreOutboundHeaderV2> {

    SearchPreOutboundHeaderV2 searchPreOutboundHeader;

    public PreOutboundHeaderV2Specification(SearchPreOutboundHeaderV2 inputSearchParams) {
        this.searchPreOutboundHeader = inputSearchParams;
    }

    @Override
    public Predicate toPredicate(Root<PreOutboundHeaderV2> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
