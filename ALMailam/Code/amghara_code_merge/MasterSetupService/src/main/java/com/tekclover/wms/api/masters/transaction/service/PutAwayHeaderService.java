...
import com.tekclover.wms.api.masters.transaction.model.dto.ImBasicData;
import com.tekclover.wms.api.masters.transaction.model.dto.TImBasicData1;
import com.tekclover.wms.api.masters.transaction.model.dto.TTStorageBinV2;
import com.tekclover.wms.api.masters.transaction.model.impl.PutAwayHeaderImpl;
import com.tekclover.wms.api.masters.transaction.model.inbound.InboundLine;
import com.tekclover.wms.api.masters.transaction.model.inbound.gr.GrLine;
...
import com.tekclover.wms.api.masters.transaction.model.inbound.preinbound.PreInboundHeaderEntity;
...
import com.tekclover.wms.api.masters.transaction.model.inbound.putaway.*;
...
import com.tekclover.wms.api.masters.transaction.model.inbound.putaway.v2.SearchPutAwayHeaderV2;
...
import com.tekclover.wms.api.masters.transaction.repository.specification.PutAwayHeaderSpecification;
import com.tekclover.wms.api.masters.transaction.repository.specification.PutAwayHeaderV2Specification;
...
//                    createInventoryMovement = inventoryService.getInventoryForInvMmt(companyCode, plantId, languageId, warehouseId, itemCode, manufactureName, 1L);
                    ...
                    if (isDeleted) {
                            TTStorageBinV2 dbstorageBin = TStorageBinRepository.getStorageBinByBinClassId(companyCode, plantId, languageId, warehouseId, 3L, updateStorageBin.getStorageBin());
                            ...
                            if (dbstorageBin != null) {
                                ...
                                if (capacityCheck && storageBinCapacityCheck) {
                                    ...
                                    TTStorageBinV2 updateTStorageBinV2 = mastersService.updateStorageBinV2(dbstorageBin.getStorageBin(),
                                            dbstorageBin,
                                            companyCode,
                                            plantId,
                                            languageId,
...
//                createInventoryMovement = inventoryService.getInventoryForInvMmt(companyCode, plantId, languageId, warehouseId, itemCode, manufactureName, 1L);
                ...
                if (isDeleted) {
                        TTStorageBinV2 dbstorageBin = TStorageBinRepository.getStorageBinByBinClassId(companyCode, plantId, languageId, warehouseId, 1L, updateStorageBin.getStorageBin());
                        log.info("dbStorageBin: " + dbstorageBin);

                        if (dbstorageBin == null) {
                            dbstorageBin = TStorageBinRepository.getStorageBinByBinClassId(companyCode, plantId, languageId, warehouseId, 1L, storageBin);
                        }
