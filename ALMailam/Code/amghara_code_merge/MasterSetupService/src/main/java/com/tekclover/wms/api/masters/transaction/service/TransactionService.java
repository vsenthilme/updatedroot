...
import com.tekclover.wms.api.masters.transaction.model.cyclecount.periodic.v2.PeriodicHeaderEntityV2;
import com.tekclover.wms.api.masters.transaction.model.cyclecount.perpetual.v2.PerpetualHeaderEntityV2;
import com.tekclover.wms.api.masters.transaction.model.inbound.preinbound.InboundIntegrationHeader;
import com.tekclover.wms.api.masters.transaction.model.inbound.preinbound.InboundIntegrationLine;
...
import com.tekclover.wms.api.masters.transaction.model.outbound.preoutbound.v2.OutboundIntegrationLineV2;
...
//                List<OutboundOrderLineV2> sqlOutboundLineList = outboundOrderLinesV2Repository.findAllByOrderIdAndOutboundOrderTypeID(dbOBOrder.getOrderId(), dbOBOrder.getOutboundOrderTypeID());
                log.info("amghara ob line list: " + dbOBOrder.getLine().size());
            ...
            log.info("There is no record found to process amghara (sql) ...Waiting..");
        }
