...
import com.tekclover.wms.api.masters.transaction.model.cyclecount.perpetual.v2.PerpetualLineV2;
import com.tekclover.wms.api.masters.transaction.model.cyclecount.stockadjustment.SearchStockAdjustment;
import com.tekclover.wms.api.masters.transaction.model.cyclecount.stockadjustment.StockAdjustment;
...
import com.tekclover.wms.api.masters.transaction.repository.InventoryMovementRepository;
import com.tekclover.wms.api.masters.transaction.repository.InventoryV2Repository;
import com.tekclover.wms.api.masters.transaction.repository.StagingLineV2Repository;
import com.tekclover.wms.api.masters.transaction.repository.StockAdjustmentRepository;
import com.tekclover.wms.api.masters.transaction.repository.specification.StockAdjustmentSpecification;
...
public class StockAdjustmentService extends BaseService {
     ...
     */
    @Transactional
    public WarehouseApiResponse processStockAdjustment(com.tekclover.wms.api.masters.transaction.model.warehouse.stockAdjustment.StockAdjustment stockAdjustment) throws java.text.ParseException {
...
//                    log.info("Inventory Updated: " + updateInventory);
     ...
     */
    public StockAdjustment autoUpdateStockAdjustmentNew(com.tekclover.wms.api.masters.transaction.model.warehouse.stockAdjustment.StockAdjustment stockAdjustment) {
...
//    }
    ...
    public StockAdjustment createStockAdjustment(InventoryV2 newInventory,Double inventoryQty, String itemDesc,
                                                 com.tekclover.wms.api.masters.transaction.model.warehouse.stockAdjustment.StockAdjustment stockAdjustment){
        //StockAdjustment Record Insert
        StockAdjustment dbStockAdjustment = new StockAdjustment();
        BeanUtils.copyProperties(newInventory, dbStockAdjustment, CommonUtils.getNullPropertyNames(newInventory));
    ...
    public StockAdjustment autoUpdateStockAdjustment(com.tekclover.wms.api.masters.transaction.model.warehouse.stockAdjustment.StockAdjustment stockAdjustment) throws java.text.ParseException {
        ...
        if (stockAdjustment.getIsDamage().equalsIgnoreCase("Y") && stockAdjustment.getIsCycleCount().equalsIgnoreCase("N")) {
            ...
            if (dbInventory == null) {
                ...
                TTStorageBinV2 storageBin = mastersService.getStorageBinBinClassId7(storageBinPutAway, authTokenForMastersService.getAccess_token());
                ...
                TImBasicData1 dbItemCode = mastersService.getImBasicData1ByItemCodeV2(imBasicData, authTokenForMastersService.getAccess_token());
