...
//    @Scheduled(fixedDelay = 30000)
    ...
    public synchronized void processInboundOrder() throws IllegalAccessException, InvocationTargetException, ParseException, MessagingException, IOException {
...
//    @Scheduled(fixedDelay = 50000)
    ...
    public synchronized void processCustomerMaster() throws IllegalAccessException, InvocationTargetException, ParseException, MessagingException, IOException {
