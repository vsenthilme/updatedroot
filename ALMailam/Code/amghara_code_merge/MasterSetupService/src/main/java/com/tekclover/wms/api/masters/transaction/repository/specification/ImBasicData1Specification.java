...
public class ImBasicData1Specification implements Specification<TImBasicData1> {
	...
	@Override
    public Predicate toPredicate(Root<TImBasicData1> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
