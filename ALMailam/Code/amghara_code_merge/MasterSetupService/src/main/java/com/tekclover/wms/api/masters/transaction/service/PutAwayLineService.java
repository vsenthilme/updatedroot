...
import com.tekclover.wms.api.masters.transaction.model.inbound.putaway.v2.SearchPutAwayLineV2;
...
import com.tekclover.wms.api.masters.transaction.repository.specification.PutAwayLineSpecification;
import com.tekclover.wms.api.masters.transaction.repository.specification.PutAwayLineV2Specification;
            ...
            for (AddPutAwayLine newPutAwayLine : newPutAwayLines) {
                ...
                if (existingPutAwayLine.isEmpty()) {
                    ...
                    if (createdPutAwayLine != null && createdPutAwayLine.getPutawayConfirmedQty() > 0L) {
                        ...
                        if (dbTStorageBin != null) {
                            inventory.setReferenceField10(dbTStorageBin.getStorageSectionId());
                            inventory.setReferenceField5(dbTStorageBin.getAisleNumber());
                            inventory.setReferenceField6(dbTStorageBin.getShelfId());
                            inventory.setReferenceField7(dbTStorageBin.getRowId());
                        }
                        ...
                        dbTStorageBin.setStatusId(1L);
                        mastersService.updateStorageBin(dbPutAwayLine.getConfirmedStorageBin(), dbTStorageBin, loginUserID, authTokenForMastersService.getAccess_token());
...
//                PutAwayHeaderV2 dbPutAwayHeader = new PutAwayHeaderV2();
                ...
                TTStorageBinV2 storageBin = TStorageBinRepository.getStorageBin(companyCode, plantId, languageId, warehouseId, newPutAwayLine.getConfirmedStorageBin());
                TTStorageBinV2 proposedBin = TStorageBinRepository.getStorageBin(companyCode, plantId, languageId, warehouseId, newPutAwayLine.getProposedStorageBin());
...
//                        }
                        ...
                        TTStorageBinV2 dbStorageBin = null;
                        try {
...
//        }
        ...
        if (dbPutAwayLine.getCbm() != null) {
            ...
            AuthToken authTokenForMastersService = TAuthTokenService.getMastersServiceAuthToken();
            TTStorageBinV2 storageBin = mastersService.getStorageBinV2(dbPutAwayLine.getConfirmedStorageBin(), dbPutAwayLine.getWarehouseId(), authTokenForMastersService.getAccess_token());
            ...
            TTStorageBinV2 updateStorageBin = mastersService.updateStorageBinV2(dbPutAwayLine.getConfirmedStorageBin(),
                    storageBin,
