...
import com.tekclover.wms.api.masters.transaction.model.dto.UserManagement;
...
public class BaseService {
    ...
    @Autowired
    protected TIDMasterService idmasterService;

    @Autowired
    protected TAuthTokenService TAuthTokenService;
