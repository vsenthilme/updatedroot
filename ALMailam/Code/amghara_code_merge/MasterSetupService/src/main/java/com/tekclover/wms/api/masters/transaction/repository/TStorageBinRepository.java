...
@Repository
@Transactional
public interface TStorageBinRepository extends JpaRepository<TStorageBin, Long>,
        JpaSpecificationExecutor<TStorageBin>, StreamableJpaSpecificationRepository<TStorageBin> {

    public List<TStorageBin> findByStorageBinInAndStorageSectionIdInAndPutawayBlockAndPickingBlockAndDeletionIndicatorOrderByStorageBinDesc(
    ...
    public Optional<TStorageBin> findByStorageBinAndDeletionIndicator(String storageBin, Long delFlag);

    public TStorageBin findByWarehouseIdAndStorageBinAndDeletionIndicator(String warehouseId, String storageBin, long l);
    ...
    TStorageBin findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndStorageBinAndDeletionIndicator(
    ...
    public List<TTStorageBinV2> getStorageBinList(@Param(value = "itemCode") String itemCode,
    ...
    @Query(value = "select * from tblstoragebin sb \n" +
            ...
            "ip.is_deleted = 0) order by remain_vol", nativeQuery = true)
    public List<TTStorageBinV2> getStorageBinListByCompany(@Param(value = "itemCode") String itemCode,
                                                           @Param(value = "warehouseId") String warehouseId,
    ...
    @Query(value = "select * from tblstoragebin sb \n" +
            ...
            "ip.is_deleted = 0) order by remain_vol", nativeQuery = true)
    public List<TTStorageBinV2> getStorageBinListByCompanyBranch(@Param(value = "itemCode") String itemCode,
                                                                 @Param(value = "warehouseId") String warehouseId,
                                                                 @Param(value = "companyCode") String companyCode,
    ...
    public List<TTStorageBinV2> getStorageBinListByCompanyBranchNonCBM(@Param(value = "itemCode") String itemCode,
                                                                       @Param(value = "warehouseId") String warehouseId,
                                                                       @Param(value = "companyCode") String companyCode,
                                                                       @Param(value = "branchCode") String branchCode,
                                                                       @Param(value = "languageId") String languageId,
    ...
    public TTStorageBinV2 getStorageBin(@Param(value = "companyCode") String companyCode,
    ...
    @Query(value = "select * from tblstoragebin sb \n" +
            ...
            "sb.is_deleted = 0 order by remain_vol", nativeQuery = true)
    public TTStorageBinV2 getStorageBinByBinClassId(@Param(value = "companyCode") String companyCode,
                                                    @Param(value = "plantId") String plantId,
                                                    @Param(value = "languageId") String languageId,
                                                    @Param(value = "warehouseId") String warehouseId,
                                                    @Param(value = "binClassId") Long binClassId,
