...
import com.tekclover.wms.api.masters.transaction.model.cyclecount.perpetual.*;
import com.tekclover.wms.api.masters.transaction.model.cyclecount.perpetual.v2.*;
...
import com.tekclover.wms.api.masters.transaction.repository.specification.PerpetualLineSpecification;
import com.tekclover.wms.api.masters.transaction.repository.specification.PerpetualLineV2Specification;
import com.tekclover.wms.api.masters.transaction.repository.specification.PerpetualZeroStkLineV2Specification;
...
//		List<IImbasicData1> imbasicdata1 = imbasicdata1Repository.findByItemCode(inventory.getItemCode());
        ...
        if (imbasicdata1T != null) {
            ...
            inventory.setDescription(imbasicdata1T.getDescription());
        }
        if (storageBin != null) {
