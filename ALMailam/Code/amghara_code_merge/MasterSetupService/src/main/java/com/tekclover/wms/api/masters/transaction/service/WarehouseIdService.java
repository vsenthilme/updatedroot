...
import com.tekclover.wms.api.masters.transaction.controller.exception.InboundOrderRequestException;
import com.tekclover.wms.api.masters.transaction.controller.exception.OutboundOrderRequestException;
...
import com.tekclover.wms.api.masters.transaction.model.warehouse.cyclecount.CycleCountHeader;
import com.tekclover.wms.api.masters.transaction.model.warehouse.cyclecount.CycleCountLine;
import com.tekclover.wms.api.masters.transaction.model.warehouse.cyclecount.periodic.Periodic;
import com.tekclover.wms.api.masters.transaction.model.warehouse.cyclecount.periodic.PeriodicHeaderV1;
import com.tekclover.wms.api.masters.transaction.model.warehouse.cyclecount.periodic.PeriodicLineV1;
import com.tekclover.wms.api.masters.transaction.model.warehouse.cyclecount.perpetual.Perpetual;
import com.tekclover.wms.api.masters.transaction.model.warehouse.cyclecount.perpetual.PerpetualHeaderV1;
import com.tekclover.wms.api.masters.transaction.model.warehouse.cyclecount.perpetual.PerpetualLineV1;
import com.tekclover.wms.api.masters.transaction.model.warehouse.inbound.*;
import com.tekclover.wms.api.masters.transaction.model.warehouse.inbound.confirmation.AXApiResponse;
import com.tekclover.wms.api.masters.transaction.model.warehouse.inbound.confirmation.InterWarehouseTransfer;
import com.tekclover.wms.api.masters.transaction.model.warehouse.inbound.v2.*;
import com.tekclover.wms.api.masters.transaction.model.warehouse.outbound.*;
import com.tekclover.wms.api.masters.transaction.model.warehouse.outbound.confirmation.InterWarehouseShipment;
import com.tekclover.wms.api.masters.transaction.model.warehouse.outbound.confirmation.Shipment;
import com.tekclover.wms.api.masters.transaction.model.warehouse.outbound.v2.*;
import com.tekclover.wms.api.masters.transaction.model.warehouse.stockAdjustment.StockAdjustment;
import com.tekclover.wms.api.masters.transaction.repository.IntegrationApiResponseRepository;
import com.tekclover.wms.api.masters.transaction.repository.OutboundOrderV2Repository;
import com.tekclover.wms.api.masters.transaction.repository.WarehouseIdRepository;
...
@Slf4j
@Service
public class WarehouseIdService extends BaseService {
	@Autowired
	...
	// ASN 
	public AXApiResponse postASNConfirmation (com.tekclover.wms.api.masters.transaction.model.warehouse.inbound.confirmation.ASN asn,
											  String authToken) {
		...
		UriComponentsBuilder builder = 
				UriComponentsBuilder.fromHttpUrl(TPropertiesConfig.getAxapiServiceAsnUrl());
	...
	public AXApiResponse postStoreReturnConfirmation (
			com.tekclover.wms.api.masters.transaction.model.warehouse.inbound.confirmation.StoreReturn storeReturn,
			String access_token) {
		HttpHeaders headers = new HttpHeaders();
		headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
		...
		UriComponentsBuilder builder = 
				UriComponentsBuilder.fromHttpUrl(TPropertiesConfig.getAxapiServiceStoreReturnUrl());
	...
	public AXApiResponse postSOReturnConfirmation (
			com.tekclover.wms.api.masters.transaction.model.warehouse.inbound.confirmation.SOReturn soReturn,
			String access_token) {
		HttpHeaders headers = new HttpHeaders();
		headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
		headers.add("User-Agent", "AX-API Rest service");
		...
		UriComponentsBuilder builder = 
				UriComponentsBuilder.fromHttpUrl(TPropertiesConfig.getAxapiServiceSOReturnUrl());
	...
	public AXApiResponse postInterWarehouseTransferConfirmation(InterWarehouseTransfer iwhTransfer,
		...
		UriComponentsBuilder builder = 
				UriComponentsBuilder.fromHttpUrl(TPropertiesConfig.getAxapiServiceInterwareHouseUrl());
	...
	public AXApiResponse postShipmentConfirmation (Shipment shipment, String access_token) {
		...
		UriComponentsBuilder builder = 
				UriComponentsBuilder.fromHttpUrl(TPropertiesConfig.getAxapiServiceShipmentUrl());
	...
	public AXApiResponse postInterWarehouseShipmentConfirmation(InterWarehouseShipment iwhShipment,
		...
		UriComponentsBuilder builder = 
				UriComponentsBuilder.fromHttpUrl(TPropertiesConfig.getAxapiServiceIWHouseShipmentUrl());
	...
	public AXApiResponse postSaleOrderConfirmation(
			com.tekclover.wms.api.masters.transaction.model.warehouse.outbound.confirmation.SalesOrder salesOrder,
			String access_token) {
		HttpHeaders headers = new HttpHeaders();
		headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
		headers.add("User-Agent", "AX-API Rest service");
		...
		UriComponentsBuilder builder = 
				UriComponentsBuilder.fromHttpUrl(TPropertiesConfig.getAxapiServiceSalesOrderUrl());
	...
	public AXApiResponse postReturnPOConfirmation(
			com.tekclover.wms.api.masters.transaction.model.warehouse.outbound.confirmation.ReturnPO returnPO,
			String access_token) {
		HttpHeaders headers = new HttpHeaders();
		headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
		headers.add("User-Agent", "AX-API Rest service");
		...
		UriComponentsBuilder builder = 
				UriComponentsBuilder.fromHttpUrl(TPropertiesConfig.getAxapiServiceReturnPOUrl());
...
//
//			// Get Warehouse
//			Optional<com.tekclover.wms.api.masters.transaction.model.warehouse.Warehouse> dbWarehouse =
...
//	// POST ShipmentOrderV2
	private OutboundOrderV2 saveSOV2(ShipmentOrderV2 shipmentOrder, boolean isRerun) throws ParseException {
		try {
			...
			Optional<WarehouseId> warehouse =
					warehouseIdRepository.findByCompanyCodeIdAndPlantIdAndLanguageIdAndDeletionIndicator(
