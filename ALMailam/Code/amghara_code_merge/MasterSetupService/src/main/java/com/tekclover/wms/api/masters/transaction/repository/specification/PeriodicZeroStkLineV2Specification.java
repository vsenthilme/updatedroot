...
import com.tekclover.wms.api.masters.transaction.model.cyclecount.periodic.v2.PeriodicZeroStockLine;
import com.tekclover.wms.api.masters.transaction.model.cyclecount.periodic.v2.SearchPeriodicLineV2;
...
public class PeriodicZeroStkLineV2Specification implements Specification<PeriodicZeroStockLine> {

	SearchPeriodicLineV2 searchPeriodicLine;

	public PeriodicZeroStkLineV2Specification(SearchPeriodicLineV2 inputSearchParams) {
		this.searchPeriodicLine = inputSearchParams;
	}
	 
	@Override
    public Predicate toPredicate(Root<PeriodicZeroStockLine> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
