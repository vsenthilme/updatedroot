...
import com.tekclover.wms.api.masters.transaction.repository.specification.PeriodicHeaderSpecification;
import com.tekclover.wms.api.masters.transaction.repository.specification.PeriodicHeaderV2Specification;
...
public class PeriodicHeaderService extends BaseService {
    ...
    @Autowired
    TStorageBinRepository TStorageBinRepository;
...
//				log.info("imbasicdata1 : " + imbasicdata1);
                ...
                periodicLine.setStorageSectionId(TStorageBinRepository.findByStorageBin(inventory.getStorageBin()));
...
//                List<IImbasicData1> imbasicdata1 = imbasicdata1Repository.findByItemCode(inventory.getItemCode());
                ...
                periodicLine.setItemDesc(imbasicdata1T.getDescription());
                ...
                // ST_SEC_ID/ST_SEC
                // Pass the ST_BIN in STORAGEBIN table and fetch ST_SEC_ID/ST_SEC values
                TTStorageBinV2 dbStorageBin = TStorageBinRepository.getStorageBin(companyCodeId, plantId, languageId, warehouseId, inventory.getStorageBin());
//                periodicLine.setStorageSectionId(storageBinRepository.findByStorageBin(inventory.getStorageBin()));
                ...
                // MFR_PART
                // Pass ITM_CODE in IMBASICDATA table and fetch MFR_PART values
                periodicLine.setManufacturerPartNo(imbasicdata1T.getManufacturerPartNo());
...
//                    periodicLineV2.setInventoryQuantity(dbInventory.getInventoryQuantity());
            ...
            if(dbInventoryList == null){
                ...
                if(TImBasicData1 != null) {
                    dbPeriodicLine.setItemDesc(TImBasicData1.getDescription());
                }
