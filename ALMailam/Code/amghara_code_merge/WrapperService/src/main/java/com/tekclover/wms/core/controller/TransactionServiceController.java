...
// -------------------------------------StagingHeader-V2--------------------------------------------------------------------------------------------
    ...
    @ApiOperation(response = OrderManagementLineV2.class, value = "Search OrderMangementLine V2 for Assignment Tab") // label for swagger
    @PostMapping("/ordermanagementline/v2/assignment/findOrderManagementLine")
    public OrderManagementLineV2[] findOrderManagementLinesV2(@RequestBody SearchOrderManagementLineV2 searchOrderMangementLine,
                                                             @RequestParam String authToken) throws Exception {
        return transactionService.findOrderManagementLinesV2(searchOrderMangementLine, authToken);
    }
...
//    }
    ...
    /*--------------------Order Lines Cancel Batch-----------------------------------------------------------*/
    @ApiOperation(response = Optional.class, value = "Batch Cancel Delivery Lines V2") // label for swagger
    @PostMapping("/outboundreversal/v2/cancel/batch")
    public ResponseEntity<?> doCancelLinesBatchV2(@RequestBody List<ReversalInput> outboundReversalInput,
                                                  @RequestParam String loginUserID, @RequestParam String authToken) throws Exception {
        transactionService.doCancelLinesBatchV2(outboundReversalInput, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.OK);
    }
