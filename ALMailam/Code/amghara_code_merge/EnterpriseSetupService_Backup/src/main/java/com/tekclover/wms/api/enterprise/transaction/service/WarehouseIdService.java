...
import com.tekclover.wms.api.enterprise.transaction.controller.exception.InboundOrderRequestException;
import com.tekclover.wms.api.enterprise.transaction.controller.exception.OutboundOrderRequestException;
...
import com.tekclover.wms.api.enterprise.transaction.model.warehouse.cyclecount.CycleCountLine;
import com.tekclover.wms.api.enterprise.transaction.model.warehouse.cyclecount.periodic.Periodic;
import com.tekclover.wms.api.enterprise.transaction.model.warehouse.cyclecount.periodic.PeriodicHeaderV1;
import com.tekclover.wms.api.enterprise.transaction.model.warehouse.cyclecount.periodic.PeriodicLineV1;
import com.tekclover.wms.api.enterprise.transaction.model.warehouse.cyclecount.perpetual.Perpetual;
import com.tekclover.wms.api.enterprise.transaction.model.warehouse.cyclecount.perpetual.PerpetualHeaderV1;
import com.tekclover.wms.api.enterprise.transaction.model.warehouse.cyclecount.perpetual.PerpetualLineV1;
import com.tekclover.wms.api.enterprise.transaction.model.warehouse.inbound.*;
import com.tekclover.wms.api.enterprise.transaction.model.warehouse.inbound.confirmation.AXApiResponse;
import com.tekclover.wms.api.enterprise.transaction.model.warehouse.inbound.confirmation.InterWarehouseTransfer;
...
import com.tekclover.wms.api.enterprise.transaction.model.warehouse.outbound.confirmation.InterWarehouseShipment;
import com.tekclover.wms.api.enterprise.transaction.model.warehouse.outbound.confirmation.Shipment;
...
import com.tekclover.wms.api.enterprise.transaction.repository.IntegrationApiResponseRepository;
...
public class WarehouseIdService extends BaseService {
	...
	// ASN 
	public AXApiResponse postASNConfirmation (com.tekclover.wms.api.enterprise.transaction.model.warehouse.inbound.confirmation.ASN asn,
											  String authToken) {
	...
	public AXApiResponse postStoreReturnConfirmation (
			com.tekclover.wms.api.enterprise.transaction.model.warehouse.inbound.confirmation.StoreReturn storeReturn,
			String access_token) {
		HttpHeaders headers = new HttpHeaders();
		headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	public AXApiResponse postSOReturnConfirmation (
			com.tekclover.wms.api.enterprise.transaction.model.warehouse.inbound.confirmation.SOReturn soReturn,
			String access_token) {
		HttpHeaders headers = new HttpHeaders();
		headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
		headers.add("User-Agent", "AX-API Rest service");
	...
	public AXApiResponse postSaleOrderConfirmation(
			com.tekclover.wms.api.enterprise.transaction.model.warehouse.outbound.confirmation.SalesOrder salesOrder,
			String access_token) {
		HttpHeaders headers = new HttpHeaders();
		headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
		headers.add("User-Agent", "AX-API Rest service");
	...
	public AXApiResponse postReturnPOConfirmation(
			com.tekclover.wms.api.enterprise.transaction.model.warehouse.outbound.confirmation.ReturnPO returnPO,
			String access_token) {
		HttpHeaders headers = new HttpHeaders();
		headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
		headers.add("User-Agent", "AX-API Rest service");
...
//
//			// Get Warehouse
//			Optional<com.tekclover.wms.api.enterprise.transaction.model.warehouse.Warehouse> dbWarehouse =
