...
//    }
    ...
    //-------------------------------------------------------------------Outbound PickList---------------------------------------------------------------
    @Async("asyncTaskExecutor")
    public CompletableFuture<WarehouseApiResponse> processOutboundPickListOrder() throws InterruptedException, InvocationTargetException, IllegalAccessException, ParseException {

        WarehouseApiResponse outboundOrder = transactionService.processPickListOutboundOrder();
