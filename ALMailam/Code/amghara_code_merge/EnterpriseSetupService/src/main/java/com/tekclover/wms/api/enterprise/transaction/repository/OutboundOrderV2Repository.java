...
public interface OutboundOrderV2Repository extends JpaRepository<OutboundOrderV2, Long>,
    ...
    List<OutboundOrderV2> findTopByProcessedStatusIdAndWarehouseIDAndOutboundOrderTypeIDOrderByOrderReceivedOn(Long processedStatusId, String warehouseId, Long outboundOrderTypeId);
    List<OutboundOrderV2> findTopByProcessedStatusIdAndWarehouseIDAndOutboundOrderTypeIDNotOrderByOrderReceivedOn(Long processedStatusId, String warehouseId, Long outboundOrderTypeId);
