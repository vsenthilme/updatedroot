...
public class BatchJobScheduler {
    ...
    public void scheduleJob() throws InterruptedException, InvocationTargetException, IllegalAccessException, ParseException {
        ...
        CompletableFuture<WarehouseApiResponse> outboundPickListOrder = scheduleAsyncService.processOutboundPickListOrder();
...
//    public void scheduleAmgharaJob() throws InterruptedException, InvocationTargetException, IllegalAccessException, ParseException {
//
//        CompletableFuture<WarehouseApiResponse> amgharaOutboundOrder = scheduleAsyncService.processAmgharaOutboundOrder();
//
//    }
