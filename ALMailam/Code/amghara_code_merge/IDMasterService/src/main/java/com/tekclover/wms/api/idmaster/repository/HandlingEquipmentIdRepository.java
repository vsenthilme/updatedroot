...
public interface HandlingEquipmentIdRepository extends JpaRepository<HandlingEquipmentId,Long>, JpaSpecificationExecutor<HandlingEquipmentId> {
	...
	findByCompanyCodeIdAndPlantIdAndWarehouseIdAndHandlingEquipmentNumberAndLanguageIdAndDeletionIndicator(
				String companyCodeId, String plantId, String warehouseId,Long handlingEquipmentNumber, String languageId, Long deletionIndicator);
}