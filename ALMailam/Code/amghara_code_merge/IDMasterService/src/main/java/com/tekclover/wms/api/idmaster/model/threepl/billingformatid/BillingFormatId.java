 ...
 */
@Table(
        name = "tblbillingformatid",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "unique_key_billingformatid",
                        columnNames = {"LANG_ID", "C_ID", "PLANT_ID", "WH_ID","BILL_FORMAT_ID"})
        }
)
@IdClass(BillingFormatIdCompositeKey.class)
public class BillingFormatId {
    @Id
    ...
    @Column(name="BILL_FORMAT_TEXT",columnDefinition = "nvarchar(200)")
