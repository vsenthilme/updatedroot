...
@NoArgsConstructor
/*
 * `C_ID`, `PLANT_ID`, `WH_ID`, `VAR_ID`, `VAR_TYP`, `VAR_SUB_ID`,'LANG_ID'
 */
@Table(
		name = "tblvariantid", 
		uniqueConstraints = { 
				@UniqueConstraint (
						...
						columnNames = {"C_ID", "PLANT_ID", "WH_ID", "VAR_ID", "VAR_TYP", "VAR_SUB_ID","LANG_ID"})
				}
		)
...
public class VariantId { 
	...
	@Id
	@Column(name = "VAR_TYP",columnDefinition = "nvarchar(20)")
	...
	@Column(name = "VAR_ID_TEXT",columnDefinition = "nvarchar(50)")
	private String variantText;
	
	@Column(name = "VAR_SUB_ID_TEXT",columnDefinition = "nvarchar(500)")
	...
	@Column(name="WAREHOUSE_ID",columnDefinition = "nvarchar(500)")
