...
//        }
    ...
    public PickupHeaderV2 updatePickupHeaderV2(String companyCodeId, String plantId, String languageId, String warehouseId, String preOutboundNo, String refDocNumber,
        ...
        log.info("Update PickupHeader/Reassign Picker : " + updatePickupHeader + "|" + loginUserID + "|" + pickupNumber + "|" + refDocNumber + "|" + lineNumber + "|" + itemCode);
        ...
        if (dbPickupHeader != null) {
            ...
            log.info("Updated PickupHeader/Reassigned Picker : " + pickup + "|" + loginUserID);
