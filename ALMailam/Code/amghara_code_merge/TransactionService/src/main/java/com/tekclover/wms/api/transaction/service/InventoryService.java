...
//                inventoryForPutAway(companyCodeId, plantId, languageId, warehouseId, itemCode, manufacturerName, binClassId);
     ...
     * @return
     */
    public String getPutAwayHeaderCreateInventoryV2(String companyCodeId, String plantId, String languageId, String warehouseId,
                                                    String itemCode, String manufacturerName, Long binClassId) {
        return inventoryV2Repository.getPutAwayHeaderCreateInventoryV2(companyCodeId, plantId, languageId, warehouseId, itemCode, manufacturerName, PACK_BARCODE, binClassId);
    }
...
//                    inventoryV2Repository.delete(inventory);
     ...
     * @return
     */
    public InventoryV2 getOutboundReversalInventoryV2(String companyCodeId, String plantId, String languageId, String warehouseId,
        ...
        IInventoryImpl dbInventory = inventoryV2Repository.getOutboundReversalInventoryV2(
                companyCodeId, plantId, languageId, warehouseId, barcodeId, itemCode, manufacturerName, PACK_BARCODE, storageBin);
