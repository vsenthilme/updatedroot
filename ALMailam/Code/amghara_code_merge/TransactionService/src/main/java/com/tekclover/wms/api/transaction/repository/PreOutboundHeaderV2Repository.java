...
//                                );
    ...
    @Query(value = "SELECT CASE WHEN \n" +
            ...
            " and lang_id = :languageId and wh_id = :warehouseId and REF_DOC_NO = :refDocNumber and PRE_OB_NO = :preOutboundNo and is_deleted = 0) = \n" +
            "(select count(*) from tblpickupline where c_id = :companyCodeId and plant_id = :plantId and \n" +
            "lang_id = :languageId and wh_id = :warehouseId and REF_DOC_NO = :refDocNumber and PRE_OB_NO = :preOutboundNo and is_deleted = 0 and STATUS_ID = :statusId) \n" +
