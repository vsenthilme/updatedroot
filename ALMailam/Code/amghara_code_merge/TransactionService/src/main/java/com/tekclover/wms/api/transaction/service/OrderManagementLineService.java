...
//                    PickupHeaderV2 pickup = pickupHeaderV2Repository.save(pickupHeader);
        ...
        //29-01-2025 -  batch savePickupHeader as requested by user
        pickupHeaderV2Repository.saveAll(pickupHeaders);
...
//            }
     ...
     * @return
     */
    public List<OrderManagementLineV2> getReversalOrderManagementLinesV2(String companyCodeId, String plantId, String languageId, String warehouseId,
                                                                         String refDocNumber, String preOutboundNo, String itemCode, String manufacturerName,
                                                                         Long lineNumber, Long orderTypeId) {
        List<Long> statusIds = Arrays.asList(96L, 47L);
        return orderManagementLineV2Repository.findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndRefDocNumberAndPreOutboundNoAndItemCodeAndManufacturerNameAndLineNumberAndOutboundOrderTypeIdAndStatusIdNotInAndDeletionIndicator(
                companyCodeId, plantId, languageId, warehouseId, refDocNumber, preOutboundNo, itemCode, manufacturerName, lineNumber, orderTypeId, statusIds, 0L);
    }
