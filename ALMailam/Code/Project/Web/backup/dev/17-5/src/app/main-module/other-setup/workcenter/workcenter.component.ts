...
export class WorkcenterComponent implements OnInit {
  ...
  deleteDialog() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        this.deleterecord(this.selection.selected[0].workCenterId,this.selection.selected[0].warehouseId,this.selection.selected[0].companyCodeId,this.selection.selected[0].plantId,this.selection.selected[0].languageId);
