...
export class CbminboundComponent implements OnInit {
  ...
  console.log(this.selectedcbm)
    ...
    const dialogRef = this.dialog.open(CbminboundNewComponent, {
      disableClose: true,
      width: '85%',
      maxWidth: '65%',
      data: { pageflow: data, code: data != 'New' ? this.selectedcbm[0].code : null,}
    });
...
//   }
  ...
  // }
  onChange() {
    console.log(this.selectedcbm.length)
