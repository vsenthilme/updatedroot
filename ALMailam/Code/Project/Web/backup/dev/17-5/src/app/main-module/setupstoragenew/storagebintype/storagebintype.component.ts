...
export class StoragebintypeComponent implements OnInit {
  ...
  deleteDialog() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        this.deleterecord(this.selectedstoragetype[0].storageBinTypeId,this.selectedstoragetype[0].warehouseId,this.selectedstoragetype[0].storageTypeId,this.selectedstoragetype[0].plantId,this.selectedstoragetype[0].languageId,this.selectedstoragetype[0].companyId);
  ...
  deleterecord(id: any,warehouseId:any,storageTypeId:any,plantId:any,languageId:any,companyId:any) {
    this.spin.show();
    this.sub.add(this.service.Delete(id,warehouseId,storageTypeId,plantId,languageId,companyId).subscribe((res) => {
