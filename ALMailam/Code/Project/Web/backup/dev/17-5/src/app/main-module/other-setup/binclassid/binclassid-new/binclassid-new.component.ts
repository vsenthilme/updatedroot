...
@Component({
  selector: 'app-binclassid-new',
  templateUrl: './binclassid-new.component.html',
  styleUrls: ['./binclassid-new.component.scss']
})
export class BinclassidNewComponent implements OnInit {
  ...
  form = this.fb.group({
    binClass: [,Validators.required],
  binClassId: [,Validators.required],
  ...
  ngOnInit(): void {
    ...
    if (this.data.pageflow != 'New') {
      this.form.controls.binClassId.disable();
     this.form.controls.plantId.disable();
    this.form.controls.warehouseId.disable();
      this.form.controls.languageId.disable();
      this.form.controls.companyCodeId.disable();
  ...
  if (this.data.code) {
    ...
    this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
      this.toastr.success(res.binClassId + " Saved Successfully!","Notification",{
        timeOut: 2000,
        progressBar: false,
      });
      this.spin.hide();
