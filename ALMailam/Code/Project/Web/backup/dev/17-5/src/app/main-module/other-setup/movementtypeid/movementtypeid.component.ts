...
screeid=3115;
  ...
  deleteDialog() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        this.deleterecord(this.selectedmvts.movementTypeId,this.selectedmvts.warehouseId,this.selectedmvts.languageId,this.selectedmvts.plantId,this.selectedmvts.companyCodeId);
