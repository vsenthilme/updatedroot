...
@Component({
  selector: 'app-dockid-new',
  templateUrl: './dockid-new.component.html',
  styleUrls: ['./dockid-new.component.scss']
})
export class DockidNewComponent implements OnInit {
  ...
  form = this.fb.group({
    ...
    createdOnFE: [],
    deletionIndicator: [],
    dockDescription: [,Validators.required],
  ...
  fill() {
    this.spin.show();
    this.sub.add(this.service.Get(this.data.code,this.data.warehouseId,this.data.languageId,this.data.companyCodeId,this.data.plantId,this.data.dockDescription).subscribe(res => {
  ...
  if (this.data.code) {
    this.sub.add(this.service.Update(this.form.getRawValue(), this.data.code,this.data.warehouseId,this.data.languageId,this.data.companyCodeId,this.data.plantId,this.data.dockDescription).subscribe(res => {
