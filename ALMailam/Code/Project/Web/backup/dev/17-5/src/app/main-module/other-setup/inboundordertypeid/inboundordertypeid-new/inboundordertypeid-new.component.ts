...
@Component({
  selector: 'app-inboundordertypeid-new',
  templateUrl: './inboundordertypeid-new.component.html',
  styleUrls: ['./inboundordertypeid-new.component.scss']
})
export class InboundordertypeidNewComponent implements OnInit {
  ...
  form = this.fb.group({
    ...
    createdOn: [],
    deletionIndicator: [],
    inboundOrderTypeId: [,Validators.required],
    inboundOrderTypeText: [,Validators.required],
  ...
  ngOnInit(): void {
    ...
    if (this.data.pageflow != 'New') {
      this.form.controls.inboundOrderTypeId.disable();
  ...
  if (this.data.code) {
    ...
    this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
      this.toastr.success(res.inboundOrderTypeId + " Saved Successfully!","Notification",{
        timeOut: 2000,
        progressBar: false,
      });
      this.spin.hide();
