 ...
 screenid=3119;
  ...
  deleteDialog() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        this.deleterecord(this.selectedspecialstock[0].specialStockIndicatorId,this.selectedspecialstock[0].stockTypeId,this.selectedspecialstock[0].warehouseId,this.selectedspecialstock[0].languageId,this.selectedspecialstock[0].companyCodeId,this.selectedspecialstock[0].plantId);
