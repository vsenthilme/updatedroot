...
deleteDialog() {
  ...
  dialogRef.afterClosed().subscribe(result => {
    ...
    if (result) {
      this.deleterecord(this.selectedprocess[0].processSequenceId,this.selectedprocess[0].warehouseId,this.selectedprocess[0].languageId,this.selectedprocess[0].plantId,this.selectedprocess[0].companyCodeId,this.selectedprocess[0].processId);
