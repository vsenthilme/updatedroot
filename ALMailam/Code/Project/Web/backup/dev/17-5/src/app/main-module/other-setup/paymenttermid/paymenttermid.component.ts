...
import { PaymenttermidNewComponent } from './paymenttermid-new/paymenttermid-new.component';
import { PaymenttermidService } from './paymenttermid.service';

@Component({
  selector: 'app-paymenttermid',
  templateUrl: './paymenttermid.component.html',
  styleUrls: ['./paymenttermid.component.scss']
})
export class PaymenttermidComponent implements OnInit {
  ...
  deleteDialog() {
    ...
    if (result) {
       this.deleterecord(this.selectedpayment[0].paymentTermId,this.selectedpayment[0].warehouseId,this.selectedpayment[0].languageId,this.selectedpayment[0].plantId,this.selectedpayment[0].companyCodeId);
   ...
   this.paymentterm.forEach(x => {
     res.push({
      ...
      "Warehouse ":x.warehouseIdAndDescription,
        "Payment Term Id":x.paymentTermId,
