...
@Component({
  selector: 'app-employeeid-new',
  templateUrl: './employeeid-new.component.html',
  styleUrls: ['./employeeid-new.component.scss']
})
export class EmployeeidNewComponent implements OnInit {
 ...
 // dialogRef: any;
  ...
  if (this.data.code) {
    ...
    this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
      this.toastr.success(res.employeeId + " Saved Successfully!","Notification",{
        timeOut: 2000,
        progressBar: false,
      });
      this.spin.hide();
