...
@Component({
  selector: 'app-controlprocessid-new',
  templateUrl: './controlprocessid-new.component.html',
  styleUrls: ['./controlprocessid-new.component.scss']
})
export class ControlprocessidNewComponent implements OnInit {
  ...
  form = this.fb.group({
    ...
    controlProcessId: [,Validators.required],
    languageId: [,Validators.required],
    controlProcess: [,Validators.required],
    deletionIndicator: [],
    referenceField1: [],
    referenceField2: [],
    referenceField3: [],
  ...
  if (this.data.code) {
    ...
    this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
      this.toastr.success(res.controlProcessId + " Saved Successfully!","Notification",{
        timeOut: 2000,
        progressBar: false,
      });
      this.spin.hide();
