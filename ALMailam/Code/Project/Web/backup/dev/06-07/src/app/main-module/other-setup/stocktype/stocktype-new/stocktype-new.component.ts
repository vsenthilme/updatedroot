...
@Component({
  selector: 'app-stocktype-new',
  templateUrl: './stocktype-new.component.html',
  styleUrls: ['./stocktype-new.component.scss']
})
export class StocktypeNewComponent implements OnInit {
  ...
  form = this.fb.group({
    ...
    stockTypeText:[,Validators.required],
    updatedBy:[],
    updatedOn:[],
    updatedOnFE:[],
  ...
  ngOnInit(): void {
    ...
    if (this.data.pageflow != 'New') {
      ...
      this.form.controls.stockTypeText.disable();
        this.form.disabled;
      this.fill();
  }
  }
  ...
  if (this.data.code) {
    ...
    this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
      this.toastr.success(res.stockTypeId + " Saved Successfully!","Notification",{
        timeOut: 2000,
        progressBar: false,
      });
      this.spin.hide();
