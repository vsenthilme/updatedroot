...
@Component({
  selector: 'app-returtypeid-new',
  templateUrl: './returtypeid-new.component.html',
  styleUrls: ['./returtypeid-new.component.scss']
})
export class ReturtypeidNewComponent implements OnInit {
 ...
 // dialogRef: any;
  ...
  form = this.fb.group({
    ...
    returnTypeText:[,Validators.required],
    updatedBy: [],
    updatedOn: [],
  ...
  ngOnInit(): void {
    ...
    if (this.data.pageflow != 'New') {
      this.form.controls.returnTypeId.disable();
  ...
  if (this.data.code) {
    ...
    this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
      this.toastr.success(res.returnTypeId + " Saved Successfully!","Notification",{
        timeOut: 2000,
        progressBar: false,
      });
      this.spin.hide();
