...
@Component({
  selector: 'app-cyclecounttypeid-new',
  templateUrl: './cyclecounttypeid-new.component.html',
  styleUrls: ['./cyclecounttypeid-new.component.scss']
})
export class CyclecounttypeidNewComponent implements OnInit {
  ...
  form = this.fb.group({
    ...
    cycleCountTypeText: [,Validators.required],
    deletionIndicator: [],
    languageId: [],
    plantId: [],
    referenceField1: [],
  ...
  ngOnInit(): void {
    ...
    if (this.data.pageflow != 'New') {
      this.form.controls.cycleCountTypeId.disable();
