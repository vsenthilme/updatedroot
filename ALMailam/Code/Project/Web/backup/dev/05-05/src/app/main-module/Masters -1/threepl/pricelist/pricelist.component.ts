...
export class PricelistComponent implements OnInit {
  ...
  console.log(this.selectedpricelist)
    ...
    const dialogRef = this.dialog.open(PricelistNewComponent, {
      disableClose: true,
      width: '85%',
      maxWidth: '65%',
      data: { pageflow: data, code: data != 'New' ? this.selectedpricelist[0].code : null,}
    });
...
//   }
  ...
  // }
  onChange() {
    console.log(this.selectedpricelist.length)
