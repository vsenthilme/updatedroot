...
export class MakeandchangeTabComponent implements OnInit {
  ...
  link = [
    { url: "/main/otherSetup/cyclecounttypeid", title: "Cycle Count Type ",  class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
    { url: "/main/otherSetup/approvalprocessid", title: "Approval Process ",  class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
    { url: "/main/otherSetup/approvalid", title: "Approval ",  class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
    { url: "/main/otherSetup/movementtypeid", title: "Movement Type ",  class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
    { url: "/main/otherSetup/submovementtypeid", title: "Sub Movement Type ",  class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
    { url: "/main/otherSetup/transfertypeid", title: "Transfer Type ",  class: "mx-1 hovertab d-flex justify-content-center align-items-center" },
