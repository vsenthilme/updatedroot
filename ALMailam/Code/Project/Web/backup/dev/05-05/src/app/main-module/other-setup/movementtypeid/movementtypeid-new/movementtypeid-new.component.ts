...
@Component({
  selector: 'app-movementtypeid-new',
  templateUrl: './movementtypeid-new.component.html',
  styleUrls: ['./movementtypeid-new.component.scss']
})
export class MovementtypeidNewComponent implements OnInit {
  ...
  form = this.fb.group({
    ...
    movementTypeText: [,Validators.required],
    plantId: [],
    referenceField1: [],
    referenceField10: [],
    referenceField2: [],
  ...
  if (this.data.code) {
    ...
    this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
      this.toastr.success(res.movementTypeId + " Saved Successfully!","Notification",{
        timeOut: 2000,
        progressBar: false,
      });
      this.spin.hide();
