...
export class PricelistassignmentComponent implements OnInit {
  ...
  console.log(this.selectedpricelistas)
    if (data != 'New')
    ...
    const dialogRef = this.dialog.open(PricelistassignmentNewComponent, {
      disableClose: true,
      width: '85%',
      maxWidth: '65%',
      data: { pageflow: data, code: data != 'New' ? this.selectedpricelistas[0].code : null,}
    });
...
//   }
  ...
  // }
  onChange() {
    console.log(this.selectedpricelistas.length)
