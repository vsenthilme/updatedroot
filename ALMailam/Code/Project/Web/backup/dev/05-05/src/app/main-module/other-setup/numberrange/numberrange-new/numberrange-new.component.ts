...
@Component({
  ...
  styleUrls: ['./numberrange-new.component.scss']
})
export class NumberrangeNewComponent implements OnInit {
  disabled = false;
  step = 0;
  //dialogRef: any;
  ...
  fill() {
    this.spin.show();
    this.sub.add(this.service.Get(this.data.code,this.data.warehouseId,this.data.languageId,this.data.plantId,this.data.companyCodeId,this.data.fiscalYear).subscribe(res => {
  ...
  if (this.data.code) {
    this.sub.add(this.service.Update(this.form.getRawValue(), this.data.code,this.data.warehouseId,this.data.languageId,this.data.plantId,this.data.companyCodeId,this.data.fiscalYear).subscribe(res => {
    ...
    this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
      this.toastr.success(res.numberRangeCode + " Saved Successfully!","Notification",{
        timeOut: 2000,
        progressBar: false,
      });
      this.spin.hide();
