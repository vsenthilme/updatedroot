...
import { QuotationheaderNewComponent } from './quotationheader-new/quotationheader-new.component';
import { QuotationheaderService } from './quotationheader.service';

@Component({
  selector: 'app-quotationheader',
  templateUrl: './quotationheader.component.html',
  styleUrls: ['./quotationheader.component.scss']
})
export class QuotationheaderComponent implements OnInit {
  ...
  console.log(this.selectedquotation)
    ...
    const dialogRef = this.dialog.open(QuotationheaderNewComponent, {
      disableClose: true,
      width: '85%',
      maxWidth: '65%',
