...
@Component({
  selector: 'app-warehousetype-new',
  templateUrl: './warehousetype-new.component.html',
  styleUrls: ['./warehousetype-new.component.scss']
})
export class WarehousetypeNewComponent implements OnInit {
  ...
  form = this.fb.group({
    ...
    languageId: [],
    warehouseTypeText: [,Validators.required],
    deletionIndicator: [],
    createdBy: [],
    createdOn: [],
    updatedBy: [],
...
if (this.data.code) {
  ...
  this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
    this.toastr.success(res.warehouseTypeId + " Saved Successfully!","Notification",{
      timeOut: 2000,
      progressBar: false,
    });
    this.spin.hide();
