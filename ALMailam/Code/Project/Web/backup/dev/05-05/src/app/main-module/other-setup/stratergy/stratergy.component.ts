...
export class StratergyComponent implements OnInit {
  ...
  deleteDialog() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        this.deleterecord(this.selectedstratergy[0].strategyNo,this.selectedstratergy[0].strategyTypeId,this.selectedstratergy[0].warehouseId,this.selectedstratergy[0].companyCodeId,this.selectedstratergy[0].plantId,this.selectedstratergy[0].languageId);
  ...
  downloadexcel() {
    ...
    this.stratergy.forEach(x => {
      res.push({
        ...
        "Strategy type text":x.strategyTypeText,
        "Strategy type ID":x.strategyTypeId,
