...
@Component({
  selector: 'app-usertype-new',
  templateUrl: './usertype-new.component.html',
  styleUrls: ['./usertype-new.component.scss']
})
export class UsertypeNewComponent implements OnInit {
  ...
  if (this.data.code) {
    ...
    this.sub.add(this.service.Create(this.form.getRawValue()).subscribe(res => {
      this.toastr.success(res.userTypeId + " Saved Successfully!","Notification",{
        timeOut: 2000,
        progressBar: false,
      });
      this.spin.hide();
