...
@Component({
  selector: 'app-quotationheader-new',
  templateUrl: './quotationheader-new.component.html',
  styleUrls: ['./quotationheader-new.component.scss']
})
export class QuotationheaderNewComponent implements OnInit {
