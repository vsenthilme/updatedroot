...
export class SubitemgroupNewComponent implements OnInit {
  ...
  form = this.fb.group({
    ...
    subItemGroup: [,Validators.required],
 ...
 onItemTypeChange(value){
  ...
  fill() {
    this.spin.show();
    this.sub.add(this.service.Get(this.data.code,this.data.warehouseId,this.data.languageId,this.data.companyCodeId,this.data.plantId,this.data.itemGroupId,this.data.itemTypeId,this.data.subItemGroup).subscribe(res => {
  ...
  if (this.data.code) {
    this.sub.add(this.service.Update(this.form.getRawValue(), this.data.code,this.data.warehouseId,this.data.languageId,this.data.companyCodeId,this.data.plantId,this.data.itemGroupId,this.data.itemTypeId,this.data.subItemGroup).subscribe(res => {
