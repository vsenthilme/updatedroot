...
@Component({
  selector: 'app-assign-physical',
  templateUrl: './assign-physical.component.html',
  styleUrls: ['./assign-physical.component.scss']
})
export class AssignPhysicalComponent implements OnInit {
