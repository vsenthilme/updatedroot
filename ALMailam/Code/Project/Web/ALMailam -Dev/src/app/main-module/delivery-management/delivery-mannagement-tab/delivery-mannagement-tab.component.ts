...
export class DeliveryMannagementTabComponent implements OnInit {
  ...
  link = [
    { url: "/main/delivery/consignment", title: "Consignments",  screenid: 3190,  class: "mx-1 d-flex justify-content-center align-items-center" },
    { url: "/main/delivery/pickup", title: "Pickup", screenid: 3188,   class: "mx-1 d-flex justify-content-center align-items-center" },
    { url: "/main/delivery/delivery", title: "Delivery",  screenid: 3189,  class: "mx-1 d-flex justify-content-center align-items-center" },
