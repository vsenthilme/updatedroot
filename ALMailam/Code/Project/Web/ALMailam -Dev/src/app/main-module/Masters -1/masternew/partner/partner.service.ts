...
export class PartnerService {
  ...
  Update(obj: any,code:any,warehouseId:any,languageId:any,plantId:any,companyCodeId:any) {
    return this.http.patch<any>(this.apiName + `impartner/`+code +'?warehouseId='+warehouseId+'&languageId='+languageId+'&plantId='+plantId+'&companyCodeId='+companyCodeId, obj);
  }
  Delete(code:any,warehouseId:any,plantId:any,languageId:any,companyCodeId:any) {
    return this.http.delete<any>(this.apiName + `impartner/`+ code +'?warehouseId='+warehouseId+'&plantId='+plantId+ '&languageId='+languageId+'&companyCodeId='+companyCodeId);
  }
  GetWh() {
