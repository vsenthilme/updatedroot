 ...
 */
@Table(
		name = "tblstoragetypeid", 
		uniqueConstraints = { 
				@UniqueConstraint (
						name = "unique_key_stroagetypeid", 
						columnNames = {"C_ID", "PLANT_ID", "WH_ID", "ST_CL_ID", "ST_TYP_ID", "LANG_ID"})
				}
		)
@IdClass(StroageTypeIdCompositeKey.class)
public class StorageTypeId { 
	...
	@Column(name = "ST_TYP_TEXT",columnDefinition = "nvarchar(500)")
