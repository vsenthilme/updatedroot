...
//    	log.info("PreInboundLine : " + preinboundline);
    ...
    @PostMapping("/v2")
    public ResponseEntity<?> postPreInboundLineV2(@Valid @RequestBody PreInboundLineV2 newPreInboundLine, @RequestParam String loginUserID)
            throws IllegalAccessException, InvocationTargetException {
    ...
    public ResponseEntity<?> patchPreInboundLineV2(@PathVariable String preInboundNo, @RequestParam String warehouseId, @RequestParam String companyCode,
        ...
        PreInboundLineEntityV2 createdPreInboundLine =
                preinboundlineService.updatePreInboundLineEntityV2(companyCode, plantId, languageId, preInboundNo, warehouseId,
