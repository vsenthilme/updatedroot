...
public class OrderManagementLineController {
	...
	public ResponseEntity<?> unallocateOrderManagementLine(@RequestParam String warehouseId, @RequestParam String languageId, @RequestParam String preOutboundNo,
		...
		OrderManagementLine updatedOrderManagementLine = 
				ordermangementlineService.doUnAllocation(warehouseId, languageId, preOutboundNo, refDocNumber, partnerCode, lineNumber,
	...
	public ResponseEntity<?> assignPicker(@RequestBody List<AssignPicker> assignPicker, @RequestParam String assignedPickerId, @RequestParam String languageId,
			@RequestParam String loginUserID) throws IllegalAccessException, InvocationTargetException {
		List<OrderManagementLine> updatedOrderManagementLine = 
				ordermangementlineService.doAssignPicker(assignPicker, assignedPickerId, languageId, loginUserID);
		return new ResponseEntity<>(updatedOrderManagementLine , HttpStatus.OK);
	}
