...
//		log.info("results: " + results);
    ...
    public List<GrHeaderV2> findGrHeaderV2(SearchGrHeaderV2 searchGrHeader) throws Exception {
        ...
        List<GrHeaderV2> results = grHeaderV2Repository.findAll(spec);
//		log.info("results: " + results);
        return results;
    }
    ...
    public void updateASNV2(String asnNumber) {
        List<GrHeaderV2> grHeaders = getGrHeadersV2();
        grHeaders.stream().forEach(g -> g.setReferenceField1(asnNumber));
        grHeaderV2Repository.saveAll(grHeaders);
    }
}
