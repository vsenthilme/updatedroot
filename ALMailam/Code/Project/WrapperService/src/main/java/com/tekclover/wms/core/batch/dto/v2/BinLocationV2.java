...
public class BinLocationV2 {
	...
	private String dtype;            // used for table extension
	 ...
	 * @param dtype
	 */
	public BinLocationV2(String languageId, String companyCodeId, String plantId, String warehouseId, String storageBin, Long floorId,
						 ...
						 Boolean pickingBlock, String blockReason, Long statusId, Long deletionIndicator, String createdBy, String dtype) {
