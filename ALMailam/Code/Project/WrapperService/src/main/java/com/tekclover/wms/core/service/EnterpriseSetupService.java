...
public class EnterpriseSetupService {
	...
	public BatchSerial[] getBatchSerial(String storageMethod,String companyId,String languageId,
										String plantId,String warehouseId,Long levelId,String maintenance,String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
...
//	}
// Delete BatchSerial
	public boolean deleteBatchSerial (String storageMethod,String companyId,String plantId,String warehouseId,String maintenance,
	...
	// GET ItemGroup
	public ItemGroup[] getItemGroup(String companyId,String languageId,String plantId,String warehouseId, Long itemTypeId, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
...
//	}
	...
	// GET Strategies
	public Strategies[] getStrategies( String companyId, String languageId,String plantId, String warehouseId,String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
	...
	// Delete Strategies
	public boolean deleteStrategies ( String companyId, String languageId,String plantId,String warehouseId,
									  String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
	...
	// Patch Variant
	public Variant[] updateVariant (String variantId, List<UpdateVariant> modifiedVariant,String companyId,String plantId,
									String warehouseId,String languageId,Long levelId,String variantSubId, String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "Classic WMS's RestTemplate");
