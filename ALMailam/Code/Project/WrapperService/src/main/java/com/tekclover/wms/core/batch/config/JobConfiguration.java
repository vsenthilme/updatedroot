...
import com.tekclover.wms.core.batch.mapper.v2.BinLocationV2FieldSetMapper;
import com.tekclover.wms.core.batch.mapper.v2.IMPartnerV2FieldSetMapper;
...
public class JobConfiguration extends DefaultBatchConfigurer {
	...
	@Bean
	public FlatFileItemReader<BinLocationV2> storageBinV2ItemReader() {
		FlatFileItemReader<BinLocationV2> reader = new FlatFileItemReader<>();
		reader.setLinesToSkip(1);
		reader.setResource(new FileSystemResource(propertiesConfig.getFileUploadDir() + propertiesConfig.getBinlocationFileName()));

		DefaultLineMapper<BinLocationV2> customerLineMapper = new DefaultLineMapper<>();
		DelimitedLineTokenizer tokenizer = new DelimitedLineTokenizer();
		tokenizer.setNames(new String[] { "languageId", "companyCodeId", "plantId", "warehouseId", "storageBin", "floorId",
				"storageSectionId", "rowId", "aisleNumber", "spanId", "shelfId", "binSectionId",
				"storageTypeId", "binClassId", "description",	"binBarcode", "putawayBlock",
				"pickingBlock", "blockReason", "statusId", "deletionIndicator", "createdBy", "dtype" });
		customerLineMapper.setLineTokenizer(tokenizer);
		customerLineMapper.setFieldSetMapper(new BinLocationV2FieldSetMapper());
		customerLineMapper.afterPropertiesSet();
		reader.setLineMapper(customerLineMapper);
		return reader;
	}
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Bean
	public JdbcBatchItemWriter<BinLocationV2> storageBinV2ItemWriter() {
		JdbcBatchItemWriter<BinLocationV2> itemWriter = new JdbcBatchItemWriter<>();
		itemWriter.setDataSource(this.dataSource);
		itemWriter.setSql("INSERT INTO tblstoragebin "
				+ " (LANG_ID, C_ID, PLANT_ID, WH_ID, ST_BIN, FL_ID, ST_SEC_ID, ROW_ID, AISLE_ID, SPAN_ID, SHELF_ID, "
				+ " BIN_SECTION_ID, ST_TYP_ID, BIN_CL_ID, ST_BIN_TEXT, BIN_BAR, PUTAWAY_BLOCK, PICK_BLOCK, BLK_REASON, "
				+ " STATUS_ID, IS_DELETED, CTD_BY, CTD_ON, UTD_BY, UTD_ON, dtype) "
				+ "VALUES (:languageId, :companyCodeId, :plantId, :warehouseId, :storageBin, :floorId, :storageSectionId,"
				+ ":rowId, :aisleNumber, :spanId, :shelfId, :binSectionId, :storageTypeId, :binClassId, :description, "
				+ ":binBarcode, :putawayBlock, :pickingBlock, :blockReason, :statusId,\r\n"
				+ ":deletionIndicator, :createdBy, GETDATE(), :createdBy, GETDATE(), :dtype)");
		itemWriter.setItemSqlParameterSourceProvider(new BeanPropertyItemSqlParameterSourceProvider());
		itemWriter.afterPropertiesSet();
		return itemWriter;
	}
	...
	@Bean
	public Step step3V2() {
		return stepBuilderFactory.get("step3V2").<BinLocationV2, BinLocationV2>chunk(10).reader(storageBinV2ItemReader())
				.writer(storageBinV2ItemWriter()).build();
	}
	...
	//---------------------------IMPartner------------------------------------------------------------------//
	@Bean
	public FlatFileItemReader<IMPartnerV2> imPartnerV2ItemReader() {
		FlatFileItemReader<IMPartnerV2> reader = new FlatFileItemReader<>();
		reader.setLinesToSkip(1);
		reader.setResource(new FileSystemResource(propertiesConfig.getFileUploadDir() + propertiesConfig.getImpartnerFileName()));

		DefaultLineMapper<IMPartnerV2> customerLineMapper = new DefaultLineMapper<>();
		DelimitedLineTokenizer tokenizer = new DelimitedLineTokenizer();
		tokenizer.setNames(new String[] { "languageId", "companyCodeId", "plantId", "warehouseId", "itemCode", "businessPartnerCode",
				"businessPartnerType", "partnerItemBarcode", "manufacturerCode", "manufacturerName","brandName",
				"partnerName","partnerItemNo","vendorItemBarcode","mfrBarcode","stock","stockUom","statusId", "referenceField1",
				"referenceField2", "referenceField3","referenceField4","referenceField5","referenceField6","referenceField7","referenceField8",
				"referenceField9","referenceField10","deletionIndicator", "createdBy"});
		customerLineMapper.setLineTokenizer(tokenizer);
		customerLineMapper.setFieldSetMapper(new IMPartnerV2FieldSetMapper());
		customerLineMapper.afterPropertiesSet();
		reader.setLineMapper(customerLineMapper);
		return reader;
	}
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Bean
	public JdbcBatchItemWriter<IMPartnerV2> imPartnerV2ItemWriter() {
		JdbcBatchItemWriter<IMPartnerV2> itemWriter = new JdbcBatchItemWriter<>();
		itemWriter.setDataSource(this.dataSource);
		itemWriter.setSql("INSERT INTO tblimpartner (LANG_ID, C_ID, PLANT_ID, WH_ID, ITM_CODE, PARTNER_CODE, PARTNER_TYP, "
				+ "PARTNER_ITM_BAR, MFR_CODE, MFR_NAME, BRND_NM, PARTNER_NAME, PARTNER_ITM_CODE, PARTNER_ITM_BAR_CODE, MFR_BAR, STK, STK_UOM,"
				+ "STATUS_ID, REF_FIELD_1, REF_FIELD_2, REF_FIELD_3,REF_FIELD_4,REF_FIELD_5,REF_FIELD_6,REF_FIELD_7,REF_FIELD_8,REF_FIELD_9,"
				+ "REF_FIELD_10, IS_DELETED,CTD_BY,"
				+ "CTD_ON, UTD_BY, UTD_ON)"
				+ "VALUES (:languageId, :companyCodeId, :plantId, :warehouseId, :itemCode, :businessPartnerCode, :businessPartnerType,"
				+ ":partnerItemBarcode, :manufacturerCode, :manufacturerName, :brandName, :partnerName, :partnerItemNo, :vendorItemBarcode,"
				+ ":mfrBarcode, :stock, :stockUom, :statusId, :referenceField1, :referenceField2, :referenceField3, :referenceField4, :referenceField5 , :referenceField6,"
	...
	@Bean
	public Step step9V2() {
		return stepBuilderFactory.get("step9V2").<IMPartnerV2, IMPartnerV2>chunk(10).reader(imPartnerV2ItemReader())
				.writer(imPartnerV2ItemWriter()).build();
	}
	...
	@Bean
	public FlatFileItemReader<StatusId> statusIdReader() {
		FlatFileItemReader<StatusId> reader = new FlatFileItemReader<>();
		reader.setLinesToSkip(1);
		reader.setResource(new FileSystemResource(propertiesConfig.getFileUploadDir() + propertiesConfig.getStatusFileName()));

		DefaultLineMapper<StatusId> customerLineMapper = new DefaultLineMapper<>();
		DelimitedLineTokenizer tokenizer = new DelimitedLineTokenizer();
		tokenizer.setNames(new String[] { "languageId", "statusId", "status","deletionIndicator", "referenceField1",
				"referenceField2", "referenceField3","referenceField4","referenceField5","referenceField6","referenceField7","referenceField8",
				"referenceField9","referenceField10", "createdBy"});
		customerLineMapper.setLineTokenizer(tokenizer);
		customerLineMapper.setFieldSetMapper(new StatusIdFieldSetMapper());
		customerLineMapper.afterPropertiesSet();
		reader.setLineMapper(customerLineMapper);
		return reader;
	}
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Bean
	public JdbcBatchItemWriter<StatusId> statusIdWriter() {
		JdbcBatchItemWriter<StatusId> itemWriter = new JdbcBatchItemWriter<>();
		itemWriter.setDataSource(this.dataSource);
		itemWriter.setSql("INSERT INTO tblstatusid (LANG_ID, STATUS_ID, STATUS_TEXT, IS_DELETED,"
				+ " REF_FIELD_1, REF_FIELD_2, REF_FIELD_3, REF_FIELD_4, REF_FIELD_5, REF_FIELD_6, REF_FIELD_7,"
				+ " REF_FIELD_8, REF_FIELD_9, REF_FIELD_10,CTD_BY,"
				+ " CTD_ON, UTD_BY, UTD_ON)"
				+ " VALUES (:languageId, :statusId, :status, :deletionIndicator, :referenceField1, "
	...
	@Bean
	public Step step11() {
		return stepBuilderFactory.get("step11").<StatusId, StatusId>chunk(10).reader(statusIdReader())
				.writer(statusIdWriter()).build();
	}
	...
	//---------------------------ItemGroupId------------------------------------------------------------------//
	@Bean
	public FlatFileItemReader<ItemGroupId> itemGroupIdReader() {
		FlatFileItemReader<ItemGroupId> reader = new FlatFileItemReader<>();
		reader.setLinesToSkip(1);
		reader.setResource(new FileSystemResource(propertiesConfig.getFileUploadDir() + propertiesConfig.getItemGroupIdFileName()));

		DefaultLineMapper<ItemGroupId> customerLineMapper = new DefaultLineMapper<>();
		DelimitedLineTokenizer tokenizer = new DelimitedLineTokenizer();
		tokenizer.setNames(new String[] {"companyCodeId","plantId","warehouseId","itemTypeId","itemGroupId","languageId","itemGroup",
				"deletionIndicator","companyIdAndDescription","plantIdAndDescription","warehouseIdAndDescription","itemTypeIdAndDescription",
		...
		customerLineMapper.setLineTokenizer(tokenizer);
		customerLineMapper.setFieldSetMapper(new ItemGroupFieldSetMapper());
		customerLineMapper.afterPropertiesSet();
		reader.setLineMapper(customerLineMapper);
		return reader;
	}
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Bean
	public JdbcBatchItemWriter<ItemGroupId> itemGroupWriter() {
		JdbcBatchItemWriter<ItemGroupId> itemWriter = new JdbcBatchItemWriter<>();
		itemWriter.setDataSource(this.dataSource);
		itemWriter.setSql("INSERT INTO tblitemgroupid (C_ID,PLANT_ID,WH_ID,ITM_TYPE_ID,ITM_GRP_ID,LANG_ID,IMT_GRP,IS_DELETED,"
				+  "COMP_ID_DESC,PLANT_ID_DESC,WAREHOUSE_ID_DESC,ITEM_TYPE_ID_DESC,REF_FIELD_1, "
				...
				+ " VALUES (:companyCodeId, :plantId, :warehouseId, :itemTypeId, :itemGroupId, :languageId, "
				+ " :itemGroup, :deletionIndicator, :companyIdAndDescription, :plantIdAndDescription, "
				+ " :warehouseIdAndDescription, :itemTypeIdAndDescription, :referenceField1, "
				+ " :referenceField2, :referenceField3, :referenceField4, :referenceField5 ,"
				+ " :referenceField6, :referenceField7, :referenceField8, :referenceField9,"
				+ " :referenceField10, :createdBy, GETDATE(), :createdBy, GETDATE())");
		itemWriter.setItemSqlParameterSourceProvider(new BeanPropertyItemSqlParameterSourceProvider());
		itemWriter.afterPropertiesSet();
		return itemWriter;
	}
	...
	@Bean
	public Step step12() {
		return stepBuilderFactory.get("step12").<ItemGroupId, ItemGroupId>chunk(10).reader(itemGroupIdReader())
				.writer(itemGroupWriter()).build();
	}
	...
	@Bean
	public FlatFileItemReader<SubItemGroupId> subItemGroupIdReader() {
		FlatFileItemReader<SubItemGroupId> reader = new FlatFileItemReader<>();
		reader.setLinesToSkip(1);
		reader.setResource(new FileSystemResource(propertiesConfig.getFileUploadDir() + propertiesConfig.getSubItemGroupIdFileName()));

		DefaultLineMapper<SubItemGroupId> customerLineMapper = new DefaultLineMapper<>();
		DelimitedLineTokenizer tokenizer = new DelimitedLineTokenizer();
		tokenizer.setNames(new String[] {"companyCodeId","plantId","warehouseId","itemTypeId","itemGroupId","subItemGroupId","languageId","subItemGroup",
				"description","companyIdAndDescription","plantIdAndDescription","warehouseIdAndDescription","itemTypeIdAndDescription","itemGroupIdAndDescription",
				"deletionIndicator","referenceField1","referenceField2", "referenceField3","referenceField4","referenceField5",
				"referenceField6","referenceField7","referenceField8","referenceField9","referenceField10", "createdBy"});
		customerLineMapper.setLineTokenizer(tokenizer);
		customerLineMapper.setFieldSetMapper(new SubItemGroupIdFieldSetMapper());
		customerLineMapper.afterPropertiesSet();
		reader.setLineMapper(customerLineMapper);
		return reader;
	}
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Bean
	public JdbcBatchItemWriter<SubItemGroupId> subItemGroupIdWriter() {
		JdbcBatchItemWriter<SubItemGroupId> itemWriter = new JdbcBatchItemWriter<>();
		itemWriter.setDataSource(this.dataSource);
		itemWriter.setSql("INSERT INTO tblsubitemgroupid (C_ID, PLANT_ID, WH_ID, ITM_TYP_ID, ITM_GRP_ID, SUB_ITM_GRP_ID,"
				+ " LANG_ID, SUB_ITM_GRP, SUB_ITM_GRP_TEXT, COMP_ID_DESC, PLANT_ID_DESC,"
				+ " WAREHOUSE_ID_DESC, ITEM_TYPE_ID_DESC, ITEM_GROUP_ID_DESC, IS_DELETED, REF_FIELD_1, "
				+ " REF_FIELD_2, REF_FIELD_3, REF_FIELD_4, REF_FIELD_5, REF_FIELD_6, REF_FIELD_7,"
				+ " REF_FIELD_8, REF_FIELD_9, REF_FIELD_10,CTD_BY,CTD_ON, UTD_BY, UTD_ON)"
				+ " VALUES (:companyCodeId, :plantId, :warehouseId, :itemTypeId, :itemGroupId,"
				+ " :subItemGroupId, :languageId, :subItemGroup, :description, :companyIdAndDescription,"
				+ " :plantIdAndDescription, :warehouseIdAndDescription, :itemTypeIdAndDescription,"
				+ " :itemGroupIdAndDescription, :deletionIndicator, :referenceField1, :referenceField2,"
				+ " :referenceField3, :referenceField4, :referenceField5, :referenceField6, :referenceField7,"
				+ " :referenceField8, :referenceField9, :referenceField10, :createdBy, GETDATE(), :createdBy, GETDATE())");
	...
	@Bean
	public Step step13() {
		return stepBuilderFactory.get("step13").<SubItemGroupId, SubItemGroupId>chunk(10).reader(subItemGroupIdReader())
				.writer(subItemGroupIdWriter()).build();
	}
	...
	@Bean
	public Job jobBinLocationV2() throws Exception {
		return jobBuilderFactory.get("jobBinLocationV2")
				.listener(wmsListener())
				.start(step3V2())
				.build();
	}
	...
	@Bean
	public Job jobIMPartnerV2() throws Exception{
		return jobBuilderFactory.get("jobIMPartnerV2")
				.listener(wmsListener())
				.start(step9V2())
				.build();
	}
	...
	@Bean
	public Job jobStatusId() throws Exception{
		return jobBuilderFactory.get("jobStatusId")
				.listener(wmsListener())
				.start(step11())
				.build();
	}
	...
	@Bean
	public Job jobItemGroupId() throws Exception{
		return jobBuilderFactory.get("jobItemGroupId")
				.listener(wmsListener())
				.start(step12())
				.build();
	}
	...
	@Bean
	public Job jobSubItemGroupId() throws Exception{
		return jobBuilderFactory.get("jobSubItemGroupId")
				.listener(wmsListener())
				.start(step13())
				.build();
	}
