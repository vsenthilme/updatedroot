...
import com.tekclover.wms.core.batch.dto.ItemGroupId;
import org.springframework.batch.item.file.mapping.FieldSetMapper;
import org.springframework.batch.item.file.transform.FieldSet;

public class ItemGroupFieldSetMapper implements FieldSetMapper<ItemGroupId> {

    @Override
    public ItemGroupId mapFieldSet(FieldSet fieldSet) {
