...
public class VariantController {
	...
	public ResponseEntity<?> getVariant(@PathVariable String variantId,@RequestParam String companyId,@RequestParam String languageId,@RequestParam Long levelId,@RequestParam String plantId,@RequestParam String warehouseId) {
    	Variant variant = variantService.getVariant(variantId,companyId,languageId,plantId,warehouseId,levelId);
	...
	public ResponseEntity<?> patchVariant(@PathVariable String variantId,@RequestParam String companyId,@RequestParam String plantId,@RequestParam String warehouseId,@RequestParam String languageId,@RequestParam Long levelId,
			@Valid @RequestBody UpdateVariant updateVariant, @RequestParam String loginUserID)
			throws IllegalAccessException, InvocationTargetException {
		Variant createdVariant = variantService.updateVariant(variantId,companyId,languageId,plantId,warehouseId,levelId,updateVariant,loginUserID);
		return new ResponseEntity<>(createdVariant , HttpStatus.OK);
	}
    
    @ApiOperation(response = Variant.class, value = "Delete Variant") // label for swagger
	@DeleteMapping("/{variantId}")
	public ResponseEntity<?> deleteVariant(@PathVariable String variantId,@RequestParam String companyId,@RequestParam String plantId,@RequestParam String languageId,@RequestParam String warehouseId,@RequestParam Long levelId,@RequestParam String loginUserID) {
    	variantService.deleteVariant(variantId,companyId,languageId,plantId,warehouseId,levelId,loginUserID);
