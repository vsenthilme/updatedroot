...
*/
    ...
    @PatchMapping("/bomline/batchUpdate/{bomNumber}")
    public ResponseEntity<?> patchBomLineBatch(@RequestParam String warehouseId, @PathVariable Long bomNumber, @RequestParam String companyCode,
                                               @RequestParam String plantId, @RequestParam String languageId, @RequestParam String loginUserID,
                                               @RequestParam String authToken, @Valid @RequestBody List<BomLine> updateBomLine) {

        BomLine[] updateBomLines = mastersService.updateBomLines(companyCode, plantId, languageId, warehouseId, bomNumber, loginUserID, updateBomLine, authToken);
        return new ResponseEntity<>(updateBomLines, HttpStatus.OK);
    }
    ...
    //Streaming
    @ApiOperation(response = ImBasicData1.class, value = "Search ImBasicData1 Stream") // label for swagger
    @PostMapping("/imbasicdata1/v3/findImBasicData1")
    public ImBasicData1[] findImBasicData1V3(@RequestBody SearchImBasicData1 searchImBasicData1,
                                              @RequestParam String authToken) throws Exception {
        return mastersService.findImBasicData1V3(searchImBasicData1, authToken);
    }
...
//DELETE
    ...
    //GET
    @ApiOperation(response = PutAwayStrategy.class, value = "Get PutAwayStrategy") // label for swagger
    @RequestMapping(value = "/putAwayStrategy/get", method = RequestMethod.GET)
    public ResponseEntity<?> getPutAwayStrategy(@RequestParam String languageId, @RequestParam String companyCodeId, @RequestParam String plantId,
                                        @RequestParam String warehouseId, @RequestParam String brand, @RequestParam String article,
                                        @RequestParam String category,@RequestParam String authToken) {

        PutAwayStrategy dbPutAwayStrategy = mastersService.getPutAwayStrategy(languageId, companyCodeId, plantId, warehouseId, brand, article, category,  authToken);
        return new ResponseEntity<>(dbPutAwayStrategy, HttpStatus.OK);
    }

    //CREATE
    @ApiOperation(response = PutAwayStrategy.class, value = "Create new PutAwayStrategy") // label for swagger
    @RequestMapping(value = "/putAwayStrategy", method = RequestMethod.POST)
    public ResponseEntity<?> createPutAwayStrategy(@RequestParam String authToken, @RequestParam String loginUserID,
                                         @RequestBody AddPutAwayStrategy addPutAwayStrategy) {

        PutAwayStrategy dbPutAwayStrategy = mastersService.addPutAwayStrategy(addPutAwayStrategy, loginUserID, authToken);
        return new ResponseEntity<>(dbPutAwayStrategy, HttpStatus.OK);
    }

    //UPDATE
    @ApiOperation(response = PutAwayStrategy.class, value = "Update PutAwayStrategy") // label for swagger
    @RequestMapping(value = "/putAwayStrategy/update", method = RequestMethod.PATCH)
    public ResponseEntity<?> updatePutAwayStrategy(@RequestParam String authToken, @RequestParam String languageId, @RequestParam String companyCodeId, @RequestParam String plantId,
                                           @RequestParam String warehouseId, @RequestParam String brand, @RequestParam String article, @RequestParam String category,  @RequestParam String loginUserID,
                                           @RequestBody UpdatePutAwayStrategy updatePutAwayStrategy) {

        PutAwayStrategy dbPutAwayStrategy = mastersService.updatePutAwayStrategy(languageId, companyCodeId, plantId, warehouseId, brand, article, category, updatePutAwayStrategy, loginUserID, authToken);
    ...
    @RequestMapping(value = "/putAwayStrategy/delete", method = RequestMethod.DELETE)
    public ResponseEntity<?> deletePutAwayStrategy(@RequestParam String authToken, @RequestParam String languageId, @RequestParam String companyCodeId, @RequestParam String plantId,
                                           @RequestParam String warehouseId, @RequestParam String brand, @RequestParam String article, @RequestParam String category,  @RequestParam String loginUserID) {

        mastersService.deletePutAwayStrategy(languageId, companyCodeId, plantId, warehouseId, brand, article, category, loginUserID, authToken);
    ...
    @PostMapping("/putAwayStrategy/findPutAwayStrategy")
    public PutAwayStrategy[] findPutAwayStrategy(@RequestBody FindPutAwayStrategy findPutAwayStrategy,
                                         @RequestParam String authToken) throws Exception {

        return mastersService.findPutAwayStrategy(findPutAwayStrategy, authToken);
    }
}