...
//		batchJobScheduler.runJobPeriodic();
    ...
    public ResponseEntity<?> postDeliveryConfirmationUploadV3(@RequestParam(required = false) String companyCodeId, @RequestParam(required = false) String plantId,
                                                              @RequestParam(required = false) String languageId, @RequestParam(required = false) String warehouseId,
                                                              @RequestParam(required = false) String loginUserID, @RequestParam("file") MultipartFile file) throws Exception {
        Map<String, String> response = fileStorageService.processDeliveryConfirmationV3(companyCodeId, plantId, languageId, warehouseId, loginUserID, file);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }

    // File Upload - InboundReversal - V3 - Walkaroo
    @ApiOperation(response = ReversalV3.class, value = "InboundReversal V3 Walkaroo") // label for swagger
    @PostMapping("/warehouse/inbound/reversal/upload/v3")
    public ResponseEntity<?> postInboundReversalUploadV3(@RequestParam String companyCodeId, @RequestParam String plantId,
                                                         @RequestParam String languageId, @RequestParam String warehouseId,
                                                         @RequestParam String loginUserID, @RequestParam("file") MultipartFile file) throws Exception {
        Map<String, String> response = fileStorageService.postInboundReversalUploadV3(companyCodeId, plantId, languageId, warehouseId, loginUserID, file);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
...
// -------------------------------------StagingHeader-V2--------------------------------------------------------------------------------------------
    ...
    public InventoryV2[] findInventoryV3(@RequestBody SearchInventoryV2 searchInventory, @RequestParam String authToken) throws Exception {
        return transactionService.findInventoryV3(searchInventory, authToken);
    }
...
<<<<<<< HEAD
    ...
    public DeliveryConfirmation[] findDeliveryConfirmationV3(@RequestBody SearchDeliveryConfirmation searchDeliveryConfirmation,
                                                             @RequestParam String authToken) throws Exception {
        return transactionService.findDeliveryConfirmation(searchDeliveryConfirmation, authToken);
    }
...
//    }
    ...
    //=================================================File Upload Inbound Orders V3 Dynamic=============================================================================
    ...
    public ResponseEntity<?> postWarehouseInboundUploadV4(@RequestParam String companyCodeId, @RequestParam String plantId,
        ...
        Map<String, String> response = fileStorageService.processInboundOrdersV3(companyCodeId, plantId, languageId, warehouseId, inboundOrderTypeId, loginUserID, file);
    ...
    public ResponseEntity<?> getAdditionalBins(@PathVariable Long pId, @RequestParam String companyCodeId, @RequestParam String plantId,
        ...
        PalletIdAssignment palletIdAssignments = transactionService.getPalletIdAssignment(companyCodeId, plantId, languageId, warehouseId, pId, authToken);
    ...
    public ResponseEntity<?> getAdditionalBins(@PathVariable String palletId, @RequestParam String companyCodeId, @RequestParam String plantId,
                                               @RequestParam String languageId, @RequestParam String warehouseId, @RequestParam String authToken) {
        PalletIdAssignment palletIdAssignmentV3 = transactionService.getPalletIdAssignmentV3(companyCodeId, plantId, languageId, warehouseId, palletId, authToken);
    ...
    public ResponseEntity<?> postPalletIdAssignment(@RequestParam String companyCodeId, @RequestParam String plantId,
                                                    ...
                                                    @RequestParam String loginUserID, @RequestParam String authToken) throws Exception {
        PalletIdAssignment[] createdPalletIdAssignment = transactionService.createPalletIdAssignment(companyCodeId, plantId, languageId, warehouseId, newPalletIdAssignment, loginUserID, authToken);
    ...
    public ResponseEntity<?> patchPalletIdAssignment(@RequestParam String companyCodeId, @RequestParam String plantId,
        ...
        PalletIdAssignment[] updatedPalletIdAssignment =
                transactionService.updatePalletIdAssignment(companyCodeId, plantId, languageId, warehouseId, updatepalletIdAssignmentList, loginUserID, authToken);
    ...
    public ResponseEntity<?> patchPalletIdStatus(@RequestParam String companyCodeId, @RequestParam String plantId, @RequestParam String languageId, @RequestParam String warehouseId,
        ...
        PalletIdAssignment[] updatedPalletIdStatus =
                transactionService.updatePalletIdStatus(companyCodeId, plantId, languageId, warehouseId, updatepalletIdStatus, loginUserID, authToken);
    ...
    public ResponseEntity<?> deletePickupLine(@PathVariable Long pId, @RequestParam String companyCodeId, @RequestParam String plantId,
                                              ...
                                              @RequestParam String loginUserID, @RequestParam String authToken)
            throws IllegalAccessException, InvocationTargetException {
        transactionService.deletePalletIdAssignment(companyCodeId, plantId, languageId, warehouseId, pId, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
    ...
    public PalletIdAssignment[] findPalletIdAssignment(@Valid @RequestBody FindPalletIdAssignment findPalletIdAssignment, @RequestParam String authToken) throws Exception {
        return transactionService.findPalletIdAssignment(findPalletIdAssignment, authToken);
    }
}