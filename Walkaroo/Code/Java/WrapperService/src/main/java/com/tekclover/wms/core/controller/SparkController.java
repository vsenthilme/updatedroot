...
public class SparkController {
    ...
    // Find InventoryV2_CORE_NEW
    @ApiOperation(response = InventoryV3.class, value = "Spark Inventory details new")
    @PostMapping("inventory/core/v2/new")
    public ResponseEntity<?> findInventoryV2New(@RequestBody FindInventoryV2 findInventoryV2) throws Exception {
        InventoryV3[] inventoryList = sparkService.findInventoryV2CoreNew(findInventoryV2);
        return new ResponseEntity<>(inventoryList, HttpStatus.OK);
    }
