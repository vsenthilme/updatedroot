...
<<<<<<< HEAD
	...
	public ResponseEntity<?> findHhtNotification(@RequestBody FindHhtNotification findHhtNotification, @RequestParam String authToken) {
		HhtNotification[] dbHhtNotification = idmasterService.findHhtNotification(findHhtNotification, authToken);
		return new ResponseEntity<>(dbHhtNotification, HttpStatus.OK);
	}
...
>>>>>>> 81dc64bb940937a238631ec1ef8d3af347b8ec9e
	...
	public Notification[] getAllNotifications(@RequestParam String userId, @RequestParam String authToken) throws ParseException {
		return idmasterService.getAllNotifications(userId, authToken);
	}
	...
	public ResponseEntity<?> markNotificationRead(@RequestParam String loginUserID,@PathVariable Long id,@RequestParam String authToken)
			throws IllegalAccessException, InvocationTargetException {
		Boolean result = idmasterService.updateNotificationAsRead(loginUserID, id, authToken);
	...
	public ResponseEntity<?> markNotificationReadAll(@RequestParam String loginUserID, @RequestParam String authToken)
			throws IllegalAccessException, InvocationTargetException {
		Boolean result = idmasterService.updateNotificationAsReadAll(loginUserID, authToken);
		return new ResponseEntity<>(result , HttpStatus.OK);
	}
	...
	public ResponseEntity<?> notificationUpdate(@Valid @RequestBody List<Notification> notification, @RequestParam String authToken)
			throws IllegalAccessException, InvocationTargetException {
		Boolean result = idmasterService.updateNotificationMessage(notification, authToken);
		return new ResponseEntity<>(result , HttpStatus.OK);
	}
	...
	public ResponseEntity<?> notificationUpdate(@RequestParam String authToken)
			throws IllegalAccessException, InvocationTargetException {
		Boolean result = idmasterService.updateNotificationMessage(authToken);
		return new ResponseEntity<>(result , HttpStatus.OK);
	}
    ...
    public ResponseEntity<?> notificationUpdate(@RequestBody SearchNotification searchNotification, @RequestParam String authToken) {
		NotificationMessage[] notificationList = idmasterService.findNotification(searchNotification, authToken);
