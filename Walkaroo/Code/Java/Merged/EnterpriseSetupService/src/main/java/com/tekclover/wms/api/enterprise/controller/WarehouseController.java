...
public class WarehouseController {
	...
	public ResponseEntity<?> getWarehouse(@PathVariable String warehouseId, 
    	...
    	Warehouse warehouse = warehouseService.getWarehouse (warehouseId, companyId, plantId, languageId);
	...
	@ApiOperation(response = Warehouse.class, value = "Update Warehouse V3")
	@PatchMapping("/v3/{warehouseId}")
	public ResponseEntity<?> patchWarehouse(@PathVariable String warehouseId, @RequestParam String companyId, @RequestParam String plantId,
											@RequestParam String languageId, @Valid @RequestBody UpdateWarehouse updateWarehouse,
											@RequestParam String loginUserID) throws Exception {
		Warehouse updatedWarehouse = warehouseService.updateWarehouse(companyId, plantId, languageId, warehouseId, updateWarehouse, loginUserID);
		return new ResponseEntity<>(updatedWarehouse, HttpStatus.OK);
	}
