 ...
 */
@Table(
		name = "tbloutboundordertypeid",
		uniqueConstraints = { 
				@UniqueConstraint (
						name = "unique_key_outboundordertypeid",
						columnNames = {"C_ID", "PLANT_ID", "WH_ID", "OB_ORD_TYP_ID", "LANG_ID"})
				}
		)
@IdClass(OutboundOrderTypeIdCompositeKey.class)
public class OutboundOrderTypeId {
	...
	@Id
	@Column(name = "OB_ORD_TYP_ID", columnDefinition = "nvarchar(10)")
	...
	@Column(name = "OB_ORD_TYP", columnDefinition = "nvarchar(50)")
