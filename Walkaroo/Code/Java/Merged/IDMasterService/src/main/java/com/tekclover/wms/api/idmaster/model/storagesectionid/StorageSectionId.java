...
@NoArgsConstructor
/*
 * `C_ID`, `PLANT_ID`, `WH_ID`, `FL_ID`, `ST_SEC_ID`,  `LANG_ID`
 */
@Table(
		name = "tblstoragesectionid", 
		uniqueConstraints = { 
				@UniqueConstraint (
						name = "unique_key_storagesectionid", 
						columnNames = {"C_ID", "PLANT_ID", "WH_ID", "FL_ID", "ST_SEC_ID", "LANG_ID"})
				}
		)
@IdClass(StorageSectionIdCompositeKey.class)
public class StorageSectionId { 
	...
	@Column(name = "ST_SEC",columnDefinition = "nvarchar(50)")
	private String storageSection;
	
	@Column(name = "ST_SEC_TEXT",columnDefinition = "nvarchar(500)")
