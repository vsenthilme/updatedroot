...
//					List<WarehouseEnterprise> optWarehouse = warehouseRepository.findByZone(version);
					List<Warehouse> optWarehouse = warehouseRepository.findByCompanyIdAndPlantIdAndLanguageIdAndWarehouseIdAndZoneAndDeletionIndicator(
	...
	public UserManagement createUserManagement (AddUserManagement newUserManagement, String loginUserID)
		...
		if (duplicateCheck != null) {
			...
			com.tekclover.wms.api.idmaster.model.warehouseid.Warehouse dbWarehouse=warehouseService.getWarehouse(newUserManagement.getWarehouseId(), newUserManagement.getCompanyCode(), newUserManagement.getPlantId(), newUserManagement.getLanguageId());
