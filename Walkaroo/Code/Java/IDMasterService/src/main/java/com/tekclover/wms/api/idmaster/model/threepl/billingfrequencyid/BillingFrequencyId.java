 ...
 */
@Table(
        name = "tblbillingfrequencyid",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "unique_key_billingfrequencyid",
                        columnNames = {"LANG_ID", "C_ID", "PLANT_ID", "WH_ID","BILL_FREQ_ID"})
        }
)
@IdClass(BillingFrequencyIdCompositeKey.class)
public class BillingFrequencyId {
    @Id
    ...
    @Column(name="BILL_FREQ_TEXT",columnDefinition = "nvarchar(200)")
    private String description;
    @Column(name="STATUS_ID")
    private Long statusId;

    @Column(name="DAY_BILL_GEN",columnDefinition = "nvarchar(50)")
    private String dayForBillGeneration;

    @Column(name="DATE_BILL_GEN",columnDefinition = "nvarchar(50)")
