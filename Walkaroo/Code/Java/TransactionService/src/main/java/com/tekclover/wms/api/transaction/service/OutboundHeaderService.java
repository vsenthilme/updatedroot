...
//        });
    ...
    public OutboundHeaderV2 updateOutboundHeaderV2(String companyCodeId, String plantId, String languageId, String warehouseId,
            ...
            throws IllegalAccessException, InvocationTargetException, java.text.ParseException {
        OutboundHeaderV2 dbOutboundHeader = 
        		getOutboundHeaderForUpdateV2(companyCodeId, plantId, languageId, warehouseId, preOutboundNo, refDocNumber, partnerCode);
        ...
        if (dbOutboundHeader != null) {
            BeanUtils.copyProperties(updateOutboundHeader, dbOutboundHeader, CommonUtils.getNullPropertyNames(updateOutboundHeader));
            dbOutboundHeader.setDeliveryOrderNo(updateOutboundHeader.getDeliveryOrderNo());
     ...
     * @throws Exception
     */
    public void updateOutboundHeaderV4(String companyCodeId, String plantId, String languageId, String warehouseId,
                                       String preOutboundNo, String refDocNumber, String deliveryOrderNo) throws Exception {
        try {
            outboundHeaderV2Repository.updateOutboundHeaderV3(companyCodeId, plantId, languageId, warehouseId, preOutboundNo, refDocNumber, deliveryOrderNo);
        } catch (Exception e) {
     ...
     * @return
     */
    public OutboundHeaderV2 getOutboundHeaderV3(String refDocNumber) {
        OutboundHeaderV2 outboundHeader = outboundHeaderV2Repository.findByRefDocNumberAndDeletionIndicator(refDocNumber, 0L);
        return outboundHeader;
    }
}