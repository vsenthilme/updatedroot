...
//                inventory.setInventoryId(Long.valueOf(System.currentTimeMillis() + "" + 8));
     ...
     * @return
     */
    public String getProposedStorageBin(String companyCode, String plantId, String languageId, String warehouseId,
                                        String itemCode, String manufacturerName, String article, String gender, String location) {
        try {
            log.info("GetProposedBin:---> " + companyCode + "|" + plantId + "|" + languageId + "|" + warehouseId + "|" + itemCode + "|" + manufacturerName + "|" + article + "|" + gender+ "|" + location);

            String putAwayHeaderStrategyBin = storageBinV2Repository.getPutAwayStrategyStorageBinV3(companyCode, plantId, languageId, warehouseId, location, gender, article);
//            String putAwayHeaderStrategyBin = storageBinV2Repository.getPutAwayStrategyStorageBinV3(companyCode, plantId, languageId, warehouseId, article);
            log.info("MasterPutAwayHeaderStrategyBin : " + putAwayHeaderStrategyBin);
            if(putAwayHeaderStrategyBin != null) {
            ...
            if(putAwayHeader != null) {
                ...
                return putAwayHeader.getProposedStorageBin();
            }

            String emptyBin = storageBinV2Repository.getStorageBinV3(companyCode, plantId, languageId, warehouseId, 1L, 0L);
            log.info("Proposed EmptyBin: " + emptyBin);
            if(emptyBin != null) {
                return emptyBin;
            }

            StorageBinV2 reserveBin = storageBinService.getStorageBinByBinClassIdV2(warehouseId, RESERVE_BIN_CLASS_ID, companyCode, plantId, languageId);
            log.info("Proposed ReserveBin: " + reserveBin);
            if(reserveBin != null) {
                log.info("Proposed ReserveBin-Bin: " + reserveBin.getStorageBin());
                return reserveBin.getStorageBin();
            }
