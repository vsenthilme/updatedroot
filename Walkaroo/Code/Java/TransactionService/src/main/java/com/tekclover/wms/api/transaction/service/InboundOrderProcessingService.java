...
public class InboundOrderProcessingService extends BaseService {
    ...
    public synchronized InboundHeaderV2 processInboundReceivedV3(String refDocNumber, InboundIntegrationHeader inboundIntegrationHeader) throws Exception {
        ...
        try {
            ...
            GrHeaderV2 createGrHeader = createGrHeaderV2(stagingHeader, caseCode, grNumber, 17L, statusDescription);
...
//            grHeaderV2Repository.saveAndFlush(createGrHeader);
            ...
            List<StagingLineEntityV2> stagingLines = createStagingLines(stagingNo, caseCode, 17L, statusDescription, overallCreatedPreInboundLineList);
