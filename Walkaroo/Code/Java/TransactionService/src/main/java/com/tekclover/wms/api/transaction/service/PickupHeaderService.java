...
public class PickupHeaderService {
     ...
     * @return
     */
    public boolean getPickupHeaderV3(String companyCodeId, String plantId, String languageId, String warehouseId,
                                     String refDocNumber, String pickupNumber, String barcodeId) {
        log.info("pickupHeaderStatusUpdateValidation : " + companyCodeId + "|" + plantId + "|" + languageId + "|" + warehouseId + "|" + refDocNumber + "|" + pickupNumber + "|" + barcodeId);
        return pickupHeaderV2Repository
                .existsByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndRefDocNumberAndPickupNumberAndBarcodeIdAndStatusIdAndDeletionIndicator(
                        companyCodeId, plantId, languageId, warehouseId, refDocNumber, pickupNumber, barcodeId, 57L, 0L);
    }
     ...
     */
    public void updatePickupHeaderV3(String companyCodeId, String plantId, String languageId, String warehouseId,
                                     String refDocNumber, String pickupNumber, String barcodeId, Long statusId, String statusDescription) {
        log.info("pickupHeaderStatusUpdate : " + companyCodeId + "|" + plantId + "|" + languageId + "|" + warehouseId + "|" + refDocNumber + "|" + pickupNumber + "|" + barcodeId);
        pickupHeaderV2Repository.updateHeaderStatus(companyCodeId, plantId, languageId, warehouseId, refDocNumber, statusId, statusDescription, pickupNumber, barcodeId);
    }
...
//    }
    ...
    public PickupHeaderV2 getPickupHeaderV3(String companyCodeId, String plantId, String languageId,
        ...
        return pickupHeaderV2Repository.findTopByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndPreOutboundNoAndCustomerIdAndDeletionIndicatorOrderByPickupCreatedOnDesc(
     ...
     * @return
     */
    public List<PickupHeaderV2> getPickupHeadersV3(String companyCodeId, String plantId, String languageId,
                                                   String warehouseId, String preOutboundNo, String customerId) {
        return pickupHeaderV2Repository.findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndPreOutboundNoAndCustomerIdAndDeletionIndicator(
                companyCodeId, plantId, languageId, warehouseId, preOutboundNo, customerId, 0L);
    }
    ...
    public List<PickupHeaderV2> getPickupHeadersV3(String companyCodeId, String plantId, String languageId,
        ...
        return pickupHeaderV2Repository.findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndRefDocNumberAndStatusIdAndDeletionIndicator(
                companyCodeId, plantId, languageId, warehouseId, refDocNumber,59L, 0L);
    }
     ...
     * @return
     */
    public List<PickupHeaderV2> getPickupHeaderByItemCodeV3(String companyCodeId, String plantId, String languageId,
                                                            String warehouseId, String preOutboundNo, String itemCode) {
        return pickupHeaderV2Repository.findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndPreOutboundNoAndItemCodeAndDeletionIndicator(
                companyCodeId, plantId, languageId, warehouseId, preOutboundNo, itemCode, 0L);
    }
     ...
     */
    public List<PickupHeaderV2> getPickupHeaderByItemCodeV3(String companyCodeId, String plantId, String languageId,
                                                            String warehouseId, String refDocNumber, String preOutboundNo, String itemCode) {
        return pickupHeaderV2Repository.findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndPreOutboundNoAndRefDocNumberAndItemCodeAndDeletionIndicator(
                companyCodeId, plantId, languageId, warehouseId, preOutboundNo, refDocNumber, itemCode, 0L);
    }
     ...
     */
    public PickupHeaderV2 getPickupHeaderV3(String companyCodeId, String plantId, String languageId, String warehouseId,
                                            String preOutboundNo, String customerId, String barcodeId, String itemCode) {
        return pickupHeaderV2Repository.findTopByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndPreOutboundNoAndCustomerIdAndItemCodeAndBarcodeIdAndDeletionIndicatorOrderByPickupCreatedOnDesc(
                        companyCodeId, plantId, languageId, warehouseId, preOutboundNo, customerId, itemCode, barcodeId, 0L);
    }
     ...
     * @return
     */
    public PickupHeaderV2 getPickupHeaderForPickUpLineV3(String companyCodeId, String plantId, String languageId, String warehouseId,
                                                         String preOutboundNo, String refDocNumber, String customerId, String barcodeId, String itemCode) {
        return pickupHeaderV2Repository.findTopByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndPreOutboundNoAndRefDocNumberAndCustomerIdAndItemCodeAndBarcodeIdAndDeletionIndicatorOrderByPickupCreatedOnDesc(
                companyCodeId, plantId, languageId, warehouseId, preOutboundNo, refDocNumber, customerId, itemCode, barcodeId, 0L);
    }
     ...
     * @return
     */
    public boolean getPickupHeaderCountForDeliveryConfirmationV3(String companyCodeId, String plantId, String languageId,
                                                                 String warehouseId, String refDocNumber, String preOutboundNo, Long statusId) {
        return pickupHeaderV2Repository.existsByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndRefDocNumberAndPreOutboundNoAndStatusIdAndDeletionIndicator(
                companyCodeId, plantId, languageId, warehouseId, refDocNumber, preOutboundNo, statusId, 0L);
    }
     ...
     * @return
     */
    public List<PickupHeaderV2> getPickupHeaderForDeliveryConfirmationV3(String companyCodeId, String plantId, String languageId,
                                                                         String warehouseId, String refDocNumber, String preOutboundNo, Long statusId) {
