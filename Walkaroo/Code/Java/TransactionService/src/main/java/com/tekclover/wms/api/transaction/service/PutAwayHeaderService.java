...
//                grLine.getWarehouseId(), grLine.getItemCode(), 1L);
    ...
    public PutAwayHeaderV2 getPutAwayHeaderV3(String companyCodeId, String plantId, String warehouseId, String languageId,
                                              String putAwayNumber, String preInboundNo, String barcodeId, String lineNumber) {
        if(lineNumber != null) {
        return putAwayHeaderV2Repository.findByCompanyCodeIdAndPlantIdAndWarehouseIdAndLanguageIdAndPutAwayNumberAndPreInboundNoAndBarcodeIdAndReferenceField9AndDeletionIndicator(
                companyCodeId, plantId, warehouseId, languageId, putAwayNumber, preInboundNo, barcodeId, lineNumber, 0L);
        } else {
            return putAwayHeaderV2Repository.findByCompanyCodeIdAndPlantIdAndWarehouseIdAndLanguageIdAndPutAwayNumberAndPreInboundNoAndBarcodeIdAndDeletionIndicator(
