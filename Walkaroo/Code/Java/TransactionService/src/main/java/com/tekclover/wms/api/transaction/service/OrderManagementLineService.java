...
//=====================================================================V2===================================================================================
     ...
     */
    public List<OrderManagementLineV2> getOrderManagementLineV2(String companyCodeId, String plantId, String languageId, String warehouseId,
                                                                String refDocNumber, String preOutboundNo, Long lineNumber, String itemCode, String barcodeId) {
        return orderManagementLineV2Repository
                .findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndRefDocNumberAndPreOutboundNoAndLineNumberAndItemCodeAndBarcodeIdAndDeletionIndicator(
                        companyCodeId, plantId, languageId, warehouseId, refDocNumber, preOutboundNo, lineNumber, itemCode, barcodeId, 0L);
    }
...
//            }
     ...
     * @throws java.text.ParseException
     */
	public OrderManagementLineV2 updateAllocationV3(OrderManagementLineV2 orderManagementLine, Long binClassId,
			Double ORD_QTY, String warehouseId, String itemCode, String loginUserID) throws java.text.ParseException {
		// Inventory Strategy Choices
		String INV_STRATEGY = propertiesConfig.getOrderAllocationStrategyCoice();
		log.info("Allocation Strategy: " + INV_STRATEGY);
		...
		int invQtyByLevelIdCount = 0;
		int invQtyGroupByLevelIdCount = 0;
		List<IInventoryImpl> stockType1InventoryList = inventoryService.getInventoryForOrderManagementV2(
				orderManagementLine.getCompanyCodeId(), orderManagementLine.getPlantId(),
				orderManagementLine.getLanguageId(), warehouseId, itemCode, 1L, binClassId,
				orderManagementLine.getManufacturerName());
		log.info("---updateAllocation---stockType1InventoryList-------> : " + stockType1InventoryList.size());
		if (stockType1InventoryList.isEmpty()) {
			return updateOrderManagementLineV2(orderManagementLine);
		...
		if (INV_STRATEGY.equalsIgnoreCase("SB_CTD_ON")) { // SB_CTD_ON
			log.info("SB_CTD_ON");
			finalInventoryList = inventoryService.getInventoryForOrderManagementOrderByCtdOnV3(
					orderManagementLine.getCompanyCodeId(), orderManagementLine.getPlantId(),
					orderManagementLine.getLanguageId(), warehouseId, itemCode, 1L, binClassId,
					orderManagementLine.getManufacturerName(), orderManagementLine.getBarcodeId());
			log.info("---------SB_CTD_ON------finalInventoryList----> : " + finalInventoryList);	
		}

		if (INV_STRATEGY.equalsIgnoreCase("SB_LEVEL_ID")) { // SB_LEVEL_ID
			log.info("SB_LEVEL_ID");
			finalInventoryList = inventoryService.getInventoryForOrderManagementOrderByLevelIdV2(
					orderManagementLine.getCompanyCodeId(), orderManagementLine.getPlantId(),
					orderManagementLine.getLanguageId(), warehouseId, itemCode, 1L, binClassId,
					orderManagementLine.getManufacturerName());
		}
		...
		if (INV_STRATEGY.equalsIgnoreCase("SB_BEST_FIT")) { // SB_BEST_FIT
			log.info("SB_BEST_FIT");
			List<IInventory> levelIdList = inventoryService.getInventoryForOrderManagementGroupByLevelIdV2(
					orderManagementLine.getCompanyCodeId(), orderManagementLine.getPlantId(),
					orderManagementLine.getLanguageId(), warehouseId, itemCode, 1L, binClassId,
					orderManagementLine.getManufacturerName());
			log.info("Group By LeveId: " + levelIdList.size());
			...
			for (IInventory iInventory : levelIdList) {
				...
				if (ORD_QTY <= iInventory.getInventoryQty()) {
					// For Walkaroo - V3
					finalInventoryList = inventoryService.getInventoryForOrderManagementGroupByBarcodedIdV3(
							orderManagementLine.getCompanyCodeId(), orderManagementLine.getPlantId(),
							orderManagementLine.getLanguageId(), warehouseId, itemCode, 1L, binClassId,
							iInventory.getLevelId(), orderManagementLine.getManufacturerName(), orderManagementLine.getBarcodeId());					log.info("Group By LeveId Inventory: " + finalInventoryList.size());

					if (finalInventoryList != null && finalInventoryList.isEmpty()) {
						return updateOrderManagementLineV2(orderManagementLine);
					}
					outerloop1: for (IInventoryImpl stBinInventory : finalInventoryList) {
						Long STATUS_ID = 0L;
						Double ALLOC_QTY = 0D;
						...
						OrderManagementLineV2 createdOrderManagementLine = orderManagementLineV2Repository
								.save(newOrderManagementLine);
						log.info("--else---createdOrderManagementLine newly created------: "
								+ createdOrderManagementLine);
						allocatedQtyFromOrderMgmt = createdOrderManagementLine.getAllocatedQty();
			...
			invQtyByLevelIdCount = levelIdList.size();
			invQtyGroupByLevelIdCount = invQtyByLevelIdList.size();
			log.info("invQtyByLevelIdCount, invQtyGroupByLevelIdCount" + invQtyByLevelIdCount + ", "
					+ invQtyGroupByLevelIdCount);
			if (invQtyByLevelIdCount != invQtyGroupByLevelIdCount) {
				log.info("newOrderManagementLine updated ---#--->" + newOrderManagementLine);
				return newOrderManagementLine;
			}
		...
		if (finalInventoryList != null && !finalInventoryList.isEmpty()) {
			...
			imBasicData.setItemCode(itemCode);
			imBasicData.setManufacturerName(orderManagementLine.getManufacturerName());
			dbImBasicData1 = mastersService.getImBasicData1ByItemCodeV2(imBasicData,
		...
		outerloop: for (IInventoryImpl stBinInventory : finalInventoryList) {
			// Getting PackBarCode by passing ST_BIN to Inventory
			Long STATUS_ID = 0L;
			Double ALLOC_QTY = 0D;
			 ...
			 * update prop_st_bin and Pack_bar_codes columns
			 */
			OrderManagementLineV2 newOrderManagementLine1 = new OrderManagementLineV2();
			BeanUtils.copyProperties(orderManagementLine, newOrderManagementLine1,
					CommonUtils.getNullPropertyNames(orderManagementLine));
			...
			newOrderManagementLine1.setCompanyDescription(description.getCompanyDesc());
			newOrderManagementLine1.setPlantDescription(description.getPlantDesc());
			newOrderManagementLine1.setWarehouseDescription(description.getWarehouseDesc());

			newOrderManagementLine1.setProposedStorageBin(stBinInventory.getStorageBin());
			if (stBinInventory.getBarcodeId() != null) {
				newOrderManagementLine1.setBarcodeId(stBinInventory.getBarcodeId());
			}
			if (stBinInventory.getLevelId() != null) {
				newOrderManagementLine1.setLevelId(stBinInventory.getLevelId());
			}
			newOrderManagementLine1.setProposedPackBarCode(stBinInventory.getPackBarcodes());
			newOrderManagementLine1.setBarcodeId(stBinInventory.getBarcodeId());
			
			log.info("--before----create----createdOrderManagementLine------: " + newOrderManagementLine1);
			
			OrderManagementLineV2 createdOrderManagementLine = orderManagementLineV2Repository.save(newOrderManagementLine1);
			log.info("--else---createdOrderManagementLine newly created------: " + createdOrderManagementLine);
			allocatedQtyFromOrderMgmt = createdOrderManagementLine.getAllocatedQty();
			...
			if (allocatedQtyFromOrderMgmt > 0) {
				// Update Inventory table
				InventoryV2 inventoryForUpdate = inventoryService.getInventoryForAllocationV3(
						orderManagementLine.getCompanyCodeId(), orderManagementLine.getPlantId(),
						orderManagementLine.getLanguageId(), warehouseId, stBinInventory.getPackBarcodes(), itemCode,
						orderManagementLine.getManufacturerName(), stBinInventory.getStorageBin(), createdOrderManagementLine.getBarcodeId());
     ...
     * @return
     */
    public List<OrderManagementLineV2> getOrderManagementLineV3(String companyCodeId, String plantId, String languageId,
                                                                String warehouseId, String preOutboundNo) {
        List<OrderManagementLineV2> orderManagementHeader = orderManagementLineV2Repository
                .findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndPreOutboundNoAndDeletionIndicator(
     ...
     * @return
     */
    public List<OrderManagementLineV2> getOrderManagementLinesV3(String companyCodeId, String plantId, String languageId, String warehouseId,
                                                                String preOutboundNo, Long lineNumber, String itemCode) {
        return orderManagementLineV2Repository.findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndPreOutboundNoAndLineNumberAndItemCodeAndDeletionIndicator(
                companyCodeId, plantId, languageId, warehouseId, preOutboundNo, lineNumber, itemCode, 0L);
    }
     ...
     * @return
     */
    public OrderManagementLineV2 getOrderManagementLineV3(String companyCodeId, String plantId, String languageId, String warehouseId,
                                                          String preOutboundNo, String refDocNumber, Long lineNumber, String itemCode, String barcodeId) {
        log.info("1.omlGet: " + companyCodeId + "|" + plantId + "|" + languageId + "|" + warehouseId + "|" + refDocNumber + "|" + lineNumber + "|" + itemCode + "|" + barcodeId);
        return orderManagementLineV2Repository.findTopByPlantIdAndCompanyCodeIdAndLanguageIdAndWarehouseIdAndPreOutboundNoAndRefDocNumberAndLineNumberAndItemCodeAndBarcodeIdAndDeletionIndicator(
                plantId, companyCodeId, languageId, warehouseId, preOutboundNo, refDocNumber, lineNumber, itemCode, barcodeId, 0L);
    }
     ...
     */
    public OrderManagementLineV2 getOrderManagementLineV3(String companyCodeId, String plantId, String languageId, String warehouseId,
                                                          String refDocNumber, Long lineNumber, String itemCode) {
        log.info("2.omlGet: " + companyCodeId + "|" + plantId + "|" + languageId + "|" + warehouseId + "|" + refDocNumber + "|" + lineNumber + "|" + itemCode);
        return orderManagementLineV2Repository.findTopByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndRefDocNumberAndLineNumberAndItemCodeAndDeletionIndicator(
     ...
     * @return
     */
    public OrderManagementLineV2 getOrderManagementLineV3(String companyCodeId, String plantId, String languageId,
                                                          String warehouseId, String refDocNumber, String barcodeId) {
        List<Long> statusIds = Arrays.asList(22L, 47L);
        return orderManagementLineV2Repository.findTopByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndRefDocNumberAndBarcodeIdAndStatusIdNotInAndDeletionIndicator(
                companyCodeId, plantId, languageId, warehouseId, refDocNumber, barcodeId, statusIds, 0L);
    }
     ...
     * @return
     */
    public List<OrderManagementLineV2> getOrderManagementLinesV3(String companyCodeId, String plantId, String languageId,
                                                                 String warehouseId, String refDocNumber, String itemCode, Long lineNumber) {
        List<Long> statusIds = Arrays.asList(22L, 47L);
        return orderManagementLineV2Repository.findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndRefDocNumberAndItemCodeAndLineNumberAndStatusIdNotInAndDeletionIndicator(
                companyCodeId, plantId, languageId, warehouseId, refDocNumber, itemCode, lineNumber, statusIds, 0L);
    }
     ...
     */
//    public List<OrderManagementLineV2> getOrderManagementLinesV3(String companyCodeId, String plantId, String languageId, String warehouseId,
//                                                                 String refDocNumber, String customerId) {
//        log.info(companyCodeId + "|" + plantId + "|" + languageId + "|" + warehouseId + "|" + refDocNumber + "|" + customerId);
//        return orderManagementLineV2Repository.findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndRefDocNumberAndCustomerIdAndStatusIdNotAndDeletionIndicator(
//                companyCodeId, plantId, languageId, warehouseId, refDocNumber, customerId, 47L, 0L);
//    }
     ...
     */
    public List<OrderManagementLineV2> getOrderManagementLinesV3(String companyCodeId, String plantId, String languageId, String warehouseId,
                                                                 String salesOrderNumber, String customerId) {
        log.info(companyCodeId + "|" + plantId + "|" + languageId + "|" + warehouseId + "|" + salesOrderNumber + "|" + customerId);
        return orderManagementLineV2Repository.findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndSalesOrderNumberAndCustomerIdAndStatusIdNotAndDeletionIndicator(
                companyCodeId, plantId, languageId, warehouseId, salesOrderNumber, customerId, 47L, 0L);
    }
     ...
     * @return
     */
    public List<OrderManagementLineV2> getOrderManagementLinesShipToPartyV3(String companyCodeId, String plantId, String languageId, String warehouseId,
     ...
     * @return
     */
    public boolean isOrderManagementLineExistV3(String companyCodeId, String plantId, String languageId, String warehouseId,
                                                String itemCode, String refDocNumber, Long lineNumber) {
        log.info(companyCodeId + "|" + plantId + "|" + languageId + "|" + warehouseId + "|" + itemCode + "|" + refDocNumber + "|" + lineNumber);
        return orderManagementLineV2Repository.existsByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndRefDocNumberAndLineNumberAndItemCodeAndStatusIdAndDeletionIndicator(
                companyCodeId, plantId, languageId, warehouseId, refDocNumber, lineNumber, itemCode, 47L, 0L);
    }
...
//            ImBasicData1V2 dbImBasicData1 = imBasicData1V2Repository.findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndManufacturerPartNoAndDeletionIndicator(
//                    orderManagementLine.getLanguageId(), orderManagementLine.getCompanyCodeId(), orderManagementLine.getPlantId(), orderManagementLine.getWarehouseId(), itemCode, manufacturerName, 0L);
//            log.info("ImBasicData1: " + dbImBasicData1);
//            if (dbImBasicData1 != null) {
//                if (dbImBasicData1.getShelfLifeIndicator() != null) {
//                    shelfLifeIndicator = dbImBasicData1.getShelfLifeIndicator();
...
//            log.info("shelfLifeIndicator: " + shelfLifeIndicator);
            ...
            int invQtyGroupByLevelIdCount = 0;
//            List<IInventoryImpl> stockType1InventoryList =
//                    inventoryService.getInventoryForOrderManagementV3(companyCodeId, plantId, languageId, warehouseId, itemCode, manufacturerName, stockTypeId, binClassId);
//            log.info("---WK--updateAllocation---stockType1InventoryList-------> : " + stockType1InventoryList.size());
//
...
//                    newOrderManagementLine.setPriceSegment(stBinInventory.getPriceSegment());
     ...
     * @throws Exception
     */
    public OrderManagementLineV2 doAllocationV3(String companyCodeId, String plantId, String languageId, String warehouseId,
                                                String preOutboundNo, String refDocNumber, String partnerCode, Long lineNumber,
                                                String itemCode, String loginUserID) throws Exception {
        try {
            List<OrderManagementLineV2> dbOrderManagementLines = getOrderManagementLineV2(companyCodeId, plantId, languageId, warehouseId, preOutboundNo, refDocNumber, partnerCode, lineNumber, itemCode);
            log.info("Processing Order management Line : " + dbOrderManagementLines);
            ...
            if (dbOrderManagementLines != null && !dbOrderManagementLines.isEmpty()) {
                ...
                for (int i = 1; i < dbOrderManagementLines.size(); i++) {
                    OrderManagementLineV2 orderManagementLineToDelete = dbOrderManagementLines.get(i);
                    deleteOrderManagementLineV2(companyCodeId, plantId, languageId, warehouseId,
                            preOutboundNo, refDocNumber, orderManagementLineToDelete.getPartnerCode(), orderManagementLineToDelete.getLineNumber(),
                            itemCode, orderManagementLineToDelete.getProposedStorageBin(), orderManagementLineToDelete.getProposedPackBarCode(), loginUserID);
                    log.info("Deleted the other orderManagementLine : " + orderManagementLineToDelete);
                }
            }
            ...
            log.error("Exception while doAllocation V3: " + e);
            throw e;
        }
    }
     ...
     * @throws Exception
     */
    public List<OrderManagementLineV2> doAllocationV3(List<OrderManagementLineV2> orderManagementLineV2s, String loginUserID) throws Exception {
        ...
        try {
            ...
            log.error("Exception while doAllocation V3 [Batch]: " + e);
            throw e;
        }
    }
     ...
     */
    @Transactional
    public List<OrderManagementLineV2> doUnAllocationV3(List<OrderManagementLineV2> orderManagementLineV2, String loginUserID) throws Exception {

        try {
            List<OrderManagementLineV2> orderManagementLineV2s = new ArrayList<>();

            for (OrderManagementLineV2 lineV2 : orderManagementLineV2) {
                if (lineV2.getStatusId() != 47) {
                    List<OrderManagementLineV2> orderManagementLineV2List = getOrderManagementLineV2(lineV2.getCompanyCodeId(), lineV2.getPlantId(), lineV2.getLanguageId(), lineV2.getWarehouseId(), lineV2.getPreOutboundNo(),
                            lineV2.getRefDocNumber(), lineV2.getLineNumber(), lineV2.getItemCode(), lineV2.getBarcodeId());
                    log.info("Processing Order management Line : " + orderManagementLineV2List);
                    ...
                    for (OrderManagementLineV2 dbOrderManagementLine : orderManagementLineV2List) {
                        String storageBin = dbOrderManagementLine.getProposedStorageBin();
                        InventoryV2 inventory =
                                inventoryService.getOutboundInventoryV3(lineV2.getCompanyCodeId(), lineV2.getPlantId(), lineV2.getLanguageId(), lineV2.getWarehouseId(),
                        ...
                        if (inventory != null) {
                            ...
                            outboundLineV2Repository.updateOutboundLineUnAllocateStatusV3(dbOrderManagementLine.getCompanyCodeId(), dbOrderManagementLine.getPlantId(), dbOrderManagementLine.getLanguageId(),
            ...
            log.error("Exception while doUnAllocation V3[batch]: " + e);
            throw e;
        }
    }
     ...
     * @return
     */
    public boolean getOrderManagementLineV3(String companyCodeId, String plantId, String languageId, String warehouseId,
                                            String refDocNumber, String preOutboundNo, List<Long> statusId) {
    ...
    public List<OrderManagementLineV2> getOrderManagementLinesV3(String companyCodeId, String plantId, String languageId, String warehouseId,
                                                                 String refDocNumber, String preOutboundNo, List<Long> statusId) {
        return orderManagementLineV2Repository.findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndRefDocNumberAndPreOutboundNoAndStatusIdInAndDeletionIndicator(
                companyCodeId, plantId, languageId, warehouseId, refDocNumber, preOutboundNo, statusId, 0L);
    }
     ...
     * @throws Exception
     */
    public OrderManagementLineV2 doUnAllocationV3(String companyCodeId, String plantId, String languageId, String warehouseId,
                                                  String preOutboundNo, String refDocNumber, String partnerCode, Long lineNumber,
                                                  String itemCode, String proposedStorageBin, String proposedPackBarCode, String loginUserID) throws Exception {
        try {
            List<OrderManagementLineV2> orderManagementLineList = getListOrderManagementLineV2(companyCodeId, plantId, languageId, warehouseId, preOutboundNo, refDocNumber, partnerCode, lineNumber, itemCode);
            ...
            for (OrderManagementLineV2 dbOrderManagementLine : orderManagementLineList) {
                String packBarcodes = dbOrderManagementLine.getProposedPackBarCode();
                String storageBin = dbOrderManagementLine.getProposedStorageBin();
                InventoryV2 inventory = inventoryService.getOutboundInventoryV3(companyCodeId, plantId, languageId, warehouseId,
            ...
            log.error("Exception while doUnAllocation V3: " + e);
            throw e;
        }
    }
}