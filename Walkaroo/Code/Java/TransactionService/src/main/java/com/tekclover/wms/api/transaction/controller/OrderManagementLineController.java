...
//=======================================================V2============================================================================================
    ...
    public ResponseEntity<?> unallocateOrderManagementLineV2(@Valid @RequestBody List<OrderManagementLineV2> orderManagementLineV2, @RequestParam String loginUserID) throws Exception {
        List<OrderManagementLineV2> updatedOrderManagementLine = ordermangementlineService.doUnAllocationV3(orderManagementLineV2, loginUserID);
        return new ResponseEntity<>(updatedOrderManagementLine, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> unallocateOrderManagementLineV2(@RequestParam String warehouseId, @RequestParam String companyCodeId, @RequestParam String plantId,
        ...
        OrderManagementLineV2 updatedOrderManagementLine =
                ordermangementlineService.doUnAllocationV3(companyCodeId, plantId, languageId, warehouseId, preOutboundNo, refDocNumber, partnerCode, lineNumber,
                        itemCode, proposedStorageBin, proposedPackBarCode, loginUserID);
        return new ResponseEntity<>(updatedOrderManagementLine, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> allocateOrderManagementLineV2(@Valid @RequestBody List<OrderManagementLineV2> orderManagementLineV2, @RequestParam String loginUserID) throws Exception {
        List<OrderManagementLineV2> updatedOrderManagementLine = ordermangementlineService.doAllocationV3(orderManagementLineV2, loginUserID);
        return new ResponseEntity<>(updatedOrderManagementLine, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> allocateOrderManagementLineV2(@RequestParam String warehouseId, @RequestParam String companyCodeId, @RequestParam String plantId,
        ...
        OrderManagementLineV2 updatedOrderManagementLine = ordermangementlineService.doAllocationV3(companyCodeId, plantId, languageId, warehouseId, preOutboundNo, refDocNumber, partnerCode, lineNumber, itemCode, loginUserID);
        return new ResponseEntity<>(updatedOrderManagementLine, HttpStatus.OK);
    }
