...
//                    inventoryV2Repository.delete(inventory);
     ...
     * @return
     */
    public InventoryV2 getInventoryV3(String companyCodeId, String plantId, String languageId, String warehouseId, String itemCode, String manufacturerName,
    ...
    public InventoryV2 createInventoryNonCBMV3(PutAwayLineV2 putAwayLine, String loginUserId) throws Exception {
        ...
        try {
            ...
            binClassId3InventoryReduction(companyCode, plantId, languageId, warehouseId, barCodeId, itemCode, manufacturerName, refDocNumber, putAwayLine.getPutawayConfirmedQty(), loginUserId);
...
>>>>>>> 81dc64bb940937a238631ec1ef8d3af347b8ec9e
    ...
    public void binClassId1InventoryReduction(String companyCode, String plantId, String languageId, String warehouseId,
        ...
        if (dbInventory != null) {
            ...
            if(!alreadyExecuted) {
                InventoryV2 createdinventory = inventoryV2Repository.save(inventory);
                log.info("BinClassId 1 created inventory[Existing] - reduced : {}", createdinventory);
