...
//            + "COALESCE(INV_QTY,0)+COALESCE(ALLOC_QTY,0) referenceField4, \n"
    ...
    @Query(value = "select max(inv_id) inventoryId into #inv from tblinventory \n" +
            ...
            "c_id in (:companyCodeId) and is_deleted = 0 \n" +
            "and inv_id in (select inventoryId from #inv) \n" +
            "group by ITM_CODE, BARCODE_ID, MFR_NAME, PACK_BARCODE, STR_NO, INV_UOM, \n" +
            "ST_BIN, BIN_CL_ID, LEVEL_ID, PLANT_ID, WH_ID, LANG_ID, C_ID \n" +
            ") x where inventoryQuantity > 0 ", nativeQuery = true)
    public List<IInventoryImpl> findInventoryForOrderManagementV3(@Param("companyCodeId") String companyCodeId,
                                                                  @Param("plantId") String plantId,
                                                                  @Param("languageId") String languageId,
                                                                  @Param("warehouseId") String warehouseId,
                                                                  @Param("itemCode") String itemCode,
    ...
    public List<IInventoryImpl> getOMLInventoryOrderByCreatedOnV3(@Param("companyCodeId") String companyCodeId,
                                                                  @Param("plantId") String plantId,
                                                                  @Param("languageId") String languageId,
                                                                  @Param("warehouseId") String warehouseId,
                                                                  @Param("barcodeId") String barcodeId,
    ...
    public List<IInventoryImpl> getOMLInventoryOrderByExpiryDateV3(@Param("companyCodeId") String companyCodeId,
                                                                   @Param("plantId") String plantId,
                                                                   @Param("languageId") String languageId,
                                                                   @Param("warehouseId") String warehouseId,
                                                                   @Param("barcodeId") String barcodeId,
    ...
    public List<IInventoryImpl> getOMLInventoryOrderByLevelIdV3(@Param("companyCodeId") String companyCodeId,
                                                                @Param("plantId") String plantId,
                                                                @Param("languageId") String languageId,
                                                                @Param("warehouseId") String warehouseId,
                                                                @Param("barcodeId") String barcodeId,
    ...
    @Query(value = "select max(inv_id) inventoryId into #inv from tblinventory \n" +
            ...
            + "HAVING SUM(INV_QTY) > 0 \r\n"
            + "ORDER BY SUM(INV_QTY)", nativeQuery = true)
    public List<IInventory> findInventoryByBatchV3(@Param("companyCodeId") String companyCodeId,
                                                   @Param("plantId") String plantId,
                                                   @Param("languageId") String languageId,
                                                   @Param("warehouseId") String warehouseId,
                                                   @Param("binClassId") Long binClassId,
    ...
    @Query(value = "select max(inv_id) inventoryId into #inv from tblinventory \n" +
            ...
            "(COALESCE(:binClassId, null) IS NULL OR (iv.BIN_CL_ID IN (:binClassId))) and\n" +
            "(COALESCE(:stockTypeId, null) IS NULL OR (iv.STCK_TYP_ID IN (:stockTypeId))) and \n" +
            "iv.is_deleted = 0 and (iv.INV_QTY > 0) order by iv.STR_NO, iv.BARCODE_ID, iv.INV_QTY, iv.ST_SEC_ID, iv.REF_FIELD_10 \n", nativeQuery = true)
    public List<IInventoryImpl> getOMLInventoryOrderByBatchV3(@Param("companyCodeId") String companyCodeId,
                                                              @Param("plantId") String plantId,
                                                              @Param("languageId") String languageId,
                                                              @Param("warehouseId") String warehouseId,
                                                              @Param("barcodeId") String barcodeId,
    ...
    @Query(value = "select max(inv_id) inventoryId into #inv from tblinventory \n" +
            ...
            + "HAVING SUM(INV_QTY) > 0 \r\n"
            + "ORDER BY SUM(INV_QTY)", nativeQuery = true)
    public List<IInventory> findInventoryGroupByLevelIdV3(@Param("companyCodeId") String companyCodeId,
                                                          @Param("plantId") String plantId,
                                                          @Param("languageId") String languageId,
                                                          @Param("warehouseId") String warehouseId,
                                                          @Param("itemCode") String itemCode,
    ...
    public List<IInventoryImpl> getOMLInventoryLevelIdV3(@Param("companyCodeId") String companyCodeId,
                                                         @Param("plantId") String plantId,
                                                         @Param("languageId") String languageId,
                                                         @Param("warehouseId") String warehouseId,
                                                         @Param("barcodeId") String barcodeId,
    ...
    @Query(value = "select max(inv_id) inventoryId into #inv from tblinventory \n" +
            ...
            "(COALESCE(:itemCode, null) IS NULL OR (iv.ITM_CODE IN (:itemCode))) and \n" +
            "(COALESCE(:storageBin, null) IS NULL OR (iv.ST_BIN IN (:storageBin))) and\n" +
            "iv.is_deleted = 0  and iv.stck_typ_id = 1 and (iv.REF_FIELD_4 > 0) order by iv.BARCODE_ID,iv.ST_SEC_ID,iv.REF_FIELD_10 \n", nativeQuery = true)
    public IInventoryImpl getPickupLineInventoryV3(@Param("companyCodeId") String companyCodeId,
                                                   @Param("plantId") String plantId,
                                                   @Param("languageId") String languageId,
                                                   @Param("warehouseId") String warehouseId,
                                                   @Param("barcodeId") String barcodeId,
    ...
    public IInventoryImpl getOutboundInventoryV3(@Param("companyCodeId") String companyCodeId,
                                                 @Param("plantId") String plantId,
                                                 @Param("languageId") String languageId,
                                                 @Param("warehouseId") String warehouseId,
                                                 @Param("barcodeId") String barcodeId,
    ...
    @Query(value = "select max(inv_id) inventoryId into #inv from tblinventory \n" +
            ...
            "(COALESCE(:itemCode, null) IS NULL OR (iv.ITM_CODE IN (:itemCode))) and \n" +
            "(COALESCE(:storageBin, null) IS NULL OR (iv.ST_BIN IN (:storageBin))) and\n" +
            "iv.is_deleted = 0  and iv.stck_typ_id = 1 order by iv.BARCODE_ID \n", nativeQuery = true)
    public IInventoryImpl getOutboundReversalInventoryV3(@Param("companyCodeId") String companyCodeId,
                                                         @Param("plantId") String plantId,
                                                         @Param("languageId") String languageId,
                                                         @Param("warehouseId") String warehouseId,
                                                         @Param("barcodeId") String barcodeId,
    ...
    public Double getInventoryBinStatusV3(@Param("companyCodeId") String companyCodeId,
                                          @Param("plantId") String plantId,
                                          @Param("languageId") String languageId,
                                          @Param("warehouseId") String warehouseId,
                                          @Param("storageBin") String storageBin);
    ...
    @Query(value = "select max(inv_id) inventoryId into #inv from tblinventory \n" +
            ...
            "iv.ITM_CODE itemCode,\n" +
            "iv.TEXT description,\n" +
            "sum(iv.INV_QTY) inventoryQuantity,\n" +
            "sum(iv.ALLOC_QTY) allocatedQuantity,\n" +
            "sum(iv.REF_FIELD_4) referenceField4,\n" +
            "iv.REF_FIELD_9 referenceField9,\n" +
            "iv.MFR_NAME manufacturerName \n" +
            "from tblinventory iv\n" +
            "where \n" +
            ...
            "(COALESCE(:noPairs, null) IS NULL OR (iv.NO_PAIRS IN (:noPairs))) and \n" +
            "iv.is_deleted = 0 and (iv.REF_FIELD_4 > 0) \n" +
            "group by itm_code, text, mfr_name, ref_field_9, pack_barcode, plant_id, wh_id, c_id, lang_id ", nativeQuery = true)
    public List<IInventoryImpl> findInventoryV3(@Param("companyCodeId") List<String> companyCodeId,
                                                 @Param("languageId") List<String> languageId,
                                                 @Param("plantId") List<String> plantId,
                                                 @Param("warehouseId") List<String> warehouseId,
                                                 @Param("referenceDocumentNo") List<String> referenceDocumentNo,
    ...
    @Query(value = "SELECT b.barcode_id FROM tblinventory b WHERE b.barcode_id IN :barcodeIds and b.is_deleted = 0 and b.ref_field_4 > 0 group by barcode_id", nativeQuery = true)
    List<String> findBarcodeIdIn(@Param("barcodeIds") List<String> barcodeIds);

    @Query(value = "SELECT b.barcode_id FROM tblinventory b WHERE b.barcode_id = :barcodeId and b.itm_code = :itemCode and b.is_deleted = 0 and b.ref_field_4 > 0 group by barcode_id", nativeQuery = true)
    List<String> findBarcodeId(@Param("barcodeId") String barcodeId,
                               @Param("itemCode") String itemCode);
<<<<<<< HEAD

    boolean existsByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndBarcodeIdAndBinClassIdAndDeletionIndicator(
            String companyCode, String plantId, String languageId, String warehouseId, String barcodeId, Long binClassId, Long deletionIndicator);
    ...
    @Query(value = "select max(inv_id) inventoryId into #inv from tblinventory \n" +
            ...
            "(COALESCE(:warehouseId, null) IS NULL OR (iv.wh_id IN (:warehouseId))) and \n" +
            "(COALESCE(:barcodeId, null) IS NULL OR (iv.barcode_id IN (:barcodeId))) and\n" +
            "iv.is_deleted = 0 and bin_cl_id = 1 \n", nativeQuery = true)
    public Double getDuplicateBarcodeInventoryStatusV3(@Param("companyCodeId") String companyCodeId,
                                                       @Param("plantId") String plantId,
                                                       @Param("languageId") String languageId,
                                                       @Param("warehouseId") String warehouseId,
                                                       @Param("barcodeId") String barcodeId);
