...
public class OutboundLineV2Specification implements Specification<OutboundLineV2> {
    ...
    public Predicate toPredicate(Root<OutboundLineV2> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
        ...
        if (searchOutboundLine.getMaterialNo() != null && !searchOutboundLine.getMaterialNo().isEmpty()) {
            ...
            predicates.add(group.in(searchOutboundLine.getMaterialNo()));
        }
        ...
        if (searchOutboundLine.getPriceSegment() != null && !searchOutboundLine.getPriceSegment().isEmpty()) {
            ...
            predicates.add(group.in(searchOutboundLine.getPriceSegment()));
        }
        ...
        if (searchOutboundLine.getBarcodeId() != null && !searchOutboundLine.getBarcodeId().isEmpty()) {
            ...
            predicates.add(group.in(searchOutboundLine.getBarcodeId()));
        }
