...
function MainComponent_li_18_a_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const i_r8 = ctx_r5.index;
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(4, _c22, ctx_r2.activeLinkIndex === i_r8));
    \u0275\u0275advance();
...
function MainComponent_li_18_a_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const i_r8 = ctx_r5.index;
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(4, _c32, data_r7.routerLink))("ngClass", \u0275\u0275pureFunction1(6, _c22, ctx_r2.activeLinkIndex === i_r8));
    \u0275\u0275advance();
    \u0275\u0275property("src", ctx_r2.isActive(i_r8) ? data_r7.srcDark : data_r7.src, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.collapsed);
...
var routes = [{
  ...
  children: [
    { path: "idMaster", loadChildren: () => import("./chunk-JQZYTEVQ.js").then((m) => m.IdMastersModule) },
    { path: "master", loadChildren: () => import("./chunk-NLADXMHM.js").then((m) => m.MasterModule) },
    { path: "airport", loadChildren: () => import("./chunk-S2YLNFGF.js").then((m) => m.AirportModule) },
    { path: "operation", loadChildren: () => import("./chunk-KKJIYDVN.js").then((m) => m.OperationModule) },
    { path: "reports", loadChildren: () => import("./chunk-5QPHQMGG.js").then((m) => m.ReportsModule) },
    { path: "finance", loadChildren: () => import("./chunk-2FRGNCEI.js").then((m) => m.FinanceModule) },
    { path: "lastMile", loadChildren: () => import("./chunk-RPUM7N2R.js").then((m) => m.LastMileModule) }
  ]
}];
...
//# sourceMappingURL=chunk-YE4GGIDX.js.map
