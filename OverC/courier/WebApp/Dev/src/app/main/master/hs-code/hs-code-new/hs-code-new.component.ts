...
export class HsCodeNewComponent {
  ...
  specialApprovalChange(){
    let descriptionText :any = this.specialApprovalIdList.filter(x => x.value == this.form.controls.specialApprovalId.value);
    this.form.controls.specialApprovalText.patchValue(descriptionText[0].label);
   }
}
