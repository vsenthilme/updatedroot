...
@Component({
  ...
  styleUrl: './pickup-new.component.scss'
})
export class PickupNewComponent {
  ...
  save() {
    ...
    serviceTypeChanged(){
      let descriptionText :any = this.serviceTypeIdList.filter(x => x.value == this.form.controls.serviceTypeId.value);
