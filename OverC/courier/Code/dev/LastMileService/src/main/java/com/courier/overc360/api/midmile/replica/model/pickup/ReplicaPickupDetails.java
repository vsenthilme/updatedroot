...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tblpickupdetails")
public class ReplicaPickupDetails {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "PICKUP_DETAIL_ID")
    private Long pickupDetailId;

    @Column(name = "PICKUP_HUB_CODE",columnDefinition = "nvarchar(50)")
    ...
    @Column(name = "PICKUP_ADDRESS_1", columnDefinition = "nvarchar(500)")
