...
//        }
    ...
    @ApiOperation(response = CustomerCourierPartner[].class, value = "Get all CustomerCourierPartner details")
    @GetMapping("/customerCourierPartner")
    public ResponseEntity<?> getAllCustomerCourierPartner(@RequestParam String authToken) {
        CustomerCourierPartner[] customerCourierPartners = idmasterService.getAllCustomerCourierPartner(authToken);
        return new ResponseEntity<>(customerCourierPartners, HttpStatus.OK);
    }

    // Get CustomerCourierPartner
    @ApiOperation(response = CustomerCourierPartner.class, value = "Get CustomerCourierPartner") // label for swagger
    @GetMapping("/customerCourierPartner/{courierPartnerId}")
    public ResponseEntity<?> getCustomerCourierPartner(@PathVariable String courierPartnerId, @RequestParam String companyId,
                                               @RequestParam String languageId, @RequestParam String partnerId, @RequestParam String authToken) {
        CustomerCourierPartner dbCustomerCourierPartner = idmasterService.getCustomerCourierPartner(companyId, languageId, courierPartnerId, partnerId, authToken);
        return new ResponseEntity<>(dbCustomerCourierPartner, HttpStatus.OK);
    }

    // Create CustomerCourierPartner
    @ApiOperation(response = CustomerCourierPartner.class, value = "Create new CustomerCourierPartner") // label for swagger
    @PostMapping("/customerCourierPartner")
    public ResponseEntity<?> postCustomerCourierPartner(@Valid @RequestBody AddCustomerCourierPartner addCustomerCourierPartner, @RequestParam String loginUserID, String authToken)
            throws IllegalAccessException, InvocationTargetException {
        CustomerCourierPartner createdCustomerCourierPartner = idmasterService.createCustomerCourierPartner(addCustomerCourierPartner, loginUserID, authToken);
        return new ResponseEntity<>(createdCustomerCourierPartner, HttpStatus.OK);
    }

    // Update CustomerCourierPartner
    @ApiOperation(response = CustomerCourierPartner.class, value = "Update CustomerCourierPartner") // label for swagger
    @PatchMapping("/customerCourierPartner/{courierPartnerId}")
    public ResponseEntity<?> patchCustomerCourierPartner(@PathVariable String courierPartnerId, @RequestParam String companyId, @RequestParam String languageId,
                                                 @RequestBody UpdateCustomerCourierPartner updateCustomerCourierPartner, @RequestParam String loginUserID,
                                                 @RequestParam String partnerId, @RequestParam String authToken) {
        CustomerCourierPartner updatedCustomerCourierPartner = idmasterService.updateCustomerCourierPartner(companyId, languageId, courierPartnerId, partnerId,
                updateCustomerCourierPartner, loginUserID, authToken);
        return new ResponseEntity<>(updatedCustomerCourierPartner, HttpStatus.OK);
    }

    // Delete CustomerCourierPartner
    @ApiOperation(response = CustomerCourierPartner.class, value = "Delete CustomerCourierPartner") // label for swagger
    @DeleteMapping("/customerCourierPartner/{courierPartnerId}")
    public ResponseEntity<?> deleteCustomerCourierPartner(@PathVariable String courierPartnerId, @RequestParam String companyId,
                                                  @RequestParam String languageId, @RequestParam String loginUserID,
                                                  @RequestParam String partnerId, @RequestParam String authToken) {
        idmasterService.deleteCustomerCourierPartner(companyId, languageId, courierPartnerId, partnerId, loginUserID, authToken);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }

    // Find CustomerCourierPartner
    @ApiOperation(response = CustomerCourierPartner[].class, value = "Find CustomerCourierPartner")
    @PostMapping("/customerCourierPartner/find")
    public ResponseEntity<?> findCustomerCourierPartner(@Valid @RequestBody FindCustomerCourierPartner findCustomerCourierPartner,
                                                @RequestParam String authToken) throws Exception {
        CustomerCourierPartner[] customerCourierPartnerList = idmasterService.findCustomerCourierPartner(findCustomerCourierPartner, authToken);
