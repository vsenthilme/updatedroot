...
import com.courier.overc360.api.controller.WrapperServiceController;
...
public class FileStorageService {
    ...
    @Autowired
    WrapperServiceController wrapperServiceController;
...
//    @Async
//    public CompletableFuture<Map<String, String>> processConsignmentOrdersV2(MultipartFile file, String companyId, String loginUserID, String taskId) throws InterruptedException {
//        this.fileStorageLocation = Paths.get(propertiesConfig.getFileUploadDir()).toAbsolutePath().normalize();
...
//            AuthToken authToken = authTokenService.getMidMileServiceAuthToken();
//            dbUploadApiResponse = midMileService.postConsignmentUpload(consignmentOrders, loginUserID, authToken.getAccess_token());
//            wrapperServiceController.uploadStatuses.put(taskId, "SUCCESS");
//            response.put("status", "UPLOADED SUCCESSFULLY");
//
////            if (dbUploadApiResponse != null) {
////                Map<String, String> mapFileProps = new HashMap<>();
////                mapFileProps.put("file", fileName);
...
//        } catch (IOException ex) {
//            ex.printStackTrace();
//            wrapperServiceController.uploadStatuses.put(taskId, "FAILED");
