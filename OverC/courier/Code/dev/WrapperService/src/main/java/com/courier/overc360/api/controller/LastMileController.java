...
//    }
    ...
    @ApiOperation(response = DeliveryStatusCount.class, value = "Find Delivery Status Count")
    @PostMapping("/pickup/status/count")
    public ResponseEntity<?> findPickupCount(@Valid @RequestBody StatusCountInput statusCountInput, @RequestParam String authToken) {
        PickupStatusCount[] response = lastMileService.findPickupStatusCount(statusCountInput, authToken);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }

    @ApiOperation(response = CustomerPickupStatusCount.class, value = "Find Delivery Status Count")
    @PostMapping("/customerPickup/status/count")
    public ResponseEntity<?> findCustomerPickupCount(@Valid @RequestBody StatusCountInput statusCountInput, @RequestParam String authToken) {
        CustomerPickupStatusCount[] response = lastMileService.findCustomerPickupStatusCount(statusCountInput, authToken);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
