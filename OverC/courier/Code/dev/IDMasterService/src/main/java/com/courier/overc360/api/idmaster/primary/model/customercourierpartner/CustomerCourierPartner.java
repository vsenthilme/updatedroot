package com.courier.overc360.api.idmaster.primary.model.customercourierpartner;

import com.courier.overc360.api.idmaster.primary.model.courierpartner.CourierPartnerCompositeKey;
 ...
 */
@Table(
        name = "tblcustomercourierpartner",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "unique_key_customercourierpartner",
