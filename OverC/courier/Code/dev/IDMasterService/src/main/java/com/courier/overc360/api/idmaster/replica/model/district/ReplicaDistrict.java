...
@Table(
        ...
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "unique_key_district",
                        columnNames = {"LANG_ID", "C_ID", "COUNTRY_ID", "PROVINCE_ID", "DISTRICT_ID"}
                )
        }
)
@IdClass(ReplicaDistrictCompositeKey.class)
public class ReplicaDistrict {
