...
@Table(
        ...
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "unique_key_logicmaster",
                        columnNames = {"C_ID", "LANG_ID", "CONSOLE_COUNT_ID"}
                )
        }
)
@IdClass(ReplicaLogicMasterCompositeKey.class)
public class ReplicaLogicMaster {
    ...
    @Id
    @Column(name = "CONSOLE_COUNT_ID", columnDefinition = "nvarchar(50)")
