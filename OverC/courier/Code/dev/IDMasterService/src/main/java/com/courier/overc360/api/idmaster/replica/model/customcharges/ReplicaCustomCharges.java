...
@AllArgsConstructor
@Entity
@Table(name = "tblcustomcharges",
        uniqueConstraints = {
                @UniqueConstraint( name = "unique_key_custom_charges",
                        columnNames = {"LANG_ID", "C_ID"}
                )
        }
)
@IdClass(ReplicaCustomChargesCompositeKey.class)
public class ReplicaCustomCharges {
    ...
    @Column(name = "CLEARANCE_FEE", columnDefinition = "nvarchar(50)")
    private String clearanceFee;

    @Column(name = "DOC_HANDLING", columnDefinition = "nvarchar(50)")
    private String docHandling;

    @Column(name = "DDU_FEE", columnDefinition = "nvarchar(50)")
    ...
    @Column(name = "DOC_UPLOAD", columnDefinition = "nvarchar(50)")
