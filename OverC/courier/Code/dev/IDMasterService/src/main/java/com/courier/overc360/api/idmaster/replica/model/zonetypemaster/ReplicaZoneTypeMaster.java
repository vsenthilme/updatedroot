 ...
 */
@Table(
        name = "tblzonetypemaster",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "unique_key_zonetypemaster",
                        columnNames = {"C_ID", "LANG_ID", "ZONE_TYPE_ID"}
                )
        }
)
@IdClass(ReplicaZoneTypeMasterCompositeKey.class)
public class ReplicaZoneTypeMaster {
