package com.courier.overc360.api.idmaster.primary.model.movingshipmentpricelist;
...
@NoArgsConstructor
@Table(
        name = "tblmovingshipmentpricelist",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "unique_key_movingshipmentpricelist",
                        columnNames = {"LANG_ID", "C_ID", "PARTNER_ID","LINE_NO"})
        }
)
@IdClass(MovingShipmentPriceListCompositeKey.class)
public class MovingShipmentPriceList {
