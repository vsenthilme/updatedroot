...
@NoArgsConstructor
/*
 * `C_ID`, `LANG_ID`, `SUB_PRODUCT_ID`, `SUB_PRODUCT_VALUE`
 */
@Table(
        name = "tblsubproduct",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "unique_key_subproduct",
                        columnNames = {"C_ID", "LANG_ID", "SUB_PRODUCT_ID", "SUB_PRODUCT_VALUE"}
                )
        }
)
@IdClass(SubProductCompositeKey.class)
