package com.courier.overc360.api.midmile.primary.util;
...
//		String str = "01-08-2022";
     ...
     */
    public static Date[] addTimeToDatesForSearchPlusOneDate(Date startDate, Date endDate) throws ParseException {
        LocalDate sLocalDate = LocalDate.ofInstant(startDate.toInstant(), ZoneId.systemDefault()).plusDays(1);
        LocalDate eLocalDate = LocalDate.ofInstant(endDate.toInstant(), ZoneId.systemDefault()).plusDays(1);
        log.info("LocalDate1------->  " + sLocalDate.atTime(0, 0, 0));
        log.info("LocalDate2------->  " + eLocalDate.atTime(23, 59, 0));
...
//        log.info("LocalDate1---##----> " + sLocalDateTime);
    ...
    public static Date[] addTimeToDatesForSearchV2(Date startDate, Date endDate) throws ParseException {
        LocalDate sLocalDate = LocalDate.ofInstant(startDate.toInstant(), ZoneId.systemDefault()).plusDays(0);
        LocalDate eLocalDate = LocalDate.ofInstant(endDate.toInstant(), ZoneId.systemDefault()).plusDays(0);
        log.info("LocalDate1------->  " + sLocalDate.atTime(0, 0, 0));
        log.info("LocalDate2------->  " + eLocalDate.atTime(23, 59, 0));
...
//        log.info("LocalDate1---##----> " + sLocalDateTime);
    ...
    public static Date[] addTimeToDatesForSearchOneDayAfter(Date startDate, Date endDate) throws ParseException {
        // Convert Date to LocalDate
        LocalDate sLocalDate = LocalDate.ofInstant(startDate.toInstant(), ZoneId.systemDefault()).plusDays(1);
        LocalDate eLocalDate = LocalDate.ofInstant(endDate.toInstant(), ZoneId.systemDefault()).plusDays(1);

        // Add time to the LocalDate
        LocalDateTime sLocalDateTime = sLocalDate.atTime(0, 0, 0);
        LocalDateTime eLocalDateTime = eLocalDate.atTime(0, 0, 0);
...
//			Date date = sdf3.parse("Wed Apr 12 16:16:33 IST 2023");
    ...
    public static Date[] addTimeToDatesForSearch(Date startDate, Date endDate) {
        // Adjust input dates to LocalDate in the system's default time zone
        LocalDate sLocalDate = LocalDate.ofInstant(startDate.toInstant(), ZoneId.systemDefault());
        LocalDate eLocalDate = LocalDate.ofInstant(endDate.toInstant(), ZoneId.systemDefault());

        // Set start and end times for the dates
        LocalDateTime sLocalDateTime = sLocalDate.atStartOfDay();
        LocalDateTime eLocalDateTime = eLocalDate.atTime(23, 59, 59);

        log.info("Start Date-Time------->  " + sLocalDateTime);
        log.info("End Date-Time------->  " + eLocalDateTime);
...
//			localDateTime = localDateTime.plusHours(numberOfDays);
    ...
    //Zone ID Default
    public static Date dateTimeZoneId(Date inputDate, int numberOfHours) throws ParseException {
        try {

            LocalDateTime localDateTime = LocalDateTime.ofInstant(inputDate.toInstant(), ZoneId.systemDefault());
            localDateTime = localDateTime.plusHours(numberOfHours);
