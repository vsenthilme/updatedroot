...
import com.courier.overc360.api.midmile.primary.model.riderassignment.RiderAssignmentImageReference;
...
@Repository
@Transactional
public interface RiderAssignImageReferenceRepository extends JpaRepository<RiderAssignmentImageReference, String>,
        JpaSpecificationExecutor<RiderAssignmentImageReference> {

    Optional<RiderAssignmentImageReference> findByLanguageIdAndCompanyIdAndPartnerIdAndMasterAirwayBillAndHouseAirwayBillAndPieceIdAndPieceItemIdAndImageRefIdAndDeletionIndicator(
    ...
    IKeyValuePair getLAndCDesc(@Param(value = "languageId") String languageId,
...
//    @Modifying
//    @Transactional
//    @Query(value = "UPDATE tblriderassignimagereference SET is_deleted = 1, UTD_ON = getDate(), UTD_BY = :loginUserID WHERE\n" +
//            " (c_id = :companyId) and (lang_id = :languageId) and (partner_id = :partnerId) and\n" +
//            " (house_airway_bill = :houseAB) and (master_airway_bill = :masterAB) and\n" +
...
//                                 @Param("masterAB") String masterAB, @Param("loginUserID") String loginUserID);
    ...
    List<RiderAssignmentImageReference> findByLanguageIdAndCompanyIdAndPartnerIdAndMasterAirwayBillAndHouseAirwayBillAndPieceIdAndPieceItemIdAndDeletionIndicator(
    ...
    RiderAssignmentImageReference findByImageRefIdAndDeletionIndicator(String imageRefId, Long deletionIndicator);

    List<RiderAssignmentImageReference> findByLanguageIdAndCompanyIdAndPartnerIdAndMasterAirwayBillAndHouseAirwayBillAndDeletionIndicator(
