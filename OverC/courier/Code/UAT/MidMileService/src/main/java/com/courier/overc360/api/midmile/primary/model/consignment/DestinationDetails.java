...
//    private Long consignmentId = 0L;
    ...
    @Column(name = "ADDRESS_LINE_1", columnDefinition = "nvarchar(1000)")
    private String addressLine1;

    @Column(name = "ADDRESS_LINE_2", columnDefinition = "nvarchar(1000)")
    private String addressLine2;

    @Column(name = "PINCODE", columnDefinition = "nvarchar(50)")
    private String pinCode;

    @Column(name = "DISTRICT", columnDefinition = "nvarchar(500)")
    private String district;

    @Column(name = "CITY", columnDefinition = "nvarchar(500)")
    private String city;

    @Column(name = "STATE", columnDefinition = "nvarchar(500)")
    private String state;

    @Column(name = "COUNTRY", columnDefinition = "nvarchar(500)")
    private String country;

    @Column(name = "LATITUDE", columnDefinition = "nvarchar(500)")
    private String latitude;

    @Column(name = "LONGITUDE", columnDefinition = "nvarchar(500)")
