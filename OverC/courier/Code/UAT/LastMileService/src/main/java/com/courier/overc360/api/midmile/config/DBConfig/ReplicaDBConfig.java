// BookDBConfig.java
package com.courier.overc360.api.midmile.config.DBConfig; // Ensure the correct package
...
@EnableJpaRepositories(entityManagerFactoryRef = "replicaEntityManagerFactory", transactionManagerRef = "replicaTransactionManager", basePackages = {
		"com.courier.overc360.api.midmile.replica.repository" }) // Adjust package name accordingly
