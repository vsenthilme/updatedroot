...
public interface DeliveryRepository extends JpaRepository<Delivery, Long>, JpaSpecificationExecutor<Delivery> {
    ...
    @Modifying
    @Query(value = "UPDATE tblconsignment_entity set " +
            "FRIGHT_CHARGE = :charge WHERE HOUSE_AIRWAY_BILL = :houseAirwayBill AND IS_DELETED = 0", nativeQuery = true)
    ...
    @Query(value = "SELECT BILLING_FREQUENCY_DATE_1, BILLING_FREQUENCY_DATE_2, BILLING_FREQUENCY_DATE_3, BILLING_FREQUENCY_DATE_4, " +
            "BILLING_FREQUENCY_DATE_5 FROM tblcustomer WHERE CUSTOMER_ID = :customerId AND BILL_GENERATION = 0 AND IS_DELETED = 0", nativeQuery = true)
