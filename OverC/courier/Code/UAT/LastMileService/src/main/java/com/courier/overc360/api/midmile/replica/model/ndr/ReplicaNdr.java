...
public class ReplicaNdr {
    ...
    @NotBlank(message = "DeliveryId is mandatory")
    @Column(name = "DELIVERY_ID", columnDefinition = "nvarchar(50)", nullable = false)
    ...
    @Column(name = "NDR_DESCRIPTION", columnDefinition = "nvarchar(500)")
