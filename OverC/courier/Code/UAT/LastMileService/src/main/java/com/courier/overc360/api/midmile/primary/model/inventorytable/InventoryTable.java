package com.courier.overc360.api.midmile.primary.model.inventorytable;

import com.courier.overc360.api.midmile.primary.model.drs.DrsCompositeKey;
...
@NoArgsConstructor
@Entity
@Table(name = "tblinventorytable",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "unique_key_inventorytable",
                        columnNames = {"LANG_ID", "C_ID", "CUSTOMER_ID", "HOUSE_AIRWAY_BILL"}
                )
        }
)
@IdClass(InventoryTableCompositeKey.class)
public class InventoryTable {
    ...
    @Column(name = "STORAGE_ID", columnDefinition = "nvarchar(50)")
    private String storageId;

    @Column(name = "VARIANCE_FLAG", columnDefinition = "nvarchar(50)")
    private String varianceFlag;

    @Column(name = "REMARK", columnDefinition = "nvarchar(2000)")
    private String remark;

    @Column(name = "HUB_CODE", columnDefinition = "nvarchar(2000)")
