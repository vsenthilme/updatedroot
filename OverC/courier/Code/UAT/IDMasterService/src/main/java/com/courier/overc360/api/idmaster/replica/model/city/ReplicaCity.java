...
public class ReplicaCity {
    ...
    @Column(name = "COUNTRY_TEXT", columnDefinition = "nvarchar(100)")
    private String countryText;

    @Column(name = "PROVINCE_TEXT", columnDefinition = "nvarchar(100)")
    private String provinceText;

    @Column(name = "DISTRICT_TEXT", columnDefinition = "nvarchar(100)")
