 ...
 */
@Table(
        name = "tblprovincemapping",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "unique_key_provincemapping",
                        columnNames = {"LANG_ID", "C_ID", "PROVINCE_ID", "PARTNER_ID"}
                )
        }
)
@IdClass(ReplicaProvinceMappingCompositeKey.class)
public class ReplicaProvinceMapping {
    ...
    @Column(name = "PARTNER_PROVINCE_ID", columnDefinition = "nvarchar(50)")
    private String partnerProvinceId;

    @Column(name = "PARTNER_PROVINCE_NAME", columnDefinition = "nvarchar(100)")
