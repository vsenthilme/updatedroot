...
import com.courier.overc360.api.idmaster.primary.model.province.ProvinceCompositeKey;
...
@NoArgsConstructor
/*
 * `LANG_ID`, `C_ID`, `COUNTRY_ID`, `PROVINCE_ID`
 */
@Table(
        name = "tblprovince",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "unique_key_province",
                        columnNames = {"LANG_ID", "C_ID", "COUNTRY_ID", "PROVINCE_ID"}
                )
        }
)
@IdClass(ReplicaProvinceCompositeKey.class)
public class ReplicaProvince {
