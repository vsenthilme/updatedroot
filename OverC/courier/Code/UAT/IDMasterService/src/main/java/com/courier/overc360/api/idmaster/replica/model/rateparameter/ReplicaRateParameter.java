...
import com.courier.overc360.api.idmaster.primary.model.rateparameter.RateParameterCompositeKey;
...
@Table(
        name = "tblrateparameter",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "unique_key_rateparameter",
                        columnNames = {"LANG_ID", "C_ID", "RATE_PARAMETER_ID"}
                )
        }
)
@IdClass(RateParameterCompositeKey.class)
public class ReplicaRateParameter {
    ...
    @Column(name = "RATE_PARAMETER_TEXT", columnDefinition = "nvarchar(50)")
