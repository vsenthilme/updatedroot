...
@Repository
@Transactional
public interface ReplicaRtoPriceRepository extends JpaRepository<ReplicaRtoPrice, String>, JpaSpecificationExecutor<ReplicaRtoPrice> {

    Optional<ReplicaRtoPrice> findByLanguageIdAndCompanyIdAndPartnerIdAndLineNoAndDeletionIndicator(
