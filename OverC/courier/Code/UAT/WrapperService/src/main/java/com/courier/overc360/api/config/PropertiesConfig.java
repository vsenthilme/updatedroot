...
public class PropertiesConfig {
    ...
    @Value("${lastmile.oauth.access_token_url}")
    private String lastMileAccessTokenUrl;
    ...
    @Value("${api.lastmile.service.url}")
    private String lastMileServiceUrl;
...
//	private String impartner111FileName;
    ...
    @Value("${doc.invoice.base.path}")
    private String docInvoicePath;

    @Value("${doc.invoice.pdf.path}")
